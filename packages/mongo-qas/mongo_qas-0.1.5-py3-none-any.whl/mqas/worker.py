...
def run_with_executable(function_name, executable=None, args=[], kwargs={}, stdout=None):
  if executable is None:
    executable = sys.executable

  data = {"function_name": function_name, "args": args, "kwargs": kwargs, "stdout": stdout}
...
class Worker:
  ...
  def __init__(self, queues: Union[Tuple[Queue,...], Type[Queue]], channel: Union[Tuple[str,...], str]=None, heart_beat: int = 1, verbosity: str = "error", logger: Union[str, Callable] = None, executables: Dict = None, logFile: str = None) -> None:
    ...
    try:
      if not payload is None:
        ...
        if not callback is None:
          ...
          output = run_with_executable(callback, args=args, kwargs=kwargs, executable=executable, stdout=self.logFile)
