...
from azureml.automl.runtime._data_definition import MaterializedTabularData, LazyTabularData, TabularData
...
from azureml.automl.runtime._ml_engine import timeseries_ml_engine, ml_engine
...
def _init_streaming_experiment_store(
    ...
    expr_store.data.lazy.set_validation_dataset(
        transformed_data_context.validation_data
    )
    ...
    if task_type == constants.Tasks.CLASSIFICATION:
        train_class_labels = np.unique(
            ...
            distinct(label_column_name).to_pandas_dataframe()
        )
