...
class ARQDK(QDK):
    ...
    def close_opened_record(self, record_id, time_out, alert):
        """
    ...
    def get_table_info(self, table_name, only_active=True):
        ...
        :return:
        """
        self.execute_method('get_table_info', table_name=table_name)
    ...
    def get_last_event(self, auto_id):
        ...
        :return:
        """
        self.execute_method('get_last_events', auto_id=auto_id)
