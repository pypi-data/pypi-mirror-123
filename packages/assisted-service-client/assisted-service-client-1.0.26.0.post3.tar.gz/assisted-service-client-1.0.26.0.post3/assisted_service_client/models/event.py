...
class Event(object):
    ...
    def __init__(self, cluster_id=None, host_id=None, infra_env_id=None, severity=None, category=None, message=None, event_time=None, request_id=None, props=None):  # noqa: E501
