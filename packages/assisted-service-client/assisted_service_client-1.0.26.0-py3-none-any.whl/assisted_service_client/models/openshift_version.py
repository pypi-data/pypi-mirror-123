...
class OpenshiftVersion(object):
    ...
    def __init__(self, display_name=None, release_image=None, release_version=None, rhcos_image=None, rhcos_rootfs=None, rhcos_version=None, support_level=None, default=None):  # noqa: E501
    ...
    def rhcos_rootfs(self, rhcos_rootfs):
        ...
        :type: str
        """
        if rhcos_rootfs is None:
            raise ValueError("Invalid value for `rhcos_rootfs`, must not be `None`")  # noqa: E501
    ...
    def support_level(self, support_level):
        ...
        allowed_values = ["beta", "production", "custom"]  # noqa: E501
