...
logging.warning("[WARNING] enhanced-dpy on PyPi uses 1.7!")
logging.warning("To get the updates, install from git!")
logging.warning("----------------------------------------")
logging.warning("pip install -U git+https://github.com/iDevision/enhanced-discord.py")
logging.warning("Support server: https://discord.gg/TvqYBrGXEm")
