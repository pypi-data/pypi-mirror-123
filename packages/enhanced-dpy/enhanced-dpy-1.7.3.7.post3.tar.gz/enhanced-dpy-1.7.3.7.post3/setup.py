...
print("[WARNING] enhanced-dpy on PyPi uses 1.7!")
print("To get the updates, install from git!")
print("----------------------------------------")
print("pip install -U git+https://github.com/iDevision/enhanced-discord.py")
print("Support server: https://discord.gg/TvqYBrGXEm")
