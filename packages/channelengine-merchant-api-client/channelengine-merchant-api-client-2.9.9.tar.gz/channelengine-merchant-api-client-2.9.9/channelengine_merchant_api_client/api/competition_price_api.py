        ...
        def __competition_prices_get_buy_box_prices(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                gtin_list ([str], none_type): Search products by submitting a list of GTIN's. (optional)<br />Max. 2000.. [optional]
                sku_list ([str], none_type): Search products by submitting a list of Sku's. (optional)<br />Max. 2000. If GtinList is already set, this one is ignored.. [optional]
