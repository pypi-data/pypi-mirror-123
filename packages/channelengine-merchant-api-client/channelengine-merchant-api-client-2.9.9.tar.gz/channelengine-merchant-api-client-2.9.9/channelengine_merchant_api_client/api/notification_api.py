    ...
    def __init__(self, api_client=None):
        ...
        def __notification_index(
            ...
            **kwargs
            ...
            Keyword Args:
                from_date (datetime, none_type): Filter on the notification date, starting from this date. This date is inclusive.. [optional]
                to_date (datetime, none_type): Filter on the notification date, until this date. This date is exclusive.. [optional]
                types ([NotificationType], none_type): Notification type(s) to filter on.. [optional]
                ...
                merchant_return_nos ([str], none_type): Filter on unique return reference used by the merchant.. [optional]
                channel_return_nos ([str], none_type): Filter on unique return reference used by the channel.. [optional]
                merchant_shipment_nos ([str], none_type): Filter on unique shipment reference used by the merchant.. [optional]
