...
def run():
    ...
    additional_sig_scan_args = shlex.quote(
        my_args.args.additional_sig_scan_args) if my_args.args.additional_sig_scan_args else None
    ...
    try:
        ...
        logging.warn("unable to get version of blackduck-c-cpp")
    ...
    if not my_args.args.skip_build:
        ...
        conf_cmd += conf_key + util.conf_cmd("--template --compiler c++ --comptype g++", cov_bin, cov_conf)
