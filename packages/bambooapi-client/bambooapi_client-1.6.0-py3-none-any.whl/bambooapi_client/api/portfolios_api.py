...
class PortfoliosApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_portfolio_site = _Endpoint(
            settings={
            ...
            callable=__add_portfolio_site
        )

        def __create_portfolio(
            self,
            portfolio_create,
            **kwargs
        ):
        ...
        self.create_portfolio = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__create_portfolio
        )

        def __create_portfolio_market(
            self,
            portfolio_id,
            market_id,
            **kwargs
        ...
        self.create_portfolio_market = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__create_portfolio_market
        )

        def __delete_portfolio(
            self,
            portfolio_id,
            **kwargs
        ):
        ...
        self.delete_portfolio = _Endpoint(
            settings={
                'response_type': (Portfolio,),
                'auth': [
                    'BearerAuth'
        ...
        self.get_portfolio = _Endpoint(
            ...
            api_client=api_client,
            callable=__get_portfolio
        )

        def __list_portfolios(
            self,
            **kwargs
        ):
        ...
        self.list_portfolios = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__list_portfolios
        )

        def __list_portfolios_markets(
            self,
            portfolio_id,
            **kwargs
        ):
        ...
        self.list_portfolios_markets = _Endpoint(
            settings={
                'response_type': ([PortfolioMarket],),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__list_portfolios_markets
        )

        def __list_portfolios_sites(
            self,
            portfolio_id,
            **kwargs
        ):
        ...
        self.list_portfolios_sites = _Endpoint(
            settings={
                'response_type': ([PortfolioSite],),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__list_portfolios_sites
        )

        def __remove_portfolio_market(
            self,
            portfolio_id,
            market_id,
            **kwargs
        ...
        self.remove_portfolio_market = _Endpoint(
            settings={
                'response_type': (PortfolioMarket,),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__remove_portfolio_market
        )

        def __remove_portfolio_site(
            self,
            portfolio_id,
            site_id,
            **kwargs
        ...
        self.remove_portfolio_site = _Endpoint(
            settings={
                'response_type': (PortfolioSite,),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__remove_portfolio_site
        )
        ...
        self.update_portfolio = _Endpoint(
            settings={
                'response_type': (Portfolio,),
                'auth': [
                    'BearerAuth'
