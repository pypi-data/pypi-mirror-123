...
class WeatherStationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_weather_station = _Endpoint(
            settings={
            ...
            callable=__create_weather_station
        )

        def __delete_weather_station(
            self,
            station_id,
            **kwargs
        ):
        ...
        self.delete_weather_station = _Endpoint(
            settings={
                'response_type': (WeatherStation,),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__delete_weather_station
        )

        def __get_station_id_by_name(
            self,
            station_name,
            **kwargs
        ):
        ...
        self.get_station_id_by_name = _Endpoint(
            settings={
                'response_type': (int,),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__get_station_id_by_name
        )

        def __insert_weather_forecasts(
            self,
            station_id,
            weather_data_point,
            **kwargs
        ...
        self.insert_weather_forecasts = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__insert_weather_forecasts
        )

        def __list_weather_stations(
            self,
            **kwargs
        ):
        ...
        self.list_weather_stations = _Endpoint(
            settings={
                'response_type': ([WeatherStation],),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__list_weather_stations
        )

        def __read_weather_forecasts(
            self,
            station_id,
            **kwargs
        ):
        ...
        self.read_weather_forecasts = _Endpoint(
            settings={
                'response_type': ([WeatherDataPoint],),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__read_weather_forecasts
        )

        def __read_weather_station(
            self,
            station_id,
            **kwargs
        ):
        ...
        self.read_weather_station = _Endpoint(
            settings={
                'response_type': (WeatherStation,),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__read_weather_station
        )

        def __update_weather_station(
            self,
            station_id,
        ...
        self.update_weather_station = _Endpoint(
            settings={
                'response_type': (WeatherStation,),
                'auth': [
                    'BearerAuth'
            ...
            api_client=api_client,
            callable=__update_weather_station
        )
