...
from trident.backend.common import to_list, addindent, get_time_suffix, format_time, get_terminal_size, get_session, \
    snake2camel, PrintException, unpack_singleton, enforce_singleton, OrderedDict, split_path, sanitize_path, make_dir_if_need, if_none
...
def as_metric(format=None,aggregate='mean',name=None):
    def _f(fun):
        ...
        m.__doc__ = m.__doc__
        m.__signature__ = inspect.Signature(fun)
    return _f
