...
class Nativemethods(metaclass=Singleton):
    ...
    def init_autd3capi(self):
        if hasattr(self, 'autd3capi'):
            return
        self.autd3capi = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.0" + self._bin_ext))
        ...
        self.autd3capi.AUTDIsOutputEnable.argtypes = [c_void_p]
        self.autd3capi.AUTDIsOutputEnable.restype = c_bool
        ...
        self.autd3capi.AUTDSendSequenceModulation.argtypes = [c_void_p, c_void_p, c_void_p]
        self.autd3capi.AUTDSendSequenceModulation.restype = c_int

        self.autd3capi.AUTDSendGainSequenceModulation.argtypes = [c_void_p, c_void_p, c_void_p]
        self.autd3capi.AUTDSendGainSequenceModulation.restype = c_int
    ...
    def init_autd3capi_from_file_modulation(self):
        ...
        self.autd3capi_from_file_modulation = ctypes.CDLL(
            os.path.join(
                self._bin_location,
                self._bin_prefix +
                "autd3capi_1.9.0-from-file-modulation" +
                self._bin_ext))
    ...
    def init_autd3capi_holo_gain(self):
        if hasattr(self, 'autd3capi_holo_gain'):
            return
        self.autd3capi_holo_gain = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.0-holo-gain" + self._bin_ext))
    ...
    def init_autd3capi_remote_twincat_link(self):
        ...
        self.autd3capi_remote_twincat_link = ctypes.CDLL(
            os.path.join(
                self._bin_location,
                self._bin_prefix +
                "autd3capi_1.9.0-remote-twincat-link" +
                self._bin_ext))
    ...
    def init_autd3capi_soem_link(self):
        if hasattr(self, 'autd3capi_soem_link'):
            return
        self.autd3capi_soem_link = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.0-soem-link" + self._bin_ext))
    ...
    def init_autd3capi_twincat_link(self):
        if hasattr(self, 'autd3capi_twincat_link'):
            return
        self.autd3capi_twincat_link = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.0-twincat-link" + self._bin_ext))
    ...
    def init_autd3capi_arrayfire_backend(self):
        ...
        self.autd3capi_arrayfire_backend = ctypes.CDLL(
            os.path.join(
                self._bin_location,
                self._bin_prefix +
                "autd3capi_1.9.0-arrayfire-backend" +
                self._bin_ext))
    ...
    def init_autd3capi_blas_backend(self):
        if hasattr(self, 'autd3capi_blas_backend'):
            return
        self.autd3capi_blas_backend = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.0-blas-backend" + self._bin_ext))
    ...
    def init_autd3capi_cuda_backend(self):
        if hasattr(self, 'autd3capi_cuda_backend'):
            return
        self.autd3capi_cuda_backend = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.0-cuda-backend" + self._bin_ext))
