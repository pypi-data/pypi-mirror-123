...
def convert_tubes_to_image(*args,  use_radius: bool=..., color_by_tube_id: bool=..., color_by_radius: bool=..., color_by_ridgeness: bool=..., color_by_medialness: bool=..., color_by_branchness: bool=..., color_by_curvature: bool=..., color_by_levelness: bool=..., color_by_roundness: bool=..., color_by_intensity: bool=..., template_image: itkt.Image=...,**kwargs):
    """Functional interface for ConvertTubesToImage"""
    import itk

    kwarg_typehints = { 'use_radius':use_radius,'color_by_tube_id':color_by_tube_id,'color_by_radius':color_by_radius,'color_by_ridgeness':color_by_ridgeness,'color_by_medialness':color_by_medialness,'color_by_branchness':color_by_branchness,'color_by_curvature':color_by_curvature,'color_by_levelness':color_by_levelness,'color_by_roundness':color_by_roundness,'color_by_intensity':color_by_intensity,'template_image':template_image }
