    ...
    for i in range(len(datos)):
        ...
        if S==1:
            ...
            if Vd > D1:
                ...
                if ((round(datos[i][5],3)*FA*FT60>In*Fsc) or (round(datos[i][6],3)*FA*FT75>In*Fsc) or (round(datos[i][7],3)*FA*FT90>In*Fsc)):
                    datos[i].append('Yes')
                else:
                    datos[i].append('Not')
            ...
            if Vd > D2:
                ...
                if ((round(datos[i][5],3)*FA*FT60>In*Fsc) or (round(datos[i][6],3)*FA*FT75)*Fsc>In or (round(datos[i][7],3)*FA*FT90>In)*Fsc):
...
def mbtcustd(Vcd=None,In=None,Nc=None,L=None,Class=None,Ta=None,Vd=None,View=None,Fsc=None):
    ...
    for i in range(len(datos)):
        ...
        if Vd > D1:
            if ((round(datos[i][4],3)*FT60>In*Fsc) or (round(datos[i][5],3)*FT75>In*Fsc) or (round(datos[i][6],3)*FT90>In*Fsc)):
                datos[i].append('Yes')
            else:
                datos[i].append('Not')
        else:
