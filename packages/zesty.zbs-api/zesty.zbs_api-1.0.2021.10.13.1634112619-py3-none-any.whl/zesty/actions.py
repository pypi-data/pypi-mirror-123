...
class FileSystemHF(IFileSystemHF):
    def __init__(self, fs_id: str, fs_usage: int, devices: Dict[str, BlockDevice], existing_actions: Dict[str, ZBSAction]):
        warnings.warn(
            'Please use the new objects inside of FileSystem.py',
            DeprecationWarning)
        self.fs_id = fs_id
    ...
    def get_devices(self) -> Dict[str, BlockDevice]:
        return self.devices
