...
class AIRBackfillingAPI(BaseAPIClient):
    def __init__(self, config: AIRClientConfig, backfill_asset: Asset, backfilling_call: bool) -> None:
        ...
        self._backfilling_call = backfilling_call
    ...
    def in_progress(self) -> bool:
        ...
        """
        return not is_string_truthy(self._meta[AIR_META_BACKFILL_COMPLETE]) and self._backfilling_call
