...
from tensorflow_probability.substrates.numpy.experimental.mcmc import infer_trajectories
...
#   `tensorflow_probability/substrates/numpy/experimental/sequential/iterated_filter.py`
