...
from tensorflow_probability.substrates.jax.experimental.mcmc import infer_trajectories
...
#   `tensorflow_probability/substrates/jax/experimental/sequential/iterated_filter.py`
