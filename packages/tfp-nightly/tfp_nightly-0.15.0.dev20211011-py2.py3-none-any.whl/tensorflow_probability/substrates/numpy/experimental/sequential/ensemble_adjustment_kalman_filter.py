...
from tensorflow_probability.substrates.numpy.experimental.sequential import ensemble_kalman_filter  # pylint:disable=line-too-long
...
#   `tensorflow_probability/substrates/numpy/experimental/sequential/ensemble_adjustment_kalman_filter.py`
