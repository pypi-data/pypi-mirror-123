...
class InitializeEnvironmentTest(unittest.TestCase):
    ...
    def test_query_my_decided_approvals(self):
        ...
        s = self.flow_app.QueryApplyDecidedByUser("long", record_condition=None)
        pprint(s)
    ...
    def test_examine_stage(self):
        ...
        ret_code = self.flow_app.ExamineStageCoherent(451, "long", True, "joint agree", "http://www.baidu.com")
        print(ret_code)
