...
class JsonRefTest(unittest.TestCase):
    ...
    def test_validate_json(self):
        ...
        # Compare text files
        # self.assertTextFilesEqual('temp',
        #                           str(PurePath(self.testing_path).joinpath(
        #                               'json_testschema.out.txt')))
        # os.remove('temp')
...
class TestObsinfo(unittest.TestCase):
    ...
    def test_test_filters(self):
        ...
        relative file name.
        """
        filelist = glob.glob(str(Path(__file__).parent.joinpath(
                    "data", "Information_Files", "filters", "*/*.yaml")))     
        for file in filelist:
            self._test_filter(file)
    ...
    def _create_test_network(self, network_file):
        ...
        network_file = str(network_dir.joinpath(network_file))
