...
with open("README.txt","r",encoding='utf8') as fh:
  long_description = fh.read()
print(long_description)
setup(
  name = 'CntNumber',         # How you named your package folder (MyLib)
  packages = ['CntNumber'],   # Chose the same as "name"
  version = '0.9.4.1',      # Start with a small number and increase it with every change you make
  ...
  author_email = 'cm.for.dev@gmail.com',      # Type in your E-Mail
  url = 'https://github.com/Cmccm123',   # Provide either the link to your github or to your website
