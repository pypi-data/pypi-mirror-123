...
from cdft1d.io_utils import read_array, read_key_value, read_system
from utils.rad_fft import RadFFT
...
def compute_d2_rigid_bond(xv, yv, zv, kgrid):
    """
    Args:
...
def compute_sm_rigid_bond(solvent_model):
    """
    Args:
