...
class AppRoleAssignment(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["AppRoleAssignmentTimeouts"] = None,
        ...
        :param app_role_id: The ID of the app role to be assigned. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/app_role_assignment.html#app_role_id AppRoleAssignment#app_role_id}
        :param principal_object_id: The object ID of the user, group or service principal to be assigned this app role. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/app_role_assignment.html#principal_object_id AppRoleAssignment#principal_object_id}
        :param resource_object_id: The object ID of the service principal representing the resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/app_role_assignment.html#resource_object_id AppRoleAssignment#resource_object_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/app_role_assignment.html#timeouts AppRoleAssignment#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def app_role_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "appRoleIdInput"))
    ...
    def principal_object_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "principalObjectIdInput"))
    ...
    def resource_object_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "resourceObjectIdInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["AppRoleAssignmentTimeouts"]:
        return typing.cast(typing.Optional["AppRoleAssignmentTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    def timeouts(self) -> "AppRoleAssignmentTimeouts":
        return typing.cast("AppRoleAssignmentTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "AppRoleAssignmentTimeouts") -> None:
...
class AppRoleAssignmentTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/app_role_assignment.html#create AppRoleAssignment#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/app_role_assignment.html#delete AppRoleAssignment#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/app_role_assignment.html#read AppRoleAssignment#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class Application(
    ...
    def __init__(
        ...
        *,
        ...
        api: typing.Optional[typing.Sequence["ApplicationApi"]] = None,
        app_role: typing.Optional[typing.Sequence["ApplicationAppRole"]] = None,
        ...
        feature_tags: typing.Optional[typing.Sequence["ApplicationFeatureTags"]] = None,
        ...
        optional_claims: typing.Optional[typing.Sequence["ApplicationOptionalClaims"]] = None,
        ...
        public_client: typing.Optional[typing.Sequence["ApplicationPublicClient"]] = None,
        required_resource_access: typing.Optional[typing.Sequence["ApplicationRequiredResourceAccess"]] = None,
        sign_in_audience: typing.Optional[builtins.str] = None,
        single_page_application: typing.Optional[typing.Sequence["ApplicationSinglePageApplication"]] = None,
        ...
        timeouts: typing.Optional["ApplicationTimeouts"] = None,
        web: typing.Optional[typing.Sequence["ApplicationWeb"]] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_name: The display name for the application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#display_name Application#display_name}
        :param api: api block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#api Application#api}
        :param app_role: app_role block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#app_role Application#app_role}
        :param device_only_auth_enabled: Specifies whether this application supports device authentication without a user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#device_only_auth_enabled Application#device_only_auth_enabled}
        :param fallback_public_client_enabled: Specifies whether the application is a public client. Appropriate for apps using token grant flows that don't use a redirect URI Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#fallback_public_client_enabled Application#fallback_public_client_enabled}
        :param feature_tags: feature_tags block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#feature_tags Application#feature_tags}
        :param group_membership_claims: Configures the ``groups`` claim issued in a user or OAuth 2.0 access token that the app expects. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#group_membership_claims Application#group_membership_claims}
        :param identifier_uris: The user-defined URI(s) that uniquely identify an application within its Azure AD tenant, or within a verified custom domain if the application is multi-tenant. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#identifier_uris Application#identifier_uris}
        :param logo_image: Base64 encoded logo image in gif, png or jpeg format. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#logo_image Application#logo_image}
        :param marketing_url: URL of the application's marketing page. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#marketing_url Application#marketing_url}
        :param oauth2_post_response_required: Specifies whether, as part of OAuth 2.0 token requests, Azure AD allows POST requests, as opposed to GET requests. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#oauth2_post_response_required Application#oauth2_post_response_required}
        :param optional_claims: optional_claims block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#optional_claims Application#optional_claims}
        :param owners: A list of object IDs of principals that will be granted ownership of the application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#owners Application#owners}
        :param prevent_duplicate_names: If ``true``, will return an error if an existing application is found with the same name. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#prevent_duplicate_names Application#prevent_duplicate_names}
        :param privacy_statement_url: URL of the application's privacy statement. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#privacy_statement_url Application#privacy_statement_url}
        :param public_client: public_client block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#public_client Application#public_client}
        :param required_resource_access: required_resource_access block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#required_resource_access Application#required_resource_access}
        :param sign_in_audience: The Microsoft account types that are supported for the current application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#sign_in_audience Application#sign_in_audience}
        :param single_page_application: single_page_application block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#single_page_application Application#single_page_application}
        :param support_url: URL of the application's support page. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#support_url Application#support_url}
        :param tags: A set of tags to apply to the application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#tags Application#tags}
        :param template_id: Unique ID of the application template from which this application is created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#template_id Application#template_id}
        :param terms_of_service_url: URL of the application's terms of service statement. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#terms_of_service_url Application#terms_of_service_url}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#timeouts Application#timeouts}
        :param web: web block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#web Application#web}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def app_role_ids(self, key: builtins.str) -> builtins.str:
        '''
        :param key: -
        '''
        return typing.cast(builtins.str, jsii.invoke(self, "appRoleIds", [key]))

    @jsii.member(jsii_name="oauth2PermissionScopeIds")
    def oauth2_permission_scope_ids(self, key: builtins.str) -> builtins.str:
        '''
        :param key: -
        '''
        return typing.cast(builtins.str, jsii.invoke(self, "oauth2PermissionScopeIds", [key]))
    ...
    def display_name_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "displayNameInput"))
    ...
    def api_input(self) -> typing.Optional[typing.List["ApplicationApi"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationApi"]], jsii.get(self, "apiInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="appRoleInput")
    def app_role_input(self) -> typing.Optional[typing.List["ApplicationAppRole"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationAppRole"]], jsii.get(self, "appRoleInput"))
    ...
    def feature_tags_input(
        self,
    ) -> typing.Optional[typing.List["ApplicationFeatureTags"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationFeatureTags"]], jsii.get(self, "featureTagsInput"))
    ...
    def optional_claims_input(
        self,
    ) -> typing.Optional[typing.List["ApplicationOptionalClaims"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationOptionalClaims"]], jsii.get(self, "optionalClaimsInput"))
    ...
    def public_client_input(
        self,
    ) -> typing.Optional[typing.List["ApplicationPublicClient"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationPublicClient"]], jsii.get(self, "publicClientInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="requiredResourceAccessInput")
    def required_resource_access_input(
        self,
    ) -> typing.Optional[typing.List["ApplicationRequiredResourceAccess"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationRequiredResourceAccess"]], jsii.get(self, "requiredResourceAccessInput"))
    ...
    def single_page_application_input(
        self,
    ) -> typing.Optional[typing.List["ApplicationSinglePageApplication"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationSinglePageApplication"]], jsii.get(self, "singlePageApplicationInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ApplicationTimeouts"]:
        return typing.cast(typing.Optional["ApplicationTimeouts"], jsii.get(self, "timeoutsInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="webInput")
    def web_input(self) -> typing.Optional[typing.List["ApplicationWeb"]]:
        return typing.cast(typing.Optional[typing.List["ApplicationWeb"]], jsii.get(self, "webInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="api")
    def api(self) -> typing.List["ApplicationApi"]:
        return typing.cast(typing.List["ApplicationApi"], jsii.get(self, "api"))

    @api.setter
    def api(self, value: typing.List["ApplicationApi"]) -> None:
        jsii.set(self, "api", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="appRole")
    def app_role(self) -> typing.List["ApplicationAppRole"]:
        return typing.cast(typing.List["ApplicationAppRole"], jsii.get(self, "appRole"))

    @app_role.setter
    def app_role(self, value: typing.List["ApplicationAppRole"]) -> None:
        jsii.set(self, "appRole", value)
    ...
    def feature_tags(self) -> typing.List["ApplicationFeatureTags"]:
        return typing.cast(typing.List["ApplicationFeatureTags"], jsii.get(self, "featureTags"))

    @feature_tags.setter
    def feature_tags(self, value: typing.List["ApplicationFeatureTags"]) -> None:
        jsii.set(self, "featureTags", value)
    ...
    def optional_claims(self) -> typing.List["ApplicationOptionalClaims"]:
        return typing.cast(typing.List["ApplicationOptionalClaims"], jsii.get(self, "optionalClaims"))

    @optional_claims.setter
    def optional_claims(self, value: typing.List["ApplicationOptionalClaims"]) -> None:
        jsii.set(self, "optionalClaims", value)
    ...
    def public_client(self) -> typing.List["ApplicationPublicClient"]:
        return typing.cast(typing.List["ApplicationPublicClient"], jsii.get(self, "publicClient"))

    @public_client.setter
    def public_client(self, value: typing.List["ApplicationPublicClient"]) -> None:
        jsii.set(self, "publicClient", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="requiredResourceAccess")
    def required_resource_access(
        self,
    ) -> typing.List["ApplicationRequiredResourceAccess"]:
        return typing.cast(typing.List["ApplicationRequiredResourceAccess"], jsii.get(self, "requiredResourceAccess"))

    @required_resource_access.setter
    def required_resource_access(
        self,
        value: typing.List["ApplicationRequiredResourceAccess"],
    ) -> None:
        jsii.set(self, "requiredResourceAccess", value)
    ...
    def single_page_application(
        self,
    ) -> typing.List["ApplicationSinglePageApplication"]:
        return typing.cast(typing.List["ApplicationSinglePageApplication"], jsii.get(self, "singlePageApplication"))

    @single_page_application.setter
    def single_page_application(
        self,
        value: typing.List["ApplicationSinglePageApplication"],
    ) -> None:
        jsii.set(self, "singlePageApplication", value)
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ApplicationTimeouts":
        return typing.cast("ApplicationTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ApplicationTimeouts") -> None:
        jsii.set(self, "timeouts", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="web")
    def web(self) -> typing.List["ApplicationWeb"]:
        return typing.cast(typing.List["ApplicationWeb"], jsii.get(self, "web"))

    @web.setter
    def web(self, value: typing.List["ApplicationWeb"]) -> None:
        jsii.set(self, "web", value)
...
class ApplicationApi:
    def __init__(
        ...
        *,
        ...
        oauth2_permission_scope: typing.Optional[typing.Sequence["ApplicationApiOauth2PermissionScope"]] = None,
        ...
        :param mapped_claims_enabled: Allows an application to use claims mapping without specifying a custom signing key. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#mapped_claims_enabled Application#mapped_claims_enabled}
        :param oauth2_permission_scope: oauth2_permission_scope block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#oauth2_permission_scope Application#oauth2_permission_scope}
        :param requested_access_token_version: The access token version expected by this resource. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#requested_access_token_version Application#requested_access_token_version}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
    ...
    def oauth2_permission_scope(
        self,
    ) -> typing.Optional[typing.List["ApplicationApiOauth2PermissionScope"]]:
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationApiOauth2PermissionScope"]], result)
...
class ApplicationApiOauth2PermissionScope:
    def __init__(
        ...
        *,
        ...
        '''
        :param id: The unique identifier of the delegated permission. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#id Application#id}
        :param admin_consent_description: Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#admin_consent_description Application#admin_consent_description}
        :param admin_consent_display_name: Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#admin_consent_display_name Application#admin_consent_display_name}
        :param enabled: Determines if the permission scope is enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#enabled Application#enabled}
        :param type: Whether this delegated permission should be considered safe for non-admin users to consent to on behalf of themselves, or whether an administrator should be required for consent to the permissions. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#type Application#type}
        :param user_consent_description: Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#user_consent_description Application#user_consent_description}
        :param user_consent_display_name: Display name for the delegated permission that appears in the end user consent experience. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#user_consent_display_name Application#user_consent_display_name}
        :param value: The value that is used for the ``scp`` claim in OAuth 2.0 access tokens. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#value Application#value}
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "id": id,
        }
...
class ApplicationAppRole:
    def __init__(
        ...
        *,
        ...
        '''
        :param allowed_member_types: Specifies whether this app role definition can be assigned to users and groups by setting to ``User``, or to other applications (that are accessing this application in a standalone scenario) by setting to ``Application``, or to both. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#allowed_member_types Application#allowed_member_types}
        :param description: Description of the app role that appears when the role is being assigned and, if the role functions as an application permissions, during the consent experiences. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#description Application#description}
        :param display_name: Display name for the app role that appears during app role assignment and in consent experiences. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#display_name Application#display_name}
        :param id: The unique identifier of the app role. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#id Application#id}
        :param enabled: Determines if the app role is enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#enabled Application#enabled}
        :param value: The value that is used for the ``roles`` claim in ID tokens and OAuth 2.0 access tokens that are authenticating an assigned service or user principal. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#value Application#value}
        '''
        self._values: typing.Dict[str, typing.Any] = {
...
class ApplicationCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["ApplicationCertificateTimeouts"] = None,
        type: typing.Optional[builtins.str] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param application_object_id: The object ID of the application for which this certificate should be created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#application_object_id ApplicationCertificate#application_object_id}
        :param value: The certificate data, which can be PEM encoded, base64 encoded DER or hexadecimal encoded DER. See also the ``encoding`` argumen Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#value ApplicationCertificate#value}
        :param encoding: Specifies the encoding used for the supplied certificate data. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#encoding ApplicationCertificate#encoding}
        :param end_date: The end date until which the certificate is valid, formatted as an RFC3339 date string (e.g. ``2018-01-01T01:02:03Z``). If omitted, the API will decide a suitable expiry date, which is typically around 2 years from the start date. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#end_date ApplicationCertificate#end_date}
        :param end_date_relative: A relative duration for which the certificate is valid until, for example ``240h`` (10 days) or ``2400h30m``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#end_date_relative ApplicationCertificate#end_date_relative}
        :param key_id: A UUID used to uniquely identify this certificate. If omitted, a random UUID will be automatically generated. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#key_id ApplicationCertificate#key_id}
        :param start_date: The start date from which the certificate is valid, formatted as an RFC3339 date string (e.g. ``2018-01-01T01:02:03Z``). If this isn't specified, the current date and time are use. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#start_date ApplicationCertificate#start_date}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#timeouts ApplicationCertificate#timeouts}
        :param type: The type of key/certificate. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#type ApplicationCertificate#type}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def application_object_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "applicationObjectIdInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ApplicationCertificateTimeouts"]:
        return typing.cast(typing.Optional["ApplicationCertificateTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ApplicationCertificateTimeouts":
        return typing.cast("ApplicationCertificateTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ApplicationCertificateTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class ApplicationCertificateTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#create ApplicationCertificate#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#delete ApplicationCertificate#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#read ApplicationCertificate#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_certificate.html#update ApplicationCertificate#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class ApplicationConfig(cdktf.TerraformMetaArguments):
    ...
    @builtins.property
    def api(self) -> typing.Optional[typing.List[ApplicationApi]]:
        '''api block.
        ...
        return typing.cast(typing.Optional[typing.List[ApplicationApi]], result)

    @builtins.property
    def app_role(self) -> typing.Optional[typing.List[ApplicationAppRole]]:
        '''app_role block.
        ...
        return typing.cast(typing.Optional[typing.List[ApplicationAppRole]], result)
    ...
    @builtins.property
    def feature_tags(self) -> typing.Optional[typing.List["ApplicationFeatureTags"]]:
        '''feature_tags block.
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationFeatureTags"]], result)
    ...
    def optional_claims(
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationOptionalClaims"]], result)
    ...
    @builtins.property
    def public_client(self) -> typing.Optional[typing.List["ApplicationPublicClient"]]:
        '''public_client block.
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationPublicClient"]], result)
    ...
    def required_resource_access(
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationRequiredResourceAccess"]], result)
    ...
    def single_page_application(
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationSinglePageApplication"]], result)
    ...
    @builtins.property
    def web(self) -> typing.Optional[typing.List["ApplicationWeb"]]:
        '''web block.
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationWeb"]], result)
...
class ApplicationFeatureTags:
    def __init__(
        ...
        *,
        ...
        '''
        :param custom_single_sign_on: Whether this application represents a custom SAML application for linked service principals. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#custom_single_sign_on Application#custom_single_sign_on}
        :param enterprise: Whether this application represents an Enterprise Application for linked service principals. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#enterprise Application#enterprise}
        :param gallery: Whether this application represents a gallery application for linked service principals. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#gallery Application#gallery}
        :param hide: Whether this application is invisible to users in My Apps and Office 365 Launcher. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#hide Application#hide}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class ApplicationOptionalClaims:
    def __init__(
        self,
        *,
        access_token: typing.Optional[typing.Sequence["ApplicationOptionalClaimsAccessToken"]] = None,
        id_token: typing.Optional[typing.Sequence["ApplicationOptionalClaimsIdToken"]] = None,
        saml2_token: typing.Optional[typing.Sequence["ApplicationOptionalClaimsSaml2Token"]] = None,
    ) -> None:
        '''
        :param access_token: access_token block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#access_token Application#access_token}
        :param id_token: id_token block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#id_token Application#id_token}
        :param saml2_token: saml2_token block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#saml2_token Application#saml2_token}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
    ...
    def access_token(
        self,
    ) -> typing.Optional[typing.List["ApplicationOptionalClaimsAccessToken"]]:
        '''access_token block.
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationOptionalClaimsAccessToken"]], result)

    @builtins.property
    def id_token(
        self,
    ) -> typing.Optional[typing.List["ApplicationOptionalClaimsIdToken"]]:
        '''id_token block.
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationOptionalClaimsIdToken"]], result)

    @builtins.property
    def saml2_token(
        self,
    ) -> typing.Optional[typing.List["ApplicationOptionalClaimsSaml2Token"]]:
        '''saml2_token block.
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationOptionalClaimsSaml2Token"]], result)
...
class ApplicationOptionalClaimsAccessToken:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: The name of the optional claim. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#name Application#name}
        :param additional_properties: List of additional properties of the claim. If a property exists in this list, it modifies the behaviour of the optional claim Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#additional_properties Application#additional_properties}
        :param essential: Whether the claim specified by the client is necessary to ensure a smooth authorization experience. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#essential Application#essential}
        :param source: The source of the claim. If ``source`` is absent, the claim is a predefined optional claim. If ``source`` is ``user``, the value of ``name`` is the extension property from the user object Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#source Application#source}
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "name": name,
        }
...
class ApplicationPassword(
    ...
    def __init__(
        ...
        *,
        ...
        end_date: typing.Optional[builtins.str] = None,
        end_date_relative: typing.Optional[builtins.str] = None,
        rotate_when_changed: typing.Optional[typing.Union[cdktf.IResolvable, typing.Mapping[builtins.str, builtins.str]]] = None,
        start_date: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional["ApplicationPasswordTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param application_object_id: The object ID of the application for which this password should be created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#application_object_id ApplicationPassword#application_object_id}
        :param display_name: A display name for the password. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#display_name ApplicationPassword#display_name}
        :param end_date: The end date until which the password is valid, formatted as an RFC3339 date string (e.g. ``2018-01-01T01:02:03Z``). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#end_date ApplicationPassword#end_date}
        :param end_date_relative: A relative duration for which the password is valid until, for example ``240h`` (10 days) or ``2400h30m``. Changing this field forces a new resource to be created Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#end_date_relative ApplicationPassword#end_date_relative}
        :param rotate_when_changed: Arbitrary map of values that, when changed, will trigger rotation of the password. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#rotate_when_changed ApplicationPassword#rotate_when_changed}
        :param start_date: The start date from which the password is valid, formatted as an RFC3339 date string (e.g. ``2018-01-01T01:02:03Z``). If this isn't specified, the current date is used. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#start_date ApplicationPassword#start_date}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#timeouts ApplicationPassword#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def rotate_when_changed_input(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.Mapping[builtins.str, builtins.str]]], jsii.get(self, "rotateWhenChangedInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ApplicationPasswordTimeouts"]:
        return typing.cast(typing.Optional["ApplicationPasswordTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    def rotate_when_changed(
        ...
        return typing.cast(typing.Union[cdktf.IResolvable, typing.Mapping[builtins.str, builtins.str]], jsii.get(self, "rotateWhenChanged"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ApplicationPasswordTimeouts":
        return typing.cast("ApplicationPasswordTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ApplicationPasswordTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class ApplicationPasswordTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#create ApplicationPassword#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#delete ApplicationPassword#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#read ApplicationPassword#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_password.html#update ApplicationPassword#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class ApplicationPreAuthorized(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["ApplicationPreAuthorizedTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param application_object_id: The object ID of the application to which this pre-authorized application should be added. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#application_object_id ApplicationPreAuthorized#application_object_id}
        :param authorized_app_id: The application ID of the pre-authorized application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#authorized_app_id ApplicationPreAuthorized#authorized_app_id}
        :param permission_ids: The IDs of the permission scopes required by the pre-authorized application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#permission_ids ApplicationPreAuthorized#permission_ids}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#timeouts ApplicationPreAuthorized#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def authorized_app_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "authorizedAppIdInput"))
    ...
    def permission_ids_input(self) -> typing.List[builtins.str]:
        return typing.cast(typing.List[builtins.str], jsii.get(self, "permissionIdsInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ApplicationPreAuthorizedTimeouts"]:
        return typing.cast(typing.Optional["ApplicationPreAuthorizedTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ApplicationPreAuthorizedTimeouts":
        return typing.cast("ApplicationPreAuthorizedTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ApplicationPreAuthorizedTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class ApplicationPreAuthorizedTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#create ApplicationPreAuthorized#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#delete ApplicationPreAuthorized#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#read ApplicationPreAuthorized#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application_pre_authorized.html#update ApplicationPreAuthorized#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class ApplicationPublicClient:
    def __init__(
        ...
        *,
        ...
        '''
        :param redirect_uris: The URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#redirect_uris Application#redirect_uris}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class ApplicationRequiredResourceAccess:
    def __init__(
        self,
        *,
        resource_access: typing.Sequence["ApplicationRequiredResourceAccessResourceAccess"],
        resource_app_id: builtins.str,
    ) -> None:
        '''
        :param resource_access: resource_access block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#resource_access Application#resource_access}
        :param resource_app_id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#resource_app_id Application#resource_app_id}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
    ...
    def resource_access(
        self,
    ) -> typing.List["ApplicationRequiredResourceAccessResourceAccess"]:
        ...
        return typing.cast(typing.List["ApplicationRequiredResourceAccessResourceAccess"], result)
...
class ApplicationRequiredResourceAccessResourceAccess:
    def __init__(self, *, id: builtins.str, type: builtins.str) -> None:
        '''
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#id Application#id}.
        :param type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#type Application#type}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "id": id,
            "type": type,
...
class ApplicationTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#create Application#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#delete Application#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#read Application#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#update Application#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class ApplicationWeb:
    def __init__(
        ...
        *,
        ...
        implicit_grant: typing.Optional[typing.Sequence["ApplicationWebImplicitGrant"]] = None,
        logout_url: typing.Optional[builtins.str] = None,
        redirect_uris: typing.Optional[typing.Sequence[builtins.str]] = None,
    ) -> None:
        '''
        :param homepage_url: Home page or landing page of the application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#homepage_url Application#homepage_url}
        :param implicit_grant: implicit_grant block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#implicit_grant Application#implicit_grant}
        :param logout_url: The URL that will be used by Microsoft's authorization service to sign out a user using front-channel, back-channel or SAML logout protocols. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#logout_url Application#logout_url}
        :param redirect_uris: The URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#redirect_uris Application#redirect_uris}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
    ...
    def implicit_grant(
        self,
    ) -> typing.Optional[typing.List["ApplicationWebImplicitGrant"]]:
        ...
        return typing.cast(typing.Optional[typing.List["ApplicationWebImplicitGrant"]], result)
...
class ApplicationWebImplicitGrant:
    def __init__(
        ...
        *,
        ...
        '''
        :param access_token_issuance_enabled: Whether this web application can request an access token using OAuth 2.0 implicit flow. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#access_token_issuance_enabled Application#access_token_issuance_enabled}
        :param id_token_issuance_enabled: Whether this web application can request an ID token using OAuth 2.0 implicit flow. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/application.html#id_token_issuance_enabled Application#id_token_issuance_enabled}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class AzureadProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param environment: The cloud environment which should be used. Possible values are: ``global`` (also ``public``), ``usgovernmentl4`` (also ``usgovernment``), ``usgovernmentl5`` (also ``dod``), ``germany`` (also ``german``), and ``china``. Defaults to ``global`` Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread#environment AzureadProvider#environment}
...
class ConditionalAccessPolicy(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        conditions: typing.Sequence["ConditionalAccessPolicyConditions"],
        display_name: builtins.str,
        grant_controls: typing.Sequence["ConditionalAccessPolicyGrantControls"],
        state: builtins.str,
        session_controls: typing.Optional[typing.Sequence["ConditionalAccessPolicySessionControls"]] = None,
        timeouts: typing.Optional["ConditionalAccessPolicyTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param conditions: conditions block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#conditions ConditionalAccessPolicy#conditions}
        :param display_name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#display_name ConditionalAccessPolicy#display_name}.
        :param grant_controls: grant_controls block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#grant_controls ConditionalAccessPolicy#grant_controls}
        :param state: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#state ConditionalAccessPolicy#state}.
        :param session_controls: session_controls block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#session_controls ConditionalAccessPolicy#session_controls}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#timeouts ConditionalAccessPolicy#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def conditions_input(self) -> typing.List["ConditionalAccessPolicyConditions"]:
        return typing.cast(typing.List["ConditionalAccessPolicyConditions"], jsii.get(self, "conditionsInput"))
    ...
    def grant_controls_input(
        self,
    ) -> typing.List["ConditionalAccessPolicyGrantControls"]:
        return typing.cast(typing.List["ConditionalAccessPolicyGrantControls"], jsii.get(self, "grantControlsInput"))
    ...
    def state_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "stateInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="sessionControlsInput")
    def session_controls_input(
        self,
    ) -> typing.Optional[typing.List["ConditionalAccessPolicySessionControls"]]:
        return typing.cast(typing.Optional[typing.List["ConditionalAccessPolicySessionControls"]], jsii.get(self, "sessionControlsInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ConditionalAccessPolicyTimeouts"]:
        return typing.cast(typing.Optional["ConditionalAccessPolicyTimeouts"], jsii.get(self, "timeoutsInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="conditions")
    def conditions(self) -> typing.List["ConditionalAccessPolicyConditions"]:
        return typing.cast(typing.List["ConditionalAccessPolicyConditions"], jsii.get(self, "conditions"))

    @conditions.setter
    def conditions(
        self,
        value: typing.List["ConditionalAccessPolicyConditions"],
    ) -> None:
    ...
    def grant_controls(self) -> typing.List["ConditionalAccessPolicyGrantControls"]:
        return typing.cast(typing.List["ConditionalAccessPolicyGrantControls"], jsii.get(self, "grantControls"))

    @grant_controls.setter
    def grant_controls(
        self,
        value: typing.List["ConditionalAccessPolicyGrantControls"],
    ) -> None:
        jsii.set(self, "grantControls", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="sessionControls")
    def session_controls(self) -> typing.List["ConditionalAccessPolicySessionControls"]:
        return typing.cast(typing.List["ConditionalAccessPolicySessionControls"], jsii.get(self, "sessionControls"))

    @session_controls.setter
    def session_controls(
        self,
        value: typing.List["ConditionalAccessPolicySessionControls"],
    ) -> None:
        jsii.set(self, "sessionControls", value)
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ConditionalAccessPolicyTimeouts":
        return typing.cast("ConditionalAccessPolicyTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ConditionalAccessPolicyTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class ConditionalAccessPolicyConditions:
    def __init__(
        self,
        *,
        applications: typing.Sequence["ConditionalAccessPolicyConditionsApplications"],
        client_app_types: typing.Sequence[builtins.str],
        locations: typing.Sequence["ConditionalAccessPolicyConditionsLocations"],
        platforms: typing.Sequence["ConditionalAccessPolicyConditionsPlatforms"],
        users: typing.Sequence["ConditionalAccessPolicyConditionsUsers"],
        ...
        '''
        :param applications: applications block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#applications ConditionalAccessPolicy#applications}
        :param client_app_types: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#client_app_types ConditionalAccessPolicy#client_app_types}.
        :param locations: locations block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#locations ConditionalAccessPolicy#locations}
        :param platforms: platforms block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#platforms ConditionalAccessPolicy#platforms}
        :param users: users block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#users ConditionalAccessPolicy#users}
        :param sign_in_risk_levels: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#sign_in_risk_levels ConditionalAccessPolicy#sign_in_risk_levels}.
        :param user_risk_levels: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#user_risk_levels ConditionalAccessPolicy#user_risk_levels}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "applications": applications,
    ...
    def applications(
        self,
    ) -> typing.List["ConditionalAccessPolicyConditionsApplications"]:
        '''applications block.
        ...
        return typing.cast(typing.List["ConditionalAccessPolicyConditionsApplications"], result)
    ...
    @builtins.property
    def locations(self) -> typing.List["ConditionalAccessPolicyConditionsLocations"]:
        '''locations block.
        ...
        return typing.cast(typing.List["ConditionalAccessPolicyConditionsLocations"], result)

    @builtins.property
    def platforms(self) -> typing.List["ConditionalAccessPolicyConditionsPlatforms"]:
        '''platforms block.
        ...
        return typing.cast(typing.List["ConditionalAccessPolicyConditionsPlatforms"], result)

    @builtins.property
    def users(self) -> typing.List["ConditionalAccessPolicyConditionsUsers"]:
        '''users block.
        ...
        return typing.cast(typing.List["ConditionalAccessPolicyConditionsUsers"], result)
...
class ConditionalAccessPolicyConditionsApplications:
    def __init__(
        self,
        *,
        included_applications: typing.Sequence[builtins.str],
        ...
        '''
        :param included_applications: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#included_applications ConditionalAccessPolicy#included_applications}.
        :param excluded_applications: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#excluded_applications ConditionalAccessPolicy#excluded_applications}.
        :param included_user_actions: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#included_user_actions ConditionalAccessPolicy#included_user_actions}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
    ...
    def included_applications(self) -> typing.List[builtins.str]:
        ...
        assert result is not None, "Required property 'included_applications' is missing"
        return typing.cast(typing.List[builtins.str], result)
...
class ConditionalAccessPolicyConditionsLocations:
    def __init__(
        ...
        *,
        ...
        '''
        :param included_locations: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#included_locations ConditionalAccessPolicy#included_locations}.
        :param excluded_locations: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#excluded_locations ConditionalAccessPolicy#excluded_locations}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
...
class ConditionalAccessPolicyConditionsPlatforms:
    def __init__(
        ...
        *,
        ...
        '''
        :param included_platforms: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#included_platforms ConditionalAccessPolicy#included_platforms}.
        :param excluded_platforms: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#excluded_platforms ConditionalAccessPolicy#excluded_platforms}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
...
class ConditionalAccessPolicyConditionsUsers:
    def __init__(
        ...
        *,
        ...
        '''
        :param excluded_groups: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#excluded_groups ConditionalAccessPolicy#excluded_groups}.
        :param excluded_roles: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#excluded_roles ConditionalAccessPolicy#excluded_roles}.
        :param excluded_users: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#excluded_users ConditionalAccessPolicy#excluded_users}.
        :param included_groups: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#included_groups ConditionalAccessPolicy#included_groups}.
        :param included_roles: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#included_roles ConditionalAccessPolicy#included_roles}.
        :param included_users: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#included_users ConditionalAccessPolicy#included_users}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class ConditionalAccessPolicyConfig(cdktf.TerraformMetaArguments):
    ...
    def conditions(self) -> typing.List[ConditionalAccessPolicyConditions]:
        ...
        return typing.cast(typing.List[ConditionalAccessPolicyConditions], result)
    ...
    def grant_controls(self) -> typing.List["ConditionalAccessPolicyGrantControls"]:
        ...
        return typing.cast(typing.List["ConditionalAccessPolicyGrantControls"], result)
    ...
    def session_controls(
        ...
        return typing.cast(typing.Optional[typing.List["ConditionalAccessPolicySessionControls"]], result)
...
class ConditionalAccessPolicyGrantControls:
    def __init__(
        ...
        *,
        ...
        '''
        :param built_in_controls: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#built_in_controls ConditionalAccessPolicy#built_in_controls}.
        :param operator: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#operator ConditionalAccessPolicy#operator}.
        :param custom_authentication_factors: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#custom_authentication_factors ConditionalAccessPolicy#custom_authentication_factors}.
        :param terms_of_use: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#terms_of_use ConditionalAccessPolicy#terms_of_use}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
...
class ConditionalAccessPolicySessionControls:
    def __init__(
        ...
        *,
        ...
        '''
        :param application_enforced_restrictions_enabled: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#application_enforced_restrictions_enabled ConditionalAccessPolicy#application_enforced_restrictions_enabled}.
        :param cloud_app_security_policy: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#cloud_app_security_policy ConditionalAccessPolicy#cloud_app_security_policy}.
        :param sign_in_frequency: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#sign_in_frequency ConditionalAccessPolicy#sign_in_frequency}.
        :param sign_in_frequency_period: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#sign_in_frequency_period ConditionalAccessPolicy#sign_in_frequency_period}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class ConditionalAccessPolicyTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#create ConditionalAccessPolicy#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#delete ConditionalAccessPolicy#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#read ConditionalAccessPolicy#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/conditional_access_policy.html#update ConditionalAccessPolicy#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class DataAzureadApplication(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["DataAzureadApplicationTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param application_id: The Application ID (also called Client ID). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application.html#application_id DataAzureadApplication#application_id}
        :param display_name: The display name for the application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application.html#display_name DataAzureadApplication#display_name}
        :param object_id: The application's object ID. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application.html#object_id DataAzureadApplication#object_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application.html#timeouts DataAzureadApplication#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @jsii.member(jsii_name="api")
    def api(self, index: builtins.str) -> "DataAzureadApplicationApi":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationApi", jsii.invoke(self, "api", [index]))
    ...
    def app_roles(self, index: builtins.str) -> "DataAzureadApplicationAppRoles":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationAppRoles", jsii.invoke(self, "appRoles", [index]))

    @jsii.member(jsii_name="featureTags")
    def feature_tags(self, index: builtins.str) -> "DataAzureadApplicationFeatureTags":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationFeatureTags", jsii.invoke(self, "featureTags", [index]))
    ...
    def optional_claims(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationOptionalClaims", jsii.invoke(self, "optionalClaims", [index]))
    ...
    def public_client(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationPublicClient", jsii.invoke(self, "publicClient", [index]))
    ...
    def required_resource_access(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationRequiredResourceAccess", jsii.invoke(self, "requiredResourceAccess", [index]))
    ...
    def single_page_application(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationSinglePageApplication", jsii.invoke(self, "singlePageApplication", [index]))
    ...
    @jsii.member(jsii_name="web")
    def web(self, index: builtins.str) -> "DataAzureadApplicationWeb":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadApplicationWeb", jsii.invoke(self, "web", [index]))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadApplicationTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadApplicationTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadApplicationTimeouts":
        return typing.cast("DataAzureadApplicationTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadApplicationTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadApplicationApi(
    ...
    def mapped_claims_enabled(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "mappedClaimsEnabled"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="oauth2PermissionScopes")
    def oauth2_permission_scopes(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "oauth2PermissionScopes"))
...
class DataAzureadApplicationFeatureTags(
    ...
    def custom_single_sign_on(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "customSingleSignOn"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="enterprise")
    def enterprise(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "enterprise"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="gallery")
    def gallery(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "gallery"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="hide")
    def hide(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "hide"))
...
class DataAzureadApplicationOptionalClaims(
    ...
    def access_token(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "accessToken"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="idToken")
    def id_token(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "idToken"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="saml2Token")
    def saml2_token(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "saml2Token"))
...
class DataAzureadApplicationOptionalClaimsAccessToken(
    ...
    def essential(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "essential"))
...
class DataAzureadApplicationPublishedAppIds(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        timeouts: typing.Optional["DataAzureadApplicationPublishedAppIdsTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application_published_app_ids.html#timeouts DataAzureadApplicationPublishedAppIds#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def timeouts_input(
        ...
        return typing.cast(typing.Optional["DataAzureadApplicationPublishedAppIdsTimeouts"], jsii.get(self, "timeoutsInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadApplicationPublishedAppIdsTimeouts":
        return typing.cast("DataAzureadApplicationPublishedAppIdsTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadApplicationPublishedAppIdsTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadApplicationPublishedAppIdsTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application_published_app_ids.html#read DataAzureadApplicationPublishedAppIds#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadApplicationRequiredResourceAccess(
    ...
    def resource_access(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "resourceAccess"))
...
class DataAzureadApplicationTemplate(
    ...
    def __init__(
        ...
        *,
        display_name: typing.Optional[builtins.str] = None,
        template_id: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional["DataAzureadApplicationTemplateTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_name: The display name for the application template. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application_template.html#display_name DataAzureadApplicationTemplate#display_name}
        :param template_id: The application template's ID. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application_template.html#template_id DataAzureadApplicationTemplate#template_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application_template.html#timeouts DataAzureadApplicationTemplate#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional["DataAzureadApplicationTemplateTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadApplicationTemplateTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadApplicationTemplateTimeouts":
        return typing.cast("DataAzureadApplicationTemplateTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadApplicationTemplateTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadApplicationTemplateTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application_template.html#read DataAzureadApplicationTemplate#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadApplicationTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/application.html#read DataAzureadApplication#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadApplicationWeb(
    ...
    def implicit_grant(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "implicitGrant"))
...
class DataAzureadApplicationWebImplicitGrant(
    ...
    def access_token_issuance_enabled(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "accessTokenIssuanceEnabled"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="idTokenIssuanceEnabled")
    def id_token_issuance_enabled(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "idTokenIssuanceEnabled"))
...
class DataAzureadClientConfig(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        timeouts: typing.Optional["DataAzureadClientConfigTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/client_config.html#timeouts DataAzureadClientConfig#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadClientConfigTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadClientConfigTimeouts"], jsii.get(self, "timeoutsInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadClientConfigTimeouts":
        return typing.cast("DataAzureadClientConfigTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadClientConfigTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadClientConfigTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/client_config.html#read DataAzureadClientConfig#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadDomains(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["DataAzureadDomainsTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param admin_managed: Set to ``true`` to only return domains whose DNS is managed by Microsoft 365. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#admin_managed DataAzureadDomains#admin_managed}
        :param include_unverified: Set to ``true`` if unverified Azure AD domains should be included. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#include_unverified DataAzureadDomains#include_unverified}
        :param only_default: Set to ``true`` to only return the default domain. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#only_default DataAzureadDomains#only_default}
        :param only_initial: Set to ``true`` to only return the initial domain, which is your primary Azure Active Directory tenant domain. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#only_initial DataAzureadDomains#only_initial}
        :param only_root: Set to ``true`` to only return verified root domains. Excludes subdomains and unverified domains. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#only_root DataAzureadDomains#only_root}
        :param supports_services: A list of supported services that must be supported by a domain. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#supports_services DataAzureadDomains#supports_services}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#timeouts DataAzureadDomains#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def domains(self, index: builtins.str) -> "DataAzureadDomainsDomains":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadDomainsDomains", jsii.invoke(self, "domains", [index]))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadDomainsTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadDomainsTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadDomainsTimeouts":
        return typing.cast("DataAzureadDomainsTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadDomainsTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadDomainsDomains(
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="adminManaged")
    def admin_managed(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "adminManaged"))
    ...
    def initial(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "initial"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="root")
    def root(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "root"))
    ...
    def verified(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "verified"))
...
class DataAzureadDomainsTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/domains.html#read DataAzureadDomains#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadGroup(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["DataAzureadGroupTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_name: The display name for the group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/group.html#display_name DataAzureadGroup#display_name}
        :param mail_enabled: Whether the group is mail-enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/group.html#mail_enabled DataAzureadGroup#mail_enabled}
        :param object_id: The object ID of the group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/group.html#object_id DataAzureadGroup#object_id}
        :param security_enabled: Whether the group is a security group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/group.html#security_enabled DataAzureadGroup#security_enabled}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/group.html#timeouts DataAzureadGroup#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadGroupTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadGroupTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadGroupTimeouts":
        return typing.cast("DataAzureadGroupTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadGroupTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadGroupTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/group.html#read DataAzureadGroup#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadGroups(
    ...
    def __init__(
        ...
        *,
        ...
        security_enabled: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        timeouts: typing.Optional["DataAzureadGroupsTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_names: The display names of the groups. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/groups.html#display_names DataAzureadGroups#display_names}
        :param mail_enabled: Whether the groups are mail-enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/groups.html#mail_enabled DataAzureadGroups#mail_enabled}
        :param object_ids: The object IDs of the groups. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/groups.html#object_ids DataAzureadGroups#object_ids}
        :param return_all: Retrieve all groups with no filter. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/groups.html#return_all DataAzureadGroups#return_all}
        :param security_enabled: Whether the groups are security-enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/groups.html#security_enabled DataAzureadGroups#security_enabled}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/groups.html#timeouts DataAzureadGroups#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadGroupsTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadGroupsTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadGroupsTimeouts":
        return typing.cast("DataAzureadGroupsTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadGroupsTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadGroupsTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/groups.html#read DataAzureadGroups#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadServicePrincipal(
    ...
    def __init__(
        ...
        *,
        ...
        display_name: typing.Optional[builtins.str] = None,
        object_id: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional["DataAzureadServicePrincipalTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param application_id: The application ID (client ID) of the application associated with this service principal. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principal.html#application_id DataAzureadServicePrincipal#application_id}
        :param display_name: The display name of the application associated with this service principal. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principal.html#display_name DataAzureadServicePrincipal#display_name}
        :param object_id: The object ID of the service principal. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principal.html#object_id DataAzureadServicePrincipal#object_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principal.html#timeouts DataAzureadServicePrincipal#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @jsii.member(jsii_name="appRoles")
    def app_roles(self, index: builtins.str) -> "DataAzureadServicePrincipalAppRoles":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadServicePrincipalAppRoles", jsii.invoke(self, "appRoles", [index]))

    @jsii.member(jsii_name="features")
    def features(self, index: builtins.str) -> "DataAzureadServicePrincipalFeatures":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadServicePrincipalFeatures", jsii.invoke(self, "features", [index]))
    ...
    def feature_tags(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadServicePrincipalFeatureTags", jsii.invoke(self, "featureTags", [index]))
    ...
    def oauth2_permission_scopes(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadServicePrincipalOauth2PermissionScopes", jsii.invoke(self, "oauth2PermissionScopes", [index]))
    ...
    def saml_single_sign_on(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadServicePrincipalSamlSingleSignOn", jsii.invoke(self, "samlSingleSignOn", [index]))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadServicePrincipalTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadServicePrincipalTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadServicePrincipalTimeouts":
        return typing.cast("DataAzureadServicePrincipalTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadServicePrincipalTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadServicePrincipalFeatures(
    ...
    def custom_single_sign_on_app(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "customSingleSignOnApp"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="enterpriseApplication")
    def enterprise_application(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "enterpriseApplication"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="galleryApplication")
    def gallery_application(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "galleryApplication"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="visibleToUsers")
    def visible_to_users(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "visibleToUsers"))
...
class DataAzureadServicePrincipalTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principal.html#read DataAzureadServicePrincipal#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadServicePrincipals(
    ...
    def __init__(
        ...
        *,
        ...
        object_ids: typing.Optional[typing.Sequence[builtins.str]] = None,
        return_all: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        timeouts: typing.Optional["DataAzureadServicePrincipalsTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param application_ids: The application IDs (client IDs) of the applications associated with the service principals. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principals.html#application_ids DataAzureadServicePrincipals#application_ids}
        :param display_names: The display names of the applications associated with the service principals. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principals.html#display_names DataAzureadServicePrincipals#display_names}
        :param ignore_missing: Ignore missing service principals and return the service principals that were found. The data source will still fail if no service principals are found Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principals.html#ignore_missing DataAzureadServicePrincipals#ignore_missing}
        :param object_ids: The object IDs of the service principals. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principals.html#object_ids DataAzureadServicePrincipals#object_ids}
        :param return_all: Fetch all service principals with no filter and return all that were found. The data source will still fail if no service principals are found. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principals.html#return_all DataAzureadServicePrincipals#return_all}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principals.html#timeouts DataAzureadServicePrincipals#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def service_principals(
        ...
        :param index: -
        '''
        return typing.cast("DataAzureadServicePrincipalsServicePrincipals", jsii.invoke(self, "servicePrincipals", [index]))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadServicePrincipalsTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadServicePrincipalsTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadServicePrincipalsTimeouts":
        return typing.cast("DataAzureadServicePrincipalsTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadServicePrincipalsTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadServicePrincipalsServicePrincipals(
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="accountEnabled")
    def account_enabled(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "accountEnabled"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="appRoleAssignmentRequired")
    def app_role_assignment_required(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.get(self, "appRoleAssignmentRequired"))
...
class DataAzureadServicePrincipalsTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/service_principals.html#read DataAzureadServicePrincipals#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadUser(
    ...
    def __init__(
        ...
        *,
        ...
        object_id: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional["DataAzureadUserTimeouts"] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param mail_nickname: The email alias of the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/user.html#mail_nickname DataAzureadUser#mail_nickname}
        :param object_id: The object ID of the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/user.html#object_id DataAzureadUser#object_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/user.html#timeouts DataAzureadUser#timeouts}
        :param user_principal_name: The user principal name (UPN) of the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/user.html#user_principal_name DataAzureadUser#user_principal_name}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadUserTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadUserTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadUserTimeouts":
        return typing.cast("DataAzureadUserTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadUserTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadUserTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/user.html#read DataAzureadUser#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DataAzureadUsers(
    ...
    def __init__(
        ...
        *,
        ...
        object_ids: typing.Optional[typing.Sequence[builtins.str]] = None,
        return_all: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        timeouts: typing.Optional["DataAzureadUsersTimeouts"] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param ignore_missing: Ignore missing users and return users that were found. The data source will still fail if no users are found Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/users.html#ignore_missing DataAzureadUsers#ignore_missing}
        :param mail_nicknames: The email aliases of the users. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/users.html#mail_nicknames DataAzureadUsers#mail_nicknames}
        :param object_ids: The object IDs of the users. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/users.html#object_ids DataAzureadUsers#object_ids}
        :param return_all: Fetch all users with no filter and return all that were found. The data source will still fail if no users are found. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/users.html#return_all DataAzureadUsers#return_all}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/users.html#timeouts DataAzureadUsers#timeouts}
        :param user_principal_names: The user principal names (UPNs) of the users. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/users.html#user_principal_names DataAzureadUsers#user_principal_names}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def users(self, index: builtins.str) -> "DataAzureadUsersUsers":
        '''
        :param index: -
        '''
        return typing.cast("DataAzureadUsersUsers", jsii.invoke(self, "users", [index]))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DataAzureadUsersTimeouts"]:
        return typing.cast(typing.Optional["DataAzureadUsersTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DataAzureadUsersTimeouts":
        return typing.cast("DataAzureadUsersTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DataAzureadUsersTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DataAzureadUsersTimeouts:
    def __init__(self, *, read: typing.Optional[builtins.str] = None) -> None:
        '''
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/d/users.html#read DataAzureadUsers#read}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if read is not None:
            self._values["read"] = read
...
class DirectoryRole(
    ...
    def __init__(
        ...
        *,
        display_name: typing.Optional[builtins.str] = None,
        template_id: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional["DirectoryRoleTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_name: The display name of the directory role. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role.html#display_name DirectoryRole#display_name}
        :param template_id: The object ID of the template associated with the directory role. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role.html#template_id DirectoryRole#template_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role.html#timeouts DirectoryRole#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DirectoryRoleTimeouts"]:
        return typing.cast(typing.Optional["DirectoryRoleTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DirectoryRoleTimeouts":
        return typing.cast("DirectoryRoleTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DirectoryRoleTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DirectoryRoleMember(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["DirectoryRoleMemberTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param member_object_id: The object ID of the member. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role_member.html#member_object_id DirectoryRoleMember#member_object_id}
        :param role_object_id: The object ID of the directory role. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role_member.html#role_object_id DirectoryRoleMember#role_object_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role_member.html#timeouts DirectoryRoleMember#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["DirectoryRoleMemberTimeouts"]:
        return typing.cast(typing.Optional["DirectoryRoleMemberTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "DirectoryRoleMemberTimeouts":
        return typing.cast("DirectoryRoleMemberTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "DirectoryRoleMemberTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class DirectoryRoleMemberTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role_member.html#create DirectoryRoleMember#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role_member.html#delete DirectoryRoleMember#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role_member.html#read DirectoryRoleMember#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role_member.html#update DirectoryRoleMember#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class DirectoryRoleTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role.html#create DirectoryRole#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role.html#delete DirectoryRole#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role.html#read DirectoryRole#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/directory_role.html#update DirectoryRole#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class Group(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["GroupTimeouts"] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_name: The display name for the group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#display_name Group#display_name}
        :param assignable_to_role: Indicates whether this group can be assigned to an Azure Active Directory role. This property can only be ``true`` for security-enabled groups. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#assignable_to_role Group#assignable_to_role}
        :param behaviors: The group behaviours for a Microsoft 365 group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#behaviors Group#behaviors}
        :param description: The description for the group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#description Group#description}
        :param mail_enabled: Whether the group is a mail enabled, with a shared group mailbox. At least one of ``mail_enabled`` or ``security_enabled`` must be specified. A group can be mail enabled *and* security enabled Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#mail_enabled Group#mail_enabled}
        :param mail_nickname: The mail alias for the group, unique in the organisation. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#mail_nickname Group#mail_nickname}
        :param members: A set of members who should be present in this group. Supported object types are Users, Groups or Service Principals Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#members Group#members}
        :param owners: A set of owners who own this group. Supported object types are Users or Service Principals. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#owners Group#owners}
        :param prevent_duplicate_names: If ``true``, will return an error if an existing group is found with the same name. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#prevent_duplicate_names Group#prevent_duplicate_names}
        :param provisioning_options: The group provisioning options for a Microsoft 365 group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#provisioning_options Group#provisioning_options}
        :param security_enabled: Whether the group is a security group for controlling access to in-app resources. At least one of ``security_enabled`` or ``mail_enabled`` must be specified. A group can be security enabled *and* mail enabled Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#security_enabled Group#security_enabled}
        :param theme: The colour theme for a Microsoft 365 group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#theme Group#theme}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#timeouts Group#timeouts}
        :param types: A set of group types to configure for the group. The only supported type is ``Unified``, which specifies a Microsoft 365 group. Required when ``mail_enabled`` is true Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#types Group#types}
        :param visibility: Specifies the group join policy and group content visibility. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#visibility Group#visibility}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["GroupTimeouts"]:
        return typing.cast(typing.Optional["GroupTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "GroupTimeouts":
        return typing.cast("GroupTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "GroupTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class GroupMember(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["GroupMemberTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param group_object_id: The object ID of the group you want to add the member to. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group_member.html#group_object_id GroupMember#group_object_id}
        :param member_object_id: The object ID of the principal you want to add as a member to the group. Supported object types are Users, Groups or Service Principals Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group_member.html#member_object_id GroupMember#member_object_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group_member.html#timeouts GroupMember#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def group_object_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "groupObjectIdInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="memberObjectIdInput")
    def member_object_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "memberObjectIdInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["GroupMemberTimeouts"]:
        return typing.cast(typing.Optional["GroupMemberTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "GroupMemberTimeouts":
        return typing.cast("GroupMemberTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "GroupMemberTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class GroupMemberTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group_member.html#create GroupMember#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group_member.html#delete GroupMember#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group_member.html#read GroupMember#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group_member.html#update GroupMember#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class GroupTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#create Group#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#delete Group#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#read Group#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/group.html#update Group#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class Invitation(
    ...
    def __init__(
        ...
        *,
        ...
        message: typing.Optional[typing.Sequence["InvitationMessage"]] = None,
        timeouts: typing.Optional["InvitationTimeouts"] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param redirect_url: The URL that the user should be redirected to once the invitation is redeemed. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#redirect_url Invitation#redirect_url}
        :param user_email_address: The email address of the user being invited. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#user_email_address Invitation#user_email_address}
        :param message: message block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#message Invitation#message}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#timeouts Invitation#timeouts}
        :param user_display_name: The display name of the user being invited. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#user_display_name Invitation#user_display_name}
        :param user_type: The user type of the user being invited. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#user_type Invitation#user_type}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def redirect_url_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "redirectUrlInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="userEmailAddressInput")
    def user_email_address_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "userEmailAddressInput"))
    ...
    def message_input(self) -> typing.Optional[typing.List["InvitationMessage"]]:
        return typing.cast(typing.Optional[typing.List["InvitationMessage"]], jsii.get(self, "messageInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["InvitationTimeouts"]:
        return typing.cast(typing.Optional["InvitationTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    def message(self) -> typing.List["InvitationMessage"]:
        return typing.cast(typing.List["InvitationMessage"], jsii.get(self, "message"))

    @message.setter
    def message(self, value: typing.List["InvitationMessage"]) -> None:
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "InvitationTimeouts":
        return typing.cast("InvitationTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "InvitationTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class InvitationConfig(cdktf.TerraformMetaArguments):
    ...
    @builtins.property
    def message(self) -> typing.Optional[typing.List["InvitationMessage"]]:
        '''message block.
        ...
        return typing.cast(typing.Optional[typing.List["InvitationMessage"]], result)
...
class InvitationMessage:
    def __init__(
        ...
        *,
        ...
        '''
        :param additional_recipients: Email addresses of additional recipients the invitation message should be sent to. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#additional_recipients Invitation#additional_recipients}
        :param body: Customized message body you want to send if you don't want to send the default message. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#body Invitation#body}
        :param language: The language you want to send the default message in. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#language Invitation#language}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class InvitationTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#create Invitation#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#delete Invitation#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#read Invitation#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/invitation.html#update Invitation#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class NamedLocation(
    ...
    def __init__(
        ...
        *,
        display_name: builtins.str,
        country: typing.Optional[typing.Sequence["NamedLocationCountry"]] = None,
        ip: typing.Optional[typing.Sequence["NamedLocationIp"]] = None,
        timeouts: typing.Optional["NamedLocationTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#display_name NamedLocation#display_name}.
        :param country: country block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#country NamedLocation#country}
        :param ip: ip block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#ip NamedLocation#ip}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#timeouts NamedLocation#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def country_input(self) -> typing.Optional[typing.List["NamedLocationCountry"]]:
        return typing.cast(typing.Optional[typing.List["NamedLocationCountry"]], jsii.get(self, "countryInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="ipInput")
    def ip_input(self) -> typing.Optional[typing.List["NamedLocationIp"]]:
        return typing.cast(typing.Optional[typing.List["NamedLocationIp"]], jsii.get(self, "ipInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["NamedLocationTimeouts"]:
        return typing.cast(typing.Optional["NamedLocationTimeouts"], jsii.get(self, "timeoutsInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="country")
    def country(self) -> typing.List["NamedLocationCountry"]:
        return typing.cast(typing.List["NamedLocationCountry"], jsii.get(self, "country"))

    @country.setter
    def country(self, value: typing.List["NamedLocationCountry"]) -> None:
    ...
    def ip(self) -> typing.List["NamedLocationIp"]:
        return typing.cast(typing.List["NamedLocationIp"], jsii.get(self, "ip"))

    @ip.setter
    def ip(self, value: typing.List["NamedLocationIp"]) -> None:
        jsii.set(self, "ip", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "NamedLocationTimeouts":
        return typing.cast("NamedLocationTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "NamedLocationTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class NamedLocationConfig(cdktf.TerraformMetaArguments):
    ...
    @builtins.property
    def country(self) -> typing.Optional[typing.List["NamedLocationCountry"]]:
        '''country block.
        ...
        return typing.cast(typing.Optional[typing.List["NamedLocationCountry"]], result)

    @builtins.property
    def ip(self) -> typing.Optional[typing.List["NamedLocationIp"]]:
        '''ip block.
        ...
        return typing.cast(typing.Optional[typing.List["NamedLocationIp"]], result)
...
class NamedLocationCountry:
    def __init__(
        ...
        *,
        ...
        '''
        :param countries_and_regions: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#countries_and_regions NamedLocation#countries_and_regions}.
        :param include_unknown_countries_and_regions: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#include_unknown_countries_and_regions NamedLocation#include_unknown_countries_and_regions}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
...
class NamedLocationIp:
    def __init__(
        ...
        *,
        ...
        '''
        :param ip_ranges: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#ip_ranges NamedLocation#ip_ranges}.
        :param trusted: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#trusted NamedLocation#trusted}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "ip_ranges": ip_ranges,
        }
...
class NamedLocationTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#create NamedLocation#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#delete NamedLocation#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#read NamedLocation#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/named_location.html#update NamedLocation#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class ServicePrincipal(
    ...
    def __init__(
        ...
        *,
        ...
        description: typing.Optional[builtins.str] = None,
        features: typing.Optional[typing.Sequence["ServicePrincipalFeatures"]] = None,
        feature_tags: typing.Optional[typing.Sequence["ServicePrincipalFeatureTags"]] = None,
        ...
        saml_single_sign_on: typing.Optional[typing.Sequence["ServicePrincipalSamlSingleSignOn"]] = None,
        tags: typing.Optional[typing.Sequence[builtins.str]] = None,
        timeouts: typing.Optional["ServicePrincipalTimeouts"] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param application_id: The application ID (client ID) of the application for which to create a service principal. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#application_id ServicePrincipal#application_id}
        :param account_enabled: Whether or not the service principal account is enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#account_enabled ServicePrincipal#account_enabled}
        :param alternative_names: A list of alternative names, used to retrieve service principals by subscription, identify resource group and full resource ids for managed identities. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#alternative_names ServicePrincipal#alternative_names}
        :param app_role_assignment_required: Whether this service principal requires an app role assignment to a user or group before Azure AD will issue a user or access token to the application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#app_role_assignment_required ServicePrincipal#app_role_assignment_required}
        :param description: Description of the service principal provided for internal end-users. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#description ServicePrincipal#description}
        :param features: features block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#features ServicePrincipal#features}
        :param feature_tags: feature_tags block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#feature_tags ServicePrincipal#feature_tags}
        ...
        :param notes: Free text field to capture information about the service principal, typically used for operational purposes. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#notes ServicePrincipal#notes}
        :param notification_email_addresses: List of email addresses where Azure AD sends a notification when the active certificate is near the expiration date. This is only for the certificates used to sign the SAML token issued for Azure AD Gallery applications Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#notification_email_addresses ServicePrincipal#notification_email_addresses}
        :param owners: A list of object IDs of principals that will be granted ownership of the service principal. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#owners ServicePrincipal#owners}
        :param preferred_single_sign_on_mode: The single sign-on mode configured for this application. Azure AD uses the preferred single sign-on mode to launch the application from Microsoft 365 or the Azure AD My Apps Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#preferred_single_sign_on_mode ServicePrincipal#preferred_single_sign_on_mode}
        :param saml_single_sign_on: saml_single_sign_on block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#saml_single_sign_on ServicePrincipal#saml_single_sign_on}
        :param tags: A set of tags to apply to the service principal. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#tags ServicePrincipal#tags}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#timeouts ServicePrincipal#timeouts}
        :param use_existing: When true, the resource will return an existing service principal instead of failing with an error. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#use_existing ServicePrincipal#use_existing}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @jsii.member(jsii_name="appRoles")
    def app_roles(self, index: builtins.str) -> "ServicePrincipalAppRoles":
        '''
        :param index: -
        '''
        return typing.cast("ServicePrincipalAppRoles", jsii.invoke(self, "appRoles", [index]))
    ...
    def oauth2_permission_scopes(
        ...
        :param index: -
        '''
        return typing.cast("ServicePrincipalOauth2PermissionScopes", jsii.invoke(self, "oauth2PermissionScopes", [index]))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="applicationIdInput")
    def application_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "applicationIdInput"))
    ...
    def features_input(
        self,
    ) -> typing.Optional[typing.List["ServicePrincipalFeatures"]]:
        return typing.cast(typing.Optional[typing.List["ServicePrincipalFeatures"]], jsii.get(self, "featuresInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="featureTagsInput")
    def feature_tags_input(
        self,
    ) -> typing.Optional[typing.List["ServicePrincipalFeatureTags"]]:
        return typing.cast(typing.Optional[typing.List["ServicePrincipalFeatureTags"]], jsii.get(self, "featureTagsInput"))
    ...
    def saml_single_sign_on_input(
        self,
    ) -> typing.Optional[typing.List["ServicePrincipalSamlSingleSignOn"]]:
        return typing.cast(typing.Optional[typing.List["ServicePrincipalSamlSingleSignOn"]], jsii.get(self, "samlSingleSignOnInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ServicePrincipalTimeouts"]:
        return typing.cast(typing.Optional["ServicePrincipalTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="features")
    def features(self) -> typing.List["ServicePrincipalFeatures"]:
        return typing.cast(typing.List["ServicePrincipalFeatures"], jsii.get(self, "features"))

    @features.setter
    def features(self, value: typing.List["ServicePrincipalFeatures"]) -> None:
        jsii.set(self, "features", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="featureTags")
    def feature_tags(self) -> typing.List["ServicePrincipalFeatureTags"]:
        return typing.cast(typing.List["ServicePrincipalFeatureTags"], jsii.get(self, "featureTags"))

    @feature_tags.setter
    def feature_tags(self, value: typing.List["ServicePrincipalFeatureTags"]) -> None:
        jsii.set(self, "featureTags", value)
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="samlSingleSignOn")
    def saml_single_sign_on(self) -> typing.List["ServicePrincipalSamlSingleSignOn"]:
        return typing.cast(typing.List["ServicePrincipalSamlSingleSignOn"], jsii.get(self, "samlSingleSignOn"))

    @saml_single_sign_on.setter
    def saml_single_sign_on(
        self,
        value: typing.List["ServicePrincipalSamlSingleSignOn"],
    ) -> None:
        jsii.set(self, "samlSingleSignOn", value)
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ServicePrincipalTimeouts":
        return typing.cast("ServicePrincipalTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ServicePrincipalTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class ServicePrincipalCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        key_id: typing.Optional[builtins.str] = None,
        start_date: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional["ServicePrincipalCertificateTimeouts"] = None,
        type: typing.Optional[builtins.str] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param service_principal_id: The object ID of the service principal for which this certificate should be created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#service_principal_id ServicePrincipalCertificate#service_principal_id}
        :param value: The certificate data, which can be PEM encoded, base64 encoded DER or hexadecimal encoded DER. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#value ServicePrincipalCertificate#value}
        :param encoding: Specifies the encoding used for the supplied certificate data. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#encoding ServicePrincipalCertificate#encoding}
        :param end_date: The end date until which the certificate is valid, formatted as an RFC3339 date string (e.g. ``2018-01-01T01:02:03Z``). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#end_date ServicePrincipalCertificate#end_date}
        :param end_date_relative: A relative duration for which the certificate is valid until, for example ``240h`` (10 days) or ``2400h30m``. Valid time units are "ns", "us" (or "µs"), "ms", "s", "m", "h" Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#end_date_relative ServicePrincipalCertificate#end_date_relative}
        :param key_id: A UUID used to uniquely identify this certificate. If not specified a UUID will be automatically generated. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#key_id ServicePrincipalCertificate#key_id}
        :param start_date: The start date from which the certificate is valid, formatted as an RFC3339 date string (e.g. ``2018-01-01T01:02:03Z``). If this isn't specified, the current date is used. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#start_date ServicePrincipalCertificate#start_date}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#timeouts ServicePrincipalCertificate#timeouts}
        :param type: The type of key/certificate. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#type ServicePrincipalCertificate#type}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def service_principal_id_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "servicePrincipalIdInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ServicePrincipalCertificateTimeouts"]:
        return typing.cast(typing.Optional["ServicePrincipalCertificateTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ServicePrincipalCertificateTimeouts":
        return typing.cast("ServicePrincipalCertificateTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ServicePrincipalCertificateTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class ServicePrincipalCertificateTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#create ServicePrincipalCertificate#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#delete ServicePrincipalCertificate#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#read ServicePrincipalCertificate#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_certificate.html#update ServicePrincipalCertificate#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class ServicePrincipalConfig(cdktf.TerraformMetaArguments):
    ...
    @builtins.property
    def features(self) -> typing.Optional[typing.List["ServicePrincipalFeatures"]]:
        '''features block.
        ...
        return typing.cast(typing.Optional[typing.List["ServicePrincipalFeatures"]], result)
    ...
    def feature_tags(
        ...
        '''
        result = self._values.get("feature_tags")
        return typing.cast(typing.Optional[typing.List["ServicePrincipalFeatureTags"]], result)
    ...
    def saml_single_sign_on(
        ...
        return typing.cast(typing.Optional[typing.List["ServicePrincipalSamlSingleSignOn"]], result)
...
class ServicePrincipalFeatureTags:
    def __init__(
        ...
        *,
        ...
        '''
        :param custom_single_sign_on: Whether this service principal represents a custom SAML application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#custom_single_sign_on ServicePrincipal#custom_single_sign_on}
        :param enterprise: Whether this service principal represents an Enterprise Application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#enterprise ServicePrincipal#enterprise}
        :param gallery: Whether this service principal represents a gallery application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#gallery ServicePrincipal#gallery}
        :param hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#hide ServicePrincipal#hide}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if custom_single_sign_on is not None:
            self._values["custom_single_sign_on"] = custom_single_sign_on
...
class ServicePrincipalFeatures:
    def __init__(
        ...
        *,
        ...
        '''
        :param custom_single_sign_on_app: Whether this service principal represents a custom SAML application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#custom_single_sign_on_app ServicePrincipal#custom_single_sign_on_app}
        :param enterprise_application: Whether this service principal represents an Enterprise Application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#enterprise_application ServicePrincipal#enterprise_application}
        :param gallery_application: Whether this service principal represents a gallery application. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#gallery_application ServicePrincipal#gallery_application}
        :param visible_to_users: Whether this app is visible to users in My Apps and Office 365 Launcher. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#visible_to_users ServicePrincipal#visible_to_users}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class ServicePrincipalPassword(
    ...
    def __init__(
        ...
        *,
        service_principal_id: builtins.str,
        rotate_when_changed: typing.Optional[typing.Union[cdktf.IResolvable, typing.Mapping[builtins.str, builtins.str]]] = None,
        timeouts: typing.Optional["ServicePrincipalPasswordTimeouts"] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param service_principal_id: The object ID of the service principal for which this password should be created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_password.html#service_principal_id ServicePrincipalPassword#service_principal_id}
        :param rotate_when_changed: Arbitrary map of values that, when changed, will trigger rotation of the password. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_password.html#rotate_when_changed ServicePrincipalPassword#rotate_when_changed}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_password.html#timeouts ServicePrincipalPassword#timeouts}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["ServicePrincipalPasswordTimeouts"]:
        return typing.cast(typing.Optional["ServicePrincipalPasswordTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "ServicePrincipalPasswordTimeouts":
        return typing.cast("ServicePrincipalPasswordTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "ServicePrincipalPasswordTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class ServicePrincipalPasswordTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_password.html#create ServicePrincipalPassword#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_password.html#delete ServicePrincipalPassword#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_password.html#read ServicePrincipalPassword#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal_password.html#update ServicePrincipalPassword#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class ServicePrincipalSamlSingleSignOn:
    def __init__(self, *, relay_state: typing.Optional[builtins.str] = None) -> None:
        '''
        :param relay_state: The relative URI the service provider would redirect to after completion of the single sign-on flow. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#relay_state ServicePrincipal#relay_state}
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class ServicePrincipalTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#create ServicePrincipal#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#delete ServicePrincipal#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#read ServicePrincipal#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/service_principal.html#update ServicePrincipal#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
...
class User(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional["UserTimeouts"] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param display_name: The name to display in the address book for the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#display_name User#display_name}
        :param user_principal_name: The user principal name (UPN) of the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#user_principal_name User#user_principal_name}
        :param account_enabled: Whether or not the account should be enabled. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#account_enabled User#account_enabled}
        :param age_group: The age group of the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#age_group User#age_group}
        :param business_phones: The telephone numbers for the user. Only one number can be set for this property. Read-only for users synced with Azure AD Connect Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#business_phones User#business_phones}
        :param city: The city in which the user is located. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#city User#city}
        :param company_name: The company name which the user is associated. This property can be useful for describing the company that an external user comes from Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#company_name User#company_name}
        :param consent_provided_for_minor: Whether consent has been obtained for minors. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#consent_provided_for_minor User#consent_provided_for_minor}
        :param cost_center: The cost center associated with the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#cost_center User#cost_center}
        :param country: The country/region in which the user is located, e.g. ``US`` or ``UK``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#country User#country}
        :param department: The name for the department in which the user works. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#department User#department}
        :param disable_password_expiration: Whether the users password is exempt from expiring. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#disable_password_expiration User#disable_password_expiration}
        :param disable_strong_password: Whether the user is allowed weaker passwords than the default policy to be specified. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#disable_strong_password User#disable_strong_password}
        :param division: The name of the division in which the user works. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#division User#division}
        :param employee_id: The employee identifier assigned to the user by the organisation. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#employee_id User#employee_id}
        :param employee_type: Captures enterprise worker type. For example, Employee, Contractor, Consultant, or Vendor. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#employee_type User#employee_type}
        :param fax_number: The fax number of the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#fax_number User#fax_number}
        :param force_password_change: Whether the user is forced to change the password during the next sign-in. Only takes effect when also changing the password Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#force_password_change User#force_password_change}
        :param given_name: The given name (first name) of the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#given_name User#given_name}
        :param job_title: The user’s job title. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#job_title User#job_title}
        :param mail: The SMTP address for the user. Cannot be unset. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#mail User#mail}
        :param mail_nickname: The mail alias for the user. Defaults to the user name part of the user principal name (UPN). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#mail_nickname User#mail_nickname}
        :param manager_id: The object ID of the user's manager. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#manager_id User#manager_id}
        :param mobile_phone: The primary cellular telephone number for the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#mobile_phone User#mobile_phone}
        :param office_location: The office location in the user's place of business. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#office_location User#office_location}
        :param onpremises_immutable_id: The value used to associate an on-premise Active Directory user account with their Azure AD user object. This must be specified if you are using a federated domain for the user's ``user_principal_name`` property when creating a new user account Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#onpremises_immutable_id User#onpremises_immutable_id}
        :param other_mails: Additional email addresses for the user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#other_mails User#other_mails}
        :param password: The password for the user. The password must satisfy minimum requirements as specified by the password policy. The maximum length is 256 characters. This property is required when creating a new user Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#password User#password}
        :param postal_code: The postal code for the user's postal address. The postal code is specific to the user's country/region. In the United States of America, this attribute contains the ZIP code Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#postal_code User#postal_code}
        :param preferred_language: The user's preferred language, in ISO 639-1 notation. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#preferred_language User#preferred_language}
        :param show_in_address_list: Whether or not the Outlook global address list should include this user. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#show_in_address_list User#show_in_address_list}
        :param state: The state or province in the user's address. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#state User#state}
        :param street_address: The street address of the user's place of business. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#street_address User#street_address}
        :param surname: The user's surname (family name or last name). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#surname User#surname}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#timeouts User#timeouts}
        :param usage_location: The usage location of the user. Required for users that will be assigned licenses due to legal requirement to check for availability of services in countries. The usage location is a two letter country code (ISO standard 3166). Examples include: ``NO``, ``JP``, and ``GB``. Cannot be reset to null once set Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#usage_location User#usage_location}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="userPrincipalNameInput")
    def user_principal_name_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "userPrincipalNameInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeoutsInput")
    def timeouts_input(self) -> typing.Optional["UserTimeouts"]:
        return typing.cast(typing.Optional["UserTimeouts"], jsii.get(self, "timeoutsInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="timeouts")
    def timeouts(self) -> "UserTimeouts":
        return typing.cast("UserTimeouts", jsii.get(self, "timeouts"))

    @timeouts.setter
    def timeouts(self, value: "UserTimeouts") -> None:
        jsii.set(self, "timeouts", value)
...
class UserTimeouts:
    def __init__(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#create User#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#delete User#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#read User#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/user.html#update User#update}.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if create is not None:
            self._values["create"] = create
