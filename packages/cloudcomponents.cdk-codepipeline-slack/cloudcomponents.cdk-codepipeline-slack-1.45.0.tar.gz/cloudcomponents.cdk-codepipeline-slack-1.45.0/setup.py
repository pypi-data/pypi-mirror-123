    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_codepipeline_slack._jsii": [
            "cdk-codepipeline-slack@1.45.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_codepipeline_slack": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-apigateway>=1.128.0, <2.0.0",
        "aws-cdk.aws-codebuild>=1.128.0, <2.0.0",
        "aws-cdk.aws-codepipeline-actions>=1.128.0, <2.0.0",
        ...
        "aws-cdk.aws-sns-subscriptions>=1.128.0, <2.0.0",
