    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cloudwatch-actions>=1.95.2, <2.0.0",
        "aws-cdk.aws-cloudwatch>=1.95.2, <2.0.0",
        "aws-cdk.aws-dynamodb>=1.95.2, <2.0.0",
