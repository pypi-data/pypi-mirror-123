...
class KafkaToolbox:
    ...
    def create_topics(self, topic_cluster_dict, num_partitions=3, replication_factor=3, topic_config=None,
        ...
        Separately, if "use_nubium_topic_cluster_maps" is True, creates topic with predefined nubium_schemas configs.
        ...
        for clust, topics in topic_dict.items():
            if topics:
                ...
                # TODO: figure out how to do error handling with futures. When done, prob need to do this:
                # for topic in topics:
                #     try:
                ...
                #             pass
                _wait_on_futures_map(self.admin_clients[clust].create_topics(topics))
    ...
    def delete_topics(self, topic_cluster_dict, ignore_nubium_topic_cluster_maps=False):
        ...
        for clust, topics in topic_dict.items():
            if topics:
                ...
                _wait_on_futures_map(self.admin_clients[clust].delete_topics(topics))
