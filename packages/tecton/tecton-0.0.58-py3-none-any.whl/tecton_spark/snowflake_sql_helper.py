...
AGGREGATION_PLANS = {
    ...
    afpb.AGGREGATION_FUNCTION_MEAN: {"COUNT", "SUM"},
}
...
def get_historical_features(
    ...
    try:
        ...
        get_historical_features_sql = get_features_sql_str_for_spine(
            ...
            # Connector will add a double quote to the table name, we have to mimic that here otherwise it will fail to
            # find the table.
...
def get_materialization_sql_str(
    ...
    if feature_view.HasField("temporal_aggregate"):
        ...
        # Need to order the functions for determinism results.
    ...
    return MATERIALIZATION_TEMPLATE.render(
        source=source,
...
def get_features_sql_str_for_spine(
    ...
    return HISTORICAL_FEATURES_TEMPLATE.render(
