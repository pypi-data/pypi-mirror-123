...
class BatchWindowAggregateFeatureView(FeatureView):
    ...
    def run(
        ...
        **mock_inputs: Union[pandas.DataFrame, DataFrame],
        ...
        :param feature_start_time: Start time for input data (both data sources, and mock_inputs).
            The values with timestamps earlier than this will be dropped.

        :param feature_end_time: End time for input data (both data sources, and mock_inputs).
            The values with timestamps earlier than this will be dropped.
        ...
        Example:
            ...
            fv.run()  # Use inputs from the linked DataSources for both ds1 and ds2.
            fv.run(ds1=mock_dataframe1)  # Use mock_dataframe1 as input ds1, ds2 from a linked DataSource.
            fv.run(ds1=mock_dataframe1, ds2=mock_dataframe2)  # Use the mock dataframes for both ds1 and ds2.
