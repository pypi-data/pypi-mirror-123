...
LATEST_RELEASE_PACKAGE_PATH = os.path.join(os.path.dirname(__file__), 'data', 'doxygen-1.9.2.windows.bin.zip')
...
def _download_doxygen_portable():
    ...
    try:
        ...
        try:
            ...
            shutil.copyfile(LATEST_RELEASE_PACKAGE_PATH, download_zip_path)
