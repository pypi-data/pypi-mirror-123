...
The model manager uses CDF Files as backend. When setting up the model manager,
it's possible to choose a dataset. It's possible to work without a dataset,
leave the default ('mlops' dataset) or choose another one.
