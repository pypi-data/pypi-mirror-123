...
class TestArticleEndpoint(unittest.TestCase):
    ...
    def test_get_amelies_article(self):
        article = self.client.article.get('5fbfa9fe-5550-4df4-9177-88186553af50')
        self.assertEqual(article['id'], '5fbfa9fe-5550-4df4-9177-88186553af50')

    def test_amelies_world(self):
        world = self.client.world.get('7940b9b9-4f4f-4d58-8cd4-d2b7d4e1644c')
        self.assertEqual(world['id'], '7940b9b9-4f4f-4d58-8cd4-d2b7d4e1644c')
