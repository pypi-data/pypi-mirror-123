...
BASE_URL = 'https://www.fi-api.io/nu/items/'
...
def run_api():
    ...
    for news_category in news_categories:
        ...
        if check_too_old(xml_temp_path, MAX_FILE_AGE):
            ...
            for image_original in root.iter('image_original'):
            ...
            for image_square in root.iter('image_square'):
...
def check_api():
    ...
    for key in keys:
        if not 'item' in key and not 'islooping' in key.lower():
