...
def get_jobs_for_asset(asset_name=None, category=None):
    ...
    items = ('category', 'queuedAt', 'startedAt', 'completedAt', 'cost', 'currencyType', 'status', 'percentComplete',
             'jobUuid', 'workflowUuid', 'baseWorkflowUuid', 'deadlineAt', 'inputFileLabels')
