...
def patch_pydantic(
    ...
    # 解决数据动态加载的问题
    added_fields: Dict[str, ModelField] = {}
            ...
            if orig_model:
                if (
                    ...
                    if field.shape == SHAPE_LIST:
                        ...
                        k_id = f"{k}_id"
                        added_fields[k_id] = ModelField.infer(
                            name=k_id,
                            value=None,
                            annotation=int
                            if (
    ...
    for k, field in added_fields.items():
        model.__fields__[k] = field
