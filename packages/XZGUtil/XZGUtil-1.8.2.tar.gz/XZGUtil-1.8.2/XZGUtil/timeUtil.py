...
def datetime_toStr(dt: datetime) -> str:
    """
    把datetime转成字符串
...
def datetime_toStr_dil(dt: datetime) -> str:
    """
    把datetime转成字符串 详细版
    :param dt: datetime.datetime.now
    :return: '2020-01-01'
...
def datetime_toChinStr(dt: datetime) -> str:
    """
    把datetime转成中文字符串
    :param dt: datetime.datetime.now
    :return: '2020-01-01'
...
def datetime_toChinStr_dil(dt: datetime) -> str:
    """
    把datetime转成字符串 详细版
    :param dt: datetime.datetime.now
    :return: '2020-01-01'
...
def str_toDatetime(str: str) -> datetime:
    """
    把字符串转成datetime  精确到日
...
def dil_str_toDatetime(str: str) -> datetime:
    """
    把字符串转成datetime 精确到秒
    :param str: '2020-01-01'
    :return:
...
def timestamp_tostr(stamp: int) -> str:
    """
    把时间戳转成字符串形式
    ...
    try:
        ...
        if ts.status_code == 200:
            ...
            return {"sysTime3": ts_toStr_det(json_data.get('time')),
                    "sysTime2": timestamp_tostr(json_data.get('time')),
