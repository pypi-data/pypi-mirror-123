...
# ones.
extensions = ['unilakedocstheme']

# openstackdocstheme options
unilakedocs_repo_name = 'openstack/openstackdocstheme'
unilakedocs_bug_project = 'openstack-doc-tools'
unilakedocs_bug_tag = 'openstackdocstheme'
unilakedocs_pdf_link = True
