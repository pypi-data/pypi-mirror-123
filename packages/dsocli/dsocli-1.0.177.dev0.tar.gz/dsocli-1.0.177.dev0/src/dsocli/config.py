...
class ConfigService:
    ...
    def update_merged_config(self, use_global_rendered=True, use_local_rendered=True):
        ...
        providers = ['config', 'parameter', 'secret', 'template', 'storage', 'package']
    ...
    def storage_provider(self):
        return self.get_provider_id('storage')
    ...
    def storage_spec(self, key):
        return self.get_provider_spec('storage', key)
