...
def partition_inference_dataset_wrapper():
    """Wrapper code for HTS partition inference dataset."""
    ...
    try:
        ...
        tdp.tabular_dataset_partition(arguments_dict, event_logger, current_step_run, is_inference=True)
...
if __name__ == "__main__":
    partition_inference_dataset_wrapper()
