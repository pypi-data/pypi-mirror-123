...
MODELS: Mapping[str, Type[DataModel]] = {
    ...
    "asset_metadata": responses.AssetMetadata,  # type: ignore
    "asset_property": responses.AssetProperty,  # type: ignore
...
class Client(BaseClient):
    ...
    asset_metadata: Type[responses.AssetMetadata]
    asset_property: Type[responses.AssetProperty]
