...
from . import pagination, requests
...
class AlarmClass(DataModelBase):
    ...
    def list_alarm_class(
        ...
        **Pagination Sortable Columns:** `alarm_class.name`, `alarm_class.title`, `alarm_class.created`, `alarm_class.updated`
...
class AlarmType(DataModelBase):
    ...
    def list_alarm_type(
        ...
        **Pagination Sortable Columns:** `alarm_type.name`, `alarm_type.title`, `alarm_type.created`, `alarm_type.updated`, `alarm_class.name`, `alarm_class.title`
...
class AssetHierarchyItem(DataModelBase):
    ...
    children: Optional[List[AssetHierarchyItem]] = None
    name: Optional[str] = None
...
class AssetHierarchyList(DataModelBase):
    ...
    @classmethod
    def get_asset_hierarchy(cls, _dry_run: bool = False, _client: Any = None) -> AssetHierarchyList:
        """
        Get Asset Hierarchy
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": AssetHierarchyList, "400": ErrorMessages, "401": ErrorMessages},
            False,
            _dry_run,
        )
        return result
    ...
    @instance_classmethod
    @DataModelBase.translate()
    def update_asset_hierarchy(
        self_or_cls,
        data: Optional[Union[requests.AssetHierarchyList, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> None:
        ...
        **kwargs:
            Extra parameters for requests.AssetHierarchyList
              - data: list
...
class AssetMetadata(DataModelBase):
    """
    ...
    def create_asset_metadata(
        self_or_cls,
        asset_name: str,
        data: Optional[Union[requests.AssetMetadataCreate, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> AssetMetadata:
        ...
        **kwargs:
            Extra parameters for requests.AssetMetadataCreate
              - name: str
              - payload: dict
    ...
    def list_asset_metadata(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[AssetMetadata], AssetMetadataListPaginated]:
        """
        List Asset Metadata
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        asset_name : :obj:`str`, optional
            Asset name
        search : :obj:`Sequence[str]`
            Search Asset Metadata by name, title or value
        page_size : :obj:`int`
            Number of objects to be returned, between 1 and 1000. Default: 20
        starting_after : :obj:`str`
            Lower bound cursor for use in pagination
        ...
        result = self_or_cls._make_request(
            ...
            None,
            False,
            {"200": AssetMetadataListPaginated, "400": ErrorMessages, "401": ErrorMessages},
            False,
            _dry_run,
        )
        return result.fetch() if fetch and not _dry_run else result
    ...
    @instance_classmethod
    @DataModelBase.translate({"asset_metadata_name": "name"})
    def delete_asset_metadata(
        self_or_cls,
        asset_name: str,
        asset_metadata_name: str,
        _dry_run: bool = False,
        _client: Any = None,
    ) -> None:
        """
        ...
        **Permission Required:** `kelvin.permission.asset.delete`.
        ...
        asset_name : :obj:`str`, optional
            Asset name
        asset_metadata_name : :obj:`str`, optional
            Asset Metadata name
        ...
        result = self_or_cls._make_request(
            ...
            {"asset_name": asset_name, "asset_metadata_name": asset_metadata_name},
            {},
            {},
            {},
            None,
    ...
    def update_asset_metadata(
        ...
        asset_name: str,
        asset_metadata_name: str,
        data: Optional[Union[requests.AssetMetadataUpdate, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> AssetMetadata:
        ...
        **kwargs:
            Extra parameters for requests.AssetMetadataUpdate
              - payload: dict
...
class AssetMetadataListPaginated(PaginatorDataModel[AssetMetadata]):
    """
    ...
    data: Optional[List[AssetMetadata]] = None
    pagination: Optional[pagination.Pagination] = None
...
class AssetProperty(DataModelBase):
    ...
    @instance_classmethod
    @DataModelBase.translate()
    def create_asset_property(
        self_or_cls,
        asset_name: str,
        data: Optional[Union[requests.AssetPropertyCreate, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> AssetProperty:
        ...
        **kwargs:
            Extra parameters for requests.AssetPropertyCreate
              - name: str
              - title: str
              - value: str
    ...
    def list_asset_property(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[AssetProperty], AssetPropertyListPaginated]:
        """
        List Asset Property
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        asset_name : :obj:`str`, optional
            Asset name
        search : :obj:`Sequence[str]`
            Search Asset Property by name, title or value
        page_size : :obj:`int`
            Number of objects to be returned, between 1 and 1000. Default: 20
        starting_after : :obj:`str`
            Lower bound cursor for use in pagination
        ...
        result = self_or_cls._make_request(
            ...
            None,
            False,
            {"200": AssetPropertyListPaginated, "400": ErrorMessages, "401": ErrorMessages},
            False,
            _dry_run,
        )
        return result.fetch() if fetch and not _dry_run else result
    ...
    @instance_classmethod
    @DataModelBase.translate({"asset_property_name": "name"})
    def delete_asset_property(
        self_or_cls,
        asset_name: str,
        asset_property_name: str,
        _dry_run: bool = False,
        _client: Any = None,
    ) -> None:
        """
        ...
        **Permission Required:** `kelvin.permission.asset.delete`.
        ...
        asset_name : :obj:`str`, optional
            Asset name
        asset_property_name : :obj:`str`, optional
            Asset Property name
        ...
        result = self_or_cls._make_request(
            ...
            {"asset_name": asset_name, "asset_property_name": asset_property_name},
            {},
            {},
            {},
            None,
    ...
    def update_asset_property(
        ...
        asset_name: str,
        asset_property_name: str,
        data: Optional[Union[requests.AssetPropertyUpdate, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> AssetProperty:
        ...
        **kwargs:
            Extra parameters for requests.AssetPropertyUpdate
              - title: str
              - value: str
...
class AssetPropertyListPaginated(PaginatorDataModel[AssetProperty]):
    """
    ...
    data: Optional[List[AssetProperty]] = None
    pagination: Optional[pagination.Pagination] = None
...
class Bridge(DataModelBase):
    ...
    def list_bridge_assets(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[Asset], AssetListPaginated]:
        """
        List Bridge Assets
...
class Metric(DataModelBase):
    ...
    def list_semantic_type(
        ...
        **Sortable Columns:** `semantictype.name`, `semantictype.title`,
        `semantictype.created`, `semantictype.updated`
...
class RelatedAssets(DataModelBase):
    """
...
class ViewItem(DataModelBase):
    ...
    def delete_view_group(
        cls, view_group_name: str, _dry_run: bool = False, _client: Any = None
    ) -> None:
        """
        Delete View Group
    ...
    def delete_view_type(
        self_or_cls, view_type_name: str, _dry_run: bool = False, _client: Any = None
    ) -> None:
        """
        Delete View Type
    ...
    @classmethod
    def delete_view(cls, view_name: str, _dry_run: bool = False, _client: Any = None) -> None:
        """
        Delete View
    ...
    def create_view_view_group_relationship(
        cls, view_name: str, view_group_name: str, _dry_run: bool = False, _client: Any = None
    ) -> None:
        """
    ...
    def delete_view_metadata(
        cls, view_name: str, view_metadata_name: str, _dry_run: bool = False, _client: Any = None
    ) -> None:
        """
...
class Alarm(DataModelBase):
    ...
    description: Optional[str]
    id: Optional[str]
    related_assets: Optional[List[RelatedAssets]]
    ...
    description: Optional[str] = None
    id: Optional[str] = None
    related_assets: Optional[List[RelatedAssets]] = None
...
class Asset(DataModelBase):
    ...
    @classmethod
    def delete_asset_class(
        cls, asset_class_name: str, _dry_run: bool = False, _client: Any = None
    ) -> None:
        """
        Delete Asset Class
    ...
    def create_asset(
        ...
        **kwargs:
        ...
        result = self_or_cls._make_request(
            ...
            False,
            {"201": Asset, "400": ErrorMessages, "401": ErrorMessages, "409": ErrorMessages},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_asset_statuses(cls, _dry_run: bool = False, _client: Any = None) -> AssetStatus:
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        ``getAssetStatuses``: ``GET`` ``/api/v4/assets/status/get``
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": AssetStatus, "400": ErrorMessages, "401": ErrorMessages, "404": ErrorMessages},
            False,
            _dry_run,
        )
        return result
    ...
    def get_asset(
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        result = self_or_cls._make_request(
            ...
            None,
            False,
            {"200": Asset, "400": ErrorMessages, "401": ErrorMessages, "404": ErrorMessages},
            False,
            _dry_run,
        )
        return result
...
class AssetListPaginated(PaginatorDataModel[Asset]):
    """
...
class ViewGroup(DataModelBase):
    ...
    def delete_view_group(
        self_or_cls, view_group_name: str, _dry_run: bool = False, _client: Any = None
    ) -> None:
        """
        Delete View Group
...
class View(DataModelBase):
    ...
    def delete_view(
        self_or_cls, view_name: str, _dry_run: bool = False, _client: Any = None
    ) -> None:
        """
        Delete View
