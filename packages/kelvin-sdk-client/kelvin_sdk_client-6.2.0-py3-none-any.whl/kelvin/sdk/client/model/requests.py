...
class AlarmCreate(DataModelBase):
    ...
    related_asset_names: Optional[List[str]]
    ...
    related_asset_names: Optional[List[str]] = None
...
class AssetMetadataCreate(DataModelBase):
    """
...
class AssetMetadataUpdate(DataModelBase):
    """
...
class AssetPropertyUpdate(DataModelBase):
    """
