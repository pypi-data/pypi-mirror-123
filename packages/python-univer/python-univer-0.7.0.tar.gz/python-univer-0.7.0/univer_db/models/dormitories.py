...
class DormitoryApplicantStudent(Base):
    ...
    applicant_id = Column(ForeignKey('univer_dormitory_applicant.dormitory_applicant_id'), primary_key=True)
...
class StudentDormitoryRoomLink(Base):
    ...
    applicant_id = Column(ForeignKey('univer_dormitory_applicant.dormitory_applicant_id'))
...
class StudentDormitoryRoomSettleHistory(Base):
    ...
    personnel_id = Column(ForeignKey('univer_personal.personal_id'))
