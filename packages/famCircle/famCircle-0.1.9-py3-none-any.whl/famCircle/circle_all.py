    ...
    def run(self):
        ...
        for lt in blastlist:
            ...
            if id1.split('^')[0] == id2.split('^')[0]:
                self.plot_bez_inner((order1, pos1, self.radius_a), (order2, pos2, self.radius_a), 'y', total_size,alp,0.2)
                # pass
            else:
                blastlist01.append([id1, id2])
                # self.plot_bez_inner((order1, pos1, self.radius_a*0.95), (order2, pos2, self.radius_a*0.95), col, total_size,alp)
                # pass


        for lt in blastlist01:
            id1, id2 = str(lt[0]),str(lt[1])
            pos1 = self.gene2pos[id1]
            pos2 = self.gene2pos[id2]
            chro1 = id1.split("^")[0]
            ...
            order2 = self.labels.index(chro2)
            alp = 0.08
            self.plot_bez_inner((order1, pos1, self.radius_a*0.95), (order2, pos2, self.radius_a*0.95), col, total_size,alp,1.6)
                # pass
