...
from pyocs.pyocs_uat_software import PyocsUatSoftware
...
class PyocsUatEdit:
    ...
    def get_burn_place_hold(self, ocs_number):
        pyocsSoftware = PyocsUatSoftware()
    ...
    def get_update_ocs_xml_list(self, ocs_number, list_xpath, filterData):
        ...
        url = 'https://ocs-uat.gz.cvte.cn/tv/Tasks/view/range:all/'
        url += ocs_number
        request = PyocsUatRequest()
