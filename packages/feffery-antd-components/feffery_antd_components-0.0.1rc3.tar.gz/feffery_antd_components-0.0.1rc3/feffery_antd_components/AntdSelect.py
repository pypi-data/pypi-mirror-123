...
- value (string | number | list of string | numbers; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, options=Component.UNDEFINED, colorsNameWidth=Component.UNDEFINED, allowClear=Component.UNDEFINED, mode=Component.UNDEFINED, disabled=Component.UNDEFINED, placeholder=Component.UNDEFINED, value=Component.UNDEFINED, defaultValue=Component.UNDEFINED, maxTagCount=Component.UNDEFINED, listHeight=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'allowClear', 'className', 'colorsNameWidth', 'defaultValue', 'disabled', 'listHeight', 'loading_state', 'maxTagCount', 'mode', 'options', 'placeholder', 'style', 'value']
        self._type = 'AntdSelect'
        self._namespace = 'feffery_antd_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'allowClear', 'className', 'colorsNameWidth', 'defaultValue', 'disabled', 'listHeight', 'loading_state', 'maxTagCount', 'mode', 'options', 'placeholder', 'style', 'value']
