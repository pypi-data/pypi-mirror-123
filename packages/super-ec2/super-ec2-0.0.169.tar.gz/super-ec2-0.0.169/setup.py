    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-elasticloadbalancingv2-targets>=1.122.0, <2.0.0",
        "aws-cdk.aws-elasticloadbalancingv2>=1.122.0, <2.0.0",
        "aws-cdk.aws-iam>=1.122.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.122.0, <2.0.0",
        "aws-cdk.aws-logs>=1.122.0, <2.0.0",
        "aws-cdk.aws-route53-targets>=1.122.0, <2.0.0",
        "aws-cdk.aws-route53>=1.122.0, <2.0.0",
        "aws-cdk.aws-s3-assets>=1.122.0, <2.0.0",
        "aws-cdk.aws-s3>=1.122.0, <2.0.0",
        "aws-cdk.aws-sns-subscriptions>=1.122.0, <2.0.0",
        "aws-cdk.aws-sns>=1.122.0, <2.0.0",
        "aws-cdk.core>=1.122.0, <2.0.0",
        "aws-cdk.custom-resources>=1.122.0, <2.0.0",
