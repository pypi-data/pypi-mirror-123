...
from .Project import Project, ProjectsList, DataProject, DBASE, PARAM, Package
...
class Slot:
    ...
    def __getstate__(self):
        ...
        Allow pickling.
        """
        dct = dict((elem, getattr(self, elem)) for elem in (
            "projects",
            "env",
            "disabled",
            "desc",
    ...
    def __dir__(self):
        ...
        """
        return list(
            self.__dict__.keys()) + [proj.name for proj in self.projects]
