...
class QAbstract3DGraph(QtGui.QWindow):
    ...
    def optimizationHintsChanged(self, hints: 'QAbstract3DGraph.OptimizationHint') -> None: ...
    ...
    def selectionModeChanged(self, mode: 'QAbstract3DGraph.SelectionFlag') -> None: ...
...
class Q3DTheme(QtCore.QObject):
    ...
    def lightColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def multiHighlightColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def singleHighlightColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def gridLineColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def labelBackgroundColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def labelTextColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def windowColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def backgroundColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def baseColorsChanged(self, colors: typing.Iterable[typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]]) -> None: ...
...
class QAbstract3DSeries(QtCore.QObject):
    ...
    def baseColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def colorStyleChanged(self, style: Q3DTheme.ColorStyle) -> None: ...
...
class QCustom3DLabel(QCustom3DItem):
    ...
    def backgroundColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def textColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def fontChanged(self, font: QtGui.QFont) -> None: ...
...
class QCustom3DVolume(QCustom3DItem):
    ...
    def sliceFrameColorChanged(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QItemModelBarDataProxy(QBarDataProxy):
    ...
    def rotationRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
    def valueRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
    def columnRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
    def rowRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
...
class QItemModelScatterDataProxy(QScatterDataProxy):
    ...
    def rotationRoleReplaceChanged(self, replace: str) -> None: ...
    def rotationRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
    def zPosRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
    def yPosRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
    def xPosRolePatternChanged(self, pattern: QtCore.QRegularExpression) -> None: ...
    def rotationRoleReplace(self) -> str: ...
    def setRotationRoleReplace(self, replace: str) -> None: ...
...
class QSurface3DSeries(QAbstract3DSeries):
    ...
    def drawModeChanged(self, mode: 'QSurface3DSeries.DrawFlag') -> None: ...
