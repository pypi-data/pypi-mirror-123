...
def get_transform_params(device):
    ...
    return [affine_transform, noise_transform, blur_transform, contrast_transform, bright_transform, gamma_transform, mirror_transform], [affine_prob, noise_prob, blur_prob, contrast_prob, gamma_prob, bright_prob, mirror_prob]
