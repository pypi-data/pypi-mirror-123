...
class Inference(object):
    ...
    def save_inference_result(self):
        ...
        if self.mode == 'save':
            ...
            print(intersection, self.result_map.shape, seg.shape, (self.result_map != 0).sum(), (seg != 0).sum(), torch.unique(self.result_map), torch.unique(seg), torch.unique((self.result_map == seg)))
