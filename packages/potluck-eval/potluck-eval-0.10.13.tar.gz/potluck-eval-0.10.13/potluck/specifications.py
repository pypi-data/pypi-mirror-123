...
class HasGoal:
    ...
    def test_output(self, capture_errors=False):
        ...
        if hasattr(self, "base_name"):
            if self.base_name == "import":
                self.default_goal_args["description"] = (
                    "Your program prints the correct output",
                    (
                ...
                self.default_goal_args["description"] = (
                    (
                        f"<code>{self.base_name}</code> prints the"
                        f" correct output"
                    ),
                    (
    ...
    def test_trace(self, trace_targets, state_function):
        ...
        # Set default (not explicit) description
        self.default_goal_args["description"] = (
            f"<code>{self.base_name}</code> uses the correct process",
            (
    ...
    def check_trace_state(
        ...
        if hasattr(self, "base_name") and self.base_name != "input":
            self.default_goal_args["description"] = (
                (
                    f"<code>{self.base_name}</code> makes the correct"
                    f" function calls"
                ),
                (
    ...
    def check_trace_count(self, target, double_or_half=False):
        ...
        if hasattr(self, "base_name") and self.base_name != "input":
            ...
            self.default_goal_args["description"] = (
                (
                    f"Makes the correct number of function calls to"
                    f" <code>{target}</code>"
                ),
                (
    ...
    def test_wavesynth_notes(self):
        ...
        if hasattr(self, "base_name"):
            ...
            self.default_goal_args["description"] = (
                f"{what.capitalize()} produces the correct note sequence",
                (
                ...
                (
                    f"{what.capitalize()} produces the correct note"
                    " sequence"
                ),
                (
            ...
            self.default_goal_args["description"] = (
                "Produces the correct note sequence",
                (
    ...
    def test_wavesynth_audio(self):
        ...
        if hasattr(self, "base_name"):
            if self.base_name == "import":
                ...
                verb = "called"
            self.default_goal_args["description"] = (
                f"{what.capitalize()} produces the correct audio",
                (
    ...
    def succeed_unless_crashed(self):
        ...
        self.default_goal_args.setdefault("tags", {})["goal_type"] = "process"
        ...
        if hasattr(self, "base_name"):
            if self.base_name == "import":
                ...
                self.default_goal_args["description"] = (
                    f"<code>{self.base_name}</code> does not crash",
                    (
        ...
        if self.group:
            ...
            if target is not None:
                self.group.default_goal_args["description"] = (
                    (
                        f"Running <code>{target}</code> exhibits the"
                        f" correct behavior"
                    ),
                    (
        ...
        if self.base_name == "import":
            HasGoal.__init__(
                ...
                default_goal_args={
                    ...
                    "description": (
                        "Your code exhibits the correct behavior",
                        (
            ...
            HasGoal.__init__(
                ...
                default_goal_args={
                    ...
                    "description": (
                        f"<code>{base_name}</code> returns the correct result",
                        (
