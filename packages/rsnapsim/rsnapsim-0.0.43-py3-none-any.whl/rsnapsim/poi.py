...
class poi():
    ...
    def codon_sensitivity(self):
        '''
        returns the percentage usage of each codon within the transcript
        times its senstitivity rate from cdict

        %codon in transcript * sensitivity

        sensitivity is defined as the ratio of the fastest synonomous codon
        rate / slowest synonomous codon rate
    ...
    def visualize_probe(self, colors=None, dpi=120, cmap='viridis'):
        ...
        rectangle = mpatches.Rectangle((0, .1), N, .8,
