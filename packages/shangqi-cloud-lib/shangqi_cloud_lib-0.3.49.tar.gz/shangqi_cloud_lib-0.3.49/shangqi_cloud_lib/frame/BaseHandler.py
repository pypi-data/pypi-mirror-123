...
class BaseHandler(tornado.web.RequestHandler, ABC):
    def __init__(self, application: "Application", request: httputil.HTTPServerRequest, **kwargs: Any):
        ...
        self.client = DataClient(f"http://{config.data_server_host}:{config.data_server_port}", config.data_server_token)
    ...
    def auth_sum_control(self, key, interface_sum=config.interface_sum, check_interface_time_horizon=config.check_interface_time_horizon,
