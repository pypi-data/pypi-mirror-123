...
def send_es_get_scroll(bool_must_list=None, route_key="", param_list=None, scroll="5m", bool_should_list=None):
    find_condition = {
        "query": {
            "bool": {
                "must": bool_must_list,
...
def send_es_post(bool_must_list=None, bool_should_list=None, param_list=None, route_key="", sort_list=None, size=10,
                 offset=0,
...
def format_es_return(bool_must_list=None, param_list=None, route_key="", sort_list=None, size=10, offset=0,
                     ...
                     bool_should_list=None):
    if not res:
        res = send_es_post(bool_must_list, bool_should_list, param_list, route_key=route_key, sort_list=sort_list,
                           size=size,
                           offset=offset,
...
def format_es_scan(bool_must_list=None, bool_should_list=None, param_list=None, route_key="", scroll="5m", size=10000,
                   is_need_decrypt_oralce=False):
    request_param = {
        "query": {
            "bool": {
                "must": bool_must_list,
