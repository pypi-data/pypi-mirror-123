...
from common.api.dtos.assessment_job_dto import AssessmentJobDTO, RunOriginDTO, RunStatusDTO, RunTypeDTO, StepFunctionStepDTO
...
class EvaluationRunCommandService(CommandService[CmdParams]):
    ...
    def run(self):
        ...
        workspace_id = self.command_parameters.workspace_id
    ...
    def _return_assessment_results(self, assessment_job: AssessmentJobDTO, policies: List[PolicyDTO]):
