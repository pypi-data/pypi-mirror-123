...
class CloudAccountCommandService(CommandService[CommandParameters]):
    ...
    def add_cloud_account_gcp(self, cloud_account_name: str, project_id: str, client_email: str, pull_interval: int, api_key):
        ...
        credentials = GcpCredentialsDTO(client_email)
