...
:LastEditTime: 2021-06-24 16:51:58
...
from seven_framework.file import BOSHelper
...
class BOS:
    ...
    def upload(self, storage_config, file_name='', stream=None, file_path=''):
        ...
        try:
            conn = BOSHelper(access_key, secret_key, end_point)
    ...
    def upload_part(self, storage_config, source_path):
        ...
        try:
            ...
            self.logger_error.exception(ex)
            invoke_result.ResultCode = "1"
            invoke_result.ResultMessage = "BOS上传文件出错"
