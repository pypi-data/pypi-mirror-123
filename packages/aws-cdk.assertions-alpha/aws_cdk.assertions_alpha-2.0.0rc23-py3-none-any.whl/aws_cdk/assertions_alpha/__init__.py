...
class Match(
    ...
    jsii_type="@aws-cdk/assertions-alpha.Match",
):
...
class MatchResult(
    ...
    jsii_type="@aws-cdk/assertions-alpha.MatchResult",
):
...
class Matcher(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="@aws-cdk/assertions-alpha.Matcher",
):
...
class Template(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/assertions-alpha.Template"):
    ...
    @builtins.classmethod
    def from_stack(cls, stack: aws_cdk.Stack) -> "Template":
...
class Capture(
    Matcher,
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/assertions-alpha.Capture",
):
