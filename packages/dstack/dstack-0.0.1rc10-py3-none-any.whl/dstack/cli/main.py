...
from dstack.cli import logs, run, stop, artifacts, status, login, logout, token, runners, git_command, \
    autoscale, resume, aws
...
def main():
    ...
    autoscale.register_parsers(subparsers)
    git_command.register_parsers(subparsers)
