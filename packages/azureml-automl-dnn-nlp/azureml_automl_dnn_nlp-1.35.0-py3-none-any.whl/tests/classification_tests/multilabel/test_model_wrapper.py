...
def test_transform_1():
    ...
    model = MockModel(2)
    wrapper = ModelWrapper(model, "some_tokenizer", "some_vectorizer", "some_column")
...
def test_predict():
    ...
    vectorizer.fit(["label0", "label1", "label2"])
    wrapper = ModelWrapper(model, "some_tokenizer", vectorizer, "some_column")
