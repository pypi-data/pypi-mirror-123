...
from azureml.automl.dnn.nlp.classification.io.read.dataloader import multiclass_dataset_loader
...
class TestTextClassificationTrainerTests:
    ...
    def test_train_valid(self, get_by_id_mock, language_mock, trainer_mock, auto_config, auto_tokenizer,
                         auto_model_mock, MulticlassDatasetTester, MulticlassValDatasetTester):
        ...
        training_set, validation_set, label_list, _, _ = multiclass_dataset_loader(
            "dataset_id", "val_dataset_id", label_column_name, "workspace", "eng")
