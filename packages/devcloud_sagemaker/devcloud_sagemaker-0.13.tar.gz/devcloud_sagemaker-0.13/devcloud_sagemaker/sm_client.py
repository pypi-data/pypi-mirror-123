...
#API_GW = "https://csctis3kqa.execute-api.us-east-2.amazonaws.com/api/"
API_GW = "https://eq0awyoili.execute-api.cn-north-1.amazonaws.com.cn/api/"
...
if __name__ == "__main__":
    ...
    #print(files)
    make_tar("yolov5")
    create_training_job("datasets_simple", "yolov5.tar", "yolov5s.pt", {"instance_type":"ml.m5.xlarge", "instance_count":"1", "framework_version":"1.8.1", "hyperparameters":{"imgsz":"64", "epochs":"10"}})
    #make_tar("train.py")
    #create_training_job("mnist", "train.tar", None, {"instance_type":"ml.m5.xlarge", "instance_count":"1", "framework_version":"1.8.1", "hyperparameters":{"epochs":"2","backend":"gloo", "hidden_channels":"2", "dropout":"0.2","kernel_size":"5", "optimizer":"sgd"}})