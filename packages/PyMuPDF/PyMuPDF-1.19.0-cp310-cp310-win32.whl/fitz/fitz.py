...
VersionFitz = "1.19.0"
VersionBind = "1.19.0"
VersionDate = "2021-10-16 07:31:46"
version = (VersionBind, VersionFitz, "20211016073146")
...
class Page(object):
    ...
    def _get_text_page_ocr(
        self,
        clip: rect_like = None,
        flags: int = 0,
        language: OptStr = None,
    ) -> "TextPage":
        val = _fitz.Page__get_text_page_ocr(self, clip, flags, language)
        val.thisown = True

        return val

    def get_textpage_ocr(
        self, clip: rect_like = None, flags: int = 0, language: str = "eng"
    ) -> "TextPage":
