...
from renxianqi.ui.menu_setting import show_copyright, show_about, show_datafiles, make_shortcut, trigger_upgrade
...
def about():
    ...
    print("===========================================")
    print("操作说明：")
    print("界面分为左右两边：左边是全部人员输入框，按照一行一个人名")
    print("界面分为左右两边：右边是实际出席人员输入框，一行一个人名")
    print("点击按钮'开始校验' ")
