...
setup(
  ...
  download_url = 'https://github.com/IMACS-GmbH/emBRICK/blob/main/Protocol%20Stacks/remoteBUS/Python%20via%20TCP-IP%20or%20RSxxx%20(using%20Windows-PC%20or%20RaspberryPi)/emBRICK-0.02.tar.gz',    # I explain this later on
