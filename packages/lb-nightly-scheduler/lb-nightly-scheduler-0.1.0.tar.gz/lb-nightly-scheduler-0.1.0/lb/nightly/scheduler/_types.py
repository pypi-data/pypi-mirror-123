...
class ArtifactTarget(luigi.target.Target):
    def __init__(self, project: Union[Project, Package], stage="checkout", platform=""):
        import lb.nightly.db.database
        ...
        self.docname = lb.nightly.db.database.Database.docname(project.slot)
