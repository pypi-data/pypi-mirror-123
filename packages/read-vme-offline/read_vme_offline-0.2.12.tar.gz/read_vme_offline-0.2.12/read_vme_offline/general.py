...
def column_to_histo( dfcol , binmax = 32*1024, savename = "", hname = "h1", writeondisk = False ):
    ...
    """
    print("D... ========= creating histo .... column to_numpy")
    narr = dfcol.to_numpy()
    ...
    th1f = ROOT.TH1F(hname, basename, binmax, 0 , binmax)
    ...
    if (savename!="") and  writeondisk:
        ...
        print("D... creating root spectum at", rootname, "name=", hname )
...
def save_to_tree(df2, filename):
    ...
    print(f"D... speed = {get_number_of_lines(filename)/meastime/1000:.3f} krows/sec")
...
#     print( freemem() )
#  #
#     print(f"D... broadening table - dtus")
