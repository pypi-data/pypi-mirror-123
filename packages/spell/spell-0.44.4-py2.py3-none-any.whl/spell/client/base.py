...
class SpellClient:
    ...
    def __init__(
        self, token, spell_admin_token=None, base_url=BASE_URL, version_str=API_VERSION, owner=None,
        workflow_id=None
    ):
        self.api = APIClient(
            base_url=base_url, version_str=version_str, token=token, spell_admin_token=spell_admin_token,
            owner=owner
        )
