...
from generic_camunda_client.models.set_removal_time_to_historic_process_instances_dto_all_of import SetRemovalTimeToHistoricProcessInstancesDtoAllOf  # noqa: E501
from generic_camunda_client.rest import ApiException

class TestSetRemovalTimeToHistoricProcessInstancesDtoAllOf(unittest.TestCase):
    """SetRemovalTimeToHistoricProcessInstancesDtoAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SetRemovalTimeToHistoricProcessInstancesDtoAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = generic_camunda_client.models.set_removal_time_to_historic_process_instances_dto_all_of.SetRemovalTimeToHistoricProcessInstancesDtoAllOf()  # noqa: E501
        if include_optional :
            return SetRemovalTimeToHistoricProcessInstancesDtoAllOf(
                historic_process_instance_ids = [
                    '0'
                    ], 
                historic_process_instance_query = generic_camunda_client.models.historic_process_instance_query_dto.HistoricProcessInstanceQueryDto(
                    ...
                    or_queries = [
                        generic_camunda_client.models.historic_process_instance_query_dto.HistoricProcessInstanceQueryDto(
                            process_instance_id = '0', 
                            process_definition_id = '0', 
                            process_definition_key = '0', 
                            process_definition_name = '0', 
                            ...
                            variable_values_ignore_case = True, 
                            sorting = [
                                generic_camunda_client.models.historic_process_instance_query_dto_sorting.HistoricProcessInstanceQueryDto_sorting(
                                    sort_by = 'instanceId', 
                                    sort_order = 'asc', )
                                ], )
                        ], 
    ...
    def testSetRemovalTimeToHistoricProcessInstancesDtoAllOf(self):
        """Test SetRemovalTimeToHistoricProcessInstancesDtoAllOf"""
