...
from generic_camunda_client.models.set_removal_time_to_historic_decision_instances_dto_all_of import SetRemovalTimeToHistoricDecisionInstancesDtoAllOf  # noqa: E501
from generic_camunda_client.rest import ApiException

class TestSetRemovalTimeToHistoricDecisionInstancesDtoAllOf(unittest.TestCase):
    """SetRemovalTimeToHistoricDecisionInstancesDtoAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SetRemovalTimeToHistoricDecisionInstancesDtoAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = generic_camunda_client.models.set_removal_time_to_historic_decision_instances_dto_all_of.SetRemovalTimeToHistoricDecisionInstancesDtoAllOf()  # noqa: E501
        if include_optional :
            return SetRemovalTimeToHistoricDecisionInstancesDtoAllOf(
                hierarchical = True, 
    ...
    def testSetRemovalTimeToHistoricDecisionInstancesDtoAllOf(self):
        """Test SetRemovalTimeToHistoricDecisionInstancesDtoAllOf"""
