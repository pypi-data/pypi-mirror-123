...
from generic_camunda_client.models.task_query_dto import TaskQueryDto  # noqa: E501
...
class TestTaskQueryDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = generic_camunda_client.models.task_query_dto.TaskQueryDto()  # noqa: E501
        if include_optional :
            return TaskQueryDto(
                ...
                parent_task_id = '0', 
                or_queries = [
                    generic_camunda_client.models.task_query_dto.TaskQueryDto(
                        process_instance_id = '0', 
                        process_instance_id_in = [
                            '0'
                            ], 
                        ...
                        or_queries = [
                            generic_camunda_client.models.task_query_dto.TaskQueryDto(
                                ...
                                parent_task_id = '0', 
                                sorting = [
                                    generic_camunda_client.models.task_query_dto_sorting.TaskQueryDto_sorting(
                                        sort_by = 'instanceId', 
                                        sort_order = 'asc', 
                                        parameters = generic_camunda_client.models.sort_task_query_parameters_dto.SortTaskQueryParametersDto(
                                            variable = '0', 
                                            type = '0', ), )
                                    ], )
                            ], 
