...
from generic_camunda_client.models.task_dto import TaskDto  # noqa: E501
...
class TestTaskDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = generic_camunda_client.models.task_dto.TaskDto()  # noqa: E501
        if include_optional :
            return TaskDto(
                id = '0', 
                name = '0', 
                ...
                form_key = '0', 
                camunda_form_ref = {
                    'key' : generic_camunda_client.models.camunda_form_ref.CamundaFormRef(
                        key = '0', 
                        binding = '0', 
                        version = 56, )
                    }, 
