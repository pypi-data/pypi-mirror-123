...
from generic_camunda_client.models.set_retries_for_external_tasks_dto import SetRetriesForExternalTasksDto  # noqa: E501
...
class TestSetRetriesForExternalTasksDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = generic_camunda_client.models.set_retries_for_external_tasks_dto.SetRetriesForExternalTasksDto()  # noqa: E501
        if include_optional :
            return SetRetriesForExternalTasksDto(
                ...
                external_task_query = generic_camunda_client.models.external_task_query_dto.ExternalTaskQueryDto(
                    external_task_id = '0', 
                    external_task_id_in = [
                        '0'
                        ], 
                    ...
                    sorting = [
                        generic_camunda_client.models.external_task_query_dto_sorting.ExternalTaskQueryDto_sorting(
                            sort_by = 'id', 
                            sort_order = 'asc', )
                        ], ), 
