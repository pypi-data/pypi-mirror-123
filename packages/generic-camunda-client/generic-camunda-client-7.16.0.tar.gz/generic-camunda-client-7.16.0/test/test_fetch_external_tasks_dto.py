...
from generic_camunda_client.models.fetch_external_tasks_dto import FetchExternalTasksDto  # noqa: E501
...
class TestFetchExternalTasksDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = generic_camunda_client.models.fetch_external_tasks_dto.FetchExternalTasksDto()  # noqa: E501
        if include_optional :
            return FetchExternalTasksDto(
                ...
                topics = [
                    generic_camunda_client.models.fetch_external_task_topic_dto.FetchExternalTaskTopicDto(
                        topic_name = '0', 
                        lock_duration = 56, 
                        variables = [
                            '0'
