...
class ProcessInstanceSuspensionStateAsyncDto(object):
    ...
    def __init__(self, process_instance_ids=None, process_instance_query=None, historic_process_instance_query=None, suspended=None, local_vars_configuration=None):  # noqa: E501
