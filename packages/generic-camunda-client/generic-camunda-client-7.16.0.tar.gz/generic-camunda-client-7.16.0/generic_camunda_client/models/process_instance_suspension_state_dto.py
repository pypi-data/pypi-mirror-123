...
class ProcessInstanceSuspensionStateDto(object):
    ...
    def __init__(self, process_definition_id=None, process_definition_key=None, process_definition_tenant_id=None, process_definition_without_tenant_id=None, process_instance_ids=None, process_instance_query=None, historic_process_instance_query=None, suspended=None, local_vars_configuration=None):  # noqa: E501
