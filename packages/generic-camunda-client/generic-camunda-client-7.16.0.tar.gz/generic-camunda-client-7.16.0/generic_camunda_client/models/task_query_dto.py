...
class TaskQueryDto(object):
    ...
    def __init__(self, process_instance_id=None, process_instance_id_in=None, process_instance_business_key=None, process_instance_business_key_expression=None, process_instance_business_key_in=None, process_instance_business_key_like=None, process_instance_business_key_like_expression=None, process_definition_id=None, process_definition_key=None, process_definition_key_in=None, process_definition_name=None, process_definition_name_like=None, execution_id=None, case_instance_id=None, case_instance_business_key=None, case_instance_business_key_like=None, case_definition_id=None, case_definition_key=None, case_definition_name=None, case_definition_name_like=None, case_execution_id=None, activity_instance_id_in=None, tenant_id_in=None, without_tenant_id=False, assignee=None, assignee_expression=None, assignee_like=None, assignee_like_expression=None, assignee_in=None, assignee_not_in=None, owner=None, owner_expression=None, candidate_group=None, candidate_group_expression=None, candidate_user=None, candidate_user_expression=None, include_assigned_tasks=False, involved_user=None, involved_user_expression=None, assigned=False, unassigned=False, task_definition_key=None, task_definition_key_in=None, task_definition_key_like=None, name=None, name_not_equal=None, name_like=None, name_not_like=None, description=None, description_like=None, priority=None, max_priority=None, min_priority=None, due_date=None, due_date_expression=None, due_after=None, due_after_expression=None, due_before=None, due_before_expression=None, without_due_date=False, follow_up_date=None, follow_up_date_expression=None, follow_up_after=None, follow_up_after_expression=None, follow_up_before=None, follow_up_before_expression=None, follow_up_before_or_not_existent=None, follow_up_before_or_not_existent_expression=None, created_on=None, created_on_expression=None, created_after=None, created_after_expression=None, created_before=None, created_before_expression=None, delegation_state=None, candidate_groups=None, candidate_groups_expression=None, with_candidate_groups=False, without_candidate_groups=False, with_candidate_users=False, without_candidate_users=False, active=False, suspended=False, task_variables=None, process_variables=None, case_instance_variables=None, variable_names_ignore_case=False, variable_values_ignore_case=False, parent_task_id=None, or_queries=None, sorting=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.assignee_not_in = assignee_not_in
        self.owner = owner
    ...
    def process_instance_business_key_expression(self):
        ...
        Restrict to tasks that belong to process instances with the given business key which  is described by an expression. See the  [user guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/expression-language/#internal-context-functions) for more information on available functions.  # noqa: E501
    ...
    def assignee_expression(self):
        ...
        Restrict to tasks that the user described by the given expression is assigned to. See the [user guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def assignee_like_expression(self):
        ...
        Restrict to tasks that have an assignee that has the parameter value described by the  given expression as a substring. See the  [user guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    @property
    def assignee_not_in(self):
        """Gets the assignee_not_in of this TaskQueryDto.  # noqa: E501

        Only include tasks which are not assigned to one of the passed and comma-separated user ids.  # noqa: E501

        :return: The assignee_not_in of this TaskQueryDto.  # noqa: E501
        :rtype: list[str]
        """
        return self._assignee_not_in

    @assignee_not_in.setter
    def assignee_not_in(self, assignee_not_in):
        """Sets the assignee_not_in of this TaskQueryDto.

        Only include tasks which are not assigned to one of the passed and comma-separated user ids.  # noqa: E501

        :param assignee_not_in: The assignee_not_in of this TaskQueryDto.  # noqa: E501
        :type: list[str]
        """

        self._assignee_not_in = assignee_not_in
    ...
    def owner_expression(self):
        ...
        Restrict to tasks that the user described by the given expression owns. See the  [user guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def candidate_group_expression(self):
        ...
        Only include tasks that are offered to the group described by the given expression.  See the  [user guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def candidate_user_expression(self):
        ...
        Only include tasks that are offered to the user described by the given expression.  See the  [user guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def due_date(self):
        ...
        Restrict to tasks that are due on the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.546+0200`.  # noqa: E501
    ...
    def due_after(self):
        ...
        Restrict to tasks that are due after the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.435+0200`.  # noqa: E501
    ...
    def due_before(self):
        ...
        Restrict to tasks that are due before the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.243+0200`.  # noqa: E501
    ...
    def without_due_date(self):
        """Gets the without_due_date of this TaskQueryDto.  # noqa: E501

        Only include tasks which have no due date. Value may only be `true`,  as `false` is the default behavior.  # noqa: E501

        :return: The without_due_date of this TaskQueryDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def without_due_date(self, without_due_date):
        """Sets the without_due_date of this TaskQueryDto.

        Only include tasks which have no due date. Value may only be `true`,  as `false` is the default behavior.  # noqa: E501

        :param without_due_date: The without_due_date of this TaskQueryDto.  # noqa: E501
        :type: bool
        """
    ...
    def follow_up_date(self):
        ...
        Restrict to tasks that have a followUp date on the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.342+0200`.  # noqa: E501
    ...
    def follow_up_after(self):
        ...
        Restrict to tasks that have a followUp date after the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.542+0200`.  # noqa: E501
    ...
    def follow_up_before(self):
        ...
        Restrict to tasks that have a followUp date before the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.234+0200`.  # noqa: E501
    ...
    def created_on(self):
        ...
        Restrict to tasks that were created on the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.324+0200`.  # noqa: E501
    ...
    def created_after(self):
        ...
        Restrict to tasks that were created after the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.342+0200`.  # noqa: E501
    ...
    def created_before(self):
        ...
        Restrict to tasks that were created before the given date. By [default](https://docs.camunda.org/manual/7.16/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.332+0200`.  # noqa: E501
    ...
    def delegation_state(self, delegation_state):
        ...
        :type: str
        """
        allowed_values = [None,"PENDING", "RESOLVED"]  # noqa: E501
    ...
    def candidate_groups_expression(self):
        ...
        Restrict to tasks that are offered to any of the candidate groups described by the given expression. See the [user guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/expression-language/#internal-context-functions) for more information on available functions. The expression must evaluate to `java.util.List` of Strings.  # noqa: E501
    ...
    def process_variables(self):
        ...
        A JSON array to only include tasks that belong to a process instance with variables with certain values. The array consists of JSON objects with three properties `name`, `operator` and `value`. `name` is the variable name, `operator` is the comparison operator to be used and `value` the variable value. `value` may be of type `String`, `Number` or `Boolean`.  Valid `operator` values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`; `notLike`. `key` and `value` may not contain underscore or comma characters.  # noqa: E501
