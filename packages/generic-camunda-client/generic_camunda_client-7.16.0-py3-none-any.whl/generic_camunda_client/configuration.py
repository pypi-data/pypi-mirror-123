...
class Configuration(object):
    ...
    def __init__(self, host="http://localhost:8080/engine-rest",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("generic_camunda_client")
