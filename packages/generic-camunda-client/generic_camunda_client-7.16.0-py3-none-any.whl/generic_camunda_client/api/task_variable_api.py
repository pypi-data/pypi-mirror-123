...
class TaskVariableApi(object):
    ...
    def delete_task_variable(self, id, var_name, **kwargs):  # noqa: E501
        """Delete Task Variable  # noqa: E501

        Removes a variable that is visible to a task. A variable is visible to a task if it is a local task variable or declared in a parent scope of the task. See documentation on [visiblity of variables](https://docs.camunda.org/manual/7.16/user-guide/process-engine/variables/).  # noqa: E501
    ...
    def get_task_variable_binary(self, id, var_name, **kwargs):  # noqa: E501
        """Get Task Variable (Binary)  # noqa: E501
    ...
    def get_task_variables(self, id, **kwargs):  # noqa: E501
        """Get Task Variables  # noqa: E501

        Retrieves all variables visible from the task. A variable is visible from the task if it is a local task variable or declared in a parent scope of the task. See documentation on [visiblity of variables](https://docs.camunda.org/manual/7.16/user-guide/process-engine/variables/).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def modify_task_variables(self, id, **kwargs):  # noqa: E501
        """Update/Delete Task Variables  # noqa: E501
    ...
    def put_task_variable(self, id, var_name, **kwargs):  # noqa: E501
        """Update Task Variable  # noqa: E501

        Updates a process variable that is visible from the Task scope. A variable is visible from the task if it is a local task variable, or declared in a parent scope of the task. See the documentation on [variable scopes and visibility](https://docs.camunda.org/manual/7.16/user-guide/process-engine/variables#variable-scopes-and-variable-visibility).  **Note**: If a variable doesn't exist, the variable is created in the top-most scope visible from the task.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def set_binary_task_variable(self, id, var_name, **kwargs):  # noqa: E501
        """Update Task Variable (Binary)  # noqa: E501
