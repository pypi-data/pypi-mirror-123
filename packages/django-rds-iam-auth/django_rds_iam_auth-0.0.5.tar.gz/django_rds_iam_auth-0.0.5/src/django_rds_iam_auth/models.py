...
class User(AbstractUser):
    ...
    UserPoolId = models.CharField(max_length=255, null=True)
    IdentityPoolId = models.CharField(max_length=255, null=True)
...
class Tenant(models.Model):
    ...
    user_pool_id = models.CharField(max_length=255, null=True, blank=True)
    user_pool_client_id = models.CharField(max_length=255, null=True, blank=True)
    identity_pool_id = models.CharField(max_length=255, null=True, blank=True)
    logo = models.TextField(blank=True, null=True)
    bucket_name = models.CharField(max_length=255)
    is_active = models.BooleanField(default=True)
    is_iot_core = models.BooleanField(default=False)
