...
class EntityUrlMap:
    ...
    if config_profile.PROFILE == Constants.DEVELOP:
        _HOST_INSTITUTION = 'http://192.168.0.11:8091/institutions/'
        _HOST_USER = 'http://192.168.0.11:8092/users/'
        _HOST_PUBLICATION = 'http://192.168.0.11:8093/publications/'
        _HOST_CHAT = 'http://192.168.0.11:8097/chats/'
        _HOST_SECURITY = 'http://192.168.0.11:8094/securities/'
        _HOST_NOTIFICATION = 'http://192.168.0.11:8098/notifications/'
    else:
