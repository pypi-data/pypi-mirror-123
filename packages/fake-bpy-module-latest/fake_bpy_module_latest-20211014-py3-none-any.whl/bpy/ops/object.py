...
def add_named(duplicate: bool = True,
              linked: bool = False,
              name: str = "",
              drop_x: int = 0,
              drop_y: int = 0):
    ...
    :param duplicate: Duplicate, Create a duplicate of the object. If not set, only ensures the object is linked into the active view layer, positions and selects/activates it (deselecting others)
    :type duplicate: bool
    :param linked: Linked, Duplicate object but not object data, linking to the original data (ignored if 'duplicate' is false)
    :type linked: bool
