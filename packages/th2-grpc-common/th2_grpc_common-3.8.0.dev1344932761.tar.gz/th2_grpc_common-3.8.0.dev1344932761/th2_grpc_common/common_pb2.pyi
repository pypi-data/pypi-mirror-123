...
class ValueFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"kind",b"kind",u"list_filter",b"list_filter",u"message_filter",b"message_filter",u"simple_filter",b"simple_filter",u"simple_list",b"simple_list"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"key",b"key",u"kind",b"kind",u"list_filter",b"list_filter",u"message_filter",b"message_filter",u"operation",b"operation",u"simple_filter",b"simple_filter",u"simple_list",b"simple_list"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"kind",b"kind"]) -> typing_extensions.Literal["simple_filter","message_filter","list_filter","simple_list"]: ...
...
class Checkpoint(google.protobuf.message.Message):
    ...
    class DirectionCheckpoint(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"direction_to_checkpoint_data",b"direction_to_checkpoint_data",u"direction_to_sequence",b"direction_to_sequence"]) -> None: ...
