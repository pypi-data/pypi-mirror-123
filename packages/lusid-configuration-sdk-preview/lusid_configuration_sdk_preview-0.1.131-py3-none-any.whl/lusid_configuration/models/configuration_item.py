...
class ConfigurationItem(object):
    ...
    def __init__(self, created_at=None, created_by=None, last_modified_at=None, last_modified_by=None, description=None, key=None, value=None, type=None, ref=None, local_vars_configuration=None):  # noqa: E501
