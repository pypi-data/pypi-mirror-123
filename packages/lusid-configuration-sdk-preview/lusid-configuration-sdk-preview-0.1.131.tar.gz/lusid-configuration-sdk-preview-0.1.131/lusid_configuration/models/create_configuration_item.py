...
class CreateConfigurationItem(object):
    ...
    def __init__(self, key=None, value=None, type=None, description=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type value: str
        :param type:  The type (text or secret) of the new configuration item (required)
        :type type: str
    ...
    def description(self, description):
        ...
        if (self.local_vars_configuration.client_side_validation and
                description is not None and not re.search(r'^([\p{L}\p{Z}\p{N}_.:\/=+\-@]*)$', description)):  # noqa: E501
            raise ValueError(r"Invalid value for `description`, must be a follow pattern or equal to `/^([\p{L}\p{Z}\p{N}_.:\/=+\-@]*)$/`")  # noqa: E501
