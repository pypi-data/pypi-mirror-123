...
function IconBusinessComponent(_a) {
    ...
    return (<svgIcon_1.default {...props} ref={forwardRef}>
      ...
      <rect fill={gradient ? `url(#${gradientId})` : 'currentColor'} mask={`url(#${maskId})`} height="100%" width="100%"/>

      {withShine && (<g mask={`url(#${maskId})`}>
          <ShineRect fill={`url(#${shineId})`} height="100%" width="100%"/>
        </g>)}
    </svgIcon_1.default>);
}
const IconBusiness = React.forwardRef((props, ref) => (<IconBusinessComponent {...props} forwardRef={ref}/>));
exports.IconBusiness = IconBusiness;
IconBusiness.displayName = 'IconBusiness';
const shine = (0, react_1.keyframes) `
  0% {
...
`;
const ShineRect = (0, styled_1.default)('rect') `
  transform: translateX(-100%);
