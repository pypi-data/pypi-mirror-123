...
exports.aliases = exports.darkTheme = exports.lightTheme = void 0;
...
const lightAliases = {
    ...
    searchTokenBackground: {
        valid: '#E8F3FE',
        validActive: (0, color_1.default)('#E8F3FE').darken(0.02).string(),
        invalid: colors.red100,
        invalidActive: (0, color_1.default)(colors.red100).darken(0.02).string(),
    },
    /**
    ...
    searchTokenBorder: {
        valid: '#B5DAFF',
        validActive: (0, color_1.default)('#B5DAFF').darken(0.15).string(),
        invalid: colors.red300,
        invalidActive: (0, color_1.default)(colors.red300).darken(0.15).string(),
    },
    /**
...
exports.aliases = lightAliases;
const dataCategory = {
    [types_1.DataCategory.ERRORS]: chartPalette_1.default[4][3],
    [types_1.DataCategory.TRANSACTIONS]: chartPalette_1.default[4][2],
    [types_1.DataCategory.ATTACHMENTS]: chartPalette_1.default[4][1],
    [types_1.DataCategory.DEFAULT]: chartPalette_1.default[4][0],
};
const generateAlertTheme = (alias) => ({
    ...
    info: {
        ...
        backgroundLight: (0, color_1.default)(colors.blue100).alpha(alias.alertBackgroundAlpha).string(),
        border: colors.blue200,
        iconColor: colors.blue300,
    },
    warning: {
        background: colors.yellow300,
        backgroundLight: (0, color_1.default)(colors.yellow100).alpha(alias.alertBackgroundAlpha).string(),
        border: colors.yellow300,
        iconColor: colors.yellow300,
    },
    success: {
        background: colors.green300,
        backgroundLight: (0, color_1.default)(colors.green100).alpha(alias.alertBackgroundAlpha).string(),
        border: colors.green200,
        iconColor: colors.green300,
    },
    error: {
        background: colors.red300,
        backgroundLight: (0, color_1.default)(colors.red100).alpha(alias.alertBackgroundAlpha).string(),
...
const generateButtonTheme = (alias) => ({
    ...
    default: {
        ...
        focusShadow: (0, color_1.default)(colors.gray200).alpha(0.5).string(),
    },
    primary: {
        color: colors.white,
        ...
        focusShadow: (0, color_1.default)(colors.purple300).alpha(0.4).string(),
    },
    success: {
        color: colors.white,
        colorActive: colors.white,
        ...
        border: '#7ccca5',
        borderActive: '#7ccca5',
        focusShadow: (0, color_1.default)(colors.green300).alpha(0.5).string(),
    },
    danger: {
        color: colors.white,
        colorActive: colors.white,
        ...
        border: '#bf2a1d',
        borderActive: '#7d1c13',
        focusShadow: (0, color_1.default)(colors.red300).alpha(0.5).string(),
    },
    link: {
...
const commonTheme = Object.assign(Object.assign({ breakpoints: ['800px', '992px', '1200px', '1440px', '2560px'] }, colors), { iconSizes, iconDirections: {
        up: '0',
        right: '90',
        down: '180',
        left: '270',
    ...
    tag,
    level, charts: {
        colors: chartPalette_1.default[chartPalette_1.default.length - 1],
        // We have an array that maps `number + 1` --> list of `number` colors
        getColorPalette: (length) => chartPalette_1.default[Math.min(chartPalette_1.default.length - 1, length + 1)],
...
const darkAliases = Object.assign(Object.assign({}, lightAliases), { bodyBackground: colors.black, headerBackground: colors.gray500, background: colors.black, backgroundSecondary: colors.gray500, border: colors.gray400, innerBorder: colors.gray500, modalBorder: `1px solid ${colors.gray400}`, modalBoxShadow: '0 15px 40px 0 rgb(67 62 75 / 30%), 0 1px 15px 0 rgb(67 61 74 / 15%)', textColor: colors.white, subText: colors.gray200, linkColor: colors.blue200, linkHoverColor: colors.blue300, disabled: colors.gray400, active: colors.pink300, focus: colors.gray500, inactive: colors.gray200, error: colors.red300, success: colors.green300, primaryButtonBorder: colors.purple200, primaryButtonBorderActive: colors.purple200, secondaryButtonText: colors.purple200, secondaryButtonBorder: colors.purple200, sidebarGradient: 'linear-gradient(6.01deg, #0A090F -8.44%, #1B0921 85.02%)', formPlaceholder: colors.gray400, formText: colors.white, formInputBorder: colors.gray400, rowBackground: colors.gray500, chartLineColor: colors.gray500, chartLabel: colors.gray400, chartOther: colors.gray300, progressBar: colors.purple200, progressBackground: colors.gray400, badgeBackground: colors.gray400, alertBackgroundAlpha: 0.1, overlayBackgroundAlpha: 'rgba(18, 9, 23, 0.7)', tagBarHover: colors.purple300, tagBar: colors.gray400, businessIconColors: [colors.pink100, colors.pink300], badgeText: colors.black, searchTokenBackground: {
        valid: '#1F1A3D',
        validActive: (0, color_1.default)('#1F1A3D').lighten(0.05).string(),
        invalid: (0, color_1.default)(colors.red300).darken(0.8).string(),
        invalidActive: (0, color_1.default)(colors.red300).darken(0.7).string(),
    }, searchTokenBorder: {
        valid: '#554E80',
        validActive: (0, color_1.default)('#554E80').lighten(0.15).string(),
        invalid: (0, color_1.default)(colors.red300).darken(0.5).string(),
        invalidActive: (0, color_1.default)(colors.red300).darken(0.4).string(),
    }, buttonCountActive: colors.gray100, buttonCount: colors.gray400, bannerBackground: colors.purple100 });
exports.lightTheme = Object.assign(Object.assign(Object.assign({}, commonTheme), lightAliases), { alert: generateAlertTheme(lightAliases), badge: generateBadgeTheme(lightAliases), button: generateButtonTheme(lightAliases) });
exports.darkTheme = Object.assign(Object.assign(Object.assign({}, commonTheme), darkAliases), { alert: generateAlertTheme(darkAliases), badge: generateBadgeTheme(darkAliases), button: generateButtonTheme(darkAliases) });
exports.default = commonTheme;
