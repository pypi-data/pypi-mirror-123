...
const promptsActivity_1 = require("./promptsActivity");
const promptIsDismissed = (prompt, daysToSnooze = 14) => {
    ...
    return !snoozedTime ? false : (0, promptsActivity_1.snoozedDays)(snoozedTime) < daysToSnooze;
};
