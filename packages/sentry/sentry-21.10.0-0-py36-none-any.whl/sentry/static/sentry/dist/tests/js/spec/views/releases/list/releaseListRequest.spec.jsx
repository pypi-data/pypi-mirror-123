...
const releaseListRequest_1 = (0, tslib_1.__importDefault)(require("app/views/releases/list/releaseListRequest"));
const utils_1 = require("app/views/releases/list/utils");
describe('ReleaseListRequest', function () {
    const { organization, routerContext, router } = (0, initializeOrg_1.initializeOrg)();
    const projectId = 123;
    const selection = {
        projects: [projectId],
        environments: [],
    ...
    MockApiClient.addMockResponse({
        ...
        predicate(_url, { query }) {
            return (0, isEqual_1.default)(query, {
                query: 'release:7a82c130be9143361f20bc77252df783cf91e4fc OR release:e102abb2c46e7fe8686441091005c12aed90da99',
                interval: '1d',
                statsPeriod: '14d',
                project: [projectId],
                field: ['sum(session)'],
    ...
    it('calculates correct session health data', function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let healthData;
            const wrapper = (0, enzyme_1.mountWithTheme)(<releaseListRequest_1.default releases={[
                    '7a82c130be9143361f20bc77252df783cf91e4fc',
                    'e102abb2c46e7fe8686441091005c12aed90da99',
                ]} organization={organization} location={Object.assign(Object.assign({}, router.location), { query: {
                        project: [projectId],
                    } })} display={[utils_1.DisplayOption.SESSIONS]} selection={selection}>
        {({ getHealthData }) => {
                    healthData = getHealthData;
                    return null;
                }}
      </releaseListRequest_1.default>, routerContext);
            // @ts-expect-error
            yield tick();
            wrapper.update();
            expect(healthData.getCrashCount('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.SESSIONS)).toBe(492);
            expect(healthData.getCrashFreeRate('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.SESSIONS)).toBe(99.76);
            expect(healthData.get24hCountByRelease('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.SESSIONS)).toBe(219826);
            expect(healthData.get24hCountByProject(projectId, utils_1.DisplayOption.SESSIONS)).toBe(835965);
            expect(healthData.getTimeSeries('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.SESSIONS)).toEqual([
                {
                    data: [
            ...
            expect(healthData.getAdoption('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.SESSIONS)).toBe(26.29607698886915);
            expect(healthData.getCrashCount('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.SESSIONS)).toBe(5);
            expect(healthData.getCrashFreeRate('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.SESSIONS)).toBe(99.921);
            expect(healthData.get24hCountByRelease('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.SESSIONS)).toBe(6320);
            expect(healthData.get24hCountByProject(projectId, utils_1.DisplayOption.SESSIONS)).toBe(835965);
            expect(healthData.getTimeSeries('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.SESSIONS)).toEqual([
                {
                    data: [
                        { name: 1615975200000, value: 0 },
                        { name: 1615978800000, value: 0 },
            ...
            expect(healthData.getAdoption('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.SESSIONS)).toBe(0.7560125124855706);
            expect(requestForAutoHealthStatsPeriodSessionHistogram).toHaveBeenCalledTimes(0);
        });
    });
    it('calculates correct user health data', function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let healthData;
            const wrapper = (0, enzyme_1.mountWithTheme)(<releaseListRequest_1.default releases={[
                    '7a82c130be9143361f20bc77252df783cf91e4fc',
                    'e102abb2c46e7fe8686441091005c12aed90da99',
                        ...
                        project: [projectId],
                    } })} display={[utils_1.DisplayOption.USERS]} selection={selection}>
        {({ getHealthData }) => {
                    healthData = getHealthData;
                    return null;
                }}
            ...
            wrapper.update();
            expect(healthData.getCrashCount('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.SESSIONS)).toBe(492);
            expect(healthData.getCrashFreeRate('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.USERS)).toBe(99.908);
            expect(healthData.get24hCountByRelease('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.USERS)).toBe(56826);
            expect(healthData.get24hCountByProject(projectId, utils_1.DisplayOption.USERS)).toBe(140965);
            expect(healthData.getTimeSeries('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.USERS)).toEqual([
                {
                    data: [
                        { name: 1615975200000, value: 0 },
                        { name: 1615978800000, value: 0 },
            ...
            expect(healthData.getAdoption('7a82c130be9143361f20bc77252df783cf91e4fc', projectId, utils_1.DisplayOption.USERS)).toBe(40.31213421771362);
            expect(healthData.getCrashCount('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.SESSIONS)).toBe(5);
            expect(healthData.getCrashFreeRate('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.USERS)).toBe(99.87);
            expect(healthData.get24hCountByRelease('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.USERS)).toBe(850);
            expect(healthData.get24hCountByProject(projectId, utils_1.DisplayOption.USERS)).toBe(140965);
            expect(healthData.getTimeSeries('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.USERS)).toEqual([
                {
                    data: [
                        { name: 1615975200000, value: 0 },
                        { name: 1615978800000, value: 0 },
            ...
            expect(healthData.getAdoption('e102abb2c46e7fe8686441091005c12aed90da99', projectId, utils_1.DisplayOption.USERS)).toBe(0.6029865569467598);
        });
    });
    it('calculates correct session count histogram (auto period)', function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let healthData;
            const wrapper = (0, enzyme_1.mountWithTheme)(<releaseListRequest_1.default releases={[
                    '7a82c130be9143361f20bc77252df783cf91e4fc',
                    'e102abb2c46e7fe8686441091005c12aed90da99',
                        ...
                        project: [projectId],
                    } })} display={[utils_1.DisplayOption.SESSIONS]} selection={selection} healthStatsPeriod={types_1.HealthStatsPeriodOption.AUTO}>
        {({ getHealthData }) => {
                    healthData = getHealthData;
                    return null;
                }}
...
//# sourceMappingURL=releaseListRequest.spec.jsx.map