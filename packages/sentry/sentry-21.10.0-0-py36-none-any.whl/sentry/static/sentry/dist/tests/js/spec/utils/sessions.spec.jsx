...
describe('utils/sessions', () => {
    describe('getCount', () => {
        ...
        it('returns sessions count', () => {
            expect((0, sessions_1.getCount)(groups, types_1.SessionField.SESSIONS)).toBe(1942);
        });
        it('returns users count', () => {
            expect((0, sessions_1.getCount)(groups, types_1.SessionField.USERS)).toBe(720);
        });
    });
    describe('getCrashFreeRate', () => {
        const { groups } = sessionsApiResponse;
        it('returns crash free sessions', () => {
            expect((0, sessions_1.getCrashFreeRate)(groups, types_1.SessionField.SESSIONS)).toBe(98.751);
        });
        it('returns crash free users', () => {
            expect((0, sessions_1.getCrashFreeRate)(groups, types_1.SessionField.USERS)).toBe(95.332);
        });
    });
    describe('getSessionStatusRate', () => {
        const { groups } = sessionsApiResponse;
        it('returns errored sessions rate', () => {
            expect((0, sessions_1.getSessionStatusRate)(groups, types_1.SessionField.SESSIONS, types_1.SessionStatus.ERRORED)).toBe(0.10153484522890543);
        });
        it('returns healthy users rate', () => {
            expect((0, sessions_1.getSessionStatusRate)(groups, types_1.SessionField.USERS, types_1.SessionStatus.HEALTHY)).toBe(90.14373716632443);
        });
    });
    describe('getSessionsInterval', () => {
        describe('with high fidelity', () => {
            it('greater than 14 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '15d' }, { highFidelity: true })).toBe('1d');
            });
            it('greater than 7 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '8d' }, { highFidelity: true })).toBe('6h');
            });
            it('30 minutes or less', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '28m' }, { highFidelity: true })).toBe('1m');
            });
            it('between one week and six hours', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '1d' }, { highFidelity: true })).toBe('1h');
            });
            it('between 6 hours and 30 minutes', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '31m' }, { highFidelity: true })).toBe('5m');
            });
            it('less or equal to 30 minutes', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '30m' }, { highFidelity: true })).toBe('1m');
            });
            it('ignores high fidelity flag if start is older than 30d', () => {
                expect((0, sessions_1.getSessionsInterval)({ start: '2017-09-15T02:41:20Z', end: '2017-09-15T02:42:20Z' }, { highFidelity: true })).toBe('1h');
            });
        });
        describe('with low fidelity', () => {
            it('greater than 14 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '15d' })).toBe('1d');
                expect((0, sessions_1.getSessionsInterval)({ start: '2021-07-19T15:14:23Z', end: '2021-08-03T15:13:32Z' }, { highFidelity: true })).toBe('1d');
            });
            it('greater than 7 days', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '8d' })).toBe('6h');
            });
            it('30 minutes or less', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '28m' })).toBe('1h');
            });
            it('between one week and six hours', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '1d' })).toBe('1h');
            });
            it('between 6 hours and 30 minutes', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '31m' })).toBe('1h');
            });
            it('less or equal to 30 minutes', () => {
                expect((0, sessions_1.getSessionsInterval)({ period: '30m' })).toBe('1h');
            });
        });
    });
    describe('filterSessionsInTimeWindow', () => {
        it('filters out intervals/series out of bounds', () => {
            const filtered = (0, sessions_1.filterSessionsInTimeWindow)(sessionsApiResponse, '2021-07-09T23:12:57.265410Z', '2021-07-11T14:49:59Z');
...
//# sourceMappingURL=sessions.spec.jsx.map