...
const filter_1 = require("app/components/events/interfaces/spans/filter");
const waterfallModel_1 = (0, tslib_1.__importDefault)(require("app/components/events/interfaces/spans/waterfallModel"));
...
describe('WaterfallModel', () => {
    ...
    it('isEvent', () => {
        const waterfallModel = new waterfallModel_1.default(event);
        expect(waterfallModel.event).toMatchObject(event);
        expect(waterfallModel.isEvent(event)).toBe(true);
        expect(waterfallModel.isEvent(Object.assign(Object.assign({}, event), { id: 'somethingelse' }))).toBe(false);
    });
    ...
    it('toggleOperationNameFilter', () => {
        ...
        const operationNameFilters = waterfallModel.operationNameFilters;
    ...
    it('toggleAllOperationNameFilters', () => {
        ...
        let operationNameFilters = waterfallModel.operationNameFilters;
        expect(operationNameFilters.type).toBe('active_filter');
    ...
    it('querySpanSearch', () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const waterfallModel = new waterfallModel_1.default(event);
    ...
    it('getWaterfall()', () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const waterfallModel = new waterfallModel_1.default(event);
        // Fuzzy search needs to be loaded asynchronously
        // @ts-expect-error
        yield tick();
        ...
        (0, utils_1.assert)(fullWaterfall[10].type === 'span_group_chain' && fullWaterfall[10].spanGrouping);
        expected = [
            {
                type: 'filtered_out',
    ...
    it('toggleSpanGroup()', () => {
        ...
        expect(spans).toEqual(fullWaterfall.filter((_span, index) => {
    ...
    it('span grouping - only child parent-child chain - root is not grouped', () => {
        ...
        const waterfallModel = new waterfallModel_1.default(event2);
        const spans = waterfallModel.getWaterfall({
            viewStart: 0,
            viewEnd: 1,
        });
        expect(spans).toEqual([
            Object.assign(Object.assign({}, fullWaterfall[0]), { numOfSpanChildren: 0, toggleSpanGroup: undefined }),
        ]);
    });
    it('span grouping - only child parent-child chain - root span and a span (2 spans) are not grouped', () => {
        ...
        expect(spans).toEqual([
            Object.assign(Object.assign({}, fullWaterfall[0]), { numOfSpanChildren: 1, toggleSpanGroup: undefined }),
            Object.assign(Object.assign({}, fullWaterfall[1]), { isLastSibling: true, numOfSpanChildren: 0, toggleSpanGroup: undefined }),
        ]);
    });
    it('span grouping - only child parent-child chain - root span and 2 spans (3 spans) are not grouped', () => {
        const event2 = Object.assign(Object.assign({}, event), { entries: [
                {
                    data: [
                        ...
                        Object.assign(Object.assign({}, event.entries[0].data[0]), { parent_span_id: event.entries[0].data[0].span_id, span_id: 'foo' }),
                    ],
                    type: event_1.EntryType.SPANS,
                },
            ] });
        ...
        expect(spans).toEqual([
            Object.assign(Object.assign({}, fullWaterfall[0]), { treeDepth: 0, numOfSpanChildren: 1, toggleSpanGroup: undefined }),
            Object.assign(Object.assign({}, fullWaterfall[1]), { treeDepth: 1, isLastSibling: true, numOfSpanChildren: 1, toggleSpanGroup: undefined }),
            Object.assign(Object.assign({}, fullWaterfall[1]), { span: Object.assign(Object.assign({}, fullWaterfall[1].span), { parent_span_id: event.entries[0].data[0].span_id, span_id: 'foo' }), treeDepth: 2, isLastSibling: true, numOfSpanChildren: 0, toggleSpanGroup: undefined }),
        ]);
    });
    it('span grouping - only child parent-child chain - root span and 3+ spans (4 spans) are not grouped', () => {
        const event2 = Object.assign(Object.assign({}, event), { entries: [
                {
                    data: [
                        event.entries[0].data[0],
                        Object.assign(Object.assign({}, event.entries[0].data[0]), { parent_span_id: event.entries[0].data[0].span_id, span_id: 'foo' }),
                        Object.assign(Object.assign({}, event.entries[0].data[0]), { parent_span_id: 'foo', span_id: 'bar' }),
                    ],
                    type: event_1.EntryType.SPANS,
                },
            ] });
        ...
        (0, utils_1.assert)(fullWaterfall[1].type === 'span');
        const collapsedWaterfallExpected = [
            Object.assign(Object.assign({}, fullWaterfall[0]), { numOfSpanChildren: 1, toggleSpanGroup: undefined }),
            {
                ...
                span: Object.assign(Object.assign({}, fullWaterfall[1].span), { parent_span_id: 'foo', span_id: 'bar' }),
                spanGrouping: [
                    Object.assign(Object.assign({}, fullWaterfall[1]), { isLastSibling: true, numOfSpanChildren: 1, toggleSpanGroup: undefined }),
                    Object.assign(Object.assign({}, fullWaterfall[1]), { span: Object.assign(Object.assign({}, fullWaterfall[1].span), { parent_span_id: event.entries[0].data[0].span_id, span_id: 'foo' }), isLastSibling: true, numOfSpanChildren: 1, toggleSpanGroup: undefined }),
                ],
                showSpanGroup: false,
                toggleSpanGroup: expect.any(Function),
            },
            Object.assign(Object.assign({}, fullWaterfall[1]), { span: Object.assign(Object.assign({}, fullWaterfall[1].span), { parent_span_id: 'foo', span_id: 'bar' }), isLastSibling: true, numOfSpanChildren: 0, treeDepth: 2, toggleSpanGroup: undefined }),
        ];
        expect(spans).toEqual(collapsedWaterfallExpected);
        // Expand span group
        (0, utils_1.assert)(spans[1].type === 'span' && spans[1].toggleSpanGroup);
        ...
        expect(spans).toEqual([
            Object.assign(Object.assign({}, fullWaterfall[0]), { numOfSpanChildren: 1, treeDepth: 0, toggleSpanGroup: undefined }),
            Object.assign(Object.assign({}, fullWaterfall[1]), { isLastSibling: true, numOfSpanChildren: 1, treeDepth: 1, toggleSpanGroup: expect.any(Function) }),
            Object.assign(Object.assign({}, fullWaterfall[1]), { span: Object.assign(Object.assign({}, fullWaterfall[1].span), { parent_span_id: event.entries[0].data[0].span_id, span_id: 'foo' }), isLastSibling: true, numOfSpanChildren: 1, treeDepth: 2, toggleSpanGroup: undefined }),
            Object.assign(Object.assign({}, fullWaterfall[1]), { span: Object.assign(Object.assign({}, fullWaterfall[1].span), { parent_span_id: 'foo', span_id: 'bar' }), isLastSibling: true, numOfSpanChildren: 0, treeDepth: 3, toggleSpanGroup: undefined }),
        ]);
        // Collapse span group
        (0, utils_1.assert)(spans[1].type === 'span' && spans[1].toggleSpanGroup);
        spans[1].toggleSpanGroup();
