...
class PipelineApi(object):
    ...
    def get_training_pipeline_runs(self, pipeline_id, project_id, **kwargs):  # noqa: E501
        ...
        :param str pipeline_id: The training pipeline's ID. (required)
        :param str project_id: Project ID of pipeline. (required)
        :param list[str] status: Allowed statuses of pipeline runs
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def log_step_metrics_with_http_info(self, project_id, pipeline_id, run_id, step_name, **kwargs):  # noqa: E501
        ...
        # Authentication setting
        auth_settings = ['AccessTokenAuth', 'BearerAuth', 'InternalTokenAuth']  # noqa: E501
    ...
    def update_batch_scoring_pipeline_credentials(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_batch_scoring_pipeline_credentials  # noqa: E501

        Update the credentials associated with a batch scoring pipeline.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_batch_scoring_pipeline_credentials(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str pipeline_public_id: pipeline public id (required)
        :param str project_id: Project ID of pipeline. (required)
        :param UpdateVCSCredentialsSchema update_vcs_credentials_schema:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: BatchScoringPipelineSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.update_batch_scoring_pipeline_credentials_with_http_info(pipeline_public_id, project_id, **kwargs)  # noqa: E501

    def update_batch_scoring_pipeline_credentials_with_http_info(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_batch_scoring_pipeline_credentials  # noqa: E501

        Update the credentials associated with a batch scoring pipeline.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_batch_scoring_pipeline_credentials_with_http_info(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(BatchScoringPipelineSchema, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['pipeline_public_id', 'project_id', 'update_vcs_credentials_schema']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_batch_scoring_pipeline_credentials" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pipeline_public_id' is set
        if ('pipeline_public_id' not in local_var_params or
                local_var_params['pipeline_public_id'] is None):
            raise ApiValueError("Missing the required parameter `pipeline_public_id` when calling `update_batch_scoring_pipeline_credentials`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in local_var_params or
                local_var_params['project_id'] is None):
            raise ApiValueError("Missing the required parameter `project_id` when calling `update_batch_scoring_pipeline_credentials`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'pipeline_public_id' in local_var_params:
            path_params['pipeline_public_id'] = local_var_params['pipeline_public_id']  # noqa: E501
        ...
        body_params = None
        if 'update_vcs_credentials_schema' in local_var_params:
            body_params = local_var_params['update_vcs_credentials_schema']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/batch_scoring_pipeline/{pipeline_public_id}/credentials', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='BatchScoringPipelineSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def update_batch_scoring_pipeline_default_secrets(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_batch_scoring_pipeline_default_secrets  # noqa: E501

        Update the default secrets associated with a batch scoring pipeline. This is a bulk update api, i.e. it will replace all the secrets for a specific pipeline with the secrets from this api call, in key-value format following these rules:   * To add/update a secret, include the secret name with new value in the request body.   * To keep an existing secret unchanged, include the secret name with null value.   * To delete an existing secret, exclude the secret name from the request body. For example, consider the pipeline with existing pipeline secrets     {\"first\": \"1\", \"second\": \"2\"} To add a new secret \"third\" and delete the existing secret \"second\", the api call should have the following request body: {\"first\": null, \"third\": \"value\"}   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_batch_scoring_pipeline_default_secrets(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_batch_scoring_pipeline_default_secrets_with_http_info(pipeline_public_id, project_id, **kwargs)  # noqa: E501

    def update_batch_scoring_pipeline_default_secrets_with_http_info(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_batch_scoring_pipeline_default_secrets  # noqa: E501

        Update the default secrets associated with a batch scoring pipeline. This is a bulk update api, i.e. it will replace all the secrets for a specific pipeline with the secrets from this api call, in key-value format following these rules:   * To add/update a secret, include the secret name with new value in the request body.   * To keep an existing secret unchanged, include the secret name with null value.   * To delete an existing secret, exclude the secret name from the request body. For example, consider the pipeline with existing pipeline secrets     {\"first\": \"1\", \"second\": \"2\"} To add a new secret \"third\" and delete the existing secret \"second\", the api call should have the following request body: {\"first\": null, \"third\": \"value\"}   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_batch_scoring_pipeline_default_secrets_with_http_info(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['pipeline_public_id', 'project_id', 'request_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_batch_scoring_pipeline_default_secrets" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pipeline_public_id' is set
        if ('pipeline_public_id' not in local_var_params or
                local_var_params['pipeline_public_id'] is None):
            raise ApiValueError("Missing the required parameter `pipeline_public_id` when calling `update_batch_scoring_pipeline_default_secrets`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in local_var_params or
                local_var_params['project_id'] is None):
            raise ApiValueError("Missing the required parameter `project_id` when calling `update_batch_scoring_pipeline_default_secrets`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/batch_scoring_pipeline/{pipeline_public_id}/secrets', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_training_pipeline_credentials(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_training_pipeline_credentials  # noqa: E501

        Update the credentials associated with a training pipeline.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_training_pipeline_credentials(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_training_pipeline_credentials_with_http_info(pipeline_public_id, project_id, **kwargs)  # noqa: E501

    def update_training_pipeline_credentials_with_http_info(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_training_pipeline_credentials  # noqa: E501

        Update the credentials associated with a training pipeline.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_training_pipeline_credentials_with_http_info(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_training_pipeline_credentials" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pipeline_public_id' is set
        if ('pipeline_public_id' not in local_var_params or
                local_var_params['pipeline_public_id'] is None):
            raise ApiValueError("Missing the required parameter `pipeline_public_id` when calling `update_training_pipeline_credentials`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in local_var_params or
                local_var_params['project_id'] is None):
            raise ApiValueError("Missing the required parameter `project_id` when calling `update_training_pipeline_credentials`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/training_pipeline/{pipeline_public_id}/credentials', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_training_pipeline_default_secrets(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_training_pipeline_default_secrets  # noqa: E501

        Update the default secrets associated with a training pipeline. This is a bulk update api, i.e. it will replace all the secrets for a specific pipeline with the secrets from this api call, in key-value format following these rules:   * To add/update a secret, include the secret name with new value in the request body.   * To keep an existing secret unchanged, include the secret name with null value.   * To delete an existing secret, exclude the secret name from the request body. For example, consider the pipeline with existing pipeline secrets     {\"first\": \"1\", \"second\": \"2\"} To add a new secret \"third\" and delete the existing secret \"second\", the api call should have the following request body: {\"first\": null, \"third\": \"value\"}   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_training_pipeline_default_secrets(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_training_pipeline_default_secrets_with_http_info(pipeline_public_id, project_id, **kwargs)  # noqa: E501

    def update_training_pipeline_default_secrets_with_http_info(self, pipeline_public_id, project_id, **kwargs):  # noqa: E501
        """update_training_pipeline_default_secrets  # noqa: E501

        Update the default secrets associated with a training pipeline. This is a bulk update api, i.e. it will replace all the secrets for a specific pipeline with the secrets from this api call, in key-value format following these rules:   * To add/update a secret, include the secret name with new value in the request body.   * To keep an existing secret unchanged, include the secret name with null value.   * To delete an existing secret, exclude the secret name from the request body. For example, consider the pipeline with existing pipeline secrets     {\"first\": \"1\", \"second\": \"2\"} To add a new secret \"third\" and delete the existing secret \"second\", the api call should have the following request body: {\"first\": null, \"third\": \"value\"}   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_training_pipeline_default_secrets_with_http_info(pipeline_public_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_training_pipeline_default_secrets" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pipeline_public_id' is set
        if ('pipeline_public_id' not in local_var_params or
                local_var_params['pipeline_public_id'] is None):
            raise ApiValueError("Missing the required parameter `pipeline_public_id` when calling `update_training_pipeline_default_secrets`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in local_var_params or
                local_var_params['project_id'] is None):
            raise ApiValueError("Missing the required parameter `project_id` when calling `update_training_pipeline_default_secrets`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/training_pipeline/{pipeline_public_id}/secrets', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
