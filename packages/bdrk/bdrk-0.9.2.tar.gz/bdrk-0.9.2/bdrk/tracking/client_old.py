...
from spanlib.infrastructure.kubernetes.env_var import HTTP_PROXY
...
class BedrockApi:
    def __init__(self, logger: Logger):
        self.logger = logger
        self.logger.warning(
            "The BedrockApi class will be deprecated in bdrk version 0.10.0. Please follow our "
            "documentation to use the new tracking client: https://pypi.org/project/bdrk/"
        )
        ...
        configuration.proxy = os.environ.get(HTTP_PROXY, None)
