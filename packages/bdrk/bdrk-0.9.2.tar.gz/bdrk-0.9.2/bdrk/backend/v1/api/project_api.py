...
class ProjectApi(object):
    ...
    def v1_project_project_id_collaborator_team_collaborator_id_delete(self, project_id, collaborator_id, **kwargs):  # noqa: E501
        """Delete a team collaborator of a project.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_project_project_id_collaborator_team_collaborator_id_delete(project_id, collaborator_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str project_id: The project's public id (required)
        :param str collaborator_id: The team collaborator's public id (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.v1_project_project_id_collaborator_team_collaborator_id_delete_with_http_info(project_id, collaborator_id, **kwargs)  # noqa: E501

    def v1_project_project_id_collaborator_team_collaborator_id_delete_with_http_info(self, project_id, collaborator_id, **kwargs):  # noqa: E501
        """Delete a team collaborator of a project.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_project_project_id_collaborator_team_collaborator_id_delete_with_http_info(project_id, collaborator_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_id', 'collaborator_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_project_project_id_collaborator_team_collaborator_id_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in local_var_params or
                local_var_params['project_id'] is None):
            raise ApiValueError("Missing the required parameter `project_id` when calling `v1_project_project_id_collaborator_team_collaborator_id_delete`")  # noqa: E501
        # verify the required parameter 'collaborator_id' is set
        if ('collaborator_id' not in local_var_params or
                local_var_params['collaborator_id'] is None):
            raise ApiValueError("Missing the required parameter `collaborator_id` when calling `v1_project_project_id_collaborator_team_collaborator_id_delete`")  # noqa: E501
        ...
        if 'project_id' in local_var_params:
            path_params['project_id'] = local_var_params['project_id']  # noqa: E501
        if 'collaborator_id' in local_var_params:
            path_params['collaborator_id'] = local_var_params['collaborator_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/project/{project_id}/collaborator/team/{collaborator_id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
