...
class ModelServerSchema(object):
    ...
    attribute_map = {
        ...
        'update_endpoint_secrets': 'update_endpoint_secrets',
    ...
    def __init__(self, created_at=None, deploy_mode=None, deploy_type=None, deployed_by=None, endpoint_id=None, id=None, image_path=None, model_version_id=None, object='server', parameters=None, resources=None, secrets=None, source=None, status=None, undeployed_at=None, undeployed_by=None, update_endpoint_secrets=False, updated_at=None, **kwargs):  # noqa: E501
        ...
        self._update_endpoint_secrets = None
        ...
        if source is not None:
            self.source = source
        if update_endpoint_secrets is not None:
            self.update_endpoint_secrets = update_endpoint_secrets
    ...
    @property
    def update_endpoint_secrets(self):
        """Gets the update_endpoint_secrets of this ModelServerSchema.  # noqa: E501


        :return: The update_endpoint_secrets of this ModelServerSchema.  # noqa: E501
        :rtype: bool
        """
        return self._update_endpoint_secrets

    @update_endpoint_secrets.setter
    def update_endpoint_secrets(self, update_endpoint_secrets):
        """Sets the update_endpoint_secrets of this ModelServerSchema.


        :param update_endpoint_secrets: The update_endpoint_secrets of this ModelServerSchema.  # noqa: E501
        :type: bool
        """

        self._update_endpoint_secrets = update_endpoint_secrets
