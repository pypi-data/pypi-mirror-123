...
class TrainingPipelineRunSchema(object):
    ...
    attribute_map = {
        ...
        'update_pipeline_secrets': 'update_pipeline_secrets',
    ...
    def __init__(self, created_at=None, created_by=None, entity_id=None, entity_number=None, environment_id=None, id=None, metrics=None, model_artefact_id=None, object='trainingPipelineRun', pipeline_id=None, schedule_number=None, script_parameters=None, secrets=None, source=None, status=None, triggered_by=None, update_pipeline_secrets=None, updated_at=None, **kwargs):  # noqa: E501
        ...
        self._update_pipeline_secrets = None
        ...
        if status is not None:
            self.status = status
        if update_pipeline_secrets is not None:
            self.update_pipeline_secrets = update_pipeline_secrets
    ...
    @property
    def update_pipeline_secrets(self):
        """Gets the update_pipeline_secrets of this TrainingPipelineRunSchema.  # noqa: E501


        :return: The update_pipeline_secrets of this TrainingPipelineRunSchema.  # noqa: E501
        :rtype: bool
        """
        return self._update_pipeline_secrets

    @update_pipeline_secrets.setter
    def update_pipeline_secrets(self, update_pipeline_secrets):
        """Sets the update_pipeline_secrets of this TrainingPipelineRunSchema.


        :param update_pipeline_secrets: The update_pipeline_secrets of this TrainingPipelineRunSchema.  # noqa: E501
        :type: bool
        """

        self._update_pipeline_secrets = update_pipeline_secrets
