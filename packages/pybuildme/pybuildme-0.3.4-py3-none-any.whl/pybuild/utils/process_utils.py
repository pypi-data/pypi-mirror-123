...
def create_process(executable : str, command : str, wait : bool = True, log_output : bool = True, callback_func : callable = None, timeout : Union[None, float] = None) -> subprocess.Popen:
    ...
    if wait:
        process.wait(timeout) if timeout is not None else process.wait()
