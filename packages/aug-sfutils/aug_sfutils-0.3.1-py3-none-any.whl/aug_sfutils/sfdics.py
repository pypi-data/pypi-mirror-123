...
typ2np = {0: np.int8, 1: np.int32, 2: np.float32, 3: np.double, 5: np.bool, \
          6: np.char, 10: np.int64, 11: np.int16, 12: np.uint16, \
          13: np.uint32, 14: np.uint64}

typ2ct = {0: ct.c_byte, 1: ct.c_int32, 2: ct.c_float, 3: ct.c_double, 5: ct.c_bool, \
          6: ct.c_char, 10: ct.c_int64, 11: ct.c_int16, 12: ct.c_uint16, \
          13: ct.c_uint32, 14: ct.c_uint64 }

fmt2typ = {1: 0, 2: 6, 3: 11, 4: 1, 5: 2, 6: 3, 7: 5, 9: 12, 13: 10, 14: 13, 15: 14, \
           1794: 6, 3842: 6, 7938: 6, 12034: 6, 16130: 6, 18178: 6}

fmt2ct = {1: ct.c_byte, 2: ct.c_char, 3: ct.c_int16, 4: ct.c_int32, \
          5: ct.c_float, 6: ct.c_double, 7: ct.c_bool, 9: ct.c_uint16, \
          13: ct.c_int64, 14: ct.c_uint32, 15: ct.c_uint64 }
...
cal_type = {0: 'NoCalib', 1: 'LinCalib', 2: 'LookUp', 3: 'extCalib'}
