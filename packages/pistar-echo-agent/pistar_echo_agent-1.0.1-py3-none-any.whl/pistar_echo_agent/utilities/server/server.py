    ...
    def __init__(
        ...
        for function in services:
            ...
            if API_DOCUMENT_FIELD.METHODS in function.__document__ \
                ...
                self.__logger.info('The api \'{api_path}\' is registered successfully.'.format(api_path=api_path))

        self.__logger.info("PiStar echo agent is ready. Agent version: 1.0.0")
