...
# if you want to set a default directory
...
- S3_SECRET_KEY
- FRED_KEY (optional)
- DEFAULT_DIR (optional; default is `sdk-python/`)
...
4. (Optional) `default_dir`: your chosen directory for where downloads will go
