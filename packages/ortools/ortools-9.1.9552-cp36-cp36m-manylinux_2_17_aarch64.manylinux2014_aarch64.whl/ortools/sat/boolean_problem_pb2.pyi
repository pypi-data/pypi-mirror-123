...
class LinearBooleanConstraint(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"lower_bound",b"lower_bound",u"name",b"name",u"upper_bound",b"upper_bound"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"coefficients",b"coefficients",u"literals",b"literals",u"lower_bound",b"lower_bound",u"name",b"name",u"upper_bound",b"upper_bound"]) -> None: ...
...
class LinearObjective(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"offset",b"offset",u"scaling_factor",b"scaling_factor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"coefficients",b"coefficients",u"literals",b"literals",u"offset",b"offset",u"scaling_factor",b"scaling_factor"]) -> None: ...
...
class LinearBooleanProblem(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"assignment",b"assignment",u"name",b"name",u"num_variables",b"num_variables",u"objective",b"objective",u"original_num_variables",b"original_num_variables"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"assignment",b"assignment",u"constraints",b"constraints",u"name",b"name",u"num_variables",b"num_variables",u"objective",b"objective",u"original_num_variables",b"original_num_variables",u"var_names",b"var_names"]) -> None: ...
