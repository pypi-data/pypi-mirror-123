...
class MPGeneralConstraintProto(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"general_constraint",b"general_constraint"]) -> typing.Optional[typing_extensions.Literal["indicator_constraint","sos_constraint","quadratic_constraint","abs_constraint","and_constraint","or_constraint","min_constraint","max_constraint"]]: ...
