...
class Task(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"cost",b"cost",u"duration",b"duration",u"machine",b"machine"]) -> None: ...
global___Task = Task
...
class Job(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"earliest_start",b"earliest_start",u"latest_end",b"latest_end"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"earliest_start",b"earliest_start",u"earliness_cost_per_time_unit",b"earliness_cost_per_time_unit",u"early_due_date",b"early_due_date",u"late_due_date",b"late_due_date",u"lateness_cost_per_time_unit",b"lateness_cost_per_time_unit",u"latest_end",b"latest_end",u"name",b"name",u"tasks",b"tasks"]) -> None: ...
global___Job = Job
...
class TransitionTimeMatrix(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"transition_time",b"transition_time"]) -> None: ...
...
class Machine(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"transition_time_matrix",b"transition_time_matrix"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"name",b"name",u"transition_time_matrix",b"transition_time_matrix"]) -> None: ...
...
class JobPrecedence(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"first_job_index",b"first_job_index",u"min_delay",b"min_delay",u"second_job_index",b"second_job_index"]) -> None: ...
...
class JsspInputProblem(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"scaling_factor",b"scaling_factor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"jobs",b"jobs",u"machines",b"machines",u"makespan_cost_per_time_unit",b"makespan_cost_per_time_unit",u"name",b"name",u"precedences",b"precedences",u"scaling_factor",b"scaling_factor",u"seed",b"seed"]) -> None: ...
...
class AssignedTask(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"alternative_index",b"alternative_index",u"start_time",b"start_time"]) -> None: ...
...
class AssignedJob(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"due_date_cost",b"due_date_cost",u"sum_of_task_costs",b"sum_of_task_costs",u"tasks",b"tasks"]) -> None: ...
...
class JsspOutputSolution(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"jobs",b"jobs",u"makespan_cost",b"makespan_cost",u"total_cost",b"total_cost"]) -> None: ...
