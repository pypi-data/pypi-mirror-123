...
class CpSolverResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["additional_solutions",b"additional_solutions","best_objective_bound",b"best_objective_bound","deterministic_time",b"deterministic_time","num_binary_propagations",b"num_binary_propagations","num_booleans",b"num_booleans","num_branches",b"num_branches","num_conflicts",b"num_conflicts","num_integer_propagations",b"num_integer_propagations","num_lp_iterations",b"num_lp_iterations","num_restarts",b"num_restarts","objective_value",b"objective_value","primal_integral",b"primal_integral","solution",b"solution","solution_info",b"solution_info","solve_log",b"solve_log","status",b"status","sufficient_assumptions_for_infeasibility",b"sufficient_assumptions_for_infeasibility","tightened_variables",b"tightened_variables","user_time",b"user_time","wall_time",b"wall_time"]) -> None: ...
