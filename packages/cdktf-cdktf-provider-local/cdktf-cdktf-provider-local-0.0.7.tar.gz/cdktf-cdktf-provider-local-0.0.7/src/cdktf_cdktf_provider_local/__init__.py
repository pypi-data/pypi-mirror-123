...
class DataLocalFile(
    ...
    def __init__(
        ...
        *,
        ...
        :param filename: Path to the output file. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/d/file.html#filename DataLocalFile#filename}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
        ...
        jsii.create(DataLocalFile, self, [scope, id, config])
    ...
    def filename_input(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "filenameInput"))
...
class File(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param filename: Path to the output file. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/r/file.html#filename File#filename}
        :param content: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/r/file.html#content File#content}.
        :param content_base64: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/r/file.html#content_base64 File#content_base64}.
        :param directory_permission: Permissions to set for directories created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/r/file.html#directory_permission File#directory_permission}
        :param file_permission: Permissions to set for the output file. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/r/file.html#file_permission File#file_permission}
        :param sensitive_content: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/r/file.html#sensitive_content File#sensitive_content}.
        :param source: Path to file to use as source for content of output file. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/local/r/file.html#source File#source}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
...
class LocalProvider(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(LocalProvider, self, [scope, id, config])
