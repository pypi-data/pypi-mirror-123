...
class Element:
    def __init__(self, name=None, nameContains=None, value=None, valueContains=None, xpath=None, index=None, label=None, labelContains=None):
        self.element_loc = {
            'name': name,
        ...
        if xpath:
            if name:
                ...
                self.element = d(xpath=xpath, value=value)
            elif valueContains:
                self.element = d(xpath=xpath, valueContains=valueContains)
            elif label:
                self.element = d(xpath=xpath, label=label)
            elif labelContains:
                self.element = d(xpath=xpath, labelContains=labelContains)
            else:
