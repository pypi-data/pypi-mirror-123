from core.ios.driver import Driver
from core.ios.driver import relaunch_wda
...
class Element:
    def __init__(self, name=None, value=None, xpath=None, index=None, label=None, labelContains=None):
        self.element_loc = {
            'name': name,
            'value': value,
            'xpath': xpath,
