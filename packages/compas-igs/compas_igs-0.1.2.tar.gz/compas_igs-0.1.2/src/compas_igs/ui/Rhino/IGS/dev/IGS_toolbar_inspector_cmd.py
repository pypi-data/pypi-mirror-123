...
import IGS_form_constraint_edge_inspector_cmd
import IGS_form_constraint_vertex_inspector_cmd
...
def RunCommand(is_interactive):
    ...
    if option == "EdgesTable":
        ...
        IGS_form_constraint_edge_inspector_cmd.RunCommand(True)

    elif option == "VertexConstraints":
        IGS_form_constraint_vertex_inspector_cmd.RunCommand(True)
