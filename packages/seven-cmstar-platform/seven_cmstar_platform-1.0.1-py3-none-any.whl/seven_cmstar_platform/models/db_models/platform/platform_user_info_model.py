...
class PlatformUserInfo:
    ...
    def get_field_list(self):
        return ['id', 'user_id', 'telephone', 'user_nick', 'gender', 'avatar', 'inviter_id', 'tags', 'qq', 'wechat', 'mail', 'status', 'freeze_reason', 'register_channel', 'app_channel', 'last_app_channel', 'last_login_time', 'create_date', 'modify_date']
