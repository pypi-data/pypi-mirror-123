...
class PlatformDollInfo:
    ...
    def __init__(self):
        ...
        self.get_type = 0  # 获得类型，1购买获得，2系统赠送
    ...
    def get_field_list(self):
        return ['id', 'doll_id', 'doll_code', 'cdk', 'order_id', 'goods_id', 'goods_code', 'seller_id', 'doll_nick', 'gender', 'height', 'telephone', 'qq', 'birth_date', 'activate_date', 'activate_user_id', 'user_id', 'get_type', 'activate_sort', 'cms_user_id', 'create_date', 'modify_date']
