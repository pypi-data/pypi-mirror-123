...
class BoundingBox(json.JSONEncoder):
    ...
    def __init__(self, label: str, box: List[float], score: float, rle_mask: Optional[Dict[str, Any]] = None) -> None:
        """
...
class ImageBoxes:
    ...
    def __init__(self, image_name: str, index_map: List[str]) -> None:
        """
