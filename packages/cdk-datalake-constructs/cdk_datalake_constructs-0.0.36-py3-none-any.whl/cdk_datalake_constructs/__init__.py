...
class DataLake(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param create_default_database: (experimental) Create default Glue Database for DataLake. Default: - false
        :param lake_type: (experimental) The Type of DataLake this instance is. This can be a DATA_PRODUCT only, CENTRAL_CATALOG, CONSUMER, or DATA_PRODUCT_AND_CATALOG type.
        :param name: (experimental) The name of the DataLake.
        :param stage_name: (experimental) The Stage the DataLake will be deployed.
        :param create_athena_workgroup: (experimental) Create default Athena workgroup for querying data lake resources. Default: - false
