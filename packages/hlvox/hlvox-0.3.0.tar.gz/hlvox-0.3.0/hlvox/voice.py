...
class Voice:
    ...
    def _setup_db(self, path: Path, db_name: str) -> TinyDB:
    ...
    def generate_audio(self, sentence: str) -> Sentence:
...
if __name__ == '__main__':
    ...
    output_path = Path.cwd().joinpath(f"{'-'.join(sentence.sayable)}.{args.format}")
