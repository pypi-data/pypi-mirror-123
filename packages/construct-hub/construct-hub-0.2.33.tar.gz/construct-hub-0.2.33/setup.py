    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codeartifact>=1.123.0, <2.0.0",
        ...
        "aws-cdk.aws-lambda-event-sources>=1.123.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.123.0, <2.0.0",
        "aws-cdk.aws-logs>=1.123.0, <2.0.0",
        "aws-cdk.aws-route53-targets>=1.123.0, <2.0.0",
        "aws-cdk.aws-route53>=1.123.0, <2.0.0",
        "aws-cdk.aws-s3-deployment>=1.123.0, <2.0.0",
