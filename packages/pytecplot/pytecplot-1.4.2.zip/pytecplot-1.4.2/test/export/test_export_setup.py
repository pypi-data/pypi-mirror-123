...
class TestExportSetup(unittest.TestCase):
    ...
    def test_format_options(self):
        _opts = self.setup.avi_format_options
        self.setup.avi_format_options = 'testing'
        self.setup.avi_format_options = None
        self.assertEqual(self.setup.avi_format_options, 'testing')
        self.setup.avi_format_options = _opts
        self.assertEqual(self.setup.avi_format_options, _opts)
    ...
    @skip_if_sdk_version_before(2021, 2)
    def test_avi_format_options(self):
        for val in ['aa', '11']:
            self.setup.avi_format_options = val
            self.assertEqual(self.setup.avi_format_options, str(val))
