# 
# This file was auto-generated on Sep 20 2021 by gencode.
...
class TecUtil(object):
    ...
    def configure_tecutil_argtypes(self):
        ...
        if self.handle is not None:
            ...
            # void TecUtilDataFaceMapAssignBConns(FaceMap_pa FaceMap, int32_t NumBndryFaces, const  int32_t * NumBndryConns_Array, const  int32_t * FaceBndryElems_Array, const  UniqueID_t * FaceBndryElemZoneUniqueIds_Array)
            try:
            ...
            # void TecUtilDataFaceMapAssignBConns64(FaceMap_pa FaceMap, int32_t NumBndryFaces, const  int32_t * NumBndryConns_Array, const  int64_t * FaceBndryElems_Array, const  UniqueID_t * FaceBndryElemZoneUniqueIds_Array)
            try:
            ...
            # Boolean_t TecUtilDataFaceNbrAssignByRef(FaceNeighbor_pa FaceNeighbor, LgIndex_t Element, int32_t Face, Boolean_t NbrsCompObscure, int32_t NumNeighbors, const  int32_t * NeighborElems, const  UniqueID_t * NeighborZoneUniqueIds)
            try:
            ...
            # Boolean_t TecUtilDataFaceNbrAssignByRef64(FaceNeighbor_pa FaceNeighbor, LgIndex_t Element, int32_t Face, Boolean_t NbrsCompObscure, int32_t NumNeighbors, const  int64_t * NeighborElems, const  UniqueID_t * NeighborZoneUniqueIds)
            try:
            ...
            # EntIndex_t TecUtilDataSetGetPartNumByName(UniqueID_t datasetID, const  char * partName)
            try:
            ...
            # void TecUtilDataSetGetUniqueIDsForZones(const  EntIndex_t * zones, EntIndex_t numZones, UniqueID_t * uniqueIDs)
            try:
            ...
            # Boolean_t TecUtilUseNamesForVariableAssignments(void)
            try:
            ...
            # void TecUtilZoneGetMetrics(EntIndex_t Zone, LgIndex_t * numIPts, LgIndex_t * numJPts, LgIndex_t * numKPts, LgIndex_t * numFaceNodes, LgIndex_t * numFaceBndryFaces, LgIndex_t * numFaceBndryConns)
            try:
            ...
            # void TecUtilZoneGetMetricsByUniqueID(UniqueID_t DatasetID, EntIndex_t Zone, LgIndex_t * numIPts, LgIndex_t * numJPts, LgIndex_t * numKPts, LgIndex_t * numFaceNodes, LgIndex_t * numFaceBndryFaces, LgIndex_t * numFaceBndryConns)
            try:
    ...
    # void TecUtilDataSetGetUniqueIDsForZones(const  EntIndex_t * zones, EntIndex_t numZones, UniqueID_t * uniqueIDs)
    @tecutil_preamble
    def DataSetGetUniqueIDsForZones(self, zones, num_zones, unique_ids_out):
        self.handle.tecUtilDataSetGetUniqueIDsForZones(zones, num_zones, unique_ids_out)
    ...
    def ZoneGetMetrics(self, zone):
        num_ipts_out = c_int64()
        num_jpts_out = c_int64()
        num_kpts_out = c_int64()
        num_face_nodes_out = c_int64()
        num_face_bndry_faces_out = c_int64()
        num_face_bndry_conns_out = c_int64()
        self.handle.tecUtilZoneGetMetrics(zone, byref(num_ipts_out), byref(num_jpts_out), byref(num_kpts_out), byref(num_face_nodes_out), byref(num_face_bndry_faces_out), byref(num_face_bndry_conns_out))
        return num_ipts_out.value, num_jpts_out.value, num_kpts_out.value, num_face_nodes_out.value, num_face_bndry_faces_out.value, num_face_bndry_conns_out.value
    ...
    def ZoneGetMetricsByUniqueID(self, dataset_id, zone):
        ...
        num_face_bndry_faces_out = c_int64()
        num_face_bndry_conns_out = c_int64()
        self.handle.tecUtilZoneGetMetricsByUniqueID(dataset_id, zone, byref(num_ipts_out), byref(num_jpts_out), byref(num_kpts_out), byref(num_face_nodes_out), byref(num_face_bndry_faces_out), byref(num_face_bndry_conns_out))
        return num_ipts_out.value, num_jpts_out.value, num_kpts_out.value, num_face_nodes_out.value, num_face_bndry_faces_out.value, num_face_bndry_conns_out.value
