...
def test_rk2():
    ...
    with pytest.raises(errors.CodeError):
        odeint(method=method, show_code=True, f=lambda v, t, beta: t)

    with pytest.raises(errors.CodeError):
        odeint(method=method, show_code=True, f=lambda v, t, _k1: t)

    with pytest.raises(errors.CodeError):
        odeint(method=method, show_code=True, f=lambda v, t, _k2: t)
