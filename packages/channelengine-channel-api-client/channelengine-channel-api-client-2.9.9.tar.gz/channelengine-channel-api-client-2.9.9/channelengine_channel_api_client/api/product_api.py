    ...
    def __init__(self, api_client=None):
        ...
        def __product_acknowledge_offer_changes(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                request_body ([str], none_type): The channel references of the updated products.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __product_get_data_changes(
            ...
            **kwargs
            ...
            Keyword Args:
                max_count (int, none_type): Optional - limit the amount of products returned for each field<br /> (ToBeCreated, ToBeUpdated, ToBeRemoved) to this number.. [optional]
                strip_html (bool, none_type): Optional - strips html by default on all fields. [optional] if omitted the server will use the default value of True
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
