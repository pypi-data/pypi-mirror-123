...
class SegmentMappingSim(MetadynamicSimulation):
    ...
    def run_scans(self):
            ...
            for i in range(self.num_replicas):
                ...
                if len(saddle_traj)==0:
                    raise ValueError('did not find any wells for this scan!')
                print('found {} MFEP saddle points for use in segment mapping'.format(len(saddle_traj)))
    ...
    def cycle_replicas(self, segment_coords):
        ...
        while continue_simulating:
            ...
            if log_p_accept<=0 * unit.kilojoules_per_mole \
                    ...
                    or current_cv_values[0]>self.unbound_distance:
                accepted +=1
                attempted +=1
            else:
                attempted+=1
