...
def define_auto(code):
    ...
    if not var_list.__contains__(var_name):
        ...
        if code.__contains__('getPlayer') or code.__contains__('sender'):
            type_Var = "Player"
            m = 'public Player '+var_name+"= new Player();\n"
            ...
            type_Var = "String"
            m = 'public String '+var_name+"= new String();\n"
            ...
            m = 'public Material '+var_name+" = new Material();\n"
            type_Var = "Material"
...
class ArrayList:
    ...
    def __contains__(self,something):
        ...
        if self.type != type(something):
            raise Exception('compare thing type have to be same as type of list '+filename+'", line '+str(long)+',')
class String:
    def __init__(self):
        global check_list
        check_list.append("define")
    ...
    for code in lines:
        ...
        if getvalue == True:
            ...
            if m == 'init':
                ...
                code = code.replace("()","")
                code = code.replace("getPlayer","getPlayer()")
