...
var_dict_type = {"Material":False,"Player":False,"Inventory":False,"World":False,"Location":False,"Block":False,"ItemStack":False,"Action":False}
global var_list
var_list = []
...
def define_auto(code):
    ...
    if not var_list.__contains__(var_name):
        ...
        elif code.__contains__('getX') or code.__contains__('getY') or code.__contains__('getZ'):
