...
class Binomial(Distribution):
    ...
    def calculate_mean(self):
        ...
        calculated_mean = self.p * self.n
        self.mean = calculated_mean
    ...
    def calculate_stdev(self):
        ...
        calculated_stdev = math.sqrt(self.n * self.p * (1 - self.p))
        self.stdev = calculated_stdev

        return calculated_stdev
    ...
    def replace_stats_with_data(self):
        ...
        # assuming 1 in the data is a positive trial and 0 is a negative trial
    ...
    def plot_bar(self):
        ...
        plt.bar(x_values=['0', '1'], height=[
                (1 - self.p) * self.n, self.p * self.n])
        plt.xlabel('Possible Values')
        plt.ylabel('Number of Occurances in File')
    ...
    def __add__(self, other):
        ...
        second_binomial = Binomial(self.p, self.n + other.n)

        return second_binomial
