...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.8.0-alpha.1634164465+505da1fc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.8.0-alpha.1634164465+505da1fc`
                """)
            else:
                raise
