...
class OrderGraphBlock(object):
    ...
    def __init__(self, block=None, order_ids=None, placement_ids=None, allocation_ids=None, execution_ids=None, ordered=None, placed=None, allocated=None, executed=None, derived_state=None, local_vars_configuration=None):  # noqa: E501
