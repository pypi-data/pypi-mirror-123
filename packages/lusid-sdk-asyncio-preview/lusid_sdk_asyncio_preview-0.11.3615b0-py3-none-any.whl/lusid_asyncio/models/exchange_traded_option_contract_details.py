...
class ExchangeTradedOptionContractDetails(object):
    ...
    def __init__(self, dom_ccy=None, strike=None, contract_size=None, country=None, delivery_type=None, description=None, exchange_code=None, exercise_date=None, exercise_type=None, option_code=None, option_type=None, underlying=None, underlying_code=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type country: str
        :param delivery_type:  The delivery type, cash or physical. An option on a future is physically settled if upon exerciseing the  holder receives a future.  Supported string (enumeration) values are: [Cash, Physical]. (required)
        :type delivery_type: str
        :param description:  Description of contract (required)
        :type description: str
        :param exchange_code:  Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX]. (required)
        :type exchange_code: str
        :param exercise_date:  Exercise Date (required)
        :type exercise_date: datetime
        :param exercise_type:  The exercise type, European, American or Bermudan  Supported string (enumeration) values are: [None, European, Bermudan, American]. (required)
        ...
        :param option_type:  The option type, Call or Put.  Supported string (enumeration) values are: [None, Call, Put]. (required)
    ...
    def delivery_type(self):
        ...
        The delivery type, cash or physical. An option on a future is physically settled if upon exerciseing the  holder receives a future.  Supported string (enumeration) values are: [Cash, Physical].  # noqa: E501
    ...
    def exchange_code(self):
        ...
        Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX].  # noqa: E501
    ...
    def exercise_type(self):
        ...
        The exercise type, European, American or Bermudan  Supported string (enumeration) values are: [None, European, Bermudan, American].  # noqa: E501
    ...
    def option_type(self):
        ...
        The option type, Call or Put.  Supported string (enumeration) values are: [None, Call, Put].  # noqa: E501
