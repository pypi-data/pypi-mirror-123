...
class OrderGraphPlacement(object):
    ...
    def __init__(self, placement=None, block_id=None, order_ids=None, allocation_ids=None, execution_ids=None, placed=None, allocated=None, executed=None, derived_state=None, local_vars_configuration=None):  # noqa: E501
