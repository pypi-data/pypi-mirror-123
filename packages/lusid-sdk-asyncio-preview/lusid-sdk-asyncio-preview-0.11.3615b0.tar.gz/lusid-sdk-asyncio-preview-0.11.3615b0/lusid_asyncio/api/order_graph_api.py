...
class OrderGraphApi(object):
    ...
    def list_order_graph_blocks_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_order_graph_blocks`, length must be less than or equal to `2147483647`")  # noqa: E501
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
    ...
    def list_order_graph_placements_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
                                                        len(local_var_params['filter']) > 2147483647):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_order_graph_placements`, length must be less than or equal to `2147483647`")  # noqa: E501
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
                                                        len(local_var_params['filter']) < 0):  # noqa: E501
