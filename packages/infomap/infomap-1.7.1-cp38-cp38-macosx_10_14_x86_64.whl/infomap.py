...
class Config(object):
    ...
    inputFormat = property(
        _infomap.Config_inputFormat_get,
        _infomap.Config_inputFormat_set)
    memoryInput = property(
        _infomap.Config_memoryInput_get,
        _infomap.Config_memoryInput_set)
    ...
    includeSelfLinks = property(
        _infomap.Config_includeSelfLinks_get,
        _infomap.Config_includeSelfLinks_set)
