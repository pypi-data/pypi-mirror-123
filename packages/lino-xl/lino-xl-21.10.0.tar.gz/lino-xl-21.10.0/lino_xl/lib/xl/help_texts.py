...
plugin."""),
    'lino_xl.lib.vat.Plugin.eu_country_codes' : _("""A set of ISO codes that are to be considered part of the EU. See
dg.plugins.vat.eu_country_codes."""),
...
resolve it at startup into an item of VatClasses."""),
    'lino_xl.lib.vat.Plugin.declaration_plugin' : _("""The plugin to use as your national VAT module."""),
    'lino_xl.lib.vat.Plugin.item_vat' : _("""Whether item prices in trade documents are meant VAT included."""),
    'lino_xl.lib.vat.Plugin.use_online_check' : _("""Whether to verify VAT numbers online via VIES."""),
...
per invoicing."""),
    ...
    'lino_xl.lib.invoicing.Plan.today' : _("""The invoice date to be used for the invoices to generate."""),
...
vat_id and related behaviour."""),
    'lino_xl.lib.vat.VatSubjectable.vat_regime' : _("""The default VAT regime to use on invoices for this partner."""),
    'lino_xl.lib.vat.VatSubjectable.vat_id' : _("""The VAT id used to identify this partner. Lino verifies validity
based on the partner's country field."""),
