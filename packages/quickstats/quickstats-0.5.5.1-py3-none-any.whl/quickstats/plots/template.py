...
def single_frame(logx:bool=False, logy:bool=False, 
    ...
    if styles['strip_extra_axis_label_decimals']['xaxis']:
        ax.xaxis.set_major_formatter(NumericFormatter())
    if styles['strip_extra_axis_label_decimals']['yaxis']:
...
def format_axis_ticks(ax, x_axis=True, y_axis=True, major_length=16, minor_length=8,
                      width=1, label_bothsides=False, tick_bothsides=False,
                      labelsize=None, x_axis_styles=None, y_axis_styles=None):
    if x_axis:
