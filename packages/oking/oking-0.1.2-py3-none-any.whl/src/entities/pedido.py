...
from src.entities.produto import ItemBrinde
from src.entities.produto import ItemPersonalizado
...
def toListFilaDecoder(filaDictArray):
    lista = []
    for fila in filaDictArray:
