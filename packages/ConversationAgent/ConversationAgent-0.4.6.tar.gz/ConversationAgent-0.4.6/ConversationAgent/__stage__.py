...
class Stage:
    ...
    def save_user_text(cls, data, stage_id, label):
        ...
        data = cls.set_default_var(data,__KEEP_DEFAULT_VAR__,"__USER_TEXT__",user_text)
        data = cls.set_var(data, stage_id, label, user_text)
        ...
        for var in sys_reply.split(" "):
            ...
            if var_ticket is not None:
                try:
                    ...
                    sys_reply_complete_refactor += f" {var}"
            else:
