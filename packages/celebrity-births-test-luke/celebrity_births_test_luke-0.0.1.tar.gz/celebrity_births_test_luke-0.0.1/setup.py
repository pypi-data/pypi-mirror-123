...
setup(
    name='celebrity_births_test_luke', ## This will be the name your package will be published with
    version='0.0.1', 
    description='Mock package that allows you to find celebrity by date of birth',
    url='https://github.com/Lugar95/Test-Package.git', # Add the URL of your github repo if published 
                                                                   # in GitHub
    author='Luke Gardiner', # Your name
    license='MIT',
