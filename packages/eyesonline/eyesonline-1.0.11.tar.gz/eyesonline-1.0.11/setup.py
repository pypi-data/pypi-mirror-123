...
def make_rules():
	...
	print('installing rules for accessing hardware...', sys.argv)
...
setuptools.setup(
    ...
    description="Python package for Remote Access of Eyes17 and other hardware",
    ...
    entry_points={
    'console_scripts': [
        'eyesonline=eyesonlineui.app:runonline',
        'eyeslocal=eyesonlineui.app:run',
    		],
	},
	cmdclass = {'install':InstallCommand},
    keywords = 'expeyes17 data-acquisition remote-access virtual-lab lab-at-home oscilloscope waveform-generator sensors physics',
    python_requires='>=3',
