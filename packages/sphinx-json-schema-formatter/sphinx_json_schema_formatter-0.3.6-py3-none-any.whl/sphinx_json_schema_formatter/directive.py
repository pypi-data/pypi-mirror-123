...
class JsonSchema(Directive):
    ...
    def handle_property(self, title, prop) -> None:
        ...
        required_label = nodes.strong("Required")
        required_text = nodes.inline(f"{is_required}")
        ...
        if default_value:
            ...
            default_label = nodes.strong("Default")
            default_text = nodes.inline(f"{default_value}")
