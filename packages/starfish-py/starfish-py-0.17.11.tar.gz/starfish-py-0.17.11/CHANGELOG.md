...
## Release v0.17.11
+   Agent object only accepts a agent.authorization object for enabling authorization

## Release v0.17.10
+   Upgrade convex-api-py to new release v0.2.2
+   Use new convex contract syntax

## Release v0.17.9
+   Upgrade convex-api-py to new release v0.2.0

## Release v0.17.8
+   Upgrade convex-api-py
+	Added leading '#' identifiers to convex addresses
