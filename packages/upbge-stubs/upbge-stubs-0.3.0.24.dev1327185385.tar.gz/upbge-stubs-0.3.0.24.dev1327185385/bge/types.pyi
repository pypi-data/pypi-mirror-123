...
class KX_BlenderMaterial(EXP_PyObjectPlus):
  ...
  blenderMaterial: bpy.types.Material = ...
...
class KX_LodManager(EXP_PyObjectPlus):
  ...
  levels: typing.List[bge.types.KX_LodLevel] = ...
...
class SCA_CollisionSensor(SCA_ISensor):
  ...
  hitObjectList: typing.Union[typing.Sequence[bge.types.KX_GameObject], typing.Mapping[str, bge.types.KX_GameObject], EXP_ListValue] = ...
