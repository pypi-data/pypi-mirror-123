...
def prinfPathDirname():
    print(os.path.dirname(__file__))

def prinfPathRealpath():
    print(os.path.realpath(__file__))

def prinfLsd():
    print(pkgresources.path(blurredface_sts_test, "haarcascade_frontalface_default.xml"))

def prinf_is_resource():
    print(pkgresources.is_resource(blurredface_sts_test, "haarcascade_frontalface_default.xml"))
