...
sources = ['ssa_translation_c_w_full.cpp','ssa_translation_lowmem.pyx',
           'ssa_translation_c_w_lowmem.cpp', 'ssa_trna_lowmem_c_w.cpp', 'ssa_trna_c_w.cpp']
sources += ['ssa_trna_custom_pool_c_w.cpp', 'ssa_trna_custom_map_c_w.cpp']
