...
class ModbusDevice:
    ...
    __logdataStartTimeStamp__ = None
    ...
    def __processregisters__(self):
        ...
        if self.__logdataStartTimeStamp__ == None:
            self.__logdataStartTimeStamp__ = datetime.now()
    
    def getlogdataage(self):
        if self.__logdataStartTimeStamp__ != None:
            difference = datetime.now() - self.__logdataStartTimeStamp__
    ...
    def clearlog(self):
        ...
        self.__logdataStartTimeStamp__ = None
