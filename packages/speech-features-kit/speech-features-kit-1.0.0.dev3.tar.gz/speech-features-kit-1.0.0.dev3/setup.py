...
A Python wrapper for convenient speech feature extraction from sound files. 
...
setup(
    ...
    name='speech-features-kit',  # Required
    ...
    url='https://github.com/dhchenx/speech-feature-kit',  # Optional
