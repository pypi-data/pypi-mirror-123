...
class QuantumCircuitConstraints(pydantic.BaseModel):
    ...
    qviz_html_output: bool = pydantic.Field(
        default=False,
        description="If true, the generation output directory will contain an html "
        "file for the quantum-viz.js interactive visualization. Note that the "
        "generation of this visualization takes extra time.",
    )
