...
from drb.utils.logical_node import Predicate
...
class DrbNodeTest(DrbNode, DrbItemTest, DrbNodeImplTest):
    ...
    def __len__(self):
        super(DrbNodeTest, self).__len__()

    def __getitem__(self, item):
        super(DrbNodeTest, self).__getitem__(item)

    def __truediv__(self, other):
        super(DrbNodeTest, self).__truediv__(other)
