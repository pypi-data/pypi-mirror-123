...
class Node(BaseModel):
    ...
    def base_set_remove_d(
        ...
        set_patch = self.Dgraph.patch_model()
        remove_patch = self.Dgraph.patch_model()
        ...
        for field_name in self.Dgraph.patch_model.__fields__.keys():
    ...
    async def _add(
        ...
        *,
        ...
        if not isinstance(input, cls.Dgraph.add_model):
            input = cls.Dgraph.add_model.parse_obj(input)
