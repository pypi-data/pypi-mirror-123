...
class Pattern(object):
    ...
    def oscar(self, maxexp=16, eventual_oscillator=True, verbose=True, return_apgcode=False, allow_guns=True):
        ...
        if return_apgcode and allow_guns and self.getrule() == 'b3s23':
...
observer.observe(targetNode, config);
    ...
    def make_gif_internal(self, p, disp, hue='#ff0000', width=350, height=350, border=5, bg=None):
    ...
    def make_gif(self, filename=None, fps=25, **kwargs):
        '''
        ...
        gif = y.make_gif_internal(p, disp, bg=bg, **kwargs)
