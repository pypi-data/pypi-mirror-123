...
class DbtModel:
    ...
    def from_dict(obj: Any) -> 'DbtModel':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        return DbtModel(id, aspect_type, compiled_sql, created_at, description, entity_id, fields, dbt_model_id, latest, macros, materialization, package_name, raw_sql, source_datasets, source_models, tags, tests, url)
