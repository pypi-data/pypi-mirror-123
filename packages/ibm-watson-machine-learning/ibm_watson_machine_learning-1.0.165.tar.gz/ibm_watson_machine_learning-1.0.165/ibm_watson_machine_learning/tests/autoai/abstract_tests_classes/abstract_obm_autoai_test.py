...
class AbstractTestOBM(abc.ABC):
    ...
    def test_05_initialize_optimizer(self):
        ...
        self.assertIsInstance(AbstractTestOBM.remote_auto_pipelines, RemoteAutoPipelines,
                              msg=f"experiment.optimizer did not return RemoteAutoPipelines object, "
                                  f"type: {type(AbstractTestOBM.remote_auto_pipelines)}")
