...
class AlwaysFFOp(_ods_ir.OpView):
  ...
  @builtins.property
  def reset(self):
    return self.operation.operands[1] if len(self.operation.operands) > 2 else None
...
class BindOp(_ods_ir.OpView):
  ...
  def __init__(self, boundInstance, instanceModule, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    attributes["boundInstance"] = boundInstance
    attributes["instanceModule"] = instanceModule
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
      successors=_ods_successors, loc=loc, ip=ip))
...
class CaseZOp(_ods_ir.OpView):
  ...
  def __init__(self, cond, casePatterns, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
...
class LocalParamOp(_ods_ir.OpView):
  ...
  def __init__(self, result, value, name, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    results.append(result)
