...
class ExtractOp(_ods_ir.OpView):
  ...
  @builtins.property
  def lowBit(self):
    return _ods_ir.IntegerAttr(self.operation.attributes["lowBit"])
...
class MuxOp(_ods_ir.OpView):
  ...
  def __init__(self, result, cond, trueValue, falseValue, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    results.append(result)
