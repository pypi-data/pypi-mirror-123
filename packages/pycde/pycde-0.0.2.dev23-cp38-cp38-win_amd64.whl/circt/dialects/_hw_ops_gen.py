...
class InstanceOp(_ods_ir.OpView):
  ...
  def __init__(self, result, instanceName, moduleName, inputs, argNames, resultNames, parameters, sym_name, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
...
class TypedeclOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type, verilogName, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    attributes["sym_name"] = sym_name
