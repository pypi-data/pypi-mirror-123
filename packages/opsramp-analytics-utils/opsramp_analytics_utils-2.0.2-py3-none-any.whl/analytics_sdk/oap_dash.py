...
from .api import (
    ...
    analysis_send_create_view,
    analysis_send_detail_view,
    compute_view
)
...
class OAPDash(dash.Dash):
    ...
    def init_app(self, app=None):
        ...
        self._add_url("analysis-runs/", analysis_run_list_view, ['POST', 'GET'])
        self._add_url("analysis-runs/<string:id>/", analysis_run_detail_view, ['PUT', 'GET'])
        self._add_url("analysis-sends/", partial(analysis_send_create_view, self.func_compute), ['POST'])
        self._add_url("analysis-sends/<string:id>/", analysis_send_detail_view, ['DELETE'])
