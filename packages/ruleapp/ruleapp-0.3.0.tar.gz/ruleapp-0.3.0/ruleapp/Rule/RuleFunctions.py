...
class RuleFunction(object):
    ...
    def add_rule_antecedent(self, user_id, rule_id, device_id):
        try:
            ...
            antecedent.order = len(self.r.lrange(key_pattern + ":device_antecedents"))
            return self.update_rule_antecedent(user_id, rule_id, device_id, antecedent.__dict__)
        except Exception as error:
            print(repr(error))
            return "error"
    ...
    def add_rule_consequent(self, user_id, rule_id, device_id):
        try:
            ...
            consequent.order = len(self.r.lrange(key_pattern + ":device_consequents"))
            return self.update_rule_consequent(user_id, rule_id, device_id, consequent.__dict__)
        except Exception as error:
            print(repr(error))
            return "error"
