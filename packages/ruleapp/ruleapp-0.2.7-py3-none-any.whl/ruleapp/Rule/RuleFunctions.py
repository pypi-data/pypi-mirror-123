...
class RuleFunction(object):
    ...
    def add_rule_antecedent(self, user_id, rule_id, device_id):
        try:
            ...
            antecedent_json.device_id = device_id
            antecedent_json.order = len(self.r.lrange(key_pattern + ":device_antecedents"))
    ...
    def add_rule_consequent(self, user_id, rule_id, device_id):
        try:
            ...
            consequent_json.device_id = device_id
            consequent_json.order = len(self.r.lrange(key_pattern + ":device_consequents"))
