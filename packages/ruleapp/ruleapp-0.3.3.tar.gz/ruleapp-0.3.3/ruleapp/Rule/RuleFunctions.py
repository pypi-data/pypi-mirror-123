    ...
    def get_rule_antecedent(self, user_id, rule_id, device_id):
        try:
            ...
            if "timer" in device_id:
                antecedent = self.timer_antecedent_functions.update_antecedent(user_id, rule_id, device_id)
            elif "WATERLEVEL" in device_id:
                antecedent = self.waterlevel_antecedent_functions.update_antecedent(user_id, rule_id, device_id)
            elif "BUTTON" in device_id:
                antecedent = self.button_antecedent_functions.update_antecedent(user_id, rule_id, device_id)
            return antecedent
        except Exception as error:
            print(repr(error))
            return "error"
