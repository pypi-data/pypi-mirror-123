...
class extractNlp:
  ...
  def main(self, srs_param, col_param,  output= mode_param):
      id_req = partOf.fulldataset(srs_param)['ID']
      data_num = partOf.fulldataset(srs_param)[col_param]
...
if __name__ == "__main__":
  try:
    triplet_data = extractNlp(dataFile).main(srs_param, col_param, mode_param)
