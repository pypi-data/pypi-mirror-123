...
def fill_configuration(args=None):
    ...
    if batch_mode:
        ...
        tdc_calibration = args["tdc_calibration"]
        ...
        apply_detector_flags = args["apply_detector_flags"]
    ...
    if start_time:
        ...
        get_all = True
    if all_analyzers:
        decoder = tdc_calibration = bcid_distribution = adc_distribution = spill_number_fixer = True
        beam_summary_data = temperature = data_quality = apply_detector_flags = True
