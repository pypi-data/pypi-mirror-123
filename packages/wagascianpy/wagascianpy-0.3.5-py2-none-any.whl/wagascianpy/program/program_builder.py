...
import wagascianpy.analysis.analyzer as ana
...
class ProgramBuilder(object):
    ...
    def add_decoder(self, **kwargs):
        ...
        :return: None
        """
        self._program.add_step(ana.Decoder.name, **kwargs)

    def add_make_hist(self, **kwargs):
        # type: (...) -> None
        """
        Add the wgMakeHist analyzer to the list of analyzers of the program
        :param kwargs: arguments to be passed to wgMakeHist
        :return: None
        """
        self._program.add_step(ana.MakeHist.name, **kwargs)

    def add_tdc_calibration(self, **kwargs):
        # type: (...) -> None
        """
        Add the wgTDC analyzer to the list of analyzers of the program
        :param kwargs: arguments to be passed to wgTDC
        :return: None
        """
        self._program.add_step(ana.TdcCalibration.name, **kwargs)
    ...
    def add_bcid_distribution(self, **kwargs):
        ...
        :return: None
        """
        self._program.add_step(ana.BcidDistribution.name, **kwargs)
    ...
    def add_adc_distribution(self, **kwargs):
        ...
        :return: None
        """
        self._program.add_step(ana.AdcDistribution.name, **kwargs)
    ...
    def add_spill_number_fixer(self, **kwargs):
        ...
        :return: None
        """
        self._program.add_step(ana.SpillNumberFixer.name, **kwargs)
    ...
    def add_beam_summary_data(self,
        ...
        self._program.add_step(ana.BeamSummaryData.name,
                               bsd_database=local_db_path,
                               bsd_repository=local_repo_path,
                               **kwargs)

    def add_apply_detector_flags(self, **kwargs):
        # type: (...) -> None
        """
        Add the apply_detector_flags analyzer to the list of analyzers of the program
        :param kwargs: arguments to be passed to apply_detector_flags
        :return: None
        """
        self._program.add_step(ana.ApplyDetectorFlags.name, **kwargs)
    ...
    def add_temperature(self, **kwargs):
        ...
        :return: None
        """
        self._program.add_step(ana.Temperature.name, **kwargs)
    ...
    def add_data_quality(self, **kwargs):
        ...
        :return: None
        """
        self._program.add_step(ana.DataQuality.name, **kwargs)
