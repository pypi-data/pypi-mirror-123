...
class WagasciAnalysis(object):
    ...
    def data_quality(self, tree_files, topology_source, data_quality_dir, data_quality_file, dif_id, passes,
        ...
        """
        lib_data_quality = ct.CDLL(os.path.join(self.m_lib_dir, 'libwgDataQuality.so'))
        wg_data_quality = _wrap_function(lib_data_quality, 'wgDataQuality', ct.c_int, [ct.c_char_p])
