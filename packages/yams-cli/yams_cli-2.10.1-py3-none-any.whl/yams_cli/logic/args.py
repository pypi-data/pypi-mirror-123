...
def setup_yams_distribution(command):
    ...
    commands['create'].add_argument('--enable-auto-format', required=False, default=False, help="Enable auto format (default: false)")
...
def setup_video_processing(command):
    commands = command.add_subcommands('action', [
        ('start', "start processing video to different codecs and resolutions (EXPERIMENTAL)",
         "--domain-id 5adcb26c-92fe-4f83-afb5-bf2322c0bfca --bucket-id 04760f77-da25-4de1-adde-bdfe62337c3c " +
         "--object-id some-object-id"),
        ('status', "Get video processing job status (EXPERIMENTAL)",
         "--domain-id 5adcb26c-92fe-4f83-afb5-bf2322c0bfca --bucket-id 04760f77-da25-4de1-adde-bdfe62337c3c " +
