...
def play(
    ...
    :param duration:    The time to play this pulse in units of the clock cycle (4ns).
                        This can both compress or expand the pulse. If not provided, the
                        default pulse duration will be used. It is possible to
                        dynamically change the duration of both constant and arbitrary
                        pulses. See the documention for more information.
    ...
    :param chirp:   Allows to perform piecewise linear sweep of the element’s
                    ...
                    See the documention for more information.
    ...
    .. note::
        arbitrary waveforrms can only be played for 67ms which are 2\ :sup:`24` clock cycles.
...
def update_frequency(element, new_frequency, units="Hz", keep_phase=False):
    ...
    is discussed in :ref:`Introduction/qua_overview:Frequency and phase transformations`.
...
def measure(pulse, element, stream=None, *outputs):
    ...
    `Measure Statement Features <../features.html#measure-statement-features>`__
    ...
    :param outputs:
        ...
        See `Measure Statement Features <features.html#measure-statement-features>`__
...
def wait(duration, *elements):
    ...
    :param duration: time to wait, `in multiples of 4nsec`. Range: [4, 2\ :sup:`32`] in steps of 1.
...
def wait_for_trigger(element, pulse_to_play=None, trigger_element=None):
    ...
    .. warning::
        ...
        controller. For the DIB, the maximum allowed voltage is 3.3V.
...
class _ResultStream:
    ...
    def map(self, function) -> "_ResultStream":
        ...
        `function <result_stream.html#qm.qua._dsl._Functions>`__ to it
