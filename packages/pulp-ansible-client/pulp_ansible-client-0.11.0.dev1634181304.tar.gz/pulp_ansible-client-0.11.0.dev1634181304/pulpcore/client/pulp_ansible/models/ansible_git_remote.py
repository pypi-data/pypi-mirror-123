...
class AnsibleGitRemote(object):
    ...
    def __init__(self, password=None, pulp_labels=None, max_retries=None, total_timeout=None, proxy_password=None, proxy_url=None, rate_limit=None, username=None, download_concurrency=None, name=None, sock_connect_timeout=None, tls_validation=None, sock_read_timeout=None, connect_timeout=None, url=None, headers=None, ca_cert=None, client_cert=None, client_key=None, proxy_username=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
