...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, total_timeout=None, pulp_href=None, headers=None, pulp_created=None, pulp_last_updated=None, pulp_labels=None, tls_validation=None, sock_connect_timeout=None, ca_cert=None, proxy_url=None, rate_limit=None, connect_timeout=None, name=None, download_concurrency=None, client_cert=None, sock_read_timeout=None, url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
