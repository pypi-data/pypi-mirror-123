...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, username=None, total_timeout=None, max_retries=None, proxy_password=None, connect_timeout=None, name=None, password=None, url=None, pulp_labels=None, ca_cert=None, client_cert=None, download_concurrency=None, tls_validation=None, headers=None, sock_read_timeout=None, sock_connect_timeout=None, client_key=None, proxy_username=None, rate_limit=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
