...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, max_retries=None, pulp_last_updated=None, connect_timeout=None, name=None, url=None, pulp_labels=None, ca_cert=None, client_cert=None, pulp_href=None, download_concurrency=None, tls_validation=None, headers=None, pulp_created=None, sock_read_timeout=None, sock_connect_timeout=None, rate_limit=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
