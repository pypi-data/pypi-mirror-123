...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, max_retries=None, url=None, pulp_href=None, rate_limit=None, sock_connect_timeout=None, connect_timeout=None, download_concurrency=None, total_timeout=None, name=None, pulp_last_updated=None, ca_cert=None, tls_validation=None, client_cert=None, sock_read_timeout=None, pulp_labels=None, pulp_created=None, headers=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
