...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, max_retries=None, url=None, username=None, rate_limit=None, sock_connect_timeout=None, connect_timeout=None, download_concurrency=None, total_timeout=None, proxy_password=None, name=None, password=None, proxy_username=None, ca_cert=None, tls_validation=None, client_cert=None, sock_read_timeout=None, pulp_labels=None, client_key=None, headers=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
