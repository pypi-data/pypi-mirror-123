...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, client_key=None, client_cert=None, username=None, download_concurrency=None, max_retries=None, rate_limit=None, name=None, proxy_password=None, ca_cert=None, pulp_labels=None, tls_validation=None, total_timeout=None, sock_read_timeout=None, url=None, proxy_url=None, connect_timeout=None, headers=None, sock_connect_timeout=None, password=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
