...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, client_cert=None, download_concurrency=None, max_retries=None, rate_limit=None, name=None, ca_cert=None, pulp_labels=None, tls_validation=None, total_timeout=None, sock_read_timeout=None, url=None, proxy_url=None, connect_timeout=None, pulp_last_updated=None, headers=None, sock_connect_timeout=None, pulp_created=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
