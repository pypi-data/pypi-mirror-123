...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, tls_validation=None, headers=None, ca_cert=None, total_timeout=None, sock_read_timeout=None, sock_connect_timeout=None, pulp_last_updated=None, pulp_href=None, connect_timeout=None, max_retries=None, url=None, client_cert=None, name=None, rate_limit=None, proxy_url=None, pulp_created=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
