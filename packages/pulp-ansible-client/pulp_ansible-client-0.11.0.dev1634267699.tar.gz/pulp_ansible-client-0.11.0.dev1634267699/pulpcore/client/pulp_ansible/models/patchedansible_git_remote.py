...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, total_timeout=None, proxy_username=None, headers=None, pulp_labels=None, tls_validation=None, sock_connect_timeout=None, ca_cert=None, password=None, proxy_url=None, proxy_password=None, rate_limit=None, client_key=None, connect_timeout=None, name=None, username=None, download_concurrency=None, client_cert=None, sock_read_timeout=None, url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
