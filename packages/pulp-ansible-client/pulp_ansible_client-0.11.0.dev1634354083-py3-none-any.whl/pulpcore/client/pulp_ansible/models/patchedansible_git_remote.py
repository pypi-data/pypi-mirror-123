...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, pulp_labels=None, tls_validation=None, client_key=None, headers=None, ca_cert=None, total_timeout=None, sock_read_timeout=None, sock_connect_timeout=None, proxy_password=None, password=None, connect_timeout=None, max_retries=None, url=None, client_cert=None, name=None, rate_limit=None, username=None, proxy_url=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
