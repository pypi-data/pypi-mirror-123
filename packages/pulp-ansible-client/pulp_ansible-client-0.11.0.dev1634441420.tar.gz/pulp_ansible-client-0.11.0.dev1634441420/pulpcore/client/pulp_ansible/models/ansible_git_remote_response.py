...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_href=None, total_timeout=None, connect_timeout=None, pulp_created=None, sock_connect_timeout=None, ca_cert=None, client_cert=None, download_concurrency=None, headers=None, rate_limit=None, pulp_labels=None, sock_read_timeout=None, proxy_url=None, tls_validation=None, max_retries=None, name=None, url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
