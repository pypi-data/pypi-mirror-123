...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, total_timeout=None, connect_timeout=None, proxy_username=None, sock_connect_timeout=None, ca_cert=None, client_cert=None, download_concurrency=None, password=None, headers=None, proxy_password=None, rate_limit=None, pulp_labels=None, sock_read_timeout=None, proxy_url=None, tls_validation=None, username=None, max_retries=None, client_key=None, name=None, url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
