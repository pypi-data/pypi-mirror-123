...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, total_timeout=None, sock_read_timeout=None, headers=None, client_cert=None, sock_connect_timeout=None, proxy_url=None, client_key=None, proxy_username=None, tls_validation=None, rate_limit=None, name=None, proxy_password=None, pulp_labels=None, password=None, username=None, max_retries=None, connect_timeout=None, ca_cert=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
