...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, total_timeout=None, sock_read_timeout=None, headers=None, client_cert=None, sock_connect_timeout=None, pulp_last_updated=None, proxy_url=None, pulp_href=None, tls_validation=None, rate_limit=None, name=None, pulp_created=None, pulp_labels=None, max_retries=None, connect_timeout=None, ca_cert=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
