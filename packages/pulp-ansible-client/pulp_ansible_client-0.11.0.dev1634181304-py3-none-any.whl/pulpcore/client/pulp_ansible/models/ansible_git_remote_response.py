...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, max_retries=None, pulp_last_updated=None, total_timeout=None, pulp_created=None, proxy_url=None, rate_limit=None, download_concurrency=None, name=None, pulp_href=None, sock_connect_timeout=None, tls_validation=None, sock_read_timeout=None, connect_timeout=None, url=None, headers=None, ca_cert=None, client_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
