...
setup(
    ...
    description='EDXML ontology brick (computer networking)',
    long_description='EDXML ontology brick defining ontology elements related to computer networks',
    ...
    install_requires=['edxml-bricks-computing>=3.0.0.dev0', 'edxml>=3.0.0.dev0'],
