...
class Aligner:
    ...
    @overload
    def get_best_alignment(self, src_sentence: Sequence[int], trg_sentence: Sequence[int]) -> Tuple[float, WordAlignmentMatrix]: ...
    @overload
    def get_best_alignment(self, src_sentence: Sequence[str], trg_sentence: Sequence[str]) -> Tuple[float, WordAlignmentMatrix]: ...
    @overload
    def get_best_alignments(self, src_sentences: Sequence[Sequence[int]], trg_sentences: Sequence[Sequence[int]]) -> Sequence[Tuple[float, WordAlignmentMatrix]]: ...
    @overload
    def get_best_alignments(self, src_sentences: Sequence[Sequence[str]], trg_sentences: Sequence[Sequence[str]]) -> Sequence[Tuple[float, WordAlignmentMatrix]]: ...
...
class AlignmentModel(Aligner):
    ...
    def read_sentence_pairs(self, src_filename: str, trg_filename: str, counts_filename: Optional[str]=None) -> None: ...
