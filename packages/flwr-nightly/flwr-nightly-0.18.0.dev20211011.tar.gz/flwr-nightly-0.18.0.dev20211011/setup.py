...
{':python_version < "3.7"': ['dataclasses==0.6'],
 'baseline': ['tensorflow-cpu==2.6.0',
              'boto3>=1.12.36,<2.0.0',
              'boto3_type_annotations>=0.3.1,<0.4.0',
              'paramiko>=2.7.1,<3.0.0',
              'docker>=4.2.0,<5.0.0',
              'matplotlib>=3.2.1,<4.0.0'],
 'examples-pytorch': ['torch>=1.9.0,<2.0.0',
                      'torchvision>=0.10.0,<0.11.0',
                      'tqdm>=4.48.2,<5.0.0'],
 'examples-tensorflow': ['tensorflow-cpu==2.6.0'],
 'http-logger': ['tensorflow-cpu==2.6.0',
                 'boto3>=1.12.36,<2.0.0',
                 'boto3>=1.12.36,<2.0.0',
                 'boto3_type_annotations>=0.3.1,<0.4.0',
                 'boto3_type_annotations>=0.3.1,<0.4.0',
 ...
 'ops': ['boto3>=1.12.36,<2.0.0',
         ...
         'paramiko>=2.7.1,<3.0.0',
         'docker>=4.2.0,<5.0.0'],
 'simulation': ['ray[default]>=1.6.0,<2.0.0']}

setup_kwargs = {
    'name': 'flwr-nightly',
    'version': '0.18.0.dev20211011',
