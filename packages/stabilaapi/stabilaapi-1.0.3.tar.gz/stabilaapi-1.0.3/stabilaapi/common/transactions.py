from stabilaapi.common.threads import Timeout


def wait_for_transaction_id(stabila, tx_id, timeout=120, poll_latency=0.1):
    with Timeout(timeout) as _timeout:
        while True:
            tx_detail = stabila.stb.get_transaction(tx_id)
