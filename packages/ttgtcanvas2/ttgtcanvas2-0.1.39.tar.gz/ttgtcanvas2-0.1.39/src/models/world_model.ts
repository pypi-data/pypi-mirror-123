...
export class WorldModel {
  ...
  skeleton() {
    ...
    <div >
      <div id="container">
        <div class="grid">
          <div class="stats">
            <div class="stats-item">
              <div class="stats-title">number of steps</div>
        ...
        <div class="ttgt-sidebar-bttn">
            <input class="rotate-bttn" type="button" value="Toggle" />
        </div>
    </div>
    `;
  }
  ...
  init_ui() {
    ...
    wrapper.innerHTML = this.skeleton().trim();
    $(function () {
      $('.ttgt-sidebar-bttn').on('click', function () {
        $('#container').toggle();
      });
    });
