...
class QGAN(AbstractModel):
    ...
    def restore_checkpoint(self, checkpoint:tf.train.Checkpoint=None):
        ...
        self.d_loss_arr = list(self.checkpoint.g_loss_arr[:self.checkpoint.step].numpy())
        self.d_loss_real_arr = list(self.checkpoint.g_loss_arr[:self.checkpoint.step].numpy())
        self.d_loss_fake_arr = list(self.checkpoint.g_loss_arr[:self.checkpoint.step].numpy())
