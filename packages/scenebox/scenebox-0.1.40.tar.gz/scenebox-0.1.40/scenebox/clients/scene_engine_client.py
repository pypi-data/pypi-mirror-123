...
from ..custom_exceptions import (AssetError, IndexingException,
                                 ...
                                 SetsError, ThumbnailNotAvailableError)
...
class SceneEngineClient(object):
    ...
    def __init__(
        ...
        """Create a SceneEngineClient object.  Used to interact with SceneBox's
           ...
           scene_engine_url:
               Specifies the URL for the SceneEngine REST server.
           asset_manager_url:
    ...
    def with_auth(self,
        ...
        """Save auth.token into SceneEngineClient as an instance attribute.  Allow for the use of SceneEngineClient
        methods when a given SceneEngineClient object has not been instantiated with an auth_token.
    ...
    def update_artifact_path(self, artifacts_path):
        """Updates the SceneEngineClient artifact path instance attribute.
    ...
    def get_job(self, job_id: str) -> Job:
        """Get the job_manager_client.Job associated with the passed job ID.
    ...
    def add_coco_annotations_from_folder(
        ...
        ground_truth:
            If True, marks the given annotations as the ground truth.
            Otherwise, does not mark the annotations as the ground truth.
        session_uid:
    ...
    def search_assets(
        ...
        """Search and retrieve a list of assets.
    ...
    def search_meta(
        ...
        """Search and retrieve the metadata of assets.
    ...
    def model_inference(self,
        ...
        image_size:
            If True and model is StarDist or Image Intensity Histogram, resizes the input images to the provided size
            before performing inference(s).
            Otherwise, do nothing.
        threshold:
           Model predictions under the threshold will be discarded. Range 0.0 to 1.0.
        classes_of_interest:
            If True, model is Mask RCNN, and either obtain_mask or obtain_bbox is True, discards model inferences from
            classes that are not in the passed list.
            Otherwise, do nothing but log an error if the model chosen is StarDist or Image Intensity Histogram.
        wait_for_completion:
            If True, polls until job is complete.
            Otherwise, continues execution and does not raise an error if the job does not complete.
        progress_callback:
