...
FILE_str = "FILE"
onnx_str = "onnx"
pytorch_lightning_str = "pytorch_lightning"
...
def save_model(model, library: str, input_shape: list):
    ...
    if not isinstance(model, str):
        ...
        if library == pytorch_str or library == pytorch_lightning_str:
...
def hash_model(model, library):
    ...
    elif library == pytorch_str or library == pytorch_lightning_str:
