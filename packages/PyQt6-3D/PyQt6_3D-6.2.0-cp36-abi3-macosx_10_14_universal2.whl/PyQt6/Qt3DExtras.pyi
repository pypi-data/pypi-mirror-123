...
class QDiffuseMapMaterial(Qt3DRender.QMaterial):
    ...
    def specularChanged(self, specular: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def diffuseChanged(self, diffuse: Qt3DRender.QAbstractTexture) -> None: ...
    def ambientChanged(self, ambient: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QForwardRenderer(Qt3DRender.QTechniqueFilter):
    ...
    def clearColorChanged(self, clearColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QGoochMaterial(Qt3DRender.QMaterial):
    ...
    def warmChanged(self, warm: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def coolChanged(self, cool: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def specularChanged(self, specular: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def diffuseChanged(self, diffuse: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setShininess(self, shininess: float) -> None: ...
...
def setupWindowSurface(self, window: QtGui.QWindow, a1: Qt3DRender.API) -> None: ...
