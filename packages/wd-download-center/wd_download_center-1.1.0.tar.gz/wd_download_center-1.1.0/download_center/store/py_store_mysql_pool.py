        ...
        if len(data) <= 0:
            ...
            try:
                ...
                if len(values) <= 0 or field_value is None:
                    return -1
                sql = "update " + table + " set " + values[:-1] + " where " + field + "='" + pymysql.escape_string(str(field_value)) + "'"
    ...
    def saveorupdate(self, table, data, field, mapping_fields=dict()):
        ...
        try:
            ...
            if field_value is None:
                return -1
            querysql = "select count(1) from " + table + " where " + field + "='" + pymysql.escape_string(str(field_value)) + "'"
