...
class DfuDevice:
    def __init__(self, device, timeout = None):
        ...
        dfu_desc = list(_get_dfu_functional_descriptors(self.cfg.interfaces()))
        ...
        for intf in self.cfg.interfaces():
            ...
            intf_name = usb.util.get_string(self.dev, intf.iInterface)
    ...
    def _control_msg(self, requestType: RequestType, request: Request, value: int, buffer):
        ...
        return self.dev.ctrl_transfer(requestType.value, request.value, value, self._memory['intf'].bInterfaceNumber, buffer, timeout=60000)
    ...
    def _get_status(self):
        ...
        text = usb.util.get_string(self.dev, msg[5])
