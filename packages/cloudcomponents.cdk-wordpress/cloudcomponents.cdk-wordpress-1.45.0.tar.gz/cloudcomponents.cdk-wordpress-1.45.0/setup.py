    ...
    """
{
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-backup>=1.128.0, <2.0.0",
        ...
        "aws-cdk.aws-efs>=1.128.0, <2.0.0",
        "aws-cdk.aws-elasticloadbalancingv2-actions>=1.128.0, <2.0.0",
        "aws-cdk.aws-elasticloadbalancingv2>=1.128.0, <2.0.0",
        "aws-cdk.aws-iam>=1.128.0, <2.0.0",
        "aws-cdk.aws-logs>=1.128.0, <2.0.0",
        "aws-cdk.aws-rds>=1.128.0, <2.0.0",
