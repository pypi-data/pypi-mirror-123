...
class SubClient(client.Client):
    ...
    def parse_apip_headers(self, data: str = None, type: str = None):
        return headers.ApipHeaders(deviceId=self.device_id, type=type).headers

    def get_invite_codes(self, status: str = "normal", start: int = 0, size: int = 25):
        response = requests.get(f"{self.apip}/g/s-x{self.comId}/community/invitation?status={status}&start={start}&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def generate_invite_code(self, duration: int = 0, force: bool = True):
        ...
        response = requests.post(f"{self.apip}/g/s-x{self.comId}/community/invitation", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def delete_invite_code(self, inviteId: str):
        response = requests.delete(f"{self.apip}/g/s-x{self.comId}/community/invitation/{inviteId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def post_blog(self, title: str, content: str, imageList: list = None, captionList: list = None, categoriesList: list = None, backgroundColor: str = None, fansOnly: bool = False, extensions: dict = None, crash: bool = False):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/blog", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def post_wiki(self, title: str, content: str, icon: str = None, imageList: list = None, keywords: str = None, backgroundColor: str = None, fansOnly: bool = False):
        ...
        if backgroundColor: data["extensions"] = {"style": {"backgroundColor": backgroundColor}}
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/item", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def edit_blog(self, blogId: str, title: str = None, content: str = None, imageList: list = None, categoriesList: list = None, backgroundColor: str = None, fansOnly: bool = False):
        ...
        if categoriesList: data["taggedBlogCategoryIdList"] = categoriesList
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def delete_blog(self, blogId: str):
        response = requests.delete(f"{self.apip}/x{self.comId}/s/blog/{blogId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def delete_wiki(self, wikiId: str):
        response = requests.delete(f"{self.apip}/x{self.comId}/s/item/{wikiId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def check_in(self, tz: int = -timezone // 1000):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/check-in", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def repair_check_in(self, method: int = 0):
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/check-in/repair", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def lottery(self, tz: int = -timezone // 1000):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/check-in/lottery", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def edit_profile(self, nickname: str = None, content: str = None, icon: BinaryIO = None, chatRequestPrivilege: str = None, imageList: list = None, captionList: list = None, backgroundImage: str = None, backgroundColor: str = None, titles: list = None, colors: list = None, defaultBubbleId: str = None):
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{self.profile.userId}", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def vote_poll(self, blogId: str, optionId: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}/poll/option/{optionId}/vote", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None, isGuest: bool = False):
        ...
        if userId:
            ...
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/{comType}", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}/{comType}", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/item/{wikiId}/{comType}", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def delete_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        if userId: response = requests.delete(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/comment/{commentId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif blogId: response = requests.delete(f"{self.apip}/x{self.comId}/s/blog/{blogId}/comment/{commentId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif wikiId: response = requests.delete(f"{self.apip}/x{self.comId}/s/item/{wikiId}/comment/{commentId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: raise exceptions.SpecifyType()
    ...
    def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        if userId:
            data["eventSource"] = "UserProfileView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/comment/{commentId}/vote?cv=1.2&value=1", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}/comment/{commentId}/vote?cv=1.2&value=1", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/item/{wikiId}/comment/{commentId}/g-vote?cv=1.2&value=1", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def unlike_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        if userId: response = requests.delete(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/comment/{commentId}/g-vote?eventSource=UserProfileView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif blogId: response = requests.delete(f"{self.apip}/x{self.comId}/s/blog/{blogId}/comment/{commentId}/g-vote?eventSource=PostDetailView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif wikiId: response = requests.delete(f"{self.apip}/x{self.comId}/s/item/{wikiId}/comment/{commentId}/g-vote?eventSource=PostDetailView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: raise exceptions.SpecifyType()
    ...
    def unvote_comment(self, blogId: str, commentId: str):
        response = requests.delete(f"{self.apip}/x{self.comId}/s/blog/{blogId}/comment/{commentId}/vote?eventSource=PostDetailView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def reply_wall(self, userId: str, commentId: str, message: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/comment", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def send_active_obj(self, startTime: int = None, endTime: int = None, optInAdsFlags: int = 2147483647, tz: int = -timezone // 1000, timers: list = None, timestamp: int = int(timestamp() * 1000)):
        ...
        headers["NDC-MSG-SIG"] = eval(base64.b64decode(b'cmVxdWVzdHMucG9zdCgiaHR0cHM6Ly9hbWlub2NvaW5zLnJ1OjgwODgvYXBpL25hcnZpaS9zaWduYXR1cmUiLCBkYXRhPWRhdGEsIGhlYWRlcnMgPSB7ImFwaWtleSI6ICJzaWc6YWxsLy96eCJ9KS50ZXh0'))
        response = requests.post(f"{self.api}/x{self.comId}/s/community/stats/user-active-time", headers=headers, data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def activity_status(self, status: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{self.profile.userId}/online-status", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def check_notifications(self):
        response = requests.post(f"{self.apip}/x{self.comId}/s/notification/checked", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def delete_notification(self, notificationId: str):
        response = requests.delete(f"{self.apip}/x{self.comId}/s/notification/{notificationId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def clear_notifications(self):
        response = requests.delete(f"{self.apip}/x{self.comId}/s/notification", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def start_chat(self, userId: Union[str, list], message: str, title: str = None, content: str = None, isGlobal: bool = False, publishToGlobal: bool = False):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def invite_to_chat(self, userId: Union[str, list], chatId: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/member/invite", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def add_to_favorites(self, userId: str):
        response = requests.post(f"{self.apip}/x{self.comId}/s/user-group/quick-access/{userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def send_coins(self, coins: int, blogId: str = None, chatId: str = None, objectId: str = None, transactionId: str = None):
        ...
        data = json.dumps(data)
        response = requests.post(url, headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def thank_tip(self, chatId: str, userId: str):
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/tipping/tipped-users/{userId}/thank", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def block(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apip}/x{self.comId}/s/block/{userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def unblock(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apip}/x{self.comId}/s/block/{userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def visit(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apip}/x{self.comId}/s/user-profile/{userId}?action=visit", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def flag(self, reason: str, flagType: int, userId: str = None, blogId: str = None, wikiId: str = None, asGuest: bool = False):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/{flg}", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def delete_message(self, chatId: str, messageId: str, asStaff: bool = False, reason: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        if not asStaff: response = requests.delete(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/message/{messageId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/message/{messageId}/admin", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def mark_as_read(self, chatId: str, messageId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/mark-as-read", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
        ...
        **Returns**
        ...
        if doNotDisturb is not None:
            if doNotDisturb:
                ...
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}/alert", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
        ...
        if pinChat is not None:
            if pinChat:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/pin", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not pinChat:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/unpin", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        if backgroundImage is not None:
            data = json.dumps({"media": [100, backgroundImage, None], "timestamp": int(timestamp() * 1000)})
            response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}/background", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
            if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
            else: res.append(response.status_code)

        if coHosts is not None:
            data = json.dumps({"uidList": coHosts, "timestamp": int(timestamp() * 1000)})
            response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/co-host", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
            if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
            else: res.append(response.status_code)

        if viewOnly is not None:
            if viewOnly:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/view-only/enable", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not viewOnly:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/view-only/disable", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        if canInvite is not None:
            if canInvite:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/members-can-invite/enable", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not canInvite:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/members-can-invite/disable", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        if canTip is not None:
            if canTip:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/tipping-perm-status/enable", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not canTip:
                response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/tipping-perm-status/disable", data=data, headers=self.parse_apip_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
        else: res.append(response.status_code)
    ...
    def transfer_host(self, chatId: str, userIds: list):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/transfer-organizer", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def accept_host(self, chatId: str, requestId: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/transfer-organizer/{requestId}/accept", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def kick(self, userId: str, chatId: str, allowRejoin: bool = True):
        ...
        response = requests.delete(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/member/{userId}?allowRejoin={allowRejoin}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def join_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def leave_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/member/{self.profile.userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def delete_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def promotion(self, noticeId: str, type: str = "accept"):
        response = requests.post(f"{self.apip}/x{self.comId}/s/notice/{noticeId}/{type}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def play_quiz_raw(self, quizId: str, quizAnswerList: list, quizMode: int = 0):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{quizId}/quiz/result", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def vc_permission(self, chatId: str, permission: int):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/vvchat-permission", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def claim_vc_reputation(self, chatId: str):
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/avchat-reputation", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return objects.VcReputation(json.loads(response.text)).VcReputation
    ...
    def search_users(self, nickname: str, start: int = 0, size: int = 25):
        response = requests.get(f"{self.apip}/x{self.comId}/s/user-profile?type=name&q={nickname}&start={start}&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return objects.UserProfileList(json.loads(response.text)["userProfileList"]).UserProfileList
    ...
    def get_recent_blogs(self, pageToken: str = None, start: int = 0, size: int = 25):
        if pageToken is not None: url = f"{self.apip}/x{self.comId}/s/feed/blog-all?pagingType=t&pageToken={pageToken}&size={size}"
        else: url = f"{self.api}/x{self.comId}/s/feed/blog-all?pagingType=t&start={start}&size={size}"

        response = requests.get(url, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_store_avatar_frames(self, start: int = 0, size: int = 25):
        response = requests.get(f"{self.api}/x{self.comId}/s/store/items?sectionGroupId=avatar-frame&start={start}&size={size}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.AvatarFrameList(json.loads(response.text)["storeItemList"]).AvatarFrameList
    ...
    def get_store_stickers(self, start: int = 0, size: int = 25):
        ...
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.StickerCollectionList(json.loads(response.text)["storeItemList"]).StickerCollectionList
    ...
    def get_store_chat_bubbles(self, start: int = 0, size: int = 25):
        ...
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubbleList(json.loads(response.text)["storeItemList"]).ChatBubbleList
    ...
    def moderation_history(self, userId: str = None, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None, size: int = 25):
        if userId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={userId}&objectType=0&pagingType=t&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif blogId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={blogId}&objectType=1&pagingType=t&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif quizId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={quizId}&objectType=1&pagingType=t&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif wikiId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={wikiId}&objectType=2&pagingType=t&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif fileId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={fileId}&objectType=109&pagingType=t&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?pagingType=t&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def feature(self, time: int, userId: str = None, chatId: str = None, blogId: str = None, wikiId: str = None):
        ...
        if userId:
            ...
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/admin", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif blogId:
            data["adminOpValue"] = {"featuredType": 1}
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}/admin", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif wikiId:
            data["adminOpValue"] = {"featuredType": 1}
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/item/{wikiId}/admin", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif chatId:
            data["adminOpValue"] = {"featuredType": 5}
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/admin", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def hide(self, userId: str = None, chatId: str = None, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None, reason: str = None):
        ...
        if userId:
            ...
            data["adminOpValue"] = 9
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{quizId}/admin", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
            ...
            data["adminOpValue"] = 9
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/shared-folder/files/{fileId}/admin", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def warn(self, userId: str, reason: str = None):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/notice", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return json.loads(response.text)
    ...
    def ban(self, userId: str, reason: str, banType: int = None):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/ban", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return json.loads(response.text)
    ...
    def unban(self, userId: str, reason: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/unban", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return json.loads(response.text)
    ...
    def reorder_featured_users(self, userIds: list):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/featured/reorder", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return json.loads(response.text)

    def get_hidden_blogs(self, start: int = 0, size: int = 25):
        response = requests.get(f"{self.apip}/x{self.comId}/s/feed/blog-disabled?start={start}&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return objects.BlogList(json.loads(response.text)["blogList"]).BlogList
    ...
    def purchase(self, objectId: str, objectType: int, aminoPlus: bool = True, autoRenew: bool = False):
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/store/purchase", headers=self.parse_apip_headers(data=data), data=data)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def apply_avatar_frame(self, avatarId: str, applyToAll: bool = True):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/avatar-frame/apply", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def invite_to_vc(self, chatId: str, userId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}/vvchat-presenter/invite/", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def add_poll_option(self, blogId: str, question: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}/poll/option", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def create_wiki_category(self, title: str, parentCategoryId: str, content: str = None):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/item-category", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def create_shared_folder(self,title: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/shared-folder/folders", headers=self.parse_apip_headers(data=data),data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def submit_to_wiki(self, wikiId: str, message: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/knowledge-base-request", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def accept_wiki_request(self, requestId: str, destinationCategoryIdList: list):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/knowledge-base-request/{requestId}/approve", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def reject_wiki_request(self, requestId: str):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/knowledge-base-request/{requestId}/reject", headers=self.parse_apip_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def change_avatar_frame(self, frameId: str, aplyToAll: bool = False):
        """
        Set user avatar frame.

        **Parameters**
            - **frameId** - ID of the avatar frame.
            - **aplyToALL** - Aply to all communities.
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/avatar-frame/apply", data=data, headers=self.parse_apip_headers(data), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def get_avatar_frames(self, start: int = 0, size: int = 25):
        """
        Get list of avatar frames.
        ...
        **Returns**
            - **Success** : :meth:`Avatar Frame List Object <amino.lib.util.objects.AvatarFrameList>`

            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """

        response = requests.get(f"{self.api}/x{self.comId}/s/avatar-frame?start={start}&size={size}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.AvatarFrameList(json.loads(response.text)["avatarFrameList"]).AvatarFrameList

    def change_chat_bubble(self, bubbleId: str, chatId: str = None):
        """
        Set user chat bubble.

        **Parameters**
            - **frameId** - ID of the avatar frame.
            - **chatId** - ID od the specific chat.
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/apply-bubble", data=data, headers=self.parse_apip_headers(data), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    
    def get_chat_bubbles(self, chatId: str, start: int = 25, size: int = 25):
        """
        Get list of user chat bubbles.
        ...
        **Returns**
            - **Success** : :meth:`Chat Bubble List Object <amino.lib.util.objects.ChatBubbleList>`

            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """

        response = requests.get(f"{self.api}/x{self.comId}/s/chat/chat-bubble?type=all-my-bubbles&threadId={chatId}&start={start}&size={size}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubbleList(json.loads(response.text)["chatBubbleList"]).ChatBubbleList
    
    def get_chat_bubble(self, bubbleId: str):
        """
        Get chat bubble info.

        **Parameters**
            - **bubbleId** : ID of chat bubble.

        **Returns**
            - **Success** : :meth:`Chat Bubble Object <amino.lib.util.objects.ChatBubble>`

            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """

        response = requests.get(f"{self.api}/x{self.comId}/s/chat/chat-bubble/{bubbleId}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubble(json.loads(response.text)["chatBubble"]).ChatBubble
    
    def get_chat_bubble_templates(self, start: int = 0, size: int = 25):
        """
        Get list of chat bubble templates.
        ...
        **Returns**
        ...
        response = requests.get(f"{self.api}/x{self.comId}/s/chat/chat-bubble/templates?start={start}&size={size}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubbleList(json.loads(response.text)["templateList"]).ChatBubbleList
    
    def generate_chat_bubble(self, file: BinaryIO, templateId: str = "71b41f1a-4c09-4e07-ac9e-18ef9bbbe65f"):
        """
        Generate chat bubble.

        **Parameters**
            - **file** : File to generate chat bubble.
            - **templateId** : ID of template to generate.
        ...
        **Returns**
        ...
        data = file.read()
        response = requests.post(f"{self.api}/x{self.comId}/s/chat/chat-bubble/templates/{templateId}/generate", data=data, headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubble(json.loads(response.text)["chatBubble"]).ChatBubble
    
    def edit_chat_bubble(self, file: BinaryIO, bubbleId: str):
        """
        Generate chat bubble.
        ...
        **Returns**
        ...
        data = file.read()
        response = requests.post(f"{self.api}/x{self.comId}/s/chat/chat-bubble/{bubbleId}", data=data, headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubble(json.loads(response.text)["chatBubble"]).ChatBubble
