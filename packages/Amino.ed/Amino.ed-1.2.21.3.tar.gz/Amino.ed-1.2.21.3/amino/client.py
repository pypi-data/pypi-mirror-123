...
from locale import getdefaultlocale as locale, resetlocale

from .lib.util import exceptions, headers, device, objects, helpers, tapjoy
from .socket import Callbacks, SocketHandler

device = device.DeviceGenerator()

class Client(Callbacks, SocketHandler):
    def __init__(self, deviceId: str = None, sockets: bool = True, proxies: dict = None, certificatePath = None, socket_trace = False, socketDebugging = False):
        ...
        self.web_headers = headers.WebHeaders().headers
        self.tapjoy_headers = tapjoy.Tapjoy().headers
    ...
    def login_sid(self, SID: str):
        ...
        **Parameters**
        ...
        user_info = self.get_user_info(self.userId)
        self.account: objects.UserProfile = user_info
        self.profile: objects.UserProfile = user_info
    ...
    def web_login(self, email: str, password: str): # I working on it
        """
        Web Login into an account.
        ...
        **Returns**
        ...
        data = json.dumps({
            ...
            "email": email,
            "secret": password,
            "recaptcha_challenge": "byAlert",
            "recaptcha_version": "v3"
        })

        response = requests.post(f"{self.web_api}/auth", headers=self.web_headers, data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: raise Exception(response.text)
        else:
            try:
                self.authenticated = True
                self.json = json.loads(response.text)
                assert self.json["result"]["uid"]
                self.userId = self.json["result"]["uid"]

                user_info = self.get_user_info(self.userId)
                self.account: objects.UserProfile = user_info
                self.profile: objects.UserProfile = user_info

                self.web_headers["cookie"] = response.headers["set-cookie"]
                sid_index = self.web_headers["cookie"].index(";")
                self.sid = self.web_headers["cookie"][4: sid_index]
                headers.sid = self.sid
                ...
                raise Exception((e, self.json["result"]))
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/auth/login", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def register(self, nickname: str, email: str, password: str, verificationCode: str, deviceId: str = device.device_id):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/auth/register", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def restore(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/account/delete-request/cancel", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def logout(self):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/auth/logout", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else:
            self.authenticated = False
            self.json = None
    ...
    def configure(self, age: int, gender: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/persona/profile/basic", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def verify(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/auth/check-security-validation", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def request_verify_code(self, email: str, resetPassword: bool = False):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/auth/request-security-validation", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def activate_account(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/auth/activate-email", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def delete_account(self, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/account/delete-request", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def change_password(self, email: str, password: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/auth/reset-password", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def check_device(self, deviceId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/device", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def upload_media(self, file: BinaryIO, fileType: str):
        ...
        **Returns**
        ...
        if fileType == "audio":
            ...
            url += "/target/chat-bubble-thumbnail"
        else: raise exceptions.SpecifyType(fileType)

        data = file.read()
        response = requests.post(f"{self.apip}{url}", data=data, headers=headers.Headers(type=t, data=data, deviceId=self.device_id).headers, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def get_eventlog(self, lang: str = "en"):
        response = requests.get(f"{self.apip}/g/s/eventlog/profile?language={lang}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def sub_clients(self, start: int = 0, size: int = 25):
        ...
        **Returns**
        ...
        response = requests.get(f"{self.apip}/g/s/community/joined?v=1&start={start}&size={size}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def join_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/member/{self.userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def leave_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apip}/g/s/chat/thread/{chatId}/member/{self.userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def start_chat(self, userId: Union[str, list], message: str, title: str = None, content: str = None, isGlobal: bool = False, publishToGlobal: bool = False):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/chat/thread", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def invite_to_chat(self, userId: Union[str, list], chatId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/member/invite", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def kick(self, userId: str, chatId: str, allowRejoin: bool = True):
        ...
        response = requests.delete(f"{self.apip}/g/s/chat/thread/{chatId}/member/{userId}?allowRejoin={allowRejoin}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def search_community(self, aminoId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apip}/g/s/search/amino-id-and-link?q={aminoId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else:
    ...
    def flag(self, reason: str, flagType: int, userId: str = None, blogId: str = None, wikiId: str = None, asGuest: bool = False):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/g/s/{flg}", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def send_message(self, chatId: str, message: str = None, messageType: int = 0, file: BinaryIO = None, fileType: str = None, replyTo: str = None, mentionUserIds: list = None, stickerId: str = None, embedId: str = None, embedType: int = None, embedLink: str = None, embedTitle: str = None, embedContent: str = None, embedImage: BinaryIO = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/message", headers=self.parse_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def delete_message(self, chatId: str, messageId: str, asStaff: bool = False, reason: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        if not asStaff: response = requests.delete(f"{self.apip}/g/s/chat/thread/{chatId}/message/{messageId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/message/{messageId}/admin", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def mark_as_read(self, chatId: str, messageId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/mark-as-read", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
        ...
        **Returns**
        ...
        if doNotDisturb is not None:
            if doNotDisturb:
                ...
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/member/{self.userId}/alert", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        ...
        if pinChat is not None:
            if pinChat:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/pin", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not pinChat:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/unpin", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        if backgroundImage is not None:
            data = json.dumps({"media": [100, backgroundImage, None], "timestamp": int(timestamp() * 1000)})
            response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/member/{self.userId}/background", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
            if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
            else: res.append(response.status_code)

        if coHosts is not None:
            data = json.dumps({"uidList": coHosts, "timestamp": int(timestamp() * 1000)})
            response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/co-host", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
            if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
            else: res.append(response.status_code)

        if viewOnly is not None:
            if viewOnly:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/view-only/enable", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not viewOnly:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/view-only/disable", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        if canInvite is not None:
            if canInvite:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/members-can-invite/enable", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not canInvite:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/members-can-invite/disable", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        if canTip is not None:
            if canTip:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/tipping-perm-status/enable", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not canTip:
                response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/tipping-perm-status/disable", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        data = json.dumps(data)
        response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 and json.loads(response.text)["api:statuscode"] != 0: res.append(exceptions.CheckException(json.loads(response.text)))
        else: res.append(response.status_code)
    ...
    def visit(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apip}/g/s/user-profile/{userId}?action=visit", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def send_coins(self, coins: int, blogId: str = None, chatId: str = None, objectId: str = None, transactionId: str = None):
        ...
        if objectId is not None:
            ...
            data["objectType"] = 2
            url = f"{self.apip}/g/s/tipping"

        if url is None: raise exceptions.SpecifyType()

        data = json.dumps(data)
        response = requests.post(url, headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def follow(self, userId: Union[str, list]):
        ...
        **Returns**
        ...
        if isinstance(userId, str):
            ...
            response = requests.post(f"{self.api}/g/s/user-profile/{self.userId}/joined", headers=self.parse_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def unblock(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.api}/g/s/block/{userId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def join_community(self, comId: str, invitationId: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{comId}/s/community/join", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def request_join_community(self, comId: str, message: str = None):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/x{comId}/s/community/membership-request", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def leave_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apip}/x{comId}/s/community/leave", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def flag_community(self, comId: str, reason: str, flagType: int, isGuest: bool = False):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/x{comId}/s/{flg}", data=data, headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def edit_profile(self, nickname: str = None, content: str = None, icon: BinaryIO = None, backgroundColor: str = None, backgroundImage: str = None, defaultBubbleId: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/g/s/user-profile/{self.userId}", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def set_privacy_status(self, isAnonymous: bool = False, getNotifications: bool = False):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/g/s/account/visit-settings", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def set_amino_id(self, aminoId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/account/change-amino-id", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def reorder_linked_communities(self, comIds: list):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/user-profile/{self.userId}/linked-community/reorder", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def add_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apip}/g/s/user-profile/{self.userId}/linked-community/{comId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def remove_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apip}/g/s/user-profile/{self.userId}/linked-community/{comId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None):
        ...
        **Returns**
        ...
        if userId:
            ...
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/g/s/user-profile/{userId}/g-comment", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/g/s/blog/{blogId}/g-comment", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/g/s/item/{wikiId}/g-comment", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def delete_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        if userId: response = requests.delete(f"{self.apip}/g/s/user-profile/{userId}/g-comment/{commentId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif blogId: response = requests.delete(f"{self.apip}/g/s/blog/{blogId}/g-comment/{commentId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif wikiId: response = requests.delete(f"{self.apip}/g/s/item/{wikiId}/g-comment/{commentId}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: raise exceptions.SpecifyType
        ...
        **Returns**
        ...
        if blogId:
            if isinstance(blogId, str):
                data["eventSource"] = "UserProfileView"
                data = json.dumps(data)
                response = requests.post(f"{self.apip}/g/s/blog/{blogId}/g-vote?cv=1.2", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)

            elif isinstance(blogId, list):
                data["targetIdList"] = blogId
                data = json.dumps(data)
                response = requests.post(f"{self.apip}/g/s/feed/g-vote", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
            ...
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/g/s/item/{wikiId}/g-vote?cv=1.2", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def unlike_blog(self, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        if blogId: response = requests.delete(f"{self.apip}/g/s/blog/{blogId}/g-vote?eventSource=UserProfileView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif wikiId: response = requests.delete(f"{self.apip}/g/s/item/{wikiId}/g-vote?eventSource=PostDetailView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: raise exceptions.SpecifyType
    ...
    def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
        ...
        if userId:
            data["eventSource"] = "UserProfileView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/g/s/user-profile/{userId}/comment/{commentId}/g-vote?cv=1.2&value=1", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/g/s/blog/{blogId}/comment/{commentId}/g-vote?cv=1.2&value=1", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/g/s/item/{wikiId}/comment/{commentId}/g-vote?cv=1.2&value=1", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def unlike_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        if userId: response = requests.delete(f"{self.apip}/g/s/user-profile/{userId}/comment/{commentId}/g-vote?eventSource=UserProfileView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif blogId: response = requests.delete(f"{self.apip}/g/s/blog/{blogId}/comment/{commentId}/g-vote?eventSource=PostDetailView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        elif wikiId: response = requests.delete(f"{self.apip}/g/s/item/{wikiId}/comment/{commentId}/g-vote?eventSource=PostDetailView", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        else: raise exceptions.SpecifyType
    ...
    def get_from_code(self, code: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apip}/g/s/link-resolution?q={code}", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
    ...
    def get_from_id(self, objectId: str, objectType: int, comId: str = None):
        ...
        **Returns**
        ...
        if comId: response = requests.post(f"{self.apip}/g/s-x{comId}/link-resolution", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        else: response = requests.post(f"{self.apip}/g/s/link-resolution", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return objects.FromCode(json.loads(response.text)["linkInfoV2"]).FromCode
    ...
    def claim_new_user_coupon(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apip}/g/s/coupon/new-user-coupon/claim", headers=self.parse_apip_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def get_subscriptions(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.api}/g/s//subscription?objectType=122&start={start}&size={size}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return json.loads(response.text)["SubscriptionItemList"]
    ...
    def accept_host(self, chatId: str, requestId: str):
        ...
        response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/transfer-organizer/{requestId}/accept", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def invite_to_vc(self, chatId: str, userId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/chat/thread/{chatId}/vvchat-presenter/invite", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def wallet_config(self, level: int):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/wallet/ads/config", headers=self.parse_apip_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code

    def get_tapjoy_rewaard(self, userId: str = None):
        """
        Claim tapjoy ad reward.

        **Parameters**
            - **userId** - ID of the User to send reward.
        ...
        **Returns**
        ...
        if response.status_code != 204: return Exception(response.text)
        else: return response.status_code
    ...
    def change_avatar_frame(self, frameId: str, aplyToAll: bool = False):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/avatar-frame/apply", data=data, headers=self.parse_apip_headers(data), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def change_chat_bubble(self, bubbleId: str, chatId: str = None):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apip}/g/s/chat/thread/apply-bubble", data=data, headers=self.parse_apip_headers(data), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200 or json.loads(response.text)["api:statuscode"] != 0: return exceptions.CheckException(response.json())
        else: return response.status_code
    ...
    def get_chat_bubbles(self, chatId: str, start: int = 25, size: int = 25):
        ...
        **Returns**
        ...
        response = requests.get(f"{self.api}/g/s/chat/chat-bubble?type=all-my-bubbles?threadId={chatId}?start={start}?size={size}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_chat_bubble(self, bubbleId: str):
        ...
        **Returns**
        ...
        response = requests.get(f"{self.api}/g/s/chat/chat-bubble/{bubbleId}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_chat_bubble_templates(self, start: int = 0, size: int = 25):
        ...
        **Returns**
        ...
        response = requests.get(f"{self.api}/g/s/chat/chat-bubble/templates?start={start}&size={size}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def generate_chat_bubble(self, file: BinaryIO, templateId: str = "71b41f1a-4c09-4e07-ac9e-18ef9bbbe65f"):
        ...
        **Returns**
        ...
        data = file.read()
        response = requests.post(f"{self.api}/g/s/chat/chat-bubble/templates/{templateId}/generate", data=data, headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubble(json.loads(response.text)["chatBubble"]).ChatBubble
    ...
    def edit_chat_bubble(self, file: BinaryIO, bubbleId: str):
        ...
        **Returns**
        ...
        data = file.read()
        response = requests.post(f"{self.api}/g/s/chat/chat-bubble/{bubbleId}", data=data, headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.ChatBubble(json.loads(response.text)["chatBubble"]).ChatBubble
