...
def distinct_by_column(list, distinct_by_column=1):  # excel column start from 1
    ...
    returns:
    dict: The distinct record return as dictionary
    """
    dict = {}
    for line in list:
...
def merge_files(merge_file_name, list_of_file_sources, write_mode="w", remove_header_line_number=0, remove_bottom_line_number=0):
    """ Function to merge list of files into 1 file. ie: merge_files(merge_file_name, ["data/file1", "data/file2"], "w", 1, 0) # Remove Header
