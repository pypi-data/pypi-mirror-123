...
class CollectionsContainingBundlesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __bundles_containing_collection(
            self,
            identifier,
            **kwargs
        ):
            ...
            >>> thread = api.bundles_containing_collection(identifier, async_req=True)
            >>> result = thread.get()
        ...
        self.bundles_containing_collection = _Endpoint(
            settings={
                'response_type': (Products,),
                'auth': [],
                'endpoint_path': '/collections/{identifier}/bundles',
                'operation_id': 'bundles_containing_collection',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__bundles_containing_collection
        )
