...
class CollectionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.collections_by_lidvid = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/collections/{identifier}',
                'operation_id': 'collections_by_lidvid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__collections_by_lidvid
        )

        def __collections_by_lidvid_all(
            self,
            identifier,
            **kwargs
        ):
        ...
        self.collections_by_lidvid_all = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/collections/{identifier}/all',
                'operation_id': 'collections_by_lidvid_all',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__collections_by_lidvid_all
        )

        def __collections_by_lidvid_latest(
            self,
            identifier,
            **kwargs
        ):
        ...
        self.collections_by_lidvid_latest = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/collections/{identifier}/latest',
                'operation_id': 'collections_by_lidvid_latest',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__collections_by_lidvid_latest
        )
