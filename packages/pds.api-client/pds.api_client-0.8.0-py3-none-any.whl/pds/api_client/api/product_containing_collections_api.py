...
class ProductContainingCollectionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __collections_containing_product(
            self,
            identifier,
            **kwargs
        ):
            ...
            >>> thread = api.collections_containing_product(identifier, async_req=True)
            >>> result = thread.get()
        ...
        self.collections_containing_product = _Endpoint(
            settings={
                'response_type': (Products,),
                'auth': [],
                'endpoint_path': '/products/{identifier}/collections',
                'operation_id': 'collections_containing_product',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__collections_containing_product
        )
