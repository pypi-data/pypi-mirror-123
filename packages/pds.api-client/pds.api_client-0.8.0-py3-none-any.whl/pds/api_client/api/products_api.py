    ...
    def __init__(self, api_client=None):
        ...
        def __products_by_lidvid(
            ...
            **kwargs
            ...
            >>> thread = api.products_by_lidvid(identifier, async_req=True)
            >>> result = thread.get()
        ...
        self.products_by_lidvid = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/products/{identifier}',
                'operation_id': 'products_by_lidvid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__products_by_lidvid
        )

        def __products_by_lidvid_all(
            self,
            identifier,
            **kwargs
        ):
            ...
            >>> thread = api.products_by_lidvid_all(identifier, async_req=True)
            >>> result = thread.get()
        ...
        self.products_by_lidvid_all = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/products/{identifier}/all',
                'operation_id': 'products_by_lidvid_all',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__products_by_lidvid_all
        )

        def __products_by_lidvid_latest(
            self,
            identifier,
            **kwargs
        ):
            ...
            >>> thread = api.products_by_lidvid_latest(identifier, async_req=True)
            >>> result = thread.get()
        ...
        self.products_by_lidvid_latest = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/products/{identifier}/latest',
                'operation_id': 'products_by_lidvid_latest',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__products_by_lidvid_latest
        )
