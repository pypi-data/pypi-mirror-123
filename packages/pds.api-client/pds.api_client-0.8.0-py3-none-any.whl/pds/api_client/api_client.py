...
from pds.api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from pds.api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BundlesApi()
        api_instance.bundle_by_lidvid  # this is an instance of the class Endpoint
        api_instance.bundle_by_lidvid()  # this invokes api_instance.bundle_by_lidvid.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.bundle_by_lidvid.callable or self.callable in this class
