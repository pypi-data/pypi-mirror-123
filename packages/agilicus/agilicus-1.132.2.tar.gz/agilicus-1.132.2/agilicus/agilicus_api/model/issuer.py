...
class Issuer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'kerberos_upstreams': ([dict],),  # noqa: E501
    ...
    def _from_openapi_data(cls, issuer, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            kerberos_upstreams ([dict]): The set of kerberos upstream identity providers for this issuer. Device identity can be used to enable zero-interaction login for users on trusted devices which have already entered their credentials. . [optional]  # noqa: E501
