...
from .transformtools import (transform_formant, transform_formant_from_dist,
                             sparse_transform, get_pros_modif_factor_from_dist,
                             transform_pitch)
...
class SpeechAudio:
    ...
    def sparse_transform(self, W_source, W_target, isFlat=True, isNorm=True):
