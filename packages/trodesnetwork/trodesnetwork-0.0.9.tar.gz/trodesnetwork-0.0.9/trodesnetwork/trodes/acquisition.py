...
class AcquisitionClient():
    def __init__(self, server_address):
        self.service = socket.ServiceConsumer('trodes.acquisition.service', server_address=server_address)
...
class AcquisitionSubscriber():
    ...
    class AcquisitionSubscriberThread(threading.Thread):
        def __init__(self, server_address, callback):
            ...
            self.subscriber = socket.SourceSubscriber('trodes.acquisition', server_address=server_address)
            self.callback = callback
