...
class FutureWrapper(QObject):
    ...
    async def acall(self, *args, **kwargs):
        #if self.receivers("call(str, tuple, dict)") == 0:
        #    if self.pass_through: return None
        #    else: raise UnconnectedSignalError("This future has no connected receivers")
        # TODO: Reimplement for debugging, right now not working bcause of QObject receivers missalignment between pyside2 and pyqt5
