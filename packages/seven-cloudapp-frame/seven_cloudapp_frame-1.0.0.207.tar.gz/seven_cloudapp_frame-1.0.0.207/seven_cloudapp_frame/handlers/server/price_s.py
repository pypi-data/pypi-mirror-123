...
@LastEditTime: 2021-09-14 19:47:28
...
class PriceGearListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        self.response_json_success(PriceBaseModel(context=self).get_price_gear_list(app_id, act_id, page_size, page_index,is_del=is_del,is_cache=False))
