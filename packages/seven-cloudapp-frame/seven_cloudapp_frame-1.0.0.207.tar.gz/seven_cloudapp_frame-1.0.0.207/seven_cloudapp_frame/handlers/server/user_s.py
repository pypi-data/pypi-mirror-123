...
@LastEditTime: 2021-09-23 16:38:02
...
class UserBlackListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        user_base_model = UserBaseModel(context=self)
        self.response_json_success(user_base_model.get_black_list(app_id, act_id, page_size, page_index, audit_status, user_id, start_date, end_date, user_nick, open_id))
...
class AssetLogListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        asset_base_model = AssetBaseModel(context=self)
        self.response_json_success(asset_base_model.get_asset_log_list(app_id, act_id, asset_type, page_size, page_index, user_id, asset_object_id, start_date, end_date, user_nick, user_open_id, source_type, source_object_id))
