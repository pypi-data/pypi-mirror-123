...
@LastEditTime: 2021-09-18 17:51:31
...
class TaskInfoListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        task_list = task_base_model.get_client_task_list(app_id, act_id, module_id, user_id, task_types, app_key, app_secret, is_log, invoke_result_data.data["daily_repeat_browse"])
