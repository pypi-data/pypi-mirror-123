...
@LastEditTime: 2021-10-08 15:08:13
...
class WechatPayNotifyHandler(FrameBaseHandler):
    ...
    def post_async(self):
        ...
        try:
            ...
            self.logging_link_error("【微信支付异步通知】" + str(ex) + ":" + str(xml_params))
...
class WechatRefundNotifyHandler(FrameBaseHandler):
    ...
    def post_async(self):
        ...
        try:
            ...
            self.business_process_executed(req_info_dict)
            return self.write(wechat_refund_reponse.convert_response_xml("SUCCESS", True))
        except Exception as ex:
            self.logging_link_error("【微信退款异步通知】" + str(ex)+":" + str(xml_params))
    ...
    def business_process_executed(self, req_info_dict):
        """
        :description: 执行后事件
...
class TiktokPayNotifyHandler(FrameBaseHandler):
    ...
    def post_async(self):
        ...
        try:
            ...
            self.logging_link_error("【抖音支付异步通知】" + str(ex) +":"+ str(json_params))
...
class TiktokRefundNotifyHandler(FrameBaseHandler):
    ...
    def post_async(self):
        ...
        try:
            ...
            self.logging_link_error("【抖音退款异步通知】" + str(ex) + ":" + str(json_params))
            return self.write(tiktok_reponse.convert_response_json(-1, "数据异常"))
