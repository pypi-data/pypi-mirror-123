...
@LastEditTime: 2021-10-11 19:06:25
                        ...
                        try:
                            ...
                            if stat_orm.repeat_type > 0:
                                if stat_orm.repeat_type == 2:
                                    ...
                                    stat_log_total = stat_log_model.get_cache_total("act_id=%s and module_id=%s and orm_id=%s and user_id=%s and create_day=%s", params=[stat_queue.act_id, stat_queue.module_id, stat_orm.id, stat_queue.user_id, now_day_int])
                                if stat_log_total > 0:
                                    is_add = False
