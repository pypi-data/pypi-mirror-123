...
@LastEditTime: 2021-09-17 19:59:06
...
def seven_cloudapp_frame_route():
    return [
        ...
        (r"/client/wpay_notify", pay.WechatPayNotifyHandler),  #微信支付异步同步
        (r"/client/wrefund_notify", pay.WechatRefundNotifyHandler),  #微信退款异步同步
        (r"/client/tvoucher_order", pay.TiktokVoucherOrderHandler),  #创建抖音预订单
        (r"/client/tpay_notify", pay.TiktokPayNotifyHandler),  #抖音支付异步同步
        (r"/client/trefund_notify", pay.TiktokRefundNotifyHandler),  #抖音退款异步同步
