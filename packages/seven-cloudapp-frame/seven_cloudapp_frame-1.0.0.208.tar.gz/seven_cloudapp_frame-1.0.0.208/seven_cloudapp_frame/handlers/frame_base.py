...
@LastEditTime: 2021-10-12 15:49:17
    ...
    def prepare(self):
        ...
        try:
            ...
            if dict_param["open_id"]:
                # 频繁请求校验
                is_continue_request, error_message = self.check_continue_request(self.__class__.__name__, dict_param["app_id"], dict_param["open_id"],1000*60)
                if is_continue_request == True:
