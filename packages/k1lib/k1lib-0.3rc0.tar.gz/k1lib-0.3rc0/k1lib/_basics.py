...
import torch.nn as nn, numpy as np, matplotlib.pyplot as plt, matplotlib as mpl
...
__all__ = ["_docsUrl", "Object", "Range", "Domain", "AutoIncrement", "Wrapper",
           ...
           "beep", "executeNb", "dontWrap",
           "Func", "polyfit", "derivative", "optimize", "inverse", "integrate",
           "ignoreWarnings", "positionalEncode", "debounce", "FAnim"]
...
try:
    import graphviz
    @patch(graphviz.Digraph, "__call__")
    @patch(graphviz.Graph, "__call__")
    def _call(self, _from, *tos):
...
"""
        for to in tos: self.edge(_from, to)
    def digraph():
