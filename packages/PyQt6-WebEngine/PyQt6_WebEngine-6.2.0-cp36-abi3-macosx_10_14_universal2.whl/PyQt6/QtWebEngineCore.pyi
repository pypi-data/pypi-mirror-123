...
class QWebEngineDownloadRequest(QtCore.QObject):
    ...
    def downloadFileNameChanged(self) -> None: ...
    def downloadDirectoryChanged(self) -> None: ...
    def isPausedChanged(self) -> None: ...
    def isFinishedChanged(self) -> None: ...
    def interruptReasonChanged(self) -> None: ...
    def totalBytesChanged(self) -> None: ...
    def receivedBytesChanged(self) -> None: ...
    def savePageFormatChanged(self) -> None: ...
    def stateChanged(self, state: 'QWebEngineDownloadRequest.DownloadState') -> None: ...
...
class QWebEnginePage(QtCore.QObject):
    ...
    def newWindowRequested(self, request: QWebEngineNewWindowRequest) -> None: ...
    def navigationRequested(self, request: QWebEngineNavigationRequest) -> None: ...
    def certificateError(self, certificateError: QWebEngineCertificateError) -> None: ...
    def loadingChanged(self, loadingInfo: QWebEngineLoadingInfo) -> None: ...
    @typing.overload
    ...
    def findTextFinished(self, result: QWebEngineFindTextResult) -> None: ...
    ...
    def registerProtocolHandlerRequested(self, request: 'QWebEngineRegisterProtocolHandlerRequest') -> None: ...
    def quotaRequested(self, quotaRequest: 'QWebEngineQuotaRequest') -> None: ...
    ...
    def scrollPositionChanged(self, position: QtCore.QPointF) -> None: ...
...
class QWebEngineProfile(QtCore.QObject):
    ...
    def downloadRequested(self, download: QWebEngineDownloadRequest) -> None: ...
    @staticmethod
