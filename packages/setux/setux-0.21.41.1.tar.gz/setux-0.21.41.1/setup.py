...
setup(
    ...
    python_requires='>3.6',
    install_requires = [
        'setux_core>=0.21.41.1',
        'setux_distros>=0.21.37.2',
        'setux_logger>=0.21.38.0',
        'setux_managers>=0.21.41.0',
        'setux_modules>=0.21.41.0',
        'setux_mappings>=0.21.39.0',
        'setux_targets>=0.21.21.0',
    ],
