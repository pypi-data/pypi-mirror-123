...
from azure.ml.component.dsl._component._annotations import InputPath, InputFile, \
    OutputPath, OutputFile, StringParameter, EnumParameter, IntParameter, FloatParameter, \
    BoolParameter
