...
class SESTemplate(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return(template or[SdIYV])[0]
 def get_physical_resource_id(self,attribute=SdIYV,**kwargs):
 ...
 def update_resource(self,new_resource,stack_name,resources):
  ...
  if SdIYR(template.get(attr,"")==new_template.get(attr,"")for attr in["SubjectPart","TextPart","HtmlPart"]):
   return
