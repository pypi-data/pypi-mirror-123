...
from ads.oracledb.mixin.oracle_db import OracleDBAccessMixin
from pandas.core.dtypes.common import is_list_like
from ads.feature_engineering import schema


@pd.api.extensions.register_dataframe_accessor("ads")
class ADSDataFrameAccessor(ADSFeatureTypesMixin, EDAMixin, OracleDBAccessMixin):
    ...
    def tags(self) -> Dict[str, List[str]]:
        ...
        -------
        Dict[str, List[str]]
            The map of clumns and associated default tags.
        """
    ...
    def feature_type(self) -> Dict[str, List[str]]:
        ...
        -------
        Dict[str, List[str]]
            The dictionary where key is column name and value is list of associated feture type
            names.
        """
