...
__all__ = ["load_Cclass","Cmodel","multi_Cmodel","train_steps"]
...
class Cannaibase:
    ...
    def __init__(self, classtype, dirct=None, save_model=True, binary_class = False):
        ...
        self.model_list = []  # list of [model_name,model_output,date,model,input_spfunc,output_spfunc]
    ...
    def add_model_base(self, model, model_n, ii,target_label=None,input_spfunc=None,output_spfunc=None):
        pass  # define in instance

#get model and model_name
    def add_model(self, model, model_n=None,input_spfunc=None,output_spfunc=None):
        ii = len(self.model_list)  #ii is id of next model
        sub_ml = self.add_model_base(model, model_n, ii, None,input_spfunc=input_spfunc,output_spfunc=output_spfunc)
...
class Cmodel(Cannaibase):
    ...
    def add_model_base(self, model, model_n, ii, target_label=None,input_spfunc=None,output_spfunc=None):
        ...
        return [model_n, df, dat,model,input_spfunc,output_spfunc]
...
class multi_Cmodel(Cmodel):
    ...
    def add_model(self, model,target_label, model_n = None, model_name=None,input_spfunc=None,output_spfunc=None):
        ...
        sub_ml = self.add_model_base(model, model_name, ii, target_label,input_spfunc=input_spfunc,output_spfunc=output_spfunc)
