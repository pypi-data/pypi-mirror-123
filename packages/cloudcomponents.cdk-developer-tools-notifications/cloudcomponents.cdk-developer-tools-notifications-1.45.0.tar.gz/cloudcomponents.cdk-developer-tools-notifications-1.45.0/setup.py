    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.45.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-codebuild>=1.128.0, <2.0.0",
        "aws-cdk.aws-codecommit>=1.128.0, <2.0.0",
        "aws-cdk.aws-codedeploy>=1.128.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.128.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.128.0, <2.0.0",
        ...
        "cloudcomponents.cdk-chatops>=1.43.0, <2.0.0",
