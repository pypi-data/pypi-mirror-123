...
"""
    ...
    The version of the OpenAPI document: 0.0.1436
...
class PoliciesApi(object):
    ...
    def create_policy_with_http_info(self, policy_creation_request, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.0.1436'
    ...
    def page_policies(self, **kwargs):  # noqa: E501
        ...
        :type as_at: datetime
        :param sort_by: Optional. Not currently used. Order the results by these fields. Use the '-' sign to denote descending order e.g. -MyFieldName
        :type sort_by: list[str]
        :param limit: Optional. 2000 if not provided. When paginating, limit the number of returned results to this many
        :type limit: int
        :param filter: Optional. Not currently used. Expression to filter the result set
        :type filter: str
    ...
    def page_policies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `page_policies`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `page_policies`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `page_policies`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
    ...
    def page_policy_collections_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `page_policy_collections`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `page_policy_collections`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `page_policy_collections`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 5000:  # noqa: E501
