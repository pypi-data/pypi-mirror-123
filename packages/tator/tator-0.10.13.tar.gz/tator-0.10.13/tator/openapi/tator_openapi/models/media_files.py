...
class MediaFiles(object):
    ...
    openapi_types = {
        ...
        'attachment': 'list[FileDefinition]',
    ...
    def __init__(self, archival=None, attachment=None, audio=None, ids=None, image=None, layout=None, live=None, quality=None, streaming=None, thumbnail=None, thumbnail_gif=None, local_vars_configuration=None):  # noqa: E501
