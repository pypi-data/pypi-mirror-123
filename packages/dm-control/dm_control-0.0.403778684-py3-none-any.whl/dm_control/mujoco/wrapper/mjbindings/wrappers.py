...
class MjVFSWrapper(util.WrapperBase):
  ...
  def filesize(self):
    """file size in bytes."""
    return util.buf_to_npy(self._ptr.contents.filesize, (2000,))
...
class MjModelWrapper(util.WrapperBase):
  ...
  def key_mpos(self):
    ...
    return util.buf_to_npy(self._ptr.contents.key_mpos,
                           (self.nkey, self.nmocap*3))

  @util.CachedProperty
  def key_mquat(self):
    """key mocap quaternion (nkey x 4*nmocap)."""
    return util.buf_to_npy(self._ptr.contents.key_mquat,
                           (self.nkey, self.nmocap*4))
...
class MjuiStateWrapper(util.WrapperBase):
  ...
  def rect(self):
    ...
    return util.buf_to_npy(self._ptr.contents.rect, (25,))
...
class MjuiItemSingleWrapper(util.WrapperBase):
...
class MjuiItemMultiWrapper(util.WrapperBase):
...
class MjuiItemSliderWrapper(util.WrapperBase):
  """slider-related."""
...
class MjuiItemEditWrapper(util.WrapperBase):
  """edit-related."""
  ...
  def range_(self):
    ...
    return util.buf_to_npy(self._ptr.contents.range_, (7, 2))
...
class MjuiItemWrapper(util.WrapperBase):
  ...
  def single(self):
    """check and button."""
    return MjuiItemSingleWrapper(ctypes.pointer(self._ptr.contents.single))

  @util.CachedProperty
  def multi(self):
    """static, radio and select."""
    return MjuiItemMultiWrapper(ctypes.pointer(self._ptr.contents.multi))

  @util.CachedProperty
  def slider(self):
    """slider."""
    return MjuiItemSliderWrapper(ctypes.pointer(self._ptr.contents.slider))

  @util.CachedProperty
  def edit(self):
    """edit."""
    return MjuiItemEditWrapper(ctypes.pointer(self._ptr.contents.edit))
...
class MjvPerturbWrapper(util.WrapperBase):
  ...
  def active2(self):
    ...
    return self._ptr.contents.active2

  @active2.setter
  def active2(self, value):
    self._ptr.contents.active2 = value
...
class MjvSceneWrapper(util.WrapperBase):
  ...
  def framergb(self):
    """frame color."""
    return util.buf_to_npy(self._ptr.contents.framergb, (3,))
...
class MjvFigureWrapper(util.WrapperBase):
  ...
  @property
  def legendoffset(self):
    """number of lines to offset legend."""
    return self._ptr.contents.legendoffset

  @legendoffset.setter
  def legendoffset(self, value):
    self._ptr.contents.legendoffset = value

  @property
  def subplot(self):
    """selected subplot (for title rendering)."""
    return self._ptr.contents.subplot

  @subplot.setter
  def subplot(self, value):
    self._ptr.contents.subplot = value
  ...
  @property
  def highlightid(self):
    """if id>=0 and no point, highlight id."""
    return self._ptr.contents.highlightid

  @highlightid.setter
  def highlightid(self, value):
    self._ptr.contents.highlightid = value
