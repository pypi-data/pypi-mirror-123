...
class MJVFS(ctypes.Structure):
  ...
  _fields_ = [
      ('nfile', ctypes.c_int),
      ('filename', ctypes.c_char * 2000 * 1000),
      ('filesize', ctypes.c_int * (2000)),
      ('filedata', ctypes.c_void_p * 2000),
  ]
...
class MJMODEL(ctypes.Structure):
  ...
  _fields_ = [
      ...
      ('key_mpos', ctypes.POINTER(ctypes.c_double)),
      ('key_mquat', ctypes.POINTER(ctypes.c_double)),
...
class MJUIITEMSINGLE(ctypes.Structure):
...
class MJUIITEMMULTI(ctypes.Structure):
  """static, radio and select-related."""
  _fields_ = [
      ('nelem', ctypes.c_int),
      ('name', ctypes.c_char * 35 * 40),
  ]


class MJUIITEMSLIDER(ctypes.Structure):
  """slider-related."""
  _fields_ = [
...
class MJUIITEMEDIT(ctypes.Structure):
  """edit-related."""
  _fields_ = [
      ('nelem', ctypes.c_int),
      ('range_', ctypes.c_double * (7 * 2)),
  ]
...
class MJVFIGURE(ctypes.Structure):
  ...
  _fields_ = [
      ...
      ('title', ctypes.c_char * 1000),
      ('xlabel', ctypes.c_char * 100),
      ('linename', ctypes.c_char * 100 * 100),
      ('legendoffset', ctypes.c_int),
      ('subplot', ctypes.c_int),
      ('highlight', ctypes.c_int * (2)),
      ('highlightid', ctypes.c_int),
      ('selection', ctypes.c_float),
