...
mjlib.mjui_addToSection.__doc__ = """
...
Args:
  ...
  def_: ctypes.POINTER(MJUIDEF) <const>
"""
mjlib.mjui_addToSection.argtypes = [
    ctypes.POINTER(MJUI),
    ctypes.c_int,
    ctypes.POINTER(MJUIDEF),
]
mjlib.mjui_addToSection.restype = None
...
mjlib.mju_insertionSortInt.__doc__ = """
Integer insertion sort, resulting list is in increasing order.

Args:
  list_: util.ndptr(dtype=np.intc, flags=('C', 'W'))
  n: ctypes.c_int
"""
mjlib.mju_insertionSortInt.argtypes = [
    util.ndptr(dtype=np.intc, flags=('C', 'W')),
    ctypes.c_int,
]
mjlib.mju_insertionSortInt.restype = None
...
Returns:
  ctypes.c_double
"""
mjlib.mju_sigmoid.argtypes = [
    ctypes.c_double,
]
mjlib.mju_sigmoid.restype = ctypes.c_double
...
class _Callbacks:
  ...
  def mjcb_contactfilter(self):
    if self._mjcb_contactfilter.value:
      return mjfConFilt(self._mjcb_contactfilter.value)
    else:
      return None
