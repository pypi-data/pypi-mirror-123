        ...
        *,
        ...
        for coord in [x1, y1, x2, y2]:
            if not isinstance(coord, int) and not isinstance(coord, float):
                raise Exception("all line segment coordinates must be int/float")
        ...
        *,
        ...
        for dim in [top, left, width, height]:
            if not isinstance(dim, int) and not isinstance(dim, float):
                raise Exception("all bounding box dimensions must be int/float")
        ...
        *,
        ...
        for keypoint in keypoints:
            ...
            if not isinstance(x, int) and not isinstance(x, float):
                raise Exception("keypoint x coordinate must be int/float")
            if not isinstance(y, int) and not isinstance(y, float):
                raise Exception("keypoint y coordinate must be int/float")
            ...
            for vertex in polygon["vertices"]:
                for num in vertex:
                    if not isinstance(num, int) and not isinstance(num, float):
                        raise Exception(
                            "all polygon vertex coordinates must be int/float"
                        )

        if center is not None:
            for num in center:
                if not isinstance(num, int) and not isinstance(num, float):
                    raise Exception("polygon center coordinates must be int/float")
            ...
            self.label_data.append(
                {
                    ...
                    "attributes": {"asset_uuid": asset_uuid},
                }
            )
            self._label_ids_set.add(label_id)
