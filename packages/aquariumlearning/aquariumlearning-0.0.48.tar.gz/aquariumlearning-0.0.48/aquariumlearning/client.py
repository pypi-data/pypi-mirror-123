...
import re
from typing import Any, Optional, Union, List, Dict, Tuple, Iterable, Callable
...
class Client:
    ...
    def create_project(
        ...
        Args:
            ...
            primary_task (Optional[str], optional): Any specific primary task for a non-object detection or classification task. Can be '2D_SEMSEG' or '2D_INSTANCE_SEGMENTATION' or 'CLASSIFICATION' or 'CLASSIFICATION_WITH_GEOMETRY' or None.
    ...
    def _create_or_update_dataset_streaming(
        ...
        if wait_until_finish:
            ...
            errored_window_uuids = [
                window.get("uuid")
                for window in dataset_upload_version_windows
                if window.get("status") == "WINDOW_ERRORED"
            ]
