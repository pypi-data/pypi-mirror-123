...
from mastapy.math_utility import _1272, _1271
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def first_component_alignment_axis(self) -> '_1272.Axis':
        ...
        return constructor.new(_1272.Axis)(value) if value else None

    @first_component_alignment_axis.setter
    def first_component_alignment_axis(self, value: '_1272.Axis'):
    ...
    @property
    def first_fe_alignment_axis(self) -> '_1271.AlignmentAxis':
        ...
        return constructor.new(_1271.AlignmentAxis)(value) if value else None

    @first_fe_alignment_axis.setter
    def first_fe_alignment_axis(self, value: '_1271.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1272.Axis':
    ...
    def component_direction_normal_to_surface(self, value: '_1272.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1271.AlignmentAxis':
    ...
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1271.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
