...
from mastapy.math_utility import _1281, _1282
from mastapy.system_model.connections_and_sockets import (
    _1985, _2006, _1987, _2011
)
from mastapy.system_model.part_model import _2160, _2182
...
class Component(_2182.Part):
    ...
    @property
    def local_coordinate_system(self) -> '_1281.CoordinateSystem3D':
        ...
        return constructor.new(_1281.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem is not None else None

    @property
    def component_connections(self) -> 'List[_1985.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1985.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2006.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1281.CoordinateSystem3D') -> '_2006.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2006.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1282.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1987.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1987.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2011.Socket') -> 'List[_2011.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_2011.Socket))

    def connect_to_socket(self, socket: '_2011.Socket') -> '_2160.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2011.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_2011.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2160.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2160.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_1987.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_2011.Socket':
