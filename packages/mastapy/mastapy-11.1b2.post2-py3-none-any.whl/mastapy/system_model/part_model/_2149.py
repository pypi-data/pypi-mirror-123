...
class Assembly(_2150.AbstractAssembly):
    ...
    def get_part_named(self, name: 'str') -> '_2182.Part':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2182.Part.TYPE](name if name else '')
    ...
    def get_part_named_of_type_abstract_assembly(self, name: 'str') -> '_2150.AbstractAssembly':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2150.AbstractAssembly.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_abstract_shaft(self, name: 'str') -> '_2151.AbstractShaft':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2151.AbstractShaft.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_abstract_shaft_or_housing(self, name: 'str') -> '_2152.AbstractShaftOrHousing':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2152.AbstractShaftOrHousing.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bearing(self, name: 'str') -> '_2155.Bearing':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2155.Bearing.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bolt(self, name: 'str') -> '_2157.Bolt':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2157.Bolt.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bolted_joint(self, name: 'str') -> '_2158.BoltedJoint':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2158.BoltedJoint.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_component(self, name: 'str') -> '_2159.Component':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2159.Component.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_connector(self, name: 'str') -> '_2162.Connector':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2162.Connector.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_datum(self, name: 'str') -> '_2163.Datum':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2163.Datum.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_external_cad_model(self, name: 'str') -> '_2166.ExternalCADModel':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2166.ExternalCADModel.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_fe_part(self, name: 'str') -> '_2167.FEPart':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2167.FEPart.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_flexible_pin_assembly(self, name: 'str') -> '_2168.FlexiblePinAssembly':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2168.FlexiblePinAssembly.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_guide_dxf_model(self, name: 'str') -> '_2169.GuideDxfModel':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2169.GuideDxfModel.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_mass_disc(self, name: 'str') -> '_2176.MassDisc':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2176.MassDisc.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_measurement_component(self, name: 'str') -> '_2177.MeasurementComponent':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2177.MeasurementComponent.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_mountable_component(self, name: 'str') -> '_2178.MountableComponent':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2178.MountableComponent.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_oil_seal(self, name: 'str') -> '_2180.OilSeal':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2180.OilSeal.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_planet_carrier(self, name: 'str') -> '_2183.PlanetCarrier':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2183.PlanetCarrier.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_point_load(self, name: 'str') -> '_2185.PointLoad':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2185.PointLoad.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_power_load(self, name: 'str') -> '_2186.PowerLoad':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2186.PowerLoad.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_root_assembly(self, name: 'str') -> '_2188.RootAssembly':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2188.RootAssembly.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_specialised_assembly(self, name: 'str') -> '_2190.SpecialisedAssembly':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2190.SpecialisedAssembly.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_unbalanced_mass(self, name: 'str') -> '_2191.UnbalancedMass':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2191.UnbalancedMass.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_virtual_component(self, name: 'str') -> '_2193.VirtualComponent':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2193.VirtualComponent.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_shaft(self, name: 'str') -> '_2196.Shaft':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2196.Shaft.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_agma_gleason_conical_gear(self, name: 'str') -> '_2226.AGMAGleasonConicalGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2226.AGMAGleasonConicalGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_agma_gleason_conical_gear_set(self, name: 'str') -> '_2227.AGMAGleasonConicalGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2227.AGMAGleasonConicalGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bevel_differential_gear(self, name: 'str') -> '_2228.BevelDifferentialGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2228.BevelDifferentialGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bevel_differential_gear_set(self, name: 'str') -> '_2229.BevelDifferentialGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2229.BevelDifferentialGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bevel_differential_planet_gear(self, name: 'str') -> '_2230.BevelDifferentialPlanetGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2230.BevelDifferentialPlanetGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bevel_differential_sun_gear(self, name: 'str') -> '_2231.BevelDifferentialSunGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2231.BevelDifferentialSunGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bevel_gear(self, name: 'str') -> '_2232.BevelGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2232.BevelGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_bevel_gear_set(self, name: 'str') -> '_2233.BevelGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2233.BevelGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_concept_gear(self, name: 'str') -> '_2234.ConceptGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2234.ConceptGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_concept_gear_set(self, name: 'str') -> '_2235.ConceptGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2235.ConceptGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_conical_gear(self, name: 'str') -> '_2236.ConicalGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2236.ConicalGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_conical_gear_set(self, name: 'str') -> '_2237.ConicalGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2237.ConicalGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_cylindrical_gear(self, name: 'str') -> '_2238.CylindricalGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2238.CylindricalGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_cylindrical_gear_set(self, name: 'str') -> '_2239.CylindricalGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2239.CylindricalGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_cylindrical_planet_gear(self, name: 'str') -> '_2240.CylindricalPlanetGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2240.CylindricalPlanetGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_face_gear(self, name: 'str') -> '_2241.FaceGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2241.FaceGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_face_gear_set(self, name: 'str') -> '_2242.FaceGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2242.FaceGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_gear(self, name: 'str') -> '_2243.Gear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2243.Gear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_gear_set(self, name: 'str') -> '_2245.GearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2245.GearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_hypoid_gear(self, name: 'str') -> '_2247.HypoidGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2247.HypoidGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_hypoid_gear_set(self, name: 'str') -> '_2248.HypoidGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2248.HypoidGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_klingelnberg_cyclo_palloid_conical_gear(self, name: 'str') -> '_2249.KlingelnbergCycloPalloidConicalGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2249.KlingelnbergCycloPalloidConicalGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self, name: 'str') -> '_2250.KlingelnbergCycloPalloidConicalGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2250.KlingelnbergCycloPalloidConicalGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self, name: 'str') -> '_2251.KlingelnbergCycloPalloidHypoidGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2251.KlingelnbergCycloPalloidHypoidGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self, name: 'str') -> '_2252.KlingelnbergCycloPalloidHypoidGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2252.KlingelnbergCycloPalloidHypoidGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self, name: 'str') -> '_2253.KlingelnbergCycloPalloidSpiralBevelGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2253.KlingelnbergCycloPalloidSpiralBevelGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self, name: 'str') -> '_2254.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2254.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_planetary_gear_set(self, name: 'str') -> '_2255.PlanetaryGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2255.PlanetaryGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_spiral_bevel_gear(self, name: 'str') -> '_2256.SpiralBevelGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2256.SpiralBevelGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_spiral_bevel_gear_set(self, name: 'str') -> '_2257.SpiralBevelGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2257.SpiralBevelGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_straight_bevel_diff_gear(self, name: 'str') -> '_2258.StraightBevelDiffGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2258.StraightBevelDiffGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_straight_bevel_diff_gear_set(self, name: 'str') -> '_2259.StraightBevelDiffGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2259.StraightBevelDiffGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_straight_bevel_gear(self, name: 'str') -> '_2260.StraightBevelGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2260.StraightBevelGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_straight_bevel_gear_set(self, name: 'str') -> '_2261.StraightBevelGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2261.StraightBevelGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_straight_bevel_planet_gear(self, name: 'str') -> '_2262.StraightBevelPlanetGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2262.StraightBevelPlanetGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_straight_bevel_sun_gear(self, name: 'str') -> '_2263.StraightBevelSunGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2263.StraightBevelSunGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_worm_gear(self, name: 'str') -> '_2264.WormGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2264.WormGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_worm_gear_set(self, name: 'str') -> '_2265.WormGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2265.WormGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_zerol_bevel_gear(self, name: 'str') -> '_2266.ZerolBevelGear':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2266.ZerolBevelGear.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_zerol_bevel_gear_set(self, name: 'str') -> '_2267.ZerolBevelGearSet':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2267.ZerolBevelGearSet.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_cycloidal_assembly(self, name: 'str') -> '_2281.CycloidalAssembly':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2281.CycloidalAssembly.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_cycloidal_disc(self, name: 'str') -> '_2282.CycloidalDisc':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2282.CycloidalDisc.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_ring_pins(self, name: 'str') -> '_2283.RingPins':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2283.RingPins.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_belt_drive(self, name: 'str') -> '_2289.BeltDrive':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2289.BeltDrive.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_clutch(self, name: 'str') -> '_2291.Clutch':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2291.Clutch.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_clutch_half(self, name: 'str') -> '_2292.ClutchHalf':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2292.ClutchHalf.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_concept_coupling(self, name: 'str') -> '_2294.ConceptCoupling':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2294.ConceptCoupling.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_concept_coupling_half(self, name: 'str') -> '_2295.ConceptCouplingHalf':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2295.ConceptCouplingHalf.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_coupling(self, name: 'str') -> '_2296.Coupling':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2296.Coupling.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_coupling_half(self, name: 'str') -> '_2297.CouplingHalf':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2297.CouplingHalf.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_cvt(self, name: 'str') -> '_2299.CVT':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2299.CVT.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_cvt_pulley(self, name: 'str') -> '_2300.CVTPulley':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2300.CVTPulley.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_part_to_part_shear_coupling(self, name: 'str') -> '_2301.PartToPartShearCoupling':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2301.PartToPartShearCoupling.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_part_to_part_shear_coupling_half(self, name: 'str') -> '_2302.PartToPartShearCouplingHalf':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2302.PartToPartShearCouplingHalf.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_pulley(self, name: 'str') -> '_2303.Pulley':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2303.Pulley.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_rolling_ring(self, name: 'str') -> '_2309.RollingRing':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2309.RollingRing.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_rolling_ring_assembly(self, name: 'str') -> '_2310.RollingRingAssembly':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2310.RollingRingAssembly.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_shaft_hub_connection(self, name: 'str') -> '_2311.ShaftHubConnection':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2311.ShaftHubConnection.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_spring_damper(self, name: 'str') -> '_2313.SpringDamper':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2313.SpringDamper.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_spring_damper_half(self, name: 'str') -> '_2314.SpringDamperHalf':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2314.SpringDamperHalf.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_synchroniser(self, name: 'str') -> '_2315.Synchroniser':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2315.Synchroniser.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_synchroniser_half(self, name: 'str') -> '_2317.SynchroniserHalf':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2317.SynchroniserHalf.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_synchroniser_part(self, name: 'str') -> '_2318.SynchroniserPart':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2318.SynchroniserPart.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_synchroniser_sleeve(self, name: 'str') -> '_2319.SynchroniserSleeve':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2319.SynchroniserSleeve.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_torque_converter(self, name: 'str') -> '_2320.TorqueConverter':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2320.TorqueConverter.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_torque_converter_pump(self, name: 'str') -> '_2321.TorqueConverterPump':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2321.TorqueConverterPump.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
    ...
    def get_part_named_of_type_torque_converter_turbine(self, name: 'str') -> '_2323.TorqueConverterTurbine':
        ...
        name = str(name)
        method_result = self.wrapped.GetPartNamed[_2323.TorqueConverterTurbine.TYPE](name if name else '')
        return constructor.new_override(method_result.__class__)(method_result) if method_result is not None else None
