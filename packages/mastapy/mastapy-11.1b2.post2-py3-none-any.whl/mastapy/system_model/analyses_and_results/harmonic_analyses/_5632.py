...
class AbstractShaftOrHousingHarmonicAnalysis(_5656.ComponentHarmonicAnalysis):
    '''AbstractShaftOrHousingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2393.AbstractShaftOrHousingSystemDeflection':
        ...
        if _2393.AbstractShaftOrHousingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_abstract_shaft_system_deflection(self) -> '_2394.AbstractShaftSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_fe_part_system_deflection(self) -> '_2459.FEPartSystemDeflection':
        ...
        if _2459.FEPartSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
