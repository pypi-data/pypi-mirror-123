...
class AGMAGleasonConicalGearMeshCompoundSystemDeflection(_2586.ConicalGearMeshCompoundSystemDeflection):
    '''AGMAGleasonConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2396.AGMAGleasonConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2396.AGMAGleasonConicalGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2396.AGMAGleasonConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2396.AGMAGleasonConicalGearMeshSystemDeflection))
        return value
