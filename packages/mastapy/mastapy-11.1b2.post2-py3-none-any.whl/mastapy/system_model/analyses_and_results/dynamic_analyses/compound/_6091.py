...
class AbstractShaftCompoundDynamicAnalysis(_6092.AbstractShaftOrHousingCompoundDynamicAnalysis):
    '''AbstractShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5961.AbstractShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5961.AbstractShaftDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5961.AbstractShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5961.AbstractShaftDynamicAnalysis))
        return value
