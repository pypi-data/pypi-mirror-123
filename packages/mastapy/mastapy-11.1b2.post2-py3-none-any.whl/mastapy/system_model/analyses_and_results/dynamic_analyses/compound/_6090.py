...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6169
...
class AbstractAssemblyCompoundDynamicAnalysis(_6169.PartCompoundDynamicAnalysis):
    '''AbstractAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5960.AbstractAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5960.AbstractAssemblyDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5960.AbstractAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5960.AbstractAssemblyDynamicAnalysis))
        return value
