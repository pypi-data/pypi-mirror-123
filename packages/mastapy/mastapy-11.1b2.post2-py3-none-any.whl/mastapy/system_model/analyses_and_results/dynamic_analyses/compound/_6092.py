...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6115
...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6115.ComponentCompoundDynamicAnalysis):
    '''AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5962.AbstractShaftOrHousingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5962.AbstractShaftOrHousingDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5962.AbstractShaftOrHousingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5962.AbstractShaftOrHousingDynamicAnalysis))
        return value
