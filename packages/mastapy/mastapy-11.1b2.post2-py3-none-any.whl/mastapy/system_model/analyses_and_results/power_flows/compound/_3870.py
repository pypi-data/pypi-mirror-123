...
class AGMAGleasonConicalGearMeshCompoundPowerFlow(_3898.ConicalGearMeshCompoundPowerFlow):
    '''AGMAGleasonConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3736.AGMAGleasonConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3736.AGMAGleasonConicalGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3736.AGMAGleasonConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3736.AGMAGleasonConicalGearMeshPowerFlow))
        return value
