...
from mastapy.math_utility.measured_data import _1347
from mastapy.gears.gear_designs.cylindrical.micro_geometry import (
    _1037, _1038, _1030, _1031,
    _1028, _1041, _1036, _1061,
    _1062, _1045, _1047, _1056,
    _1058
)
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical import _962, _950, _977
...
class CylindricalGearFlankMicroGeometry(_522.FlankMicroGeometry):
    '''CylindricalGearFlankMicroGeometry
    ...
    @property
    def micro_geometry_matrix(self) -> '_1347.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'MicroGeometryMatrix' is the original name of this property.'''

        return constructor.new(_1347.GriddedSurfaceAccessor)(self.wrapped.MicroGeometryMatrix) if self.wrapped.MicroGeometryMatrix else None

    @micro_geometry_matrix.setter
    def micro_geometry_matrix(self, value: '_1347.GriddedSurfaceAccessor'):
    ...
    @property
    def profile_relief(self) -> '_1037.CylindricalGearProfileModification':
        ...
        if _1037.CylindricalGearProfileModification.TYPE not in self.wrapped.ProfileRelief.__class__.__mro__:
    ...
    @property
    def lead_relief(self) -> '_1030.CylindricalGearLeadModification':
        ...
        if _1030.CylindricalGearLeadModification.TYPE not in self.wrapped.LeadRelief.__class__.__mro__:
    ...
    @property
    def bias(self) -> '_1028.CylindricalGearBiasModification':
        ...
        return constructor.new(_1028.CylindricalGearBiasModification)(self.wrapped.Bias) if self.wrapped.Bias else None

    @property
    def triangular_end_relief(self) -> '_1041.CylindricalGearTriangularEndModification':
        ...
        return constructor.new(_1041.CylindricalGearTriangularEndModification)(self.wrapped.TriangularEndRelief) if self.wrapped.TriangularEndRelief else None

    @property
    def profile_control_point(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint else None

    @property
    def micro_geometry_map(self) -> '_1036.CylindricalGearMicroGeometryMap':
        ...
        return constructor.new(_1036.CylindricalGearMicroGeometryMap)(self.wrapped.MicroGeometryMap) if self.wrapped.MicroGeometryMap else None

    @property
    def total_lead_relief_points(self) -> 'List[_1061.TotalLeadReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TotalLeadReliefPoints, constructor.new(_1061.TotalLeadReliefWithDeviation))
        return value

    @property
    def total_profile_relief_points(self) -> 'List[_1062.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TotalProfileReliefPoints, constructor.new(_1062.TotalProfileReliefWithDeviation))
        return value

    @property
    def lead_form_deviation_points(self) -> 'List[_1045.LeadFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadFormDeviationPoints, constructor.new(_1045.LeadFormReliefWithDeviation))
        return value

    @property
    def lead_slope_deviation_points(self) -> 'List[_1047.LeadSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadSlopeDeviationPoints, constructor.new(_1047.LeadSlopeReliefWithDeviation))
        return value

    @property
    def profile_form_deviation_points(self) -> 'List[_1056.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormDeviationPoints, constructor.new(_1056.ProfileFormReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_10_percent_face_width(self) -> 'List[_1058.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt10PercentFaceWidth, constructor.new(_1058.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_50_percent_face_width(self) -> 'List[_1058.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt50PercentFaceWidth, constructor.new(_1058.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_90_percent_face_width(self) -> 'List[_1058.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt90PercentFaceWidth, constructor.new(_1058.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def gear_design(self) -> '_950.CylindricalGearDesign':
