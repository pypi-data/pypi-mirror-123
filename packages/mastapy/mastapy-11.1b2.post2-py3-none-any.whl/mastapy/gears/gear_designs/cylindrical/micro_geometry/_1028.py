...
from mastapy.gears.micro_geometry import _521
...
class CylindricalGearBiasModification(_521.BiasModification):
    '''CylindricalGearBiasModification
    ...
    @property
    def profile_evaluation_upper_limit(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluationUpperLimit) if self.wrapped.ProfileEvaluationUpperLimit else None

    @property
    def profile_evaluation_lower_limit(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluationLowerLimit) if self.wrapped.ProfileEvaluationLowerLimit else None

    @property
    def zero_bias_relief(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
