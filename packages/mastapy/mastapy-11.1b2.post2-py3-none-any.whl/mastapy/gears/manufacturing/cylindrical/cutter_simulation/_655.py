...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _656, _661
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self) -> '_656.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_656.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_661.FinishStockPoint':
        ...
        return constructor.new(_661.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter else None

    @property
    def stock_removed_at_designed_sap(self) -> '_661.FinishStockPoint':
        ...
        return constructor.new(_661.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_661.FinishStockPoint':
        ...
        return constructor.new(_661.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm else None

    @property
    def gear_fillet_points(self) -> 'List[_699.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_699.NamedPoint))
        return value

    @property
    def finish_stock_indexed_arcs(self) -> 'List[_661.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_661.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_661.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_661.FinishStockPoint))
        return value
