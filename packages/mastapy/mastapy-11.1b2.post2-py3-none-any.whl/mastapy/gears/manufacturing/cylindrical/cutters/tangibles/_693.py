...
class CutterShapeDefinition(_0.APIBase):
    ...
    @property
    def design(self) -> '_683.CylindricalGearRealCutterDesign':
        ...
        if _683.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_677.CylindricalGearFormGrindingWheel':
        ...
        if _677.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_678.CylindricalGearGrindingWorm':
        ...
        if _678.CylindricalGearGrindingWorm.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_hob_design(self) -> '_679.CylindricalGearHobDesign':
        ...
        if _679.CylindricalGearHobDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_680.CylindricalGearPlungeShaver':
        ...
        if _680.CylindricalGearPlungeShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_rack_design(self) -> '_682.CylindricalGearRackDesign':
        ...
        if _682.CylindricalGearRackDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_684.CylindricalGearShaper':
        ...
        if _684.CylindricalGearShaper.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_685.CylindricalGearShaver':
        ...
        if _685.CylindricalGearShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_involute_cutter_design(self) -> '_688.InvoluteCutterDesign':
        ...
        if _688.InvoluteCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def fillet_points(self) -> 'List[_699.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_699.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_699.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_699.NamedPoint))
        return value
