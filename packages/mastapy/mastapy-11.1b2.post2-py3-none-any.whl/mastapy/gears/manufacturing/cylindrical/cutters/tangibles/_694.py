...
class CylindricalGearFormedWheelGrinderTangible(_693.CutterShapeDefinition):
    '''CylindricalGearFormedWheelGrinderTangible
    ...
    @property
    def design(self) -> '_677.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_677.CylindricalGearFormGrindingWheel)(self.wrapped.Design) if self.wrapped.Design else None
