...
from mastapy.gears.load_case.bevel import _833
...
class ConicalGearMeshRating(_325.GearMeshRating):
    '''ConicalGearMeshRating
    ...
    @property
    def mesh_load_case(self) -> '_828.ConicalMeshLoadCase':
        ...
        if _828.ConicalMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def conical_mesh_load_case(self) -> '_828.ConicalMeshLoadCase':
        ...
        if _828.ConicalMeshLoadCase.TYPE not in self.wrapped.ConicalMeshLoadCase.__class__.__mro__:
    ...
    @property
    def meshed_gears(self) -> 'List[_497.ConicalMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_497.ConicalMeshedGearRating))
        return value
