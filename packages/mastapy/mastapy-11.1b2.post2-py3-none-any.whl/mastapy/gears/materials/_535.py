...
from mastapy.gears.materials import _543
...
class AGMACylindricalGearMaterial(_543.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    def material_application(self) -> '_212.AGMAMaterialApplications':
        ...
        return constructor.new(_212.AGMAMaterialApplications)(value) if value else None
    ...
    def material_class(self) -> '_213.AGMAMaterialClasses':
        ...
        return constructor.new(_213.AGMAMaterialClasses)(value) if value else None
    ...
    def grade(self) -> '_214.AGMAMaterialGrade':
        ...
        return constructor.new(_214.AGMAMaterialGrade)(value) if value else None
