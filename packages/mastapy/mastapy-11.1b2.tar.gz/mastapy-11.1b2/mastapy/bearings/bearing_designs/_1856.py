...
from mastapy.bearings import _1613
...
class LinearBearing(_1853.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1613.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1613.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1613.BearingStiffnessMatrixOption'):
