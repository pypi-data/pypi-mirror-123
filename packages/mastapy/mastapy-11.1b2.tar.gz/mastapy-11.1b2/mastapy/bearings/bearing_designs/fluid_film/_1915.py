...
from mastapy.bearings.bearing_designs.fluid_film import _1907
...
class TiltingPadThrustBearing(_1907.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1630.TiltingPadTypes':
        ...
        return constructor.new(_1630.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1630.TiltingPadTypes'):
