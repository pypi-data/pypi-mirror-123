...
class PlainGreaseFilledJournalBearing(_1911.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1910.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1910.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1910.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1912.PlainJournalHousing':
        ...
        if _1912.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1905.CylindricalHousingJournalBearing':
        ...
        if _1905.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1906.MachineryEncasedJournalBearing':
        ...
        if _1906.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1908.PedestalJournalBearing':
        ...
        if _1908.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
