...
class GeometricConstants(_0.APIBase):
    ...
    def geometric_constants_for_rolling_frictional_moments(self) -> '_1876.GeometricConstantsForRollingFrictionalMoments':
        ...
        return constructor.new(_1876.GeometricConstantsForRollingFrictionalMoments)(self.wrapped.GeometricConstantsForRollingFrictionalMoments) if self.wrapped.GeometricConstantsForRollingFrictionalMoments else None
    ...
    def geometric_constants_for_sliding_frictional_moments(self) -> '_1877.GeometricConstantsForSlidingFrictionalMoments':
        ...
        return constructor.new(_1877.GeometricConstantsForSlidingFrictionalMoments)(self.wrapped.GeometricConstantsForSlidingFrictionalMoments) if self.wrapped.GeometricConstantsForSlidingFrictionalMoments else None
