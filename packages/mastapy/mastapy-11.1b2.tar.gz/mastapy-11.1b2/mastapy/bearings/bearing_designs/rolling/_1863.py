...
from mastapy.bearings.bearing_designs.rolling import _1864, _1885
...
class BallBearing(_1885.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1864.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1864.BallBearingShoulderDefinition))
        return value
