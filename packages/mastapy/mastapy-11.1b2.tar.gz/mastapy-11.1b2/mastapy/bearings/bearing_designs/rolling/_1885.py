...
from mastapy.bearings import (
    _1623, _1626, _1602, _1603,
    _1604, _1605
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import (
    _1895, _1878, _1873, _1869,
    _1888, _1866, _1875, _1887
)
from mastapy._internal.python_net import python_net_import
from mastapy.utility import _1363
from mastapy.materials import _217
from mastapy.bearings.bearing_designs import _1854
...
class RollingBearing(_1854.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1602.BearingCatalog':
        ...
        return constructor.new(_1602.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1869.BearingTypeExtraInformation':
        ...
        return constructor.new(_1869.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1605.BearingCageMaterial':
        ...
        return constructor.new(_1605.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1605.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1888.SleeveType':
        ...
        return constructor.new(_1888.SleeveType)(value) if value else None
    ...
    def kz(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.KZ) if self.wrapped.KZ else None
    ...
    @property
    def history(self) -> '_1363.FileHistory':
        ...
        return constructor.new(_1363.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1866.BearingProtection':
        ...
        return constructor.new(_1866.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
    ...
    def element_material(self) -> '_217.BearingMaterial':
        ...
        return constructor.new(_217.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None
    ...
    def inner_ring_material(self) -> '_217.BearingMaterial':
        ...
        return constructor.new(_217.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None
    ...
    def outer_ring_material(self) -> '_217.BearingMaterial':
        ...
        return constructor.new(_217.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None

    @property
    def geometric_constants(self) -> '_1875.GeometricConstants':
        ...
        return constructor.new(_1875.GeometricConstants)(self.wrapped.GeometricConstants) if self.wrapped.GeometricConstants else None

    @property
    def skf_seal_frictional_moment_constants(self) -> '_1887.SKFSealFrictionalMomentConstants':
        ...
        return constructor.new(_1887.SKFSealFrictionalMomentConstants)(self.wrapped.SKFSealFrictionalMomentConstants) if self.wrapped.SKFSealFrictionalMomentConstants else None
