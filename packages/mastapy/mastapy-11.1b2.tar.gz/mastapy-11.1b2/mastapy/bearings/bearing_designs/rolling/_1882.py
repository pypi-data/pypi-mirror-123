...
class RollerBearing(_1885.RollingBearing):
    ...
    def kl(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.KL) if self.wrapped.KL else None
    ...
    def roller_profile_set(self) -> '_1657.ProfileSet':
        ...
        return constructor.new(_1657.ProfileSet)(self.wrapped.RollerProfileSet) if self.wrapped.RollerProfileSet else None
    ...
    def outer_race_profile_set(self) -> '_1657.ProfileSet':
        ...
        return constructor.new(_1657.ProfileSet)(self.wrapped.OuterRaceProfileSet) if self.wrapped.OuterRaceProfileSet else None
    ...
    def inner_race_profile_set(self) -> '_1657.ProfileSet':
        ...
        return constructor.new(_1657.ProfileSet)(self.wrapped.InnerRaceProfileSet) if self.wrapped.InnerRaceProfileSet else None
