...
class SKFSealFrictionalMomentConstants(_0.APIBase):
    ...
    def beta(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.Beta) if self.wrapped.Beta else None
    ...
    def ks1(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.KS1) if self.wrapped.KS1 else None
    ...
    def ks2(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.KS2) if self.wrapped.KS2 else None
    ...
    def seal_counterface_diameter(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.SealCounterfaceDiameter) if self.wrapped.SealCounterfaceDiameter else None
    ...
    def seal_location(self) -> 'overridable.Overridable_SealLocation':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.SealLocation, value) if self.wrapped.SealLocation else None
