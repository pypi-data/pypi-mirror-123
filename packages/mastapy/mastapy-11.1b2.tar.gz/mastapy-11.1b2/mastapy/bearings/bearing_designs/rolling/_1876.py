...
class GeometricConstantsForRollingFrictionalMoments(_0.APIBase):
    ...
    def r1(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.R1) if self.wrapped.R1 else None
    ...
    def r2(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.R2) if self.wrapped.R2 else None
    ...
    def r3(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.R3) if self.wrapped.R3 else None
    ...
    def r4(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.R4) if self.wrapped.R4 else None
