...
class LoadedNonBarrelRollerBearingRow(_1753.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1747.LoadedNonBarrelRollerBearingResults':
