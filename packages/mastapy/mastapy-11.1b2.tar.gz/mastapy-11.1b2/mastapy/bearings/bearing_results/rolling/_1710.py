...
from mastapy.bearings.bearing_results.rolling import _1709, _1707
...
class LoadedAngularContactThrustBallBearingRow(_1707.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1709.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1709.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
