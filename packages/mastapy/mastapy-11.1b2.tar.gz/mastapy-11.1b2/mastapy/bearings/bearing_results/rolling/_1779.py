...
from mastapy.bearings.bearing_results.rolling import _1778, _1726
...
class LoadedThrustBallBearingRow(_1726.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1778.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1778.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
