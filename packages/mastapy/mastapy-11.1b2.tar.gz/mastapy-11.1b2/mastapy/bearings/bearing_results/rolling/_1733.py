...
from mastapy.bearings.bearing_results.rolling import _1732, _1744, _1748
...
class LoadedCylindricalRollerBearingRow(_1748.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1732.LoadedCylindricalRollerBearingResults':
