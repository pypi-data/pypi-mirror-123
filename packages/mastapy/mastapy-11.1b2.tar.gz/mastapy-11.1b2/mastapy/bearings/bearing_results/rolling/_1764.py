...
from mastapy.bearings.bearing_results.rolling import _1763, _1753
...
class LoadedSphericalRollerRadialBearingRow(_1753.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1763.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1763.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
