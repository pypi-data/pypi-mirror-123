...
from mastapy.bearings.bearing_results.rolling import _1699, _1799, _1756
...
class LoadedBallBearingResults(_1756.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def friction_model_for_gyroscopic_moment(self) -> '_1699.FrictionModelForGyroscopicMoment':
        ...
        return constructor.new(_1699.FrictionModelForGyroscopicMoment)(value) if value else None

    @property
    def track_truncation(self) -> '_1799.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1799.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
