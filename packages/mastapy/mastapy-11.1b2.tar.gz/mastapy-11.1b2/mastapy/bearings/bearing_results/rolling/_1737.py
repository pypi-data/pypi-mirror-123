...
from mastapy.bearings.bearing_results.rolling import _1700, _1798, _1797
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1700.InternalClearance':
        ...
        if _1700.InternalClearance.TYPE not in self.wrapped.OperatingInternalClearance.__class__.__mro__:
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1797.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1797.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1797.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1797.StressAtPosition))
        return value
