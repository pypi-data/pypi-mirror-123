...
from mastapy.bearings.bearing_results.rolling import _1735, _1726
...
class LoadedDeepGrooveBallBearingRow(_1726.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1735.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1735.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
