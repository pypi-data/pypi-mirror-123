...
from mastapy.bearings.bearing_results.rolling import _1706, _1709, _1726
...
class LoadedAngularContactBallBearingRow(_1726.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1706.LoadedAngularContactBallBearingResults':
