...
class SKFModuleResults(_0.APIBase):
    ...
    def minimum_load(self) -> '_1815.MinimumLoad':
        ...
        return constructor.new(_1815.MinimumLoad)(self.wrapped.MinimumLoad) if self.wrapped.MinimumLoad else None
    ...
    def viscosities(self) -> '_1824.Viscosities':
        ...
        return constructor.new(_1824.Viscosities)(self.wrapped.Viscosities) if self.wrapped.Viscosities else None
    ...
    def bearing_loads(self) -> '_1802.BearingLoads':
        ...
        return constructor.new(_1802.BearingLoads)(self.wrapped.BearingLoads) if self.wrapped.BearingLoads else None
    ...
    def grease_life_and_relubrication_interval(self) -> '_1811.GreaseLifeAndRelubricationInterval':
        ...
        return constructor.new(_1811.GreaseLifeAndRelubricationInterval)(self.wrapped.GreaseLifeAndRelubricationInterval) if self.wrapped.GreaseLifeAndRelubricationInterval else None
    ...
    def adjusted_speed(self) -> '_1800.AdjustedSpeed':
        ...
        return constructor.new(_1800.AdjustedSpeed)(self.wrapped.AdjustedSpeed) if self.wrapped.AdjustedSpeed else None
    ...
    def dynamic_axial_load_carrying_capacity(self) -> '_1804.DynamicAxialLoadCarryingCapacity':
        ...
        return constructor.new(_1804.DynamicAxialLoadCarryingCapacity)(self.wrapped.DynamicAxialLoadCarryingCapacity) if self.wrapped.DynamicAxialLoadCarryingCapacity else None
    ...
    def static_safety_factors(self) -> '_1823.StaticSafetyFactors':
        ...
        return constructor.new(_1823.StaticSafetyFactors)(self.wrapped.StaticSafetyFactors) if self.wrapped.StaticSafetyFactors else None
    ...
    def bearing_rating_life(self) -> '_1803.BearingRatingLife':
        ...
        return constructor.new(_1803.BearingRatingLife)(self.wrapped.BearingRatingLife) if self.wrapped.BearingRatingLife else None
    ...
    def frequencies(self) -> '_1805.Frequencies':
        ...
        return constructor.new(_1805.Frequencies)(self.wrapped.Frequencies) if self.wrapped.Frequencies else None
    ...
    def friction(self) -> '_1807.Friction':
        ...
        return constructor.new(_1807.Friction)(self.wrapped.Friction) if self.wrapped.Friction else None
