...
from mastapy.bearings.bearing_results.rolling import _1744, _1733
...
class LoadedNeedleRollerBearingRow(_1733.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1744.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1744.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
