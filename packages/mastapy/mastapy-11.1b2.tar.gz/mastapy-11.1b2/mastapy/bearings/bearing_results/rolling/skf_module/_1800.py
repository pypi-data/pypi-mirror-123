...
from mastapy.bearings.bearing_results.rolling.skf_module import _1801, _1820
...
class AdjustedSpeed(_1820.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1801.AdjustmentFactors':
        ...
        return constructor.new(_1801.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
