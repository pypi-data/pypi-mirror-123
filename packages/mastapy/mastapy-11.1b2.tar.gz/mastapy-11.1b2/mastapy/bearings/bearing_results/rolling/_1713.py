...
from mastapy.bearings.bearing_results.rolling import _1712, _1753
...
class LoadedAsymmetricSphericalRollerBearingRow(_1753.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1712.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1712.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
