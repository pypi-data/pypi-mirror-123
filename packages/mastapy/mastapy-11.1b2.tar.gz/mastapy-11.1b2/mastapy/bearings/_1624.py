...
from mastapy.bearings import (
    _1602, _1627, _1616, _1625
)
from mastapy.math_utility import _1271
from mastapy._internal.python_net import python_net_import
from mastapy.utility.databases import _1581
...
class RollingBearingDatabase(_1581.SQLDatabase['_1625.RollingBearingKey', '_1885.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1885.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1885.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1602.BearingCatalog', type_: '_1627.RollingBearingType', bore_range: '_1271.Range', outer_diameter_range: '_1271.Range', width_range: '_1271.Range', dynamic_capacity_range: '_1271.Range', number_of_rows: 'int', material_type: '_1616.HybridSteelAll') -> 'List[_1885.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1602.BearingCatalog', type_: '_1627.RollingBearingType') -> 'List[_1885.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else None, catalog, type_), constructor.new(_1885.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1602.BearingCatalog') -> '_1885.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1602.BearingCatalog') -> 'List[_1885.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1885.RollingBearing))

    def create_bearing(self, type_: '_1627.RollingBearingType', designation: Optional['str'] = 'None') -> '_1885.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1885.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1627.RollingBearingType', designation: Optional['str'] = 'None') -> '_1625.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1625.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
