...
from mastapy.bearings.tolerances import _1634, _1631
...
class InterferenceTolerance(_1631.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1634.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1634.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1619.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1619.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1619.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
