...
class RoundnessSpecification(_1366.IndependentReportablePropertiesBase['RoundnessSpecification']):
    ...
    def specification_type(self) -> '_1649.RoundnessSpecificationType':
        ...
        return constructor.new(_1649.RoundnessSpecificationType)(value) if value else None
    ...
    def user_specified_deviation(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.UserSpecifiedDeviation) if self.wrapped.UserSpecifiedDeviation else None
    ...
    def type_of_fit(self) -> '_1654.TypeOfFit':
        ...
        return constructor.new(_1654.TypeOfFit)(value) if value else None
