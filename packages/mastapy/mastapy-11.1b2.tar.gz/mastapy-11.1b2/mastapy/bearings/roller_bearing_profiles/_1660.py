...
from mastapy.bearings.roller_bearing_profiles import _1665
...
class RollerBearingCrownedProfile(_1665.RollerBearingProfile):
    '''RollerBearingCrownedProfile
    ...
    def crown_radius(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.CrownRadius) if self.wrapped.CrownRadius else None
    ...
    def crown_end_drop(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.CrownEndDrop) if self.wrapped.CrownEndDrop else None
