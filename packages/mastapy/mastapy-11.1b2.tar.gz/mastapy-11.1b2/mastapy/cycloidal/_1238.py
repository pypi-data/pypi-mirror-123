...
class CycloidalDiscDesign(_0.APIBase):
    ...
    def modifications_specification(self) -> '_1241.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1241.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification else None
