...
class CustomTableAndChart(_1536.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1271.Range':
        ...
        if _1271.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
