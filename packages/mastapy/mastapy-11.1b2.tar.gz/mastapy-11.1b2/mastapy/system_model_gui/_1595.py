...
class MASTAGUI(_0.APIBase):
    ...
    def active_design(self) -> '_1920.Design':
        ...
        return constructor.new(_1920.Design)(self.wrapped.ActiveDesign) if self.wrapped.ActiveDesign else None
    ...
    def operation_mode(self) -> '_1543.OperationMode':
        ...
        return constructor.new(_1543.OperationMode)(value) if value else None
