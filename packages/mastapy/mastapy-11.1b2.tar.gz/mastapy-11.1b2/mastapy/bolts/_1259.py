...
class DetailedBoltDesign(_0.APIBase):
    ...
    def rolled_before_or_after_heat_treatment(self) -> '_1265.RolledBeforeOrAfterHeatTreament':
        ...
        return constructor.new(_1265.RolledBeforeOrAfterHeatTreament)(value) if value else None
    ...
    def joint_geometry(self) -> '_1262.JointGeometries':
        ...
        return constructor.new(_1262.JointGeometries)(value) if value else None
    ...
    def bolt_geometry(self) -> '_1250.BoltGeometry':
        ...
        return constructor.new(_1250.BoltGeometry)(self.wrapped.BoltGeometry) if self.wrapped.BoltGeometry else None
    ...
    def material_of_bolt(self) -> '_1252.BoltMaterial':
        ...
        return constructor.new(_1252.BoltMaterial)(self.wrapped.MaterialOfBolt) if self.wrapped.MaterialOfBolt else None
