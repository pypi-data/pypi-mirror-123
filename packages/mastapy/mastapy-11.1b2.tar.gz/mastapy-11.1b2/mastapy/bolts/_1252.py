...
from mastapy.bolts import _1267, _1248
...
class BoltMaterial(_1248.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1267.StrengthGrades':
        ...
        return constructor.new(_1267.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1267.StrengthGrades'):
