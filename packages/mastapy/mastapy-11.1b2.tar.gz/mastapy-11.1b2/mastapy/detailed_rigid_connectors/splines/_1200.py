...
from mastapy.detailed_rigid_connectors.splines import _1182
...
class SplineMaterial(_239.Material):
    ...
    @property
    def heat_treatment_type(self) -> '_1182.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_1182.HeatTreatmentTypes'):
