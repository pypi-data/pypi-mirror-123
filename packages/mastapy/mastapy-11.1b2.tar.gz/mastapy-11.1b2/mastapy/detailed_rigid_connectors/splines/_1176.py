...
from mastapy.detailed_rigid_connectors.splines import _1186, _1195, _1203
...
class DIN5480SplineHalfDesign(_1203.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1186.ManufacturingTypes':
        ...
        return constructor.new(_1186.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1186.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1195.FinishingMethods':
        ...
        return constructor.new(_1195.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1195.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
