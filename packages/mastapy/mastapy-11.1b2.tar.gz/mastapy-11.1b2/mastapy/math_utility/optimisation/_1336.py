...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    def integer_range(self) -> '_1368.IntegerRange':
        ...
        return constructor.new(_1368.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange else None
    ...
    def specification_type(self) -> '_1341.TargetingPropertyTo':
        ...
        return constructor.new(_1341.TargetingPropertyTo)(value) if value else None
    ...
    def specify_input_range_as(self) -> '_1340.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1340.SpecifyOptimisationInputAs)(value) if value else None
