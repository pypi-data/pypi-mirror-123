...
from mastapy.math_utility.optimisation import _1338, _1336
...
class ParetoOptimistaionVariable(_1336.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1338.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1338.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1338.PropertyTargetForDominantCandidateSearch'):
