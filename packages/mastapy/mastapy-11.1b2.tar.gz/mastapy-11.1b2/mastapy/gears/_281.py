...
class BevelHypoidGearDesignSettings(_1371.PerMachineSettings):
    '''BevelHypoidGearDesignSettings
    ...
    @property
    def quality_grade_type(self) -> '_309.QualityGradeTypes':
    ...
    def quality_grade_type(self, value: '_309.QualityGradeTypes'):
