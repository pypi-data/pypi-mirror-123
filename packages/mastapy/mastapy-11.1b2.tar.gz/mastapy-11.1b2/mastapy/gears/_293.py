...
from mastapy.gears.rating.cylindrical import _439, _424
from mastapy.gears.gear_designs.cylindrical import _1020, _956
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_439.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_439.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_439.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1020.TolerancedMetalMeasurements':
        ...
        return constructor.new(_1020.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_1020.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def general_transmission_properties(self) -> '_226.GeneralTransmissionProperties':
        ...
        return constructor.new(_226.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_424.CylindricalGearRatingSettings':
        ...
        return constructor.new(_424.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
