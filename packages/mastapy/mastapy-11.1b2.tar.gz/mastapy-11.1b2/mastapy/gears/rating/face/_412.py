...
from mastapy.gears.rating.face import _415, _413
from mastapy.gears.rating.cylindrical.iso6336 import _473, _475
...
class FaceGearMeshRating(_325.GearMeshRating):
    '''FaceGearMeshRating
    ...
    @property
    def active_flank(self) -> '_291.GearFlanks':
        ...
        return constructor.new(_291.GearFlanks)(value) if value else None

    @property
    def mesh_load_case(self) -> '_824.FaceMeshLoadCase':
        ...
        return constructor.new(_824.FaceMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def gear_set_rating(self) -> '_415.FaceGearSetRating':
        ...
        return constructor.new(_415.FaceGearSetRating)(self.wrapped.GearSetRating) if self.wrapped.GearSetRating else None

    @property
    def mesh_single_flank_rating(self) -> '_473.ISO63362006MeshSingleFlankRating':
    ...
    @property
    def face_gear_mesh(self) -> '_931.FaceGearMeshDesign':
        ...
        return constructor.new(_931.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh else None
