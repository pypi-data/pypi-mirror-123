...
from mastapy.gears.gear_designs.conical import _1100
...
class AGMAGleasonConicalGearMeshRating(_493.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1100.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1100.LoadDistributionFactorMethods)(value) if value else None
