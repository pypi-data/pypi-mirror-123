...
class HypoidGearMeshRating(_519.AGMAGleasonConicalGearMeshRating):
    ...
    def iso10300_hypoid_mesh_single_flank_rating_method_b1(self) -> '_390.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_390.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB1 else None
    ...
    def iso10300_hypoid_mesh_single_flank_rating_method_b2(self) -> '_389.Iso10300MeshSingleFlankRatingHypoidMethodB2':
        ...
        return constructor.new(_389.Iso10300MeshSingleFlankRatingHypoidMethodB2)(self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB2 else None
    ...
    def gleason_hypoid_mesh_single_flank_rating(self) -> '_408.GleasonHypoidMeshSingleFlankRating':
        ...
        return constructor.new(_408.GleasonHypoidMeshSingleFlankRating)(self.wrapped.GleasonHypoidMeshSingleFlankRating) if self.wrapped.GleasonHypoidMeshSingleFlankRating else None

    @property
    def hypoid_gear_mesh(self) -> '_926.HypoidGearMeshDesign':
        ...
        return constructor.new(_926.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh else None
