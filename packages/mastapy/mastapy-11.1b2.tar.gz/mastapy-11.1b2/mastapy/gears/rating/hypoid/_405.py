...
from mastapy.gears.rating.hypoid import _403, _404
...
class HypoidGearSetRating(_521.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_403.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_403.HypoidGearMeshRating))
        return value
