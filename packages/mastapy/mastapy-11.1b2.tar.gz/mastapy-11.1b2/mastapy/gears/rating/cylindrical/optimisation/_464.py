...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    @property
    def safety_factors(self) -> '_333.SafetyFactorResults':
        ...
        return constructor.new(_333.SafetyFactorResults)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def normalised_safety_factors(self) -> '_333.SafetyFactorResults':
        ...
        return constructor.new(_333.SafetyFactorResults)(self.wrapped.NormalisedSafetyFactors) if self.wrapped.NormalisedSafetyFactors else None
