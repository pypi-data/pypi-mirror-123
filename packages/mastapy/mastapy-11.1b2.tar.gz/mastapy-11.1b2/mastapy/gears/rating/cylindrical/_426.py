...
class CylindricalGearSetDutyCycleRating(_327.GearSetDutyCycleRating):
    '''CylindricalGearSetDutyCycleRating
    ...
    def optimisations(self) -> '_461.CylindricalGearSetRatingOptimisationHelper':
        ...
        return constructor.new(_461.CylindricalGearSetRatingOptimisationHelper)(self.wrapped.Optimisations) if self.wrapped.Optimisations else None

    @property
    def gear_mesh_duty_cycle_ratings(self) -> 'List[_429.CylindricalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshDutyCycleRatings, constructor.new(_429.CylindricalMeshDutyCycleRating))
        return value

    @property
    def cylindrical_mesh_duty_cycle_ratings(self) -> 'List[_429.CylindricalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshDutyCycleRatings, constructor.new(_429.CylindricalMeshDutyCycleRating))
        return value
