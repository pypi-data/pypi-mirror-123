...
from mastapy.gears import _288, _306
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.gears.rating.cylindrical import _430, _427, _422
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _450, _452, _454
...
from mastapy.gears.load_case.cylindrical import _827
...
class CylindricalGearMeshRating(_325.GearMeshRating):
    '''CylindricalGearMeshRating
    ...
    @property
    def active_flank(self) -> '_288.CylindricalFlanks':
        ...
        return constructor.new(_288.CylindricalFlanks)(value) if value else None
    ...
    @property
    def load_sharing_factor_source(self) -> '_306.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_306.PlanetaryRatingLoadSharingOption)(value) if value else None
    ...
    @property
    def cylindrical_mesh_single_flank_rating(self) -> '_430.CylindricalMeshSingleFlankRating':
        ...
        if _430.CylindricalMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_metal_plastic_or_plastic_metal_vdi2736_mesh_single_flank_rating(self) -> '_450.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating':
        ...
        if _450.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_plastic_gear_vdi2736_abstract_mesh_single_flank_rating(self) -> '_452.PlasticGearVDI2736AbstractMeshSingleFlankRating':
        ...
        if _452.PlasticGearVDI2736AbstractMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_plastic_plastic_vdi2736_mesh_single_flank_rating(self) -> '_454.PlasticPlasticVDI2736MeshSingleFlankRating':
        ...
        if _454.PlasticPlasticVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso63361996_mesh_single_flank_rating(self) -> '_471.ISO63361996MeshSingleFlankRating':
        ...
        if _471.ISO63361996MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso63362006_mesh_single_flank_rating(self) -> '_473.ISO63362006MeshSingleFlankRating':
        ...
        if _473.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso63362019_mesh_single_flank_rating(self) -> '_475.ISO63362019MeshSingleFlankRating':
        ...
        if _475.ISO63362019MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso6336_abstract_mesh_single_flank_rating(self) -> '_477.ISO6336AbstractMeshSingleFlankRating':
        ...
        if _477.ISO6336AbstractMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso6336_abstract_metal_mesh_single_flank_rating(self) -> '_479.ISO6336AbstractMetalMeshSingleFlankRating':
        ...
        if _479.ISO6336AbstractMetalMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_488.DIN3990MeshSingleFlankRating':
        ...
        if _488.DIN3990MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_agma2101_mesh_single_flank_rating(self) -> '_490.AGMA2101MeshSingleFlankRating':
        ...
        if _490.AGMA2101MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_load_case(self) -> '_827.CylindricalMeshLoadCase':
        ...
        return constructor.new(_827.CylindricalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def gear_set_rating(self) -> '_427.CylindricalGearSetRating':
        ...
        return constructor.new(_427.CylindricalGearSetRating)(self.wrapped.GearSetRating) if self.wrapped.GearSetRating else None

    @property
    def vdi_cylindrical_gear_single_flank_rating(self) -> '_449.VDI2737InternalGearSingleFlankRating':
        ...
        return constructor.new(_449.VDI2737InternalGearSingleFlankRating)(self.wrapped.VDICylindricalGearSingleFlankRating) if self.wrapped.VDICylindricalGearSingleFlankRating else None

    @property
    def isodin_cylindrical_mesh_single_flank_rating(self) -> '_479.ISO6336AbstractMetalMeshSingleFlankRating':
        ...
        if _479.ISO6336AbstractMetalMeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_iso63361996_mesh_single_flank_rating(self) -> '_471.ISO63361996MeshSingleFlankRating':
        ...
        if _471.ISO63361996MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_iso63362006_mesh_single_flank_rating(self) -> '_473.ISO63362006MeshSingleFlankRating':
        ...
        if _473.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_iso63362019_mesh_single_flank_rating(self) -> '_475.ISO63362019MeshSingleFlankRating':
        ...
        if _475.ISO63362019MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_488.DIN3990MeshSingleFlankRating':
        ...
        if _488.DIN3990MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating(self) -> '_430.CylindricalMeshSingleFlankRating':
        ...
        if _430.CylindricalMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_metal_plastic_or_plastic_metal_vdi2736_mesh_single_flank_rating(self) -> '_450.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating':
        ...
        if _450.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_plastic_gear_vdi2736_abstract_mesh_single_flank_rating(self) -> '_452.PlasticGearVDI2736AbstractMeshSingleFlankRating':
        ...
        if _452.PlasticGearVDI2736AbstractMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_plastic_plastic_vdi2736_mesh_single_flank_rating(self) -> '_454.PlasticPlasticVDI2736MeshSingleFlankRating':
        ...
        if _454.PlasticPlasticVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso63361996_mesh_single_flank_rating(self) -> '_471.ISO63361996MeshSingleFlankRating':
        ...
        if _471.ISO63361996MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso63362006_mesh_single_flank_rating(self) -> '_473.ISO63362006MeshSingleFlankRating':
        ...
        if _473.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso63362019_mesh_single_flank_rating(self) -> '_475.ISO63362019MeshSingleFlankRating':
        ...
        if _475.ISO63362019MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso6336_abstract_mesh_single_flank_rating(self) -> '_477.ISO6336AbstractMeshSingleFlankRating':
        ...
        if _477.ISO6336AbstractMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso6336_abstract_metal_mesh_single_flank_rating(self) -> '_479.ISO6336AbstractMetalMeshSingleFlankRating':
        ...
        if _479.ISO6336AbstractMetalMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_488.DIN3990MeshSingleFlankRating':
        ...
        if _488.DIN3990MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_agma2101_mesh_single_flank_rating(self) -> '_490.AGMA2101MeshSingleFlankRating':
        ...
        if _490.AGMA2101MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def agma_cylindrical_mesh_single_flank_rating(self) -> '_490.AGMA2101MeshSingleFlankRating':
        ...
        return constructor.new(_490.AGMA2101MeshSingleFlankRating)(self.wrapped.AGMACylindricalMeshSingleFlankRating) if self.wrapped.AGMACylindricalMeshSingleFlankRating else None

    @property
    def cylindrical_gear_mesh(self) -> '_959.CylindricalGearMeshDesign':
        ...
        return constructor.new(_959.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMesh) if self.wrapped.CylindricalGearMesh else None
