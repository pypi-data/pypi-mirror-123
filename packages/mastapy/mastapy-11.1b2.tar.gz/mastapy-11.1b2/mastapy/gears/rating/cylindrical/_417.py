...
class CylindricalGearDutyCycleRating(_323.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_426.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_426.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_426.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_426.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None
    ...
    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_436.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_436.MeshRatingForReports))
        return value
