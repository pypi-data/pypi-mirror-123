...
class CylindricalGearSingleFlankRating(_329.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def metal_plastic(self) -> '_243.MetalPlasticType':
        ...
        return constructor.new(_243.MetalPlasticType)(value) if value else None
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_423.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_423.CylindricalGearRatingGeometryDataSource)(value) if value else None
