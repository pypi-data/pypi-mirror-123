...
from mastapy.gears.gear_designs.cylindrical import _1009, _1008
from mastapy.materials import _237
from mastapy.gears.rating.cylindrical import _425, _424, _428
...
class CylindricalMeshSingleFlankRating(_331.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_286.ContactRatioDataSource':
        ...
        return constructor.new(_286.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_1009.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_1009.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    def lubrication_detail(self) -> '_237.LubricationDetail':
        ...
        return constructor.new(_237.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def sorted_scuffing_results(self) -> '_425.CylindricalGearScuffingResults':
        ...
        return constructor.new(_425.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_425.CylindricalGearScuffingResults':
        ...
        return constructor.new(_425.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None
    ...
    def rating_settings(self) -> '_424.CylindricalGearRatingSettings':
        ...
        return constructor.new(_424.CylindricalGearRatingSettings)(self.wrapped.RatingSettings) if self.wrapped.RatingSettings else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_428.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_428.CylindricalGearSingleFlankRating))
        return value
