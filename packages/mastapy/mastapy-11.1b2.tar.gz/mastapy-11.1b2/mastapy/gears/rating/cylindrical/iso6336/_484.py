...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_486.ToothFlankFractureAnalysisPoint':
        ...
        return constructor.new(_486.ToothFlankFractureAnalysisPoint)(self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure) if self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure else None

    @property
    def watch_points(self) -> 'List[_486.ToothFlankFractureAnalysisPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WatchPoints, constructor.new(_486.ToothFlankFractureAnalysisPoint))
        return value
