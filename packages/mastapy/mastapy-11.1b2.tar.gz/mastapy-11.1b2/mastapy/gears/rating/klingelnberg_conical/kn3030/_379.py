...
class KlingelnbergConicalMeshSingleFlankRating(_331.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_352.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_352.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
