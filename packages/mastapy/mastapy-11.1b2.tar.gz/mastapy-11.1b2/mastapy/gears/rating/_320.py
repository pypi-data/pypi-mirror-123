...
class AbstractGearSetRating(_1145.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_319.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_319.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_318.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_318.AbstractGearMeshRating))
        return value
