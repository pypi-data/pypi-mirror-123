...
class MeshSingleFlankRating(_0.APIBase):
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_329.GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_329.GearSingleFlankRating))
        return value
