...
class ZerolBevelGearRating(_509.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_892.ZerolBevelGearDesign':
        ...
        return constructor.new(_892.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
