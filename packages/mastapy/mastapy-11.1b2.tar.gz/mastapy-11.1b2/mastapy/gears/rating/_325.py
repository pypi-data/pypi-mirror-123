...
from mastapy.gears.load_case.worm import _821
from mastapy._internal.cast_exception import CastException
from mastapy.gears.load_case.face import _824
from mastapy.gears.load_case.cylindrical import _827
from mastapy.gears.load_case.conical import _830
from mastapy.gears.load_case.concept import _833
from mastapy.gears.load_case.bevel import _835
...
class GearMeshRating(_318.AbstractGearMeshRating):
    '''GearMeshRating
    ...
    @property
    def mesh_load_case(self) -> '_818.MeshLoadCase':
        ...
        if _818.MeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_worm_mesh_load_case(self) -> '_821.WormMeshLoadCase':
        ...
        if _821.WormMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_face_mesh_load_case(self) -> '_824.FaceMeshLoadCase':
        ...
        if _824.FaceMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_cylindrical_mesh_load_case(self) -> '_827.CylindricalMeshLoadCase':
        ...
        if _827.CylindricalMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_conical_mesh_load_case(self) -> '_830.ConicalMeshLoadCase':
        ...
        if _830.ConicalMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_concept_mesh_load_case(self) -> '_833.ConceptMeshLoadCase':
        ...
        if _833.ConceptMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
    ...
    @property
    def mesh_load_case_of_type_bevel_mesh_load_case(self) -> '_835.BevelMeshLoadCase':
        ...
        if _835.BevelMeshLoadCase.TYPE not in self.wrapped.MeshLoadCase.__class__.__mro__:
