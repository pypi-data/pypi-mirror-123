...
from mastapy.gears.rating import _321, _319
...
class GearRating(_319.AbstractGearRating):
    '''GearRating
    ...
    @property
    def static_safety_factor(self) -> '_321.BendingAndContactReportingObject':
        ...
        return constructor.new(_321.BendingAndContactReportingObject)(self.wrapped.StaticSafetyFactor) if self.wrapped.StaticSafetyFactor else None

    @property
    def bending_safety_factor_results(self) -> '_248.SafetyFactorItem':
        ...
        if _248.SafetyFactorItem.TYPE not in self.wrapped.BendingSafetyFactorResults.__class__.__mro__:
    ...
    @property
    def contact_safety_factor_results(self) -> '_248.SafetyFactorItem':
        ...
        if _248.SafetyFactorItem.TYPE not in self.wrapped.ContactSafetyFactorResults.__class__.__mro__:
