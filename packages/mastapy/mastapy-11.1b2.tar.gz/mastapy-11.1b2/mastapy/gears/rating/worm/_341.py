...
from mastapy.gears.rating.worm import _338, _339
...
class WormGearSetRating(_328.GearSetRating):
    '''WormGearSetRating
    ...
    @property
    def worm_mesh_ratings(self) -> 'List[_338.WormGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshRatings, constructor.new(_338.WormGearMeshRating))
        return value
