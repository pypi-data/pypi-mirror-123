...
class WormGearDutyCycleRating(_323.GearDutyCycleRating):
    ...
    def gear_set_design_duty_cycle(self) -> '_340.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_340.WormGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None
    ...
    def worm_gear_set_design_duty_cycle(self) -> '_340.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_340.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDesignDutyCycle) if self.wrapped.WormGearSetDesignDutyCycle else None
