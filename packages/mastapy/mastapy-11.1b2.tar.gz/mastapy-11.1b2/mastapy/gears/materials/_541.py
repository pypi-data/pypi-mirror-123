...
from mastapy.gears.materials import _562, _548
...
class BevelGearMaterial(_548.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_562.SNCurveDefinition':
        ...
        return constructor.new(_562.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_562.SNCurveDefinition'):
