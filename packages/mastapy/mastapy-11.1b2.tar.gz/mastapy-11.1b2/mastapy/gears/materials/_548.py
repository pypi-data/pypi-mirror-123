...
class GearMaterial(_239.Material):
    ...
    def sn_curve_contact(self) -> '_249.SNCurve':
        ...
        return constructor.new(_249.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None
    ...
    def sn_curve_bending(self) -> '_249.SNCurve':
        ...
        return constructor.new(_249.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
