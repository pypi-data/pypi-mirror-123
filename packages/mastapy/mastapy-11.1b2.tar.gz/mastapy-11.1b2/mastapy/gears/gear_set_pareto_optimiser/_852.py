...
from mastapy.gears.gear_set_pareto_optimiser import _853
...
class GearNameMapper(_0.APIBase):
    ...
    @property
    def gear_name_pickers(self) -> 'List[_853.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_853.GearNamePicker))
        return value
