...
from mastapy.gears import _289, _288
...
class CylindricalMeshLoadCase(_818.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_289.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_289.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_289.CylindricalMisalignmentDataSource'):
