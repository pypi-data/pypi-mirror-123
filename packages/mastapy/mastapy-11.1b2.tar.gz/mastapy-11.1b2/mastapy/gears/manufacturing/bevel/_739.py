...
from mastapy.gears.manufacturing.bevel import _748, _741
...
class ConicalMeshManufacturingConfig(_741.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_748.ConicalWheelManufacturingConfig':
        ...
        return constructor.new(_748.ConicalWheelManufacturingConfig)(self.wrapped.WheelConfig) if self.wrapped.WheelConfig else None
