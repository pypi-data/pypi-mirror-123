...
from mastapy.gears.manufacturing.bevel.cutters import _769
from mastapy._internal import constructor
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _775, _776, _777
...
class Wheel(_0.APIBase):
    ...
    @property
    def basic_conical_gear_machine_settings(self) -> '_775.BasicConicalGearMachineSettings':
        ...
        if _775.BasicConicalGearMachineSettings.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_776.BasicConicalGearMachineSettingsFormate':
        ...
        if _776.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_777.BasicConicalGearMachineSettingsGenerated':
        ...
        if _777.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
