...
from mastapy.gears.manufacturing.bevel import _752, _766
...
class ManufacturingMachine(_1579.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_752.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_752.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_752.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_766.WheelFormatMachineTypes':
        ...
        return constructor.new(_766.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_766.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
