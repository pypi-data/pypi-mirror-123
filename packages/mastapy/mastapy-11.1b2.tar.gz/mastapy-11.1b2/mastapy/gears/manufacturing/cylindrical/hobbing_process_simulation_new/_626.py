...
class HobbingProcessSimulationInput(_639.ProcessSimulationInput):
    '''HobbingProcessSimulationInput
    ...
    @property
    def hob_manufacture_error(self) -> '_630.HobManufactureError':
        ...
        return constructor.new(_630.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError else None

    @property
    def hob_resharpening_error(self) -> '_631.HobResharpeningError':
        ...
        return constructor.new(_631.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError else None
