...
from mastapy.gears.manufacturing.cylindrical.cutters import _690
...
class CylindricalGearShaper(_690.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_1012.ShaperEdgeTypes':
        ...
        return constructor.new(_1012.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1012.ShaperEdgeTypes'):
