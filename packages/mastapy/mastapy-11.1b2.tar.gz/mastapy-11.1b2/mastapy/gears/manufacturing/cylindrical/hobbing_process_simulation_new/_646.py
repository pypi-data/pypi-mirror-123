...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _607
...
class WormGrindingCutterCalculation(_648.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_607.PointOfInterest':
        ...
        return constructor.new(_607.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
