...
class PlungeShaverCalculation(_0.APIBase):
    ...
    def inputs(self) -> '_602.PlungeShaverCalculationInputs':
        ...
        return constructor.new(_602.PlungeShaverCalculationInputs)(self.wrapped.Inputs) if self.wrapped.Inputs else None
    ...
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_611.VirtualPlungeShaverOutputs':
        ...
        return constructor.new(_611.VirtualPlungeShaverOutputs)(self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear) if self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear else None
