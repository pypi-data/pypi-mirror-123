...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _719
...
class RedressingSettings(_0.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_687.CylindricalGearShaver':
        ...
        if _687.CylindricalGearShaver.TYPE not in self.wrapped.RedressedShaver.__class__.__mro__:
