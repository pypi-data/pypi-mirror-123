...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _700, _702, _697
...
class CylindricalGearGrindingWorm(_684.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_700.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_700.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
