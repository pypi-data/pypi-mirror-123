...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _616, _648
...
class WormGrindingProcessProfileCalculation(_648.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def chart_display_method(self) -> '_965.CylindricalGearProfileMeasurementType':
    ...
    def chart_display_method(self, value: '_965.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def right_flank(self) -> '_616.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_616.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_616.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_616.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
