...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    def lead_calculation(self) -> '_636.ProcessLeadCalculation':
        ...
        return constructor.new(_636.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation else None
    ...
    def profile_calculation(self) -> '_638.ProcessProfileCalculation':
        ...
        return constructor.new(_638.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation else None
    ...
    def pitch_calculation(self) -> '_637.ProcessPitchCalculation':
        ...
        return constructor.new(_637.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation else None
    ...
    def gear_tooth_shape_calculation(self) -> '_635.ProcessGearShape':
        ...
        return constructor.new(_635.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation else None
    ...
    def total_modification_calculation(self) -> '_642.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_642.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation else None
