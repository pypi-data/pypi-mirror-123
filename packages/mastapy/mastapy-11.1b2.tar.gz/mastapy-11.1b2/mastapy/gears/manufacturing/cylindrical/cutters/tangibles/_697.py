...
class CylindricalGearHobShape(_702.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_681.CylindricalGearHobDesign':
        ...
        return constructor.new(_681.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design else None
