...
class ProcessLeadCalculation(_0.APIBase):
    ...
    def right_flank_accuracy_calculation(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation else None
    ...
    def left_flank_accuracy_calculation(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation else None
