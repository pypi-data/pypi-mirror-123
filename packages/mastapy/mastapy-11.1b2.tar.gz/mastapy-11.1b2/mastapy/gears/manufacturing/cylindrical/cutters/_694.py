...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _667
...
class RoughCutterCreationSettings(_0.APIBase):
    ...
    @property
    def rough_thickness_used_to_generate_cutter(self) -> '_1020.TolerancedMetalMeasurements':
    ...
    def rough_thickness_used_to_generate_cutter(self, value: '_1020.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RoughThicknessUsedToGenerateCutter = value

    @property
    def finish_thickness_used_to_generate_cutter(self) -> '_1020.TolerancedMetalMeasurements':
    ...
    def finish_thickness_used_to_generate_cutter(self, value: '_1020.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishThicknessUsedToGenerateCutter = value

    @property
    def rough_tool_clearances(self) -> '_667.ManufacturingOperationConstraints':
        ...
        return constructor.new(_667.ManufacturingOperationConstraints)(self.wrapped.RoughToolClearances) if self.wrapped.RoughToolClearances else None

    @property
    def finish_tool_clearances(self) -> '_667.ManufacturingOperationConstraints':
        ...
        return constructor.new(_667.ManufacturingOperationConstraints)(self.wrapped.FinishToolClearances) if self.wrapped.FinishToolClearances else None
