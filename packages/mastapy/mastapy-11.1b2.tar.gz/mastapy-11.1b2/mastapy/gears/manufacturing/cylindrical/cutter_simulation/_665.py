...
class GearCutterSimulation(_0.APIBase):
    ...
    def minimum_thickness_virtual(self) -> '_673.VirtualSimulationCalculator':
        ...
        return constructor.new(_673.VirtualSimulationCalculator)(self.wrapped.MinimumThicknessVirtual) if self.wrapped.MinimumThicknessVirtual else None
    ...
    def average_thickness_virtual(self) -> '_673.VirtualSimulationCalculator':
        ...
        return constructor.new(_673.VirtualSimulationCalculator)(self.wrapped.AverageThicknessVirtual) if self.wrapped.AverageThicknessVirtual else None
    ...
    def maximum_thickness_virtual(self) -> '_673.VirtualSimulationCalculator':
        ...
        return constructor.new(_673.VirtualSimulationCalculator)(self.wrapped.MaximumThicknessVirtual) if self.wrapped.MaximumThicknessVirtual else None
