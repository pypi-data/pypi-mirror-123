...
class CylindricalGearFormGrindingWheel(_685.CylindricalGearRealCutterDesign):
    '''CylindricalGearFormGrindingWheel
    ...
    @property
    def right_hand_cutting_edge_shape(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'RightHandCuttingEdgeShape' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.RightHandCuttingEdgeShape) if self.wrapped.RightHandCuttingEdgeShape else None

    @right_hand_cutting_edge_shape.setter
    def right_hand_cutting_edge_shape(self, value: '_1317.Vector2DListAccessor'):
