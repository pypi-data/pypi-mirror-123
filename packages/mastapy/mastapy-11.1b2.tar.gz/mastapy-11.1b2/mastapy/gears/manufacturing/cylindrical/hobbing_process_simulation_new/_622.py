...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _614, _620
...
class HobbingProcessLeadCalculation(_620.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
