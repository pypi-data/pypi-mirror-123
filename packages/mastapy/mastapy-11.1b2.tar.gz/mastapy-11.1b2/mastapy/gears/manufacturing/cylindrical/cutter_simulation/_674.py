...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _700
...
class WormGrinderSimulationCalculator(_669.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_700.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_700.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
