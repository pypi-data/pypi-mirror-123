...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _657
...
class FormWheelGrindingSimulationCalculator(_657.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_696.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_696.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
