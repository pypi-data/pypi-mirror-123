...
class ShaperSimulationCalculator(_657.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_698.CylindricalGearShaperTangible':
        ...
        return constructor.new(_698.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
