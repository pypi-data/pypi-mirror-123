...
class CylindricalGearTIFFAnalysis(_1146.GearDesignAnalysis):
    '''CylindricalGearTIFFAnalysis
    ...
    def analysis(self) -> '_843.CylindricalGearTwoDimensionalFEAnalysis':
        ...
        return constructor.new(_843.CylindricalGearTwoDimensionalFEAnalysis)(self.wrapped.Analysis) if self.wrapped.Analysis else None
