...
from mastapy.gears.fe_model import _1130
...
class GearFEModel(_1149.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1130.GearMeshingElementOptions':
        ...
        return constructor.new(_1130.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_291.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_291.GearFlanks', progress: '_7248.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
