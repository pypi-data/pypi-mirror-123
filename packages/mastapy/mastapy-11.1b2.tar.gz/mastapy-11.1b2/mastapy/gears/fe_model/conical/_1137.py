...
from mastapy.gears.fe_model.conical import _1138
...
class ConicalSetFEModel(_1131.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1138.FlankDataSource':
        ...
        return constructor.new(_1138.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1138.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
