...
class PocketingPowerLossCoefficients(_1579.NamedDatabaseItem):
    '''PocketingPowerLossCoefficients
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1349.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'RawPocketingPowerLossLookupTable' is the original name of this property.'''

        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.RawPocketingPowerLossLookupTable) if self.wrapped.RawPocketingPowerLossLookupTable else None

    @raw_pocketing_power_loss_lookup_table.setter
    def raw_pocketing_power_loss_lookup_table(self, value: '_1349.GriddedSurfaceAccessor'):
    ...
    @property
    def specifications_for_the_effect_of_oil_kinematic_viscosity(self) -> 'List[_311.SpecificationForTheEffectOfOilKinematicViscosity]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecificationsForTheEffectOfOilKinematicViscosity, constructor.new(_311.SpecificationForTheEffectOfOilKinematicViscosity))
        return value
