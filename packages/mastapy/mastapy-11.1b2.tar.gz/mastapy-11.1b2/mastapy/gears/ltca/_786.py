...
from mastapy.gears.ltca import _787, _785
...
class GearMeshLoadDistributionAnalysis(_1151.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1296.FourierSeries':
        ...
        return constructor.new(_1296.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_787.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_787.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_785.GearLoadDistributionAnalysis', flank: '_291.GearFlanks', stress_type: '_82.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_785.GearLoadDistributionAnalysis', stress_type: '_82.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
