...
from mastapy.gears.ltca.conical import _812
...
class ConicalMeshLoadDistributionAnalysis(_786.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_830.ConicalMeshLoadCase':
        ...
        if _830.ConicalMeshLoadCase.TYPE not in self.wrapped.ConicalMeshLoadCase.__class__.__mro__:
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_738.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_738.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_812.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_812.ConicalMeshedGearLoadDistributionAnalysis))
        return value
