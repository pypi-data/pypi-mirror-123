...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_1093.CutterGaugeLengths':
        ...
        return constructor.new(_1093.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1093.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_1092.CutterBladeType':
        ...
        return constructor.new(_1092.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1092.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_1101.TopremEntryType':
        ...
        return constructor.new(_1101.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1101.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_1102.TopremLetter':
        ...
        return constructor.new(_1102.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_1102.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_1102.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_1102.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
