...
class KlingelnbergConicalGearDesign(_1085.ConicalGearDesign):
    ...
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_555.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_555.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial else None
