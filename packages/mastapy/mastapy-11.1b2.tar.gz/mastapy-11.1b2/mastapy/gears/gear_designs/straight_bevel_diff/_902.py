...
from mastapy.gears.gear_designs.straight_bevel_diff import _903, _901, _904
...
class StraightBevelDiffGearMeshDesign(_1112.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_901.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_901.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_904.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_904.StraightBevelDiffMeshedGearDesign))
        return value
