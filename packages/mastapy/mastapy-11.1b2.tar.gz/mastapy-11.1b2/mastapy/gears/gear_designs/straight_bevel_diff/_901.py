...
from mastapy.gears.gear_designs.bevel import _1116, _1111
...
class StraightBevelDiffGearDesign(_1111.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1116.EdgeRadiusType':
        ...
        return constructor.new(_1116.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1116.EdgeRadiusType'):
