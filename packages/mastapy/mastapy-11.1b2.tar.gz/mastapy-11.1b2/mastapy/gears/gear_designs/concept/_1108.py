...
from mastapy.gears.gear_designs.concept import _1109, _1107
...
class ConceptGearMeshDesign(_889.GearMeshDesign):
    '''ConceptGearMeshDesign
    ...
    @property
    def concept_gears(self) -> 'List[_1107.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1107.ConceptGearDesign))
        return value
