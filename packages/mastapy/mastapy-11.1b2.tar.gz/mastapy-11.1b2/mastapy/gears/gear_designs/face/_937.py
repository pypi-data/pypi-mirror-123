...
from mastapy.gears.gear_designs.face import _930, _929
...
class FaceGearWheelDesign(_929.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_930.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_930.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_930.FaceGearDiameterFaceWidthSpecificationMethod'):
