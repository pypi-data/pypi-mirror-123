...
class FaceGearSetDesign(_890.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_934.FaceGearPinionDesign':
        ...
        return constructor.new(_934.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_937.FaceGearWheelDesign':
        ...
        return constructor.new(_937.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_936.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_936.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_929.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_929.FaceGearDesign))
        return value
    ...
    @property
    def face_meshes(self) -> 'List[_931.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_931.FaceGearMeshDesign))
        return value
