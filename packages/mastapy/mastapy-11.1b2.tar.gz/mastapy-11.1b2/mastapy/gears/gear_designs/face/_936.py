...
from mastapy.gears.gear_designs.face import _935, _933, _932
...
class FaceGearSetMicroGeometry(_1159.GearSetImplementationDetail):
    '''FaceGearSetMicroGeometry
    ...
    def face_gear_set_design(self) -> '_935.FaceGearSetDesign':
        ...
        return constructor.new(_935.FaceGearSetDesign)(self.wrapped.FaceGearSetDesign) if self.wrapped.FaceGearSetDesign else None
    ...
    @property
    def face_mesh_micro_geometries(self) -> 'List[_932.FaceGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshMicroGeometries, constructor.new(_932.FaceGearMeshMicroGeometry))
        return value
