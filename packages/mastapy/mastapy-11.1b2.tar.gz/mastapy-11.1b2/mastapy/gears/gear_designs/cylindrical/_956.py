...
class CylindricalGearDesignConstraintSettings(_1371.PerMachineSettings):
    ...
    def cylindrical_gear_design_constraints(self) -> '_954.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_954.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
