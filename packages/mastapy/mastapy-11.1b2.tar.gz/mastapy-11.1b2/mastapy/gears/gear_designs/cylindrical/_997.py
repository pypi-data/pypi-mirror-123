...
from mastapy.gears.gear_designs.cylindrical import _977, _974
...
class LinearBacklashSepcification(_0.APIBase):
    ...
    @property
    def normal_backlash(self) -> '_977.CylindricalMeshLinearBacklashSpecification':
        ...
        if _977.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.NormalBacklash.__class__.__mro__:
    ...
    @property
    def circumferential_backlash_pitch_circle(self) -> '_977.CylindricalMeshLinearBacklashSpecification':
        ...
        if _977.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.CircumferentialBacklashPitchCircle.__class__.__mro__:
    ...
    @property
    def circumferential_backlash_reference_circle(self) -> '_977.CylindricalMeshLinearBacklashSpecification':
        ...
        if _977.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.CircumferentialBacklashReferenceCircle.__class__.__mro__:
    ...
    @property
    def radial_backlash(self) -> '_977.CylindricalMeshLinearBacklashSpecification':
        ...
        if _977.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.RadialBacklash.__class__.__mro__:
    ...
    @property
    def linear_backlash(self) -> 'List[_977.CylindricalMeshLinearBacklashSpecification]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinearBacklash, constructor.new(_977.CylindricalMeshLinearBacklashSpecification))
        return value
