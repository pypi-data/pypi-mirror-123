...
from mastapy.utility.report import _1536
...
class CylindricalGearTableWithMGCharts(_1536.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_971.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_971.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_971.CylindricalGearTableMGItemDetail'):
