...
class MeshAlignment(_0.APIBase):
    ...
    @property
    def gear_a_alignment(self) -> '_1046.GearAlignment':
        ...
        return constructor.new(_1046.GearAlignment)(self.wrapped.GearAAlignment) if self.wrapped.GearAAlignment else None

    @property
    def gear_b_alignment(self) -> '_1046.GearAlignment':
        ...
        return constructor.new(_1046.GearAlignment)(self.wrapped.GearBAlignment) if self.wrapped.GearBAlignment else None
