...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1062, _1050, _1057
...
class CylindricalGearTriangularEndModificationAtOrientation(_0.APIBase):
    ...
    @property
    def linear(self) -> '_1062.SingleCylindricalGearTriangularEndModification':
        ...
        if _1062.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.Linear.__class__)(self.wrapped.Linear) if self.wrapped.Linear else None

    @property
    def linear_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1050.LinearCylindricalGearTriangularEndModification':
        ...
        if _1050.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def linear_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1057.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1057.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def parabolic(self) -> '_1062.SingleCylindricalGearTriangularEndModification':
        ...
        if _1062.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.Parabolic.__class__)(self.wrapped.Parabolic) if self.wrapped.Parabolic else None

    @property
    def parabolic_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1050.LinearCylindricalGearTriangularEndModification':
        ...
        if _1050.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
    ...
    @property
    def parabolic_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1057.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1057.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
