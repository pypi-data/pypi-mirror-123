...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1064, _1058
...
class MeshedCylindricalGearFlankMicroGeometry(_0.APIBase):
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1058.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormReliefPoints, constructor.new(_1058.ProfileFormReliefWithDeviation))
        return value

    @property
    def involute_inspection_points(self) -> 'List[_1064.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InvoluteInspectionPoints, constructor.new(_1064.TotalProfileReliefWithDeviation))
        return value
