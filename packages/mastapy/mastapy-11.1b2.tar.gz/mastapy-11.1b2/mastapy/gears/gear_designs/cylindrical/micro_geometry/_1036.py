...
from mastapy.gears.gear_designs.cylindrical import _952, _979, _964
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1031, _1054
...
class CylindricalGearMicroGeometry(_1149.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    @property
    def cylindrical_gear(self) -> '_952.CylindricalGearDesign':
        ...
        if _952.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGear.__class__.__mro__:
    ...
    @property
    def left_flank(self) -> '_1031.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1031.CylindricalGearFlankMicroGeometry)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_1031.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1031.CylindricalGearFlankMicroGeometry)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
    ...
    @property
    def flanks(self) -> 'List[_1031.CylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1031.CylindricalGearFlankMicroGeometry))
        return value

    @property
    def meshed_gears(self) -> 'List[_1054.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_1054.MeshedCylindricalGearMicroGeometry))
        return value

    @property
    def both_flanks(self) -> '_1031.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1031.CylindricalGearFlankMicroGeometry)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None
