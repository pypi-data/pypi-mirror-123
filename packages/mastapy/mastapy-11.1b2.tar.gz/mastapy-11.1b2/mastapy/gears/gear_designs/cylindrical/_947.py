...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self) -> '_946.CylindricalGearAbstractRack':
        ...
        if _946.CylindricalGearAbstractRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_basic_rack(self) -> '_948.CylindricalGearBasicRack':
        ...
        if _948.CylindricalGearBasicRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_962.CylindricalGearPinionTypeCutter':
        ...
        if _962.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_standard_rack(self) -> '_1014.StandardRack':
        ...
        if _1014.StandardRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
