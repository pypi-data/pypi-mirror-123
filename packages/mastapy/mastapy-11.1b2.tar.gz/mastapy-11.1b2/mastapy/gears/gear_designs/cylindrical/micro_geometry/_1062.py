...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    def profile_evaluation(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluation) if self.wrapped.ProfileEvaluation else None
    ...
    def profile_start(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.ProfileStart) if self.wrapped.ProfileStart else None
