...
class CylindricalGearDefaults(_1371.PerMachineSettings):
    ...
    def finish_stock_type(self) -> '_1027.FinishStockType':
        ...
        return constructor.new(_1027.FinishStockType)(value) if value else None
    ...
    def system_of_fits_defaults(self) -> '_1072.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1072.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None
    ...
    def rough_cutter_creation_settings(self) -> '_694.RoughCutterCreationSettings':
        ...
        return constructor.new(_694.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
