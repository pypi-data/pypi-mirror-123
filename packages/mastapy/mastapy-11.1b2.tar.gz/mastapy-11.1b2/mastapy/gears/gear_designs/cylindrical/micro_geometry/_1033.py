...
class CylindricalGearLeadModificationAtProfilePosition(_1032.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
