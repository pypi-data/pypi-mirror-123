...
from mastapy.utility.units_and_measurements.measurements import _1436, _1452
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    @property
    def normal_thickness(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.NormalThickness) if self.wrapped.NormalThickness else None

    @property
    def normal_thickness_at_specified_diameter(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.NormalThicknessAtSpecifiedDiameter) if self.wrapped.NormalThicknessAtSpecifiedDiameter else None

    @property
    def chordal_span(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.ChordalSpan) if self.wrapped.ChordalSpan else None

    @property
    def over_balls(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.OverBalls) if self.wrapped.OverBalls else None

    @property
    def transverse_thickness(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.TransverseThickness) if self.wrapped.TransverseThickness else None

    @property
    def transverse_thickness_at_specified_diameter(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.TransverseThicknessAtSpecifiedDiameter) if self.wrapped.TransverseThicknessAtSpecifiedDiameter else None

    @property
    def profile_shift_coefficient(self) -> '_973.CylindricalGearToothThicknessSpecification[_1452.Number]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1452.Number](self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient else None

    @property
    def profile_shift(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.ProfileShift) if self.wrapped.ProfileShift else None

    @property
    def tooth_thickness(self) -> 'List[_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothThickness, constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort])
        return value
