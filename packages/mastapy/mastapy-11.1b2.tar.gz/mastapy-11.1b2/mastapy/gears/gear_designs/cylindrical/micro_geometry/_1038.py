...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1051
...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_1051.MeasuredMapDataTypes':
        ...
        return constructor.new(_1051.MeasuredMapDataTypes)(value) if value else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_1051.MeasuredMapDataTypes'):
