...
from mastapy.gears.gear_designs.cylindrical import _962, _947
...
class CylindricalGearPinionTypeCutterFlank(_947.CylindricalGearAbstractRackFlank):
    '''CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self) -> '_962.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_962.CylindricalGearPinionTypeCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
