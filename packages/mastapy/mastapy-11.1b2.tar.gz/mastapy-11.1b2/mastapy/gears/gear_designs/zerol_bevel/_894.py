...
from mastapy.gears.gear_designs.zerol_bevel import _892, _893
...
class ZerolBevelGearSetDesign(_1113.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self) -> '_317.ZerolBevelGleasonToothTaperOption':
        ...
        return constructor.new(_317.ZerolBevelGleasonToothTaperOption)(value) if value else None

    @tooth_taper_zerol.setter
    def tooth_taper_zerol(self, value: '_317.ZerolBevelGleasonToothTaperOption'):
    ...
    @property
    def gears(self) -> 'List[_892.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_892.ZerolBevelGearDesign))
        return value
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_893.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_893.ZerolBevelGearMeshDesign))
        return value
