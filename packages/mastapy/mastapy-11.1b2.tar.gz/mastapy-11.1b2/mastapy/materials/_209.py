...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def radiation_efficiency_curve(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'RadiationEfficiencyCurve' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.RadiationEfficiencyCurve) if self.wrapped.RadiationEfficiencyCurve else None

    @radiation_efficiency_curve.setter
    def radiation_efficiency_curve(self, value: '_1317.Vector2DListAccessor'):
    ...
    def input_type(self) -> '_210.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_210.AcousticRadiationEfficiencyInputType)(value) if value else None
