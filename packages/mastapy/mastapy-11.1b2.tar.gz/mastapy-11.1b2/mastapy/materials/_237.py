...
class LubricationDetail(_1579.NamedDatabaseItem):
    '''LubricationDetail
    ...
    def density_specification_method(self) -> '_222.DensitySpecificationMethod':
        ...
        return constructor.new(_222.DensitySpecificationMethod)(value) if value else None
    ...
    @property
    def density_vs_temperature(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'DensityVsTemperature' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.DensityVsTemperature) if self.wrapped.DensityVsTemperature else None

    @density_vs_temperature.setter
    def density_vs_temperature(self, value: '_1317.Vector2DListAccessor'):
    ...
    def pressure_viscosity_coefficient_method(self) -> '_245.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_245.PressureViscosityCoefficientMethod)(value) if value else None
    ...
    def oil_filtration_and_contamination(self) -> '_244.OilFiltrationOptions':
        ...
        return constructor.new(_244.OilFiltrationOptions)(value) if value else None
    ...
    def grease_contamination_level(self) -> '_227.GreaseContaminationOptions':
        ...
        return constructor.new(_227.GreaseContaminationOptions)(value) if value else None
    ...
    def lubricant_type_supply(self) -> '_216.BearingLubricationCondition':
        ...
        return constructor.new(_216.BearingLubricationCondition)(value) if value else None
    ...
    def lubricant_viscosity_classification(self) -> '_234.LubricantViscosityClassification':
        ...
        return constructor.new(_234.LubricantViscosityClassification)(value) if value else None
    ...
    def lubricant_grade_agma(self) -> '_233.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_233.LubricantViscosityClassAGMA)(value) if value else None
    ...
    def lubricant_grade_sae(self) -> '_236.LubricantViscosityClassSAE':
        ...
        return constructor.new(_236.LubricantViscosityClassSAE)(value) if value else None
    ...
    def delivery(self) -> '_232.LubricantDelivery':
        ...
        return constructor.new(_232.LubricantDelivery)(value) if value else None
    ...
    def agma925a03_lubricant_type(self) -> '_211.AGMALubricantType':
        ...
        return constructor.new(_211.AGMALubricantType)(value) if value else None
    ...
    def iso_lubricant_type(self) -> '_230.ISOLubricantType':
        ...
        return constructor.new(_230.ISOLubricantType)(value) if value else None
