...
from mastapy.fe_tools.enums import _1170
...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    def elastic_modulus_components(self) -> '_179.ElasticModulusOrthotropicComponents':
        ...
        return constructor.new(_179.ElasticModulusOrthotropicComponents)(self.wrapped.ElasticModulusComponents) if self.wrapped.ElasticModulusComponents else None
    ...
    def shear_modulus_components(self) -> '_194.ShearModulusOrthotropicComponents':
        ...
        return constructor.new(_194.ShearModulusOrthotropicComponents)(self.wrapped.ShearModulusComponents) if self.wrapped.ShearModulusComponents else None
    ...
    def poissons_ratio_components(self) -> '_192.PoissonRatioOrthotropicComponents':
        ...
        return constructor.new(_192.PoissonRatioOrthotropicComponents)(self.wrapped.PoissonsRatioComponents) if self.wrapped.PoissonsRatioComponents else None
    ...
    def thermal_expansion_coefficient_components(self) -> '_195.ThermalExpansionOrthotropicComponents':
        ...
        return constructor.new(_195.ThermalExpansionOrthotropicComponents)(self.wrapped.ThermalExpansionCoefficientComponents) if self.wrapped.ThermalExpansionCoefficientComponents else None
