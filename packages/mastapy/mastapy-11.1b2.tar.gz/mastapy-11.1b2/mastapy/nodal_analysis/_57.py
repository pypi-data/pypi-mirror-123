...
class FEMeshingOptions(_0.APIBase):
    ...
    def minimum_element_size(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.MinimumElementSize) if self.wrapped.MinimumElementSize else None
    ...
    def element_order(self) -> '_55.ElementOrder':
        ...
        return constructor.new(_55.ElementOrder)(value) if value else None
    ...
    def element_shape(self) -> '_87.VolumeElementShape':
        ...
        return constructor.new(_87.VolumeElementShape)(value) if value else None
