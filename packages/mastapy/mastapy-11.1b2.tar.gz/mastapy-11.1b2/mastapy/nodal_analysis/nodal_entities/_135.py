...
class LineContactStiffnessEntity(_120.ArbitraryNodalComponent):
    '''LineContactStiffnessEntity
    ...
    @property
    def stiffness_in_local_coordinate_system(self) -> '_74.NodalMatrix':
        ...
        return constructor.new(_74.NodalMatrix)(self.wrapped.StiffnessInLocalCoordinateSystem) if self.wrapped.StiffnessInLocalCoordinateSystem else None
