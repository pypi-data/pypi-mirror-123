...
from mastapy.nodal_analysis import _48
...
class Bar(_136.NodalComponent):
    ...
    @property
    def bar_geometry(self) -> '_48.BarGeometry':
        ...
        return constructor.new(_48.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
