...
from mastapy.math_utility.stiffness_calculators import _1320
...
class SurfaceToSurfaceContactStiffnessEntity(_120.ArbitraryNodalComponent):
    ...
    @property
    def contact(self) -> '_1320.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1320.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
