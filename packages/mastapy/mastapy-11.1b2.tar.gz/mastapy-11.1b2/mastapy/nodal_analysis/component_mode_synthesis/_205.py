...
class RealCMSResults(_202.CMSResults):
    '''RealCMSResults
    ...
    @property
    def node_displacements(self) -> '_119.NodeVectorState':
        ...
        if _119.NodeVectorState.TYPE not in self.wrapped.NodeDisplacements.__class__.__mro__:
