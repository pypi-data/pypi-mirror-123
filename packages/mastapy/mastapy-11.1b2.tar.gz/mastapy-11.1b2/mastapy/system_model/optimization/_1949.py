...
from mastapy.system_model.optimization import _1950
...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_1950.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1950.MeasuredAndFactorViewModel))
        return value
