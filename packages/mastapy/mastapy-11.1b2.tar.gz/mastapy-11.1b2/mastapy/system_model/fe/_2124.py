...
from mastapy.system_model.fe import _2119, _2118
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    def file_type(self) -> 'SystemDeflectionFEExportOptions.ExportType':
        ...
        return constructor.new(SystemDeflectionFEExportOptions.ExportType)(value) if value else None
    ...
    @property
    def nodes(self) -> 'List[_2119.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2119.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2118.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2118.PerLinkExportOptions))
        return value
    ...
    def export_to_op2_file(self, file_path: 'str'):
        ...
        file_path = str(file_path)
        self.wrapped.ExportToOP2File(file_path if file_path else None)
