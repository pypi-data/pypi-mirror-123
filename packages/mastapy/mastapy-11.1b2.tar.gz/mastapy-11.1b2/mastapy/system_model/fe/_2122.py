...
from mastapy.system_model.fe import _2120, _2075
...
class RaceBearingFEWithSelection(_2075.BaseFEWithSelection):
    '''RaceBearingFEWithSelection
    ...
    def manual_alignment(self) -> '_1282.CoordinateSystemEditor':
        ...
        return constructor.new(_1282.CoordinateSystemEditor)(self.wrapped.ManualAlignment) if self.wrapped.ManualAlignment else None

    @property
    def race_bearing(self) -> '_2120.RaceBearingFE':
        ...
        return constructor.new(_2120.RaceBearingFE)(self.wrapped.RaceBearing) if self.wrapped.RaceBearing else None
