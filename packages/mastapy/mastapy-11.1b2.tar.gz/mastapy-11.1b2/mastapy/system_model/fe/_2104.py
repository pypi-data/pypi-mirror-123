...
class FESubstructureWithSelection(_2075.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2097.FESubstructure':
        ...
        return constructor.new(_2097.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure else None

    @property
    def element_face_groups(self) -> 'List[_2090.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2090.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2115.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2115.NodeGroupWithSelection))
        return value
