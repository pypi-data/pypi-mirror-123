...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    def rigid_coupling_type(self) -> '_175.RigidCouplingType':
        ...
        return constructor.new(_175.RigidCouplingType)(value) if value else None
    ...
    @property
    def fe_substructure_node(self) -> '_2099.FESubstructureNode':
        ...
        return constructor.new(_2099.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode else None
