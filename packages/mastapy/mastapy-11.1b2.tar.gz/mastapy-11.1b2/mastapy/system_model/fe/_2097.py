...
from mastapy.system_model.fe import (
    _2077, _2102, _2125, _2071,
    _2073, _2098, _2123, _2099,
    _2095, _2109, _2110, _2108,
    _2105, _2106, _2107
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2163, _2159, _2167
...
from mastapy.system_model import _1938
...
from mastapy.system_model.fe.links import _2132
...
class FESubstructure(_62.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2077.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2077.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2077.BearingNodeAlignmentOption'):
    ...
    def geometry_meshing_material(self, value: 'str'):
        self.wrapped.GeometryMeshingMaterial.SetSelectedItem(str(value) if value else None)
    ...
    @property
    def alignment_method(self) -> '_2071.AlignmentMethod':
        ...
        return constructor.new(_2071.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2071.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def gravity_force_source(self) -> '_66.GravityForceSource':
        ...
        return constructor.new(_66.GravityForceSource)(value) if value else None
    ...
    def fe_meshing_options(self) -> '_80.ShaftFEMeshingOptions':
        ...
        return constructor.new(_80.ShaftFEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None
    ...
    def cms_model(self) -> '_199.CMSModel':
        ...
        return constructor.new(_199.CMSModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None
    ...
    def geometry_modeller_dimensions(self) -> '_146.GeometryModellerDimensions':
        ...
        return constructor.new(_146.GeometryModellerDimensions)(self.wrapped.GeometryModellerDimensions) if self.wrapped.GeometryModellerDimensions else None

    @property
    def alignment_to_component(self) -> '_1938.RelativeComponentAlignment[_2159.Component]':
        ...
        return constructor.new(_1938.RelativeComponentAlignment)[_2159.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2073.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2073.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1281.CoordinateSystem3D':
        ...
        return constructor.new(_1281.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_2098.FESubstructureExportOptions':
        ...
        return constructor.new(_2098.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    def acoustic_radiation_efficiency(self) -> '_209.AcousticRadiationEfficiency':
        ...
        return constructor.new(_209.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None
    ...
    def sound_pressure_enclosure(self) -> '_251.SoundPressureEnclosure':
        ...
        return constructor.new(_251.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2123.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2123.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2196.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2196.Shaft))
        return value

    @property
    def links(self) -> 'List[_2132.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2132.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1347.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1347.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1347.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1347.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2095.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2095.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2109.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2109.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2110.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2110.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2167.FEPart':
        ...
        return constructor.new(_2167.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart else None

    def import_fe_mesh(self, file_path: 'str', format_: '_152.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7248.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2099.FESubstructureNode') -> 'List[_2132.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2132.FELink))
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7248.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2108.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2105.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2106.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2107.FESubstructureWithSelectionForModalAnalysis':
