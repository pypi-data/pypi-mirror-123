...
class ShaftCompoundModalAnalysis(_4947.AbstractShaftCompoundModalAnalysis):
    '''ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4895.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4895.ShaftModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4895.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4895.ShaftModalAnalysis))
        return value
