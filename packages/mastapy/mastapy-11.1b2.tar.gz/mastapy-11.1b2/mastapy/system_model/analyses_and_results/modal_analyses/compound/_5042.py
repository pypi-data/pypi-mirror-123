...
from mastapy.system_model.analyses_and_results.modal_analyses import _4894
...
class ShaftHubConnectionCompoundModalAnalysis(_4982.ConnectorCompoundModalAnalysis):
    '''ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4894.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4894.ShaftHubConnectionModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4894.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4894.ShaftHubConnectionModalAnalysis))
        return value
