...
from mastapy.system_model.analyses_and_results.modal_analyses import _2348, _4800
...
class RootAssemblyModalAnalysis(_4800.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2348.ModalAnalysis':
        ...
        if _2348.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
