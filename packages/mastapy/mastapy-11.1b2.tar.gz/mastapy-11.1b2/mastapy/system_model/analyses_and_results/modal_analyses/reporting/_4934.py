...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4938
...
class CalculateFullFEResultsForMode(_0.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_4938.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_4938.ModalCMSResultsForModeAndFE))
        return value
