...
class RollingRingCompoundModalAnalysis(_4985.CouplingHalfCompoundModalAnalysis):
    '''RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4892.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4892.RollingRingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4892.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4892.RollingRingModalAnalysis))
        return value
