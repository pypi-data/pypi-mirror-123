...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5023
...
class PlanetCarrierCompoundModalAnalysis(_5023.MountableComponentCompoundModalAnalysis):
    '''PlanetCarrierCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4884.PlanetCarrierModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4884.PlanetCarrierModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4884.PlanetCarrierModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4884.PlanetCarrierModalAnalysis))
        return value
