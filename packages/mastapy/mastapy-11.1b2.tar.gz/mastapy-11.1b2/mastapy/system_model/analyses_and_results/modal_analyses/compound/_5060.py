...
class SynchroniserHalfCompoundModalAnalysis(_5061.SynchroniserPartCompoundModalAnalysis):
    '''SynchroniserHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4913.SynchroniserHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4913.SynchroniserHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4913.SynchroniserHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4913.SynchroniserHalfModalAnalysis))
        return value
