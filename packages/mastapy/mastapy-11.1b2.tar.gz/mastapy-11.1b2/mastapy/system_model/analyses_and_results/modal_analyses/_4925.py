...
TMeasurement = TypeVar('TMeasurement', bound='_1382.MeasurementBase')


class WhineWaterfallReferenceValues(_4926.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
