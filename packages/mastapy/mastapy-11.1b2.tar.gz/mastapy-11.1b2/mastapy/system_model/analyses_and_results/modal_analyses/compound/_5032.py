...
class PointLoadCompoundModalAnalysis(_5068.VirtualComponentCompoundModalAnalysis):
    '''PointLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4885.PointLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4885.PointLoadModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4885.PointLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4885.PointLoadModalAnalysis))
        return value
