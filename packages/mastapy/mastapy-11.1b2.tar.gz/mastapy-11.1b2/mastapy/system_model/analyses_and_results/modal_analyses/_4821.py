...
class ConceptCouplingModalAnalysis(_4833.CouplingModalAnalysis):
    '''ConceptCouplingModalAnalysis
    ...
    def system_deflection_results(self) -> '_2427.ConceptCouplingSystemDeflection':
        ...
        return constructor.new(_2427.ConceptCouplingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
