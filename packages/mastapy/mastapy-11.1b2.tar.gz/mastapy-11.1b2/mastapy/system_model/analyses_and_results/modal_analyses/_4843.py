...
from mastapy.system_model.analyses_and_results.modal_analyses import _4842, _4841, _4855
...
class CylindricalGearSetModalAnalysis(_4855.GearSetModalAnalysis):
    '''CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4842.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysis, constructor.new(_4842.CylindricalGearModalAnalysis))
        return value

    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4841.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysis, constructor.new(_4841.CylindricalGearMeshModalAnalysis))
        return value
