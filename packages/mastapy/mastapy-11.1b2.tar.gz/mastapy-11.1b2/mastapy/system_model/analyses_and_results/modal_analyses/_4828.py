...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4944
...
class ConnectionModalAnalysis(_7231.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2435.ConnectionSystemDeflection':
        ...
        if _2435.ConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_abstract_shaft_to_mountable_component_connection_system_deflection(self) -> '_2401.AbstractShaftToMountableComponentConnectionSystemDeflection':
        ...
        if _2401.AbstractShaftToMountableComponentConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_coaxial_connection_system_deflection(self) -> '_2422.CoaxialConnectionSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_cycloidal_disc_central_bearing_connection_system_deflection(self) -> '_2444.CycloidalDiscCentralBearingConnectionSystemDeflection':
        ...
        if _2444.CycloidalDiscCentralBearingConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cycloidal_disc_planetary_bearing_connection_system_deflection(self) -> '_2445.CycloidalDiscPlanetaryBearingConnectionSystemDeflection':
        ...
        if _2445.CycloidalDiscPlanetaryBearingConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_inter_mountable_component_connection_system_deflection(self) -> '_2475.InterMountableComponentConnectionSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_planetary_connection_system_deflection(self) -> '_2497.PlanetaryConnectionSystemDeflection':
        ...
        if _2497.PlanetaryConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_shaft_to_mountable_component_connection_system_deflection(self) -> '_2513.ShaftToMountableComponentConnectionSystemDeflection':
        ...
        if _2513.ShaftToMountableComponentConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
