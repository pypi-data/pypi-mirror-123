...
class FlexiblePinAnalysisConceptLevel(_5958.FlexiblePinAnalysis):
    ...
    def flexible_pin_nominal_load_case(self) -> '_2466.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2466.FlexiblePinAssemblySystemDeflection)(self.wrapped.FlexiblePinNominalLoadCase) if self.wrapped.FlexiblePinNominalLoadCase else None
    ...
    def flexible_pin_extreme_load_case(self) -> '_2466.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2466.FlexiblePinAssemblySystemDeflection)(self.wrapped.FlexiblePinExtremeLoadCase) if self.wrapped.FlexiblePinExtremeLoadCase else None
