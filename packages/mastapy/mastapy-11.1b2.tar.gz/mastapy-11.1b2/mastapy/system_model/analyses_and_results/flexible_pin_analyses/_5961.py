...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2608, _2644, _2567
...
class FlexiblePinAnalysisGearAndBearingRating(_5958.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2608.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2608.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2567.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2567.BearingCompoundSystemDeflection))
        return value
