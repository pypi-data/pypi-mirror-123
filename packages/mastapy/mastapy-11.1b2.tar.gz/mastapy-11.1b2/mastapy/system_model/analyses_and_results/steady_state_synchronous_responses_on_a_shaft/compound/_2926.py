...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft(_2837.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2799.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2799.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2799.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2799.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft))
        return value
