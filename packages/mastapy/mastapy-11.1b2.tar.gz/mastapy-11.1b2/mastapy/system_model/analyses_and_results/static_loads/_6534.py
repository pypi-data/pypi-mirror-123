...
class ConicalGearSetHarmonicLoadData(_6582.GearSetHarmonicLoadData):
    '''ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_314.TESpecificationType':
        ...
        return constructor.new(_314.TESpecificationType)(value) if value else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_314.TESpecificationType'):
