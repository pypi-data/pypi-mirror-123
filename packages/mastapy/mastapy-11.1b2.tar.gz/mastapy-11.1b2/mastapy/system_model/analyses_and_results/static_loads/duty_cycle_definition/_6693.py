...
class TimeSeriesImporter(_0.APIBase):
    ...
    def import_type(self) -> '_6598.ImportType':
        ...
        return constructor.new(_6598.ImportType)(value) if value else None
    ...
    def time_step_input(self) -> '_6694.TimeStepInputOptions':
        ...
        return constructor.new(_6694.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None
    ...
    def gear_ratio_options(self) -> '_6685.GearRatioInputOptions':
        ...
        return constructor.new(_6685.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None
    ...
    def design_state_options(self) -> '_6682.DesignStateOptions':
        ...
        return constructor.new(_6682.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None
    ...
    def load_case_name_inputs(self) -> '_6686.LoadCaseNameOptions':
        ...
        return constructor.new(_6686.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None
