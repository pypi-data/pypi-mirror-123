...
class RootAssemblyLoadCase(_6506.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    def assembly_design(self) -> '_2188.RootAssembly':
        ...
        return constructor.new(_2188.RootAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    def brake_force_input_values(self) -> '_90.ForceInputComponent':
        ...
        return constructor.new(_90.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None
    ...
    def road_incline_input_values(self) -> '_89.AngleInputComponent':
        ...
        return constructor.new(_89.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1357.PIDControlSettings':
        ...
        return constructor.new(_1357.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None
    ...
    def target_vehicle_speed(self) -> '_94.VelocityInputComponent':
        ...
        return constructor.new(_94.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None

    @property
    def load_case(self) -> '_6492.StaticLoadCase':
        ...
        if _6492.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6552.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6552.CylindricalGearSetLoadCase))
        return value
