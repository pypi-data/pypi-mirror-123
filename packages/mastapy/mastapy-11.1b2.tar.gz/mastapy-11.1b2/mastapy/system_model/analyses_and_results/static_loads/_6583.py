...
class GearSetLoadCase(_6643.SpecialisedAssemblyLoadCase):
    ...
    def gear_mesh_stiffness_model(self) -> '_5137.GearMeshStiffnessModel':
        ...
        return constructor.new(_5137.GearMeshStiffnessModel)(value) if value else None
    ...
    def mesh_stiffness_source(self) -> 'overridable.Overridable_MeshStiffnessSource':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.MeshStiffnessSource, value) if self.wrapped.MeshStiffnessSource else None
    ...
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6703.AdvancedTimeSteppingAnalysisForModulationOptions':
        ...
        return constructor.new(_6703.AdvancedTimeSteppingAnalysisForModulationOptions)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions else None
