...
from mastapy.system_model import _1923
...
class ConceptCouplingLoadCase(_6540.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1923.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1923.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1923.ConceptCouplingSpeedRatioSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpeedRatioSpecificationMethod = value

    @property
    def speed_ratio_vs_time(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.SpeedRatioVsTime) if self.wrapped.SpeedRatioVsTime else None
    ...
    def assembly_design(self) -> '_2294.ConceptCoupling':
        ...
        return constructor.new(_2294.ConceptCoupling)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def speed_ratio_pid_control(self) -> '_1357.PIDControlSettings':
        ...
        return constructor.new(_1357.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
