...
from mastapy.system_model.analyses_and_results.static_loads import _6628, _6673
...
class PointLoadLoadCase(_6673.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    def component_design(self) -> '_2185.PointLoad':
        ...
        return constructor.new(_2185.PointLoad)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    def force_x(self) -> '_90.ForceInputComponent':
        ...
        return constructor.new(_90.ForceInputComponent)(self.wrapped.ForceX) if self.wrapped.ForceX else None
    ...
    def force_y(self) -> '_90.ForceInputComponent':
        ...
        return constructor.new(_90.ForceInputComponent)(self.wrapped.ForceY) if self.wrapped.ForceY else None
    ...
    def axial_load(self) -> '_90.ForceInputComponent':
        ...
        return constructor.new(_90.ForceInputComponent)(self.wrapped.AxialLoad) if self.wrapped.AxialLoad else None
    ...
    def moment_x(self) -> '_91.MomentInputComponent':
        ...
        return constructor.new(_91.MomentInputComponent)(self.wrapped.MomentX) if self.wrapped.MomentX else None
    ...
    def moment_y(self) -> '_91.MomentInputComponent':
        ...
        return constructor.new(_91.MomentInputComponent)(self.wrapped.MomentY) if self.wrapped.MomentY else None
    ...
    def moment_z(self) -> '_91.MomentInputComponent':
        ...
        return constructor.new(_91.MomentInputComponent)(self.wrapped.MomentZ) if self.wrapped.MomentZ else None

    def get_harmonic_load_data_for_import(self) -> '_6628.PointLoadHarmonicLoadData':
