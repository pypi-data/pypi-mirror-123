...
class PlanetaryGearSetLoadCase(_6552.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1369.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1369.LoadCaseOverrideOption'):
    ...
    def assembly_design(self) -> '_2255.PlanetaryGearSet':
        ...
        return constructor.new(_2255.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
