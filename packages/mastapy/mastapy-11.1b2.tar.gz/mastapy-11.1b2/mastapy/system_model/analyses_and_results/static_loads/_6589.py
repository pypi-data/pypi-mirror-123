...
from mastapy.system_model.analyses_and_results.static_loads import _6600, _6587, _6567
...
class HarmonicLoadDataFluxImport(_6587.HarmonicLoadDataCSVImport['_6567.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6600.InnerDiameterReference':
        ...
        return constructor.new(_6600.InnerDiameterReference)(value) if value else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6600.InnerDiameterReference'):
