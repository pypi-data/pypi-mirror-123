...
from mastapy.system_model.analyses_and_results import _2370
...
class PartLoadCase(_2370.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6492.StaticLoadCase':
        ...
        if _6492.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    def get_harmonic_load_data_for_import(self) -> '_6586.HarmonicLoadDataBase':
