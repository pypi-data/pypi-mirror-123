...
from mastapy.system_model.analyses_and_results.static_loads import _6543, _6509
...
class CVTLoadCase(_6509.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6543.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6543.CVTPulleyLoadCase))
        return value
