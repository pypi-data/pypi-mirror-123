...
class ConicalGearManufactureError(_6579.GearManufactureError):
    '''ConicalGearManufactureError
    ...
    @property
    def pitch_errors_concave_flank(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'PitchErrorsConcaveFlank' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.PitchErrorsConcaveFlank) if self.wrapped.PitchErrorsConcaveFlank else None

    @pitch_errors_concave_flank.setter
    def pitch_errors_concave_flank(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.PitchErrorsConcaveFlank = value

    @property
    def pitch_errors_convex_flank(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'PitchErrorsConvexFlank' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.PitchErrorsConvexFlank) if self.wrapped.PitchErrorsConvexFlank else None

    @pitch_errors_convex_flank.setter
    def pitch_errors_convex_flank(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
