...
from mastapy.system_model.analyses_and_results.static_loads import _6551, _6580
...
class CylindricalGearMeshLoadCase(_6580.GearMeshLoadCase):
    '''CylindricalGearMeshLoadCase
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents(self) -> '_552.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_552.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents else None
