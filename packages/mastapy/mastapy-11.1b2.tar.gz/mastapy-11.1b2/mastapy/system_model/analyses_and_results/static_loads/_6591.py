...
from mastapy.system_model.analyses_and_results.static_loads import _6594, _6590, _6568
...
T = TypeVar('T', bound='_6568.ElectricMachineHarmonicLoadImportOptionsBase')


class HarmonicLoadDataImportFromMotorPackages(_6590.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
