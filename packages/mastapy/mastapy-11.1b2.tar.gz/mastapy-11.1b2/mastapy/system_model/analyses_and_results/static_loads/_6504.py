...
from mastapy.bearings.tolerances import _1648
...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    def roundness_specification(self) -> '_1648.RoundnessSpecification':
        ...
        return constructor.new(_1648.RoundnessSpecification)(self.wrapped.RoundnessSpecification) if self.wrapped.RoundnessSpecification else None

    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6633.RingPinManufacturingError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinManufacturingErrors, constructor.new(_6633.RingPinManufacturingError))
        return value
