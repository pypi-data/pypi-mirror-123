...
from mastapy.system_model.analyses_and_results.static_loads import _6532, _6578
...
class ConicalGearLoadCase(_6578.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6532.ConicalGearManufactureError':
        ...
        return constructor.new(_6532.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
