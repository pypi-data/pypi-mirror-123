...
class ModalAnalysisForHarmonicAnalysis(_2348.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5719.HarmonicAnalysisOptions':
        ...
        if _5719.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
