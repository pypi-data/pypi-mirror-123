...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5423, _5424, _5436
...
class CylindricalGearSetHarmonicAnalysisOfSingleExcitation(_5436.GearSetHarmonicAnalysisOfSingleExcitation):
    '''CylindricalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def cylindrical_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5423.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5423.CylindricalGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def cylindrical_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5424.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5424.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
