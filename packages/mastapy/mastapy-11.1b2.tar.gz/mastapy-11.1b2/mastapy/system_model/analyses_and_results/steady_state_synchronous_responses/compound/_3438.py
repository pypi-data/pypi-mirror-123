...
class ShaftHubConnectionCompoundSteadyStateSynchronousResponse(_3378.ConnectorCompoundSteadyStateSynchronousResponse):
    '''ShaftHubConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3305.ShaftHubConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3305.ShaftHubConnectionSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3305.ShaftHubConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3305.ShaftHubConnectionSteadyStateSynchronousResponse))
        return value
