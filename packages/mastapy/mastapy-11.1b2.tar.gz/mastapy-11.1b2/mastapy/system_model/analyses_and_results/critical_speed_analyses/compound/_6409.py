...
class CylindricalGearCompoundCriticalSpeedAnalysis(_6420.GearCompoundCriticalSpeedAnalysis):
    '''CylindricalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6280.CylindricalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6280.CylindricalGearCriticalSpeedAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6280.CylindricalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6280.CylindricalGearCriticalSpeedAnalysis))
        return value
