...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6365
...
class CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis(_6365.AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6279.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6279.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6279.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6279.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis))
        return value
