...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6280, _6281, _6293
...
class CylindricalGearSetCriticalSpeedAnalysis(_6293.GearSetCriticalSpeedAnalysis):
    '''CylindricalGearSetCriticalSpeedAnalysis
    ...
    @property
    def cylindrical_gears_critical_speed_analysis(self) -> 'List[_6280.CylindricalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCriticalSpeedAnalysis, constructor.new(_6280.CylindricalGearCriticalSpeedAnalysis))
        return value

    @property
    def cylindrical_meshes_critical_speed_analysis(self) -> 'List[_6281.CylindricalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCriticalSpeedAnalysis, constructor.new(_6281.CylindricalGearMeshCriticalSpeedAnalysis))
        return value
