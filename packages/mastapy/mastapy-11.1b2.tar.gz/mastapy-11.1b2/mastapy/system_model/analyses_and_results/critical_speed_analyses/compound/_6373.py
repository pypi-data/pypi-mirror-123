...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6378.BevelGearCompoundCriticalSpeedAnalysis):
    '''BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6242.BevelDifferentialGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6242.BevelDifferentialGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6242.BevelDifferentialGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6242.BevelDifferentialGearCriticalSpeedAnalysis))
        return value
