...
class BeltConnectionCompoundCriticalSpeedAnalysis(_6427.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    '''BeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6240.BeltConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6240.BeltConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6240.BeltConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6240.BeltConnectionCriticalSpeedAnalysis))
        return value
