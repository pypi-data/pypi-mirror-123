...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(_6427.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    '''RollingRingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6325.RollingRingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6325.RollingRingConnectionCriticalSpeedAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6325.RollingRingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6325.RollingRingConnectionCriticalSpeedAnalysis))
        return value
