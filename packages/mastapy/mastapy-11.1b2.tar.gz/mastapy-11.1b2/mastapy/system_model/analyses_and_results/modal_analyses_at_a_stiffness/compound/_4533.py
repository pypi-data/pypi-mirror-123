...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4423.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    '''ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4403.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4403.ZerolBevelGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4403.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4403.ZerolBevelGearMeshModalAnalysisAtAStiffness))
        return value
