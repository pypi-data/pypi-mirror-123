...
class StraightBevelGearAdvancedSystemDeflection(_6979.BevelGearAdvancedSystemDeflection):
    '''StraightBevelGearAdvancedSystemDeflection
    ...
    def component_load_case(self) -> '_6654.StraightBevelGearLoadCase':
        ...
        return constructor.new(_6654.StraightBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_365.StraightBevelGearRating':
        ...
        return constructor.new(_365.StraightBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2526.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2526.StraightBevelGearSystemDeflection))
        return value
