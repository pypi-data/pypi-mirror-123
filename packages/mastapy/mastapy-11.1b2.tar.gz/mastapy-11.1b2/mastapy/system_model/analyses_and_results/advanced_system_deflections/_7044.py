...
class OilSealAdvancedSystemDeflection(_6999.ConnectorAdvancedSystemDeflection):
    '''OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2492.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2492.OilSealSystemDeflection))
        return value
