...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7071, _7072, _6981
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_6981.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_7071.StraightBevelDiffGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsAdvancedSystemDeflection, constructor.new(_7071.StraightBevelDiffGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_7072.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesAdvancedSystemDeflection, constructor.new(_7072.StraightBevelDiffGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2522.StraightBevelDiffGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2522.StraightBevelDiffGearSetSystemDeflection))
        return value
