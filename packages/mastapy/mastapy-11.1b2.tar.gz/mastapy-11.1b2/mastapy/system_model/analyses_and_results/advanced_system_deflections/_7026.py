...
class GuideDxfModelAdvancedSystemDeflection(_6988.ComponentAdvancedSystemDeflection):
    '''GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2470.GuideDxfModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2470.GuideDxfModelSystemDeflection))
        return value
