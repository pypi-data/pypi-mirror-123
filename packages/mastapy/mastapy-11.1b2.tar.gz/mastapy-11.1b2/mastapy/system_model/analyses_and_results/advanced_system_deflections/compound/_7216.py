...
class TorqueConverterTurbineCompoundAdvancedSystemDeflection(_7135.CouplingHalfCompoundAdvancedSystemDeflection):
    '''TorqueConverterTurbineCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7086.TorqueConverterTurbineAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7086.TorqueConverterTurbineAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7086.TorqueConverterTurbineAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7086.TorqueConverterTurbineAdvancedSystemDeflection))
        return value
