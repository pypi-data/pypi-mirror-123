...
from mastapy.gears.gear_designs.cylindrical import _959, _952
from mastapy.gears.ltca.cylindrical import _802
...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7011, _7000, _7024
...
class CylindricalGearMeshAdvancedSystemDeflection(_7024.GearMeshAdvancedSystemDeflection):
    '''CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def inactive_flank(self) -> '_288.CylindricalFlanks':
    ...
    @property
    def gear_mesh_design(self) -> '_959.CylindricalGearMeshDesign':
        ...
        return constructor.new(_959.CylindricalGearMeshDesign)(self.wrapped.GearMeshDesign) if self.wrapped.GearMeshDesign else None

    @property
    def point_with_maximum_contact_pressure(self) -> '_802.CylindricalGearMeshLoadedContactPoint':
        ...
        return constructor.new(_802.CylindricalGearMeshLoadedContactPoint)(self.wrapped.PointWithMaximumContactPressure) if self.wrapped.PointWithMaximumContactPressure else None

    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_1296.FourierSeries':
        ...
        return constructor.new(_1296.FourierSeries)(self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod) if self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod else None
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2448.CylindricalGearMeshSystemDeflectionTimestep]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshSystemDeflectionResults, constructor.new(_2448.CylindricalGearMeshSystemDeflectionTimestep))
        return value

    @property
    def gear_designs(self) -> 'List[_952.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDesigns, constructor.new(_952.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_7011.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedAnalyses, constructor.new(_7011.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_7000.ContactChartPerToothPass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MaxPressureContactChartForEachToothPassForGearA, constructor.new(_7000.ContactChartPerToothPass))
        return value
