...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7099
...
class CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection(_7099.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7010.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7010.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_7010.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7010.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection))
        return value
