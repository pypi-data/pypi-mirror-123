...
class ZerolBevelGearAdvancedSystemDeflection(_6979.BevelGearAdvancedSystemDeflection):
    '''ZerolBevelGearAdvancedSystemDeflection
    ...
    def component_load_case(self) -> '_6677.ZerolBevelGearLoadCase':
        ...
        return constructor.new(_6677.ZerolBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    def component_detailed_analysis(self) -> '_335.ZerolBevelGearRating':
        ...
        return constructor.new(_335.ZerolBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2549.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2549.ZerolBevelGearSystemDeflection))
        return value
