...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_7003.CouplingHalfAdvancedSystemDeflection):
    '''PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2495.PartToPartShearCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2495.PartToPartShearCouplingHalfSystemDeflection))
        return value
