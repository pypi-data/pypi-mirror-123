...
class GearMeshAdvancedSystemDeflection(_7030.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''GearMeshAdvancedSystemDeflection
    ...
    @property
    def misalignment_fourier_series_for_first_tooth_passing_period(self) -> '_1296.FourierSeries':
        ...
        return constructor.new(_1296.FourierSeries)(self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod) if self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod else None
