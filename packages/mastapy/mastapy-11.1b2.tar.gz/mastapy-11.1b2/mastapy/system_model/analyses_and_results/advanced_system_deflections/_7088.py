...
class UnbalancedMassAdvancedSystemDeflection(_7089.VirtualComponentAdvancedSystemDeflection):
    '''UnbalancedMassAdvancedSystemDeflection
    ...
    def component_load_case(self) -> '_6672.UnbalancedMassLoadCase':
        ...
        return constructor.new(_6672.UnbalancedMassLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2542.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2542.UnbalancedMassSystemDeflection))
        return value
