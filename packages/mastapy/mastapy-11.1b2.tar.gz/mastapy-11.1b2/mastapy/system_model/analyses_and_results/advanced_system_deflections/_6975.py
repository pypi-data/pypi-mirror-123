...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_6980.BevelGearMeshAdvancedSystemDeflection):
    '''BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2409.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2409.BevelDifferentialGearMeshSystemDeflection))
        return value
