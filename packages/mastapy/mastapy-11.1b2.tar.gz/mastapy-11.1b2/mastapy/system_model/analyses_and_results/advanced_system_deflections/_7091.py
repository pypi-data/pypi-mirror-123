...
class WormGearMeshAdvancedSystemDeflection(_7024.GearMeshAdvancedSystemDeflection):
    '''WormGearMeshAdvancedSystemDeflection
    ...
    def connection_load_case(self) -> '_6675.WormGearMeshLoadCase':
        ...
        return constructor.new(_6675.WormGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2544.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2544.WormGearMeshSystemDeflection))
        return value
