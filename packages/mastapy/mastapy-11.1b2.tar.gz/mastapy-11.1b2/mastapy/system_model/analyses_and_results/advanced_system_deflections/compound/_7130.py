...
class ConicalGearSetCompoundAdvancedSystemDeflection(_7156.GearSetCompoundAdvancedSystemDeflection):
    ...
    def gear_duty_cycle_rating(self) -> '_495.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_495.ConicalGearSetDutyCycleRating)(self.wrapped.GearDutyCycleRating) if self.wrapped.GearDutyCycleRating else None
    ...
    def conical_gear_duty_cycle_rating(self) -> '_495.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_495.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
