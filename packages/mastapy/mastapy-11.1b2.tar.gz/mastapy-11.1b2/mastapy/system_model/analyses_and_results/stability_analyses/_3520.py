...
from mastapy.system_model.analyses_and_results.stability_analyses import _3521, _3519, _3531
...
class CylindricalGearSetStabilityAnalysis(_3531.GearSetStabilityAnalysis):
    '''CylindricalGearSetStabilityAnalysis
    ...
    @property
    def cylindrical_gears_stability_analysis(self) -> 'List[_3521.CylindricalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsStabilityAnalysis, constructor.new(_3521.CylindricalGearStabilityAnalysis))
        return value

    @property
    def cylindrical_meshes_stability_analysis(self) -> 'List[_3519.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesStabilityAnalysis, constructor.new(_3519.CylindricalGearMeshStabilityAnalysis))
        return value
