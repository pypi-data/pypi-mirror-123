...
class TorqueConverterCompoundStabilityAnalysis(_3640.CouplingCompoundStabilityAnalysis):
    '''TorqueConverterCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3593.TorqueConverterStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3593.TorqueConverterStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3593.TorqueConverterStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3593.TorqueConverterStabilityAnalysis))
        return value
