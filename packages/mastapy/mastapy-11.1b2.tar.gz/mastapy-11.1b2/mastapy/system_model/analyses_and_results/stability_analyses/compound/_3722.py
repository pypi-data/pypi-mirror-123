...
class TorqueConverterPumpCompoundStabilityAnalysis(_3642.CouplingHalfCompoundStabilityAnalysis):
    '''TorqueConverterPumpCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3592.TorqueConverterPumpStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3592.TorqueConverterPumpStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3592.TorqueConverterPumpStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3592.TorqueConverterPumpStabilityAnalysis))
        return value
