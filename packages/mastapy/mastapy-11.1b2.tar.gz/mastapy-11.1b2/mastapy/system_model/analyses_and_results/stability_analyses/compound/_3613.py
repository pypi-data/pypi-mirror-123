...
class BeltDriveCompoundStabilityAnalysis(_3701.SpecialisedAssemblyCompoundStabilityAnalysis):
    '''BeltDriveCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3481.BeltDriveStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3481.BeltDriveStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3481.BeltDriveStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3481.BeltDriveStabilityAnalysis))
        return value
