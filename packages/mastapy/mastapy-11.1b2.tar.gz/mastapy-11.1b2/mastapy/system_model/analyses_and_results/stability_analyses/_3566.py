...
from mastapy.system_model.analyses_and_results.stability_analyses import _2355, _3478
...
class RootAssemblyStabilityAnalysis(_3478.AssemblyStabilityAnalysis):
    '''RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2355.StabilityAnalysis':
        ...
        return constructor.new(_2355.StabilityAnalysis)(self.wrapped.StabilityAnalysisInputs) if self.wrapped.StabilityAnalysisInputs else None
