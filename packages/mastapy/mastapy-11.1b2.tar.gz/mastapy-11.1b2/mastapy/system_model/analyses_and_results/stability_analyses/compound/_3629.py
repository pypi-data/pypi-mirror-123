...
class ConceptCouplingCompoundStabilityAnalysis(_3640.CouplingCompoundStabilityAnalysis):
    '''ConceptCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3499.ConceptCouplingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3499.ConceptCouplingStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3499.ConceptCouplingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3499.ConceptCouplingStabilityAnalysis))
        return value
