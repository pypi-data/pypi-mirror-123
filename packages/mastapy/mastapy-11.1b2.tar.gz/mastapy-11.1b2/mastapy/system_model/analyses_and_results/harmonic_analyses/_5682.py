...
class CycloidalDiscHarmonicAnalysis(_5637.AbstractShaftHarmonicAnalysis):
    '''CycloidalDiscHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2446.CycloidalDiscSystemDeflection':
        ...
        return constructor.new(_2446.CycloidalDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
