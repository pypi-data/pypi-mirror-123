...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    def selected_result_location_group(self) -> '_5800.ResultLocationSelectionGroup':
        ...
        return constructor.new(_5800.ResultLocationSelectionGroup)(self.wrapped.SelectedResultLocationGroup) if self.wrapped.SelectedResultLocationGroup else None
