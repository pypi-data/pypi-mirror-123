...
class BoltHarmonicAnalysis(_5662.ComponentHarmonicAnalysis):
    '''BoltHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2418.BoltSystemDeflection':
        ...
        return constructor.new(_2418.BoltSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
