...
class FaceGearMeshCompoundHarmonicAnalysis(_5887.GearMeshCompoundHarmonicAnalysis):
    '''FaceGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5703.FaceGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5703.FaceGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5703.FaceGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5703.FaceGearMeshHarmonicAnalysis))
        return value
