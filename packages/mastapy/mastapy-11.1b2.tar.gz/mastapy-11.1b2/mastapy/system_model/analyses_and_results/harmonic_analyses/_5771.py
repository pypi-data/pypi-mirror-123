...
class StraightBevelGearHarmonicAnalysis(_5652.BevelGearHarmonicAnalysis):
    '''StraightBevelGearHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2526.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2526.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
