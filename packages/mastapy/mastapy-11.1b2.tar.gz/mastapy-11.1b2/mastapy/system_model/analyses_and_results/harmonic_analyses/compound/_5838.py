...
class BeltDriveCompoundHarmonicAnalysis(_5926.SpecialisedAssemblyCompoundHarmonicAnalysis):
    '''BeltDriveCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5646.BeltDriveHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5646.BeltDriveHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5646.BeltDriveHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5646.BeltDriveHarmonicAnalysis))
        return value
