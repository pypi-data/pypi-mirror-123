...
class ConceptCouplingConnectionHarmonicAnalysis(_5674.CouplingConnectionHarmonicAnalysis):
    '''ConceptCouplingConnectionHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2425.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2425.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
