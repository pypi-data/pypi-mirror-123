...
from mastapy.system_model.analyses_and_results import _2367
...
class HarmonicAnalysisFEExportOptions(_5717.HarmonicAnalysisExportOptions['_2367.IHaveFEPartHarmonicAnalysisResults', '_2167.FEPart']):
    '''HarmonicAnalysisFEExportOptions
    ...
    @property
    def analysis_options(self) -> '_5719.HarmonicAnalysisOptions':
        ...
        if _5719.HarmonicAnalysisOptions.TYPE not in self.wrapped.AnalysisOptions.__class__.__mro__:
    ...
    def eigenvalue_options(self) -> '_154.EigenvalueOptions':
        ...
        return constructor.new(_154.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None
