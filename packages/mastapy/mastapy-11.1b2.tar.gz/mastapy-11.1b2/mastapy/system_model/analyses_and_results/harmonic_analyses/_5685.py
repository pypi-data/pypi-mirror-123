...
class CylindricalGearMeshHarmonicAnalysis(_5710.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7012.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2447.CylindricalGearMeshSystemDeflection':
