...
class RollingRingConnectionCompoundHarmonicAnalysis(_5893.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''RollingRingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5753.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5753.RollingRingConnectionHarmonicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5753.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5753.RollingRingConnectionHarmonicAnalysis))
        return value
