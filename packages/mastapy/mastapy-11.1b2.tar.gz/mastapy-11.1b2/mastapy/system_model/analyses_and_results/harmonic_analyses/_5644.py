...
class BearingHarmonicAnalysis(_5673.ConnectorHarmonicAnalysis):
    ...
    def rolling_bearing_speed_results(self) -> '_1795.RollingBearingSpeedResults':
        ...
        return constructor.new(_1795.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults else None
    ...
    def system_deflection_results(self) -> '_2406.BearingSystemDeflection':
        ...
        return constructor.new(_2406.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
