...
class ClutchHarmonicAnalysis(_5676.CouplingHarmonicAnalysis):
    '''ClutchHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2421.ClutchSystemDeflection':
        ...
        return constructor.new(_2421.ClutchSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
