...
class ConceptGearMeshHarmonicAnalysis(_5710.GearMeshHarmonicAnalysis):
    '''ConceptGearMeshHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2428.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2428.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
