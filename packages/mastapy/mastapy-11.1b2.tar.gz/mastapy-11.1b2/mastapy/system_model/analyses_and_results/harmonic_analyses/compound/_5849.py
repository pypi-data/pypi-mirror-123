...
class ClutchCompoundHarmonicAnalysis(_5865.CouplingCompoundHarmonicAnalysis):
    '''ClutchCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5659.ClutchHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5659.ClutchHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5659.ClutchHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5659.ClutchHarmonicAnalysis))
        return value
