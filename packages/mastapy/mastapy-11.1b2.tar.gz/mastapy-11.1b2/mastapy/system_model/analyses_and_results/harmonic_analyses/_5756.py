...
class ShaftHarmonicAnalysis(_5637.AbstractShaftHarmonicAnalysis):
    ...
    def coupled_modal_analysis(self) -> '_4895.ShaftModalAnalysis':
        ...
        return constructor.new(_4895.ShaftModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis else None
    ...
    def export(self) -> '_5721.HarmonicAnalysisShaftExportOptions':
        ...
        return constructor.new(_5721.HarmonicAnalysisShaftExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    def system_deflection_results(self) -> '_2512.ShaftSystemDeflection':
        ...
        return constructor.new(_2512.ShaftSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
