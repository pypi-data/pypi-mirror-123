...
class KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis(_5727.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2479.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2479.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
