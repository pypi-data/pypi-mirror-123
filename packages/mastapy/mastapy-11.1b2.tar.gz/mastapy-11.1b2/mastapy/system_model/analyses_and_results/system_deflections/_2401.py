...
class AbstractShaftToMountableComponentConnectionSystemDeflection(_2435.ConnectionSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3741.AbstractShaftToMountableComponentConnectionPowerFlow':
