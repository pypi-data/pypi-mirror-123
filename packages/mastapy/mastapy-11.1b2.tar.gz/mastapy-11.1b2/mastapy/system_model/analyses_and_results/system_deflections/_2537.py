...
class TorqueConverterPumpSystemDeflection(_2438.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3861.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3861.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
