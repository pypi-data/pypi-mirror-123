...
from mastapy.gears.gear_designs.conical import _1091
...
class FaceGearMeshSystemDeflection(_2467.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    def connection_design(self) -> '_2026.FaceGearMesh':
        ...
        return constructor.new(_2026.FaceGearMesh)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None
    ...
    def connection_load_case(self) -> '_6573.FaceGearMeshLoadCase':
        ...
        return constructor.new(_6573.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3792.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3792.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_412.FaceGearMeshRating':
        ...
        return constructor.new(_412.FaceGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_412.FaceGearMeshRating':
        ...
        return constructor.new(_412.FaceGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
