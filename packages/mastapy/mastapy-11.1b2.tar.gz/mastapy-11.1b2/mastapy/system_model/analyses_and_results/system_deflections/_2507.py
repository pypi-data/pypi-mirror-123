...
class RollingRingSystemDeflection(_2438.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3834.RollingRingPowerFlow':
        ...
        return constructor.new(_3834.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
