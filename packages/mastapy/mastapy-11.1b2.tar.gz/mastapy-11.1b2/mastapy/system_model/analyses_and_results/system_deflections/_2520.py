...
class SpringDamperSystemDeflection(_2439.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3845.SpringDamperPowerFlow':
        ...
        return constructor.new(_3845.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
