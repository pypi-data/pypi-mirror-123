...
class ShaftSectionSystemDeflection(_121.Bar):
    ...
    @property
    def left_end(self) -> '_2510.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2510.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2510.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2510.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
