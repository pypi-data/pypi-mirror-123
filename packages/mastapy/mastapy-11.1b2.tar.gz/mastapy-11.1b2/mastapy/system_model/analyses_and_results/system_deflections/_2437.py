...
class CouplingConnectionSystemDeflection(_2475.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3775.CouplingConnectionPowerFlow':
