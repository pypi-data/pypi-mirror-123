...
class PlanetCarrierCompoundSystemDeflection(_2637.MountableComponentCompoundSystemDeflection):
    '''PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2498.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2498.PlanetCarrierSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2498.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2498.PlanetCarrierSystemDeflection))
        return value
