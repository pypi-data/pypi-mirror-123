...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2554
...
class PlanetCarrierSystemDeflection(_2490.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    def component_load_case(self) -> '_6626.PlanetCarrierLoadCase':
        ...
        return constructor.new(_6626.PlanetCarrierLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3824.PlanetCarrierPowerFlow':
        ...
        return constructor.new(_3824.PlanetCarrierPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def windup(self) -> 'List[_2554.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2554.PlanetCarrierWindup))
        return value
