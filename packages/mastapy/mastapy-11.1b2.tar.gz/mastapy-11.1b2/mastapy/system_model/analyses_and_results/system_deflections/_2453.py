...
from mastapy.system_model.analyses_and_results.power_flows import _3787, _3789
from mastapy.gears.rating.cylindrical import _422
from mastapy.gears.manufacturing.cylindrical import _571
from mastapy.system_model.analyses_and_results.system_deflections import _2457, _2469
...
class CylindricalGearSystemDeflection(_2469.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3787.CylindricalGearPowerFlow':
    ...
    @property
    def component_detailed_analysis(self) -> '_422.CylindricalGearRating':
        ...
        return constructor.new(_422.CylindricalGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def manufacturing_analysis(self) -> '_571.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_571.CylindricalManufacturedGearLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None
    ...
    @property
    def cylindrical_gear_system_deflections_in_meshes(self) -> 'List[_2457.CylindricalMeshedGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSystemDeflectionsInMeshes, constructor.new(_2457.CylindricalMeshedGearSystemDeflection))
        return value
