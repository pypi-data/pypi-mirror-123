...
from mastapy.system_model.analyses_and_results.system_deflections import _2494, _2439
...
class PartToPartShearCouplingSystemDeflection(_2439.CouplingSystemDeflection):
    '''PartToPartShearCouplingSystemDeflection
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2494.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2494.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
    ...
    def assembly_load_case(self) -> '_6622.PartToPartShearCouplingLoadCase':
        ...
        return constructor.new(_6622.PartToPartShearCouplingLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def power_flow_results(self) -> '_3821.PartToPartShearCouplingPowerFlow':
        ...
        return constructor.new(_3821.PartToPartShearCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
