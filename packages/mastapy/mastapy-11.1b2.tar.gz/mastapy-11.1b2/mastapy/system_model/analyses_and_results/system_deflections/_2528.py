...
class StraightBevelSunGearSystemDeflection(_2523.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3853.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3853.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
