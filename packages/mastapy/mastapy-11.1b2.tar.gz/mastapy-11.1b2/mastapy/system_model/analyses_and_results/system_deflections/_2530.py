...
from mastapy.system_model.analyses_and_results.power_flows import _3855, _3854, _3857
...
class SynchroniserPartSystemDeflection(_2438.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3855.SynchroniserPartPowerFlow':
