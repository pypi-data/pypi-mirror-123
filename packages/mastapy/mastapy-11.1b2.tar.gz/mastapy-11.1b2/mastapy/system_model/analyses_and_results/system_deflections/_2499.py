...
class PointLoadSystemDeflection(_2543.VirtualComponentSystemDeflection):
    '''PointLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3825.PointLoadPowerFlow':
        ...
        return constructor.new(_3825.PointLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
