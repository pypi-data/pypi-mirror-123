...
from mastapy.utility.enums import _1571
...
class ShaftSystemDeflectionSectionsReport(_1512.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1571.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1571.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1571.TableAndChartOptions'):
