...
class HypoidGearSystemDeflection(_2404.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3802.HypoidGearPowerFlow':
        ...
        return constructor.new(_3802.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
