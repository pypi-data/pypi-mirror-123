...
from mastapy.system_model.analyses_and_results.power_flows import _3748, _3779
from mastapy.system_model.analyses_and_results.system_deflections import _2407, _2514
...
class BeltDriveSystemDeflection(_2514.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3748.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2407.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2407.BeltConnectionSystemDeflection))
        return value
