...
from mastapy.system_model.analyses_and_results.system_deflections import _2485, _2535
from mastapy.system_model.fe import _2121
from mastapy.system_model.analyses_and_results.analysis_cases import _7234
...
class SystemDeflection(_7234.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2485.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2485.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2535.SystemDeflectionOptions':
        ...
        return constructor.new(_2535.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
