...
class WormGearMeshSystemDeflection(_2467.GearMeshSystemDeflection):
    '''WormGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3865.WormGearMeshPowerFlow':
        ...
        return constructor.new(_3865.WormGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
