...
class ConceptGearSystemDeflection(_2469.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    def component_load_case(self) -> '_6528.ConceptGearLoadCase':
        ...
        return constructor.new(_6528.ConceptGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3768.ConceptGearPowerFlow':
        ...
        return constructor.new(_3768.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def component_detailed_analysis(self) -> '_505.ConceptGearRating':
        ...
        return constructor.new(_505.ConceptGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
