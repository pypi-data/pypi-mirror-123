...
from mastapy.system_model.drawing import _1959
...
class ConcentricPartGroupCombinationSystemDeflectionResults(_0.APIBase):
    ...
    @property
    def shaft_deflections_in_view_coordinate_system(self) -> 'List[_1959.ConcentricPartGroupCombinationSystemDeflectionShaftResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionsInViewCoordinateSystem, constructor.new(_1959.ConcentricPartGroupCombinationSystemDeflectionShaftResults))
        return value
