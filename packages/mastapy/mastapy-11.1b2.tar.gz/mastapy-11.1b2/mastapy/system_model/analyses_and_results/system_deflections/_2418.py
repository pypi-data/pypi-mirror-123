...
class BoltSystemDeflection(_2423.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3758.BoltPowerFlow':
        ...
        return constructor.new(_3758.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
