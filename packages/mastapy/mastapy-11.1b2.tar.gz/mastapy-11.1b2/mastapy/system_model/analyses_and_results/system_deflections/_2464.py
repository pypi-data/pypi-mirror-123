...
class FaceGearSystemDeflection(_2469.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3793.FaceGearPowerFlow':
        ...
        return constructor.new(_3793.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
