...
class StraightBevelGearSystemDeflection(_2416.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3850.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3850.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
