...
class RollingRingConnectionCompoundSystemDeflection(_2625.InterMountableComponentConnectionCompoundSystemDeflection):
    '''RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2506.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2506.RollingRingConnectionSystemDeflection))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2506.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2506.RollingRingConnectionSystemDeflection))
        return value
