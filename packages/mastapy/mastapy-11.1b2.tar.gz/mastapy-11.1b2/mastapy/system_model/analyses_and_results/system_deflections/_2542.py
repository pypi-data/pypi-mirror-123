...
class UnbalancedMassSystemDeflection(_2543.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3863.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3863.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
