...
from mastapy.system_model.analyses_and_results.power_flows import _3805, _3808, _3811
...
class KlingelnbergCycloPalloidConicalGearMeshSystemDeflection(_2432.ConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3805.KlingelnbergCycloPalloidConicalGearMeshPowerFlow':
