...
class RingPinsSystemDeflection(_2490.MountableComponentSystemDeflection):
    '''RingPinsSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3830.RingPinsPowerFlow':
        ...
        return constructor.new(_3830.RingPinsPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
