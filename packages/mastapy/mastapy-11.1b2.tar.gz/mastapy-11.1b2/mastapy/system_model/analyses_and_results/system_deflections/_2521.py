...
class StraightBevelDiffGearMeshSystemDeflection(_2414.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6652.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_6652.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3846.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3846.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_360.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_360.StraightBevelDiffGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
