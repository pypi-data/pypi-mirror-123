...
class RollingRingAssemblySystemDeflection(_2514.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3832.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3832.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
