...
from mastapy.system_model.analyses_and_results.power_flows import _3762, _3782
...
class CoaxialConnectionSystemDeflection(_2513.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3762.CoaxialConnectionPowerFlow':
