...
class MeasurementComponentSystemDeflection(_2543.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3815.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3815.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
