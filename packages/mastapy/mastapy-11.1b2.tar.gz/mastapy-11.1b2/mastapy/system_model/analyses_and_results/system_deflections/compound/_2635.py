...
class MassDiscCompoundSystemDeflection(_2683.VirtualComponentCompoundSystemDeflection):
    '''MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2487.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2487.MassDiscSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2487.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2487.MassDiscSystemDeflection))
        return value
