...
class ConceptGearMeshSystemDeflection(_2467.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    def connection_load_case(self) -> '_6529.ConceptGearMeshLoadCase':
        ...
        return constructor.new(_6529.ConceptGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3767.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3767.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_504.ConceptGearMeshRating':
        ...
        return constructor.new(_504.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
    ...
    def component_detailed_analysis(self) -> '_504.ConceptGearMeshRating':
        ...
        return constructor.new(_504.ConceptGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
