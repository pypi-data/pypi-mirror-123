...
from mastapy.system_model.analyses_and_results import _2365
...
class RigidlyConnectedComponentGroupSystemDeflection(_2365.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1301.MassProperties':
        ...
        return constructor.new(_1301.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties else None

    @property
    def components(self) -> 'List[_2423.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2423.ComponentSystemDeflection))
        return value
