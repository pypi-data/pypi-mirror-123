...
from mastapy.system_model.analyses_and_results.power_flows import _3747, _3778
...
class BeltConnectionSystemDeflection(_2475.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3747.BeltConnectionPowerFlow':
