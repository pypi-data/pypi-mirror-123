...
from mastapy.gears.ltca.cylindrical import _803, _805
...
class CylindricalGearSetSystemDeflectionWithLTCAResults(_2450.CylindricalGearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflectionWithLTCAResults
    ...
    @property
    def basic_ltca_results(self) -> '_803.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _803.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResults.__class__.__mro__:
    ...
    @property
    def basic_ltca_results_only_first_planetary_mesh(self) -> '_803.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _803.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results(self) -> '_803.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _803.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResults.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results_only_first_planetary_mesh(self) -> '_803.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _803.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
