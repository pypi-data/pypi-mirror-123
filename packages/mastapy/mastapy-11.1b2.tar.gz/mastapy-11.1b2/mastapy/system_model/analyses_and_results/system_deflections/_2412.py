...
class BevelDifferentialPlanetGearSystemDeflection(_2411.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    def component_design(self) -> '_2230.BevelDifferentialPlanetGear':
        ...
        return constructor.new(_2230.BevelDifferentialPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def power_flow_results(self) -> '_3752.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3752.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
