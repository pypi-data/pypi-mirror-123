...
class MassDiscSystemDeflection(_2543.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3814.MassDiscPowerFlow':
        ...
        return constructor.new(_3814.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
