...
from mastapy.system_model.analyses_and_results.system_deflections import _2541, _2543
...
class PowerLoadSystemDeflection(_2543.VirtualComponentSystemDeflection):
    '''PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3828.PowerLoadPowerFlow':
        ...
        return constructor.new(_3828.PowerLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2541.TransmissionErrorResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_2541.TransmissionErrorResult))
        return value
