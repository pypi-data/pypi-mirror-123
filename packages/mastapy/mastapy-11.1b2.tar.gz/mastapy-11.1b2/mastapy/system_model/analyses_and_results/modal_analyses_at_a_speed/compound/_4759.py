...
class ShaftCompoundModalAnalysisAtASpeed(_4665.AbstractShaftCompoundModalAnalysisAtASpeed):
    '''ShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4631.ShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4631.ShaftModalAnalysisAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4631.ShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4631.ShaftModalAnalysisAtASpeed))
        return value
