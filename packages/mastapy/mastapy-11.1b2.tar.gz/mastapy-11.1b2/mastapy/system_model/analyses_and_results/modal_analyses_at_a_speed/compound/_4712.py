...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(_4723.GearMeshCompoundModalAnalysisAtASpeed):
    '''CylindricalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4582.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4582.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4582.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4582.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
