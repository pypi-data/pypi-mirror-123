...
class StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation(_6807.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_design(self) -> '_2263.StraightBevelSunGear':
        ...
        return constructor.new(_2263.StraightBevelSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    def system_deflection_results(self) -> '_2528.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2528.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
