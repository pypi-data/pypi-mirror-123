...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(_6824.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''PointLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_load_case(self) -> '_6629.PointLoadLoadCase':
        ...
        return constructor.new(_6629.PointLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2499.PointLoadSystemDeflection':
        ...
        return constructor.new(_2499.PointLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
