...
class CVTAdvancedTimeSteppingAnalysisForModulation(_6711.BeltDriveAdvancedTimeSteppingAnalysisForModulation):
    '''CVTAdvancedTimeSteppingAnalysisForModulation
    ...
    def assembly_design(self) -> '_2299.CVT':
        ...
        return constructor.new(_2299.CVT)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def system_deflection_results(self) -> '_2442.CVTSystemDeflection':
        ...
        return constructor.new(_2442.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
