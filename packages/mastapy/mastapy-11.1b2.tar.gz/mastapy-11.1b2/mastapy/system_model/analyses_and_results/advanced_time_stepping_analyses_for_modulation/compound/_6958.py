...
class ZerolBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_6848.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_design(self) -> '_2046.ZerolBevelGearMesh':
        ...
        return constructor.new(_2046.ZerolBevelGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6829.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6829.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6829.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6829.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value
