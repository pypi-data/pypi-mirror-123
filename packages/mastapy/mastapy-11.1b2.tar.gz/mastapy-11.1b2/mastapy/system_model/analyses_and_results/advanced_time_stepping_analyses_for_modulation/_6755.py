...
class FaceGearMeshAdvancedTimeSteppingAnalysisForModulation(_6760.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''FaceGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2462.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2462.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
