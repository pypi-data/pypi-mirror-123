...
class RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation(_6800.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2505.RollingRingAssemblySystemDeflection':
        ...
        return constructor.new(_2505.RollingRingAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
