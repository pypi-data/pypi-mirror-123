...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_6817.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2529.SynchroniserHalfSystemDeflection':
        ...
        return constructor.new(_2529.SynchroniserHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
