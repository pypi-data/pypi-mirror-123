...
class TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(_6740.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_load_case(self) -> '_6666.TorqueConverterPumpLoadCase':
        ...
        return constructor.new(_6666.TorqueConverterPumpLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2537.TorqueConverterPumpSystemDeflection':
        ...
        return constructor.new(_2537.TorqueConverterPumpSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
