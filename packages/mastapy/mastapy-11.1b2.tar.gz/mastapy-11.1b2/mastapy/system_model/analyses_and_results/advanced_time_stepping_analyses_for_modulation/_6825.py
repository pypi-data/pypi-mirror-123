...
class WormGearAdvancedTimeSteppingAnalysisForModulation(_6759.GearAdvancedTimeSteppingAnalysisForModulation):
    '''WormGearAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2546.WormGearSystemDeflection':
        ...
        return constructor.new(_2546.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
