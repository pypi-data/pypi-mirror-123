...
class SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation(_6740.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_load_case(self) -> '_6649.SpringDamperHalfLoadCase':
        ...
        return constructor.new(_6649.SpringDamperHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    def system_deflection_results(self) -> '_2519.SpringDamperHalfSystemDeflection':
        ...
        return constructor.new(_2519.SpringDamperHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
