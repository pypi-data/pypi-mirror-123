...
class SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6869.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2065.SpringDamperConnection':
        ...
        return constructor.new(_2065.SpringDamperConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    def connection_design(self) -> '_2065.SpringDamperConnection':
        ...
        return constructor.new(_2065.SpringDamperConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6805.SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6805.SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6805.SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6805.SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
