...
class CVTPulleyAdvancedTimeSteppingAnalysisForModulation(_6790.PulleyAdvancedTimeSteppingAnalysisForModulation):
    '''CVTPulleyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2441.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2441.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
