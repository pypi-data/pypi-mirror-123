...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(_6737.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    '''ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2509.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2509.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
