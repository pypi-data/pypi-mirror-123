...
class ClutchHalfAdvancedTimeSteppingAnalysisForModulation(_6740.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6521.ClutchHalfLoadCase':
        ...
        return constructor.new(_6521.ClutchHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2420.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2420.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
