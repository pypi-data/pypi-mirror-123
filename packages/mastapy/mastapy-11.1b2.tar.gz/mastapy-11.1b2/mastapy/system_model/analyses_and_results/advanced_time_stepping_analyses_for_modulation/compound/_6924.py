...
class RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6896.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_design(self) -> '_2007.RollingRingConnection':
        ...
        return constructor.new(_2007.RollingRingConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    def connection_design(self) -> '_2007.RollingRingConnection':
        ...
        return constructor.new(_2007.RollingRingConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6795.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6795.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6795.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6795.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
