...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_6739.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    def connection_load_case(self) -> '_6520.ClutchConnectionLoadCase':
        ...
        return constructor.new(_6520.ClutchConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    def system_deflection_results(self) -> '_2419.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2419.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
