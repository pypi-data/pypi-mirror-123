...
from mastapy.system_model.analyses_and_results import _2364
...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7248.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1924.DesignEntity') -> '_2364.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2364.DesignEntityAnalysis') -> '_2364.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
