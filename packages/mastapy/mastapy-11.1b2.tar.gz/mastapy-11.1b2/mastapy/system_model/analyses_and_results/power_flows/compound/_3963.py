...
class RollingRingCompoundPowerFlow(_3910.CouplingHalfCompoundPowerFlow):
    '''RollingRingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3834.RollingRingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3834.RollingRingPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3834.RollingRingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3834.RollingRingPowerFlow))
        return value
