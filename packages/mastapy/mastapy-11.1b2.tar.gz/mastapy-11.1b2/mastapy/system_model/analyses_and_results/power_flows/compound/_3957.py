...
class PointLoadCompoundPowerFlow(_3993.VirtualComponentCompoundPowerFlow):
    '''PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3825.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3825.PointLoadPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3825.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3825.PointLoadPowerFlow))
        return value
