...
class ClutchCompoundPowerFlow(_3908.CouplingCompoundPowerFlow):
    '''ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3761.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3761.ClutchPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3761.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3761.ClutchPowerFlow))
        return value
