...
class RootAssemblyCompoundPowerFlow(_3878.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_5358.AbstractStaticLoadCaseGroup':
        ...
        if _5358.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5356.AbstractDesignStateLoadCaseGroup':
        ...
        if _5356.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_5361.DesignState':
        ...
        if _5361.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5362.DutyCycle':
        ...
        if _5362.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5365.SubGroupInSingleDesignState':
        ...
        if _5365.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3835.RootAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3835.RootAssemblyPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3835.RootAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3835.RootAssemblyPowerFlow))
        return value
