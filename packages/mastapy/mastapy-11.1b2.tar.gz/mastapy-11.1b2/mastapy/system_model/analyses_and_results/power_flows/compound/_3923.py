...
class ExternalCADModelCompoundPowerFlow(_3896.ComponentCompoundPowerFlow):
    '''ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3791.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3791.ExternalCADModelPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3791.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3791.ExternalCADModelPowerFlow))
        return value
