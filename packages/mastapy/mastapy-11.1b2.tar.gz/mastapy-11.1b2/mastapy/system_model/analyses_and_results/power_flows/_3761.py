...
from mastapy.system_model.analyses_and_results.power_flows import _3759, _3777
...
class ClutchPowerFlow(_3777.CouplingPowerFlow):
    '''ClutchPowerFlow
    ...
    def clutch_connection(self) -> '_3759.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3759.ClutchConnectionPowerFlow)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
