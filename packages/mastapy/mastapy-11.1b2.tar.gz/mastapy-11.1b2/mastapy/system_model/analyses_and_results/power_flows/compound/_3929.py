...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3948
...
class GearCompoundPowerFlow(_3948.MountableComponentCompoundPowerFlow):
    '''GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3798.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3798.GearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3798.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3798.GearPowerFlow))
        return value
