...
class SpringDamperCompoundPowerFlow(_3908.CouplingCompoundPowerFlow):
    '''SpringDamperCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3845.SpringDamperPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3845.SpringDamperPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3845.SpringDamperPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3845.SpringDamperPowerFlow))
        return value
