...
class BevelDifferentialGearMeshCompoundPowerFlow(_3888.BevelGearMeshCompoundPowerFlow):
    '''BevelDifferentialGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3749.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3749.BevelDifferentialGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3749.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3749.BevelDifferentialGearMeshPowerFlow))
        return value
