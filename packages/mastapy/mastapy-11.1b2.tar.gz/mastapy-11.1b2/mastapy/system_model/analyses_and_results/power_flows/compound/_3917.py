...
class CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow(_3874.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3783.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3783.CycloidalDiscPlanetaryBearingConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3783.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3783.CycloidalDiscPlanetaryBearingConnectionPowerFlow))
        return value
