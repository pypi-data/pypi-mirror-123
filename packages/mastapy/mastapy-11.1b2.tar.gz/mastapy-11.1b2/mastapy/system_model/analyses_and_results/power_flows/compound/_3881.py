...
class BeltDriveCompoundPowerFlow(_3969.SpecialisedAssemblyCompoundPowerFlow):
    '''BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3748.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3748.BeltDrivePowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3748.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3748.BeltDrivePowerFlow))
        return value
