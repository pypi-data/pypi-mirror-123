...
class ConceptCouplingCompoundPowerFlow(_3908.CouplingCompoundPowerFlow):
    '''ConceptCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3766.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3766.ConceptCouplingPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3766.ConceptCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3766.ConceptCouplingPowerFlow))
        return value
