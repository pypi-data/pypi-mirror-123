...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5223, _5225
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5114.ConnectorMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5223.DynamicForceVector3DResult':
        ...
        return constructor.new(_5223.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_5225.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5225.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
