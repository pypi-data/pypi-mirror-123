...
from mastapy.system_model.analyses_and_results.analysis_cases import _7241
...
class MultibodyDynamicsAnalysis(_7241.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5160.MBDAnalysisOptions':
        ...
        return constructor.new(_5160.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None
