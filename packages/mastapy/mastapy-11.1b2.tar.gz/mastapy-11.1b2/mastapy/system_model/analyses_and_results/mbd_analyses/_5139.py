...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5138, _5136, _5187
...
class GearSetMultibodyDynamicsAnalysis(_5187.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5138.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5138.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5136.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5136.GearMeshMultibodyDynamicsAnalysis))
        return value
