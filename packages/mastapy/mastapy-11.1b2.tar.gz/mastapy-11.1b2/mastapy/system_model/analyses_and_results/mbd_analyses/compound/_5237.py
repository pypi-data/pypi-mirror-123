...
class BeltDriveCompoundMultibodyDynamicsAnalysis(_5325.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    '''BeltDriveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5087.BeltDriveMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5087.BeltDriveMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5087.BeltDriveMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5087.BeltDriveMultibodyDynamicsAnalysis))
        return value
