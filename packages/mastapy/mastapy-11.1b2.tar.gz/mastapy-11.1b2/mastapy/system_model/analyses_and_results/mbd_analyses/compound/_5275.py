...
class CylindricalGearMeshCompoundMultibodyDynamicsAnalysis(_5286.GearMeshCompoundMultibodyDynamicsAnalysis):
    '''CylindricalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5125.CylindricalGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5125.CylindricalGearMeshMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5125.CylindricalGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5125.CylindricalGearMeshMultibodyDynamicsAnalysis))
        return value
