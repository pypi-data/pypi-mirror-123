...
class BeltConnectionMultibodyDynamicsAnalysis(_5148.InterMountableComponentConnectionMultibodyDynamicsAnalysis):
    '''BeltConnectionMultibodyDynamicsAnalysis
    ...
    def loading_status(self) -> '_70.LoadingStatus':
        ...
        return constructor.new(_70.LoadingStatus)(value) if value else None
