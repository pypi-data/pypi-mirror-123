...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5210, _5115
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5115.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5210.TorqueConverterStatus':
        ...
        return constructor.new(_5210.TorqueConverterStatus)(value) if value else None
