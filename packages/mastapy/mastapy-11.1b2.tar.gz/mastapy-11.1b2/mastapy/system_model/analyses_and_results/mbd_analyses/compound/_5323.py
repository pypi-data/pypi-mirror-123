...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5183
...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5263.ConnectorCompoundMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5183.ShaftHubConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5183.ShaftHubConnectionMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5183.ShaftHubConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5183.ShaftHubConnectionMultibodyDynamicsAnalysis))
        return value
