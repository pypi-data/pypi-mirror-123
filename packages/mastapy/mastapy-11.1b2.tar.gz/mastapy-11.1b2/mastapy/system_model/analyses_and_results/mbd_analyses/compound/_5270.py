...
class CycloidalAssemblyCompoundMultibodyDynamicsAnalysis(_5325.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    '''CycloidalAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5121.CycloidalAssemblyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5121.CycloidalAssemblyMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5121.CycloidalAssemblyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5121.CycloidalAssemblyMultibodyDynamicsAnalysis))
        return value
