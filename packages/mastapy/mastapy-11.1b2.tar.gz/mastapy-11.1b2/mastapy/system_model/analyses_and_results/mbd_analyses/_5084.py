...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5223
...
class BearingMultibodyDynamicsAnalysis(_5114.ConnectorMultibodyDynamicsAnalysis):
    '''BearingMultibodyDynamicsAnalysis
