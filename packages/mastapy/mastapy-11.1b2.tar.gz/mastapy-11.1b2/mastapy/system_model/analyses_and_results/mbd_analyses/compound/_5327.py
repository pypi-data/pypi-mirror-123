...
class SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5244.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    '''SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5188.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5188.SpiralBevelGearMeshMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5188.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5188.SpiralBevelGearMeshMultibodyDynamicsAnalysis))
        return value
