...
class CoaxialConnectionCompoundMultibodyDynamicsAnalysis(_5324.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''CoaxialConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5102.CoaxialConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5102.CoaxialConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5102.CoaxialConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5102.CoaxialConnectionMultibodyDynamicsAnalysis))
        return value
