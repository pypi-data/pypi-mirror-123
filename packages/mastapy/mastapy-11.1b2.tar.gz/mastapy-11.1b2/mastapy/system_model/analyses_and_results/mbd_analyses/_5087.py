...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5174, _5187
...
class BeltDriveMultibodyDynamicsAnalysis(_5187.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5174.PulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5174.PulleyMultibodyDynamicsAnalysis))
        return value
