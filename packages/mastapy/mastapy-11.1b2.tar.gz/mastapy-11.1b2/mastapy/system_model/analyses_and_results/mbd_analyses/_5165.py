...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2352
from mastapy.math_utility.convergence import _1356, _1355
from mastapy.utility_gui import _1598
from mastapy.system_model.drawing import _1964
from mastapy.system_model.analyses_and_results.analysis_cases import _7239
...
class PartMultibodyDynamicsAnalysis(_7239.PartTimeSeriesLoadAnalysisCase):
    '''PartMultibodyDynamicsAnalysis
    ...
    @property
    def data_logger(self) -> '_1356.DataLogger':
        ...
        if _1356.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
    ...
    def create_viewable(self) -> '_1964.MBDAnalysisViewable':
