...
from mastapy.bearings.bearing_results import _1676, _1684, _1687
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling import (
    _1715, _1722, _1730, _1746,
    _1770
)
...
class BearingCompoundParametricStudyTool(_4183.ConnectorCompoundParametricStudyTool):
    '''BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1676.LoadedBearingDutyCycle':
        ...
        if _1676.LoadedBearingDutyCycle.TYPE not in self.wrapped.BearingDutyCycleResults.__class__.__mro__:
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4008.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4008.BearingParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4008.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4008.BearingParametricStudyTool))
        return value
