...
class RollingRingConnectionCompoundParametricStudyTool(_4212.InterMountableComponentConnectionCompoundParametricStudyTool):
    '''RollingRingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4110.RollingRingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4110.RollingRingConnectionParametricStudyTool))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4110.RollingRingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4110.RollingRingConnectionParametricStudyTool))
        return value
