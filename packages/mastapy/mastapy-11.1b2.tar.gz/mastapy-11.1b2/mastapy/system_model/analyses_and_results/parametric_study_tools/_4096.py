...
class ParametricStudyVariable(_2361.AnalysisCaseVariable):
    ...
    def dimension(self) -> '_4087.ParametricStudyDimension':
        ...
        return constructor.new(_4087.ParametricStudyDimension)(value) if value else None
    ...
    def distribution(self) -> '_4084.MonteCarloDistribution':
        ...
        return constructor.new(_4084.MonteCarloDistribution)(value) if value else None
    ...
    def doe_variable_setter(self) -> '_4052.DesignOfExperimentsVariableSetter':
        ...
        return constructor.new(_4052.DesignOfExperimentsVariableSetter)(self.wrapped.DOEVariableSetter) if self.wrapped.DOEVariableSetter else None
