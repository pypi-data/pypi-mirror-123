...
class BevelDifferentialGearCompoundParametricStudyTool(_4163.BevelGearCompoundParametricStudyTool):
    '''BevelDifferentialGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4012.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4012.BevelDifferentialGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4012.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4012.BevelDifferentialGearParametricStudyTool))
        return value
