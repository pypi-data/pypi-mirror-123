...
class OilSealCompoundParametricStudyTool(_4183.ConnectorCompoundParametricStudyTool):
    '''OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4086.OilSealParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4086.OilSealParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4086.OilSealParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4086.OilSealParametricStudyTool))
        return value
