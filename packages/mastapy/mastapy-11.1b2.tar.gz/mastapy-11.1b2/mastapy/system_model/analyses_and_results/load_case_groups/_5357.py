...
from mastapy.system_model.analyses_and_results.static_loads import _6639, _6491
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    def parametric_analysis_options(self) -> '_4093.ParametricStudyToolOptions':
        ...
        return constructor.new(_4093.ParametricStudyToolOptions)(self.wrapped.ParametricAnalysisOptions) if self.wrapped.ParametricAnalysisOptions else None

    @property
    def load_case_root_assemblies(self) -> 'List[_6639.RootAssemblyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseRootAssemblies, constructor.new(_6639.RootAssemblyLoadCase))
        return value
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7248.TaskProgress') -> 'List[_6491.LoadCase]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.CreateLoadCases(number_of_load_cases if number_of_load_cases else 0, token.wrapped if token else None), constructor.new(_6491.LoadCase))
