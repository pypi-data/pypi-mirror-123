...
class RollingRingConnectionCompoundDynamicAnalysis(_6161.InterMountableComponentConnectionCompoundDynamicAnalysis):
    '''RollingRingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6059.RollingRingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6059.RollingRingConnectionDynamicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6059.RollingRingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6059.RollingRingConnectionDynamicAnalysis))
        return value
