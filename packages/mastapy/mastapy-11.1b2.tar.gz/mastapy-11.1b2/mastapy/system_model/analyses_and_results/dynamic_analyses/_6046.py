...
class PartDynamicAnalysis(_7237.PartFEAnalysis):
    '''PartDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_2339.DynamicAnalysis':
        ...
        if _2339.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
