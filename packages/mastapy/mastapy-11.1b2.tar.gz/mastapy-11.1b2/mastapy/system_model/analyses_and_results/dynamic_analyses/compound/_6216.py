...
class TorqueConverterTurbineCompoundDynamicAnalysis(_6135.CouplingHalfCompoundDynamicAnalysis):
    '''TorqueConverterTurbineCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6087.TorqueConverterTurbineDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6087.TorqueConverterTurbineDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6087.TorqueConverterTurbineDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6087.TorqueConverterTurbineDynamicAnalysis))
        return value
