...
class TorqueConverterPumpCompoundDynamicAnalysis(_6135.CouplingHalfCompoundDynamicAnalysis):
    '''TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6086.TorqueConverterPumpDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6086.TorqueConverterPumpDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6086.TorqueConverterPumpDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6086.TorqueConverterPumpDynamicAnalysis))
        return value
