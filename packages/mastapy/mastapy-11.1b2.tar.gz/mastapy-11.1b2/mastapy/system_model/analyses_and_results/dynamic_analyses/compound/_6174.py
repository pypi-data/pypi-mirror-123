...
class OilSealCompoundDynamicAnalysis(_6132.ConnectorCompoundDynamicAnalysis):
    '''OilSealCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6045.OilSealDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6045.OilSealDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6045.OilSealDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6045.OilSealDynamicAnalysis))
        return value
