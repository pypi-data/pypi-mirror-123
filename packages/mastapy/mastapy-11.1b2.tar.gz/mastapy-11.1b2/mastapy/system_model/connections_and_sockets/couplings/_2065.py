...
class SpringDamperConnection(_2061.CouplingConnection):
    ...
    def damping_option(self) -> '_1922.ComponentDampingOption':
        ...
        return constructor.new(_1922.ComponentDampingOption)(value) if value else None
    ...
    def damping(self) -> '_68.LinearDampingConnectionProperties':
        ...
        return constructor.new(_68.LinearDampingConnectionProperties)(self.wrapped.Damping) if self.wrapped.Damping else None
