...
class FaceGearMesh(_2028.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_931.FaceGearMeshDesign':
        ...
        return constructor.new(_931.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
