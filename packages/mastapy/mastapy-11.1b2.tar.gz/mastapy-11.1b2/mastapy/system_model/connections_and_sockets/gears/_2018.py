...
class BevelGearMesh(_2014.AGMAGleasonConicalGearMesh):
    '''BevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_1112.BevelGearMeshDesign':
        ...
        if _1112.BevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_zerol_bevel_gear_mesh_design(self) -> '_893.ZerolBevelGearMeshDesign':
        ...
        if _893.ZerolBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_straight_bevel_diff_gear_mesh_design(self) -> '_902.StraightBevelDiffGearMeshDesign':
        ...
        if _902.StraightBevelDiffGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_straight_bevel_gear_mesh_design(self) -> '_906.StraightBevelGearMeshDesign':
        ...
        if _906.StraightBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_spiral_bevel_gear_mesh_design(self) -> '_910.SpiralBevelGearMeshDesign':
        ...
        if _910.SpiralBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
