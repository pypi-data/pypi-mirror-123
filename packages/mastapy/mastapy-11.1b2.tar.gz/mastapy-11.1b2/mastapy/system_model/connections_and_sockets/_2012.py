...
class SocketConnectionOptions(_0.APIBase):
    ...
    @property
    def sockets(self) -> 'List[_2013.SocketConnectionSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Sockets, constructor.new(_2013.SocketConnectionSelection))
        return value
