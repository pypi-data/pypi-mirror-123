...
from mastapy.system_model.part_model.import_from_cad import _2216, _2217
...
class ConnectorFromCAD(_2217.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2216.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2216.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2216.HousedOrMounted'):
