...
from mastapy.system_model.part_model import _2175, _2178
from mastapy.system_model.connections_and_sockets import _2003
...
class PlanetCarrier(_2178.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_2003.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_2003.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2196.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2196.Shaft', offset: Optional['float'] = float('nan')):
