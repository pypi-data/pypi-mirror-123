...
from mastapy.system_model.part_model.couplings import _2321, _2323, _2296
...
class TorqueConverter(_2296.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2321.TorqueConverterPump':
        ...
        return constructor.new(_2321.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2323.TorqueConverterTurbine':
        ...
        return constructor.new(_2323.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
