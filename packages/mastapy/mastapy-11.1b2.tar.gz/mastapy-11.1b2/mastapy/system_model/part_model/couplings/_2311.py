...
from mastapy.system_model.part_model.couplings import (
    _2305, _2308, _2304, _2307,
    _2312, _2306
)
from mastapy.detailed_rigid_connectors.splines import (
    _1194, _1179, _1199, _1174,
    _1177, _1181, _1184, _1185,
    _1192, _1204
)
from mastapy._internal.python_net import python_net_import
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.interference_fits import _1229
from mastapy.detailed_rigid_connectors.keyed_joints import _1221
...
class ShaftHubConnection(_2162.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2305.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2305.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2305.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_1194.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_1194.SplineDesignTypes)(value) if value else None

    @spline_type.setter
    def spline_type(self, value: '_1194.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def angle_of_first_connection_point(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.AngleOfFirstConnectionPoint) if self.wrapped.AngleOfFirstConnectionPoint else None
    ...
    @property
    def spline_joint_design(self) -> '_1199.SplineJointDesign':
        ...
        if _1199.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1174.CustomSplineJointDesign':
        ...
        if _1174.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1177.DIN5480SplineJointDesign':
        ...
        if _1177.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1181.GBT3478SplineJointDesign':
        ...
        if _1181.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1184.ISO4156SplineJointDesign':
        ...
        if _1184.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1185.JISB1603SplineJointDesign':
        ...
        if _1185.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1192.SAESplineJointDesign':
        ...
        if _1192.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1204.StandardSplineJointDesign':
        ...
        if _1204.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def interference_fit_design(self) -> '_1229.InterferenceFitDesign':
        ...
        if _1229.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
    ...
    def nonlinear_stiffness(self) -> '_54.DiagonalNonlinearStiffness':
        ...
        return constructor.new(_54.DiagonalNonlinearStiffness)(self.wrapped.NonlinearStiffness) if self.wrapped.NonlinearStiffness else None

    @property
    def left_flank_lead_relief(self) -> '_2312.SplineLeadRelief':
        ...
        return constructor.new(_2312.SplineLeadRelief)(self.wrapped.LeftFlankLeadRelief) if self.wrapped.LeftFlankLeadRelief else None

    @property
    def right_flank_lead_relief(self) -> '_2312.SplineLeadRelief':
        ...
        return constructor.new(_2312.SplineLeadRelief)(self.wrapped.RightFlankLeadRelief) if self.wrapped.RightFlankLeadRelief else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2306.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2306.RigidConnectorToothLocation))
        return value

    @property
    def lead_reliefs(self) -> 'List[_2312.SplineLeadRelief]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadReliefs, constructor.new(_2312.SplineLeadRelief))
        return value
