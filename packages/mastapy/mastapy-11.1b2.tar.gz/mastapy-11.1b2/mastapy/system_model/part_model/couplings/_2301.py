...
class PartToPartShearCoupling(_2296.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2063.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_2063.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
