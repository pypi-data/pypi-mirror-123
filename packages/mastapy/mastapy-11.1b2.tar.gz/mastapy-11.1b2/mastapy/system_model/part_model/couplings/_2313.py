...
class SpringDamper(_2296.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2065.SpringDamperConnection':
        ...
        return constructor.new(_2065.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection else None
