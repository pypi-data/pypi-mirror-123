...
class ConceptCoupling(_2296.Coupling):
    '''ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'EfficiencyVsSpeedRatio' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.EfficiencyVsSpeedRatio) if self.wrapped.EfficiencyVsSpeedRatio else None

    @efficiency_vs_speed_ratio.setter
    def efficiency_vs_speed_ratio(self, value: '_1317.Vector2DListAccessor'):
    ...
    def coupling_type(self) -> '_51.CouplingType':
        ...
        return constructor.new(_51.CouplingType)(value) if value else None
