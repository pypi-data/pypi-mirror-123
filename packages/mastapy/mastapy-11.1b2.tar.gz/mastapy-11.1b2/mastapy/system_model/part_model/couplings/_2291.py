...
from mastapy.system_model.part_model.couplings import _2293, _2296
...
class Clutch(_2296.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2293.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2293.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2293.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5101.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5101.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5101.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def angular_speed_temperature_grid(self) -> '_1349.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'AngularSpeedTemperatureGrid' is the original name of this property.'''

        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.AngularSpeedTemperatureGrid) if self.wrapped.AngularSpeedTemperatureGrid else None

    @angular_speed_temperature_grid.setter
    def angular_speed_temperature_grid(self, value: '_1349.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.AngularSpeedTemperatureGrid = value

    @property
    def linear_speed_temperature_grid(self) -> '_1349.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'LinearSpeedTemperatureGrid' is the original name of this property.'''

        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.LinearSpeedTemperatureGrid) if self.wrapped.LinearSpeedTemperatureGrid else None

    @linear_speed_temperature_grid.setter
    def linear_speed_temperature_grid(self, value: '_1349.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def flow_rate_vs_speed(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'FlowRateVsSpeed' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.FlowRateVsSpeed) if self.wrapped.FlowRateVsSpeed else None

    @flow_rate_vs_speed.setter
    def flow_rate_vs_speed(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.FlowRateVsSpeed = value

    @property
    def clutch_connection(self) -> '_2057.ClutchConnection':
        ...
        return constructor.new(_2057.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
