...
class ComponentsConnectedResult(_0.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_2161.ConnectedSockets':
        ...
        return constructor.new(_2161.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
