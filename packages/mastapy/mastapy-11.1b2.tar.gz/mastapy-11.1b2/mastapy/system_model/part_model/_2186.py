...
from mastapy.system_model import _1937
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2195, _2193
...
class PowerLoad(_2193.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def engine_torque_grid(self) -> '_1349.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'EngineTorqueGrid' is the original name of this property.'''

        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.EngineTorqueGrid) if self.wrapped.EngineTorqueGrid else None

    @engine_torque_grid.setter
    def engine_torque_grid(self, value: '_1349.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.EngineTorqueGrid = value

    @property
    def engine_fuel_consumption_grid(self) -> '_1349.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'EngineFuelConsumptionGrid' is the original name of this property.'''

        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.EngineFuelConsumptionGrid) if self.wrapped.EngineFuelConsumptionGrid else None

    @engine_fuel_consumption_grid.setter
    def engine_fuel_consumption_grid(self, value: '_1349.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def single_blade_details(self) -> '_2195.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2195.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6558.ElectricMachineDetail':
        ...
        return constructor.new(_6558.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
    ...
    def oil_pump_detail(self) -> '_266.OilPumpDetail':
        ...
        return constructor.new(_266.OilPumpDetail)(self.wrapped.OilPumpDetail) if self.wrapped.OilPumpDetail else None
