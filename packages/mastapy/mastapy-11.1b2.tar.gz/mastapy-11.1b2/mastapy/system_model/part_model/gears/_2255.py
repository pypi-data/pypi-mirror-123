...
from mastapy.system_model.part_model.gears import _2238, _2240, _2239
...
class PlanetaryGearSet(_2239.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2238.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2238.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2240.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2240.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2238.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2238.CylindricalGear))
        return value

    def add_sun(self) -> '_2238.CylindricalGear':
    ...
    def add_planet(self) -> '_2238.CylindricalGear':
    ...
    def add_annulus(self) -> '_2238.CylindricalGear':
