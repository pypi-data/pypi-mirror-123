...
from mastapy.system_model.part_model.gears import _2243
...
class CylindricalGear(_2243.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_952.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_952.CylindricalGearDesign':
        ...
        if _952.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
