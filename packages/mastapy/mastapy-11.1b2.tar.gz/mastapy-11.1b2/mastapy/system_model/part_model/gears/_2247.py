...
class HypoidGear(_2226.AGMAGleasonConicalGear):
    ...
    def conical_gear_design(self) -> '_925.HypoidGearDesign':
        ...
        return constructor.new(_925.HypoidGearDesign)(self.wrapped.ConicalGearDesign) if self.wrapped.ConicalGearDesign else None
    ...
    def hypoid_gear_design(self) -> '_925.HypoidGearDesign':
        ...
        return constructor.new(_925.HypoidGearDesign)(self.wrapped.HypoidGearDesign) if self.wrapped.HypoidGearDesign else None
