...
class GearSet(_2190.SpecialisedAssembly):
    '''GearSet
    ...
    @property
    def active_gear_set_design(self) -> '_890.GearSetDesign':
        ...
        if _890.GearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_worm_gear_set_design(self) -> '_899.WormGearSetDesign':
        ...
        if _899.WormGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_face_gear_set_design(self) -> '_935.FaceGearSetDesign':
        ...
        if _935.FaceGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_967.CylindricalGearSetDesign':
        ...
        if _967.CylindricalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_978.CylindricalPlanetaryGearSetDesign':
        ...
        if _978.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_conical_gear_set_design(self) -> '_1087.ConicalGearSetDesign':
    ...
    @property
    def active_gear_set_design_of_type_concept_gear_set_design(self) -> '_1109.ConceptGearSetDesign':
        ...
        if _1109.ConceptGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_designs(self) -> 'List[_890.GearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_890.GearSetDesign))
        return value

    def set_active_gear_set_design(self, gear_set_design: '_890.GearSetDesign'):
    ...
    def add_gear_set_design(self, design: '_890.GearSetDesign'):
