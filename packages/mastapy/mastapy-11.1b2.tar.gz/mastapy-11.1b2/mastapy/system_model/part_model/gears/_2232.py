...
class BevelGear(_2226.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    @property
    def conical_gear_design(self) -> '_1111.BevelGearDesign':
    ...
    @property
    def bevel_gear_design(self) -> '_1111.BevelGearDesign':
        ...
        if _1111.BevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_zerol_bevel_gear_design(self) -> '_892.ZerolBevelGearDesign':
        ...
        if _892.ZerolBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_901.StraightBevelDiffGearDesign':
        ...
        if _901.StraightBevelDiffGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_gear_design(self) -> '_905.StraightBevelGearDesign':
        ...
        if _905.StraightBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_spiral_bevel_gear_design(self) -> '_909.SpiralBevelGearDesign':
        ...
        if _909.SpiralBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
