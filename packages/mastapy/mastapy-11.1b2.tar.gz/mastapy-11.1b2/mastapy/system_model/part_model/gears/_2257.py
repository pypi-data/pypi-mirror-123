...
class SpiralBevelGearSet(_2233.BevelGearSet):
    ...
    def conical_gear_set_design(self) -> '_911.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_911.SpiralBevelGearSetDesign)(self.wrapped.ConicalGearSetDesign) if self.wrapped.ConicalGearSetDesign else None
    ...
    def spiral_bevel_gear_set_design(self) -> '_911.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_911.SpiralBevelGearSetDesign)(self.wrapped.SpiralBevelGearSetDesign) if self.wrapped.SpiralBevelGearSetDesign else None
