...
class Bolt(_2159.Component):
    ...
    def loaded_bolt(self) -> '_1264.LoadedBolt':
        ...
        return constructor.new(_1264.LoadedBolt)(self.wrapped.LoadedBolt) if self.wrapped.LoadedBolt else None
    ...
    def bolted_joint(self) -> '_2158.BoltedJoint':
        ...
        return constructor.new(_2158.BoltedJoint)(self.wrapped.BoltedJoint) if self.wrapped.BoltedJoint else None
