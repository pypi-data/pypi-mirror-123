...
from mastapy.utility.modal_analysis.gears import _1551, _1555
...
class GearMeshForTE(_1555.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1551.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1551.GearOrderForTE))
        return value
