...
class CustomReport(_1520.CustomReportItemContainer):
    '''CustomReport
    ...
    @property
    def cad_table_border_style(self) -> '_1506.CadTableBorderType':
        ...
        return constructor.new(_1506.CadTableBorderType)(value) if value else None

    @cad_table_border_style.setter
    def cad_table_border_style(self, value: '_1506.CadTableBorderType'):
    ...
    @property
    def page_size_for_cad_export(self) -> '_1505.CadPageSize':
        ...
        return constructor.new(_1505.CadPageSize)(value) if value else None

    @page_size_for_cad_export.setter
    def page_size_for_cad_export(self, value: '_1505.CadPageSize'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def include_report_check(self) -> '_1537.DefinitionBooleanCheckOptions':
        ...
        return constructor.new(_1537.DefinitionBooleanCheckOptions)(value) if value else None

    @include_report_check.setter
    def include_report_check(self, value: '_1537.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
