...
from mastapy.utility.cad_export import _1583
...
class CustomReportCadDrawing(_1527.CustomReportNameableItem):
    '''CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1583.StockDrawings':
        '''StockDrawings: 'StockDrawing' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StockDrawing)
        return constructor.new(_1583.StockDrawings)(value) if value else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1583.StockDrawings'):
