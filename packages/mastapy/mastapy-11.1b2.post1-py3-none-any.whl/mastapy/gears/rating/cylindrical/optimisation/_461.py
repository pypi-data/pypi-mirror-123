...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_462.OptimisationResultsPair[_466.SafetyFactorOptimisationStepResultNumber]':
        ...
        return constructor.new(_462.OptimisationResultsPair)[_466.SafetyFactorOptimisationStepResultNumber](self.wrapped.ProfileShiftCoefficientOptimisationResults) if self.wrapped.ProfileShiftCoefficientOptimisationResults is not None else None

    @property
    def helix_angle_optimisation_results(self) -> '_462.OptimisationResultsPair[_465.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_462.OptimisationResultsPair)[_465.SafetyFactorOptimisationStepResultAngle](self.wrapped.HelixAngleOptimisationResults) if self.wrapped.HelixAngleOptimisationResults is not None else None

    @property
    def normal_module_optimisation_results(self) -> '_462.OptimisationResultsPair[_467.SafetyFactorOptimisationStepResultShortLength]':
        ...
        return constructor.new(_462.OptimisationResultsPair)[_467.SafetyFactorOptimisationStepResultShortLength](self.wrapped.NormalModuleOptimisationResults) if self.wrapped.NormalModuleOptimisationResults is not None else None

    @property
    def pressure_angle_optimisation_results(self) -> '_462.OptimisationResultsPair[_465.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_462.OptimisationResultsPair)[_465.SafetyFactorOptimisationStepResultAngle](self.wrapped.PressureAngleOptimisationResults) if self.wrapped.PressureAngleOptimisationResults is not None else None

    @property
    def all_normal_module_optimisation_results(self) -> 'List[_463.SafetyFactorOptimisationResults[_467.SafetyFactorOptimisationStepResultShortLength]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalModuleOptimisationResults, constructor.new(_463.SafetyFactorOptimisationResults)[_467.SafetyFactorOptimisationStepResultShortLength])
        return value

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_463.SafetyFactorOptimisationResults[_465.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllHelixAngleOptimisationResults, constructor.new(_463.SafetyFactorOptimisationResults)[_465.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_463.SafetyFactorOptimisationResults[_465.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalPressureAngleOptimisationResults, constructor.new(_463.SafetyFactorOptimisationResults)[_465.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_463.SafetyFactorOptimisationResults[_465.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HelixAngleAndNormalPressureAngleOptimisationResults, constructor.new(_463.SafetyFactorOptimisationResults)[_465.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_463.SafetyFactorOptimisationResults[_466.SafetyFactorOptimisationStepResultNumber]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllProfileShiftOptimisationResults, constructor.new(_463.SafetyFactorOptimisationResults)[_466.SafetyFactorOptimisationStepResultNumber])
        return value
