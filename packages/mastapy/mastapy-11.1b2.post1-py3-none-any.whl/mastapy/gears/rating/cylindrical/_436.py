...
class MeshRatingForReports(_0.APIBase):
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_420.CylindricalGearMeshRating':
        ...
        return constructor.new(_420.CylindricalGearMeshRating)(self.wrapped.CylindricalGearMeshRating) if self.wrapped.CylindricalGearMeshRating is not None else None
