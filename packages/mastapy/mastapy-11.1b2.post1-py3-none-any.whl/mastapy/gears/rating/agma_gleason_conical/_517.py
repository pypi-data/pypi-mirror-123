...
class AGMAGleasonConicalGearMeshRating(_491.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1098.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1098.LoadDistributionFactorMethods)(value) if value else None
