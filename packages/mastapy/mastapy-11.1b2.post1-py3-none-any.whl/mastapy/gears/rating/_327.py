...
class GearSetDutyCycleRating(_320.AbstractGearSetRating):
    ...
    @property
    def gear_set_design(self) -> '_890.GearSetDesign':
        ...
        if _890.GearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_894.ZerolBevelGearSetDesign':
        ...
        if _894.ZerolBevelGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_worm_gear_set_design(self) -> '_899.WormGearSetDesign':
        ...
        if _899.WormGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_903.StraightBevelDiffGearSetDesign':
        ...
        if _903.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_907.StraightBevelGearSetDesign':
        ...
        if _907.StraightBevelGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_911.SpiralBevelGearSetDesign':
        ...
        if _911.SpiralBevelGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_design(self) -> '_915.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        if _915.KlingelnbergCycloPalloidSpiralBevelGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_919.KlingelnbergCycloPalloidHypoidGearSetDesign':
        ...
        if _919.KlingelnbergCycloPalloidHypoidGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_klingelnberg_conical_gear_set_design(self) -> '_923.KlingelnbergConicalGearSetDesign':
        ...
        if _923.KlingelnbergConicalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_hypoid_gear_set_design(self) -> '_927.HypoidGearSetDesign':
        ...
        if _927.HypoidGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_face_gear_set_design(self) -> '_935.FaceGearSetDesign':
        ...
        if _935.FaceGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_967.CylindricalGearSetDesign':
        ...
        if _967.CylindricalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_978.CylindricalPlanetaryGearSetDesign':
        ...
        if _978.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_conical_gear_set_design(self) -> '_1087.ConicalGearSetDesign':
        ...
        if _1087.ConicalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_concept_gear_set_design(self) -> '_1109.ConceptGearSetDesign':
        ...
        if _1109.ConceptGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_bevel_gear_set_design(self) -> '_1113.BevelGearSetDesign':
        ...
        if _1113.BevelGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_agma_gleason_conical_gear_set_design(self) -> '_1126.AGMAGleasonConicalGearSetDesign':
        ...
        if _1126.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
