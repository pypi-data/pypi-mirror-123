...
from mastapy.utility.model_validation import _1543
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.math_utility import _1269
from mastapy.math_utility.measured_ranges import _1346
...
class DesignConstraint(_0.APIBase):
    ...
    @property
    def range(self) -> '_1269.Range':
        '''Range: 'Range' is the original name of this property.'''

        if _1269.Range.TYPE not in self.wrapped.Range.__class__.__mro__:
    ...
    @range.setter
    def range(self, value: '_1269.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def integer_range(self) -> '_1366.IntegerRange':
        '''IntegerRange: 'IntegerRange' is the original name of this property.'''

        return constructor.new(_1366.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange else None

    @integer_range.setter
    def integer_range(self, value: '_1366.IntegerRange'):
        value = value.wrapped if value else None
