...
from mastapy.gears.gear_designs import _886
...
class SelectedDesignConstraintsCollection(_1371.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_886.DesignConstraintsCollection':
        ...
        return constructor.new(_886.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints is not None else None
