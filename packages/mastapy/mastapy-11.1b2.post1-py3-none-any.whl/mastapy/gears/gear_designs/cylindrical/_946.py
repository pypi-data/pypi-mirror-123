...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_952.CylindricalGearDesign':
        ...
        if _952.CylindricalGearDesign.TYPE not in self.wrapped.Gear.__class__.__mro__:
    ...
    @property
    def shaper_for_agma_rating(self) -> '_686.CylindricalGearShaper':
        ...
        return constructor.new(_686.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating is not None else None

    @property
    def left_flank(self) -> '_947.CylindricalGearAbstractRackFlank':
        ...
        if _947.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_949.CylindricalGearBasicRackFlank':
        ...
        if _949.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_963.CylindricalGearPinionTypeCutterFlank':
        ...
        if _963.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_standard_rack_flank(self) -> '_1015.StandardRackFlank':
        ...
        if _1015.StandardRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_947.CylindricalGearAbstractRackFlank':
        ...
        if _947.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_949.CylindricalGearBasicRackFlank':
        ...
        if _949.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_963.CylindricalGearPinionTypeCutterFlank':
        ...
        if _963.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_standard_rack_flank(self) -> '_1015.StandardRackFlank':
        ...
        if _1015.StandardRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def flanks(self) -> 'List[_947.CylindricalGearAbstractRackFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_947.CylindricalGearAbstractRackFlank))
        return value

    @property
    def both_flanks(self) -> '_947.CylindricalGearAbstractRackFlank':
        ...
        if _947.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_basic_rack_flank(self) -> '_949.CylindricalGearBasicRackFlank':
        ...
        if _949.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_963.CylindricalGearPinionTypeCutterFlank':
        ...
        if _963.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_standard_rack_flank(self) -> '_1015.StandardRackFlank':
        ...
        if _1015.StandardRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
