...
from mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash import _1027
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1072
from mastapy.gears.manufacturing.cylindrical.cutters import _694
...
class CylindricalGearDefaults(_1371.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self) -> '_1027.FinishStockType':
        ...
        return constructor.new(_1027.FinishStockType)(value) if value is not None else None

    @finish_stock_type.setter
    def finish_stock_type(self, value: '_1027.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockType = value

    @property
    def system_of_fits_defaults(self) -> '_1072.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1072.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults is not None else None

    @property
    def rough_cutter_creation_settings(self) -> '_694.RoughCutterCreationSettings':
        ...
        return constructor.new(_694.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings is not None else None
