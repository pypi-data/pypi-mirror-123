...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self) -> '_658.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_658.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver is not None else None
