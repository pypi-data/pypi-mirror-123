...
class CylindricalGearDesignConstraintSettings(_1371.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_954.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_954.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints is not None else None
