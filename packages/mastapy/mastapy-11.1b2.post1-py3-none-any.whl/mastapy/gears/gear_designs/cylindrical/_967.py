...
from mastapy.gears.gear_designs.cylindrical import (
    _938, _985, _1008, _1002,
    _1026, _968, _999, _952,
    _959, _969
)
...
class CylindricalGearSetDesign(_890.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_938.AddendumModificationDistributionRule':
        ...
        return constructor.new(_938.AddendumModificationDistributionRule)(value) if value is not None else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_938.AddendumModificationDistributionRule'):
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_469.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_469.HelicalGearMicroGeometryOption)(value) if value is not None else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_469.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_985.GearFitSystems':
        ...
        return constructor.new(_985.GearFitSystems)(value) if value is not None else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_985.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_1008.Scuffing':
        ...
        return constructor.new(_1008.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing is not None else None

    @property
    def micropitting(self) -> '_1002.Micropitting':
        ...
        return constructor.new(_1002.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting is not None else None

    @property
    def usage(self) -> '_1026.Usage':
        ...
        return constructor.new(_1026.Usage)(self.wrapped.Usage) if self.wrapped.Usage is not None else None

    @property
    def left_flank(self) -> '_968.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_968.CylindricalGearSetFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_968.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_968.CylindricalGearSetFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
    ...
    def ltca_settings(self) -> '_999.LtcaSettings':
        ...
        return constructor.new(_999.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings is not None else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_579.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_579.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration is not None else None

    @property
    def gears(self) -> 'List[_952.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_952.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_952.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_952.CylindricalGearDesign))
        return value
    ...
    @property
    def flanks(self) -> 'List[_968.CylindricalGearSetFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_968.CylindricalGearSetFlankDesign))
        return value

    @property
    def micro_geometries(self) -> 'List[_1041.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_1041.CylindricalGearSetMicroGeometry))
        return value

    @property
    def both_flanks(self) -> '_968.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_968.CylindricalGearSetFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None

    @property
    def manufacturing_configurations(self) -> 'List[_579.CylindricalSetManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_579.CylindricalSetManufacturingConfig))
        return value
    ...
    def set_active_manufacturing_configuration(self, value: '_579.CylindricalSetManufacturingConfig'):
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_579.CylindricalSetManufacturingConfig':
    ...
    def delete_manufacturing_configuration(self, config: '_579.CylindricalSetManufacturingConfig'):
    ...
    def create_optimiser(self, duty_cycle: '_426.CylindricalGearSetDutyCycleRating') -> '_969.CylindricalGearSetMacroGeometryOptimiser':
    ...
    def add_new_micro_geometry(self) -> '_1041.CylindricalGearSetMicroGeometry':
    ...
    def delete_micro_geometry(self, micro_geometry: '_1041.CylindricalGearSetMicroGeometry'):
    ...
    def set_active_micro_geometry(self, value: '_1041.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_1041.CylindricalGearSetMicroGeometry':
