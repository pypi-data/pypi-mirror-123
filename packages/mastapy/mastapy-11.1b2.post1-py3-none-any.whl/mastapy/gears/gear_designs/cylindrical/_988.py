...
from mastapy.gears.gear_designs.cylindrical import _942, _986
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_942.CreateNewSuitableCutterOption':
        ...
        return constructor.new(_942.CreateNewSuitableCutterOption)(value) if value is not None else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_942.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CreateNewSuitableCutters = value

    @property
    def use_as_design_mode_geometry(self) -> '_942.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_942.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAsDesignModeGeometry = value

    @property
    def gears(self) -> 'List[_986.GearManufacturingConfigSetupViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_986.GearManufacturingConfigSetupViewModel))
        return value
