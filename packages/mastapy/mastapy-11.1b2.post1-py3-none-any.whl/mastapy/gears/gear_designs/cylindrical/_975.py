...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_976.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_976.CylindricalMeshedGearFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_976.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_976.CylindricalMeshedGearFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def flanks(self) -> 'List[_976.CylindricalMeshedGearFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_976.CylindricalMeshedGearFlank))
        return value

    @property
    def both_flanks(self) -> '_976.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_976.CylindricalMeshedGearFlank)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
