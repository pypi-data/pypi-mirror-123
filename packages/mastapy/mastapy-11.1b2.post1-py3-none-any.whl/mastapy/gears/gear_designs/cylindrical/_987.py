...
class GearSetFCAImportSetup(_0.APIBase):
    ...
    @property
    def meshes(self) -> 'List[_959.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_959.CylindricalGearMeshDesign))
        return value
