...
from mastapy.gears.gear_designs.conical import _1099, _1087
...
class KlingelnbergConicalGearSetDesign(_1087.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1099.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1099.KlingelnbergFinishingMethods)(value) if value is not None else None

    @gear_finish.setter
    def gear_finish(self, value: '_1099.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_922.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_922.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_922.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_922.KlingelnbergConicalGearMeshDesign))
        return value
