...
class ConicalGearSetDesign(_890.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_1086.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1086.ConicalGearMeshDesign))
        return value
