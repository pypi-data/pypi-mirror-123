...
from mastapy.utility.reporting_property_framework import _1501
...
from mastapy.gears.analysis import _1145
...
TAnalysis = TypeVar('TAnalysis', bound='_1145.AbstractGearSetAnalysis')
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def select_chart_type(self) -> '_1334.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new(_1334.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value is not None else None

    @select_chart_type.setter
    def select_chart_type(self, value: '_1334.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SelectChartType = value

    @property
    def chart_type(self) -> '_1501.CustomChartType':
        ...
        return constructor.new(_1501.CustomChartType)(value) if value is not None else None
    ...
    @property
    def optimiser(self) -> '_849.DesignSpaceSearchBase[TAnalysis, TCandidate]':
        ...
        if _849.DesignSpaceSearchBase[TAnalysis, TCandidate].TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_cylindrical_gear_set_pareto_optimiser(self) -> '_848.CylindricalGearSetParetoOptimiser':
        ...
        if _848.CylindricalGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_face_gear_set_pareto_optimiser(self) -> '_851.FaceGearSetParetoOptimiser':
        ...
        if _851.FaceGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_gear_set_pareto_optimiser(self) -> '_855.GearSetParetoOptimiser':
        ...
        if _855.GearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_hypoid_gear_set_pareto_optimiser(self) -> '_856.HypoidGearSetParetoOptimiser':
        ...
        if _856.HypoidGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_design_space_search(self) -> '_859.MicroGeometryDesignSpaceSearch':
        ...
        if _859.MicroGeometryDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_gear_set_design_space_search(self) -> '_862.MicroGeometryGearSetDesignSpaceSearch':
        ...
        if _862.MicroGeometryGearSetDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_spiral_bevel_gear_set_pareto_optimiser(self) -> '_881.SpiralBevelGearSetParetoOptimiser':
        ...
        if _881.SpiralBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_straight_bevel_gear_set_pareto_optimiser(self) -> '_882.StraightBevelGearSetParetoOptimiser':
        ...
        if _882.StraightBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def bars(self) -> 'List[_845.BarForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_845.BarForPareto)[TAnalysis, TCandidate])
        return value

    @property
    def input_sliders(self) -> 'List[_857.InputSliderForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSliders, constructor.new(_857.InputSliderForPareto)[TAnalysis, TCandidate])
        return value
