...
class FaceGearSetParetoOptimiser(_855.GearSetParetoOptimiser):
    '''FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_935.FaceGearSetDesign':
        ...
        return constructor.new(_935.FaceGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_935.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_935.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_935.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_935.FaceGearSetDesign))
        return value
