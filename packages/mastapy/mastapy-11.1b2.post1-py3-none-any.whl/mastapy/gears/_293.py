...
class GearSetDesignGroup(_0.APIBase):
    ...
    def misalignment_contact_pattern_enhancement(self) -> '_439.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_439.MisalignmentContactPatternEnhancements)(value) if value is not None else None
    ...
    def default_rough_toleranced_metal_measurement(self) -> '_1020.TolerancedMetalMeasurements':
        ...
        return constructor.new(_1020.TolerancedMetalMeasurements)(value) if value is not None else None
    ...
    def settings(self) -> '_424.CylindricalGearRatingSettings':
        ...
        return constructor.new(_424.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings is not None else None
