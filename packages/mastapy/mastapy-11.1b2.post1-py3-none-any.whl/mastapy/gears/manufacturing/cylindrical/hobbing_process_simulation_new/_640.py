...
T = TypeVar('T', bound='_639.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_636.ProcessLeadCalculation':
        ...
        return constructor.new(_636.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation is not None else None

    @property
    def profile_calculation(self) -> '_638.ProcessProfileCalculation':
        ...
        return constructor.new(_638.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation is not None else None

    @property
    def pitch_calculation(self) -> '_637.ProcessPitchCalculation':
        ...
        return constructor.new(_637.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation is not None else None

    @property
    def gear_tooth_shape_calculation(self) -> '_635.ProcessGearShape':
        ...
        return constructor.new(_635.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation is not None else None

    @property
    def total_modification_calculation(self) -> '_642.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_642.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation is not None else None
