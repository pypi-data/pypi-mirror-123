...
class ProcessProfileCalculation(_0.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_616.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_616.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation is not None else None

    @property
    def left_flank_accuracy_calculation(self) -> '_616.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_616.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation is not None else None
