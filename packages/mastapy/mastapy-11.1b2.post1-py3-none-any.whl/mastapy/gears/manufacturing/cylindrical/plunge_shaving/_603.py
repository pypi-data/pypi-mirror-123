...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _610, _596
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1271.Range':
        ...
        if _1271.Range.TYPE not in self.wrapped.CalculatedConjugateFaceWidth.__class__.__mro__:
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_944.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_944.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails is not None else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_610.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_610.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_596.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_596.CalculationError))
        return value
