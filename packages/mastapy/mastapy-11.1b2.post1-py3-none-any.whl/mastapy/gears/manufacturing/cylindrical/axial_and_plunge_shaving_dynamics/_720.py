...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _716, _715, _719
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _658
from mastapy.gears.manufacturing.cylindrical.cutters import _687, _682
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_716.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_716.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 is not None else None

    @property
    def accuracy_level_iso7(self) -> '_716.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_716.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 is not None else None

    @property
    def designed_gear(self) -> '_658.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_658.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear is not None else None

    @property
    def shaver(self) -> '_687.CylindricalGearShaver':
        ...
        if _687.CylindricalGearShaver.TYPE not in self.wrapped.Shaver.__class__.__mro__:
    ...
    @property
    def life_shaver(self) -> '_687.CylindricalGearShaver':
        ...
        if _687.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
    ...
    @property
    def new_cutter_start_of_shaving(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving is not None else None

    @property
    def life_cutter_start_of_shaving(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving is not None else None
