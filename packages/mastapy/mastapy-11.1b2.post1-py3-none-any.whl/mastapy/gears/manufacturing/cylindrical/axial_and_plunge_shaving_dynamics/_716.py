...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _717
...
class RollAngleRangeRelativeToAccuracy(_0.APIBase):
    ...
    @property
    def roll_angle_range(self) -> 'List[_717.RollAngleReportObject]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollAngleRange, constructor.new(_717.RollAngleReportObject))
        return value
