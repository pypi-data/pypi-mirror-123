...
class CustomisableEdgeProfile(_0.APIBase):
    ...
    @property
    def customised_cutting_edge_profile(self) -> 'List[_691.MutatableCommon]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CustomisedCuttingEdgeProfile, constructor.new(_691.MutatableCommon))
        return value
