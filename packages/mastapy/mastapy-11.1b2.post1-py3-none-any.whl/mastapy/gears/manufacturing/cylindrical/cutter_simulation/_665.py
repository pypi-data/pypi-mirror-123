...
class GearCutterSimulation(_0.APIBase):
    ...
    @property
    def cutter_simulation_of_type_finish_cutter_simulation(self) -> '_662.FinishCutterSimulation':
        ...
        if _662.FinishCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def cutter_simulation_of_type_rough_cutter_simulation(self) -> '_670.RoughCutterSimulation':
        ...
        if _670.RoughCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def minimum_thickness(self) -> '_657.CutterSimulationCalc':
        ...
        if _657.CutterSimulationCalc.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_664.FormWheelGrindingSimulationCalculator':
        ...
        if _664.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_hob_simulation_calculator(self) -> '_666.HobSimulationCalculator':
        ...
        if _666.HobSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_rack_simulation_calculator(self) -> '_669.RackSimulationCalculator':
        ...
        if _669.RackSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaper_simulation_calculator(self) -> '_671.ShaperSimulationCalculator':
        ...
        if _671.ShaperSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaving_simulation_calculator(self) -> '_672.ShavingSimulationCalculator':
        ...
        if _672.ShavingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_virtual_simulation_calculator(self) -> '_673.VirtualSimulationCalculator':
        ...
        if _673.VirtualSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_674.WormGrinderSimulationCalculator':
        ...
        if _674.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def average_thickness(self) -> '_657.CutterSimulationCalc':
        ...
        if _657.CutterSimulationCalc.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_664.FormWheelGrindingSimulationCalculator':
        ...
        if _664.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_hob_simulation_calculator(self) -> '_666.HobSimulationCalculator':
        ...
        if _666.HobSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_rack_simulation_calculator(self) -> '_669.RackSimulationCalculator':
        ...
        if _669.RackSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaper_simulation_calculator(self) -> '_671.ShaperSimulationCalculator':
        ...
        if _671.ShaperSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaving_simulation_calculator(self) -> '_672.ShavingSimulationCalculator':
        ...
        if _672.ShavingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_virtual_simulation_calculator(self) -> '_673.VirtualSimulationCalculator':
        ...
        if _673.VirtualSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_674.WormGrinderSimulationCalculator':
        ...
        if _674.WormGrinderSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness(self) -> '_657.CutterSimulationCalc':
        ...
        if _657.CutterSimulationCalc.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_664.FormWheelGrindingSimulationCalculator':
        ...
        if _664.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_hob_simulation_calculator(self) -> '_666.HobSimulationCalculator':
        ...
        if _666.HobSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_rack_simulation_calculator(self) -> '_669.RackSimulationCalculator':
        ...
        if _669.RackSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaper_simulation_calculator(self) -> '_671.ShaperSimulationCalculator':
        ...
        if _671.ShaperSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaving_simulation_calculator(self) -> '_672.ShavingSimulationCalculator':
        ...
        if _672.ShavingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_virtual_simulation_calculator(self) -> '_673.VirtualSimulationCalculator':
        ...
        if _673.VirtualSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_674.WormGrinderSimulationCalculator':
        ...
        if _674.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def smallest_active_profile(self) -> '_657.CutterSimulationCalc':
        ...
        if _657.CutterSimulationCalc.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_form_wheel_grinding_simulation_calculator(self) -> '_664.FormWheelGrindingSimulationCalculator':
        ...
        if _664.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_hob_simulation_calculator(self) -> '_666.HobSimulationCalculator':
        ...
        if _666.HobSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_rack_simulation_calculator(self) -> '_669.RackSimulationCalculator':
        ...
        if _669.RackSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaper_simulation_calculator(self) -> '_671.ShaperSimulationCalculator':
        ...
        if _671.ShaperSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaving_simulation_calculator(self) -> '_672.ShavingSimulationCalculator':
        ...
        if _672.ShavingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_virtual_simulation_calculator(self) -> '_673.VirtualSimulationCalculator':
        ...
        if _673.VirtualSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_worm_grinder_simulation_calculator(self) -> '_674.WormGrinderSimulationCalculator':
        ...
        if _674.WormGrinderSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def minimum_thickness_virtual(self) -> '_673.VirtualSimulationCalculator':
        ...
        return constructor.new(_673.VirtualSimulationCalculator)(self.wrapped.MinimumThicknessVirtual) if self.wrapped.MinimumThicknessVirtual is not None else None

    @property
    def average_thickness_virtual(self) -> '_673.VirtualSimulationCalculator':
        ...
        return constructor.new(_673.VirtualSimulationCalculator)(self.wrapped.AverageThicknessVirtual) if self.wrapped.AverageThicknessVirtual is not None else None

    @property
    def maximum_thickness_virtual(self) -> '_673.VirtualSimulationCalculator':
        ...
        return constructor.new(_673.VirtualSimulationCalculator)(self.wrapped.MaximumThicknessVirtual) if self.wrapped.MaximumThicknessVirtual is not None else None

    @property
    def thickness_calculators(self) -> 'List[_657.CutterSimulationCalc]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThicknessCalculators, constructor.new(_657.CutterSimulationCalc))
        return value

    @property
    def virtual_thickness_calculators(self) -> 'List[_673.VirtualSimulationCalculator]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VirtualThicknessCalculators, constructor.new(_673.VirtualSimulationCalculator))
        return value

    @property
    def gear_mesh_cutter_simulations(self) -> 'List[_660.CylindricalManufacturedRealGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulations, constructor.new(_660.CylindricalManufacturedRealGearInMesh))
        return value

    @property
    def gear_mesh_cutter_simulations_virtual(self) -> 'List[_661.CylindricalManufacturedVirtualGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulationsVirtual, constructor.new(_661.CylindricalManufacturedVirtualGearInMesh))
        return value
