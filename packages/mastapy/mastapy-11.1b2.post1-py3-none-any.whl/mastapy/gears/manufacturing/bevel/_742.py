...
from mastapy.gears.manufacturing.bevel.cutters import _767, _768
...
class ConicalPinionManufacturingConfig(_730.ConicalGearManufacturingConfig):
    '''ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self) -> '_739.ConicalMeshManufacturingConfig':
        ...
        return constructor.new(_739.ConicalMeshManufacturingConfig)(self.wrapped.MeshConfig) if self.wrapped.MeshConfig is not None else None

    @property
    def pinion_concave_ob_configuration(self) -> '_735.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_735.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration is not None else None

    @property
    def pinion_convex_ib_configuration(self) -> '_735.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_735.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration is not None else None

    @property
    def pinion_finish_cutter(self) -> '_767.PinionFinishCutter':
        ...
        return constructor.new(_767.PinionFinishCutter)(self.wrapped.PinionFinishCutter) if self.wrapped.PinionFinishCutter is not None else None

    @property
    def pinion_rough_cutter(self) -> '_768.PinionRoughCutter':
        ...
        return constructor.new(_768.PinionRoughCutter)(self.wrapped.PinionRoughCutter) if self.wrapped.PinionRoughCutter is not None else None

    @property
    def pinion_cutter_parameters_concave(self) -> '_760.PinionFinishMachineSettings':
        ...
        if _760.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_755.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _755.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_756.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _756.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_conical_machine_settings_specified(self) -> '_758.PinionConicalMachineSettingsSpecified':
        ...
        if _758.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_761.PinionHypoidFormateTiltMachineSettings':
        ...
        if _761.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_762.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _762.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_machine_settings_smt(self) -> '_763.PinionMachineSettingsSMT':
        ...
        if _763.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex(self) -> '_760.PinionFinishMachineSettings':
        ...
        if _760.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_755.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _755.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_756.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _756.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_conical_machine_settings_specified(self) -> '_758.PinionConicalMachineSettingsSpecified':
        ...
        if _758.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_761.PinionHypoidFormateTiltMachineSettings':
        ...
        if _761.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_762.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _762.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_machine_settings_smt(self) -> '_763.PinionMachineSettingsSMT':
        ...
        if _763.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_rough_machine_setting(self) -> '_764.PinionRoughMachineSetting':
        ...
        return constructor.new(_764.PinionRoughMachineSetting)(self.wrapped.PinionRoughMachineSetting) if self.wrapped.PinionRoughMachineSetting is not None else None
