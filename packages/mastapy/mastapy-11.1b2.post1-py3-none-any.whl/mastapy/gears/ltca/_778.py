...
from mastapy.gears.cylindrical import _1138, _1137
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_797.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_797.CylindricalGearLoadDistributionAnalysis)(self.wrapped.GearLoadDistributionAnalysis) if self.wrapped.GearLoadDistributionAnalysis else None

    @property
    def other_gear_load_distribution_analysis(self) -> '_797.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_797.CylindricalGearLoadDistributionAnalysis)(self.wrapped.OtherGearLoadDistributionAnalysis) if self.wrapped.OtherGearLoadDistributionAnalysis else None

    @property
    def contact_charts(self) -> '_1138.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_1138.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1137.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1137.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_777.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1296.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_777.ContactResultType', include_tip_contact: 'bool') -> '_1296.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_777.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
