...
from mastapy.utility.databases import _1580
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self) -> '_1580.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1580.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey is not None else None

    @database_key.setter
    def database_key(self, value: '_1580.NamedKey'):
