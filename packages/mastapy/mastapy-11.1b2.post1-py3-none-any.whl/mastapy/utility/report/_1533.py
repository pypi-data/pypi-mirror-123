...
from mastapy.html import _271
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.report import _1516
...
class CustomReportText(_1516.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_271.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_271.HeadingType)(value) if value is not None else None

    @heading_type.setter
    def heading_type(self, value: '_271.HeadingType'):
