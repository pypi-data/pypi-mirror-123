...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @property
    def version_to_copy(self) -> '_1377.SystemDirectory':
        ...
        return constructor.new(_1377.SystemDirectory)(self.wrapped.VersionToCopy) if self.wrapped.VersionToCopy is not None else None

    @property
    def current_version(self) -> '_1377.SystemDirectory':
        ...
        return constructor.new(_1377.SystemDirectory)(self.wrapped.CurrentVersion) if self.wrapped.CurrentVersion is not None else None
