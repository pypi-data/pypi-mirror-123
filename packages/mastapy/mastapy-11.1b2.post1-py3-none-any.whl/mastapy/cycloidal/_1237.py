...
from mastapy.cycloidal import _1244, _1238, _1243
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1244.RingPinsDesign':
        ...
        return constructor.new(_1244.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins is not None else None

    @property
    def discs(self) -> 'List[_1238.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1238.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1243.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1243.NamedDiscPhase))
        return value
