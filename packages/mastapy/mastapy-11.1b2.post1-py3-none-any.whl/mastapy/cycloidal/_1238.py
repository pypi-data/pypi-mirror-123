...
from mastapy.cycloidal import _1241
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def modifications_specification(self) -> '_1241.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1241.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification is not None else None
