...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self) -> '_3732.RotorDynamicsDrawStyle':
        ...
        if _3732.RotorDynamicsDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_steady_state_synchronous_response_draw_style(self) -> '_3316.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3316.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_stability_analysis_draw_style(self) -> '_3577.StabilityAnalysisDrawStyle':
        ...
        if _3577.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_critical_speed_analysis_draw_style(self) -> '_6271.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6271.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
