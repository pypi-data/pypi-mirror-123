...
from mastapy.utility.enums import _1570
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1570.BearingForceArrowOption':
        ...
        return constructor.new(_1570.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1570.BearingForceArrowOption'):
