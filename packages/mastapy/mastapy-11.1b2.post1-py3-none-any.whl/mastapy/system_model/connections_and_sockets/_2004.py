...
from mastapy.system_model.connections_and_sockets import _1991
...
class PlanetarySocketBase(_1991.CylindricalSocket):
    '''PlanetarySocketBase
    ...
    def planetary_details(self) -> '_305.PlanetaryDetail':
        ...
        return constructor.new(_305.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails is not None else None
