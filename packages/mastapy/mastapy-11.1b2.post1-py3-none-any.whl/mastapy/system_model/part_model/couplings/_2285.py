...
from mastapy.system_model.part_model.couplings import _2287, _2290
...
class Clutch(_2290.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2287.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2287.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2287.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5095.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5095.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5095.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def angular_speed_temperature_grid(self) -> '_1347.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'AngularSpeedTemperatureGrid' is the original name of this property.'''

        return constructor.new(_1347.GriddedSurfaceAccessor)(self.wrapped.AngularSpeedTemperatureGrid) if self.wrapped.AngularSpeedTemperatureGrid else None

    @angular_speed_temperature_grid.setter
    def angular_speed_temperature_grid(self, value: '_1347.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.AngularSpeedTemperatureGrid = value

    @property
    def linear_speed_temperature_grid(self) -> '_1347.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'LinearSpeedTemperatureGrid' is the original name of this property.'''

        return constructor.new(_1347.GriddedSurfaceAccessor)(self.wrapped.LinearSpeedTemperatureGrid) if self.wrapped.LinearSpeedTemperatureGrid else None

    @linear_speed_temperature_grid.setter
    def linear_speed_temperature_grid(self, value: '_1347.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def flow_rate_vs_speed(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'FlowRateVsSpeed' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.FlowRateVsSpeed) if self.wrapped.FlowRateVsSpeed else None

    @flow_rate_vs_speed.setter
    def flow_rate_vs_speed(self, value: '_1315.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.FlowRateVsSpeed = value

    @property
    def clutch_connection(self) -> '_2051.ClutchConnection':
        ...
        return constructor.new(_2051.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
