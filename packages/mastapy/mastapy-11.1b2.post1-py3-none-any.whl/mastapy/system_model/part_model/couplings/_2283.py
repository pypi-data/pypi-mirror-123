...
from mastapy.system_model.part_model.couplings import _2284, _2297
...
class BeltDrive(_2184.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2284.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2284.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2284.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2297.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2297.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1977.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1977.BeltConnection))
        return value
