...
from mastapy.cycloidal import _1238, _1239, _1245
from mastapy.system_model.part_model import _2175, _2151
...
from mastapy.detailed_rigid_connectors.splines import _1200
from mastapy.bolts import _1248, _1252
from mastapy.system_model.connections_and_sockets.cycloidal import _2054
...
class CycloidalDisc(_2151.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1238.CycloidalDiscDesign':
        ...
        return constructor.new(_1238.CycloidalDiscDesign)(self.wrapped.CycloidalDiscDesign) if self.wrapped.CycloidalDiscDesign is not None else None

    @property
    def load_sharing_settings(self) -> '_2175.LoadSharingSettings':
        ...
        return constructor.new(_2175.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings is not None else None
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2054.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2054.CycloidalDiscPlanetaryBearingSocket))
        return value
