...
class PowerLoad(_2193.VirtualComponent):
    ...
    def engine_torque_grid(self) -> '_1349.GriddedSurfaceAccessor':
        ...
        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.EngineTorqueGrid) if self.wrapped.EngineTorqueGrid is not None else None
    ...
    def engine_fuel_consumption_grid(self) -> '_1349.GriddedSurfaceAccessor':
        ...
        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.EngineFuelConsumptionGrid) if self.wrapped.EngineFuelConsumptionGrid is not None else None
    ...
    def single_blade_details(self) -> '_2195.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2195.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails is not None else None
    ...
    def electric_machine_detail(self) -> '_6558.ElectricMachineDetail':
        ...
        return constructor.new(_6558.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail is not None else None
