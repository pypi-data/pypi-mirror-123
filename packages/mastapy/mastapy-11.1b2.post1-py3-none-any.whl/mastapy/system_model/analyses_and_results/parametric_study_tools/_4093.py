...
from mastapy.system_model.analyses_and_results.static_loads import _6505, _6618
from mastapy.system_model import _1928, _1924
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4095, _4096
from mastapy.system_model.analyses_and_results import _2361
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6618.ParametricStudyType':
        ...
        return constructor.new(_6618.ParametricStudyType)(value) if value is not None else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6618.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1928.ExternalFullFELoader':
        ...
        return constructor.new(_1928.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader is not None else None

    @property
    def step_results(self) -> 'List[_4095.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4095.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4096.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4096.ParametricStudyVariable))
        return value

    @property
    def parametric_study_logging_variables(self) -> 'List[_2361.AnalysisCaseVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParametricStudyLoggingVariables, constructor.new(_2361.AnalysisCaseVariable))
        return value
    ...
    def data_logger_for(self, design_entity: '_1924.DesignEntity') -> '_1356.DataLogger':
    ...
    def add_study_variable(self, design_entity: '_1924.DesignEntity', path: 'List[str]') -> '_4096.ParametricStudyVariable':
    ...
    def remove_study_variable(self, study_variable: '_4096.ParametricStudyVariable'):
    ...
    def move_study_variable_up(self, study_variable: '_4096.ParametricStudyVariable'):
    ...
    def move_study_variable_down(self, study_variable: '_4096.ParametricStudyVariable'):
    ...
    def add_logging_variable(self, design_entity: '_1924.DesignEntity', path: 'List[str]') -> '_2361.AnalysisCaseVariable':
    ...
    def remove_logging_variable(self, analysis_variable: '_2361.AnalysisCaseVariable'):
