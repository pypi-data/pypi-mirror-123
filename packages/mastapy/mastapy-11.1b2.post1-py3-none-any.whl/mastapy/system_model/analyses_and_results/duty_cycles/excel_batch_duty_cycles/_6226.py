...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6230, _6227, _6229
from mastapy.utility import _1376
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6230.MASTAFileDetails':
        ...
        return constructor.new(_6230.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails is not None else None

    @property
    def excel_file_details(self) -> '_6227.ExcelFileDetails':
        ...
        return constructor.new(_6227.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails is not None else None

    @property
    def working_folder(self) -> '_1376.SelectableFolder':
        ...
        return constructor.new(_1376.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder is not None else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6229.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6229.ExcelSheetDesignStateSelector))
        return value
