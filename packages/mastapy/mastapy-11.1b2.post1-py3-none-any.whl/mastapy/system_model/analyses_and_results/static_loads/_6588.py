...
from mastapy.system_model.analyses_and_results.static_loads import _6616, _6590, _6566
...
class HarmonicLoadDataExcelImport(_6590.HarmonicLoadDataImportBase['_6566.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6616.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6616.NamedSpeed))
        return value
