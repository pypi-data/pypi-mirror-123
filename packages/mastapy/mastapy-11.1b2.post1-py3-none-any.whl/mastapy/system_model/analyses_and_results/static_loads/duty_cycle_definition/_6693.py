...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6683, _6694, _6685, _6682,
    _6686, _6688, _6695, _6692,
    _6684, _6687, _6681
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6598.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6598.ImportType)(value) if value is not None else None

    @import_type.setter
    def import_type(self, value: '_6598.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6694.TimeStepInputOptions':
        ...
        return constructor.new(_6694.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput is not None else None

    @property
    def gear_ratio_options(self) -> '_6685.GearRatioInputOptions':
        ...
        return constructor.new(_6685.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions is not None else None

    @property
    def design_state_options(self) -> '_6682.DesignStateOptions':
        ...
        return constructor.new(_6682.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions is not None else None

    @property
    def load_case_name_inputs(self) -> '_6686.LoadCaseNameOptions':
        ...
        return constructor.new(_6686.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs is not None else None

    @property
    def file_inputs(self) -> 'List[_6688.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6688.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6695.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6695.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6692.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6692.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6684.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6684.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6687.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6687.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6681.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6681.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1568.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1568.ColumnTitle))
        return value
