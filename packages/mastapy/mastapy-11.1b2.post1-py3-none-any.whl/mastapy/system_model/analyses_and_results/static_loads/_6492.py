...
from mastapy.system_model.analyses_and_results import (
    _2359, _2354, _2334, _2345,
    _2353, _2337, _2356, _2348,
    _2338, _2355, _2336, _2342,
    _2396, _2333
)
...
from mastapy.system_model.analyses_and_results.load_case_groups import _5359, _5360, _5361
from mastapy.system_model.analyses_and_results.static_loads import _6505, _6491
...
class StaticLoadCase(_6491.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def system_deflection(self) -> '_2359.SystemDeflectionAnalysis':
        ...
        return constructor.new(_2359.SystemDeflectionAnalysis)(self.wrapped.SystemDeflection) if self.wrapped.SystemDeflection is not None else None

    @property
    def power_flow(self) -> '_2354.PowerFlowAnalysis':
        ...
        return constructor.new(_2354.PowerFlowAnalysis)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow is not None else None

    @property
    def advanced_system_deflection(self) -> '_2334.AdvancedSystemDeflectionAnalysis':
        ...
        return constructor.new(_2334.AdvancedSystemDeflectionAnalysis)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection is not None else None
    ...
    def harmonic_analysis(self) -> '_2345.HarmonicAnalysis':
        ...
        return constructor.new(_2345.HarmonicAnalysis)(self.wrapped.HarmonicAnalysis) if self.wrapped.HarmonicAnalysis is not None else None

    @property
    def parametric_study_tool(self) -> '_2353.ParametricStudyToolAnalysis':
        ...
        return constructor.new(_2353.ParametricStudyToolAnalysis)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool is not None else None

    @property
    def compound_parametric_study_tool(self) -> '_2337.CompoundParametricStudyToolAnalysis':
        ...
        return constructor.new(_2337.CompoundParametricStudyToolAnalysis)(self.wrapped.CompoundParametricStudyTool) if self.wrapped.CompoundParametricStudyTool is not None else None

    @property
    def steady_state_synchronous_response(self) -> '_2356.SteadyStateSynchronousResponseAnalysis':
        ...
        return constructor.new(_2356.SteadyStateSynchronousResponseAnalysis)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse is not None else None
    ...
    def modal_analysis(self) -> '_2348.ModalAnalysis':
        ...
        return constructor.new(_2348.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis is not None else None

    @property
    def critical_speed_analysis(self) -> '_2338.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2338.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysis) if self.wrapped.CriticalSpeedAnalysis is not None else None

    @property
    def stability_analysis(self) -> '_2355.StabilityAnalysis':
        ...
        return constructor.new(_2355.StabilityAnalysis)(self.wrapped.StabilityAnalysis) if self.wrapped.StabilityAnalysis is not None else None
    ...
    def advanced_time_stepping_analysis_for_modulation(self) -> '_2336.AdvancedTimeSteppingAnalysisForModulation':
        ...
        return constructor.new(_2336.AdvancedTimeSteppingAnalysisForModulation)(self.wrapped.AdvancedTimeSteppingAnalysisForModulation) if self.wrapped.AdvancedTimeSteppingAnalysisForModulation is not None else None

    @property
    def dynamic_model_for_modal_analysis(self) -> '_2342.DynamicModelForModalAnalysis':
        ...
        return constructor.new(_2342.DynamicModelForModalAnalysis)(self.wrapped.DynamicModelForModalAnalysis) if self.wrapped.DynamicModelForModalAnalysis is not None else None
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_306.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_306.PlanetaryRatingLoadSharingOption)(value) if value is not None else None

    @planetary_rating_load_sharing_method.setter
    def planetary_rating_load_sharing_method(self, value: '_306.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6965.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6965.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions is not None else None

    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2396.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2396.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions is not None else None
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5719.HarmonicAnalysisOptions':
        ...
        if _5719.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptionsForATSAM.__class__.__mro__:
    ...
    @property
    def clutch_engagements(self) -> 'List[_5359.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5359.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5360.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5360.ConceptSynchroGearEngagementStatus))
        return value

    @property
    def design_state_load_case_group(self) -> '_5361.DesignState':
        ...
        return constructor.new(_5361.DesignState)(self.wrapped.DesignStateLoadCaseGroup) if self.wrapped.DesignStateLoadCaseGroup is not None else None

    def analysis_of(self, analysis_type: '_6505.AnalysisType') -> '_2333.SingleAnalysis':
    ...
    def duplicate(self, new_design_state_group: '_5361.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
