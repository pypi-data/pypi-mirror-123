...
from mastapy.system_model.analyses_and_results.static_loads import _6581, _6586
...
class GearSetHarmonicLoadData(_6586.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6581.GearMeshTEOrderType':
        ...
        return constructor.new(_6581.GearMeshTEOrderType)(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6581.GearMeshTEOrderType'):
