...
from mastapy.system_model.analyses_and_results.modal_analyses import _4812, _4847, _4872
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2392, _2397, _2399, _2402,
    _2404, _2409, _2411, _2415,
    _2421, _2423, _2427, _2433,
    _2436, _2437, _2444, _2445,
    _2446, _2457, _2460, _2462,
    _2466, _2471, _2474, _2477,
    _2490, _2499, _2502, _2508,
    _2510, _2514, _2516, _2519,
    _2526, _2532, _2539, _2542
)
...
class AbstractAssemblyModalAnalysis(_4872.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4812.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4812.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4847.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4847.GearMeshModalAnalysis))
        return value

    @property
    def system_deflection_results(self) -> '_2392.AbstractAssemblySystemDeflection':
        ...
        if _2392.AbstractAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_agma_gleason_conical_gear_set_system_deflection(self) -> '_2397.AGMAGleasonConicalGearSetSystemDeflection':
        ...
        if _2397.AGMAGleasonConicalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_assembly_system_deflection(self) -> '_2399.AssemblySystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_belt_drive_system_deflection(self) -> '_2402.BeltDriveSystemDeflection':
        ...
        if _2402.BeltDriveSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_bevel_differential_gear_set_system_deflection(self) -> '_2404.BevelDifferentialGearSetSystemDeflection':
        ...
        if _2404.BevelDifferentialGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_bevel_gear_set_system_deflection(self) -> '_2409.BevelGearSetSystemDeflection':
        ...
        if _2409.BevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_bolted_joint_system_deflection(self) -> '_2411.BoltedJointSystemDeflection':
        ...
        if _2411.BoltedJointSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_clutch_system_deflection(self) -> '_2415.ClutchSystemDeflection':
        ...
        if _2415.ClutchSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_concept_coupling_system_deflection(self) -> '_2421.ConceptCouplingSystemDeflection':
        ...
        if _2421.ConceptCouplingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_concept_gear_set_system_deflection(self) -> '_2423.ConceptGearSetSystemDeflection':
        ...
        if _2423.ConceptGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_conical_gear_set_system_deflection(self) -> '_2427.ConicalGearSetSystemDeflection':
        ...
        if _2427.ConicalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_coupling_system_deflection(self) -> '_2433.CouplingSystemDeflection':
        ...
        if _2433.CouplingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cvt_system_deflection(self) -> '_2436.CVTSystemDeflection':
        ...
        if _2436.CVTSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cycloidal_assembly_system_deflection(self) -> '_2437.CycloidalAssemblySystemDeflection':
        ...
        if _2437.CycloidalAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_set_system_deflection(self) -> '_2444.CylindricalGearSetSystemDeflection':
        ...
        if _2444.CylindricalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_set_system_deflection_timestep(self) -> '_2445.CylindricalGearSetSystemDeflectionTimestep':
        ...
        if _2445.CylindricalGearSetSystemDeflectionTimestep.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_set_system_deflection_with_ltca_results(self) -> '_2446.CylindricalGearSetSystemDeflectionWithLTCAResults':
        ...
        if _2446.CylindricalGearSetSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_face_gear_set_system_deflection(self) -> '_2457.FaceGearSetSystemDeflection':
        ...
        if _2457.FaceGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_flexible_pin_assembly_system_deflection(self) -> '_2460.FlexiblePinAssemblySystemDeflection':
        ...
        if _2460.FlexiblePinAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_gear_set_system_deflection(self) -> '_2462.GearSetSystemDeflection':
        ...
        if _2462.GearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_hypoid_gear_set_system_deflection(self) -> '_2466.HypoidGearSetSystemDeflection':
        ...
        if _2466.HypoidGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_conical_gear_set_system_deflection(self) -> '_2471.KlingelnbergCycloPalloidConicalGearSetSystemDeflection':
        ...
        if _2471.KlingelnbergCycloPalloidConicalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_system_deflection(self) -> '_2474.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
        ...
        if _2474.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_system_deflection(self) -> '_2477.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection':
        ...
        if _2477.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_part_to_part_shear_coupling_system_deflection(self) -> '_2490.PartToPartShearCouplingSystemDeflection':
        ...
        if _2490.PartToPartShearCouplingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_rolling_ring_assembly_system_deflection(self) -> '_2499.RollingRingAssemblySystemDeflection':
        ...
        if _2499.RollingRingAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_root_assembly_system_deflection(self) -> '_2502.RootAssemblySystemDeflection':
        ...
        if _2502.RootAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_specialised_assembly_system_deflection(self) -> '_2508.SpecialisedAssemblySystemDeflection':
        ...
        if _2508.SpecialisedAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_spiral_bevel_gear_set_system_deflection(self) -> '_2510.SpiralBevelGearSetSystemDeflection':
        ...
        if _2510.SpiralBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_spring_damper_system_deflection(self) -> '_2514.SpringDamperSystemDeflection':
        ...
        if _2514.SpringDamperSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_straight_bevel_diff_gear_set_system_deflection(self) -> '_2516.StraightBevelDiffGearSetSystemDeflection':
        ...
        if _2516.StraightBevelDiffGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_straight_bevel_gear_set_system_deflection(self) -> '_2519.StraightBevelGearSetSystemDeflection':
        ...
        if _2519.StraightBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_synchroniser_system_deflection(self) -> '_2526.SynchroniserSystemDeflection':
        ...
        if _2526.SynchroniserSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_torque_converter_system_deflection(self) -> '_2532.TorqueConverterSystemDeflection':
        ...
        if _2532.TorqueConverterSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_worm_gear_set_system_deflection(self) -> '_2539.WormGearSetSystemDeflection':
        ...
        if _2539.WormGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_zerol_bevel_gear_set_system_deflection(self) -> '_2542.ZerolBevelGearSetSystemDeflection':
        ...
        if _2542.ZerolBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
