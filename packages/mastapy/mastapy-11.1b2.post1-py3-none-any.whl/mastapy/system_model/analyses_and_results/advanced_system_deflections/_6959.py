...
from mastapy.system_model.part_model.gears import _2239
...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_791.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_791.UseAdvancedLTCAOptions)(value) if value else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_791.UseAdvancedLTCAOptions'):
