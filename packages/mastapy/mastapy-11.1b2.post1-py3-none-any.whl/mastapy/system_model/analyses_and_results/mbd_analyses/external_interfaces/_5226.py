...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_5146.InputSignalFilterLevel':
        ...
        return constructor.new(_5146.InputSignalFilterLevel)(value) if value is not None else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5146.InputSignalFilterLevel'):
