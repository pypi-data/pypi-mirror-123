...
class GearMeshHarmonicAnalysis(_5725.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2467.GearMeshSystemDeflection':
