...
from mastapy.system_model.fe import _2072, _2079
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2072.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2072.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2072.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2079.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2079.BearingRaceNodeLink))
        return value
