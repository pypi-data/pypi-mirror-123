...
from mastapy.bearings.bearing_results import _1673
from mastapy.bearings.bearing_results.rolling import _1701
...
class RollingBearingFrictionCoefficients(_1366.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    '''RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1673.EquivalentLoadFactors':
        ...
        return constructor.new(_1673.EquivalentLoadFactors)(self.wrapped.ISO14179StaticEquivalentLoadFactors) if self.wrapped.ISO14179StaticEquivalentLoadFactors is not None else None

    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1673.EquivalentLoadFactors':
        ...
        return constructor.new(_1673.EquivalentLoadFactors)(self.wrapped.ISO14179DynamicEquivalentLoadFactors) if self.wrapped.ISO14179DynamicEquivalentLoadFactors is not None else None

    @property
    def iso14179_settings(self) -> '_1701.ISO14179Settings':
        ...
        return constructor.new(_1701.ISO14179Settings)(self.wrapped.ISO14179Settings) if self.wrapped.ISO14179Settings is not None else None
