...
from mastapy.bearings.bearing_results.rolling.skf_module import _1797, _1815
...
class AdjustedSpeed(_1815.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1797.AdjustmentFactors':
        ...
        return constructor.new(_1797.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
