...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    @property
    def value_vs_time(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'ValueVsTime' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.ValueVsTime) if self.wrapped.ValueVsTime is not None else None

    @value_vs_time.setter
    def value_vs_time(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsTime = value

    @property
    def value_vs_angle(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'ValueVsAngle' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.ValueVsAngle) if self.wrapped.ValueVsAngle is not None else None

    @value_vs_angle.setter
    def value_vs_angle(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsAngle = value

    @property
    def value_vs_angle_and_speed(self) -> '_1349.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'ValueVsAngleAndSpeed' is the original name of this property.'''

        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.ValueVsAngleAndSpeed) if self.wrapped.ValueVsAngleAndSpeed is not None else None

    @value_vs_angle_and_speed.setter
    def value_vs_angle_and_speed(self, value: '_1349.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsAngleAndSpeed = value

    @property
    def value_vs_position(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'ValueVsPosition' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.ValueVsPosition) if self.wrapped.ValueVsPosition is not None else None

    @value_vs_position.setter
    def value_vs_position(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
