...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    def radiation_efficiency_curve(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.RadiationEfficiencyCurve) if self.wrapped.RadiationEfficiencyCurve is not None else None
