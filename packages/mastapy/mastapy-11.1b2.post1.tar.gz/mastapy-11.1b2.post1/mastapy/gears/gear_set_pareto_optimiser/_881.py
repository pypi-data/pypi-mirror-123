...
class SpiralBevelGearSetParetoOptimiser(_855.GearSetParetoOptimiser):
    '''SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_911.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_911.SpiralBevelGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_911.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_911.SpiralBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_911.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_911.SpiralBevelGearSetDesign))
        return value
