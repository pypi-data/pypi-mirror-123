...
class HypoidGearSetParetoOptimiser(_855.GearSetParetoOptimiser):
    '''HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_927.HypoidGearSetDesign':
        ...
        return constructor.new(_927.HypoidGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_927.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_927.HypoidGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_927.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_927.HypoidGearSetDesign))
        return value
