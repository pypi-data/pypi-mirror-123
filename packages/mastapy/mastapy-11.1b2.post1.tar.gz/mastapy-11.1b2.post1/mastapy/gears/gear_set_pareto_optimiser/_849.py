...
from mastapy.math_utility.optimisation import _1332, _1323, _1329
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_858.LargerOrSmaller':
        ...
        return constructor.new(_858.LargerOrSmaller)(value) if value is not None else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_858.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1332.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1332.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy is not None else None

    @property
    def optimisation_targets(self) -> 'List[_865.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_865.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_1323.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1323.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_883.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_883.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_847.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_847.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_880.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_880.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1329.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1329.ParetoOptimisationFilter))
        return value
