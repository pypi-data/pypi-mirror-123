...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_617.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_617.CentreDistanceOffsetMethod)(value) if value is not None else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_617.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_613.AnalysisMethod':
        ...
        return constructor.new(_613.AnalysisMethod)(value) if value is not None else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_613.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AnalysisSetting = value

    @property
    def user_specified_center_distance_offset_relative_to_cutter_height(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight) if self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight is not None else None

    @user_specified_center_distance_offset_relative_to_cutter_height.setter
    def user_specified_center_distance_offset_relative_to_cutter_height(self, value: '_1317.Vector2DListAccessor'):
    ...
    @property
    def cutter_mounting_error(self) -> '_644.RackMountingError':
        ...
        return constructor.new(_644.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError is not None else None

    @property
    def gear_mounting_error(self) -> '_619.GearMountingError':
        ...
        return constructor.new(_619.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError is not None else None

    @property
    def cutter_head_slide_error(self) -> '_618.CutterHeadSlideError':
        ...
        return constructor.new(_618.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError is not None else None
