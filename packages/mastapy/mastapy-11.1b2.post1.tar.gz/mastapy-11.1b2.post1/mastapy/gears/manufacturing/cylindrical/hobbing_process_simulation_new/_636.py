...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _614
...
class ProcessLeadCalculation(_0.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation is not None else None

    @property
    def left_flank_accuracy_calculation(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation is not None else None
