...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _673
...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_673.VirtualSimulationCalculator':
        ...
        return constructor.new(_673.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear is not None else None
