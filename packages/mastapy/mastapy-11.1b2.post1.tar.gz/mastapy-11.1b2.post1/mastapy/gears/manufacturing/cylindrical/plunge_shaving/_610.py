...
class ShaverPointOfInterest(_0.APIBase):
    ...
    @property
    def point_of_interest_on_the_gear(self) -> '_607.PointOfInterest':
        ...
        return constructor.new(_607.PointOfInterest)(self.wrapped.PointOfInterestOnTheGear) if self.wrapped.PointOfInterestOnTheGear is not None else None
