...
from mastapy.gears.manufacturing.cylindrical import _588, _589
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    def lead_measurement_method(self) -> '_599.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_599.MicroGeometryDefinitionMethod)(value) if value is not None else None
    ...
    @property
    def lead_micro_geometry(self) -> '_588.MicroGeometryInputsLead':
        ...
        return constructor.new(_588.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry is not None else None

    @property
    def profile_micro_geometry(self) -> 'List[_589.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_589.MicroGeometryInputsProfile))
        return value
