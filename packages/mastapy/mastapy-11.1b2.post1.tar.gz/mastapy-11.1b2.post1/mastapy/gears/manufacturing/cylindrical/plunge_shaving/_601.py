...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _602, _611
...
class PlungeShaverCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_602.PlungeShaverCalculationInputs':
        ...
        return constructor.new(_602.PlungeShaverCalculationInputs)(self.wrapped.Inputs) if self.wrapped.Inputs is not None else None

    @property
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_611.VirtualPlungeShaverOutputs':
        ...
        return constructor.new(_611.VirtualPlungeShaverOutputs)(self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear) if self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear is not None else None
