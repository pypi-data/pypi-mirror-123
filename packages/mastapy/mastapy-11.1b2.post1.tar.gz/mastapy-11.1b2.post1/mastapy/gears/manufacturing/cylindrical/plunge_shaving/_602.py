...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_298.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_298.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_658.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_658.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry is not None else None

    @property
    def tooth_thickness(self) -> '_1024.ToothThicknessSpecificationBase':
        ...
        if _1024.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_984.FinishToothThicknessDesignSpecification':
        ...
        if _984.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_readonly_tooth_thickness_specification(self) -> '_1005.ReadonlyToothThicknessSpecification':
        ...
        if _1005.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_1023.ToothThicknessSpecification':
        ...
        if _1023.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
