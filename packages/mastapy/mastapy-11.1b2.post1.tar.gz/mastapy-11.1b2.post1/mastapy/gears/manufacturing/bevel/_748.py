...
from mastapy.gears.manufacturing.bevel.cutters import _770, _769
...
class ConicalWheelManufacturingConfig(_730.ConicalGearManufacturingConfig):
    '''ConicalWheelManufacturingConfig
    ...
    @property
    def wheel_rough_cutter(self) -> '_770.WheelRoughCutter':
        ...
        return constructor.new(_770.WheelRoughCutter)(self.wrapped.WheelRoughCutter) if self.wrapped.WheelRoughCutter is not None else None

    @property
    def wheel_finish_cutter(self) -> '_769.WheelFinishCutter':
        ...
        return constructor.new(_769.WheelFinishCutter)(self.wrapped.WheelFinishCutter) if self.wrapped.WheelFinishCutter is not None else None
    ...
    def specified_cradle_style_machine_settings(self) -> '_778.CradleStyleConicalMachineSettingsGenerated':
        ...
        return constructor.new(_778.CradleStyleConicalMachineSettingsGenerated)(self.wrapped.SpecifiedCradleStyleMachineSettings) if self.wrapped.SpecifiedCradleStyleMachineSettings is not None else None

    @property
    def specified_machine_settings(self) -> '_775.BasicConicalGearMachineSettings':
        ...
        if _775.BasicConicalGearMachineSettings.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_776.BasicConicalGearMachineSettingsFormate':
        ...
        if _776.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_777.BasicConicalGearMachineSettingsGenerated':
        ...
        if _777.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
