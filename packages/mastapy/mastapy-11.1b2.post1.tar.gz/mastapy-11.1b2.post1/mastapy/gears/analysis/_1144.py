...
from mastapy.gears.rating.conical import _492, _494
from mastapy.gears.rating.concept import _502, _505
from mastapy.gears.rating.bevel import _509
from mastapy.gears.rating.agma_gleason_conical import _520
from mastapy.gears.manufacturing.cylindrical import _566, _570, _571
from mastapy.gears.manufacturing.bevel import (
    _729, _730, _731, _732,
    _742, _743, _748
)
from mastapy.gears.ltca import _785
from mastapy.gears.ltca.cylindrical import _799
from mastapy.gears.ltca.conical import _810
from mastapy.gears.load_case import _816
from mastapy.gears.load_case.worm import _819
from mastapy.gears.load_case.face import _822
from mastapy.gears.load_case.cylindrical import _825
from mastapy.gears.load_case.conical import _828
from mastapy.gears.load_case.concept import _831
from mastapy.gears.load_case.bevel import _834
from mastapy.gears.gear_two_d_fe_analysis import _841, _842
from mastapy.gears.gear_designs.face import _933
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1036, _1037
from mastapy.gears.fe_model import _1128
from mastapy.gears.fe_model.cylindrical import _1132
from mastapy.gears.fe_model.conical import _1135
...
class AbstractGearMeshAnalysis(_0.APIBase):
    ...
    @property
    def gear_a(self) -> '_1143.AbstractGearAnalysis':
        ...
        if _1143.AbstractGearAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_duty_cycle_rating(self) -> '_492.ConicalGearDutyCycleRating':
        ...
        if _492.ConicalGearDutyCycleRating.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_rating(self) -> '_494.ConicalGearRating':
        ...
        if _494.ConicalGearRating.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to ConicalGearRating. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_concept_gear_duty_cycle_rating(self) -> '_502.ConceptGearDutyCycleRating':
        ...
        if _502.ConceptGearDutyCycleRating.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_concept_gear_rating(self) -> '_505.ConceptGearRating':
        ...
        if _505.ConceptGearRating.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to ConceptGearRating. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_bevel_gear_rating(self) -> '_509.BevelGearRating':
        ...
        if _509.BevelGearRating.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to BevelGearRating. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_agma_gleason_conical_gear_rating(self) -> '_520.AGMAGleasonConicalGearRating':
        ...
        if _520.AGMAGleasonConicalGearRating.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_manufacturing_config(self) -> '_566.CylindricalGearManufacturingConfig':
        ...
        if _566.CylindricalGearManufacturingConfig.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_manufactured_gear_duty_cycle(self) -> '_570.CylindricalManufacturedGearDutyCycle':
        ...
        if _570.CylindricalManufacturedGearDutyCycle.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_manufactured_gear_load_case(self) -> '_571.CylindricalManufacturedGearLoadCase':
        ...
        if _571.CylindricalManufacturedGearLoadCase.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_manufacturing_analysis(self) -> '_729.ConicalGearManufacturingAnalysis':
        ...
        if _729.ConicalGearManufacturingAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_manufacturing_config(self) -> '_730.ConicalGearManufacturingConfig':
        ...
        if _730.ConicalGearManufacturingConfig.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_micro_geometry_config(self) -> '_731.ConicalGearMicroGeometryConfig':
        ...
        if _731.ConicalGearMicroGeometryConfig.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_micro_geometry_config_base(self) -> '_732.ConicalGearMicroGeometryConfigBase':
        ...
        if _732.ConicalGearMicroGeometryConfigBase.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_pinion_manufacturing_config(self) -> '_742.ConicalPinionManufacturingConfig':
        ...
        if _742.ConicalPinionManufacturingConfig.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_pinion_micro_geometry_config(self) -> '_743.ConicalPinionMicroGeometryConfig':
        ...
        if _743.ConicalPinionMicroGeometryConfig.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_wheel_manufacturing_config(self) -> '_748.ConicalWheelManufacturingConfig':
        ...
        if _748.ConicalWheelManufacturingConfig.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_load_distribution_analysis(self) -> '_785.GearLoadDistributionAnalysis':
        ...
        if _785.GearLoadDistributionAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_load_distribution_analysis(self) -> '_799.CylindricalGearLoadDistributionAnalysis':
        ...
        if _799.CylindricalGearLoadDistributionAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_load_distribution_analysis(self) -> '_810.ConicalGearLoadDistributionAnalysis':
        ...
        if _810.ConicalGearLoadDistributionAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_load_case_base(self) -> '_816.GearLoadCaseBase':
        ...
        if _816.GearLoadCaseBase.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to GearLoadCaseBase. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_worm_gear_load_case(self) -> '_819.WormGearLoadCase':
        ...
        if _819.WormGearLoadCase.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to WormGearLoadCase. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_face_gear_load_case(self) -> '_822.FaceGearLoadCase':
        ...
        if _822.FaceGearLoadCase.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to FaceGearLoadCase. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_cylindrical_gear_load_case(self) -> '_825.CylindricalGearLoadCase':
        ...
        if _825.CylindricalGearLoadCase.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_load_case(self) -> '_828.ConicalGearLoadCase':
        ...
        if _828.ConicalGearLoadCase.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_concept_gear_load_case(self) -> '_831.ConceptGearLoadCase':
        ...
        if _831.ConceptGearLoadCase.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_bevel_load_case(self) -> '_834.BevelLoadCase':
        ...
        if _834.BevelLoadCase.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to BevelLoadCase. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_cylindrical_gear_tiff_analysis(self) -> '_841.CylindricalGearTIFFAnalysis':
        ...
        if _841.CylindricalGearTIFFAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_tiff_analysis_duty_cycle(self) -> '_842.CylindricalGearTIFFAnalysisDutyCycle':
        ...
        if _842.CylindricalGearTIFFAnalysisDutyCycle.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_face_gear_micro_geometry(self) -> '_933.FaceGearMicroGeometry':
        ...
        if _933.FaceGearMicroGeometry.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_micro_geometry(self) -> '_1036.CylindricalGearMicroGeometry':
        ...
        if _1036.CylindricalGearMicroGeometry.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_micro_geometry_duty_cycle(self) -> '_1037.CylindricalGearMicroGeometryDutyCycle':
        ...
        if _1037.CylindricalGearMicroGeometryDutyCycle.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_fe_model(self) -> '_1128.GearFEModel':
        ...
        if _1128.GearFEModel.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to GearFEModel. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA is not None else None

    @property
    def gear_a_of_type_cylindrical_gear_fe_model(self) -> '_1132.CylindricalGearFEModel':
        ...
        if _1132.CylindricalGearFEModel.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_fe_model(self) -> '_1135.ConicalGearFEModel':
        ...
        if _1135.ConicalGearFEModel.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_design_analysis(self) -> '_1146.GearDesignAnalysis':
        ...
        if _1146.GearDesignAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_implementation_analysis(self) -> '_1147.GearImplementationAnalysis':
        ...
        if _1147.GearImplementationAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_implementation_analysis_duty_cycle(self) -> '_1148.GearImplementationAnalysisDutyCycle':
        ...
        if _1148.GearImplementationAnalysisDutyCycle.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_implementation_detail(self) -> '_1149.GearImplementationDetail':
        ...
        if _1149.GearImplementationDetail.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_b(self) -> '_1143.AbstractGearAnalysis':
        ...
        if _1143.AbstractGearAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_duty_cycle_rating(self) -> '_492.ConicalGearDutyCycleRating':
        ...
        if _492.ConicalGearDutyCycleRating.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_rating(self) -> '_494.ConicalGearRating':
        ...
        if _494.ConicalGearRating.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to ConicalGearRating. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_concept_gear_duty_cycle_rating(self) -> '_502.ConceptGearDutyCycleRating':
        ...
        if _502.ConceptGearDutyCycleRating.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_concept_gear_rating(self) -> '_505.ConceptGearRating':
        ...
        if _505.ConceptGearRating.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to ConceptGearRating. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_bevel_gear_rating(self) -> '_509.BevelGearRating':
        ...
        if _509.BevelGearRating.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to BevelGearRating. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_agma_gleason_conical_gear_rating(self) -> '_520.AGMAGleasonConicalGearRating':
        ...
        if _520.AGMAGleasonConicalGearRating.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_manufacturing_config(self) -> '_566.CylindricalGearManufacturingConfig':
        ...
        if _566.CylindricalGearManufacturingConfig.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_manufactured_gear_duty_cycle(self) -> '_570.CylindricalManufacturedGearDutyCycle':
        ...
        if _570.CylindricalManufacturedGearDutyCycle.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_manufactured_gear_load_case(self) -> '_571.CylindricalManufacturedGearLoadCase':
        ...
        if _571.CylindricalManufacturedGearLoadCase.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_manufacturing_analysis(self) -> '_729.ConicalGearManufacturingAnalysis':
        ...
        if _729.ConicalGearManufacturingAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_manufacturing_config(self) -> '_730.ConicalGearManufacturingConfig':
        ...
        if _730.ConicalGearManufacturingConfig.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_micro_geometry_config(self) -> '_731.ConicalGearMicroGeometryConfig':
        ...
        if _731.ConicalGearMicroGeometryConfig.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_micro_geometry_config_base(self) -> '_732.ConicalGearMicroGeometryConfigBase':
        ...
        if _732.ConicalGearMicroGeometryConfigBase.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_pinion_manufacturing_config(self) -> '_742.ConicalPinionManufacturingConfig':
        ...
        if _742.ConicalPinionManufacturingConfig.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_pinion_micro_geometry_config(self) -> '_743.ConicalPinionMicroGeometryConfig':
        ...
        if _743.ConicalPinionMicroGeometryConfig.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_wheel_manufacturing_config(self) -> '_748.ConicalWheelManufacturingConfig':
        ...
        if _748.ConicalWheelManufacturingConfig.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_load_distribution_analysis(self) -> '_785.GearLoadDistributionAnalysis':
        ...
        if _785.GearLoadDistributionAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_load_distribution_analysis(self) -> '_799.CylindricalGearLoadDistributionAnalysis':
        ...
        if _799.CylindricalGearLoadDistributionAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_load_distribution_analysis(self) -> '_810.ConicalGearLoadDistributionAnalysis':
        ...
        if _810.ConicalGearLoadDistributionAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_load_case_base(self) -> '_816.GearLoadCaseBase':
        ...
        if _816.GearLoadCaseBase.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to GearLoadCaseBase. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_worm_gear_load_case(self) -> '_819.WormGearLoadCase':
        ...
        if _819.WormGearLoadCase.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to WormGearLoadCase. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_face_gear_load_case(self) -> '_822.FaceGearLoadCase':
        ...
        if _822.FaceGearLoadCase.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to FaceGearLoadCase. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_cylindrical_gear_load_case(self) -> '_825.CylindricalGearLoadCase':
        ...
        if _825.CylindricalGearLoadCase.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_load_case(self) -> '_828.ConicalGearLoadCase':
        ...
        if _828.ConicalGearLoadCase.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_concept_gear_load_case(self) -> '_831.ConceptGearLoadCase':
        ...
        if _831.ConceptGearLoadCase.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_bevel_load_case(self) -> '_834.BevelLoadCase':
        ...
        if _834.BevelLoadCase.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to BevelLoadCase. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_cylindrical_gear_tiff_analysis(self) -> '_841.CylindricalGearTIFFAnalysis':
        ...
        if _841.CylindricalGearTIFFAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_tiff_analysis_duty_cycle(self) -> '_842.CylindricalGearTIFFAnalysisDutyCycle':
        ...
        if _842.CylindricalGearTIFFAnalysisDutyCycle.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_face_gear_micro_geometry(self) -> '_933.FaceGearMicroGeometry':
        ...
        if _933.FaceGearMicroGeometry.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_micro_geometry(self) -> '_1036.CylindricalGearMicroGeometry':
        ...
        if _1036.CylindricalGearMicroGeometry.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_micro_geometry_duty_cycle(self) -> '_1037.CylindricalGearMicroGeometryDutyCycle':
        ...
        if _1037.CylindricalGearMicroGeometryDutyCycle.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_fe_model(self) -> '_1128.GearFEModel':
        ...
        if _1128.GearFEModel.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to GearFEModel. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB is not None else None

    @property
    def gear_b_of_type_cylindrical_gear_fe_model(self) -> '_1132.CylindricalGearFEModel':
        ...
        if _1132.CylindricalGearFEModel.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_fe_model(self) -> '_1135.ConicalGearFEModel':
        ...
        if _1135.ConicalGearFEModel.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_design_analysis(self) -> '_1146.GearDesignAnalysis':
        ...
        if _1146.GearDesignAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_implementation_analysis(self) -> '_1147.GearImplementationAnalysis':
        ...
        if _1147.GearImplementationAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_implementation_analysis_duty_cycle(self) -> '_1148.GearImplementationAnalysisDutyCycle':
        ...
        if _1148.GearImplementationAnalysisDutyCycle.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_implementation_detail(self) -> '_1149.GearImplementationDetail':
        ...
        if _1149.GearImplementationDetail.TYPE not in self.wrapped.GearB.__class__.__mro__:
