...
from mastapy.gears.materials import _556, _548
...
class CylindricalGearMaterial(_548.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_556.ManufactureRating':
        ...
        return constructor.new(_556.ManufactureRating)(value) if value is not None else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_556.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_556.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_556.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_556.ManufactureRating':
    ...
    def machine_process_development(self, value: '_556.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_556.ManufactureRating':
    ...
    def manufacturability(self, value: '_556.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
