...
from mastapy.gears.cylindrical import _1140, _1139
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_799.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_799.CylindricalGearLoadDistributionAnalysis)(self.wrapped.GearLoadDistributionAnalysis) if self.wrapped.GearLoadDistributionAnalysis is not None else None

    @property
    def other_gear_load_distribution_analysis(self) -> '_799.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_799.CylindricalGearLoadDistributionAnalysis)(self.wrapped.OtherGearLoadDistributionAnalysis) if self.wrapped.OtherGearLoadDistributionAnalysis is not None else None

    @property
    def contact_charts(self) -> '_1140.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_1140.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts is not None else None

    @property
    def contact_charts_as_text_file(self) -> '_1139.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1139.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile is not None else None

    def contact_patch_detailed(self, result_type: '_779.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1298.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_779.ContactResultType', include_tip_contact: 'bool') -> '_1298.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_779.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
