...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    @property
    def profile_evaluation(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluation) if self.wrapped.ProfileEvaluation is not None else None

    @property
    def profile_start(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.ProfileStart) if self.wrapped.ProfileStart is not None else None
