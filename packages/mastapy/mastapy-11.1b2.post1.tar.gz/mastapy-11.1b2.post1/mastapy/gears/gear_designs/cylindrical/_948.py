...
class CylindricalGearBasicRack(_946.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_940.BasicRackProfiles':
        ...
        return constructor.new(_940.BasicRackProfiles)(value) if value is not None else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_940.BasicRackProfiles'):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_1019.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_1019.TipAlterationCoefficientMethod)(value) if value is not None else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_1019.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_962.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_962.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating is not None else None
