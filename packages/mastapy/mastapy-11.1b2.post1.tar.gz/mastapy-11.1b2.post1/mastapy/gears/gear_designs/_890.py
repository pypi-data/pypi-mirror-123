...
from mastapy.gears.fe_model import _1131
from mastapy.gears.fe_model.cylindrical import _1134
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1137
...
class GearSetDesign(_888.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def transmission_properties_gears(self) -> '_293.GearSetDesignGroup':
        ...
        return constructor.new(_293.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears is not None else None

    @property
    def active_ltcafe_model(self) -> '_1131.GearSetFEModel':
        ...
        if _1131.GearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1134.CylindricalGearSetFEModel':
        ...
        if _1134.CylindricalGearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_conical_set_fe_model(self) -> '_1137.ConicalSetFEModel':
        ...
        if _1137.ConicalSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model(self) -> '_1131.GearSetFEModel':
        ...
        if _1131.GearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1134.CylindricalGearSetFEModel':
        ...
        if _1134.CylindricalGearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_set_fe_model(self) -> '_1137.ConicalSetFEModel':
        ...
        if _1137.ConicalSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def gears(self) -> 'List[_887.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_887.GearDesign))
        return value

    @property
    def ltcafe_models(self) -> 'List[_1131.GearSetFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LTCAFEModels, constructor.new(_1131.GearSetFEModel))
        return value
