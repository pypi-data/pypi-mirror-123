...
from mastapy.gears.materials import _555
...
class KlingelnbergConicalGearDesign(_1085.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_555.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_555.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial is not None else None
