...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1265.RolledBeforeOrAfterHeatTreament':
        ...
        return constructor.new(_1265.RolledBeforeOrAfterHeatTreament)(value) if value is not None else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1265.RolledBeforeOrAfterHeatTreament'):
    ...
    @property
    def joint_geometry(self) -> '_1262.JointGeometries':
        ...
        return constructor.new(_1262.JointGeometries)(value) if value is not None else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1262.JointGeometries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clamped_parts(self) -> 'List[_1257.ClampedSection]':
        '''List[ClampedSection]: 'ClampedParts' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedParts, constructor.new(_1257.ClampedSection))
        return value

    @clamped_parts.setter
    def clamped_parts(self, value: 'List[_1257.ClampedSection]'):
        value = value if value else None
    ...
    @property
    def bolt_geometry(self) -> '_1250.BoltGeometry':
        ...
        return constructor.new(_1250.BoltGeometry)(self.wrapped.BoltGeometry) if self.wrapped.BoltGeometry is not None else None
    ...
    @property
    def material_of_nut(self) -> '_1248.BoltedJointMaterial':
        ...
        if _1248.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfNut.__class__.__mro__:
    ...
    @property
    def material_of_bolt(self) -> '_1252.BoltMaterial':
        ...
        return constructor.new(_1252.BoltMaterial)(self.wrapped.MaterialOfBolt) if self.wrapped.MaterialOfBolt is not None else None

    @property
    def material_of_tapped_thread(self) -> '_1248.BoltedJointMaterial':
        ...
        if _1248.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfTappedThread.__class__.__mro__:
    ...
    @property
    def clamped_sections(self) -> 'List[_1257.ClampedSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedSections, constructor.new(_1257.ClampedSection))
        return value
