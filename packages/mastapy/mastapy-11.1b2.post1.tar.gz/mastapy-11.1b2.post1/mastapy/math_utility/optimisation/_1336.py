...
from mastapy.math_utility.optimisation import _1341, _1340
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def range(self) -> '_1271.Range':
        '''Range: 'Range' is the original name of this property.'''

        if _1271.Range.TYPE not in self.wrapped.Range.__class__.__mro__:
    ...
    @range.setter
    def range(self, value: '_1271.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def integer_range(self) -> '_1368.IntegerRange':
        '''IntegerRange: 'IntegerRange' is the original name of this property.'''

        return constructor.new(_1368.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange is not None else None

    @integer_range.setter
    def integer_range(self, value: '_1368.IntegerRange'):
        value = value.wrapped if value else None
    ...
    @property
    def specification_type(self) -> '_1341.TargetingPropertyTo':
        ...
        return constructor.new(_1341.TargetingPropertyTo)(value) if value is not None else None

    @specification_type.setter
    def specification_type(self, value: '_1341.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1340.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1340.SpecifyOptimisationInputAs)(value) if value is not None else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1340.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
