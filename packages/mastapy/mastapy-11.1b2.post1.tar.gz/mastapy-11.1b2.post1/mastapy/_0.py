...
class APIBase:
    ...
    def is_valid(self, property_name: 'str') -> 'bool':
        ...
        method_result = self.wrapped.IsValid(property_name if property_name else None)
        return method_result
    ...
    def is_read_only(self, property_name: 'str') -> 'bool':
        ...
        property_name = str(property_name)
        method_result = self.wrapped.IsReadOnly(property_name if property_name else None)
        return method_result
