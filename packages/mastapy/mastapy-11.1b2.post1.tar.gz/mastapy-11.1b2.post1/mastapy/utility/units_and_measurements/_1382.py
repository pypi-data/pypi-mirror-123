...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1375.RoundingMethods':
        ...
        return constructor.new(_1375.RoundingMethods)(value) if value is not None else None

    @rounding_method.setter
    def rounding_method(self, value: '_1375.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1387.Unit':
        ...
        if _1387.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
