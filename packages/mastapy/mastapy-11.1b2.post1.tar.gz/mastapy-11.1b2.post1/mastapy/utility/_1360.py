...
from mastapy.utility import _1370, _1359
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self) -> '_1370.NumberFormatInfoSummary':
        ...
        return constructor.new(_1370.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture is not None else None

    @property
    def dispatchers(self) -> 'List[_1359.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1359.DispatcherHelper))
        return value
