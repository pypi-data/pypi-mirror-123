...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1897, _1896
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1897.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1897.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1896.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1896.AbstractXmlVariableAssignment))
        return value
