...
from mastapy.bearings.bearing_designs.rolling import _1868
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1868.BearingProtectionLevel':
        ...
        return constructor.new(_1868.BearingProtectionLevel)(value) if value is not None else None

    @property
    def new_protection_level(self) -> '_1868.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1868.BearingProtectionLevel'):
