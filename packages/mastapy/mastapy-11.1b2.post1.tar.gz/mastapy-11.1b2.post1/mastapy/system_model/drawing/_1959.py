...
from mastapy.system_model.drawing import _1971
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2512.ShaftSystemDeflection':
        ...
        return constructor.new(_2512.ShaftSystemDeflection)(self.wrapped.ShaftSystemDeflection) if self.wrapped.ShaftSystemDeflection is not None else None

    @property
    def node_results(self) -> 'List[_1971.ShaftDeflectionDrawingNodeItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1971.ShaftDeflectionDrawingNodeItem))
        return value
