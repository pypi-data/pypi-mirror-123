...
from mastapy.system_model.import_export import _1956
...
class Part(_1924.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self) -> '_1301.MassProperties':
        ...
        return constructor.new(_1301.MassProperties)(self.wrapped.MassPropertiesFromDesign) if self.wrapped.MassPropertiesFromDesign is not None else None

    @property
    def mass_properties_from_design_including_planetary_duplicates(self) -> '_1301.MassProperties':
        ...
        return constructor.new(_1301.MassProperties)(self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates) if self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates is not None else None
    ...
    @property
    def local_connections(self) -> 'List[_1987.Connection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LocalConnections, constructor.new(_1987.Connection))
        return value

    def connections_to(self, part: 'Part') -> 'List[_1987.Connection]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionsTo(part.wrapped if part else None), constructor.new(_1987.Connection))
    ...
    def create_geometry_export_options(self) -> '_1956.GeometryExportOptions':
    ...
    def copy_to(self, container: '_2149.Assembly') -> 'Part':
