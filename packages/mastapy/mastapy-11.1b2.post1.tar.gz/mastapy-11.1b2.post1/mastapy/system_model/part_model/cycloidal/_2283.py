...
from mastapy.cycloidal import _1244, _1245
...
class RingPins(_2178.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1244.RingPinsDesign':
        ...
        return constructor.new(_1244.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign is not None else None

    @property
    def ring_pins_material(self) -> '_1245.RingPinsMaterial':
        ...
        return constructor.new(_1245.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial is not None else None
