...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2276
from mastapy.system_model.part_model.gears import _2238, _2245
...
class CylindricalGearSet(_2245.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_967.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_967.CylindricalGearSetDesign':
        ...
        if _967.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSetDesign.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_set(self) -> '_2276.SuperchargerRotorSet':
        ...
        return constructor.new(_2276.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet is not None else None

    @property
    def cylindrical_gears(self) -> 'List[_2238.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2238.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_2024.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_2024.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_967.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_967.CylindricalGearSetDesign))
        return value
