...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5147, _5186, _5181
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.analysis_cases import _7226
...
class MBDRunUpAnalysisOptions(_7226.AbstractAnalysisOptions['_6493.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5147.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5147.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5147.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5186.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5186.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5186.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5181.RunUpDrivingMode':
        ...
        return constructor.new(_5181.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5181.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
