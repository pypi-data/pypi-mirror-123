...
from mastapy.system_model.part_model.couplings import _2317, _2319
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2317.SynchroniserHalf':
        ...
        return constructor.new(_2317.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone is not None else None

    @property
    def sleeve(self) -> '_2319.SynchroniserSleeve':
        ...
        return constructor.new(_2319.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve is not None else None
