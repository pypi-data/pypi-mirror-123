...
from mastapy.math_utility import _1286, _1296
...
class PointLoadHarmonicLoadData(_6644.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1286.DegreesOfFreedom':
        ...
        return constructor.new(_1286.DegreesOfFreedom)(value) if value is not None else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1286.DegreesOfFreedom'):
