...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7011, _7015, _7012
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_7011.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7011.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.CylindricalGearAdvancedSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_7011.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7011.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearAdvancedSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7012.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.CylindricalGearMeshAdvancedSystemDeflection) if self.wrapped.CylindricalGearMeshAdvancedSystemDeflection is not None else None
