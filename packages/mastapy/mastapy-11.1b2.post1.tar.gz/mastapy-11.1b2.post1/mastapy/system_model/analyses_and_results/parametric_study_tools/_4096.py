...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4087, _4084, _4052
...
class ParametricStudyVariable(_2361.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4087.ParametricStudyDimension':
        ...
        return constructor.new(_4087.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4087.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4084.MonteCarloDistribution':
        ...
        return constructor.new(_4084.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4084.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def doe_variable_setter(self) -> '_4052.DesignOfExperimentsVariableSetter':
        ...
        return constructor.new(_4052.DesignOfExperimentsVariableSetter)(self.wrapped.DOEVariableSetter) if self.wrapped.DOEVariableSetter is not None else None
