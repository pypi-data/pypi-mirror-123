...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5797, _5795
...
class ExcitationSourceSelection(_5795.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5797.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5797.HarmonicSelection))
        return value
