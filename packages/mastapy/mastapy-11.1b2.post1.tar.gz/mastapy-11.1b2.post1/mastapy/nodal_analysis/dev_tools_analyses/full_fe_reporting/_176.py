...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1164, _1163
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1164.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1164.ContactPairReferenceSurfaceType)(value) if value is not None else None

    @property
    def constrained_surface_type(self) -> '_1163.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1163.ContactPairConstrainedSurfaceType)(value) if value is not None else None
