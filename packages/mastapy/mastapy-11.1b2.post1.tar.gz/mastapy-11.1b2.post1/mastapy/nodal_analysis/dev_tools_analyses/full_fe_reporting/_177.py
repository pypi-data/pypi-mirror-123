...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1160
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1160.CoordinateSystemType':
        ...
        return constructor.new(_1160.CoordinateSystemType)(value) if value is not None else None
