...
from mastapy.fe_tools.enums import _1169
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1169.ElementPropertyClass':
        ...
        return constructor.new(_1169.ElementPropertyClass)(value) if value is not None else None
