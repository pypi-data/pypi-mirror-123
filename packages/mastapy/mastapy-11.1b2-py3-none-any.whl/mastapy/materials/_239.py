...
class Material(_1579.NamedDatabaseItem):
    '''Material
    ...
    def standard(self) -> '_242.MaterialStandards':
        ...
        return constructor.new(_242.MaterialStandards)(value) if value else None
    ...
    def hardness_type(self) -> '_228.HardnessType':
        ...
        return constructor.new(_228.HardnessType)(value) if value else None
