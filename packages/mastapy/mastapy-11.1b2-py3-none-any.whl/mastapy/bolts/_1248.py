...
class BoltedJointMaterial(_239.Material):
    ...
    @property
    def temperature_dependent_youngs_moduli(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'TemperatureDependentYoungsModuli' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.TemperatureDependentYoungsModuli) if self.wrapped.TemperatureDependentYoungsModuli else None

    @temperature_dependent_youngs_moduli.setter
    def temperature_dependent_youngs_moduli(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.TemperatureDependentYoungsModuli = value

    @property
    def temperature_dependent_coefficient_of_thermal_expansion(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'TemperatureDependentCoefficientOfThermalExpansion' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.TemperatureDependentCoefficientOfThermalExpansion) if self.wrapped.TemperatureDependentCoefficientOfThermalExpansion else None

    @temperature_dependent_coefficient_of_thermal_expansion.setter
    def temperature_dependent_coefficient_of_thermal_expansion(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
