...
class ShaftDamageResults(_0.APIBase):
    ...
    @property
    def cyclic_degrees_of_utilisation(self) -> 'List[_1308.RealVector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CyclicDegreesOfUtilisation, constructor.new(_1308.RealVector))
        return value
