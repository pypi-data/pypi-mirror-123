...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    def section_end(self) -> '_79.SectionEnd':
        ...
        return constructor.new(_79.SectionEnd)(value) if value else None
    ...
    def sn_curve(self) -> '_249.SNCurve':
        ...
        return constructor.new(_249.SNCurve)(self.wrapped.SNCurve) if self.wrapped.SNCurve else None
    ...
    def sn_curve_axial(self) -> '_249.SNCurve':
        ...
        return constructor.new(_249.SNCurve)(self.wrapped.SNCurveAxial) if self.wrapped.SNCurveAxial else None
    ...
    def sn_curve_bending_x(self) -> '_249.SNCurve':
        ...
        return constructor.new(_249.SNCurve)(self.wrapped.SNCurveBendingX) if self.wrapped.SNCurveBendingX else None
    ...
    def sn_curve_bending_y(self) -> '_249.SNCurve':
        ...
        return constructor.new(_249.SNCurve)(self.wrapped.SNCurveBendingY) if self.wrapped.SNCurveBendingY else None
    ...
    def sn_curve_torsional(self) -> '_249.SNCurve':
        ...
        return constructor.new(_249.SNCurve)(self.wrapped.SNCurveTorsional) if self.wrapped.SNCurveTorsional else None
