...
class LoadedDetailedBearingResults(_1685.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    def lubrication(self) -> '_237.LubricationDetail':
        ...
        return constructor.new(_237.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
