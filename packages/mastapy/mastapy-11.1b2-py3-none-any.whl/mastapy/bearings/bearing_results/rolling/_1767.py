...
from mastapy.bearings.bearing_results.rolling import _1766, _1753
...
class LoadedSphericalRollerThrustBearingRow(_1753.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1766.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1766.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
