...
from mastapy.bearings.bearing_results.rolling import _1788, _1747
...
class LoadedCylindricalRollerBearingResults(_1747.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_1788.PermissibleContinuousAxialLoadResults':
        ...
        return constructor.new(_1788.PermissibleContinuousAxialLoadResults)(self.wrapped.PermissibleContinuousAxialLoad) if self.wrapped.PermissibleContinuousAxialLoad else None
