...
from mastapy.bearings.bearing_results.rolling.skf_module import _1817, _1820
...
class DynamicAxialLoadCarryingCapacity(_1820.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1817.PermissibleAxialLoad':
        ...
        return constructor.new(_1817.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad else None
