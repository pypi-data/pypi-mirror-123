...
from mastapy.bearings.bearing_results.rolling.skf_module import _1814, _1820
...
class BearingRatingLife(_1820.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1814.LifeModel':
        ...
        return constructor.new(_1814.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
