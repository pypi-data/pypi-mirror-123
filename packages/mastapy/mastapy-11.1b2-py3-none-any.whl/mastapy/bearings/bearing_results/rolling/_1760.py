...
from mastapy.bearings.bearing_results.rolling import _1759, _1726
...
class LoadedSelfAligningBallBearingRow(_1726.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1759.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1759.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
