...
from mastapy.bearings.bearing_results.rolling import _1775, _1726
...
class LoadedThreePointContactBallBearingRow(_1726.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1775.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1775.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
