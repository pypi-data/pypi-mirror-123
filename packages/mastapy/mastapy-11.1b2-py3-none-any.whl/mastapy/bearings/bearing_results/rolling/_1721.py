...
from mastapy.bearings.bearing_results.rolling import _1720, _1718
...
class LoadedAxialThrustNeedleRollerBearingRow(_1718.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1720.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1720.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
