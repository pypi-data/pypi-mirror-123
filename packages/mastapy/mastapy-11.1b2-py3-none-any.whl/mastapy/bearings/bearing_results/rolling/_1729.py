...
from mastapy.bearings.bearing_results.rolling import _1728, _1753
...
class LoadedCrossedRollerBearingRow(_1753.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1728.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1728.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
