...
from mastapy.bearings.bearing_results.rolling import (
    _1725, _1706, _1709, _1735,
    _1740, _1759, _1775, _1778,
    _1724, _1757
)
...
class LoadedBallBearingRow(_1757.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1725.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1724.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1724.LoadedBallBearingRaceResults))
        return value
