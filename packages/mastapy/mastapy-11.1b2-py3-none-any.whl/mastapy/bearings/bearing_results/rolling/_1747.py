...
from mastapy.bearings.bearing_results.rolling import _1796, _1752
...
class LoadedNonBarrelRollerBearingResults(_1752.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1796.SMTRibStressResults':
        ...
        return constructor.new(_1796.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
