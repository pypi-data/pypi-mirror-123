...
from mastapy.bearings import _1615
from mastapy.bearings.bearing_results.rolling.fitting import _1836, _1834, _1837
from mastapy.bearings.bearing_results.rolling import (
    _1700, _1798, _1696, _1784,
    _1757
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.abma import _1840, _1838, _1839
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1827, _1825, _1831, _1830,
    _1826, _1832, _1828
)
from mastapy.bearings.bearing_results.rolling.skf_module import _1822
from mastapy.bearings.bearing_results import _1682
...
class LoadedRollingBearingResults(_1682.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1615.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1615.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1836.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1836.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1836.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1836.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1834.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1834.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1834.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1834.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1696.DIN732Results':
        ...
        return constructor.new(_1696.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def ansiabma(self) -> '_1840.ANSIABMAResults':
        ...
        if _1840.ANSIABMAResults.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_1838.ANSIABMA112014Results':
        ...
        if _1838.ANSIABMA112014Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_1839.ANSIABMA92015Results':
        ...
        if _1839.ANSIABMA92015Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def iso2812007(self) -> '_1827.ISO2812007Results':
        ...
        if _1827.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1825.BallISO2812007Results':
        ...
        if _1825.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1831.RollerISO2812007Results':
        ...
        if _1831.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1830.ISOTS162812008Results':
        ...
        if _1830.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1826.BallISOTS162812008Results':
        ...
        if _1826.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1832.RollerISOTS162812008Results':
        ...
        if _1832.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1828.ISO762006Results':
        ...
        return constructor.new(_1828.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1784.MaximumStaticContactStress':
        ...
        return constructor.new(_1784.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1822.SKFModuleResults':
        ...
        return constructor.new(_1822.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1757.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1757.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1837.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1837.RingFittingThermalResults))
        return value
