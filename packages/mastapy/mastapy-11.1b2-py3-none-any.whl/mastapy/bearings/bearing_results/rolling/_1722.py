...
from mastapy.bearings.bearing_results import _1687
...
class LoadedBallBearingDutyCycle(_1687.LoadedRollingBearingDutyCycle):
    '''LoadedBallBearingDutyCycle
    ...
    @property
    def track_truncation_inner_summary(self) -> '_1589.DutyCyclePropertySummaryPercentage[_1725.LoadedBallBearingResults]':
        ...
        return constructor.new(_1589.DutyCyclePropertySummaryPercentage)[_1725.LoadedBallBearingResults](self.wrapped.TrackTruncationInnerSummary) if self.wrapped.TrackTruncationInnerSummary else None

    @property
    def track_truncation_outer_summary(self) -> '_1589.DutyCyclePropertySummaryPercentage[_1725.LoadedBallBearingResults]':
        ...
        return constructor.new(_1589.DutyCyclePropertySummaryPercentage)[_1725.LoadedBallBearingResults](self.wrapped.TrackTruncationOuterSummary) if self.wrapped.TrackTruncationOuterSummary else None
