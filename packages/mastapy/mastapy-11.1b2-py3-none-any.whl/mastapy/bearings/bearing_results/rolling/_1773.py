...
from mastapy.bearings.bearing_results.rolling import _1772, _1748
...
class LoadedTaperRollerBearingRow(_1748.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1772.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1772.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
