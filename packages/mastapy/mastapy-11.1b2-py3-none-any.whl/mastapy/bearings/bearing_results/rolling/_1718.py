...
from mastapy.bearings.bearing_results.rolling import _1717, _1720, _1748
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1748.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1717.LoadedAxialThrustCylindricalRollerBearingResults':
