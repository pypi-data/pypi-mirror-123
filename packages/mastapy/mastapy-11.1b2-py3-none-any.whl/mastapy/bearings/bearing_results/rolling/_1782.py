...
from mastapy.bearings.bearing_results.rolling import _1781, _1753
...
class LoadedToroidalRollerBearingRow(_1753.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1781.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1781.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
