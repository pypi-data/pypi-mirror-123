...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    def radial_load_summary(self) -> '_1588.DutyCyclePropertySummaryForce[_1608.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1588.DutyCyclePropertySummaryForce)[_1608.BearingLoadCaseResultsLightweight](self.wrapped.RadialLoadSummary) if self.wrapped.RadialLoadSummary else None
    ...
    def z_thrust_reaction_summary(self) -> '_1588.DutyCyclePropertySummaryForce[_1608.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1588.DutyCyclePropertySummaryForce)[_1608.BearingLoadCaseResultsLightweight](self.wrapped.ZThrustReactionSummary) if self.wrapped.ZThrustReactionSummary else None
