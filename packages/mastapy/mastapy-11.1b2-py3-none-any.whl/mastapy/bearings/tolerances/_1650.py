...
from mastapy.bearings.tolerances import _1646, _1638
...
class SupportDetail(_1638.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1646.RadialSpecificationMethod':
        ...
        return constructor.new(_1646.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1646.RadialSpecificationMethod'):
