...
from mastapy.bearings import (
    _1622, _1621, _1614, _1615
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1819
...
class BearingSettings(_1371.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1621.RatingLife':
        ...
        return constructor.new(_1621.RatingLife)(value) if value else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1621.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1614.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1614.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1614.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_authentication(self) -> '_1819.SKFAuthentication':
        ...
        return constructor.new(_1819.SKFAuthentication)(self.wrapped.SKFAuthentication) if self.wrapped.SKFAuthentication else None
