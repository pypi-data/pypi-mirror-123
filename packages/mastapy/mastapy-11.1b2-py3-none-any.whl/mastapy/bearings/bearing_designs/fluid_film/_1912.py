...
from mastapy.bearings.bearing_results import _1672
...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1672.DefaultOrUserInput':
        ...
        return constructor.new(_1672.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1672.DefaultOrUserInput'):
