...
class PlainOilFedJournalBearing(_1911.PlainJournalBearing):
    ...
    def feed_type(self) -> '_1618.JournalOilFeedType':
        ...
        return constructor.new(_1618.JournalOilFeedType)(value) if value else None
    ...
    def number_of_axial_points_for_pressure_distribution(self) -> 'overridable.Overridable_int':
        ...
        return constructor.new(overridable.Overridable_int)(self.wrapped.NumberOfAxialPointsForPressureDistribution) if self.wrapped.NumberOfAxialPointsForPressureDistribution else None
    ...
    def number_of_circumferential_points_for_pressure_distribution(self) -> 'overridable.Overridable_int':
        ...
        return constructor.new(overridable.Overridable_int)(self.wrapped.NumberOfCircumferentialPointsForPressureDistribution) if self.wrapped.NumberOfCircumferentialPointsForPressureDistribution else None
    ...
    def axial_groove_oil_feed(self) -> '_1902.AxialGrooveJournalBearing':
        ...
        return constructor.new(_1902.AxialGrooveJournalBearing)(self.wrapped.AxialGrooveOilFeed) if self.wrapped.AxialGrooveOilFeed else None
    ...
    def axial_hole_oil_feed(self) -> '_1903.AxialHoleJournalBearing':
        ...
        return constructor.new(_1903.AxialHoleJournalBearing)(self.wrapped.AxialHoleOilFeed) if self.wrapped.AxialHoleOilFeed else None
    ...
    def circumferential_groove_oil_feed(self) -> '_1904.CircumferentialFeedJournalBearing':
        ...
        return constructor.new(_1904.CircumferentialFeedJournalBearing)(self.wrapped.CircumferentialGrooveOilFeed) if self.wrapped.CircumferentialGrooveOilFeed else None
