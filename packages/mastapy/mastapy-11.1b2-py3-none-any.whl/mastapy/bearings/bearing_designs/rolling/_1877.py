...
class GeometricConstantsForSlidingFrictionalMoments(_0.APIBase):
    ...
    def s1(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.S1) if self.wrapped.S1 else None
    ...
    def s2(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.S2) if self.wrapped.S2 else None
    ...
    def s3(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.S3) if self.wrapped.S3 else None
    ...
    def s4(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.S4) if self.wrapped.S4 else None
    ...
    def s5(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.S5) if self.wrapped.S5 else None
