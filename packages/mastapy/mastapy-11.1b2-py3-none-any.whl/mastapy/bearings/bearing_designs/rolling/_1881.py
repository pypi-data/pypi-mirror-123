...
from mastapy.bearings.bearing_designs.rolling import _1883, _1884, _1882
...
class NonBarrelRollerBearing(_1882.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1883.RollerEndShape':
        ...
        return constructor.new(_1883.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1883.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1884.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1884.RollerRibDetail))
        return value
