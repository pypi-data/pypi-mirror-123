...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1165
...
class ElementPropertiesShell(_189.ElementPropertiesWithMaterial):
    ...
    @property
    def wall_type(self) -> '_1165.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1165.ElementPropertiesShellWallType)(value) if value else None
