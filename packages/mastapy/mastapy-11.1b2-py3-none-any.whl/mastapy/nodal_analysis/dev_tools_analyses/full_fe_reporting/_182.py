...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1162
...
class ElementPropertiesBeam(_189.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self) -> '_1162.BeamSectionType':
        ...
        return constructor.new(_1162.BeamSectionType)(value) if value else None
