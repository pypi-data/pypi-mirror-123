...
from mastapy.system_model.drawing import _1970, _1966
...
class ContourDrawStyle(_275.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1572.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1572.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1572.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1970.ScalingDrawStyle':
        ...
        return constructor.new(_1970.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1966.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1966.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
