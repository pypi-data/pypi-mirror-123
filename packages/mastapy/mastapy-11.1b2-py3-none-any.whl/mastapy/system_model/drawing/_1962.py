...
from mastapy.system_model.drawing import _1960, _1967
...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3732
...
class DynamicAnalysisViewable(_1967.PartAnalysisCaseWithContourViewable):
    '''DynamicAnalysisViewable
    ...
    @property
    def contour_draw_style(self) -> '_1960.ContourDrawStyle':
        ...
        if _1960.ContourDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_system_deflection_draw_style(self) -> '_2534.SystemDeflectionDrawStyle':
        ...
        if _2534.SystemDeflectionDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_steady_state_synchronous_response_draw_style(self) -> '_3316.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3316.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_stability_analysis_draw_style(self) -> '_3577.StabilityAnalysisDrawStyle':
        ...
        if _3577.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_rotor_dynamics_draw_style(self) -> '_3732.RotorDynamicsDrawStyle':
        ...
        if _3732.RotorDynamicsDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_modal_analysis_draw_style(self) -> '_4873.ModalAnalysisDrawStyle':
        ...
        if _4873.ModalAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_mbd_analysis_draw_style(self) -> '_5159.MBDAnalysisDrawStyle':
        ...
        if _5159.MBDAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5716.HarmonicAnalysisDrawStyle':
        ...
        if _5716.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_dynamic_analysis_draw_style(self) -> '_6018.DynamicAnalysisDrawStyle':
        ...
        if _6018.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_critical_speed_analysis_draw_style(self) -> '_6271.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6271.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style(self) -> '_6018.DynamicAnalysisDrawStyle':
        ...
        if _6018.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_modal_analysis_draw_style(self) -> '_4873.ModalAnalysisDrawStyle':
        ...
        if _4873.ModalAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5716.HarmonicAnalysisDrawStyle':
        ...
        if _5716.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
