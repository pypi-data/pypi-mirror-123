...
from mastapy.system_model import _1939
from mastapy import _0
from mastapy.system_model.part_model import _2159
...
T = TypeVar('T', bound='_2159.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1273.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1273.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_1939.RelativeOffsetOption':
        ...
        return constructor.new(_1939.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1939.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
