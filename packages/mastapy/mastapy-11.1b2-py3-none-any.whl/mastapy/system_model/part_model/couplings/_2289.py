...
from mastapy.system_model.part_model.couplings import _2290, _2303
from mastapy.system_model.connections_and_sockets import _1983
...
class BeltDrive(_2190.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2290.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2290.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2290.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2303.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2303.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1983.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1983.BeltConnection))
        return value
