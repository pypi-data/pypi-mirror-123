...
from mastapy.system_model.part_model.couplings import _2319, _2317
...
class Synchroniser(_2190.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2319.SynchroniserSleeve':
        ...
        return constructor.new(_2319.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2317.SynchroniserHalf':
        ...
        return constructor.new(_2317.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2317.SynchroniserHalf':
        ...
        return constructor.new(_2317.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_2057.ClutchConnection':
        ...
        return constructor.new(_2057.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_2057.ClutchConnection':
        ...
        return constructor.new(_2057.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
