...
from mastapy.system_model.part_model.couplings import _2297
...
class RollingRing(_2297.CouplingHalf):
    '''RollingRing
    ...
    @property
    def largest_end(self) -> '_298.Hand':
    ...
    @largest_end.setter
    def largest_end(self, value: '_298.Hand'):
