...
class SplineLeadRelief(_0.APIBase):
    ...
    def contact_position(self) -> '_1319.IndividualContactPosition':
        ...
        return constructor.new(_1319.IndividualContactPosition)(value) if value else None
    ...
    def crowning(self) -> '_2298.CrowningSpecification':
        ...
        return constructor.new(_2298.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning else None
