...
from mastapy.system_model import _1920
from mastapy._internal import constructor, conversion
from mastapy.geometry import _276
from mastapy.system_model.part_model.projections import _2199
from mastapy.system_model.part_model.part_groups import _2204
...
class RootAssembly(_2149.Assembly):
    '''RootAssembly
    ...
    def model(self) -> '_1920.Design':
        ...
        return constructor.new(_1920.Design)(self.wrapped.Model) if self.wrapped.Model else None

    @property
    def packaging_limits(self) -> '_276.PackagingLimits':
        ...
        return constructor.new(_276.PackagingLimits)(self.wrapped.PackagingLimits) if self.wrapped.PackagingLimits else None

    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2199.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2199.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2204.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2204.ParallelPartGroup))
        return value
