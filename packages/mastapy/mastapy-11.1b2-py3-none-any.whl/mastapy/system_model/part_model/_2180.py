...
from mastapy.materials.efficiency import _268
...
class OilSeal(_2162.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_268.OilSealMaterialType':
        ...
        return constructor.new(_268.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_268.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1688.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1688.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
