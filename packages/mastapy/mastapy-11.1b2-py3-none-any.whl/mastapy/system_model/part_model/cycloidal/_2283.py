...
class RingPins(_2178.MountableComponent):
    ...
    def ring_pins_design(self) -> '_1244.RingPinsDesign':
        ...
        return constructor.new(_1244.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign else None
    ...
    def ring_pins_material(self) -> '_1245.RingPinsMaterial':
        ...
        return constructor.new(_1245.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial else None
