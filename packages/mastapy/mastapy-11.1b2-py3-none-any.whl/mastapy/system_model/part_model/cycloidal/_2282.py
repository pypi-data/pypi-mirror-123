...
class CycloidalDisc(_2151.AbstractShaft):
    ...
    def cycloidal_disc_design(self) -> '_1238.CycloidalDiscDesign':
        ...
        return constructor.new(_1238.CycloidalDiscDesign)(self.wrapped.CycloidalDiscDesign) if self.wrapped.CycloidalDiscDesign else None
    ...
    def load_sharing_settings(self) -> '_2175.LoadSharingSettings':
        ...
        return constructor.new(_2175.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings else None
