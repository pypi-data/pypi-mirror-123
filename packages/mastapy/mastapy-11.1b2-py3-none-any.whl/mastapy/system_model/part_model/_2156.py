...
from mastapy.bearings.bearing_results import _1692, _1691
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def mounting_sleeve_material(self) -> '_217.BearingMaterial':
        ...
        return constructor.new(_217.BearingMaterial)(self.wrapped.MountingSleeveMaterial) if self.wrapped.MountingSleeveMaterial else None
