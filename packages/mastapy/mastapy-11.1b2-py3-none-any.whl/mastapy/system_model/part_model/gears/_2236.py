...
from mastapy.system_model.part_model.gears import _2244, _2243
...
class ConicalGear(_2243.Gear):
    ...
    @property
    def orientation(self) -> '_2244.GearOrientations':
        ...
        return constructor.new(_2244.GearOrientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_2244.GearOrientations'):
    ...
    @property
    def active_gear_design(self) -> '_1085.ConicalGearDesign':
    ...
    @property
    def conical_gear_design(self) -> '_1085.ConicalGearDesign':
        ...
        if _1085.ConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_zerol_bevel_gear_design(self) -> '_892.ZerolBevelGearDesign':
        ...
        if _892.ZerolBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_901.StraightBevelDiffGearDesign':
        ...
        if _901.StraightBevelDiffGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_straight_bevel_gear_design(self) -> '_905.StraightBevelGearDesign':
        ...
        if _905.StraightBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_spiral_bevel_gear_design(self) -> '_909.SpiralBevelGearDesign':
        ...
        if _909.SpiralBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_913.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _913.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_917.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _917.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_conical_gear_design(self) -> '_921.KlingelnbergConicalGearDesign':
        ...
        if _921.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_hypoid_gear_design(self) -> '_925.HypoidGearDesign':
        ...
        if _925.HypoidGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_bevel_gear_design(self) -> '_1111.BevelGearDesign':
        ...
        if _1111.BevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_1124.AGMAGleasonConicalGearDesign':
        ...
        if _1124.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
