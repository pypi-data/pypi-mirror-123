...
class KlingelnbergCycloPalloidSpiralBevelGear(_2249.KlingelnbergCycloPalloidConicalGear):
    ...
    def conical_gear_design(self) -> '_913.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_913.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.ConicalGearDesign) if self.wrapped.ConicalGearDesign else None
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_913.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_913.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign else None
