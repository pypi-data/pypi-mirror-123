...
from mastapy.gears.gear_designs.worm import _897, _896, _900
...
class WormGear(_2243.Gear):
    ...
    @property
    def active_gear_design(self) -> '_897.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_897.WormGearDesign':
        ...
        if _897.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
