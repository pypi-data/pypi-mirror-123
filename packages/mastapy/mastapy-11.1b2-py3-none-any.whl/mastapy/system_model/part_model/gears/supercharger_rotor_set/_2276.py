...
class SuperchargerRotorSet(_1579.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2278.YVariableForImportedData':
        ...
        return constructor.new(_2278.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2278.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2271.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2271.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2273.RotorSpeedInputOptions':
        ...
        return constructor.new(_2273.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2268.BoostPressureInputOptions':
        ...
        return constructor.new(_2268.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2270.PressureRatioInputOptions':
        ...
        return constructor.new(_2270.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2269.InputPowerInputOptions':
        ...
        return constructor.new(_2269.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2272.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2272.RotorSetMeasuredPoint))
        return value
