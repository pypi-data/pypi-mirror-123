...
class FaceGear(_2243.Gear):
    ...
    @property
    def active_gear_design(self) -> '_929.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_929.FaceGearDesign':
        ...
        if _929.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
