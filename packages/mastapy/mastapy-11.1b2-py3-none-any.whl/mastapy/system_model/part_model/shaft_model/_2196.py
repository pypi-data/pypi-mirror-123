...
class Shaft(_2151.AbstractShaft):
    ...
    def guide_image(self) -> '_2170.GuideImage':
        ...
        return constructor.new(_2170.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def fe_substructure_replacing_this(self) -> '_2097.FESubstructure':
        ...
        return constructor.new(_2097.FESubstructure)(self.wrapped.FESubstructureReplacingThis) if self.wrapped.FESubstructureReplacingThis else None
