...
from mastapy.system_model.part_model.part_groups import _2200, _2201, _2204
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2200.ConcentricOrParallelPartGroup':
        ...
        if _2200.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2201.ConcentricPartGroup':
        ...
        if _2201.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2204.ParallelPartGroup':
        ...
        if _2204.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
