...
from mastapy.bearings.tolerances import (
    _1633, _1634, _1636, _1647,
    _1642, _1650, _1637, _1651,
    _1643, _1653
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_results import _1688, _1689, _1671
from mastapy.bearings import (
    _1610, _1617, _1606, _1602
)
...
from mastapy.system_model.part_model import (
    _2154, _2187, _2156, _2160,
    _2162
)
from mastapy.materials import _237
from mastapy.bearings.bearing_results.rolling import _1794
...
class Bearing(_2162.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1634.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1634.BearingToleranceDefinitionOptions)(value) if value else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1634.BearingToleranceDefinitionOptions'):
    ...
    def orientation(self) -> '_1688.Orientations':
        ...
        return constructor.new(_1688.Orientations)(value) if value else None
    ...
    def is_internal_clearance_adjusted_after_fitting(self) -> 'overridable.Overridable_bool':
        ...
        return constructor.new(overridable.Overridable_bool)(self.wrapped.IsInternalClearanceAdjustedAfterFitting) if self.wrapped.IsInternalClearanceAdjustedAfterFitting else None
    ...
    @property
    def journal_bearing_type(self) -> '_1617.JournalBearingType':
        ...
        return constructor.new(_1617.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1617.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1606.BearingDampingMatrixOption':
        ...
        return constructor.new(_1606.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1606.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def permissible_axial_load_calculation_method(self) -> 'overridable.Overridable_CylindricalRollerMaxAxialLoadMethod':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.PermissibleAxialLoadCalculationMethod, value) if self.wrapped.PermissibleAxialLoadCalculationMethod else None
    ...
    @property
    def ring_tolerance_inner(self) -> '_1636.InnerRingTolerance':
        ...
        return constructor.new(_1636.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1647.RingTolerance':
        ...
        if _1647.RingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1636.InnerRingTolerance':
        ...
        if _1636.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1642.OuterRingTolerance':
        ...
        if _1642.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_outer(self) -> '_1642.OuterRingTolerance':
        ...
        return constructor.new(_1642.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1647.RingTolerance':
        ...
        if _1647.RingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1636.InnerRingTolerance':
        ...
        if _1636.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1642.OuterRingTolerance':
        ...
        if _1642.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_support_detail(self) -> '_1650.SupportDetail':
        ...
        return constructor.new(_1650.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1650.SupportDetail':
        ...
        return constructor.new(_1650.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1650.SupportDetail':
        ...
        return constructor.new(_1650.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1650.SupportDetail':
        ...
        return constructor.new(_1650.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1637.InnerSupportTolerance':
        ...
        return constructor.new(_1637.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1651.SupportTolerance':
        ...
        if _1651.SupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1637.InnerSupportTolerance':
        ...
        if _1637.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1643.OuterSupportTolerance':
        ...
        if _1643.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_outer(self) -> '_1643.OuterSupportTolerance':
        ...
        return constructor.new(_1643.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1651.SupportTolerance':
        ...
        if _1651.SupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1637.InnerSupportTolerance':
        ...
        if _1637.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1643.OuterSupportTolerance':
        ...
        if _1643.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1643.OuterSupportTolerance':
        ...
        return constructor.new(_1643.OuterSupportTolerance)(self.wrapped.InnerMountingSleeveBoreTolerance) if self.wrapped.InnerMountingSleeveBoreTolerance else None

    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1637.InnerSupportTolerance':
        ...
        return constructor.new(_1637.InnerSupportTolerance)(self.wrapped.InnerMountingSleeveOuterDiameterTolerance) if self.wrapped.InnerMountingSleeveOuterDiameterTolerance else None

    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1643.OuterSupportTolerance':
        ...
        return constructor.new(_1643.OuterSupportTolerance)(self.wrapped.OuterMountingSleeveBoreTolerance) if self.wrapped.OuterMountingSleeveBoreTolerance else None

    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1637.InnerSupportTolerance':
        ...
        return constructor.new(_1637.InnerSupportTolerance)(self.wrapped.OuterMountingSleeveOuterDiameterTolerance) if self.wrapped.OuterMountingSleeveOuterDiameterTolerance else None

    @property
    def simple_bearing_detail_property(self) -> '_1853.BearingDesign':
        ...
        if _1853.BearingDesign.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1854.DetailedBearing':
        ...
        if _1854.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1855.DummyRollingBearing':
        ...
        if _1855.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1856.LinearBearing':
        ...
        if _1856.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1857.NonLinearBearing':
        ...
        if _1857.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1858.AngularContactBallBearing':
        ...
        if _1858.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1859.AngularContactThrustBallBearing':
        ...
        if _1859.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1860.AsymmetricSphericalRollerBearing':
        ...
        if _1860.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1861.AxialThrustCylindricalRollerBearing':
        ...
        if _1861.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1862.AxialThrustNeedleRollerBearing':
        ...
        if _1862.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1863.BallBearing':
        ...
        if _1863.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1865.BarrelRollerBearing':
        ...
        if _1865.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_1870.CrossedRollerBearing':
        ...
        if _1870.CrossedRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1871.CylindricalRollerBearing':
        ...
        if _1871.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1872.DeepGrooveBallBearing':
        ...
        if _1872.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1874.FourPointContactBallBearing':
        ...
        if _1874.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1879.MultiPointContactBallBearing':
        ...
        if _1879.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1880.NeedleRollerBearing':
        ...
        if _1880.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1881.NonBarrelRollerBearing':
        ...
        if _1881.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1882.RollerBearing':
        ...
        if _1882.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1885.RollingBearing':
        ...
        if _1885.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1886.SelfAligningBallBearing':
        ...
        if _1886.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1889.SphericalRollerBearing':
        ...
        if _1889.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1890.SphericalRollerThrustBearing':
        ...
        if _1890.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1891.TaperRollerBearing':
        ...
        if _1891.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1892.ThreePointContactBallBearing':
        ...
        if _1892.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1893.ThrustBallBearing':
        ...
        if _1893.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1894.ToroidalRollerBearing':
        ...
        if _1894.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1907.PadFluidFilmBearing':
        ...
        if _1907.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1909.PlainGreaseFilledJournalBearing':
        ...
        if _1909.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1911.PlainJournalBearing':
        ...
        if _1911.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1913.PlainOilFedJournalBearing':
        ...
        if _1913.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1914.TiltingPadJournalBearing':
        ...
        if _1914.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1915.TiltingPadThrustBearing':
        ...
        if _1915.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1917.ConceptAxialClearanceBearing':
        ...
        if _1917.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1918.ConceptClearanceBearing':
        ...
        if _1918.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1919.ConceptRadialClearanceBearing':
        ...
        if _1919.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def detail(self) -> '_1853.BearingDesign':
        ...
        if _1853.BearingDesign.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_detailed_bearing(self) -> '_1854.DetailedBearing':
        ...
        if _1854.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1855.DummyRollingBearing':
        ...
        if _1855.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_linear_bearing(self) -> '_1856.LinearBearing':
        ...
        if _1856.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1857.NonLinearBearing':
        ...
        if _1857.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1858.AngularContactBallBearing':
        ...
        if _1858.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1859.AngularContactThrustBallBearing':
        ...
        if _1859.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1860.AsymmetricSphericalRollerBearing':
        ...
        if _1860.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1861.AxialThrustCylindricalRollerBearing':
        ...
        if _1861.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1862.AxialThrustNeedleRollerBearing':
        ...
        if _1862.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_ball_bearing(self) -> '_1863.BallBearing':
        ...
        if _1863.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1865.BarrelRollerBearing':
        ...
        if _1865.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_1870.CrossedRollerBearing':
        ...
        if _1870.CrossedRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1871.CylindricalRollerBearing':
        ...
        if _1871.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1872.DeepGrooveBallBearing':
        ...
        if _1872.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1874.FourPointContactBallBearing':
        ...
        if _1874.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1879.MultiPointContactBallBearing':
        ...
        if _1879.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1880.NeedleRollerBearing':
        ...
        if _1880.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1881.NonBarrelRollerBearing':
        ...
        if _1881.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_roller_bearing(self) -> '_1882.RollerBearing':
        ...
        if _1882.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1885.RollingBearing':
        ...
        if _1885.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1886.SelfAligningBallBearing':
        ...
        if _1886.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1889.SphericalRollerBearing':
        ...
        if _1889.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1890.SphericalRollerThrustBearing':
        ...
        if _1890.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1891.TaperRollerBearing':
        ...
        if _1891.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1892.ThreePointContactBallBearing':
        ...
        if _1892.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1893.ThrustBallBearing':
        ...
        if _1893.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1894.ToroidalRollerBearing':
        ...
        if _1894.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1907.PadFluidFilmBearing':
        ...
        if _1907.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1909.PlainGreaseFilledJournalBearing':
        ...
        if _1909.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1911.PlainJournalBearing':
        ...
        if _1911.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1913.PlainOilFedJournalBearing':
        ...
        if _1913.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1914.TiltingPadJournalBearing':
        ...
        if _1914.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1915.TiltingPadThrustBearing':
        ...
        if _1915.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1917.ConceptAxialClearanceBearing':
        ...
        if _1917.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1918.ConceptClearanceBearing':
        ...
        if _1918.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1919.ConceptRadialClearanceBearing':
        ...
        if _1919.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def axial_internal_clearance_tolerance(self) -> '_2154.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_2154.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_2187.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_2187.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None
    ...
    def overridden_lubrication_detail(self) -> '_237.LubricationDetail':
        ...
        return constructor.new(_237.LubricationDetail)(self.wrapped.OverriddenLubricationDetail) if self.wrapped.OverriddenLubricationDetail else None

    @property
    def friction_coefficients(self) -> '_1794.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1794.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def force_at_zero_displacement(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.ForceAtZeroDisplacement) if self.wrapped.ForceAtZeroDisplacement else None

    @property
    def tolerance_combinations(self) -> 'List[_1653.ToleranceCombination]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToleranceCombinations, constructor.new(_1653.ToleranceCombination))
        return value

    @property
    def mounting(self) -> 'List[_2156.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mounting, constructor.new(_2156.BearingRaceMountingOptions))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1602.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2196.Shaft', offset: Optional['float'] = float('nan')) -> '_2160.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2196.Shaft', offset: Optional['float'] = float('nan')) -> '_2160.ComponentsConnectedResult':
