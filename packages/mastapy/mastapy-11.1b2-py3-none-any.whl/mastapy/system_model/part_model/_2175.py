...
from mastapy.system_model.part_model import _2153, _2174
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2153.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2153.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2153.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2174.LoadSharingModes':
        ...
        return constructor.new(_2174.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2174.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
