...
class StaticLoadCase(_6491.LoadCase):
    ...
    def system_deflection(self) -> '_2359.SystemDeflectionAnalysis':
        ...
        return constructor.new(_2359.SystemDeflectionAnalysis)(self.wrapped.SystemDeflection) if self.wrapped.SystemDeflection else None
    ...
    def power_flow(self) -> '_2354.PowerFlowAnalysis':
        ...
        return constructor.new(_2354.PowerFlowAnalysis)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow else None
    ...
    def advanced_system_deflection(self) -> '_2334.AdvancedSystemDeflectionAnalysis':
        ...
        return constructor.new(_2334.AdvancedSystemDeflectionAnalysis)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None
    ...
    def harmonic_analysis(self) -> '_2345.HarmonicAnalysis':
        ...
        return constructor.new(_2345.HarmonicAnalysis)(self.wrapped.HarmonicAnalysis) if self.wrapped.HarmonicAnalysis else None
    ...
    def parametric_study_tool(self) -> '_2353.ParametricStudyToolAnalysis':
        ...
        return constructor.new(_2353.ParametricStudyToolAnalysis)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
    ...
    def compound_parametric_study_tool(self) -> '_2337.CompoundParametricStudyToolAnalysis':
        ...
        return constructor.new(_2337.CompoundParametricStudyToolAnalysis)(self.wrapped.CompoundParametricStudyTool) if self.wrapped.CompoundParametricStudyTool else None
    ...
    def steady_state_synchronous_response(self) -> '_2356.SteadyStateSynchronousResponseAnalysis':
        ...
        return constructor.new(_2356.SteadyStateSynchronousResponseAnalysis)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
    ...
    def modal_analysis(self) -> '_2348.ModalAnalysis':
        ...
        return constructor.new(_2348.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None
    ...
    def critical_speed_analysis(self) -> '_2338.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2338.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysis) if self.wrapped.CriticalSpeedAnalysis else None
    ...
    def stability_analysis(self) -> '_2355.StabilityAnalysis':
        ...
        return constructor.new(_2355.StabilityAnalysis)(self.wrapped.StabilityAnalysis) if self.wrapped.StabilityAnalysis else None
    ...
    def dynamic_model_for_modal_analysis(self) -> '_2342.DynamicModelForModalAnalysis':
        ...
        return constructor.new(_2342.DynamicModelForModalAnalysis)(self.wrapped.DynamicModelForModalAnalysis) if self.wrapped.DynamicModelForModalAnalysis else None
    ...
    def advanced_system_deflection_options(self) -> '_6965.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6965.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None
    ...
    def te_set_up_for_dynamic_analyses_options(self) -> '_2396.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2396.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None
    ...
    def design_state_load_case_group(self) -> '_5361.DesignState':
        ...
        return constructor.new(_5361.DesignState)(self.wrapped.DesignStateLoadCaseGroup) if self.wrapped.DesignStateLoadCaseGroup else None
