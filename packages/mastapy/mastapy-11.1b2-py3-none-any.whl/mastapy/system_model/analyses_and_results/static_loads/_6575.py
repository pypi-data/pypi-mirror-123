...
from mastapy.system_model.fe import _2074, _2097
...
class FEPartLoadCase(_6496.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2074.AngleSource':
        ...
        return constructor.new(_2074.AngleSource)(value) if value else None
