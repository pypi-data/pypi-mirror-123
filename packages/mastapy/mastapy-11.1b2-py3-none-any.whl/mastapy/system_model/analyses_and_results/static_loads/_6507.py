...
from mastapy.math_utility.hertzian_contact import _1354
...
from mastapy.bearings.bearing_results.rolling import _1699, _1793, _1794
from mastapy.bearings.bearing_results import _1671
from mastapy.system_model.part_model import _2155
from mastapy.bearings.tolerances import _1644, _1650
...
class BearingLoadCase(_6537.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    def oil_level(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.OilLevel) if self.wrapped.OilLevel else None
    ...
    def rolling_frictional_moment_factor_for_newly_greased_bearing(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.RollingFrictionalMomentFactorForNewlyGreasedBearing) if self.wrapped.RollingFrictionalMomentFactorForNewlyGreasedBearing else None
    ...
    @property
    def include_fitting_effects(self) -> '_1369.LoadCaseOverrideOption':
        ...
        return constructor.new(_1369.LoadCaseOverrideOption)(value) if value else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1369.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeFittingEffects = value

    @property
    def include_thermal_expansion_effects(self) -> '_1369.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1369.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeThermalExpansionEffects = value

    @property
    def include_ring_ovality(self) -> '_1369.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1369.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearing_stiffness_model(self) -> '_5085.BearingStiffnessModel':
        ...
        return constructor.new(_5085.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5085.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5085.BearingStiffnessModel':
    ...
    def use_element_contact_angles_for_angular_velocities_in_ball_bearing(self) -> 'overridable.Overridable_bool':
        ...
        return constructor.new(overridable.Overridable_bool)(self.wrapped.UseElementContactAnglesForAngularVelocitiesInBallBearing) if self.wrapped.UseElementContactAnglesForAngularVelocitiesInBallBearing else None
    ...
    def roller_analysis_method(self) -> 'overridable.Overridable_RollerAnalysisMethod':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.RollerAnalysisMethod, value) if self.wrapped.RollerAnalysisMethod else None
    ...
    def minimum_clearance_for_ribs(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.MinimumClearanceForRibs) if self.wrapped.MinimumClearanceForRibs else None
    ...
    @property
    def left_ring_detail(self) -> '_1644.RaceDetail':
        ...
        return constructor.new(_1644.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail else None

    @property
    def right_ring_detail(self) -> '_1644.RaceDetail':
        ...
        return constructor.new(_1644.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail else None
    ...
    @property
    def inner_ring_detail(self) -> '_1644.RaceDetail':
        ...
        return constructor.new(_1644.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail else None
    ...
    @property
    def outer_ring_detail(self) -> '_1644.RaceDetail':
        ...
        return constructor.new(_1644.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail else None
