...
from mastapy.utility.file_access_helpers import _1569
from mastapy.utility_gui import _1597
...
class MultiTimeSeriesDataInputFileOptions(_1597.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1569.TextFileDelimiterOptions':
        ...
        return constructor.new(_1569.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
