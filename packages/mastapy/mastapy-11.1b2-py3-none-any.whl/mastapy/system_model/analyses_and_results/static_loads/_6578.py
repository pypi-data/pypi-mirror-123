...
class GearLoadCase(_6615.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6579.GearManufactureError':
        ...
        if _6579.GearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6532.ConicalGearManufactureError':
        ...
        if _6532.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6549.CylindricalGearManufactureError':
        ...
        if _6549.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
