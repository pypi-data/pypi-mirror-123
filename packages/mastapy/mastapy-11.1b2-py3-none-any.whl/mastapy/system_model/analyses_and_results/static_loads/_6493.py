...
class TimeSeriesLoadCase(_6491.LoadCase):
    ...
    def multibody_dynamics_analysis(self) -> '_2352.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2352.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysis) if self.wrapped.MultibodyDynamicsAnalysis else None
    ...
    def driva_analysis_options(self) -> '_5160.MBDAnalysisOptions':
        ...
        return constructor.new(_5160.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
    ...
    def time_series_load_case_group(self) -> '_5369.TimeSeriesLoadCaseGroup':
        ...
        return constructor.new(_5369.TimeSeriesLoadCaseGroup)(self.wrapped.TimeSeriesLoadCaseGroup) if self.wrapped.TimeSeriesLoadCaseGroup else None
