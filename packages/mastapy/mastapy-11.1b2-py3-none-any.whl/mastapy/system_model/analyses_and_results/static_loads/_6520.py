...
class ClutchConnectionLoadCase(_6538.CouplingConnectionLoadCase):
    '''ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'ClutchPressures' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.ClutchPressures) if self.wrapped.ClutchPressures else None

    @clutch_pressures.setter
    def clutch_pressures(self, value: '_1317.Vector2DListAccessor'):
