...
from mastapy.system_model.analyses_and_results.static_loads import _6549, _6578
...
class CylindricalGearLoadCase(_6578.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6549.CylindricalGearManufactureError':
        ...
        return constructor.new(_6549.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def overridden_micro_geometry(self) -> '_1036.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1036.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
