...
class WindTurbineCertificationReport(_5957.CombinationAnalysis):
    ...
    def design(self) -> '_2188.RootAssembly':
        ...
        return constructor.new(_2188.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def ldd_static_analysis(self) -> '_2654.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2654.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None
    ...
    def nominal_load_case_static_analysis(self) -> '_2508.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2508.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None
    ...
    def extreme_load_case_static_analysis(self) -> '_2508.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2508.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
