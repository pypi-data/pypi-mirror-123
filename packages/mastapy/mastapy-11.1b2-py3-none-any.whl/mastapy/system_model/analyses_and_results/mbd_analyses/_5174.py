...
class PulleyMultibodyDynamicsAnalysis(_5116.CouplingHalfMultibodyDynamicsAnalysis):
    '''PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self) -> 'List[_5224.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakPulleyTorque, constructor.new(_5224.DynamicTorqueResultAtTime))
        return value
