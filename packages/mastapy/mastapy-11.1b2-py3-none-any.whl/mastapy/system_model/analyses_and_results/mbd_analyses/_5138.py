...
class GearMultibodyDynamicsAnalysis(_5163.MountableComponentMultibodyDynamicsAnalysis):
    '''GearMultibodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5224.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5224.DynamicTorqueResultAtTime))
        return value
