...
class RollingRingConnectionCompoundMultibodyDynamicsAnalysis(_5292.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''RollingRingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5178.RollingRingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5178.RollingRingConnectionMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5178.RollingRingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5178.RollingRingConnectionMultibodyDynamicsAnalysis))
        return value
