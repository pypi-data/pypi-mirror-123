...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5208
...
class TorqueConverterCompoundMultibodyDynamicsAnalysis(_5264.CouplingCompoundMultibodyDynamicsAnalysis):
    '''TorqueConverterCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5208.TorqueConverterMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5208.TorqueConverterMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5208.TorqueConverterMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5208.TorqueConverterMultibodyDynamicsAnalysis))
        return value
