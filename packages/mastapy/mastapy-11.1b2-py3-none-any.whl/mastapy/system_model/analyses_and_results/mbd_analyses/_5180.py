...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2352, _5083
...
class RootAssemblyMultibodyDynamicsAnalysis(_5083.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2352.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2352.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs else None
