...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5098, _5117
...
class ClutchMultibodyDynamicsAnalysis(_5117.CouplingMultibodyDynamicsAnalysis):
    '''ClutchMultibodyDynamicsAnalysis
    ...
    def assembly_load_case(self) -> '_6522.ClutchLoadCase':
        ...
        return constructor.new(_6522.ClutchLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def clutch_connection(self) -> '_5098.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5098.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
