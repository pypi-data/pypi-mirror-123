...
class FlexiblePinAssemblyCompoundCriticalSpeedAnalysis(_6460.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    '''FlexiblePinAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6290.FlexiblePinAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6290.FlexiblePinAssemblyCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6290.FlexiblePinAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6290.FlexiblePinAssemblyCriticalSpeedAnalysis))
        return value
