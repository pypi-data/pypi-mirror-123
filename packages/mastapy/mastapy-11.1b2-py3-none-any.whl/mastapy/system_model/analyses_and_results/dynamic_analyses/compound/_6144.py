...
class CylindricalGearMeshCompoundDynamicAnalysis(_6155.GearMeshCompoundDynamicAnalysis):
    '''CylindricalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6014.CylindricalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6014.CylindricalGearMeshDynamicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6014.CylindricalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6014.CylindricalGearMeshDynamicAnalysis))
        return value
