...
class MassDiscCompoundDynamicAnalysis(_6218.VirtualComponentCompoundDynamicAnalysis):
    '''MassDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6042.MassDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6042.MassDiscDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6042.MassDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6042.MassDiscDynamicAnalysis))
        return value
