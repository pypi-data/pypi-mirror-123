...
class PowerLoadCompoundDynamicAnalysis(_6218.VirtualComponentCompoundDynamicAnalysis):
    '''PowerLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6054.PowerLoadDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6054.PowerLoadDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6054.PowerLoadDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6054.PowerLoadDynamicAnalysis))
        return value
