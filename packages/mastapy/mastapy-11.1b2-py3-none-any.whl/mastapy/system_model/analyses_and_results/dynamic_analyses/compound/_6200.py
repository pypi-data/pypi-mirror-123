...
class SpringDamperHalfCompoundDynamicAnalysis(_6135.CouplingHalfCompoundDynamicAnalysis):
    '''SpringDamperHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6071.SpringDamperHalfDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6071.SpringDamperHalfDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6071.SpringDamperHalfDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6071.SpringDamperHalfDynamicAnalysis))
        return value
