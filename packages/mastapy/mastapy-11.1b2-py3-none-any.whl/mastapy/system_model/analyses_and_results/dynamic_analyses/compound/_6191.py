...
class ShaftCompoundDynamicAnalysis(_6097.AbstractShaftCompoundDynamicAnalysis):
    '''ShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6062.ShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6062.ShaftDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6062.ShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6062.ShaftDynamicAnalysis))
        return value
