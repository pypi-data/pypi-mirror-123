...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6211
...
class SynchroniserSleeveCompoundDynamicAnalysis(_6211.SynchroniserPartCompoundDynamicAnalysis):
    '''SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6083.SynchroniserSleeveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6083.SynchroniserSleeveDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6083.SynchroniserSleeveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6083.SynchroniserSleeveDynamicAnalysis))
        return value
