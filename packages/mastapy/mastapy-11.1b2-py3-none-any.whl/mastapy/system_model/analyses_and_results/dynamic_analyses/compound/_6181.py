...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6173
...
class PlanetCarrierCompoundDynamicAnalysis(_6173.MountableComponentCompoundDynamicAnalysis):
    '''PlanetCarrierCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6052.PlanetCarrierDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6052.PlanetCarrierDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6052.PlanetCarrierDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6052.PlanetCarrierDynamicAnalysis))
        return value
