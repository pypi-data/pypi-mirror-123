...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6132
...
class ShaftHubConnectionCompoundDynamicAnalysis(_6132.ConnectorCompoundDynamicAnalysis):
    '''ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6063.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6063.ShaftHubConnectionDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6063.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6063.ShaftHubConnectionDynamicAnalysis))
        return value
