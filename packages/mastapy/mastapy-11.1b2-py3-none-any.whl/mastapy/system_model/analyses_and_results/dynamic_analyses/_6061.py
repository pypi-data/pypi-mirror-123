...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2339, _5973
...
from mastapy.system_model.analyses_and_results.modal_analyses import _2342
...
class RootAssemblyDynamicAnalysis(_5973.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2339.DynamicAnalysis':
        ...
        if _2339.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
