...
class SynchroniserShift(_0.APIBase):
    ...
    def cone(self) -> '_2317.SynchroniserHalf':
        ...
        return constructor.new(_2317.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None
    ...
    def sleeve(self) -> '_2319.SynchroniserSleeve':
        ...
        return constructor.new(_2319.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
