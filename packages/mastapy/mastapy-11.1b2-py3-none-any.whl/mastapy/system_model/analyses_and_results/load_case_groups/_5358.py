...
class AbstractStaticLoadCaseGroup(_5357.AbstractLoadCaseGroup):
    ...
    def optimum_tooth_numbers_target(self) -> '_5368.SystemOptimiserTargets':
        ...
        return constructor.new(_5368.SystemOptimiserTargets)(value) if value else None
    ...
    def gear_set_optimisation(self) -> '_5367.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new(_5367.SystemOptimiserGearSetOptimisation)(value) if value else None
    ...
    def compound_system_deflection(self) -> '_2394.CompoundSystemDeflectionAnalysis':
        ...
        return constructor.new(_2394.CompoundSystemDeflectionAnalysis)(self.wrapped.CompoundSystemDeflection) if self.wrapped.CompoundSystemDeflection else None
    ...
    def compound_power_flow(self) -> '_2389.CompoundPowerFlowAnalysis':
        ...
        return constructor.new(_2389.CompoundPowerFlowAnalysis)(self.wrapped.CompoundPowerFlow) if self.wrapped.CompoundPowerFlow else None
    ...
    def compound_advanced_system_deflection(self) -> '_2371.CompoundAdvancedSystemDeflectionAnalysis':
        ...
        return constructor.new(_2371.CompoundAdvancedSystemDeflectionAnalysis)(self.wrapped.CompoundAdvancedSystemDeflection) if self.wrapped.CompoundAdvancedSystemDeflection else None
    ...
    def compound_harmonic_analysis(self) -> '_2381.CompoundHarmonicAnalysis':
        ...
        return constructor.new(_2381.CompoundHarmonicAnalysis)(self.wrapped.CompoundHarmonicAnalysis) if self.wrapped.CompoundHarmonicAnalysis else None
    ...
    def compound_steady_state_synchronous_response(self) -> '_2391.CompoundSteadyStateSynchronousResponseAnalysis':
        ...
        return constructor.new(_2391.CompoundSteadyStateSynchronousResponseAnalysis)(self.wrapped.CompoundSteadyStateSynchronousResponse) if self.wrapped.CompoundSteadyStateSynchronousResponse else None
    ...
    def compound_modal_analysis(self) -> '_2384.CompoundModalAnalysis':
        ...
        return constructor.new(_2384.CompoundModalAnalysis)(self.wrapped.CompoundModalAnalysis) if self.wrapped.CompoundModalAnalysis else None
    ...
    def compound_critical_speed_analysis(self) -> '_2374.CompoundCriticalSpeedAnalysis':
        ...
        return constructor.new(_2374.CompoundCriticalSpeedAnalysis)(self.wrapped.CompoundCriticalSpeedAnalysis) if self.wrapped.CompoundCriticalSpeedAnalysis else None
    ...
    def compound_stability_analysis(self) -> '_2390.CompoundStabilityAnalysis':
        ...
        return constructor.new(_2390.CompoundStabilityAnalysis)(self.wrapped.CompoundStabilityAnalysis) if self.wrapped.CompoundStabilityAnalysis else None
    ...
    def compound_advanced_time_stepping_analysis_for_modulation(self) -> '_2373.CompoundAdvancedTimeSteppingAnalysisForModulation':
        ...
        return constructor.new(_2373.CompoundAdvancedTimeSteppingAnalysisForModulation)(self.wrapped.CompoundAdvancedTimeSteppingAnalysisForModulation) if self.wrapped.CompoundAdvancedTimeSteppingAnalysisForModulation else None
    ...
    def compound_dynamic_model_for_modal_analysis(self) -> '_2378.CompoundDynamicModelForModalAnalysis':
        ...
        return constructor.new(_2378.CompoundDynamicModelForModalAnalysis)(self.wrapped.CompoundDynamicModelForModalAnalysis) if self.wrapped.CompoundDynamicModelForModalAnalysis else None
