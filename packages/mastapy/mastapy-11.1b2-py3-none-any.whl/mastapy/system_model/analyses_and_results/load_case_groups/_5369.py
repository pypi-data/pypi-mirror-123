...
class TimeSeriesLoadCaseGroup(_5357.AbstractLoadCaseGroup):
    ...
    def compound_multibody_dynamics_analysis(self) -> '_2388.CompoundMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2388.CompoundMultibodyDynamicsAnalysis)(self.wrapped.CompoundMultibodyDynamicsAnalysis) if self.wrapped.CompoundMultibodyDynamicsAnalysis else None
