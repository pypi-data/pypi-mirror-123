...
class GuideDxfModelSystemDeflection(_2423.ComponentSystemDeflection):
    '''GuideDxfModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3800.GuideDxfModelPowerFlow':
        ...
        return constructor.new(_3800.GuideDxfModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
