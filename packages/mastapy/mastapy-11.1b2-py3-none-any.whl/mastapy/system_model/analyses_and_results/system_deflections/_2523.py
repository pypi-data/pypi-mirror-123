...
from mastapy.system_model.analyses_and_results.power_flows import _3847, _3852, _3853
...
class StraightBevelDiffGearSystemDeflection(_2416.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3847.StraightBevelDiffGearPowerFlow':
