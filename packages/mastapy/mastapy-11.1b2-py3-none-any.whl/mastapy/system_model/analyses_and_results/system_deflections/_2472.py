...
class HypoidGearSetSystemDeflection(_2403.AGMAGleasonConicalGearSetSystemDeflection):
    ...
    def power_flow_results(self) -> '_3803.HypoidGearSetPowerFlow':
        ...
        return constructor.new(_3803.HypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    def rating(self) -> '_405.HypoidGearSetRating':
        ...
        return constructor.new(_405.HypoidGearSetRating)(self.wrapped.Rating) if self.wrapped.Rating else None
    ...
    def component_detailed_analysis(self) -> '_405.HypoidGearSetRating':
        ...
        return constructor.new(_405.HypoidGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
