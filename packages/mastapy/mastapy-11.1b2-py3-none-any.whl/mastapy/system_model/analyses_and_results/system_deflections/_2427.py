...
class ConceptCouplingSystemDeflection(_2439.CouplingSystemDeflection):
    '''ConceptCouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3766.ConceptCouplingPowerFlow':
        ...
        return constructor.new(_3766.ConceptCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
