...
class BevelDifferentialSunGearSystemDeflection(_2411.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3753.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3753.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
