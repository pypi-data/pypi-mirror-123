...
class PowerLoadCompoundSystemDeflection(_2683.VirtualComponentCompoundSystemDeflection):
    '''PowerLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2500.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2500.PowerLoadSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2500.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2500.PowerLoadSystemDeflection))
        return value
