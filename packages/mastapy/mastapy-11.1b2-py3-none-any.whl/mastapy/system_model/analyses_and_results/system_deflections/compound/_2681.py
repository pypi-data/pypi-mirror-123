...
class TorqueConverterTurbineCompoundSystemDeflection(_2598.CouplingHalfCompoundSystemDeflection):
    '''TorqueConverterTurbineCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2539.TorqueConverterTurbineSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2539.TorqueConverterTurbineSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2539.TorqueConverterTurbineSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2539.TorqueConverterTurbineSystemDeflection))
        return value
