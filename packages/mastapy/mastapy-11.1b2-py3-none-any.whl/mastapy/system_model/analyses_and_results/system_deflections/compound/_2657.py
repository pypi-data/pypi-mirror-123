...
class ShaftHubConnectionCompoundSystemDeflection(_2595.ConnectorCompoundSystemDeflection):
    '''ShaftHubConnectionCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2509.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2509.ShaftHubConnectionSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2509.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2509.ShaftHubConnectionSystemDeflection))
        return value
