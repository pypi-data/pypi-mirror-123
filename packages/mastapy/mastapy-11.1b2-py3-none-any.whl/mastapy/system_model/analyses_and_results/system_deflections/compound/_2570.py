...
class BevelDifferentialGearCompoundSystemDeflection(_2575.BevelGearCompoundSystemDeflection):
    '''BevelDifferentialGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2411.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2411.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2411.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2411.BevelDifferentialGearSystemDeflection))
        return value
