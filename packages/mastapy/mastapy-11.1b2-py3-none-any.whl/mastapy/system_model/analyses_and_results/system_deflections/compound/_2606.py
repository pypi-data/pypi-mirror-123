...
class CylindricalGearCompoundSystemDeflection(_2618.GearCompoundSystemDeflection):
    '''CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def cylindrical_duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalDutyCycleRating) if self.wrapped.CylindricalDutyCycleRating else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2455.CylindricalGearSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2455.CylindricalGearSystemDeflectionWithLTCAResults))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2455.CylindricalGearSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2455.CylindricalGearSystemDeflectionWithLTCAResults))
        return value
