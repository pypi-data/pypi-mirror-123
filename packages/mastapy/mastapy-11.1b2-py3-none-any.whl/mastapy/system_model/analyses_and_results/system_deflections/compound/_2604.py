...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2560
...
class CycloidalDiscCompoundSystemDeflection(_2560.AbstractShaftCompoundSystemDeflection):
    '''CycloidalDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2446.CycloidalDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2446.CycloidalDiscSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2446.CycloidalDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2446.CycloidalDiscSystemDeflection))
        return value
