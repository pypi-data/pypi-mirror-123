...
class TorqueConverterPumpCompoundSystemDeflection(_2598.CouplingHalfCompoundSystemDeflection):
    '''TorqueConverterPumpCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2537.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2537.TorqueConverterPumpSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2537.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2537.TorqueConverterPumpSystemDeflection))
        return value
