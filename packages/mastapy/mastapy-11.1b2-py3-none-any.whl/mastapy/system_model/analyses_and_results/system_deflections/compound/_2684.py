...
class WormGearCompoundSystemDeflection(_2618.GearCompoundSystemDeflection):
    '''WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_337.WormGearDutyCycleRating':
        ...
        return constructor.new(_337.WormGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def worm_duty_cycle_rating(self) -> '_337.WormGearDutyCycleRating':
        ...
        return constructor.new(_337.WormGearDutyCycleRating)(self.wrapped.WormDutyCycleRating) if self.wrapped.WormDutyCycleRating else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2546.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2546.WormGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2546.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2546.WormGearSystemDeflection))
        return value
