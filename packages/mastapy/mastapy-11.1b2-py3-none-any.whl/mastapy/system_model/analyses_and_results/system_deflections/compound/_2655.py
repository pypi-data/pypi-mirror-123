...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2656, _2560
...
class ShaftCompoundSystemDeflection(_2560.AbstractShaftCompoundSystemDeflection):
    '''ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2656.ShaftDutyCycleSystemDeflection':
        ...
        return constructor.new(_2656.ShaftDutyCycleSystemDeflection)(self.wrapped.ShaftDutyCycleDamageResults) if self.wrapped.ShaftDutyCycleDamageResults else None

    @property
    def component_analysis_cases_ready(self) -> 'List[_2512.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2512.ShaftSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2512.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2512.ShaftSystemDeflection))
        return value
