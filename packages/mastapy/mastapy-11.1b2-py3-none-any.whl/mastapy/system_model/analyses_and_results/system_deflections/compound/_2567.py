...
class BearingCompoundSystemDeflection(_2595.ConnectorCompoundSystemDeflection):
    '''BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1676.LoadedBearingDutyCycle':
        ...
        if _1676.LoadedBearingDutyCycle.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2406.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2406.BearingSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2406.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2406.BearingSystemDeflection))
        return value
