...
class OilSealCompoundSystemDeflection(_2595.ConnectorCompoundSystemDeflection):
    '''OilSealCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2492.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2492.OilSealSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2492.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2492.OilSealSystemDeflection))
        return value
