...
class StraightBevelDiffGearMeshCompoundSystemDeflection(_2576.BevelGearMeshCompoundSystemDeflection):
    '''StraightBevelDiffGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2521.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2521.StraightBevelDiffGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2521.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2521.StraightBevelDiffGearMeshSystemDeflection))
        return value
