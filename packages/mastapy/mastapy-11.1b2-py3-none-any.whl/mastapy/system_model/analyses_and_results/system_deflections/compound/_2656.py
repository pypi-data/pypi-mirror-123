...
class ShaftDutyCycleSystemDeflection(_0.APIBase):
    ...
    @property
    def shaft_design(self) -> '_2196.Shaft':
        ...
        return constructor.new(_2196.Shaft)(self.wrapped.ShaftDesign) if self.wrapped.ShaftDesign else None
    ...
    @property
    def shaft_static_analyses(self) -> 'List[_2512.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2512.ShaftSystemDeflection))
        return value
