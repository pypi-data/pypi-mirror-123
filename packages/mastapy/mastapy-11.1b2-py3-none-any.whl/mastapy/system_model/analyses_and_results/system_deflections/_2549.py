...
class ZerolBevelGearSystemDeflection(_2416.BevelGearSystemDeflection):
    '''ZerolBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3869.ZerolBevelGearPowerFlow':
        ...
        return constructor.new(_3869.ZerolBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
