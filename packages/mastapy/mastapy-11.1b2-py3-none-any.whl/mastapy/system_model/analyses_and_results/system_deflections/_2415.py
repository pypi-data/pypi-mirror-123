...
class BevelGearSetSystemDeflection(_2403.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3756.BevelGearSetPowerFlow':
