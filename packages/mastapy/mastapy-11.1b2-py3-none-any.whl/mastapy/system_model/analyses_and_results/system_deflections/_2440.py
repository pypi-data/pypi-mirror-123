...
class CVTBeltConnectionSystemDeflection(_2407.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3778.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3778.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
