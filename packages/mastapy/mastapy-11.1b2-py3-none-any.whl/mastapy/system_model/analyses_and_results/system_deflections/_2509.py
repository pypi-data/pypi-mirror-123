...
from mastapy.detailed_rigid_connectors.rating import _1220
from mastapy.detailed_rigid_connectors.splines.ratings import (
    _1208, _1210, _1212, _1214,
    _1216
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1226
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1233
from mastapy.bearings.bearing_results import _1670
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2558
...
class ShaftHubConnectionSystemDeflection(_2436.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    def component_design(self) -> '_2311.ShaftHubConnection':
        ...
        return constructor.new(_2311.ShaftHubConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    def component_load_case(self) -> '_6640.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_6640.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3836.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3836.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def component_detailed_analysis(self) -> '_1220.ShaftHubConnectionRating':
        ...
        if _1220.ShaftHubConnectionRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1208.AGMA6123SplineJointRating':
        ...
        if _1208.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1210.DIN5466SplineRating':
        ...
        if _1210.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1212.GBT17855SplineJointRating':
        ...
        if _1212.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1214.SAESplineJointRating':
        ...
        if _1214.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1216.SplineJointRating':
        ...
        if _1216.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1226.KeywayRating':
        ...
        if _1226.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1233.InterferenceFitRating':
        ...
        if _1233.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1670.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1670.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1670.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1670.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2558.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2558.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2558.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2558.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2558.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2558.SplineFlankContactReporting))
        return value
