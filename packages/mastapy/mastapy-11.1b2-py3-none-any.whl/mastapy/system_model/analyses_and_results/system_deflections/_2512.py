...
from mastapy.system_model.analyses_and_results.system_deflections import _2510, _2511, _2400
...
class ShaftSystemDeflection(_2400.AbstractShaftSystemDeflection):
    '''ShaftSystemDeflection
    ...
    def component_design(self) -> '_2196.Shaft':
        ...
        return constructor.new(_2196.Shaft)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    def component_load_case(self) -> '_6641.ShaftLoadCase':
        ...
        return constructor.new(_6641.ShaftLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3837.ShaftPowerFlow':
        ...
        return constructor.new(_3837.ShaftPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2510.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2510.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2510.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2510.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2510.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2510.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2511.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2511.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2510.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2510.ShaftSectionEndResultsSystemDeflection))
        return value

    @property
    def mounted_components_applying_torque(self) -> 'List[_1344.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MountedComponentsApplyingTorque, constructor.new(_1344.ForceResults))
        return value
