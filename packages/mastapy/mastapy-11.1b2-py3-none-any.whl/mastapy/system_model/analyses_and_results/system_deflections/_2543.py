...
class VirtualComponentSystemDeflection(_2490.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3864.VirtualComponentPowerFlow':
