...
class SpiralBevelGearMeshSystemDeflection(_2414.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3840.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3840.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
