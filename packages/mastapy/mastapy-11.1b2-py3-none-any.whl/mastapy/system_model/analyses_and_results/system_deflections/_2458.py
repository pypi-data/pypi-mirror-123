...
class CylindricalPlanetGearSystemDeflection(_2455.CylindricalGearSystemDeflectionWithLTCAResults):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3789.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3789.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
