...
from mastapy.system_model.analyses_and_results.power_flows import _3829, _3780
...
class PulleySystemDeflection(_2438.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3829.PulleyPowerFlow':
