...
class HypoidGearMeshSystemDeflection(_2402.AGMAGleasonConicalGearMeshSystemDeflection):
    '''HypoidGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3801.HypoidGearMeshPowerFlow':
        ...
        return constructor.new(_3801.HypoidGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
