...
from mastapy.system_model.analyses_and_results.system_deflections import _2503, _2514
...
class CycloidalAssemblySystemDeflection(_2514.SpecialisedAssemblySystemDeflection):
    '''CycloidalAssemblySystemDeflection
    ...
    def assembly_load_case(self) -> '_6544.CycloidalAssemblyLoadCase':
        ...
        return constructor.new(_6544.CycloidalAssemblyLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def power_flow_results(self) -> '_3781.CycloidalAssemblyPowerFlow':
        ...
        return constructor.new(_3781.CycloidalAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def ring_pins_to_disc_connections(self) -> 'List[_2503.RingPinsToDiscConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinsToDiscConnections, constructor.new(_2503.RingPinsToDiscConnectionSystemDeflection))
        return value
