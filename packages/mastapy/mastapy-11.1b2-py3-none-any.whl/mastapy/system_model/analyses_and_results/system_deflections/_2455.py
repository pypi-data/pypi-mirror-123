...
class CylindricalGearSystemDeflectionWithLTCAResults(_2453.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_799.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_799.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
