...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2422.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3782.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3782.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
