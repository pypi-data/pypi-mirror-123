...
class ShaftSectionEndResultsSystemDeflection(_0.APIBase):
    ...
    @property
    def displacements(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.Displacements) if self.wrapped.Displacements else None

    @property
    def forces(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.Forces) if self.wrapped.Forces else None
