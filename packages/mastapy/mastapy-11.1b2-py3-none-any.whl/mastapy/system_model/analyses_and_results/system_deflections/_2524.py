...
class StraightBevelGearMeshSystemDeflection(_2414.BevelGearMeshSystemDeflection):
    '''StraightBevelGearMeshSystemDeflection
    ...
    def connection_load_case(self) -> '_6655.StraightBevelGearMeshLoadCase':
        ...
        return constructor.new(_6655.StraightBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3849.StraightBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3849.StraightBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_364.StraightBevelGearMeshRating':
        ...
        return constructor.new(_364.StraightBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_364.StraightBevelGearMeshRating':
        ...
        return constructor.new(_364.StraightBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
