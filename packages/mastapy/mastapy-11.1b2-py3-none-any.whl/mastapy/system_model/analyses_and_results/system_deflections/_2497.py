...
class PlanetaryConnectionSystemDeflection(_2513.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3822.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3822.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
