...
class StraightBevelPlanetGearSystemDeflection(_2523.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3852.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3852.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
