...
class SpringDamperHalfSystemDeflection(_2438.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3844.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3844.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
