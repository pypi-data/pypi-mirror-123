...
from mastapy.system_model.part_model import _2152, _2151, _2167
...
class AbstractShaftOrHousingSystemDeflection(_2423.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def component_design(self) -> '_2152.AbstractShaftOrHousing':
    ...
    @property
    def power_flow_results(self) -> '_3739.AbstractShaftOrHousingPowerFlow':
