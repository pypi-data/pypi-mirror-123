...
class BevelGearMeshSystemDeflection(_2402.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3754.BevelGearMeshPowerFlow':
