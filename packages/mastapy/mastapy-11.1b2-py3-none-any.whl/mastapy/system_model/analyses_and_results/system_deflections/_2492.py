...
class OilSealSystemDeflection(_2436.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3817.OilSealPowerFlow':
        ...
        return constructor.new(_3817.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
