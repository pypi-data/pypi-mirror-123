...
class KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection(_2476.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection
    ...
    def connection_load_case(self) -> '_6606.KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
        ...
        return constructor.new(_6606.KlingelnbergCycloPalloidHypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3808.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow':
        ...
        return constructor.new(_3808.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_373.KlingelnbergCycloPalloidHypoidGearMeshRating':
        ...
        return constructor.new(_373.KlingelnbergCycloPalloidHypoidGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_373.KlingelnbergCycloPalloidHypoidGearMeshRating':
        ...
        return constructor.new(_373.KlingelnbergCycloPalloidHypoidGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
