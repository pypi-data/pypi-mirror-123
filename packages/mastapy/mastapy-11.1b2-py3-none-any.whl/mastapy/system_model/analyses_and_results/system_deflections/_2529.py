...
class SynchroniserHalfSystemDeflection(_2530.SynchroniserPartSystemDeflection):
    ...
    def clutch_connection(self) -> '_2419.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2419.ClutchConnectionSystemDeflection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
    ...
    def power_flow_results(self) -> '_3854.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_3854.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
