...
class ExternalCADModelSystemDeflection(_2423.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3791.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3791.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
