...
class ClutchHalfSystemDeflection(_2438.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3760.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3760.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
