...
from mastapy.system_model.analyses_and_results.power_flows import _3740, _3784, _3837
...
class AbstractShaftSystemDeflection(_2399.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3740.AbstractShaftPowerFlow':
