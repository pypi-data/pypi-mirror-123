...
from mastapy.system_model.analyses_and_results.system_deflections import _2504, _2475
...
class RingPinsToDiscConnectionSystemDeflection(_2475.InterMountableComponentConnectionSystemDeflection):
    '''RingPinsToDiscConnectionSystemDeflection
    ...
    def connection_load_case(self) -> '_6635.RingPinsToDiscConnectionLoadCase':
        ...
        return constructor.new(_6635.RingPinsToDiscConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3831.RingPinsToDiscConnectionPowerFlow':
        ...
        return constructor.new(_3831.RingPinsToDiscConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2504.RingPinToDiscContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinToDiscContacts, constructor.new(_2504.RingPinToDiscContactReporting))
        return value
