...
from mastapy.system_model.analyses_and_results.system_deflections import _2523, _2521, _2415
...
class StraightBevelDiffGearSetSystemDeflection(_2415.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3848.StraightBevelDiffGearSetPowerFlow':
        ...
        return constructor.new(_3848.StraightBevelDiffGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2523.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2523.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2521.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2521.StraightBevelDiffGearMeshSystemDeflection))
        return value
