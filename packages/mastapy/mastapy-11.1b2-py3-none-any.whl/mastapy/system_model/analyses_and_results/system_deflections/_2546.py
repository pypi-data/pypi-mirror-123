...
class WormGearSystemDeflection(_2469.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3866.WormGearPowerFlow':
        ...
        return constructor.new(_3866.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
