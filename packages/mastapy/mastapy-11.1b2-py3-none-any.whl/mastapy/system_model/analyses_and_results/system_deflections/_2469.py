...
from mastapy.math_utility.measured_vectors import _1343
from mastapy.system_model.analyses_and_results.power_flows import (
    _3798, _3743, _3750, _3752,
    _3753, _3755, _3768, _3771,
    _3787, _3789, _3793, _3802,
    _3806, _3809, _3812, _3841,
    _3847, _3850, _3852, _3853,
    _3866, _3869
)
...
class GearSystemDeflection(_2490.MountableComponentSystemDeflection):
    '''GearSystemDeflection
    ...
    @property
    def mesh_point_results_in_wcs(self) -> 'List[_1343.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshPointResultsInWCS, constructor.new(_1343.ForceAndDisplacementResults))
        return value

    @property
    def power_flow_results(self) -> '_3798.GearPowerFlow':
