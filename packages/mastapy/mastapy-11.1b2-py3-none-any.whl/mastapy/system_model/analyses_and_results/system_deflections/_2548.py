...
from mastapy.system_model.analyses_and_results.system_deflections import _2549, _2547, _2415
...
class ZerolBevelGearSetSystemDeflection(_2415.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3870.ZerolBevelGearSetPowerFlow':
        ...
        return constructor.new(_3870.ZerolBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2549.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2549.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2547.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2547.ZerolBevelGearMeshSystemDeflection))
        return value
