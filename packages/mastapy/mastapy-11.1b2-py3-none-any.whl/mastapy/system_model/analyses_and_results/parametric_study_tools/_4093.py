...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def parametric_study_type(self) -> '_6618.ParametricStudyType':
        ...
        return constructor.new(_6618.ParametricStudyType)(value) if value else None
    ...
    def external_full_fe_loader(self) -> '_1928.ExternalFullFELoader':
        ...
        return constructor.new(_1928.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None
