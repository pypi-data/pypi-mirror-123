...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4145, _4144, _4018
...
class ZerolBevelGearSetParametricStudyTool(_4018.BevelGearSetParametricStudyTool):
    '''ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4145.ZerolBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsParametricStudyTool, constructor.new(_4145.ZerolBevelGearParametricStudyTool))
        return value

    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4144.ZerolBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesParametricStudyTool, constructor.new(_4144.ZerolBevelGearMeshParametricStudyTool))
        return value
