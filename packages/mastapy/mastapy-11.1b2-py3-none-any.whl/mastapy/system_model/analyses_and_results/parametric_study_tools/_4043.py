...
class CycloidalAssemblyParametricStudyTool(_4116.SpecialisedAssemblyParametricStudyTool):
    '''CycloidalAssemblyParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2443.CycloidalAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2443.CycloidalAssemblySystemDeflection))
        return value
