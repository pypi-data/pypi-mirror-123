...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4048, _4047, _4067
...
class CylindricalGearSetParametricStudyTool(_4067.GearSetParametricStudyTool):
    '''CylindricalGearSetParametricStudyTool
    ...
    @property
    def cylindrical_gears_parametric_study_tool(self) -> 'List[_4048.CylindricalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsParametricStudyTool, constructor.new(_4048.CylindricalGearParametricStudyTool))
        return value

    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4047.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesParametricStudyTool, constructor.new(_4047.CylindricalGearMeshParametricStudyTool))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2450.CylindricalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2450.CylindricalGearSetSystemDeflection))
        return value
