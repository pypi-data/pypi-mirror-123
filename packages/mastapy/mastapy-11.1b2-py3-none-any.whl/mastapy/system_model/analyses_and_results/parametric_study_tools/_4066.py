...
class GearParametricStudyTool(_4085.MountableComponentParametricStudyTool):
    '''GearParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results(self) -> 'List[_323.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleResults, constructor.new(_323.GearDutyCycleRating))
        return value
