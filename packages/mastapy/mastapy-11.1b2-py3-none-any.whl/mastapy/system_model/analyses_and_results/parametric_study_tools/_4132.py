...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4116
...
class SynchroniserParametricStudyTool(_4116.SpecialisedAssemblyParametricStudyTool):
    '''SynchroniserParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2532.SynchroniserSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2532.SynchroniserSystemDeflection))
        return value
