...
class GearSetParametricStudyTool(_4116.SpecialisedAssemblyParametricStudyTool):
    '''GearSetParametricStudyTool
    ...
    @property
    def gear_set_duty_cycle_results(self) -> 'List[_327.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDutyCycleResults, constructor.new(_327.GearSetDutyCycleRating))
        return value
