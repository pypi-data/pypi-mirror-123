...
class BoltedJointParametricStudyTool(_4116.SpecialisedAssemblyParametricStudyTool):
    '''BoltedJointParametricStudyTool
    ...
    def assembly_load_case(self) -> '_6518.BoltedJointLoadCase':
        ...
        return constructor.new(_6518.BoltedJointLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2417.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2417.BoltedJointSystemDeflection))
        return value
