...
class DutyCycleResultsForAllGearSets(_0.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1155.GearSetGroupDutyCycle':
        ...
        return constructor.new(_1155.GearSetGroupDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
