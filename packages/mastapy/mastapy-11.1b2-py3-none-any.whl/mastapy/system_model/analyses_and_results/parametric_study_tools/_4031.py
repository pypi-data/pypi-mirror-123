...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4030, _4029, _4067
...
class ConceptGearSetParametricStudyTool(_4067.GearSetParametricStudyTool):
    '''ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4030.ConceptGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsParametricStudyTool, constructor.new(_4030.ConceptGearParametricStudyTool))
        return value

    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4029.ConceptGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesParametricStudyTool, constructor.new(_4029.ConceptGearMeshParametricStudyTool))
        return value
