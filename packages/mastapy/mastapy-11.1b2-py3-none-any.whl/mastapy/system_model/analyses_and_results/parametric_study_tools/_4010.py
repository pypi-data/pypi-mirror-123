...
class BeltDriveParametricStudyTool(_4116.SpecialisedAssemblyParametricStudyTool):
    '''BeltDriveParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2408.BeltDriveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2408.BeltDriveSystemDeflection))
        return value
