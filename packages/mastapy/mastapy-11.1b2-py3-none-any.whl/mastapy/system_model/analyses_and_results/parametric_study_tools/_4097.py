...
from mastapy.system_model.analyses_and_results.analysis_cases import _7235
...
class PartParametricStudyTool(_7235.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4092.ParametricStudyTool':
        ...
        return constructor.new(_4092.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None

    @property
    def data_logger(self) -> '_1598.DataLoggerWithCharts':
        ...
        return constructor.new(_1598.DataLoggerWithCharts)(self.wrapped.DataLogger) if self.wrapped.DataLogger else None
