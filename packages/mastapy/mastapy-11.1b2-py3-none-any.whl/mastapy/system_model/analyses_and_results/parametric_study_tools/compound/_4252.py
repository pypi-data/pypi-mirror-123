...
class StraightBevelDiffGearCompoundParametricStudyTool(_4163.BevelGearCompoundParametricStudyTool):
    '''StraightBevelDiffGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4124.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4124.StraightBevelDiffGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4124.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4124.StraightBevelDiffGearParametricStudyTool))
        return value
