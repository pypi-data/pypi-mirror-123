...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4224
...
class GearCompoundParametricStudyTool(_4224.MountableComponentCompoundParametricStudyTool):
    '''GearCompoundParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results(self) -> '_323.GearDutyCycleRating':
        ...
        if _323.GearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_worm_gear_duty_cycle_rating(self) -> '_337.WormGearDutyCycleRating':
        ...
        if _337.WormGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_face_gear_duty_cycle_rating(self) -> '_410.FaceGearDutyCycleRating':
        ...
        if _410.FaceGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_cylindrical_gear_duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        if _417.CylindricalGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_conical_gear_duty_cycle_rating(self) -> '_492.ConicalGearDutyCycleRating':
        ...
        if _492.ConicalGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_concept_gear_duty_cycle_rating(self) -> '_502.ConceptGearDutyCycleRating':
        ...
        if _502.ConceptGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4066.GearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4066.GearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4066.GearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4066.GearParametricStudyTool))
        return value
