...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4269
...
class PowerLoadCompoundParametricStudyTool(_4269.VirtualComponentCompoundParametricStudyTool):
    '''PowerLoadCompoundParametricStudyTool
    ...
    @property
    def load_cases(self) -> 'List[_6630.PowerLoadLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_6630.PowerLoadLoadCase))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4105.PowerLoadParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4105.PowerLoadParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4105.PowerLoadParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4105.PowerLoadParametricStudyTool))
        return value
