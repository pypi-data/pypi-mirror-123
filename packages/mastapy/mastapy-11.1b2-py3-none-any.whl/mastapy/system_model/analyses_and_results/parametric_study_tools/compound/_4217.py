...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool(_4214.KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4076.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4076.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4076.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4076.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value
