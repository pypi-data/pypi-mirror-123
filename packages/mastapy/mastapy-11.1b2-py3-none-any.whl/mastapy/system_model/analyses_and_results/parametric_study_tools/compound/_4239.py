...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4111
...
class RollingRingCompoundParametricStudyTool(_4186.CouplingHalfCompoundParametricStudyTool):
    '''RollingRingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4111.RollingRingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4111.RollingRingParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4111.RollingRingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4111.RollingRingParametricStudyTool))
        return value
