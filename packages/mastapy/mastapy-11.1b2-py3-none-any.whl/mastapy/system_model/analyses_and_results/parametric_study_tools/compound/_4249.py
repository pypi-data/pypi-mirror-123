...
class SpringDamperCompoundParametricStudyTool(_4184.CouplingCompoundParametricStudyTool):
    '''SpringDamperCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4122.SpringDamperParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4122.SpringDamperParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4122.SpringDamperParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4122.SpringDamperParametricStudyTool))
        return value
