...
class CylindricalGearMeshCompoundParametricStudyTool(_4206.GearMeshCompoundParametricStudyTool):
    '''CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4047.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4047.CylindricalGearMeshParametricStudyTool))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4047.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4047.CylindricalGearMeshParametricStudyTool))
        return value
