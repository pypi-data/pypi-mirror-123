...
class BeltDriveCompoundParametricStudyTool(_4245.SpecialisedAssemblyCompoundParametricStudyTool):
    '''BeltDriveCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4010.BeltDriveParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4010.BeltDriveParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4010.BeltDriveParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4010.BeltDriveParametricStudyTool))
        return value
