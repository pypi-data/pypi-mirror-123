...
class RootAssemblyCompoundParametricStudyTool(_4154.AssemblyCompoundParametricStudyTool):
    ...
    def results_for_reporting(self) -> '_4094.ParametricStudyToolResultsForReporting':
        ...
        return constructor.new(_4094.ParametricStudyToolResultsForReporting)(self.wrapped.ResultsForReporting) if self.wrapped.ResultsForReporting else None
    ...
    def root_assembly_duty_cycle_results(self) -> '_2611.DutyCycleEfficiencyResults':
        ...
        return constructor.new(_2611.DutyCycleEfficiencyResults)(self.wrapped.RootAssemblyDutyCycleResults) if self.wrapped.RootAssemblyDutyCycleResults else None
