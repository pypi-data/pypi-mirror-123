...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4212
...
class RingPinsToDiscConnectionCompoundParametricStudyTool(_4212.InterMountableComponentConnectionCompoundParametricStudyTool):
    '''RingPinsToDiscConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4108.RingPinsToDiscConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4108.RingPinsToDiscConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4108.RingPinsToDiscConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4108.RingPinsToDiscConnectionParametricStudyTool))
        return value
