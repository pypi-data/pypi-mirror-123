...
from mastapy.system_model.analyses_and_results.modal_analyses import _4823, _4822, _4855
...
class ConceptGearSetModalAnalysis(_4855.GearSetModalAnalysis):
    '''ConceptGearSetModalAnalysis
    ...
    def system_deflection_results(self) -> '_2429.ConceptGearSetSystemDeflection':
        ...
        return constructor.new(_2429.ConceptGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def concept_gears_modal_analysis(self) -> 'List[_4823.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysis, constructor.new(_4823.ConceptGearModalAnalysis))
        return value

    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4822.ConceptGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysis, constructor.new(_4822.ConceptGearMeshModalAnalysis))
        return value
