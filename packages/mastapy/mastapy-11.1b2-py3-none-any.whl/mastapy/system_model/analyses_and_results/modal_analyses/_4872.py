...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    def analysis_type(self) -> '_49.BarModelAnalysisType':
        ...
        return constructor.new(_49.BarModelAnalysisType)(value) if value else None
    ...
    def mode_options(self) -> '_154.EigenvalueOptions':
        ...
        return constructor.new(_154.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
