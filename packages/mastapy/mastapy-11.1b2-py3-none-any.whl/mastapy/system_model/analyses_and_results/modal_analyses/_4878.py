...
from mastapy.system_model.analyses_and_results.modal_analyses import _2348
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _2351
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4945, _4942, _4944
...
from mastapy.system_model.drawing import _1965
...
class PartModalAnalysis(_7238.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_2348.ModalAnalysis':
        ...
        if _2348.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    @property
    def results_for_modes(self) -> 'List[_4945.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4945.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4942.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4942.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4942.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4942.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_4944.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4944.SingleExcitationResultsModalAnalysis))
        return value
    ...
    def create_viewable(self) -> '_1965.ModalAnalysisViewable':
