...
class GuideDxfModelCompoundModalAnalysis(_4971.ComponentCompoundModalAnalysis):
    '''GuideDxfModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4856.GuideDxfModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4856.GuideDxfModelModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4856.GuideDxfModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4856.GuideDxfModelModalAnalysis))
        return value
