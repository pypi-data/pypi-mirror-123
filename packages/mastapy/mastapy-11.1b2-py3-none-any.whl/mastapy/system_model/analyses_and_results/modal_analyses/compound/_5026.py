...
class PartToPartShearCouplingCompoundModalAnalysis(_4983.CouplingCompoundModalAnalysis):
    '''PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4881.PartToPartShearCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4881.PartToPartShearCouplingModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4881.PartToPartShearCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4881.PartToPartShearCouplingModalAnalysis))
        return value
