...
class CylindricalGearCompoundModalAnalysis(_5004.GearCompoundModalAnalysis):
    '''CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4842.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4842.CylindricalGearModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4842.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4842.CylindricalGearModalAnalysis))
        return value
