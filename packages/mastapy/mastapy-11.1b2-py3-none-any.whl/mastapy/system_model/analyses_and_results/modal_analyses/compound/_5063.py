...
class TorqueConverterCompoundModalAnalysis(_4983.CouplingCompoundModalAnalysis):
    '''TorqueConverterCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4918.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4918.TorqueConverterModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4918.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4918.TorqueConverterModalAnalysis))
        return value
