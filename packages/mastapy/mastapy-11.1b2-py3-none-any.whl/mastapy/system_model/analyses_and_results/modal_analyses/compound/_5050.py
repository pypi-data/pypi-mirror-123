...
class SpringDamperHalfCompoundModalAnalysis(_4985.CouplingHalfCompoundModalAnalysis):
    '''SpringDamperHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4903.SpringDamperHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4903.SpringDamperHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4903.SpringDamperHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4903.SpringDamperHalfModalAnalysis))
        return value
