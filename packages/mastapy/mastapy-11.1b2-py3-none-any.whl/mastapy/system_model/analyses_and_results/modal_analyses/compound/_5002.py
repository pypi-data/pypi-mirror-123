...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4948
...
class FEPartCompoundModalAnalysis(_4948.AbstractShaftOrHousingCompoundModalAnalysis):
    '''FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4850.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4850.FEPartModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4850.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4850.FEPartModalAnalysis))
        return value
