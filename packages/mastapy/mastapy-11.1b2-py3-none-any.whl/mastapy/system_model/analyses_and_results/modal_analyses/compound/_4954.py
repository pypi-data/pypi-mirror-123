...
class BearingCompoundModalAnalysis(_4982.ConnectorCompoundModalAnalysis):
    '''BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4801.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4801.BearingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4801.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4801.BearingModalAnalysis))
        return value
