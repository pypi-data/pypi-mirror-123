...
class CycloidalDiscCompoundModalAnalysis(_4947.AbstractShaftCompoundModalAnalysis):
    '''CycloidalDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4839.CycloidalDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4839.CycloidalDiscModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4839.CycloidalDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4839.CycloidalDiscModalAnalysis))
        return value
