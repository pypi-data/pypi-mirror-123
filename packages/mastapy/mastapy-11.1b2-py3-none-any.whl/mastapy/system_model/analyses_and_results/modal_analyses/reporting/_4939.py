...
class PerModeResultsReport(_1512.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1571.TableAndChartOptions':
    ...
    def display_option(self, value: '_1571.TableAndChartOptions'):
