...
class SteadyStateSynchronousResponseOnAShaft(_7240.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3317.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3317.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
