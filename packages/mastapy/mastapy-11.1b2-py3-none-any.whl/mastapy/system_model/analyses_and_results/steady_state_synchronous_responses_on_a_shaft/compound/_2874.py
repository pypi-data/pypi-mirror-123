...
class FaceGearCompoundSteadyStateSynchronousResponseOnAShaft(_2879.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''FaceGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2746.FaceGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2746.FaceGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2746.FaceGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2746.FaceGearSteadyStateSynchronousResponseOnAShaft))
        return value
