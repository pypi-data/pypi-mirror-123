...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_2838.BevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft):
    '''BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    def component_design(self) -> '_2016.BevelDifferentialGearMesh':
        ...
        return constructor.new(_2016.BevelDifferentialGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2702.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2702.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2702.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2702.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
