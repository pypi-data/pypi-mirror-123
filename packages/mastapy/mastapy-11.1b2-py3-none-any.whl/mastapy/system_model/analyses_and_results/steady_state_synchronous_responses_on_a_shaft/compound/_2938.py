...
class TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft(_2858.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2811.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2811.TorqueConverterSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2811.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2811.TorqueConverterSteadyStateSynchronousResponseOnAShaft))
        return value
