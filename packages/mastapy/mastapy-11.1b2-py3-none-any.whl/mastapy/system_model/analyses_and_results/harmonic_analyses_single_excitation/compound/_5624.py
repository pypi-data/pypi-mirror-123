...
class TorqueConverterConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5544.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''TorqueConverterConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5494.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5494.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5494.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5494.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation))
        return value
