...
class ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation(_5531.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5428.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5428.ExternalCADModelHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5428.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5428.ExternalCADModelHarmonicAnalysisOfSingleExcitation))
        return value
