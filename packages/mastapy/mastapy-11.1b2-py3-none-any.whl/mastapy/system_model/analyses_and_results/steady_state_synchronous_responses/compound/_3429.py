...
class PowerLoadCompoundSteadyStateSynchronousResponse(_3464.VirtualComponentCompoundSteadyStateSynchronousResponse):
    '''PowerLoadCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3297.PowerLoadSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3297.PowerLoadSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3297.PowerLoadSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3297.PowerLoadSteadyStateSynchronousResponse))
        return value
