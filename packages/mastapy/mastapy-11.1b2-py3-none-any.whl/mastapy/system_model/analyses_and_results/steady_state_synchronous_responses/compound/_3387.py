...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3343
...
class CycloidalDiscCompoundSteadyStateSynchronousResponse(_3343.AbstractShaftCompoundSteadyStateSynchronousResponse):
    '''CycloidalDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3255.CycloidalDiscSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3255.CycloidalDiscSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3255.CycloidalDiscSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3255.CycloidalDiscSteadyStateSynchronousResponse))
        return value
