...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3439
...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponse(_3439.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    '''PlanetaryConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3293.PlanetaryConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3293.PlanetaryConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3293.PlanetaryConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3293.PlanetaryConnectionSteadyStateSynchronousResponse))
        return value
