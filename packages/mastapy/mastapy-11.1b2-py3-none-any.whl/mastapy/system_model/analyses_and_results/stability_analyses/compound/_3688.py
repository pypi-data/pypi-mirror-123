...
class PlanetCarrierCompoundStabilityAnalysis(_3680.MountableComponentCompoundStabilityAnalysis):
    '''PlanetCarrierCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3557.PlanetCarrierStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3557.PlanetCarrierStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3557.PlanetCarrierStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3557.PlanetCarrierStabilityAnalysis))
        return value
