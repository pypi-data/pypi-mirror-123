...
class BevelDifferentialGearCompoundStabilityAnalysis(_3619.BevelGearCompoundStabilityAnalysis):
    '''BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3484.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3484.BevelDifferentialGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3484.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3484.BevelDifferentialGearStabilityAnalysis))
        return value
