...
from mastapy.system_model.analyses_and_results.stability_analyses import _3511, _3473
...
class ShaftStabilityAnalysis(_3473.AbstractShaftStabilityAnalysis):
    '''ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3511.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_3511.CriticalSpeed))
        return value
