...
class HypoidGearHarmonicAnalysis(_5640.AGMAGleasonConicalGearHarmonicAnalysis):
    '''HypoidGearHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2473.HypoidGearSystemDeflection':
        ...
        return constructor.new(_2473.HypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
