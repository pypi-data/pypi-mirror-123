...
class BevelDifferentialPlanetGearHarmonicAnalysis(_5647.BevelDifferentialGearHarmonicAnalysis):
    '''BevelDifferentialPlanetGearHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2412.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2412.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
