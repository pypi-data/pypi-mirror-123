...
class ExternalCADModelCompoundHarmonicAnalysis(_5853.ComponentCompoundHarmonicAnalysis):
    '''ExternalCADModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5701.ExternalCADModelHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5701.ExternalCADModelHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5701.ExternalCADModelHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5701.ExternalCADModelHarmonicAnalysis))
        return value
