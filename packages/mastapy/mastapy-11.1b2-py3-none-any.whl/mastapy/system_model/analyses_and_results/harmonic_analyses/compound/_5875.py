...
class CylindricalGearCompoundHarmonicAnalysis(_5886.GearCompoundHarmonicAnalysis):
    '''CylindricalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5684.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5684.CylindricalGearHarmonicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5684.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5684.CylindricalGearHarmonicAnalysis))
        return value
