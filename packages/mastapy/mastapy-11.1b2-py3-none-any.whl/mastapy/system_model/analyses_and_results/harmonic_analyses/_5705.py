...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5718, _5638
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5806
...
class FEPartHarmonicAnalysis(_5638.AbstractShaftOrHousingHarmonicAnalysis):
    '''FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4850.FEPartModalAnalysis':
        ...
        return constructor.new(_4850.FEPartModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis else None

    @property
    def export(self) -> '_5718.HarmonicAnalysisFEExportOptions':
        ...
        return constructor.new(_5718.HarmonicAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def results(self) -> '_5806.FEPartHarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5806.FEPartHarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results else None
    ...
    def system_deflection_results(self) -> '_2465.FEPartSystemDeflection':
        ...
        return constructor.new(_2465.FEPartSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
