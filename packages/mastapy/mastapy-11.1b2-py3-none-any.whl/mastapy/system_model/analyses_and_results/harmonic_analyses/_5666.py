...
class ConceptGearHarmonicAnalysis(_5708.GearHarmonicAnalysis):
    '''ConceptGearHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2430.ConceptGearSystemDeflection':
        ...
        return constructor.new(_2430.ConceptGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
