...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5796
from mastapy.system_model.analyses_and_results.modal_analyses import _4874
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5761, _5707
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5796.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5796.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4874.ModalAnalysisOptions':
        ...
        return constructor.new(_4874.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
