...
from mastapy.system_model.analyses_and_results.system_deflections import _2450, _2451, _2452
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5684, _5685, _5713
...
class CylindricalGearSetHarmonicAnalysis(_5713.GearSetHarmonicAnalysis):
    '''CylindricalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2450.CylindricalGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5684.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsHarmonicAnalysis, constructor.new(_5684.CylindricalGearHarmonicAnalysis))
        return value

    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5684.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsHarmonicAnalysis, constructor.new(_5684.CylindricalGearHarmonicAnalysis))
        return value

    @property
    def meshes_harmonic_analysis(self) -> 'List[_5685.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesHarmonicAnalysis, constructor.new(_5685.CylindricalGearMeshHarmonicAnalysis))
        return value

    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5685.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesHarmonicAnalysis, constructor.new(_5685.CylindricalGearMeshHarmonicAnalysis))
        return value
