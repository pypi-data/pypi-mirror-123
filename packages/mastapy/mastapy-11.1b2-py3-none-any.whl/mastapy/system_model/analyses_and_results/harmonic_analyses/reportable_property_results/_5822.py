...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5824, _5804
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5824.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
        ...
        return constructor.new(_5824.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic)(self.wrapped.Magnitude) if self.wrapped.Magnitude else None

    @property
    def result_at_reference_speed(self) -> '_5804.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic':
        ...
        return constructor.new(_5804.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic)(self.wrapped.ResultAtReferenceSpeed) if self.wrapped.ResultAtReferenceSpeed else None

    @property
    def data_points(self) -> 'List[_5804.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPoints, constructor.new(_5804.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic))
        return value
