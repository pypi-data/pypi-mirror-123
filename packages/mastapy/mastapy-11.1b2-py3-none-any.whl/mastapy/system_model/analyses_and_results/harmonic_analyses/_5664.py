...
class ConceptCouplingHalfHarmonicAnalysis(_5675.CouplingHalfHarmonicAnalysis):
    '''ConceptCouplingHalfHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2426.ConceptCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2426.ConceptCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
