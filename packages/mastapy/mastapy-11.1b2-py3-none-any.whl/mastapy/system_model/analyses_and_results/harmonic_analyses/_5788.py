...
class WormGearMeshHarmonicAnalysis(_5710.GearMeshHarmonicAnalysis):
    '''WormGearMeshHarmonicAnalysis
    ...
    def system_deflection_results(self) -> '_2544.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2544.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
