...
from mastapy.utility.model_validation import _1546, _1547
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1510.CustomReport':
        ...
        return constructor.new(_1510.CustomReport)(self.wrapped.ActiveReportAsText) if self.wrapped.ActiveReportAsText else None
    ...
    def safety_factors(self) -> '_247.SafetyFactorGroup':
        ...
        return constructor.new(_247.SafetyFactorGroup)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def component_design(self) -> '_1924.DesignEntity':
        ...
        if _1924.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1987.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2182.Part':
    ...
    @property
    def all_status_errors(self) -> 'List[_1547.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1547.StatusItem))
        return value
