...
from mastapy import _7242
from mastapy.system_model import _1919
from mastapy.system_model.analyses_and_results.analysis_cases import _7227
...
class CompoundAnalysis:
    ...
    def perform_analysis_with_progress(self, progress: '_7242.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1919.DesignEntity') -> 'Iterable[_7227.DesignEntityCompoundAnalysis]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.ResultsFor(design_entity.wrapped if design_entity else None), constructor.new(_7227.DesignEntityCompoundAnalysis))
