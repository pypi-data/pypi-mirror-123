...
class ConceptCouplingConnectionAdvancedSystemDeflection(_7002.CouplingConnectionAdvancedSystemDeflection):
    '''ConceptCouplingConnectionAdvancedSystemDeflection
    ...
    def connection_load_case(self) -> '_6525.ConceptCouplingConnectionLoadCase':
        ...
        return constructor.new(_6525.ConceptCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2425.ConceptCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2425.ConceptCouplingConnectionSystemDeflection))
        return value
