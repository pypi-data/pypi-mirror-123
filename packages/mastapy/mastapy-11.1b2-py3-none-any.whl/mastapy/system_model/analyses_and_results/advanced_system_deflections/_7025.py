...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7040, _7064
...
class GearSetAdvancedSystemDeflection(_7064.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_7040.UseLtcaInAsdOption':
        ...
        return constructor.new(_7040.UseLtcaInAsdOption)(value) if value else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_7040.UseLtcaInAsdOption'):
