...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7011, _7012, _7025
...
class CylindricalGearSetAdvancedSystemDeflection(_7025.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self) -> '_967.CylindricalGearSetDesign':
    ...
    @property
    def micro_geometry(self) -> '_1041.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1041.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
    ...
    def rating(self) -> '_427.CylindricalGearSetRating':
        ...
        return constructor.new(_427.CylindricalGearSetRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_427.CylindricalGearSetRating':
        ...
        return constructor.new(_427.CylindricalGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_7011.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_7011.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_7012.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection))
        return value
