...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7012, _7014, _7023
...
class CylindricalGearAdvancedSystemDeflection(_7023.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7012.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7014.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_7014.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7014.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_7014.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
