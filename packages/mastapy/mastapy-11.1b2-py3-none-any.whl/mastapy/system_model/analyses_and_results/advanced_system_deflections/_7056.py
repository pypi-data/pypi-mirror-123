...
class RingPinsToDiscConnectionAdvancedSystemDeflection(_7030.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''RingPinsToDiscConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2503.RingPinsToDiscConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2503.RingPinsToDiscConnectionSystemDeflection))
        return value
