...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6964, _6970
...
class RootAssemblyAdvancedSystemDeflection(_6970.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6964.AdvancedSystemDeflection':
        ...
        return constructor.new(_6964.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
