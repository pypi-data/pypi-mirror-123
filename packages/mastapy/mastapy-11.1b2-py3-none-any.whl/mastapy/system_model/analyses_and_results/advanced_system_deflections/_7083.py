...
class TorqueConverterAdvancedSystemDeflection(_7001.CouplingAdvancedSystemDeflection):
    '''TorqueConverterAdvancedSystemDeflection
    ...
    def assembly_load_case(self) -> '_6665.TorqueConverterLoadCase':
        ...
        return constructor.new(_6665.TorqueConverterLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2538.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2538.TorqueConverterSystemDeflection))
        return value
