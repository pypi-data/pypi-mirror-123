...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7018, _7019, _7025
...
class FaceGearSetAdvancedSystemDeflection(_7025.GearSetAdvancedSystemDeflection):
    '''FaceGearSetAdvancedSystemDeflection
    ...
    def rating(self) -> '_415.FaceGearSetRating':
        ...
        return constructor.new(_415.FaceGearSetRating)(self.wrapped.Rating) if self.wrapped.Rating else None
    ...
    def component_detailed_analysis(self) -> '_415.FaceGearSetRating':
        ...
        return constructor.new(_415.FaceGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def face_gears_advanced_system_deflection(self) -> 'List[_7018.FaceGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsAdvancedSystemDeflection, constructor.new(_7018.FaceGearAdvancedSystemDeflection))
        return value

    @property
    def face_meshes_advanced_system_deflection(self) -> 'List[_7019.FaceGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesAdvancedSystemDeflection, constructor.new(_7019.FaceGearMeshAdvancedSystemDeflection))
        return value
