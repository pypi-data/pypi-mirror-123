...
class TorqueConverterTurbineAdvancedSystemDeflection(_7003.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2539.TorqueConverterTurbineSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2539.TorqueConverterTurbineSystemDeflection))
        return value
