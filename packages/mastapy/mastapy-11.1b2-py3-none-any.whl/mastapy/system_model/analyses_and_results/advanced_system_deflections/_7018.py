...
class FaceGearAdvancedSystemDeflection(_7023.GearAdvancedSystemDeflection):
    '''FaceGearAdvancedSystemDeflection
    ...
    def component_load_case(self) -> '_6572.FaceGearLoadCase':
        ...
        return constructor.new(_6572.FaceGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    def component_detailed_analysis(self) -> '_413.FaceGearRating':
        ...
        return constructor.new(_413.FaceGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2464.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2464.FaceGearSystemDeflection))
        return value
