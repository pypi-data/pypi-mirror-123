...
class ClutchHalfAdvancedSystemDeflection(_7003.CouplingHalfAdvancedSystemDeflection):
    '''ClutchHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2420.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2420.ClutchHalfSystemDeflection))
        return value
