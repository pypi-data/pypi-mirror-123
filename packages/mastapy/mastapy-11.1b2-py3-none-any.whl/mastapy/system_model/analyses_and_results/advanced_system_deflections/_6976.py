...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6974, _6975, _6981
...
class BevelDifferentialGearSetAdvancedSystemDeflection(_6981.BevelGearSetAdvancedSystemDeflection):
    '''BevelDifferentialGearSetAdvancedSystemDeflection
    ...
    @property
    def bevel_differential_gears_advanced_system_deflection(self) -> 'List[_6974.BevelDifferentialGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsAdvancedSystemDeflection, constructor.new(_6974.BevelDifferentialGearAdvancedSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_advanced_system_deflection(self) -> 'List[_6975.BevelDifferentialGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesAdvancedSystemDeflection, constructor.new(_6975.BevelDifferentialGearMeshAdvancedSystemDeflection))
        return value
