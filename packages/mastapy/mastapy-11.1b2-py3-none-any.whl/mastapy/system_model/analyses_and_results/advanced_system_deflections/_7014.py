...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7012.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.CylindricalGearMeshAdvancedSystemDeflection) if self.wrapped.CylindricalGearMeshAdvancedSystemDeflection else None
