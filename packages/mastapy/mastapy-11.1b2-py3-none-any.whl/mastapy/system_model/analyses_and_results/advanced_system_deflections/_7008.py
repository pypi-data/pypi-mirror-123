...
class CycloidalDiscAdvancedSystemDeflection(_6961.AbstractShaftAdvancedSystemDeflection):
    '''CycloidalDiscAdvancedSystemDeflection
    ...
    def component_load_case(self) -> '_6546.CycloidalDiscLoadCase':
        ...
        return constructor.new(_6546.CycloidalDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2446.CycloidalDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2446.CycloidalDiscSystemDeflection))
        return value
