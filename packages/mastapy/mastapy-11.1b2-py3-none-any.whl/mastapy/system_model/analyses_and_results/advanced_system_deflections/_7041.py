...
class MassDiscAdvancedSystemDeflection(_7089.VirtualComponentAdvancedSystemDeflection):
    '''MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2487.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2487.MassDiscSystemDeflection))
        return value
