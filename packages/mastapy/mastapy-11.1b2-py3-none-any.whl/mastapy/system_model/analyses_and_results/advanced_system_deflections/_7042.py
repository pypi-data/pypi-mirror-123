...
class MeasurementComponentAdvancedSystemDeflection(_7089.VirtualComponentAdvancedSystemDeflection):
    '''MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2488.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2488.MeasurementComponentSystemDeflection))
        return value
