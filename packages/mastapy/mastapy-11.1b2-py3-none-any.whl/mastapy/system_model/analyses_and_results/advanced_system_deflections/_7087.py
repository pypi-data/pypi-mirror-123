...
class TransmissionErrorToOtherPowerLoad(_0.APIBase):
    ...
    @property
    def fourier_series_of_te(self) -> '_1296.FourierSeries':
        ...
        return constructor.new(_1296.FourierSeries)(self.wrapped.FourierSeriesOfTE) if self.wrapped.FourierSeriesOfTE else None
