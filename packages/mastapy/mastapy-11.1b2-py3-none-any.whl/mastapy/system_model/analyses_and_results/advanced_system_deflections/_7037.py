...
class KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection(_7031.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection
    ...
    def component_load_case(self) -> '_6608.KlingelnbergCycloPalloidSpiralBevelGearLoadCase':
        ...
        return constructor.new(_6608.KlingelnbergCycloPalloidSpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    def component_detailed_analysis(self) -> '_371.KlingelnbergCycloPalloidSpiralBevelGearRating':
        ...
        return constructor.new(_371.KlingelnbergCycloPalloidSpiralBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2484.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2484.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value
