...
class PulleyAdvancedSystemDeflection(_7003.CouplingHalfAdvancedSystemDeflection):
    '''PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2501.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2501.PulleySystemDeflection))
        return value
