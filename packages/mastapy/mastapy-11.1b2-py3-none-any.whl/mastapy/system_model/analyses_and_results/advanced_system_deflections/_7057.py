...
class RollingRingAdvancedSystemDeflection(_7003.CouplingHalfAdvancedSystemDeflection):
    '''RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2507.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2507.RollingRingSystemDeflection))
        return value
