...
class PartToPartShearCouplingAdvancedSystemDeflection(_7001.CouplingAdvancedSystemDeflection):
    '''PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2496.PartToPartShearCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2496.PartToPartShearCouplingSystemDeflection))
        return value
