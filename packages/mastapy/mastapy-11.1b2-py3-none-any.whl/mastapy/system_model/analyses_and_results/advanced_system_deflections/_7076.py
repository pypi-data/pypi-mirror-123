...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7074, _7075, _6981
...
class StraightBevelGearSetAdvancedSystemDeflection(_6981.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_7074.StraightBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsAdvancedSystemDeflection, constructor.new(_7074.StraightBevelGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_7075.StraightBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesAdvancedSystemDeflection, constructor.new(_7075.StraightBevelGearMeshAdvancedSystemDeflection))
        return value
