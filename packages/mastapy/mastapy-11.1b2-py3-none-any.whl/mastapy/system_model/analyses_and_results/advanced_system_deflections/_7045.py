...
from mastapy.system_model.drawing import _1958
...
class PartAdvancedSystemDeflection(_7238.PartStaticLoadAnalysisCase):
    '''PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6964.AdvancedSystemDeflection':
        ...
        return constructor.new(_6964.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None
    ...
    def create_viewable(self) -> '_1958.AdvancedSystemDeflectionViewable':
