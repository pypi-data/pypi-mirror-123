...
class CylindricalGearMeshCompoundAdvancedSystemDeflection(_7155.GearMeshCompoundAdvancedSystemDeflection):
    '''CylindricalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7012.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7012.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection))
        return value
