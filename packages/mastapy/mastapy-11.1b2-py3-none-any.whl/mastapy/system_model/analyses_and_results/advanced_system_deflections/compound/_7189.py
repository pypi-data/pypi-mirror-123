...
class RollingRingConnectionCompoundAdvancedSystemDeflection(_7161.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    '''RollingRingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7059.RollingRingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7059.RollingRingConnectionAdvancedSystemDeflection))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7059.RollingRingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7059.RollingRingConnectionAdvancedSystemDeflection))
        return value
