...
class CylindricalGearCompoundAdvancedSystemDeflection(_7154.GearCompoundAdvancedSystemDeflection):
    '''CylindricalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.GearDutyCycleRating) if self.wrapped.GearDutyCycleRating else None

    @property
    def cylindrical_gear_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalGearRating) if self.wrapped.CylindricalGearRating else None

    @property
    def component_analysis_cases_ready(self) -> 'List[_7011.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7011.CylindricalGearAdvancedSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7011.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7011.CylindricalGearAdvancedSystemDeflection))
        return value
