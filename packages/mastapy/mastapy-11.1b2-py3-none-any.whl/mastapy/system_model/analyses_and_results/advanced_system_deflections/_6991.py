...
class ConceptCouplingHalfAdvancedSystemDeflection(_7003.CouplingHalfAdvancedSystemDeflection):
    '''ConceptCouplingHalfAdvancedSystemDeflection
    ...
    def component_load_case(self) -> '_6526.ConceptCouplingHalfLoadCase':
        ...
        return constructor.new(_6526.ConceptCouplingHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2426.ConceptCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2426.ConceptCouplingHalfSystemDeflection))
        return value
