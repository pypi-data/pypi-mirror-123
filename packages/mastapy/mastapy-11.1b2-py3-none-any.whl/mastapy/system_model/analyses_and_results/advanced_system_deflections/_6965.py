...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_793.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_793.UseAdvancedLTCAOptions)(value) if value else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_793.UseAdvancedLTCAOptions'):
    ...
    def time_options(self) -> '_2397.TimeOptions':
        ...
        return constructor.new(_2397.TimeOptions)(self.wrapped.TimeOptions) if self.wrapped.TimeOptions else None
