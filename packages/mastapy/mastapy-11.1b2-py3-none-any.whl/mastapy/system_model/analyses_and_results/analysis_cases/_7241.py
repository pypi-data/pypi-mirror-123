...
class TimeSeriesLoadAnalysisCase(_7225.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6493.TimeSeriesLoadCase':
        ...
        return constructor.new(_6493.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
