...
class UnbalancedMassAdvancedTimeSteppingAnalysisForModulation(_6824.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''UnbalancedMassAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2542.UnbalancedMassSystemDeflection':
        ...
        return constructor.new(_2542.UnbalancedMassSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
