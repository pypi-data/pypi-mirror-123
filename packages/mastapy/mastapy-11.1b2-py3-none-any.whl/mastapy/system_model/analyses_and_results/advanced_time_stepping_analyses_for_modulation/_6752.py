...
class DatumAdvancedTimeSteppingAnalysisForModulation(_6726.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''DatumAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2459.DatumSystemDeflection':
        ...
        return constructor.new(_2459.DatumSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
