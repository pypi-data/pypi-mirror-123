...
class AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(_6726.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2399.AbstractShaftOrHousingSystemDeflection':
