...
class CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6710.BeltConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    def connection_design(self) -> '_1988.CVTBeltConnection':
        ...
        return constructor.new(_1988.CVTBeltConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def system_deflection_results(self) -> '_2440.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2440.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
