...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6718.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2409.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2409.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
