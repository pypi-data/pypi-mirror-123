...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_6799.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    def connection_load_case(self) -> '_6623.PlanetaryConnectionLoadCase':
        ...
        return constructor.new(_6623.PlanetaryConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2497.PlanetaryConnectionSystemDeflection':
        ...
        return constructor.new(_2497.PlanetaryConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
