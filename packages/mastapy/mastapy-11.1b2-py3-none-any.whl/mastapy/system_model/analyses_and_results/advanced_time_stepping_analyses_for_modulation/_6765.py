...
class HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_6705.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    def connection_load_case(self) -> '_6596.HypoidGearMeshLoadCase':
        ...
        return constructor.new(_6596.HypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2471.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2471.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
