...
from mastapy.system_model.analyses_and_results.static_loads import _6631, _6543
from mastapy.system_model.analyses_and_results.system_deflections import _2501, _2441
...
class PulleyAdvancedTimeSteppingAnalysisForModulation(_6740.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''PulleyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6631.PulleyLoadCase':
        ...
        if _6631.PulleyLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2501.PulleySystemDeflection':
