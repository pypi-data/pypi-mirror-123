...
class ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6760.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2432.ConicalGearMeshSystemDeflection':
