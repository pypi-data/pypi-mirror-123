...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _2336, _6707
...
class RootAssemblyAdvancedTimeSteppingAnalysisForModulation(_6707.AssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''RootAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    def results(self) -> '_5825.RootAssemblyHarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5825.RootAssemblyHarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results else None
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_inputs(self) -> '_2336.AdvancedTimeSteppingAnalysisForModulation':
        ...
        return constructor.new(_2336.AdvancedTimeSteppingAnalysisForModulation)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationInputs) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationInputs else None
    ...
    def system_deflection_results(self) -> '_2508.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2508.RootAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
