...
from mastapy.system_model.part_model.gears import _2240
...
class CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6748.CylindricalGearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2240.CylindricalPlanetGear':
        ...
        return constructor.new(_2240.CylindricalPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2458.CylindricalPlanetGearSystemDeflection':
        ...
        return constructor.new(_2458.CylindricalPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
