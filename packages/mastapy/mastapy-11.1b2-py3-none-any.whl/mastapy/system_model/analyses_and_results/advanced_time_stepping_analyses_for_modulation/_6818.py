...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_6817.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_load_case(self) -> '_6662.SynchroniserSleeveLoadCase':
        ...
        return constructor.new(_6662.SynchroniserSleeveLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2531.SynchroniserSleeveSystemDeflection':
        ...
        return constructor.new(_2531.SynchroniserSleeveSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
