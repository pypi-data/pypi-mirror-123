...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6712.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_design(self) -> '_2231.BevelDifferentialSunGear':
        ...
        return constructor.new(_2231.BevelDifferentialSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2413.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2413.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
