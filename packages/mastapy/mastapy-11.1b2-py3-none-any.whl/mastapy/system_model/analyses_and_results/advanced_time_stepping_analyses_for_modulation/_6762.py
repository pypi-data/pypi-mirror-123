...
class GuideDxfModelAdvancedTimeSteppingAnalysisForModulation(_6726.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''GuideDxfModelAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_load_case(self) -> '_6584.GuideDxfModelLoadCase':
        ...
        return constructor.new(_6584.GuideDxfModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2470.GuideDxfModelSystemDeflection':
        ...
        return constructor.new(_2470.GuideDxfModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
