...
class KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation(_6768.KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation):
    '''KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_load_case(self) -> '_6605.KlingelnbergCycloPalloidHypoidGearLoadCase':
        ...
        return constructor.new(_6605.KlingelnbergCycloPalloidHypoidGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2481.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
        ...
        return constructor.new(_2481.KlingelnbergCycloPalloidHypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
