...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6735.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_design(self) -> '_2227.AGMAGleasonConicalGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2403.AGMAGleasonConicalGearSetSystemDeflection':
