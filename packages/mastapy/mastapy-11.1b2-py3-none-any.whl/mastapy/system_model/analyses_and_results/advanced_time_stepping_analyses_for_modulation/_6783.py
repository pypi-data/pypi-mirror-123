...
class PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6739.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    def connection_load_case(self) -> '_6620.PartToPartShearCouplingConnectionLoadCase':
        ...
        return constructor.new(_6620.PartToPartShearCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2494.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2494.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
