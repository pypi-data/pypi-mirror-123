...
class PlanetCarrierAdvancedTimeSteppingAnalysisForModulation(_6779.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''PlanetCarrierAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2498.PlanetCarrierSystemDeflection':
        ...
        return constructor.new(_2498.PlanetCarrierSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
