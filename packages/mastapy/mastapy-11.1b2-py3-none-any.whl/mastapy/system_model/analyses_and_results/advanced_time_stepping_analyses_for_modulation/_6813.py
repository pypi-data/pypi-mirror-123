...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6807.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2262.StraightBevelPlanetGear':
        ...
        return constructor.new(_2262.StraightBevelPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2527.StraightBevelPlanetGearSystemDeflection':
        ...
        return constructor.new(_2527.StraightBevelPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
