...
class ConnectorAdvancedTimeSteppingAnalysisForModulation(_6779.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''ConnectorAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2436.ConnectorSystemDeflection':
