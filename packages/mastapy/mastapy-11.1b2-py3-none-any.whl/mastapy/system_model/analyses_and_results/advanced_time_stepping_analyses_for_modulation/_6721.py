...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_6800.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2417.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2417.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
