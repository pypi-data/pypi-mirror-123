...
class BearingCompoundAdvancedTimeSteppingAnalysisForModulation(_6867.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BearingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6709.BearingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6709.BearingAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6709.BearingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6709.BearingAdvancedTimeSteppingAnalysisForModulation))
        return value
