...
class FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_6929.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_design(self) -> '_2168.FlexiblePinAssembly':
        ...
        return constructor.new(_2168.FlexiblePinAssembly)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6758.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6758.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6758.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6758.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation))
        return value
