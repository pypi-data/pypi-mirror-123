...
class ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_6868.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_design(self) -> '_2294.ConceptCoupling':
        ...
        return constructor.new(_2294.ConceptCoupling)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6727.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6727.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6727.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6727.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value
