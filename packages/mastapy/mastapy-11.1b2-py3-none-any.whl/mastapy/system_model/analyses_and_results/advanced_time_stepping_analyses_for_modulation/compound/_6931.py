...
class SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_6848.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    def component_design(self) -> '_2038.SpiralBevelGearMesh':
        ...
        return constructor.new(_2038.SpiralBevelGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    def connection_design(self) -> '_2038.SpiralBevelGearMesh':
        ...
        return constructor.new(_2038.SpiralBevelGearMesh)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6802.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6802.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6802.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6802.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value
