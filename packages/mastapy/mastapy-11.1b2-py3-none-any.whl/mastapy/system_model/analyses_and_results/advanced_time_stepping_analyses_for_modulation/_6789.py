...
class PowerLoadAdvancedTimeSteppingAnalysisForModulation(_6824.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''PowerLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2500.PowerLoadSystemDeflection':
        ...
        return constructor.new(_2500.PowerLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
