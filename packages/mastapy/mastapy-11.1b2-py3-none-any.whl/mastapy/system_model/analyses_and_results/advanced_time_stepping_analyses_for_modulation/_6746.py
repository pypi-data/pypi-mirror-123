...
class CycloidalDiscCentralBearingConnectionAdvancedTimeSteppingAnalysisForModulation(_6725.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''CycloidalDiscCentralBearingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    def connection_design(self) -> '_2050.CycloidalDiscCentralBearingConnection':
        ...
        return constructor.new(_2050.CycloidalDiscCentralBearingConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def system_deflection_results(self) -> '_2444.CycloidalDiscCentralBearingConnectionSystemDeflection':
        ...
        return constructor.new(_2444.CycloidalDiscCentralBearingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
