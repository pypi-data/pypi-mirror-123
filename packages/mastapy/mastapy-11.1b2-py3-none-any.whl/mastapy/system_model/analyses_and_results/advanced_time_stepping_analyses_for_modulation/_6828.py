...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6717.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2549.ZerolBevelGearSystemDeflection':
        ...
        return constructor.new(_2549.ZerolBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
