...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(_6738.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperAdvancedTimeSteppingAnalysisForModulation
    ...
    def assembly_load_case(self) -> '_6650.SpringDamperLoadCase':
        ...
        return constructor.new(_6650.SpringDamperLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def system_deflection_results(self) -> '_2520.SpringDamperSystemDeflection':
        ...
        return constructor.new(_2520.SpringDamperSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
