...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6718.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    def system_deflection_results(self) -> '_2524.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2524.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
