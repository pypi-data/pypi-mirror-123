...
from mastapy.system_model.analyses_and_results.power_flows import _3869, _3868, _3756
...
class ZerolBevelGearSetPowerFlow(_3756.BevelGearSetPowerFlow):
    '''ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3869.ZerolBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3869.ZerolBevelGearPowerFlow))
        return value

    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_3869.ZerolBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsPowerFlow, constructor.new(_3869.ZerolBevelGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3868.ZerolBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3868.ZerolBevelGearMeshPowerFlow))
        return value

    @property
    def zerol_bevel_meshes_power_flow(self) -> 'List[_3868.ZerolBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesPowerFlow, constructor.new(_3868.ZerolBevelGearMeshPowerFlow))
        return value
