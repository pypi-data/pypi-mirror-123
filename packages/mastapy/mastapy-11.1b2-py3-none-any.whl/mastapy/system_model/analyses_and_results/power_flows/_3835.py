...
from mastapy.system_model.analyses_and_results.power_flows import _3826, _3745
...
class RootAssemblyPowerFlow(_3745.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3826.PowerFlow':
        ...
        return constructor.new(_3826.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
