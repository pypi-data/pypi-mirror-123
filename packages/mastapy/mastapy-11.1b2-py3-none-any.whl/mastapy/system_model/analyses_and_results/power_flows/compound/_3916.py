...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3872
...
class CycloidalDiscCompoundPowerFlow(_3872.AbstractShaftCompoundPowerFlow):
    '''CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3784.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3784.CycloidalDiscPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3784.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3784.CycloidalDiscPowerFlow))
        return value
