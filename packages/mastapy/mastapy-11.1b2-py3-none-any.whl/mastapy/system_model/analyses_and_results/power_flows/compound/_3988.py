...
class TorqueConverterCompoundPowerFlow(_3908.CouplingCompoundPowerFlow):
    '''TorqueConverterCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3860.TorqueConverterPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3860.TorqueConverterPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3860.TorqueConverterPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3860.TorqueConverterPowerFlow))
        return value
