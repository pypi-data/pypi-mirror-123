...
class TorqueConverterConnectionCompoundPowerFlow(_3909.CouplingConnectionCompoundPowerFlow):
    '''TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3859.TorqueConverterConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3859.TorqueConverterConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3859.TorqueConverterConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3859.TorqueConverterConnectionPowerFlow))
        return value
