...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3986
...
class SynchroniserSleeveCompoundPowerFlow(_3986.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3857.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3857.SynchroniserSleevePowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3857.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3857.SynchroniserSleevePowerFlow))
        return value
