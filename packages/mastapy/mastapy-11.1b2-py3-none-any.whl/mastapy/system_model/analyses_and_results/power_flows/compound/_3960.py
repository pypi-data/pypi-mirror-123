...
class RingPinsCompoundPowerFlow(_3948.MountableComponentCompoundPowerFlow):
    '''RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3830.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3830.RingPinsPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3830.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3830.RingPinsPowerFlow))
        return value
