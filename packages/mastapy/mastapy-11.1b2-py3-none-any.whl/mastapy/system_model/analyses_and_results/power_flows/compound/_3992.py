...
class UnbalancedMassCompoundPowerFlow(_3993.VirtualComponentCompoundPowerFlow):
    '''UnbalancedMassCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3863.UnbalancedMassPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3863.UnbalancedMassPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3863.UnbalancedMassPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3863.UnbalancedMassPowerFlow))
        return value
