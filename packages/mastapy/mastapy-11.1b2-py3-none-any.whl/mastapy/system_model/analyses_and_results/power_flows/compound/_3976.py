...
class StraightBevelDiffGearCompoundPowerFlow(_3887.BevelGearCompoundPowerFlow):
    '''StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3847.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3847.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3847.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3847.StraightBevelDiffGearPowerFlow))
        return value
