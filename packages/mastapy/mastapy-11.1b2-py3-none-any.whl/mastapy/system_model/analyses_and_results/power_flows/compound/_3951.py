...
class PartToPartShearCouplingCompoundPowerFlow(_3908.CouplingCompoundPowerFlow):
    '''PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3821.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3821.PartToPartShearCouplingPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3821.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3821.PartToPartShearCouplingPowerFlow))
        return value
