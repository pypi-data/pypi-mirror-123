...
class ConceptCouplingHalfCompoundPowerFlow(_3910.CouplingHalfCompoundPowerFlow):
    '''ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3765.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3765.ConceptCouplingHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3765.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3765.ConceptCouplingHalfPowerFlow))
        return value
