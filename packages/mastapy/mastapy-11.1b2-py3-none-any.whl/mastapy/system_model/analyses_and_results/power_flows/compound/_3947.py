...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3993
...
class MeasurementComponentCompoundPowerFlow(_3993.VirtualComponentCompoundPowerFlow):
    '''MeasurementComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3815.MeasurementComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3815.MeasurementComponentPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3815.MeasurementComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3815.MeasurementComponentPowerFlow))
        return value
