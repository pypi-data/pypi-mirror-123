...
class PowerLoadCompoundPowerFlow(_3993.VirtualComponentCompoundPowerFlow):
    '''PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3828.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3828.PowerLoadPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3828.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3828.PowerLoadPowerFlow))
        return value
