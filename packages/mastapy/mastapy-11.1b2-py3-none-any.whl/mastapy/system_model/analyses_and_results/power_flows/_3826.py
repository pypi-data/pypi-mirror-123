...
class PowerFlow(_7240.StaticLoadAnalysisCase):
    '''PowerFlow
    ...
    @property
    def torsional_system_deflection(self) -> '_2540.TorsionalSystemDeflection':
        ...
        return constructor.new(_2540.TorsionalSystemDeflection)(self.wrapped.TorsionalSystemDeflection) if self.wrapped.TorsionalSystemDeflection else None
