...
from mastapy.system_model.analyses_and_results.power_flows import _3858, _3804
...
class GearMeshPowerFlow(_3804.InterMountableComponentConnectionPowerFlow):
    '''GearMeshPowerFlow
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3858.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3858.ToothPassingHarmonic))
        return value
