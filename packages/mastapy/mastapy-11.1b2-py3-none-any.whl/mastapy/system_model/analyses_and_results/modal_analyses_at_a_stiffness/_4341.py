...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4340, _4339, _4282
...
class HypoidGearSetModalAnalysisAtAStiffness(_4282.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4340.HypoidGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysisAtAStiffness, constructor.new(_4340.HypoidGearModalAnalysisAtAStiffness))
        return value

    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4339.HypoidGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysisAtAStiffness, constructor.new(_4339.HypoidGearMeshModalAnalysisAtAStiffness))
        return value
