...
class CylindricalGearCompoundModalAnalysisAtAStiffness(_4464.GearCompoundModalAnalysisAtAStiffness):
    '''CylindricalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4324.CylindricalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4324.CylindricalGearModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4324.CylindricalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4324.CylindricalGearModalAnalysisAtAStiffness))
        return value
