...
class StraightBevelDiffGearCompoundModalAnalysisAtAStiffness(_4422.BevelGearCompoundModalAnalysisAtAStiffness):
    '''StraightBevelDiffGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4383.StraightBevelDiffGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4383.StraightBevelDiffGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4383.StraightBevelDiffGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4383.StraightBevelDiffGearModalAnalysisAtAStiffness))
        return value
