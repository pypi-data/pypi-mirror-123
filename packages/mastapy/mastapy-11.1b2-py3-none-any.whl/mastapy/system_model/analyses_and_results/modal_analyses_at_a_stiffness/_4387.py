...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4386, _4385, _4294
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_4294.BevelGearSetModalAnalysisAtAStiffness):
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4386.StraightBevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysisAtAStiffness, constructor.new(_4386.StraightBevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4385.StraightBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysisAtAStiffness, constructor.new(_4385.StraightBevelGearMeshModalAnalysisAtAStiffness))
        return value
