...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4377, _4376, _4294
...
class SpiralBevelGearSetModalAnalysisAtAStiffness(_4294.BevelGearSetModalAnalysisAtAStiffness):
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4377.SpiralBevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysisAtAStiffness, constructor.new(_4377.SpiralBevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4376.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysisAtAStiffness, constructor.new(_4376.SpiralBevelGearMeshModalAnalysisAtAStiffness))
        return value
