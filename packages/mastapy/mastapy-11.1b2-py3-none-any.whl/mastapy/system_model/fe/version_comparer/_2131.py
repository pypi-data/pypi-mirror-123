...
class NodeComparisonResult(_0.APIBase):
    ...
    def original_result(self) -> '_1345.NodeResults':
        ...
        return constructor.new(_1345.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult else None
    ...
    def new_result(self) -> '_1345.NodeResults':
        ...
        return constructor.new(_1345.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult else None
    ...
    def displacement_change(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
