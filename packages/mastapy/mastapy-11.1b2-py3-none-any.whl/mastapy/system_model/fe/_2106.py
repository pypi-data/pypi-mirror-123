...
class FESubstructureWithSelectionForHarmonicAnalysis(_2104.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForHarmonicAnalysis
    ...
    def harmonic_draw_style(self) -> '_161.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_161.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
