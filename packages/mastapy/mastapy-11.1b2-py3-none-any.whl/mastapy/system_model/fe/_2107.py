...
from mastapy.system_model.fe import _2101, _2104
...
class FESubstructureWithSelectionForModalAnalysis(_2104.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForModalAnalysis
    ...
    def modal_draw_style(self) -> '_163.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_163.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2101.FESubstructureNodeModeShapes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FullFEModeShapesAtCondensationNodes, constructor.new(_2101.FESubstructureNodeModeShapes))
        return value
