...
class ConceptGearMesh(_2028.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1108.ConceptGearMeshDesign':
        ...
        return constructor.new(_1108.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
