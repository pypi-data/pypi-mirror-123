...
from mastapy.system_model.part_model.gears import _2239, _2255, _2238
...
class CylindricalGearMesh(_2028.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2239.CylindricalGearSet':
        ...
        if _2239.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1348.ShortLengthRange':
        ...
        return constructor.new(_1348.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None

    @property
    def cylindrical_gear_mesh_design(self) -> '_959.CylindricalGearMeshDesign':
        ...
        return constructor.new(_959.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMeshDesign) if self.wrapped.CylindricalGearMeshDesign else None
