...
from mastapy.gears.gear_designs.worm import _898
...
class WormGearMesh(_2028.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_898.WormGearMeshDesign':
        ...
        return constructor.new(_898.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
