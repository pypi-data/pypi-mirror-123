...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_1920.Design':
        ...
        return constructor.new(_1920.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties else None
    ...
    def user_specified_data(self) -> '_1499.UserSpecifiedData':
        ...
        return constructor.new(_1499.UserSpecifiedData)(self.wrapped.UserSpecifiedData) if self.wrapped.UserSpecifiedData else None
