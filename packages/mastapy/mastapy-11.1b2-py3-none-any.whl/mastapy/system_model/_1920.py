...
class Design(_0.APIBase):
    ...
    def masta_gui(self) -> '_1595.MASTAGUI':
        ...
        return constructor.new(_1595.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    def efficiency_rating_method_for_bearings(self) -> '_260.BearingEfficiencyRatingMethod':
        ...
        return constructor.new(_260.BearingEfficiencyRatingMethod)(value) if value else None
    ...
    def efficiency_rating_method_if_skf_loss_model_does_not_provide_losses(self) -> 'enum_with_selected_value.EnumWithSelectedValue_BearingEfficiencyRatingMethod':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.EfficiencyRatingMethodIfSKFLossModelDoesNotProvideLosses, value) if self.wrapped.EfficiencyRatingMethodIfSKFLossModelDoesNotProvideLosses else None
    ...
    def unbalanced_mass_inclusion(self) -> '_2192.UnbalancedMassInclusionOption':
        ...
        return constructor.new(_2192.UnbalancedMassInclusionOption)(value) if value else None
    ...
    def thermal_expansion_for_grounded_nodes(self) -> '_1941.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1941.ThermalExpansionOptionForGroundedNodes)(value) if value else None
    ...
    def transverse_contact_ratio_requirement(self) -> '_287.ContactRatioRequirements':
        ...
        return constructor.new(_287.ContactRatioRequirements)(value) if value else None
    ...
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_552.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_552.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None
    ...
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_552.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_552.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None
    ...
    def file_save_details_most_recent(self) -> '_1364.FileHistoryItem':
        ...
        return constructor.new(_1364.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None
    ...
    def default_system_temperatures(self) -> '_1942.TransmissionTemperatureSet':
        ...
        return constructor.new(_1942.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    def detailed_spline_settings(self) -> '_1175.DetailedSplineJointSettings':
        ...
        return constructor.new(_1175.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    def file_save_details_all(self) -> '_1363.FileHistory':
        ...
        return constructor.new(_1363.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    def gear_set_design_group(self) -> '_293.GearSetDesignGroup':
        ...
        return constructor.new(_293.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None
    ...
    def selected_gear_set_selection_group(self) -> '_2225.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2225.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None
    ...
    def system(self) -> '_1940.SystemReporting':
        ...
        return constructor.new(_1940.SystemReporting)(self.wrapped.System) if self.wrapped.System else None
    ...
    def fe_batch_operations(self) -> '_2076.BatchOperations':
        ...
        return constructor.new(_2076.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None
    ...
    def root_assembly(self) -> '_2188.RootAssembly':
        ...
        return constructor.new(_2188.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None
    ...
    def gear_set_config(self) -> '_2246.GearSetConfiguration':
        ...
        return constructor.new(_2246.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None
    ...
    def status(self) -> '_1546.Status':
        ...
        return constructor.new(_1546.Status)(self.wrapped.Status) if self.wrapped.Status else None
    ...
    def databases(self) -> '_1979.Databases':
        ...
        return constructor.new(_1979.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None
    ...
    def masta_settings(self) -> '_1921.MastaSettings':
        ...
        return constructor.new(_1921.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings else None
    ...
    def design_state_load_case_group_named(self, name: 'str') -> '_5361.DesignState':
        ...
        name = str(name)
        method_result = self.wrapped.DesignStateLoadCaseGroupNamed(name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None
    ...
    def time_series_load_case_group_named(self, name: 'str') -> '_5369.TimeSeriesLoadCaseGroup':
        ...
        name = str(name)
        method_result = self.wrapped.TimeSeriesLoadCaseGroupNamed(name if name else None)
        return constructor.new_override(method_result.__class__)(method_result) if method_result else None
