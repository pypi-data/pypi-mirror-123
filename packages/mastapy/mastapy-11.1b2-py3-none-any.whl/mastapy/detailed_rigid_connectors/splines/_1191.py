...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1206
from mastapy.detailed_rigid_connectors.splines import _1203
...
class SAESplineHalfDesign(_1203.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1206.SAESplineTolerances':
        ...
        return constructor.new(_1206.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
