...
from mastapy.detailed_rigid_connectors.splines import (
    _1182, _1199, _1174, _1177,
    _1181, _1184, _1185, _1192,
    _1204
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1205
from mastapy.detailed_rigid_connectors import _1172
...
class SplineHalfDesign(_1172.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1182.HeatTreatmentTypes':
        ...
        return constructor.new(_1182.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1182.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1205.FitAndTolerance':
        ...
        return constructor.new(_1205.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
