...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1225
...
class KeywayRating(_1233.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1221.KeyedJointDesign':
        ...
        return constructor.new(_1221.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign else None

    @property
    def keyway_half_ratings(self) -> 'List[_1225.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1225.KeywayHalfRating))
        return value
