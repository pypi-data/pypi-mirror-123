...
from mastapy.detailed_rigid_connectors.keyed_joints import _1224, _1222
...
class KeyedJointDesign(_1229.InterferenceFitDesign):
    '''KeyedJointDesign
