...
from mastapy.detailed_rigid_connectors.interference_fits import _1231
from mastapy.bearings.tolerances import _1651, _1637, _1643
...
class InterferenceFitHalfDesign(_1172.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1231.StressRegions':
        ...
        return constructor.new(_1231.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1651.SupportTolerance':
        ...
        if _1651.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1637.InnerSupportTolerance':
        ...
        if _1637.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1643.OuterSupportTolerance':
        ...
        if _1643.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
