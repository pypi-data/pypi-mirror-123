...
from mastapy.detailed_rigid_connectors.interference_fits import _1228, _1227, _1232
...
class InterferenceFitDesign(_1171.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1228.CalculationMethods':
        ...
        return constructor.new(_1228.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1228.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1227.AssemblyMethods':
        ...
        return constructor.new(_1227.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1227.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
