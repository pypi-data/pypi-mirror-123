...
from mastapy.detailed_rigid_connectors.splines import (
    _1174, _1177, _1181, _1184,
    _1185, _1192, _1199, _1204
)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1171.DetailedRigidConnectorDesign':
        ...
        if _1171.DetailedRigidConnectorDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1174.CustomSplineJointDesign':
        ...
        if _1174.CustomSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1177.DIN5480SplineJointDesign':
        ...
        if _1177.DIN5480SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1181.GBT3478SplineJointDesign':
        ...
        if _1181.GBT3478SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1184.ISO4156SplineJointDesign':
        ...
        if _1184.ISO4156SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1185.JISB1603SplineJointDesign':
        ...
        if _1185.JISB1603SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1192.SAESplineJointDesign':
        ...
        if _1192.SAESplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1199.SplineJointDesign':
        ...
        if _1199.SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1204.StandardSplineJointDesign':
        ...
        if _1204.StandardSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1221.KeyedJointDesign':
        ...
        if _1221.KeyedJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1229.InterferenceFitDesign':
        ...
        if _1229.InterferenceFitDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
