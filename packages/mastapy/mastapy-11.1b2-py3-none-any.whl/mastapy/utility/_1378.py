...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    def version_to_copy(self) -> '_1377.SystemDirectory':
        ...
        return constructor.new(_1377.SystemDirectory)(self.wrapped.VersionToCopy) if self.wrapped.VersionToCopy else None
    ...
    def current_version(self) -> '_1377.SystemDirectory':
        ...
        return constructor.new(_1377.SystemDirectory)(self.wrapped.CurrentVersion) if self.wrapped.CurrentVersion else None
