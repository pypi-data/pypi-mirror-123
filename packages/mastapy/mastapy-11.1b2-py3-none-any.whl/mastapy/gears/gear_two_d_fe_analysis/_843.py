...
from mastapy.gears.gear_two_d_fe_analysis import _844
...
class CylindricalGearTwoDimensionalFEAnalysis(_0.APIBase):
    ...
    @property
    def findley_critical_plane_analysis(self) -> '_844.FindleyCriticalPlaneAnalysis':
        ...
        return constructor.new(_844.FindleyCriticalPlaneAnalysis)(self.wrapped.FindleyCriticalPlaneAnalysis) if self.wrapped.FindleyCriticalPlaneAnalysis else None
