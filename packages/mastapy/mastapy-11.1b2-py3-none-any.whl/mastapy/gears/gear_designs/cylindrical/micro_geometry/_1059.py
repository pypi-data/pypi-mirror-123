...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1061
...
class ProfileReliefWithDeviation(_1061.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile else None
