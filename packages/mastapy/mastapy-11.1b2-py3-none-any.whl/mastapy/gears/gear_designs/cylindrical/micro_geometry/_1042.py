...
from mastapy.gears.gear_two_d_fe_analysis import _840
...
class CylindricalGearSetMicroGeometryDutyCycle(_1158.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def rating(self) -> '_426.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_426.CylindricalGearSetDutyCycleRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def tiff_analysis(self) -> '_840.CylindricalGearSetTIFFAnalysisDutyCycle':
        ...
        return constructor.new(_840.CylindricalGearSetTIFFAnalysisDutyCycle)(self.wrapped.TIFFAnalysis) if self.wrapped.TIFFAnalysis else None

    @property
    def meshes(self) -> 'List[_1035.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1035.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
