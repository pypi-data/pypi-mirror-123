...
class CylindricalGearMeshMicroGeometryDutyCycle(_1150.GearMeshDesignAnalysis):
    '''CylindricalGearMeshMicroGeometryDutyCycle
    ...
    @property
    def meshes_analysis(self) -> 'List[_800.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_800.CylindricalGearMeshLoadDistributionAnalysis))
        return value
