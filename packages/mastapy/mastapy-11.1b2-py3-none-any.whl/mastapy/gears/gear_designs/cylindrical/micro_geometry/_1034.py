...
class CylindricalGearMeshMicroGeometry(_1153.GearMeshImplementationDetail):
    ...
    def cylindrical_mesh(self) -> '_959.CylindricalGearMeshDesign':
        ...
        return constructor.new(_959.CylindricalGearMeshDesign)(self.wrapped.CylindricalMesh) if self.wrapped.CylindricalMesh else None
    ...
    def gear_a(self) -> '_1036.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1036.CylindricalGearMicroGeometry)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    def gear_b(self) -> '_1036.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1036.CylindricalGearMicroGeometry)(self.wrapped.GearB) if self.wrapped.GearB else None
