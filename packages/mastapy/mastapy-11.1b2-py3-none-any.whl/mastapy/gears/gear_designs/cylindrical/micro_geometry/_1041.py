...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1036, _1034
...
class CylindricalGearSetMicroGeometry(_1159.GearSetImplementationDetail):
    '''CylindricalGearSetMicroGeometry
    ...
    @property
    def cylindrical_mesh_micro_geometries(self) -> 'List[_1034.CylindricalGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshMicroGeometries, constructor.new(_1034.CylindricalGearMeshMicroGeometry))
        return value
