...
from mastapy.gears.gear_designs.cylindrical import _1010, _1011, _1009
...
class Scuffing(_1366.IndependentReportablePropertiesBase['Scuffing']):
    '''Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_1010.ScuffingTemperatureMethodsAGMA':
    ...
    def scuffing_temperature_method_agma(self, value: '_1010.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_1011.ScuffingTemperatureMethodsISO':
    ...
    def scuffing_temperature_method_iso(self, value: '_1011.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
