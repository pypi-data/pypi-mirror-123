...
class Usage(_1366.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def safety_requirement(self) -> '_310.SafetyRequirementsAGMA':
    ...
    def safety_requirement(self, value: '_310.SafetyRequirementsAGMA'):
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_1013.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_1013.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_1013.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
