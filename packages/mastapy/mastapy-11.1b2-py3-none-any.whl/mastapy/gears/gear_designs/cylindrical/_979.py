...
from mastapy.gears.gear_designs.cylindrical import _1004, _1003, _952
...
class CylindricalPlanetGearDesign(_952.CylindricalGearDesign):
    '''CylindricalPlanetGearDesign
    ...
    @property
    def planetary_details(self) -> '_305.PlanetaryDetail':
        ...
        return constructor.new(_305.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails else None

    @property
    def planetary_sidebands_amplitude_factors(self) -> 'List[_1004.NamedPlanetSideBandAmplitudeFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySidebandsAmplitudeFactors, constructor.new(_1004.NamedPlanetSideBandAmplitudeFactor))
        return value

    @property
    def planet_assembly_indices(self) -> 'List[_1003.NamedPlanetAssemblyIndex]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetAssemblyIndices, constructor.new(_1003.NamedPlanetAssemblyIndex))
        return value
