...
class CylindricalGearBasicRack(_946.CylindricalGearAbstractRack):
    ...
    def basic_rack_profile(self) -> '_940.BasicRackProfiles':
        ...
        return constructor.new(_940.BasicRackProfiles)(value) if value else None
    ...
    def proportional_method_for_tip_clearance(self) -> '_1019.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_1019.TipAlterationCoefficientMethod)(value) if value else None
    ...
    def pinion_type_cutter_for_rating(self) -> '_962.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_962.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating else None
