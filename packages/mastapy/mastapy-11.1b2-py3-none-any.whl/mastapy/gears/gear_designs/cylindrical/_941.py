...
from mastapy.gears.gear_designs.cylindrical import _991, _992
...
class CaseHardeningProperties(_0.APIBase):
    ...
    @property
    def hardness_profile_calculation_method(self) -> '_991.HardnessProfileCalculationMethod':
        ...
        return constructor.new(_991.HardnessProfileCalculationMethod)(value) if value else None

    @hardness_profile_calculation_method.setter
    def hardness_profile_calculation_method(self, value: '_991.HardnessProfileCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HardnessProfileCalculationMethod = value

    @property
    def heat_treatment_type(self) -> '_992.HeatTreatmentType':
        ...
        return constructor.new(_992.HeatTreatmentType)(value) if value else None
