...
class TiffAnalysisSettings(_1366.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def measured_residual_stress_profile_property(self) -> '_1317.Vector2DListAccessor':
        '''Vector2DListAccessor: 'MeasuredResidualStressProfileProperty' is the original name of this property.'''

        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.MeasuredResidualStressProfileProperty) if self.wrapped.MeasuredResidualStressProfileProperty else None

    @measured_residual_stress_profile_property.setter
    def measured_residual_stress_profile_property(self, value: '_1317.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.MeasuredResidualStressProfileProperty = value

    @property
    def surface_material_properties(self) -> '_990.HardenedMaterialProperties':
        ...
        return constructor.new(_990.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_990.HardenedMaterialProperties':
        ...
        return constructor.new(_990.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
