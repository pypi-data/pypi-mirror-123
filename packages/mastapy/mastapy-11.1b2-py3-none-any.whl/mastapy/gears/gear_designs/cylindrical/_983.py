...
class FinishStockSpecification(_1007.RelativeValuesSpecification['FinishStockSpecification']):
    '''FinishStockSpecification
    ...
    @property
    def finish_stock_rough_thickness_specification_method(self) -> '_1027.FinishStockType':
    ...
    def finish_stock_rough_thickness_specification_method(self, value: '_1027.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockRoughThicknessSpecificationMethod = value

    @property
    def normal(self) -> '_1021.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _1021.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.Normal.__class__.__mro__:
    ...
    @property
    def tangent_to_reference_circle(self) -> '_1021.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _1021.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.TangentToReferenceCircle.__class__.__mro__:
