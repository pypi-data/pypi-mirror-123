...
from mastapy.gears import _309, _299, _280
from mastapy.utility.units_and_measurements import _1384
...
class CylindricalGearDesignSettings(_1371.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def default_micro_geometry_lead_tolerance_chart_view(self) -> '_1055.MicroGeometryLeadToleranceChartView':
        ...
        return constructor.new(_1055.MicroGeometryLeadToleranceChartView)(value) if value else None

    @default_micro_geometry_lead_tolerance_chart_view.setter
    def default_micro_geometry_lead_tolerance_chart_view(self, value: '_1055.MicroGeometryLeadToleranceChartView'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DefaultMicroGeometryLeadToleranceChartView = value

    @property
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self) -> '_982.DoubleAxisScaleAndRange':
        ...
        return constructor.new(_982.DoubleAxisScaleAndRange)(value) if value else None

    @default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts.setter
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self, value: '_982.DoubleAxisScaleAndRange'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DefaultScaleAndRangeOfFlankReliefAxesForMicroGeometryToleranceCharts = value

    @property
    def default_flank_side_with_zero_face_width(self) -> '_525.FlankSide':
        ...
        return constructor.new(_525.FlankSide)(value) if value else None

    @default_flank_side_with_zero_face_width.setter
    def default_flank_side_with_zero_face_width(self, value: '_525.FlankSide'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DefaultFlankSideWithZeroFaceWidth = value

    @property
    def cylindrical_gear_profile_measurement(self) -> '_965.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_965.CylindricalGearProfileMeasurementType)(value) if value else None

    @cylindrical_gear_profile_measurement.setter
    def cylindrical_gear_profile_measurement(self, value: '_965.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CylindricalGearProfileMeasurement = value

    @property
    def agma_quality_grade_type(self) -> '_309.QualityGradeTypes':
        ...
        return constructor.new(_309.QualityGradeTypes)(value) if value else None

    @agma_quality_grade_type.setter
    def agma_quality_grade_type(self, value: '_309.QualityGradeTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMAQualityGradeType = value

    @property
    def tolerance_rounding_system(self) -> '_1384.MeasurementSystem':
        ...
        return constructor.new(_1384.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1384.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def agma_tolerances_standard(self) -> '_280.AGMAToleranceStandard':
        ...
        return constructor.new(_280.AGMAToleranceStandard)(value) if value else None

    @agma_tolerances_standard.setter
    def agma_tolerances_standard(self, value: '_280.AGMAToleranceStandard'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def micro_geometry_profile_relief_definition(self) -> '_1001.MicroGeometryProfileConvention':
        ...
        return constructor.new(_1001.MicroGeometryProfileConvention)(value) if value else None

    @micro_geometry_profile_relief_definition.setter
    def micro_geometry_profile_relief_definition(self, value: '_1001.MicroGeometryProfileConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self) -> '_532.MainProfileReliefEndsAtTheStartOfTipReliefOption':
        ...
        return constructor.new(_532.MainProfileReliefEndsAtTheStartOfTipReliefOption)(value) if value else None

    @main_profile_modification_ends_at_the_start_of_tip_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self, value: '_532.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_535.ParabolicTipReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_535.ParabolicTipReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_535.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self) -> '_531.MainProfileReliefEndsAtTheStartOfRootReliefOption':
        ...
        return constructor.new(_531.MainProfileReliefEndsAtTheStartOfRootReliefOption)(value) if value else None

    @main_profile_modification_ends_at_the_start_of_root_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self, value: '_531.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_534.ParabolicRootReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_534.ParabolicRootReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_534.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
