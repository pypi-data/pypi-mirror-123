...
from mastapy.gears.gear_designs.cylindrical import _963, _946
...
class CylindricalGearPinionTypeCutter(_946.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self) -> '_963.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_963.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_963.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_963.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
