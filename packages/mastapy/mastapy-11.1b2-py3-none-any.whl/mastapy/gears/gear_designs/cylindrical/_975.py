...
class CylindricalMeshedGear(_0.APIBase):
    ...
    def left_flank(self) -> '_976.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_976.CylindricalMeshedGearFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
    ...
    def right_flank(self) -> '_976.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_976.CylindricalMeshedGearFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
    ...
    def both_flanks(self) -> '_976.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_976.CylindricalMeshedGearFlank)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None
