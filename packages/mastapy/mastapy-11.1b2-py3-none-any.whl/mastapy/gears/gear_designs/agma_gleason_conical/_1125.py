...
from mastapy.gears.gear_designs.conical import _1100, _1086
...
class AGMAGleasonConicalGearMeshDesign(_1086.ConicalGearMeshDesign):
    '''AGMAGleasonConicalGearMeshDesign
    ...
    @property
    def profile_crowning_setting(self) -> '_401.ProfileCrowningSetting':
        ...
        return constructor.new(_401.ProfileCrowningSetting)(value) if value else None

    @profile_crowning_setting.setter
    def profile_crowning_setting(self, value: '_401.ProfileCrowningSetting'):
    ...
    @property
    def mounting_conditions_of_pinion_and_wheel(self) -> '_399.MountingConditionsOfPinionAndWheel':
        ...
        return constructor.new(_399.MountingConditionsOfPinionAndWheel)(value) if value else None

    @mounting_conditions_of_pinion_and_wheel.setter
    def mounting_conditions_of_pinion_and_wheel(self, value: '_399.MountingConditionsOfPinionAndWheel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MountingConditionsOfPinionAndWheel = value

    @property
    def verification_of_contact_pattern(self) -> '_402.VerificationOfContactPattern':
        ...
        return constructor.new(_402.VerificationOfContactPattern)(value) if value else None

    @verification_of_contact_pattern.setter
    def verification_of_contact_pattern(self, value: '_402.VerificationOfContactPattern'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.VerificationOfContactPattern = value

    @property
    def iso10300_gear_set_finishing_methods(self) -> '_386.Iso10300FinishingMethods':
        ...
        return constructor.new(_386.Iso10300FinishingMethods)(value) if value else None

    @iso10300_gear_set_finishing_methods.setter
    def iso10300_gear_set_finishing_methods(self, value: '_386.Iso10300FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
