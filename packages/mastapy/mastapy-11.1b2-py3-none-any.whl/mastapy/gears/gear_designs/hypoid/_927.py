...
from mastapy.gears.gear_designs.hypoid import _925, _926
...
class HypoidGearSetDesign(_1126.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_925.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_925.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_925.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_925.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_926.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_926.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_926.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_926.HypoidGearMeshDesign))
        return value
