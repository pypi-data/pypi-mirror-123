...
class GearDesign(_888.GearDesignComponent):
    '''GearDesign
    ...
    @property
    def tifffe_model(self) -> '_1128.GearFEModel':
        ...
        if _1128.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1132.CylindricalGearFEModel':
        ...
        if _1132.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1135.ConicalGearFEModel':
        ...
        if _1135.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
