...
from mastapy.gears.gear_designs.creation_options import _1078
...
class CylindricalGearPairCreationOptions(_1078.GearSetCreationOptions['_967.CylindricalGearSetDesign']):
    '''CylindricalGearPairCreationOptions
