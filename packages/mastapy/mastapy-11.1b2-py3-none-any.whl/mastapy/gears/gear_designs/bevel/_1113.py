...
from mastapy.gears.gear_designs.bevel import _1121, _1122, _1120
...
class BevelGearSetDesign(_1126.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1082.BacklashDistributionRule':
        ...
        return constructor.new(_1082.BacklashDistributionRule)(value) if value else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1082.BacklashDistributionRule'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BacklashDistributionRule = value

    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1302.MaxMinMean':
        ...
        return constructor.new(_1302.MaxMinMean)(value) if value else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1302.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def round_cutter_specifications(self) -> '_1122.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1122.WheelFinishCutterPointWidthRestrictionMethod)(value) if value else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1122.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_taper_root_line_tilt_method(self) -> '_312.SpiralBevelRootLineTilt':
        ...
        return constructor.new(_312.SpiralBevelRootLineTilt)(value) if value else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_312.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1120.ToothProportionsInputMethod':
        ...
        return constructor.new(_1120.ToothProportionsInputMethod)(value) if value else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1120.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
