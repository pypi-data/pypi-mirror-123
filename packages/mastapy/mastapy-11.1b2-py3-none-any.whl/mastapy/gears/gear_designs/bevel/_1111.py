...
from mastapy.gears.gear_designs.bevel import _1117
...
class BevelGearDesign(_1124.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1117.FinishingMethods':
        ...
        return constructor.new(_1117.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1117.FinishingMethods'):
