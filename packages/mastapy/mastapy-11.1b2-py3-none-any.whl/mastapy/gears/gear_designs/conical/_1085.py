...
class ConicalGearDesign(_887.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_750.FlankMeasurementBorder':
        ...
        return constructor.new(_750.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
