...
class ConicalGearFlankMicroGeometry(_524.FlankMicroGeometry):
    ...
    def profile_relief(self) -> '_1106.ConicalGearProfileModification':
        ...
        return constructor.new(_1106.ConicalGearProfileModification)(self.wrapped.ProfileRelief) if self.wrapped.ProfileRelief else None
    ...
    def lead_relief(self) -> '_1105.ConicalGearLeadModification':
        ...
        return constructor.new(_1105.ConicalGearLeadModification)(self.wrapped.LeadRelief) if self.wrapped.LeadRelief else None
    ...
    def bias(self) -> '_1103.ConicalGearBiasModification':
        ...
        return constructor.new(_1103.ConicalGearBiasModification)(self.wrapped.Bias) if self.wrapped.Bias else None
