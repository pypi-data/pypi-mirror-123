...
from mastapy.gears.gear_designs.bevel import _1115, _1119, _1118
...
class ConicalGearMeshDesign(_889.GearMeshDesign):
    '''ConicalGearMeshDesign
    ...
    @property
    def driven_machine_characteristic_gleason(self) -> '_1115.DrivenMachineCharacteristicGleason':
        ...
        return constructor.new(_1115.DrivenMachineCharacteristicGleason)(value) if value else None

    @driven_machine_characteristic_gleason.setter
    def driven_machine_characteristic_gleason(self, value: '_1115.DrivenMachineCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristicGleason = value

    @property
    def prime_mover_characteristic_gleason(self) -> '_1119.PrimeMoverCharacteristicGleason':
        ...
        return constructor.new(_1119.PrimeMoverCharacteristicGleason)(value) if value else None

    @prime_mover_characteristic_gleason.setter
    def prime_mover_characteristic_gleason(self, value: '_1119.PrimeMoverCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristicGleason = value

    @property
    def prime_mover_characteristic(self) -> '_1118.MachineCharacteristicAGMAKlingelnberg':
        ...
        return constructor.new(_1118.MachineCharacteristicAGMAKlingelnberg)(value) if value else None

    @prime_mover_characteristic.setter
    def prime_mover_characteristic(self, value: '_1118.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristic = value

    @property
    def driven_machine_characteristic(self) -> '_1118.MachineCharacteristicAGMAKlingelnberg':
    ...
    def driven_machine_characteristic(self, value: '_1118.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
