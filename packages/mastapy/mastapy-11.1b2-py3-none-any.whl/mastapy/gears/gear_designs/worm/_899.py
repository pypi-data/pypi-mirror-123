...
from mastapy.gears.gear_designs.worm import _897, _898
...
class WormGearSetDesign(_890.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_897.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_897.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_897.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_897.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_898.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_898.WormGearMeshDesign))
        return value
