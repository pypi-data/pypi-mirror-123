...
class WormDesign(_897.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_315.WormAddendumFactor':
        ...
        return constructor.new(_315.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_315.WormAddendumFactor'):
