...
from mastapy.gears.gear_designs.spiral_bevel import _911, _909, _912
...
class SpiralBevelGearMeshDesign(_1112.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    def spiral_bevel_gear_set(self) -> '_911.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_911.SpiralBevelGearSetDesign)(self.wrapped.SpiralBevelGearSet) if self.wrapped.SpiralBevelGearSet else None

    @property
    def spiral_bevel_gears(self) -> 'List[_909.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_909.SpiralBevelGearDesign))
        return value

    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_912.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_912.SpiralBevelMeshedGearDesign))
        return value
