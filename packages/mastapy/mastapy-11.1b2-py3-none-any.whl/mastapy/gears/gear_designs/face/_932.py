...
class FaceGearMeshMicroGeometry(_1153.GearMeshImplementationDetail):
    ...
    def face_mesh(self) -> '_931.FaceGearMeshDesign':
        ...
        return constructor.new(_931.FaceGearMeshDesign)(self.wrapped.FaceMesh) if self.wrapped.FaceMesh else None
    ...
    def face_gear_set_micro_geometry(self) -> '_936.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_936.FaceGearSetMicroGeometry)(self.wrapped.FaceGearSetMicroGeometry) if self.wrapped.FaceGearSetMicroGeometry else None
