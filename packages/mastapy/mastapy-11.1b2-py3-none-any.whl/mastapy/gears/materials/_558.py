...
class PlasticSNCurve(_0.APIBase):
    ...
    def lubricant(self) -> '_256.VDI2736LubricantType':
        ...
        return constructor.new(_256.VDI2736LubricantType)(value) if value else None
    ...
    @property
    def material(self) -> '_557.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_557.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
