...
class CylindricalGearLoadDistributionAnalysis(_785.GearLoadDistributionAnalysis):
    ...
    def rating(self) -> '_422.CylindricalGearRating':
        ...
        return constructor.new(_422.CylindricalGearRating)(self.wrapped.Rating) if self.wrapped.Rating else None
    ...
    def tiff_analysis(self) -> '_841.CylindricalGearTIFFAnalysis':
        ...
        return constructor.new(_841.CylindricalGearTIFFAnalysis)(self.wrapped.TIFFAnalysis) if self.wrapped.TIFFAnalysis else None
