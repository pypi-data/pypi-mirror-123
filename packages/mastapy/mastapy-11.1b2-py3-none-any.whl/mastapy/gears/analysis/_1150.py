...
class GearMeshDesignAnalysis(_1144.AbstractGearMeshAnalysis):
    '''GearMeshDesignAnalysis
    ...
    @property
    def gear_a(self) -> '_1146.GearDesignAnalysis':
    ...
    @property
    def gear_b(self) -> '_1146.GearDesignAnalysis':
