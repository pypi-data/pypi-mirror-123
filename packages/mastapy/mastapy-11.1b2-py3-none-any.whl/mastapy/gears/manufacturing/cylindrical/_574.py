...
class CylindricalManufacturedGearSetDutyCycle(_1158.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalManufacturedGearSetDutyCycle
    ...
    def manufacturing_configuration(self) -> '_579.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_579.CylindricalSetManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
