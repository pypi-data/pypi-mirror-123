...
class CylindricalGearFormedWheelGrinderTangible(_695.CutterShapeDefinition):
    '''CylindricalGearFormedWheelGrinderTangible
    ...
    @property
    def design(self) -> '_679.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_679.CylindricalGearFormGrindingWheel)(self.wrapped.Design) if self.wrapped.Design else None
