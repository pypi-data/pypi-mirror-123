...
class CylindricalGearShaperTangible(_695.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_686.CylindricalGearShaper':
        ...
        return constructor.new(_686.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design else None
