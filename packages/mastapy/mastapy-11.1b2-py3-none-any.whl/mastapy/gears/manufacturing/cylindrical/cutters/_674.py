...
from mastapy.gears.manufacturing.cylindrical.cutters import _689
...
class CustomisableEdgeProfile(_0.APIBase):
    ...
    @property
    def customised_cutting_edge_profile(self) -> 'List[_689.MutatableCommon]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CustomisedCuttingEdgeProfile, constructor.new(_689.MutatableCommon))
        return value
