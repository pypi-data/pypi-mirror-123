...
from mastapy.gears import _298, _316
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _702, _697, _700
...
class CylindricalGearRackDesign(_685.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_316.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_316.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_316.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
