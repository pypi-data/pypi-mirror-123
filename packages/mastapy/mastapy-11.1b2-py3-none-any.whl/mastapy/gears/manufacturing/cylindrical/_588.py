...
from mastapy.gears.manufacturing.cylindrical import _587, _586
...
class MicroGeometryInputsLead(_587.MicroGeometryInputs['_586.LeadModificationSegment']):
    '''MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self) -> '_1271.Range':
        ...
        if _1271.Range.TYPE not in self.wrapped.LeadMicroGeometryRange.__class__.__mro__:
