...
class ShavingDynamicsCalculationForDesignedGears(_720.ShavingDynamicsCalculation['T'], Generic[T]):
    '''ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def start_of_shaving_profile(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value else None

    @property
    def end_of_shaving_profile(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value else None

    @property
    def redressing(self) -> '_718.ShaverRedressing[T]':
        ...
        if _718.ShaverRedressing[T].TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_704.AxialShaverRedressing':
        ...
        if _704.AxialShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_711.PlungeShaverRedressing':
        ...
        if _711.PlungeShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
