...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    def accuracy_level_iso6(self) -> '_716.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_716.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None
    ...
    def accuracy_level_iso7(self) -> '_716.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_716.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None
    ...
    def designed_gear(self) -> '_658.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_658.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    def new_cutter_start_of_shaving(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None
    ...
    def life_cutter_start_of_shaving(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
