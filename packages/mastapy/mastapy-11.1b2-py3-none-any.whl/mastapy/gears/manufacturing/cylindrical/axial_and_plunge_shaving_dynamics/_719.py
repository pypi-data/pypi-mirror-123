...
class ShavingDynamics(_0.APIBase):
    ...
    def crossed_axis_calculation_details(self) -> '_945.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_945.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
