...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _710, _724, _709
...
class PlungeShavingDynamicsViewModel(_724.ShavingDynamicsViewModel['_709.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_710.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_710.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
