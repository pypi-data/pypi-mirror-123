...
class PlungeShaverGeneration(_0.APIBase):
    ...
    def crossed_axis_calculation_details(self) -> '_944.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_944.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
