...
class HobbingProcessSimulationNew(_640.ProcessSimulationNew['_626.HobbingProcessSimulationInput']):
    ...
    def hobbing_process_lead_calculation(self) -> '_622.HobbingProcessLeadCalculation':
        ...
        return constructor.new(_622.HobbingProcessLeadCalculation)(self.wrapped.HobbingProcessLeadCalculation) if self.wrapped.HobbingProcessLeadCalculation else None
    ...
    def hobbing_process_pitch_calculation(self) -> '_624.HobbingProcessPitchCalculation':
        ...
        return constructor.new(_624.HobbingProcessPitchCalculation)(self.wrapped.HobbingProcessPitchCalculation) if self.wrapped.HobbingProcessPitchCalculation else None
    ...
    def hobbing_process_profile_calculation(self) -> '_625.HobbingProcessProfileCalculation':
        ...
        return constructor.new(_625.HobbingProcessProfileCalculation)(self.wrapped.HobbingProcessProfileCalculation) if self.wrapped.HobbingProcessProfileCalculation else None
    ...
    def hobbing_process_gear_shape_calculation(self) -> '_621.HobbingProcessGearShape':
        ...
        return constructor.new(_621.HobbingProcessGearShape)(self.wrapped.HobbingProcessGearShapeCalculation) if self.wrapped.HobbingProcessGearShapeCalculation else None
    ...
    def hobbing_process_mark_on_shaft_calculation(self) -> '_623.HobbingProcessMarkOnShaft':
        ...
        return constructor.new(_623.HobbingProcessMarkOnShaft)(self.wrapped.HobbingProcessMarkOnShaftCalculation) if self.wrapped.HobbingProcessMarkOnShaftCalculation else None
    ...
    def hobbing_process_total_modification(self) -> '_629.HobbingProcessTotalModificationCalculation':
        ...
        return constructor.new(_629.HobbingProcessTotalModificationCalculation)(self.wrapped.HobbingProcessTotalModification) if self.wrapped.HobbingProcessTotalModification else None
