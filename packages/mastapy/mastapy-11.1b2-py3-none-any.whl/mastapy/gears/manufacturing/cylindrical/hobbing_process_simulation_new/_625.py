...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _616, _620
...
class HobbingProcessProfileCalculation(_620.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
