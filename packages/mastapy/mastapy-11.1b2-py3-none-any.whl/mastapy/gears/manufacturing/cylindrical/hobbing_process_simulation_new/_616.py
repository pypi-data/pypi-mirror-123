...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _632
...
class CalculateProfileDeviationAccuracy(_0.APIBase):
    ...
    @property
    def manufactured_iso132811995e_quality_grades(self) -> 'List[_632.ManufacturedQualityGrade]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturedISO132811995EQualityGrades, constructor.new(_632.ManufacturedQualityGrade))
        return value

    @property
    def manufactured_ansiagma20151a01_quality_grades(self) -> 'List[_632.ManufacturedQualityGrade]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturedANSIAGMA20151A01QualityGrades, constructor.new(_632.ManufacturedQualityGrade))
        return value
