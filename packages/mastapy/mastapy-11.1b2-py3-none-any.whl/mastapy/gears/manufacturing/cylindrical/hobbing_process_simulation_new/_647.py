...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _614, _648
...
class WormGrindingLeadCalculation(_648.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
    ...
    @property
    def right_flank(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_614.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
