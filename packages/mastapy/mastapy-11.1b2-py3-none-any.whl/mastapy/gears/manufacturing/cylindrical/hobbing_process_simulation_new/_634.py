...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _639, _626, _653
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_639.ProcessSimulationInput':
        ...
        if _639.ProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_626.HobbingProcessSimulationInput':
        ...
        if _626.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_653.WormGrindingProcessSimulationInput':
        ...
        if _653.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
