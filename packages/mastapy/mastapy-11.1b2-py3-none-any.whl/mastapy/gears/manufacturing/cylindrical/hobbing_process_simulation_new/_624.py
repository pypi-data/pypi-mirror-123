...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _615, _620
...
class HobbingProcessPitchCalculation(_620.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
