...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _645, _639
...
class WormGrindingProcessSimulationInput(_639.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_645.WormGrinderManufactureError':
        ...
        return constructor.new(_645.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError else None
