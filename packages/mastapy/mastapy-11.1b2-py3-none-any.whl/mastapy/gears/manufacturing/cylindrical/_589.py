...
from mastapy.gears.manufacturing.cylindrical import _587, _591
...
class MicroGeometryInputsProfile(_587.MicroGeometryInputs['_591.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self) -> '_1271.Range':
        ...
        if _1271.Range.TYPE not in self.wrapped.ProfileMicroGeometryRange.__class__.__mro__:
