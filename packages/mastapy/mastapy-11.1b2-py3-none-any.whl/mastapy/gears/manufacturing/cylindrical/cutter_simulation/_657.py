...
class CutterSimulationCalc(_0.APIBase):
    ...
    def gear(self) -> '_658.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_658.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear else None
    ...
    def stock_removed_at_reference_diameter(self) -> '_663.FinishStockPoint':
        ...
        return constructor.new(_663.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter else None
    ...
    def stock_removed_at_designed_sap(self) -> '_663.FinishStockPoint':
        ...
        return constructor.new(_663.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP else None
    ...
    def stock_removed_at_rough_tip_form(self) -> '_663.FinishStockPoint':
        ...
        return constructor.new(_663.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm else None
