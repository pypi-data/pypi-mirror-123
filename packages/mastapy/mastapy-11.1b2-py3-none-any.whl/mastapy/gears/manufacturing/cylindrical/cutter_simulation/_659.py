...
class CylindricalGearSpecification(_0.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_1024.ToothThicknessSpecificationBase':
        ...
        if _1024.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_984.FinishToothThicknessDesignSpecification':
        ...
        if _984.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_readonly_tooth_thickness_specification(self) -> '_1005.ReadonlyToothThicknessSpecification':
        ...
        if _1005.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_1023.ToothThicknessSpecification':
        ...
        if _1023.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
