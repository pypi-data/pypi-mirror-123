...
class PinionRoughMachineSetting(_0.APIBase):
    ...
    @property
    def pinion_config(self) -> '_742.ConicalPinionManufacturingConfig':
        ...
        return constructor.new(_742.ConicalPinionManufacturingConfig)(self.wrapped.PinionConfig) if self.wrapped.PinionConfig else None

    @property
    def gear_set(self) -> '_1087.ConicalGearSetDesign':
