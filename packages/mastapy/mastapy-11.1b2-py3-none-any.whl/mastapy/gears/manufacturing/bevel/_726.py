...
class AbstractTCA(_0.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_1091.ConicalMeshMisalignments':
        ...
        return constructor.new(_1091.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
