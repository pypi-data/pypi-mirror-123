...
from mastapy.gears.manufacturing.bevel import _726
...
class BevelMachineSettingOptimizationResult(_0.APIBase):
    ...
    @property
    def calculated_deviations_convex(self) -> '_726.ConicalFlankDeviationsData':
        ...
        return constructor.new(_726.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConvex) if self.wrapped.CalculatedDeviationsConvex else None

    @property
    def imported_deviations_convex(self) -> '_726.ConicalFlankDeviationsData':
        ...
        return constructor.new(_726.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConvex) if self.wrapped.ImportedDeviationsConvex else None

    @property
    def calculated_deviations_concave(self) -> '_726.ConicalFlankDeviationsData':
        ...
        return constructor.new(_726.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConcave) if self.wrapped.CalculatedDeviationsConcave else None

    @property
    def imported_deviations_concave(self) -> '_726.ConicalFlankDeviationsData':
        ...
        return constructor.new(_726.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConcave) if self.wrapped.ImportedDeviationsConcave else None
