...
class PinionConvex(_0.APIBase):
    ...
    @property
    def pinion_convex_ib_configuration(self) -> '_777.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_777.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration else None
