...
from mastapy.gears.manufacturing.bevel import _749, _733
...
class ConicalMeshManufacturingAnalysis(_1151.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_749.EaseOffBasedTCA':
        ...
        return constructor.new(_749.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_733.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_733.ConicalMeshedGearManufacturingAnalysis))
        return value
