...
from mastapy.gears.gear_designs.conical import _1089
...
class AbstractTCA(_0.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_1089.ConicalMeshMisalignments':
        ...
        return constructor.new(_1089.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
