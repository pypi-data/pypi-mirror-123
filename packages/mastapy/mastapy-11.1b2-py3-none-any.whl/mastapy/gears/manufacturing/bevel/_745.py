...
from mastapy.gears.gear_designs.conical import _1089, _1088
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _730, _739, _747
...
class ConicalSetManufacturingConfig(_747.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_730.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_730.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_739.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_739.ConicalMeshManufacturingConfig))
        return value
