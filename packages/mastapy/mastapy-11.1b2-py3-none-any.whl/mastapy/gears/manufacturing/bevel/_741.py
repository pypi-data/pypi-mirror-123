...
class ConicalMeshMicroGeometryConfigBase(_1153.GearMeshImplementationDetail):
    '''ConicalMeshMicroGeometryConfigBase
    ...
    @property
    def wheel_config(self) -> '_732.ConicalGearMicroGeometryConfigBase':
        ...
        if _732.ConicalGearMicroGeometryConfigBase.TYPE not in self.wrapped.WheelConfig.__class__.__mro__:
    ...
    @property
    def wheel_config_of_type_conical_gear_manufacturing_config(self) -> '_730.ConicalGearManufacturingConfig':
        ...
        if _730.ConicalGearManufacturingConfig.TYPE not in self.wrapped.WheelConfig.__class__.__mro__:
    ...
    @property
    def wheel_config_of_type_conical_gear_micro_geometry_config(self) -> '_731.ConicalGearMicroGeometryConfig':
        ...
        if _731.ConicalGearMicroGeometryConfig.TYPE not in self.wrapped.WheelConfig.__class__.__mro__:
    ...
    @property
    def wheel_config_of_type_conical_pinion_manufacturing_config(self) -> '_742.ConicalPinionManufacturingConfig':
        ...
        if _742.ConicalPinionManufacturingConfig.TYPE not in self.wrapped.WheelConfig.__class__.__mro__:
    ...
    @property
    def wheel_config_of_type_conical_pinion_micro_geometry_config(self) -> '_743.ConicalPinionMicroGeometryConfig':
        ...
        if _743.ConicalPinionMicroGeometryConfig.TYPE not in self.wrapped.WheelConfig.__class__.__mro__:
    ...
    @property
    def wheel_config_of_type_conical_wheel_manufacturing_config(self) -> '_748.ConicalWheelManufacturingConfig':
        ...
        if _748.ConicalWheelManufacturingConfig.TYPE not in self.wrapped.WheelConfig.__class__.__mro__:
    ...
    @property
    def mesh(self) -> '_1086.ConicalGearMeshDesign':
        ...
        if _1086.ConicalGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_zerol_bevel_gear_mesh_design(self) -> '_893.ZerolBevelGearMeshDesign':
        ...
        if _893.ZerolBevelGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_straight_bevel_diff_gear_mesh_design(self) -> '_902.StraightBevelDiffGearMeshDesign':
        ...
        if _902.StraightBevelDiffGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_straight_bevel_gear_mesh_design(self) -> '_906.StraightBevelGearMeshDesign':
        ...
        if _906.StraightBevelGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_spiral_bevel_gear_mesh_design(self) -> '_910.SpiralBevelGearMeshDesign':
        ...
        if _910.SpiralBevelGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_design(self) -> '_914.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign':
        ...
        if _914.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh_design(self) -> '_918.KlingelnbergCycloPalloidHypoidGearMeshDesign':
        ...
        if _918.KlingelnbergCycloPalloidHypoidGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_klingelnberg_conical_gear_mesh_design(self) -> '_922.KlingelnbergConicalGearMeshDesign':
        ...
        if _922.KlingelnbergConicalGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_hypoid_gear_mesh_design(self) -> '_926.HypoidGearMeshDesign':
        ...
        if _926.HypoidGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
            raise CastException('Failed to cast mesh to HypoidGearMeshDesign. Expected: {}.'.format(self.wrapped.Mesh.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Mesh.__class__)(self.wrapped.Mesh) if self.wrapped.Mesh else None

    @property
    def mesh_of_type_bevel_gear_mesh_design(self) -> '_1112.BevelGearMeshDesign':
        ...
        if _1112.BevelGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
            raise CastException('Failed to cast mesh to BevelGearMeshDesign. Expected: {}.'.format(self.wrapped.Mesh.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Mesh.__class__)(self.wrapped.Mesh) if self.wrapped.Mesh else None

    @property
    def mesh_of_type_agma_gleason_conical_gear_mesh_design(self) -> '_1125.AGMAGleasonConicalGearMeshDesign':
        ...
        if _1125.AGMAGleasonConicalGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
