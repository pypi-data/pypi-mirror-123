...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _777
...
class PinionConcave(_0.APIBase):
    ...
    @property
    def pinion_concave_ob_configuration(self) -> '_777.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_777.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration else None
