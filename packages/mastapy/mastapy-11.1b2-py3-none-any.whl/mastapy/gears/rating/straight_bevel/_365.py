...
class StraightBevelGearRating(_509.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_905.StraightBevelGearDesign':
        ...
        return constructor.new(_905.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
