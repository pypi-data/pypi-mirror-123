...
from mastapy.gears.rating.conical import _495, _494
...
class ConicalGearDutyCycleRating(_323.GearDutyCycleRating):
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_495.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_495.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_495.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_495.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle else None
    ...
    @property
    def gear_ratings(self) -> 'List[_494.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_494.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_494.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_494.ConicalGearRating))
        return value
