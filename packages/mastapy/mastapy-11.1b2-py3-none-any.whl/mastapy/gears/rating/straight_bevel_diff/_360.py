...
from mastapy.gears.rating.straight_bevel_diff import _363, _361
...
class StraightBevelDiffGearMeshRating(_493.ConicalGearMeshRating):
    '''StraightBevelDiffGearMeshRating
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_902.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_902.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh else None

    @property
    def meshed_gears(self) -> 'List[_363.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_363.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def gears_in_mesh(self) -> 'List[_363.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_363.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def straight_bevel_diff_gear_ratings(self) -> 'List[_361.StraightBevelDiffGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearRatings, constructor.new(_361.StraightBevelDiffGearRating))
        return value
