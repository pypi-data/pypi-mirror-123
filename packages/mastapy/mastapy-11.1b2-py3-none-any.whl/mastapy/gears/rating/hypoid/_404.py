...
class HypoidGearRating(_520.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_925.HypoidGearDesign':
        ...
        return constructor.new(_925.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear else None
