...
class ZerolBevelGearMeshRating(_508.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_893.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_893.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
