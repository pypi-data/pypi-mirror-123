...
class SpiralBevelGearMeshRating(_508.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_910.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_910.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
