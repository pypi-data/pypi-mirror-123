...
class SpiralBevelGearRating(_509.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_909.SpiralBevelGearDesign':
        ...
        return constructor.new(_909.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
