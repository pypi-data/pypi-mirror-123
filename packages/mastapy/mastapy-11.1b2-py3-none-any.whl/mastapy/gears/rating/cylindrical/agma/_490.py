...
from mastapy.gears.gear_designs.cylindrical import _966, _1010
from mastapy.materials import _225
from mastapy.gears.rating.cylindrical.agma import _489
...
class AGMA2101MeshSingleFlankRating(_430.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_1010.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_1010.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_489.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_489.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_489.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_489.AGMA2101GearSingleFlankRating))
        return value
