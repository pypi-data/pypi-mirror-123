...
from mastapy.gears.rating.cylindrical import _418, _419, _448
...
class CylindricalGearRating(_326.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_448.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_448.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None
