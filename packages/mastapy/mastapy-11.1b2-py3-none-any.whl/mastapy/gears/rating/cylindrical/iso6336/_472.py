...
from mastapy.gears.rating.cylindrical.iso6336 import _468, _478
...
class ISO63362006GearSingleFlankRating(_478.ISO6336AbstractMetalGearSingleFlankRating):
    '''ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_468.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_468.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults else None
