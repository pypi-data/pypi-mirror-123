...
class ISO6336AbstractMetalMeshSingleFlankRating(_477.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_rating_method_flash_temperature_method(self) -> '_441.ScuffingFlashTemperatureRatingMethod':
        ...
        return constructor.new(_441.ScuffingFlashTemperatureRatingMethod)(value) if value else None

    @property
    def scuffing_rating_method_integral_temperature_method(self) -> '_442.ScuffingIntegralTemperatureRatingMethod':
        ...
        return constructor.new(_442.ScuffingIntegralTemperatureRatingMethod)(value) if value else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_1011.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_1011.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_421.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_421.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_473.ISO63362006MeshSingleFlankRating':
        ...
        if _473.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.SingleFlankRatingOfTestGearsForMicropitting.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_478.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_478.ISO6336AbstractMetalGearSingleFlankRating))
        return value
