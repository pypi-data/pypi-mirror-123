...
from mastapy.gears.rating.cylindrical import _439, _430
from mastapy.gears.rating.cylindrical.iso6336 import _476
...
class ISO6336AbstractMeshSingleFlankRating(_430.CylindricalMeshSingleFlankRating):
    '''ISO6336AbstractMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_476.ISO6336AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_476.ISO6336AbstractGearSingleFlankRating))
        return value

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_476.ISO6336AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_476.ISO6336AbstractGearSingleFlankRating))
        return value
