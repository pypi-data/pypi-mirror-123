...
from mastapy.gears.gear_designs.concept import _1108
...
class ConceptGearMeshRating(_325.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_1108.ConceptGearMeshDesign':
        ...
        return constructor.new(_1108.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
