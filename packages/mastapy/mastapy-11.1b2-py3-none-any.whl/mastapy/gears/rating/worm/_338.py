...
class WormGearMeshRating(_325.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_898.WormGearMeshDesign':
        ...
        return constructor.new(_898.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
