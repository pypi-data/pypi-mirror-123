...
from mastapy.gears.fe_model import _1129, _1128
...
class GearSetFEModel(_1159.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1129.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1129.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1128.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1128.GearFEModel))
        return value
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7248.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
