...
from mastapy.gears.gear_set_pareto_optimiser import _849, _860
...
class MicroGeometryDesignSpaceSearch(_849.DesignSpaceSearchBase['_803.CylindricalGearSetLoadDistributionAnalysis', '_860.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_803.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _803.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.LoadCaseDutyCycle.__class__.__mro__:
    ...
    @property
    def selected_candidate_micro_geometry(self) -> '_1041.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1041.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_1041.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_1041.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_1041.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_1041.CylindricalGearSetMicroGeometry))
        return value
