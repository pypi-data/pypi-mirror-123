...
from mastapy.gears.gear_set_pareto_optimiser import _850
...
class MicroGeometryDesignSpaceSearchCandidate(_850.DesignSpaceSearchCandidateBase['_803.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate(self) -> '_803.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _803.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_for_slider(self) -> '_1041.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1041.CylindricalGearSetMicroGeometry)(self.wrapped.CandidateForSlider) if self.wrapped.CandidateForSlider else None
