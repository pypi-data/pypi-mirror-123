...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    def remove_candidates_with(self) -> '_858.LargerOrSmaller':
        ...
        return constructor.new(_858.LargerOrSmaller)(value) if value else None
    ...
    def selected_design_space_search_strategy(self) -> '_1332.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1332.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None
