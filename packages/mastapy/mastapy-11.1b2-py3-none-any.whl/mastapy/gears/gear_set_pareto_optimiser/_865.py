...
from mastapy.math_utility.optimisation import _1323
...
class OptimisationTarget(_0.APIBase, Generic[T]):
    ...
    @property
    def input_setters(self) -> 'List[_1323.InputSetter[T]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1323.InputSetter)[T])
        return value
