...
from krmining.datasets import make_fruit_sold_dummy

class TestEvaluate(unittest.TestCase):
    def setUp(self):
        self.df = make_fruit_sold_dummy()
        
        self.max_length = 2
        self.desire_confidence = [1.0, 1.0, 1.0, 1.0, 0.6666666666666666, 1.0, 0.6666666666666666, 
                                  0.6666666666666666, 1.0, 0.6666666666666666, 0.6666666666666666, 1.0,
                                  0.6666666666666666, 0.6666666666666666, 1.0, 0.6666666666666666, 1.0, 
