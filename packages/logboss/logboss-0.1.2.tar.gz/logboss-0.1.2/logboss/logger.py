...
class Logger(metaclass=_Singleton):
    ...
    def log(self, msg: Any, log_tag: LogTagBase = None, num_prev_callers: int = 0):
        ...
        Args:
            msg: Log message.
            log_tag: A LogTagType to tag to the log message.
            num_prev_callers: Number of previous calls in the call stack that identifies the
                originator of the log message. This should rarely, if ever, be set, but is
                configurable should a a previous caller be tied to the log message.
        """
    ...
    def log_exception(self, log_tag: LogTagBase = None):
        ...
        Args:
           log_tag: A LogTagType object that suits an exception. If not given
        """
        if self._disabled:
            return
    ...
    def set_mode(self, mode: str, log_tag: LogTagBase = None, why: str = ''):
        ...
        Args:
            ...
            log_tag: The log tag that logs why. Defaults to the default INFO log tag.
