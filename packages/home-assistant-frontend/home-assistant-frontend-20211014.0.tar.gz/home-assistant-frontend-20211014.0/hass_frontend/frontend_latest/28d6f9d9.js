/*! For license information please see 28d6f9d9.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[37370],{39841:(e,t,i)=>{"use strict";i(94604),i(65660);var o=i(9672),r=i(87156),s=i(50856),a=i(44181);(0,o.k)({_template:s.d`
    <style>
      :host {
        display: block;
        /**
...
`}static get properties(){return{hass:Object,nodes:Array,selectedNode:{type:Number,value:-1},protectionNode:{type:Boolean,value:!1},_protectionValueID:{type:Number,value:-1},_selectedProtectionParameter:{type:Number,value:-1,observer:"_computeProtectionData"},_protectionOptions:Array,_protection:{type:Array,value:()=>[]},_loadedProtectionValue:{type:String,value:""},_protectionData:{type:Object,value:{}},_nodePath:String}}static get observers(){return["_nodesChanged(nodes, selectedNode)"]}ready(){super.ready(),this.addEventListener("hass-api-called",(e=>this.apiCalled(e)))}apiCalled(e){e.detail.success&&setTimeout((()=>{this._refreshProtection(this.selectedNode)}),5e3)}_nodesChanged(){if(this.nodes&&this.protection){if(0===this.protection.length)return;let e=[],t=-1,i=-1;this.protection.forEach((o=>{"options"===o.key?e=o.value:"value_id"===o.key?t=o.value:"selected"===o.key&&(i=o.value)})),this.setProperties({protectionNode:!0,_protectionOptions:e,_loadedProtectionValue:i,_protectionValueID:t})}}async _refreshProtection(e){const t=[],i=await this.hass.callApi("GET",`zwave/protection/${this.nodes[e].attributes.node_id}`);Object.keys(i).forEach((e=>{t.push({key:e,value:i[e]})})),this.setProperties({_protection:t,_selectedProtectionParameter:-1,_loadedProtectionValue:this.protection[1].value})}_computeProtectionData(e){-1!==this.selectedNode&&-1!==e&&(this._protectionData={selection:this._protectionOptions[e],value_id:this._protectionValueID},this._nodePath=`zwave/protection/${this.nodes[this.selectedNode].attributes.node_id}`)}}customElements.define("zwave-node-protection",B);class F extends r.H3{static get template(){return o.d`
    ...
    `}},{kind:"get",static:!0,key:"styles",value:function(){return[_.Qx,f.iv`
      ...
      `]}},{kind:"method",key:"_computeCaption",value:function(e){let t=`${e.value.label}`;return t+=` (${this.hass.localize("ui.panel.config.zwave.common.instance")}:`,t+=` ${e.value.instance},`,t+=` ${this.hass.localize("ui.panel.config.zwave.common.index")}:`,t+=` ${e.value.index})`,t}}]}}),f.oi);class Y extends((0,c.Z)((0,l.I)(r.H3))){static get template(){return o.d`
