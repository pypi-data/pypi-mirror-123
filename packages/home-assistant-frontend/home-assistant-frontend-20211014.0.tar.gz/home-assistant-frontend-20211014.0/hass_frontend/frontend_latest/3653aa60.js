/*! For license information please see 3653aa60.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[1895,84281],{85753:(i,e,a)=>{"use strict";a.d(e,{I:()=>n,E:()=>r});a(94604);var t=a(78161);const n={hostAttributes:{role:"menubar"},keyBindings:{left:"_onLeftKey",right:"_onRightKey"},_onUpKey:function(i){this.focusedItem.click(),i.detail.keyboardEvent.preventDefault()},_onDownKey:function(i){this.focusedItem.click(),i.detail.keyboardEvent.preventDefault()},get _isRTL(){return"rtl"===window.getComputedStyle(this).direction},_onLeftKey:function(i){this._isRTL?this._focusNext():this._focusPrevious(),i.detail.keyboardEvent.preventDefault()},_onRightKey:function(i){this._isRTL?this._focusPrevious():this._focusNext(),i.detail.keyboardEvent.preventDefault()},_onKeydown:function(i){this.keyboardEventMatchesKeys(i,"up down left right esc")||this._focusWithKeyboardEvent(i)}},r=[t.i,n]},50611:(i,e,a)=>{"use strict";a.d(e,{K:()=>u});a(94604);var t=a(21006),n=a(98235);const r={properties:{checked:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0,observer:"_checkedChanged"},toggles:{type:Boolean,value:!0,reflectToAttribute:!0},value:{type:String,value:"on",observer:"_valueChanged"}},observers:["_requiredChanged(required)"],created:function(){this._hasIronCheckedElementBehavior=!0},_getValidity:function(i){return this.disabled||!this.required||this.checked},_requiredChanged:function(){this.required?this.setAttribute("aria-required","true"):this.removeAttribute("aria-required")},_checkedChanged:function(){this.active=this.checked,this.fire("iron-change")},_valueChanged:function(){void 0!==this.value&&null!==this.value||(this.value="on")}},o=[t.V,n.x,r];var s=a(49075),c=a(84938);const h={_checkedChanged:function(){r._checkedChanged.call(this),this.hasRipple()&&(this.checked?this._ripple.setAttribute("checked",""):this._ripple.removeAttribute("checked"))},_buttonStateChanged:function(){c.o._buttonStateChanged.call(this),this.disabled||this.isAttached&&(this.checked=this.active)}},u=[s.B,o,h]},49075:(i,e,a)=>{"use strict";a.d(e,{S:()=>o,B:()=>s});a(94604);var t=a(51644),n=a(26110),r=a(84938);const o={observers:["_focusedChanged(receivedFocusFromKeyboard)"],_focusedChanged:function(i){i&&this.ensureRipple(),this.hasRipple()&&(this._ripple.holdDown=i)},_createRipple:function(){var i=r.o._createRipple();return i.id="ink",i.setAttribute("center",""),i.classList.add("circle"),i}},s=[t.P,n.a,r.o,o]},84938:(i,e,a)=>{"use strict";a.d(e,{o:()=>r});a(94604),a(60748);var t=a(51644),n=a(87156);const r={properties:{noink:{type:Boolean,observer:"_noinkChanged"},_rippleContainer:{type:Object}},_buttonStateChanged:function(){this.focused&&this.ensureRipple()},_downHandler:function(i){t.$._downHandler.call(this,i),this.pressed&&this.ensureRipple(i)},ensureRipple:function(i){if(!this.hasRipple()){this._ripple=this._createRipple(),this._ripple.noink=this.noink;var e=this._rippleContainer||this.root;if(e&&(0,n.vz)(e).appendChild(this._ripple),i){var a=(0,n.vz)(this._rippleContainer||this),t=(0,n.vz)(i).rootTarget;a.deepContains(t)&&this._ripple.uiDownAction(i)}}},getRipple:function(){return this.ensureRipple(),this._ripple},hasRipple:function(){return Boolean(this._ripple)},_createRipple:function(){return document.createElement("paper-ripple")},_noinkChanged:function(i){this.hasRipple()&&(this._ripple.noink=i)}}},27662:(i,e,a)=>{"use strict";a(94604),a(65660);var t=a(50611),n=a(9672),r=a(50856),o=a(87529);const s=r.d`
<style>
  :host {
