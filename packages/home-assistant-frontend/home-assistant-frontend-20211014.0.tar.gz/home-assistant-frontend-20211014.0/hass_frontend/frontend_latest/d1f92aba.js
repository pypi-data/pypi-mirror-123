      ...
      <div class="card-config">
        ...
        <div class="side-by-side">
          ...
          <ha-icon-input
            ...
            .value=${this._icon}
            .placeholder=${this._icon||(0,c.M)(this.hass.states[this._entity])}
            .configValue=${"icon"}
            @value-changed=${this._valueChanged}
          ></ha-icon-input>
        </div>
