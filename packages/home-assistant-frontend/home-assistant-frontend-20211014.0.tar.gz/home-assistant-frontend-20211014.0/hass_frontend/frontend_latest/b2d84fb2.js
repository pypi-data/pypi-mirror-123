/*! For license information please see b2d84fb2.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[89822,13103,40492],{14166:(t,e,i)=>{i.d(e,{W:()=>n});var s=function(){return s=Object.assign||function(t){for(var e,i=1,s=arguments.length;i<s;i++)for(var n in e=arguments[i])Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t},s.apply(this,arguments)};function n(t,e,i){void 0===e&&(e=Date.now()),void 0===i&&(i={});var n=s(s({},r),i||{}),o=(+t-+e)/1e3;if(Math.abs(o)<n.second)return{value:Math.round(o),unit:"second"};var a=o/60;if(Math.abs(a)<n.minute)return{value:Math.round(a),unit:"minute"};var h=o/3600;if(Math.abs(h)<n.hour)return{value:Math.round(h),unit:"hour"};var l=o/86400;if(Math.abs(l)<n.day)return{value:Math.round(l),unit:"day"};var d=new Date(t),u=new Date(e),c=d.getFullYear()-u.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var p=12*c+d.getMonth()-u.getMonth();if(Math.round(Math.abs(p))>0)return{value:Math.round(p),unit:"month"};var v=o/604800;return{value:Math.round(v),unit:"week"}}var r={second:45,minute:45,hour:22,day:5}},18601:(t,e,i)=>{i.d(e,{qN:()=>a.q,Wg:()=>l});var s,n,r=i(87480),o=i(5701),a=i(78220);const h=null!==(n=null===(s=window.ShadyDOM)||void 0===s?void 0:s.inUse)&&void 0!==n&&n;class l extends a.H{constructor(){super(...arguments),this.disabled=!1,this.containingForm=null,this.formDataListener=t=>{this.disabled||this.setFormData(t.formData)}}findFormElement(){if(!this.shadowRoot||h)return null;const t=this.getRootNode().querySelectorAll("form");for(const e of Array.from(t))if(e.contains(this))return e;return null}connectedCallback(){var t;super.connectedCallback(),this.containingForm=this.findFormElement(),null===(t=this.containingForm)||void 0===t||t.addEventListener("formdata",this.formDataListener)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this.containingForm)||void 0===t||t.removeEventListener("formdata",this.formDataListener),this.containingForm=null}click(){this.formElement&&!this.disabled&&(this.formElement.focus(),this.formElement.click())}firstUpdated(){super.firstUpdated(),this.shadowRoot&&this.mdcRoot.addEventListener("change",(t=>{this.dispatchEvent(new Event("change",t))}))}}l.shadowRootOptions={mode:"open",delegatesFocus:!0},(0,r.__decorate)([(0,o.C)({type:Boolean})],l.prototype,"disabled",void 0)},39841:(t,e,i)=>{i(94604),i(65660);var s=i(9672),n=i(87156),r=i(50856),o=i(44181);(0,s.k)({_template:r.d`
    <style>
      :host {
        display: block;
        /**
