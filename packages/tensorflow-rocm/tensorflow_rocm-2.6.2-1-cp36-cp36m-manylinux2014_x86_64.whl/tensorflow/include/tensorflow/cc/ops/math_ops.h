...
class BatchGemm {
 public:
  /// Optional attribute setters for BatchGemm
  struct Attrs {
    /// Defaults to false
  ...
  BatchGemm(const ::tensorflow::Scope& scope, ::tensorflow::Input a,
          ::tensorflow::Input b, ::tensorflow::Input c);
  BatchGemm(const ::tensorflow::Scope& scope, ::tensorflow::Input a,
          ::tensorflow::Input b, ::tensorflow::Input c, const BatchGemm::Attrs&
          attrs);
  operator ::tensorflow::Output() const { return output; }
  operator ::tensorflow::Input() const { return output; }
  ::tensorflow::Node* node() const { return output.node(); }
