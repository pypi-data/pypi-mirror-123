...
region_table.find_in_map("regionName", "us-east-2")
```
...
import aws_cdk.lambda_layer_awscli
import aws_cdk.lambda_layer_kubectl
import aws_cdk.lambda_layer_node_proxy_agent
