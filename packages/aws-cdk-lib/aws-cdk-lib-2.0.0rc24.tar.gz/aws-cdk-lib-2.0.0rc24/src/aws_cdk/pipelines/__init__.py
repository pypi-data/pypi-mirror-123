...
from aws_cdk_lib.pipelines import CodePipeline, CodePipelineSource, ShellStep
...
class AdditionalArtifact:
    ...
    @builtins.property
    def artifact(self) -> _Artifact_0cb05964:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.BaseStageOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class BaseStageOptions:
    def __init__(
        ...
        *,
        ...
        security_notification_topic: typing.Optional[_ITopic_9eca4852] = None,
    ) -> None:
        '''(experimental) Base options for a pipelines stage.

        :param confirm_broadening_permissions: (experimental) Runs a ``cdk diff --security-only --fail`` to pause the pipeline if there are any security changes. If the stage is configured with ``confirmBroadeningPermissions`` enabled, you can use this property to override the stage configuration. For example, Pipeline Stage "Prod" has confirmBroadeningPermissions enabled, with applications "A", "B", "C". All three applications will run a security check, but if we want to disable the one for "C", we run ``stage.addApplication(C, { confirmBroadeningPermissions: false })`` to override the pipeline stage behavior. Adds 1 to the run order space. Default: false
        :param security_notification_topic: (experimental) Optional SNS topic to send notifications to when the security check registers changes within the application. Default: undefined no notification topic for security check manual approval action
    ...
    @builtins.property
    def security_notification_topic(self) -> typing.Optional[_ITopic_9eca4852]:
...
class CdkPipeline(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        cloud_assembly_artifact: _Artifact_0cb05964,
        asset_build_spec: typing.Optional[_BuildSpec_4961ea5b] = None,
        ...
        :param asset_build_spec: (experimental) Custom BuildSpec that is merged with generated one (for asset publishing actions). Default: - none
        ...
        :param enable_key_rotation: (experimental) Enables KMS key rotation for cross-account keys. Cannot be set if ``crossAccountKeys`` was set to ``false``. Key rotation costs $1/month when enabled. Default: - false (key rotation is disabled)
        ...
        :param self_mutation_build_spec: (experimental) Custom BuildSpec that is merged with generated one (for self-mutation stage). Default: - none
    ...
    def stack_output(self, cfn_output: _CfnOutput_7273f911) -> "StackOutput":
    ...
    def stage(self, stage_name: builtins.str) -> _IStage_415fc571:
        ...
        :stability: experimental
        '''
        return typing.cast(_IStage_415fc571, jsii.invoke(self, "stage", [stage_name]))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="codePipeline")
    def code_pipeline(self) -> _Pipeline_ea38de84:
        ...
        :stability: experimental
        '''
        return typing.cast(_Pipeline_ea38de84, jsii.get(self, "codePipeline"))
...
class CdkPipelineProps:
    ...
    @builtins.property
    def cloud_assembly_artifact(self) -> _Artifact_0cb05964:
    ...
    @builtins.property
    def asset_build_spec(self) -> typing.Optional[_BuildSpec_4961ea5b]:
    ...
    def enable_key_rotation(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Enables KMS key rotation for cross-account keys.
    ...
    @builtins.property
    def self_mutation_build_spec(self) -> typing.Optional[_BuildSpec_4961ea5b]:
    ...
    @builtins.property
    def source_action(self) -> typing.Optional[_IAction_0ecf4cc4]:
        ...
        return typing.cast(typing.Optional[_IAction_0ecf4cc4], result)
    ...
    @builtins.property
    def synth_action(self) -> typing.Optional[_IAction_0ecf4cc4]:
...
class CdkStage(
    ...
    def __init__(
        ...
        *,
        cloud_assembly_artifact: _Artifact_0cb05964,
        host: "IStageHost",
        pipeline_stage: _IStage_415fc571,
        stage_name: builtins.str,
        confirm_broadening_permissions: typing.Optional[builtins.bool] = None,
        security_notification_topic: typing.Optional[_ITopic_9eca4852] = None,
    ) -> None:
        ...
        :param confirm_broadening_permissions: (experimental) Run a security check before every application prepare/deploy actions. Note: Stage level security check can be overriden per application as follows: ``stage.addApplication(app, { confirmBroadeningPermissions: false })`` Default: false
        :param security_notification_topic: (experimental) Optional SNS topic to send notifications to when any security check registers changes within a application. Note: The Stage Notification Topic can be overriden per application as follows: ``stage.addApplication(app, { securityNotificationTopic: newTopic })`` Default: undefined no stage level notification topic
    ...
    def add_actions(self, *actions: _IAction_0ecf4cc4) -> None:
...
class CdkStageProps:
    ...
    @builtins.property
    def pipeline_stage(self) -> _IStage_415fc571:
        ...
        return typing.cast(_IStage_415fc571, result)
...
@jsii.implements(_IAction_0ecf4cc4)
class DeployCdkStackAction(
    ...
    def __init__(
        self,
        *,
        action_role: _IRole_235f5d8e,
        stack_name: builtins.str,
        template_path: builtins.str,
        cloud_formation_execution_role: typing.Optional[_IRole_235f5d8e] = None,
        ...
        cloud_assembly_input: _Artifact_0cb05964,
    ...
    def from_stack_artifact(
        cls,
        scope: constructs.Construct,
        artifact: _CloudFormationStackArtifact_97533dc8,
        *,
    ...
    def bind(
        ...
        *,
        ...
        return typing.cast(_ActionConfig_846fc217, jsii.invoke(self, "bind", [scope, stage, options]))
    ...
    def action_properties(self) -> _ActionProperties_026c42e3:
        '''(experimental) Exists to implement IAction.

        :stability: experimental
        '''
        return typing.cast(_ActionProperties_026c42e3, jsii.get(self, "actionProperties"))
...
class DeployCdkStackActionOptions:
    ...
    @builtins.property
    def cloud_assembly_input(self) -> _Artifact_0cb05964:
...
class DeployCdkStackActionProps(DeployCdkStackActionOptions):
    ...
    @builtins.property
    def action_role(self) -> _IRole_235f5d8e:
    ...
    @builtins.property
    def cloud_formation_execution_role(self) -> typing.Optional[_IRole_235f5d8e]:
...
class IStageHost(typing_extensions.Protocol):
    ...
    ) -> typing.Optional[_Artifact_0cb05964]:
...
class _IStageHostProxy:
    ...
    def stack_output_artifact(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_Artifact_0cb05964], jsii.invoke(self, "stackOutputArtifact", [stack_artifact_id]))
...
class PublishAssetsAction(
    ...
    def __init__(
        ...
        *,
        ...
        asset_type: AssetType,
        cloud_assembly_input: _Artifact_0cb05964,
        build_spec: typing.Optional[_BuildSpec_4961ea5b] = None,
        cdk_cli_version: typing.Optional[builtins.str] = None,
        create_buildspec_file: typing.Optional[builtins.bool] = None,
        dependable: typing.Optional[constructs.IDependable] = None,
        ...
        :param cloud_assembly_input: (experimental) The CodePipeline artifact that holds the Cloud Assembly.
        :param build_spec: (experimental) Custom BuildSpec that is merged with generated one. Default: - none
        ...
        :param dependable: (experimental) Any Dependable construct that the CodeBuild project needs to take a dependency on. Default: - none
...
class PublishAssetsActionProps:
    ...
    @builtins.property
    def build_spec(self) -> typing.Optional[_BuildSpec_4961ea5b]:
    ...
    @builtins.property
    def dependable(self) -> typing.Optional[constructs.IDependable]:
...
@jsii.implements(_IAction_0ecf4cc4, _IGrantable_71c4f5de)
class ShellScriptAction(
    ...
    def __init__(
        ...
        *,
        ...
        additional_artifacts: typing.Optional[typing.Sequence[_Artifact_0cb05964]] = None,
        bash_options: typing.Optional[builtins.str] = None,
        environment: typing.Optional[_BuildEnvironment_4ee6fb51] = None,
...
class ShellScriptActionProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(environment, dict):
            environment = _BuildEnvironment_4ee6fb51(**environment)
        if isinstance(subnet_selection, dict):
            subnet_selection = _SubnetSelection_e57d76df(**subnet_selection)
        self._values: typing.Dict[str, typing.Any] = {
            "action_name": action_name,
    ...
    @builtins.property
    def additional_artifacts(self) -> typing.Optional[typing.List[_Artifact_0cb05964]]:
    ...
    @builtins.property
    def environment(self) -> typing.Optional[_BuildEnvironment_4ee6fb51]:
...
class SimpleSynthAction(
    ...
    def __init__(
        ...
        *,
        ...
        cloud_assembly_artifact: _Artifact_0cb05964,
        source_artifact: _Artifact_0cb05964,
        action_name: typing.Optional[builtins.str] = None,
        ...
        :param build_spec: (experimental) custom BuildSpec that is merged with the generated one. Default: - none
...
class SimpleSynthOptions:
    ...
    @builtins.property
    def source_artifact(self) -> _Artifact_0cb05964:
...
class StackOutput(
    ...
    def __init__(
        self,
        artifact_file: _ArtifactPath_bf444090,
    ...
    def artifact_file(self) -> _ArtifactPath_bf444090:
        '''(experimental) The artifact and file the output is stored in.

        :stability: experimental
        '''
        return typing.cast(_ArtifactPath_bf444090, jsii.get(self, "artifactFile"))
...
class UpdatePipelineAction(
    ...
    def __init__(
        ...
        *,
        ...
        :param build_spec: (experimental) Custom BuildSpec that is merged with generated one. Default: - none
        :param cdk_cli_version: (experimental) Version of CDK CLI to 'npm install'. Default: - Latest version
        :param docker_credentials: (experimental) Docker registries and associated credentials necessary during the pipeline self-update stage. Default: []
