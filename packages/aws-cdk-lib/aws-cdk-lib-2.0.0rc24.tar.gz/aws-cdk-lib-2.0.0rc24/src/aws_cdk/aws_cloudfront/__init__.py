...
class CfnFunction(
    ...
    def __init__(
        ...
        *,
        ...
        function_metadata: typing.Optional[typing.Union["CfnFunction.FunctionMetadataProperty", _IResolvable_da3f097b]] = None,
    ) -> None:
    ...
    def function_metadata(
        self,
    ) -> typing.Optional[typing.Union["CfnFunction.FunctionMetadataProperty", _IResolvable_da3f097b]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnFunction.FunctionMetadataProperty", _IResolvable_da3f097b]], jsii.get(self, "functionMetadata"))

    @function_metadata.setter
    def function_metadata(
        self,
        value: typing.Optional[typing.Union["CfnFunction.FunctionMetadataProperty", _IResolvable_da3f097b]],
    ) -> None:
...
class CfnFunctionProps:
    ...
    def function_metadata(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnFunction.FunctionMetadataProperty, _IResolvable_da3f097b]], result)
