...
{'': ['*'],
 ...
 'lcdoc.mkdocs.lp': ['assets/*',
                     ...
                     'assets/plantuml/*',
                     'plugs/about/*'],
 'lcdoc.mkdocs.lp.plugs.chart': ['docs/img/*', 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.chartist': ['docs/img/*', 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.column': ['docs/img/*', 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.drawio': ['docs/example.drawio',
                                  'docs/example.drawio',
                                  'docs/img/*',
                                  'docs/index.md',
                                  'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.flowchart': ['docs/img/*', 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.kroki': ['docs/excali.json',
                                 'docs/excali.json',
                                 'docs/img/*',
                                 'docs/index.md',
                                 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.lightbox': ['docs/img/*', 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.make_badges': ['docs/img/gl_badges.png',
                                       'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.make_file': ['docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.markmap': ['docs/img/*', 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.mermaid': ['docs/img/*', 'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.call_flow_logging': ['docs/img/*',
                                                            'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.comments': ['docs/img/*',
                                                   'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.cov_report': ['docs/img/*',
                                                     'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.data_table': ['assets/*',
                                                     'docs/img/*',
                                                     'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.diag_diagram': ['docs/img/*',
                                                       'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.git_changelog': ['assets/keepachangelog/*',
                                                        'docs/*',
                                                        'docs/img/*'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.lprunner': ['docs/img/*',
                                                   'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.mpl_pyplot': ['docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.project_dependencies': ['docs/*',
                                                               'docs/img/*'],
 'lcdoc.mkdocs.lp.plugs.python.pyplugs.screenshot': ['docs/img/*',
                                                     'docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.show_file': ['docs/index.md'],
 'lcdoc.mkdocs.lp.plugs.show_src': ['docs/index.md']}
