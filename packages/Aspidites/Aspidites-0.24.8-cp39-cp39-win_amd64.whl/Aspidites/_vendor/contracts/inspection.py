...
from inspect import (FullArgSpec, CO_COROUTINE, CO_GENERATOR, CO_ASYNC_GENERATOR, CORO_CLOSED, CORO_CREATED,
                     CORO_RUNNING, CORO_SUSPENDED, CO_VARARGS, CO_VARKEYWORDS, CO_ITERABLE_COROUTINE)
import cython
