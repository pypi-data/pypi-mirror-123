...
setup(
    ...
    name='digital_twin_platform',  # Required
    ...
    description='A framework for working with digital twin systems and simulation',  # Optional
    ...
    url='https://github.com/INTO-CPS-Association/digital-twin-platform',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Kenneth Lausdahl',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='kenneth@lausdahl.com',  # Optional
    ...
    # larger catalog.
    keywords='digital twin, setuptools, development',  # Optional
...
#        '': ['data/docker-compose.yml', 'data/.env', 'data/example-pipe.yml', 'data/external_identify_processor.py'],
#    },
    ...
    entry_points={  # Optional
        'console_scripts': [
            'cli=digital_twin_platform:main',
        ],
    },
