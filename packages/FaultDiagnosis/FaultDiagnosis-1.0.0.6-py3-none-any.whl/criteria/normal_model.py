...
class Criteria:
    ...
    def standard_model(self):
        ...
        #print("df_fault len :", len(df_fault))
        #print("df_fault :", df_fault)
    ...
    def normal_model(self):
        ...
        #print('Y_prediction1 :', Y_prediction1)
    ...
    def fault_model(self):
        ...
        for eno in np.arange(1,22):
            ...
            if ((AirCondition == '1' and len(fault_total) < 152262) or (
                    AirCondition == '2' and len(fault_total) < 120076)):
                print('정상적인 표준 센싱 정보 데이터가 존재하지 않습니다.')
                sys.exit(0)
            ...
            for i in range(rowcount):
                ...
                for j in range(colcount):
                    ...
                    #print('confusionMat[i,j]:',i, j, confusionMat[i,j])
...
"""
SiteCode = Common.sitecode(Common.SiteCode)
Criteria.standard_model(Common.SiteCode)
Criteria.normal_model(Common.SiteCode)
Criteria.fault_model(Common.SiteCode)
"""