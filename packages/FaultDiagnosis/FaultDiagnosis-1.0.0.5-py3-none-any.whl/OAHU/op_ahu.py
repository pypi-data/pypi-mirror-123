...
def op_normal_predict(StartDate, EndDate, EquipmentClassCode, EquipmentNo, SiteCode, BuildingNo, ZoneNo):
    ...
    # fault_data = fault_data.query(StartDate + ' <= SensingTime <= ' + EndDate)
    ...
    #print("fault_data:", fault_data)
    print('fault_data len:', len(fault_data))
...
fault_predict, Y_pred1, Y_prediction2, aircondition = op_normal_predict(StartDate, EndDate, EquipmentClassCode,
                                                                        EquipmentNo, SiteCode, BuildingNo, ZoneNo)
op_best_poly_reg_model(fault_predict, Y_pred1, Y_prediction2, AirCondition, EquipmentClassCode, EquipmentNo, SiteCode,
                       BuildingNo, ZoneNo)
