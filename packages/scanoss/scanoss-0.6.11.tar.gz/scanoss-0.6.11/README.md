...
## Container Usage
To leverage the CLI from within a container, please look at [DOCKER.md](DOCKER.md).
The image is also published on GitHub Containers. For more details, please look at [GHCR.md](GHCR.md).
