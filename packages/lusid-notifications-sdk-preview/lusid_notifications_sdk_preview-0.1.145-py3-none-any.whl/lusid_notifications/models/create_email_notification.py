...
class CreateEmailNotification(object):
    ...
    def __init__(self, description=None, subject=None, body=None, email_address_to=None, email_address_cc=None, email_address_bcc=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def body(self):
        """Gets the body of this CreateEmailNotification.  # noqa: E501

        The body of the email  # noqa: E501

        :return: The body of this CreateEmailNotification.  # noqa: E501
        :rtype: str
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this CreateEmailNotification.

        The body of the email  # noqa: E501

        :param body: The body of this CreateEmailNotification.  # noqa: E501
        :type body: str
        """
        if self.local_vars_configuration.client_side_validation and body is None:  # noqa: E501
            raise ValueError("Invalid value for `body`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                body is not None and len(body) > 2147483647):
            raise ValueError("Invalid value for `body`, length must be less than or equal to `2147483647`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
