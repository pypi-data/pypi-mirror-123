...
from deci_client.deci_api import ApiClient, Configuration, ApiException, FrameworkType
...
class DeciPlatformClient(PlatformApi):
    ...
    def add_model(self, add_model_request: ModelMetadata, model_local_path: str = None, local_loaded_model=None,
                  **kwargs):
        """
