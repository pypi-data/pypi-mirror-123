...
class User(object):
    ...
    def __init__(self, update_time=None, creation_time=None, first_name=None, last_name=None, user_id=None, company_id=None, email=None, job_title=None, state=None, feature_flags=[], deci_role=None, local_vars_configuration=None):  # noqa: E501
