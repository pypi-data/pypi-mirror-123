...
class PlatformApi(object):
    ...
    def deploy_model_to_infery(self, model_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str model_id: The unique ID of model in the model repository. (required)
        :param InferenceHardware hardware: The hardware on which the model will be loaded, and inference occur.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_all_accuracy_metrics(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: APIResponseDictDeciInfraDataTypesEnumDeepLearningTaskDeepLearningTaskListDeciInfraDataTypesEnumModelsEnumsAccuracyMetricKey
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_all_accuracy_metrics_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(APIResponseDictDeciInfraDataTypesEnumDeepLearningTaskDeepLearningTaskListDeciInfraDataTypesEnumModelsEnumsAccuracyMetricKey, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='APIResponseDictDeciInfraDataTypesEnumDeepLearningTaskDeepLearningTaskListDeciInfraDataTypesEnumModelsEnumsAccuracyMetricKey',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_all_batch_sizes(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: APIResponseListDeciInfraDataTypesEnumModelsEnumsBatchSize
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_all_batch_sizes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(APIResponseListDeciInfraDataTypesEnumModelsEnumsBatchSize, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='APIResponseListDeciInfraDataTypesEnumModelsEnumsBatchSize',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def request_support(self, support_request_form, **kwargs):  # noqa: E501
        ...
        Requests deci's support to contact you.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
