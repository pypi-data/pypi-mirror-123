...
```python
# Example automatically generated without compilation. See https://github.com/aws/jsii/issues/826
from aws_cdk import lambda_ as lambda_
...
class CfnEventSourceMapping(
    ...
    def __init__(
        ...
        *,
        ...
        :param starting_position_timestamp: ``AWS::Lambda::EventSourceMapping.StartingPositionTimestamp``.
...
class CfnFunction(
    ...
    def __init__(
        ...
        *,
        ...
        :param architectures: ``AWS::Lambda::Function.Architectures``.
...
class CfnLayerVersion(
    ...
    def __init__(
        ...
        *,
        ...
        :param compatible_architectures: ``AWS::Lambda::LayerVersion.CompatibleArchitectures``.
