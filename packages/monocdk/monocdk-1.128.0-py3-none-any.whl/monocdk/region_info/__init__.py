...
from aws_cdk_lib.region_info import RegionInfo
...
```python
# Example automatically generated. See https://github.com/aws/jsii/issues/826
from aws_cdk import region_info as region_info
...
class FactName(metaclass=jsii.JSIIMeta, jsii_type="monocdk.region_info.FactName"):
    ...
    @builtins.classmethod
    def cloudwatch_lambda_insights_version(cls, version: builtins.str) -> builtins.str:
        ...
        :stability: experimental
        '''
        return typing.cast(builtins.str, jsii.sinvoke(cls, "cloudwatchLambdaInsightsVersion", [version]))
...
class RegionInfo(metaclass=jsii.JSIIMeta, jsii_type="monocdk.region_info.RegionInfo"):
    ...
    def cloudwatch_lambda_insights_arn(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.invoke(self, "cloudwatchLambdaInsightsArn", [insights_version]))
