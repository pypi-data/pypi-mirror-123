...
class Database(object):
    ...
    def __init__(self, id=None, name=None, description=None, location=None, organization_id=None, tables=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
