...
class AnalysisJobStatus(object):
    ...
    def __init__(self, id=None, analysis_job_id=None, project_id=None, source=None, step=None, message=None, type=None, order=None, progress=None, metadata=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
