...
class ModelJob(object):
    ...
    def __init__(self, id=None, type=None, outcome_type=None, config=None, execution_id=None, status=None, project_id=None, model_id=None, model_batch_job_id=None, model_batch_job=None, cohort_id=None, dataset_id=None, project=None, model=None, cohort=None, dataset=None, events=None, outputs=None, model_job_output_features=None, model_job_statuses=None, feature_sub_categories=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
