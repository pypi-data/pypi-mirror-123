...
class Feature(object):
    ...
    def __init__(self, id=None, column_name=None, column_alias=None, display_name=None, feature_sub_category_id=None, aggregation_type=None, is_filter=None, is_trainable=None, is_explainable=None, is_categorical=None, category_values=None, type=None, feature_table_id=None, feature_table=None, feature_sub_category=None, model_job_output_features=None, organization_feature_exclusions=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
