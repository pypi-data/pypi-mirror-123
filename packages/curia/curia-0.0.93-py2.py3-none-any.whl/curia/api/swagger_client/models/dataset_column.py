...
class DatasetColumn(object):
    ...
    def __init__(self, id=None, name=None, type=None, metadata=None, dataset_id=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
