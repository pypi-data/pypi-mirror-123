...
class ModelJobStatus(object):
    ...
    def __init__(self, id=None, model_job_id=None, project_id=None, source=None, step=None, message=None, type=None, order=None, created_at=None, updated_at=None, last_updated_by=None, created_by=None, progress=None, metadata=None, version=None):  # noqa: E501
