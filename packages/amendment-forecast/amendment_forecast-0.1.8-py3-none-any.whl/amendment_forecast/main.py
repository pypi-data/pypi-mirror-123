...
def run_forecast_ensemble(
    ...
    ensemble.append({
        "name": "ensemble",
        "model": None,
        "train_timestamps": ensemble_train_timestamps,
        "prediction_values": ensemble_predictions,
        "actual_values": ensemble_actuals,
        "forecast_timestamps": ensemble_forecast_timestamps,
