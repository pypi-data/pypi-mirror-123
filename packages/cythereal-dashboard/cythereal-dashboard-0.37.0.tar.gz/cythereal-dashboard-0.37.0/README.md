...
api_instance = cythereal_dashboard.DashboardApi(cythereal_dashboard.ApiClient(configuration))
start_date = '1999-01-01' # str | Return counts from the given date until endDate. Specify date as `YYYY-MM-DD`.  (optional) (default to 1999-01-01)
end_date = '9999-12-31' # str | Return counts from startDate until the given date. Specify date as `YYYY-MM-DD`.        (optional) (default to 9999-12-31)
all_files = false # bool |  (optional) (default to false)
children_only = false # bool |  (optional) (default to false)
files_only = false # bool |  (optional) (default to false)
file_type = 'file_type_example' # str |  (optional)
children_file_type = 'children_file_type_example' # str |  (optional)

try:
    # Get the users total number of binaries, campaigns, and tags
    api_response = api_instance.get_counts(start_date=start_date, end_date=end_date, all_files=all_files, children_only=children_only, files_only=files_only, file_type=file_type, children_file_type=children_file_type)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DashboardApi->get_counts: %s\n" % e)
...
*LogsApi* | [**list_nginx_logs**](docs/LogsApi.md#list_nginx_logs) | **GET** /logs/nginx | Gets the nginx specific logs for a user
...
## Documentation For Models
 ...
 - [Names](docs/Names.md)
 - [NginxLogs](docs/NginxLogs.md)
 - [NginxLogsInner](docs/NginxLogsInner.md)
 ...
 - [NginxLogsResponse](docs/NginxLogsResponse.md)
