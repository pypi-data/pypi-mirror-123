...
def add_named(duplicate: bool = True, linked: bool = False, name: str = '', drop_x: int = 0, drop_y: int = 0) -> None:
...
def collection_instance_add(name: str = 'Collection', collection: str = '', align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), scale: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), drop_x: int = 0, drop_y: int = 0) -> None:
...
def gpencil_add(radius: float = 1.0, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), scale: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), type: str = 'EMPTY', use_in_front: bool = False, use_lights: bool = False, stroke_depth_order: str = '3D') -> None:
...
def transfer_mode(use_eyedropper: bool = False, use_flash_on_transfer: bool = True) -> None:
