...
class NSG_Cluster:
    def __init__(self, url, user, password, group_name, policy=False):
        ...
        if self.spplited_url[0] == "axprensxtmgr":
            ...
            if "cbs" in group_name:
                ...
                self.master_group_name = self.spplited_group_name[0] + "-" + self.spplited_group_name[1] + "-" + self.spplited_group_name[2] + "-" + self.spplited_group_name[3] + "-all"
            ### If MongoDB...
    ...
    def create_group_cluster_and_rules(self):
        ...
        if self.policy == False:
            print(self.master_group_name)
            print(self.complete_group_name)
