...
# To use when specifying typehints
ExportTypeLiteral = Literal["HTTP", "API_PUSH", "SFTP", "BQ", "ALGOLIA", "AUDIENCE_PUSH"]
...
# To use when specifying typehints
ChannelTypeLiteral = Literal['mct', 'mct_legacy', 'googleads', 'facebook', 'facebook_flight', 'amazon_home', 'bing',
                             'shopping_actions', 'criteo', 'searchads_360', 'leguide_fr', 'kelkoo', 'mct_push', 'pricerunner',
