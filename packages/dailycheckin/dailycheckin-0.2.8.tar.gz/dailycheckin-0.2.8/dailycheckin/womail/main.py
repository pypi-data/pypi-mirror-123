                ...
                try:
                    ...
                    task_data = [
                        ...
                        },
                        {
                            ...
                            "url": "https://club.mail.wo.cn/clubwebservice/growth/addIntegral?phoneNum={usermobile}&resourceType={resource_flag}",
                        },
                        {
                            "irid": 545,
                        ...
                        },
                        {
                            ...
                            "attachData": '{"jumpLink":"/clubwebservice/club-index/activity-scope?currentPage=activityScope"}',
                            "description": "Web端参与俱乐部活动+1积分",
                            "url": "https://club.mail.wo.cn/clubwebservice/growth/addGrowthViaTask?phoneNum={usermobile}&resourceType={resource_flag}",
                        },
                        {
                            "irid": 561,
                            "resourceName": "俱乐部积分兑换",
                    ...
                    for task_item in task_data:
                        ...
                        try:
                            if "每日签到" in resource_name:
                                ...
                                url = task_item["url"].format(usermobile=usermobile, resource_flag=resource_flag)
                                res = requests.get(url=url, headers=headers).json()
                                result = res.get("description")
                                msg.append({"name": resource_name, "value": result})
                        except Exception as e:
