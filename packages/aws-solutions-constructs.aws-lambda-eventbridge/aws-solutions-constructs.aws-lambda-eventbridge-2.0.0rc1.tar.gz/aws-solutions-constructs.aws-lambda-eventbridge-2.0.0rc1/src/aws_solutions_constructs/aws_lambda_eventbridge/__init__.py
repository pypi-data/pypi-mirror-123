...
from aws_solutions_constructs.aws_lambda_eventbridge import LambdaToEventbridge, LambdaToEventbridgeProps
...
class LambdaToEventbridge(
    ...
    def __init__(
        ...
        *,
        ...
        :param event_bus_environment_variable_name: Optional Name for the EventBus's name environment variable set for the Lambda function. Default: - EVENTBUS_NAME is used
