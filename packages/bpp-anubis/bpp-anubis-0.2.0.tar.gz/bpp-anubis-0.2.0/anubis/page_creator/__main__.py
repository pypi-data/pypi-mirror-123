...
def main():
    ...
    if os.path.isfile(os.path.join(args.page_object_directory, args.object_directory, f'{args.object_name}.py')):
        ...
        object_path = os.path.join(os.path.join(args.page_directory, f'{args.object_name}.py'))
        locator_path = os.path.join(os.path.join(f'{args.locator_directory}', f'{args.object_name}.py'))
