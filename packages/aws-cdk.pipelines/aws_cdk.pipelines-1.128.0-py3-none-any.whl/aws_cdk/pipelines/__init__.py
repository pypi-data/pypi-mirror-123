...
class CdkPipeline(
    ...
    def __init__(
        ...
        *,
        ...
        :param enable_key_rotation: Enables KMS key rotation for cross-account keys. Cannot be set if ``crossAccountKeys`` was set to ``false``. Key rotation costs $1/month when enabled. Default: - false (key rotation is disabled)
