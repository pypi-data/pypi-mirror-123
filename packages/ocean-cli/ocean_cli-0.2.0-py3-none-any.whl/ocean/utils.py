...
def print(msg="", type=PrintType.NORMAL, nl=True):
    if type == PrintType.NORMAL:
        click.echo(msg, nl=nl)
    elif type == PrintType.SUCCESS:
        click.secho(u'\u2713' + f" {msg}", fg="green", bold=True, nl=nl)
    elif type == PrintType.FAILED:
        click.secho(u'\u2717' + f" {msg}", fg="red", bold=True, nl=nl)
    elif type == PrintType.WORNING:
        click.secho(u'\u26A0' + f" {msg}", fg="yellow", bold=True, nl=nl)
