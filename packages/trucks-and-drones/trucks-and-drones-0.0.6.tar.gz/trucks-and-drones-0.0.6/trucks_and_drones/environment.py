...
class CustomEnv(gym.Env):
    ...
    @property
    def total_time(self):
        return self.simulation.temp_db.total_time

    def get_data(self, key, index=None):
        return self.simulation.temp_db(key, index)
    ...
    def reset(self):
        ...
        return observation #np.array(observation, dtype=np.float32)
    ...
    def save_rendered(self, path):
        self.visualizer.save_screen(path)
