...
from configuration.overrider.databricks_keyvault_overrider import DatabricksKeyVaultOverrider
from configuration.overrider.environment_overrider import EnvironmentOverrider
from configuration.reader import FileSysConfigurationReader
from configuration.singleton import SingletonMeta
from configuration.utils import ConfigurationUtils
...
class Configuration(metaclass=SingletonMeta):
    ...
    def __load(
        ...
        if enable_airflow_vars is not None and enable_airflow_vars.lower() == "true":
            ...
            from configuration.overrider.airflow_env_overrider import AirflowEnvOverrider
