...
class SweepComponentDefinition(ComponentDefinition):
    ...
    def _from_dict(cls, dct, ignore_unexpected_keywords=True, base_dir=None,
        ...
        if base_dir:
            ...
            dct['inputs'] = {**dct.get('inputs', {}), **trail_component_data.get('inputs', {})}
            dct['outputs'] = {**dct.get('outputs', {}), **trail_component_data.get('outputs', {})}
        ...
        try:
            ...
            if param.linked_param_assignments:
                if inferred_meta_dict["type"] is None:
                    ...
                    logging.warning(
                        "Can not determine the type of parameter {!r} of pipeline {!r}, setting is as string.".format(
