...
from kelvin.sdk.lib.utils.general_utils import check_if_image_is_allowed_on_platform
...
def get_kelvin_app_building_object(
    ...
    check_if_image_is_allowed_on_platform(registry_url=registry_url, docker_image_name=kelvin_app_builder_image)
    check_if_image_is_allowed_on_platform(registry_url=registry_url, docker_image_name=kelvin_app_runner_image)
