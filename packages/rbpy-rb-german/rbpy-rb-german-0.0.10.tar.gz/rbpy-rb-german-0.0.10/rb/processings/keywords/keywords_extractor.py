...
class KeywordExtractor:
    ...
    def extract_keywords(only_noun, text: Union[str, TextElement], lang: Lang = Lang.RO, max_keywords: int = 40, vector_model: VectorModel = None, threshold: float = 0.3) -> List[Tuple[float, str]]:
