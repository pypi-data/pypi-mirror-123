...
class CustomResourceDefinitionVersion(DataclassDictMixIn):
    """CustomResourceDefinitionVersion describes a version for CRD.
      ...
      * **schema** ``CustomResourceValidation`` - *(optional)* schema describes the schema used for validation, pruning, and defaulting of
...
@dataclass
class WebhookConversion(DataclassDictMixIn):
    """WebhookConversion describes how to call a conversion webhook
      ...
      * **clientConfig** ``WebhookClientConfig`` - *(optional)* clientConfig is the instructions for how to call the webhook if strategy is
        `Webhook`.
    """
