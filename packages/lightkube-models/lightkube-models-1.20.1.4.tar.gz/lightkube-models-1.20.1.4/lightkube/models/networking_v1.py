...
class IngressClassSpec(DataclassDictMixIn):
    """IngressClassSpec provides information about the class of an Ingress.
      ...
      * **controller** ``str`` - *(optional)* Controller refers to the name of the controller that should handle this class.
        ...
        field is immutable.
      * **parameters** ``core_v1.TypedLocalObjectReference`` - *(optional)* Parameters is a link to a custom resource containing additional configuration
        for the controller. This is optional if the controller does not require extra
        parameters.
    """
    controller: 'str' = None
    parameters: 'core_v1.TypedLocalObjectReference' = None
