...
from getranet_automl.exceptions import (InvalidArgumentException,
                                        InvalidAudioFormatException)
from getranet_automl.storage.storage import upload_blob
...
class GoogleSpeechAPI:
    ...
    def transcribe_path(
        ...
        if srt:
            ...
            self.__write_srt(srt_filepath, lang, subs)
    ...
    def transcribe_file(
        ...
        elif not self.preprocessed_file:
            raise InvalidArgumentException(400, "Missing file.")
