...
URL = 'https://github.com/u3814520/WebCrawle-eslite'      # 專案網址
EMAIL = 'u3814520@gmail.com'         # 信箱
AUTHOR = 'chiao ting'              # 作者
REQUIRES_PYTHON = '>=3.6.0'      # python 版本
VERSION = '0.1.3'                # 版本(更新版本需改變)

# What packages are required for this module to be executed?  # 專安需要哪些套件
REQUIRED = [
