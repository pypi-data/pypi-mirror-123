...
curl -L https://github.com/PyO3/maturin/releases/download/v0.11.5/maturin-x86_64-unknown-linux-musl.tar.gz | tar -xz -C /usr/local/bin
maturin --version
echo "::endgroup::"
maturin build -i python3.7 --release --strip