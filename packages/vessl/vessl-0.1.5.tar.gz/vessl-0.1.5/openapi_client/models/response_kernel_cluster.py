...
class ResponseKernelCluster(object):
    ...
    def __init__(self, created_dt=None, id=None, is_savvihub_managed=None, kubernetes_service_type=None, name=None, provider=None, region=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
