...
PROJECT_TYPES = [PROJECT_TYPE_VERSION_CONTROL, PROJECT_TYPE_CLI_DRIVEN]
...
SWEEP_ALGORITHM_TYPE_BAYESIAN = "baysian"
...
VESSL_IMAGE_PATH = "vessl-images"
VESSL_PLOTS_FILETYPE_IMAGE = "image"
VESSL_PLOTS_FILETYPE_IMAGES = "images"

WORKSPACE_ZIP_PATH = "workspace-backup.zip"
WORKSPACE_TEMP_ZIP_PATH = f"/tmp/{WORKSPACE_ZIP_PATH}"

SSH_CONFIG_PATH = f"{Path.home()}/.ssh/config"
SSH_CONFIG_FORMAT = """Host {host}
    ...
    CheckHostIP no
"""
SSH_PUBLIC_KEY_PATH = f"{Path.home()}/.ssh/id_ed25519.pub"
SSH_PRIVATE_KEY_PATH = f"{Path.home()}/.ssh/id_ed25519"
