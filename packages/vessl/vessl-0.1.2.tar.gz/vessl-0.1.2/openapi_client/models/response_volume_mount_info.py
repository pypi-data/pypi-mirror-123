...
class ResponseVolumeMountInfo(object):
    ...
    def __init__(self, code=None, dataset=None, dataset_version=None, is_dir=None, mount_type=None, path=None, project=None, read_only=None, size=None, source_type=None, volume=None, local_vars_configuration=None):  # noqa: E501
