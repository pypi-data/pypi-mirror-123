...
class ResponseCodeRepository(object):
    ...
    def __init__(self, git_owner=None, git_provider=None, git_ref=None, git_repo=None, organization_credentials_id=None, url=None, local_vars_configuration=None):  # noqa: E501
