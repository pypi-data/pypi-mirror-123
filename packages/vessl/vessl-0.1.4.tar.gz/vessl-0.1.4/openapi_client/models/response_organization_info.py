...
class ResponseOrganizationInfo(object):
    ...
    def __init__(self, aws_external_id=None, created_dt=None, credit_balance=None, default_kernel_cluster=None, default_region=None, description=None, display_name=None, id=None, is_managed_cluster_enabled=None, is_public=None, name=None, primary_owner_id=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
    ...
    def default_kernel_cluster(self):
        """Gets the default_kernel_cluster of this ResponseOrganizationInfo.  # noqa: E501


        :return: The default_kernel_cluster of this ResponseOrganizationInfo.  # noqa: E501
    ...
    def default_kernel_cluster(self, default_kernel_cluster):
        """Sets the default_kernel_cluster of this ResponseOrganizationInfo.


        :param default_kernel_cluster: The default_kernel_cluster of this ResponseOrganizationInfo.  # noqa: E501
    ...
    def is_managed_cluster_enabled(self):
        """Gets the is_managed_cluster_enabled of this ResponseOrganizationInfo.  # noqa: E501


        :return: The is_managed_cluster_enabled of this ResponseOrganizationInfo.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_managed_cluster_enabled(self, is_managed_cluster_enabled):
        """Sets the is_managed_cluster_enabled of this ResponseOrganizationInfo.


        :param is_managed_cluster_enabled: The is_managed_cluster_enabled of this ResponseOrganizationInfo.  # noqa: E501
        :type is_managed_cluster_enabled: bool
        """
        if self.local_vars_configuration.client_side_validation and is_managed_cluster_enabled is None:  # noqa: E501
            raise ValueError("Invalid value for `is_managed_cluster_enabled`, must not be `None`")  # noqa: E501
