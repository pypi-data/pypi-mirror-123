...
class ResponseVolumeMountInfo(object):
    ...
    openapi_types = {
        ...
        'mount_type': 'str',
        'path': 'str',
        'project': 'OrmVolumeSourceProject',
        'read_only': 'bool',
        'size': 'int',
        'source_type': 'str',
    ...
    def __init__(self, archive_file=None, code=None, dataset=None, dataset_version=None, is_dir=None, mount_type=None, path=None, project=None, read_only=None, size=None, source_type=None, volume=None, local_vars_configuration=None):  # noqa: E501
    ...
    def project(self, project):
        ...
        :type project: OrmVolumeSourceProject
        """
