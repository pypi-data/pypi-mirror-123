...
class ResponseKernelResourceSpec(object):
    ...
    openapi_types = {
        ...
        'created_dt': 'datetime',
        'description': 'str',
        'gpu_labels': 'OrmKernelResourceSpecGpuLabels',
        'gpu_limit': 'int',
        'gpu_type': 'str',
        'id': 'int',
        'is_preset': 'bool',
    ...
    def __init__(self, available=None, cpu_limit=None, cpu_type=None, created_dt=None, description=None, gpu_labels=None, gpu_limit=None, gpu_type=None, id=None, is_preset=None, memory_limit=None, name=None, processor_type=None, spot=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
    ...
    def gpu_labels(self):
        ...
        :rtype: OrmKernelResourceSpecGpuLabels
        """
    ...
    def gpu_labels(self, gpu_labels):
        ...
        :type gpu_labels: OrmKernelResourceSpecGpuLabels
        """
