...
class OrmOrganizationEdges(object):
    ...
    def __init__(self, billing_histories=None, default_kernel_cluster=None, default_storage=None, default_volume=None, notification_configs=None, organization_credentials=None, organization_kernel_clusters=None, primary_owner=None, quotas=None, user_organization=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
