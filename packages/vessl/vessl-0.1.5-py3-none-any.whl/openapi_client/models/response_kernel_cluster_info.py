...
class ResponseKernelClusterInfo(object):
    ...
    def __init__(self, created_dt=None, current_system_metrics=None, docs_link=None, id=None, is_savvihub_managed=None, kubernetes_namespace=None, kubernetes_service_type=None, message=None, name=None, provider=None, region=None, status=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
