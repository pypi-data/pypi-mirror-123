...
class ResponseKernelClusterNodeInfo(object):
    ...
    openapi_types = {
        ...
        'name': 'str',
        'updated_dt': 'datetime',
        'workspaces_status_summary': 'ResponseKernelClusterNodeInfoExperimentsStatusSummary'
    }
    ...
    def __init__(self, cpu_allocatable=None, cpu_limits=None, cpu_requests=None, created_dt=None, current_system_metrics=None, ephemeral_storage_allocatable=None, ephemeral_storage_limits=None, ephemeral_storage_requests=None, experiments_status_summary=None, gpu_allocatable=None, gpu_limits=None, gpu_product_name=None, gpu_requests=None, id=None, internal_ip=None, memory_allocatable=None, memory_limits=None, memory_requests=None, name=None, updated_dt=None, workspaces_status_summary=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._workspaces_status_summary = None
        ...
        if workspaces_status_summary is not None:
            self.workspaces_status_summary = workspaces_status_summary
    ...
    @property
    def workspaces_status_summary(self):
        """Gets the workspaces_status_summary of this ResponseKernelClusterNodeInfo.  # noqa: E501


        :return: The workspaces_status_summary of this ResponseKernelClusterNodeInfo.  # noqa: E501
        :rtype: ResponseKernelClusterNodeInfoExperimentsStatusSummary
        """
        return self._workspaces_status_summary

    @workspaces_status_summary.setter
    def workspaces_status_summary(self, workspaces_status_summary):
        """Sets the workspaces_status_summary of this ResponseKernelClusterNodeInfo.


        :param workspaces_status_summary: The workspaces_status_summary of this ResponseKernelClusterNodeInfo.  # noqa: E501
        :type workspaces_status_summary: ResponseKernelClusterNodeInfoExperimentsStatusSummary
        """

        self._workspaces_status_summary = workspaces_status_summary
