...
class DeletedOrphanedEntity:
    ...
    def __repr__(self):
        return f"""
            DeletedOrphanedEntity(deleted {self.from_entity} of type {self.from_class}, 
            because {self.to_entity} of type {self.to_class} has disappeared and mapping
            allows deleting orphans)
        """
