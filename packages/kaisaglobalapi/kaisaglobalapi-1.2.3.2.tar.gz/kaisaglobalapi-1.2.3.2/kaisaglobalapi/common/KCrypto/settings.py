...
------------------------------
  KCrypto <options> [file path] <file path 2...>


Encrypt all top level files in directory:
-----------------------------------------
  KCrypto <options> [directory path] <directory path 2...>
  
  
Create a tar archive from directory and encrypt the archive:
-----------------------------------------------------------
  KCrypto --tar [directory path] <directory path 2...>
...
Enter `KCrypto --help` or `decrypto --help` to view the available options.
...
ABOUT
KCrypto provides a simple interface to symmetric Gnu Privacy Guard (gpg) encryption and decryption for one or more files.  gpg must be installed on your system in order to use the crypto and decrypto executables.

USAGE
  ENCRYPTION
    KCrypto <options> [file path] <file path...>
    KCrypto <options> [directory path] <directory path...>
