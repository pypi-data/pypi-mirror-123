...
from tests.resource_files import read_csv_as_pd, create_resources_file_path
...
class TestRectangularGeometry(unittest.TestCase):
    ...
    def test_build_geometry_rectangle_with_dict(self, mock_show=None):
        # arrange
        block_def = [
            {'no': 1, 'x': 40.0, 'y': 0, 'alpha': 0.0, 'nco': 3, 'type': 2, 'current': 13500,
             'condname': 'SMC11T100', 'n1': 2, 'n2': 20, 'imag': 0, 'turn': 0}]
        layer_def = [{"no": 1,"symm": 1,"typexy": 1,"blocks": [1]}]

        cadata_path = create_resources_file_path('resources/geometry/roxie/SMC/roxie-SMC.cadata')
    ...
    def test_build_geometry_rectangle_with_json(self, mock_show=None):
        # arrange
        json_path = create_resources_file_path('resources/geometry/roxie/SMC/three_cable_coil.json')
        cadata_path = create_resources_file_path('resources/geometry/roxie/SMC/roxie-SMC.cadata')
        cadata = CableDatabase.read_cadata(cadata_path)
    ...
    def test_build_geometry_rectangle_with_data(self, mock_show=None):
        # arrange
        data_path = create_resources_file_path('resources/geometry/roxie/SMC/three_cable_coil.data')
        cadata_path = create_resources_file_path('resources/geometry/roxie/SMC/roxie-SMC.cadata')
        cadata = CableDatabase.read_cadata(cadata_path)
    ...
    def test_build_geometry_rectangle_with_csv(self, mock_show=None):
        # arrange
        block_dl_path = create_resources_file_path('resources/geometry/roxie/SMC/three_cable_coil.csv')
        layer_df_path = create_resources_file_path('resources/geometry/roxie/SMC/layer_data.csv')
        cadata_path = create_resources_file_path('resources/geometry/roxie/SMC/roxie-SMC.cadata')
        cadata = CableDatabase.read_cadata(cadata_path)
    ...
    def test_smc_build_geometry_rectangle_with_data(self, mock_show=None):
        # arrange
        data_path = create_resources_file_path('resources/geometry/roxie/SMC/SMC11T_v3_35turns_ins100_new.data')
        cadata_path = create_resources_file_path('resources/geometry/roxie/SMC/roxie-SMC.cadata')
        cadata = CableDatabase.read_cadata(cadata_path)
    ...
    def test_to_roxie_df_with_csv(self):
        # arrange
        block_df_path = create_resources_file_path('resources/geometry/roxie/SMC/three_cable_coil.csv')
        layer_df_path = create_resources_file_path('resources/geometry/roxie/SMC/layer_data.csv')
        cadata_path = create_resources_file_path('resources/geometry/roxie/SMC/roxie-SMC.cadata')
        cadata = CableDatabase.read_cadata(cadata_path)
