...
def cluster_topic_map():
    ...
    dict_out = {
        ...
        "NubiumIntegrations_Vivastream_ContactsVivastreamRetriever_Timestamps": cluster_2,
        "NubiumIntegrations_Vivastream_CdoToFormTransform": cluster_2,
        "NubiumIntegrations_UploadWizard_ContactsUploadsMembersRetriever_Timestamps": cluster_2,
