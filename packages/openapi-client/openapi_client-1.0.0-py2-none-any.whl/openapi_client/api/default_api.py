...
from openapi_client.model.save_dataset_version_response import SaveDatasetVersionResponse
...
from openapi_client.model.test_dataset_response import TestDatasetResponse
...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __save_dataset_setup(
            self,
            save_dataset_setup_params,
            **kwargs
        ):
            """save_dataset_setup  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.save_dataset_setup(save_dataset_setup_params, async_req=True)
            >>> result = thread.get()

            Args:
                save_dataset_setup_params (SaveDatasetSetupParams):
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['save_dataset_setup_params'] = \
                save_dataset_setup_params
            return self.call_with_http_info(**kwargs)

        self.save_dataset_setup = _Endpoint(
            settings={
                'response_type': (SaveDatasetSetupResponse,),
                'auth': [],
                'endpoint_path': '/datasets/saveDatasetSetup',
                'operation_id': 'save_dataset_setup',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'openapi_types': {
                    'save_dataset_setup_params':
                        (SaveDatasetSetupParams,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'save_dataset_setup_params': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.save_dataset_version = _Endpoint(
            settings={
                'response_type': (SaveDatasetVersionResponse,),
                'auth': [],
        ...
        def __test_dataset(
            self,
            dataset_setup_test_request_params,
            **kwargs
        ):
            """test_dataset  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.test_dataset(dataset_setup_test_request_params, async_req=True)
            >>> result = thread.get()

            Args:
                dataset_setup_test_request_params (DatasetSetupTestRequestParams):
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['dataset_setup_test_request_params'] = \
                dataset_setup_test_request_params
            return self.call_with_http_info(**kwargs)

        self.test_dataset = _Endpoint(
            settings={
                'response_type': (TestDatasetResponse,),
                'auth': [],
                'endpoint_path': '/datasets/testDataset',
                'operation_id': 'test_dataset',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'openapi_types': {
                    'dataset_setup_test_request_params':
                        (DatasetSetupTestRequestParams,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'dataset_setup_test_request_params': 'body',
                },
                'collection_format_map': {
                }
            },
